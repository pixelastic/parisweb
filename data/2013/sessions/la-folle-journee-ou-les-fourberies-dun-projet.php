...
<title>Paris Web - La folle journée, ou les fourberies d'un projet</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/introduction.php" title="Introduction" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/changement-de-salle.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="La folle journée, ou les fourberies d'un projet" />
	<meta property="twitter:description" content="Un projet web, on le sait, est un parcours semé d’embûches. Au fil des multiples exigences et retours clients, il évolue tout au long de sa réalisation, et pas toujours en bien… Comment trier les…" />
	<meta property="dc:title" content="La folle journée, ou les fourberies d'un projet" />
	<meta property="og:title" content="La folle journée, ou les fourberies d'un projet" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/la-folle-journee-ou-les-fourberies-dun-projet.php" />
	<meta property="og:description" content="Un projet web, on le sait, est un parcours semé d’embûches. Au fil des multiples exigences et retours clients, il évolue tout au long de sa réalisation, et pas toujours en bien… Comment trier les…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>La folle journée, ou les fourberies d'un projet</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1115">
						<header>
							<h1>La folle journée, ou les fourberies d'un projet</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/77859624" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/la-folle-journee-ou-les-fourberies-dun-projet.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1115">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/la-folle-journee-ou-les-fourberies-dun-projet.php" class="url">La folle journée, ou les fourberies d'un projet</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2013/conferences/">Conférence</a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/">Grand auditorium</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2013/10.php">jeudi 10</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
 9 <abbr title="heures">h</abbr> 30
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/gestion-de-projet" rel="tag">gestion de projet</a><br /><a href="http://www.paris-web.fr/2013/recherche/metier" rel="tag">métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p><strong>Un projet web, on le sait, est un parcours semé d’embûches.</strong> Au fil des multiples exigences et retours clients, il évolue tout au long de sa réalisation, et pas toujours en bien…</p>

<p>Comment trier les sollicitations des clients ? Comment y répondre de façon constructive ? Comment, que l’on soit commercial, créatif, développeur ou chef de projet, arbitrer ses choix tout en ménageant d’un côté les intérêts du projet et de l’autre les légitimes exigences de chacun ?</p>

<p>Entre décisions arbitraires et mauvaise foi aveugle, un projet peut vite se transformer en farce digne de Molière : c’est ce que nous avons choisi de dépeindre ici !</p>

<p>Acte 1 : <strong>L’avant-vente.</strong><br />
« Un site à base de QR codes ? Révolutionnaire ! »</p>

<p>Acte 2 : <strong>La direction artistique.</strong><br />
« Ah, votre femme n’aime pas le rose ? »</p>

<p>Acte 3 : <strong>L’intégration.</strong><br />
« Ce &lt;div class="span"&gt; est une contrainte CMS, désolé. »</p>

<p>Acte 4 : <strong>Le développement.</strong><br />
« L’offshore au Bangladesh ? Bonne idée ! »</p>

<p>Acte 5 : <strong>La mise en production.</strong><br />
« Allez go go go, c’est vendredi ! »</p>

<p>Alors, le client : précieux allié ou perfide saboteur ?</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/julien-dubedout.php">Julien Dubedout</a>, <a href="https://www.paris-web.fr/2013/../orateurs/florian-boudot.php">Florian Boudot</a> et <a href="https://www.paris-web.fr/2013/../orateurs/christophe-andrieu.php">Christophe Andrieu</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Julien Dubedout" src="https://www.paris-web.fr/2013/assets_c/2013/08/julien_dubedout-thumb-143x143-360.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Depuis le temps où sa mère devait lui demander de quitter internet pour pouvoir téléphoner, Julien porte un grand intérêt au web.</p>

<p>D'abord webdesigner freelance, il est ensuite embauché chez Publicis Modem où il rencontre <a href="http://www.paris-web.fr/orateurs/christophe-andrieu.php">Christophe</a> et <a href="http://www.paris-web.fr/orateurs/florian-boudot.php">Florian</a>. Il démissionne 3 ans plus tard pour rejoindre l'agence Roxane et élargir son champ d'intervention. Voilà plus de 8 ans qu'internet le supporte.</p>

<p>En plus de son vrai travail, il a co-créé le blog <a href="mariejulien.com">mariejulien.com</a> ainsi que quelques autres projets web. Gendre idéal, il sait commander chez Subway sans dire "heuu" une seule fois ni se faire refiler les suppléments fromage, il arrive à composter son billet SNCF dans le bon sens du premier coup, et il sait que le "V" De "DVD" veut dire "versatile" et non "vidéo".</p>

<p>Il est prêt à tout pour assister à Paris Web gratuitement. Après l'animation de 2 ateliers en 2010 et 2011, et un plan machiavélique hélas échoué en 2012, il a fait boire ses compagnons pour les décider à présenter un sujet de conférence. Depuis qu'il a appris qu'ils avaient été sélectionnés, il a confisqué les passeports de ses 2 amis pour ne pas qu'ils fuient au Paraguay.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Florian Boudot" src="https://www.paris-web.fr/2013/assets_c/2013/07/Florian-Boudot-3-thumb-143x143-347.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Florian commence par faire du webdesign dans une petite agence en alternance et ça lui plaît pas mal. A cette époque où c'est le webdesigner qui intègre ses propres créas à base de &lt;table&gt;, il commence à se passionner pour cette étape de la production web.</p>

<p>La découverte d’un poste d’intégrateur HTML chez Wcube (futur Publicis Modem) en 2005 l’enchante et il laisse le côté créa pour se consacrer qu'au CSS et à l’HTML. Abordés sous l’angle d’une grosse agence, les projets sont tout de suite à une plus grande échelle, avec plus de contraintes et d'exigence. Développer de meilleures méthodes de production devient alors une quête !</p>

<p>Un séjour en Nouvelle-Zélande, une expérience du Freelance, et beaucoup de très bons techniciens enrichiront son parcours. Florian travaille actuellement pour Publicis Modem en tant que front-end web developer.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Christophe Andrieu" src="https://www.paris-web.fr/2013/assets_c/2013/06/christophe.andrieux.2-thumb-143x143-318.jpg" width="143" height="143">
