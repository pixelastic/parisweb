...
<title>Paris Web - Théorie du flow et webdocumentaires</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/soyez-responsables-construisez-votre-api.php" title="Soyez responsables : construisez votre API" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/html5-accessibility.php" title="HTML5 accessibility" />
	...
	<meta name="twitter:title" content="Théorie du flow et webdocumentaires" />
	<meta property="twitter:description" content="Mihály Csíkszentmihályi. Derrière ce nom barbare se cache un psychologue hongrois qui a, en 1970, formalisé la théorie du flow cognitif. Cette série de principes, bien connue des designers…" />
	<meta property="dc:title" content="Théorie du flow et webdocumentaires" />
	<meta property="og:title" content="Théorie du flow et webdocumentaires" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/theorie-du-flow-et-webdocumentaires.php" />
	<meta property="og:description" content="Mihály Csíkszentmihályi. Derrière ce nom barbare se cache un psychologue hongrois qui a, en 1970, formalisé la théorie du flow cognitif. Cette série de principes, bien connue des designers…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Théorie du flow et webdocumentaires</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1116">
						<header>
							<h1>Théorie du flow et webdocumentaires</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/84519560" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/theorie_workflow.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1116">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/theorie-du-flow-et-webdocumentaires.php" class="url">Théorie du flow et webdocumentaires</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/ux" rel="tag">UX</a><br /><a href="http://www.paris-web.fr/2013/recherche/webdocumentaires" rel="tag">webdocumentaires</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Mihály Csíkszentmihályi. Derrière ce nom barbare se cache un psychologue hongrois qui a, en 1970, formalisé la théorie du flow cognitif. Cette série de principes, bien connue des designers d'expérience, est à la base du plaisir qu'on peut ressentir devant des objets interactifs bien conçus, les bons jeux vidéo par exemple. Mais comment pourrait-on essayer d'appliquer cette théorie pour raconter des histoires documentaires interactives sur le web ? Cette présentation serait une adaptation de cet article : <a href="http://florentmaurin.com/?p=272">Théorie du flow et webdocumentaires</a>.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/florent-maurin.php">Florent Maurin</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Florent Maurin" src="https://www.paris-web.fr/2013/assets_c/2013/06/florent-maurin-thumb-143x143-324.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Florent Maurin est diplômé de l'Ecole supérieure de journalisme de Lille. Après 10 ans de presse jeunesse chez Bayard, (Okapi, J'aime Lire, puis Bayam, l'offre numérique du groupe), il dirige depuis janvier 2013 The Pixel Hunt (http://www.thepixelhunt.com), société de production d'objets d’information interactifs et ludiques. Il est auteur de plusieurs newsgames, des modules au carrefour entre info et jeu vidéo, publiés sur Lemonde.fr. Il est aussi scénariste interactif de webdocumentaires, architecte transmedia, et formateur nouvelles écritures (EMI-CFD, ENJMIN...).  Florent participe au site #Antibuzz, de France Inter, sur lequel il tient une chronique sur les narrations numériques.</p></div>
</div>
