...
<title>Paris Web - jQuery sans jQuery</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/deux-ou-trois-choses-que-vous-ne-savez-peut-etre-pas-sur-la-securite-de-votre-site-web.php" title="Deux ou trois choses que vous ne savez peut-être pas sur la sécurité de votre site Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/un-petit-pas-pour-lem-un-grand-pas-pour-le-web.php" title="Un petit pas pour l'em, un grand pas pour le Web" />
	...
	<meta name="twitter:title" content="jQuery sans jQuery" />
	<meta property="twitter:description" content="Une immense majorité de développeurs connaissent jQuery, mais pas vraiment JavaScript. Nous verrons comment faire en pur JS ce que vous avez l’habitude de faire avec jQuery, en mettant l’accent sur…" />
	<meta property="dc:title" content="jQuery sans jQuery" />
	<meta property="og:title" content="jQuery sans jQuery" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/jquery-sans-jquery.php" />
	<meta property="og:description" content="Une immense majorité de développeurs connaissent jQuery, mais pas vraiment JavaScript. Nous verrons comment faire en pur JS ce que vous avez l’habitude de faire avec jQuery, en mettant l’accent sur…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>jQuery sans jQuery</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1111">
						<header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/80452338" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/jquerysansjquery-131011050951-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://paris-web.fr/2013/jquerysansjquery-131011050951-phpapp01.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1111">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/jquery-sans-jquery.php" class="url">jQuery sans jQuery</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/javascript" rel="tag">JavaScript</a></dd>
