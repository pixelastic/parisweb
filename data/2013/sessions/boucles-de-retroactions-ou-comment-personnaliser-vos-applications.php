...
<title>Paris Web - Boucles de rétroactions, ou comment personnaliser vos applications</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/vers-une-nouvelle-ethique.php" title="Vers une nouvelle éthique" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/pause-1.php" title="Pause" />
	...
	<meta name="twitter:title" content="Boucles de rétroactions, ou comment personnaliser vos applications" />
	<meta property="twitter:description" content="Le web est un monde hyper globalisé et tout à fait décentralisé. Les modes de vie de chacun de vos utilisateurs peuvent être radicalement différents les uns des autres. Alors pourquoi continuer à…" />
	<meta property="dc:title" content="Boucles de rétroactions, ou comment personnaliser vos applications" />
	<meta property="og:title" content="Boucles de rétroactions, ou comment personnaliser vos applications" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/boucles-de-retroactions-ou-comment-personnaliser-vos-applications.php" />
	<meta property="og:description" content="Le web est un monde hyper globalisé et tout à fait décentralisé. Les modes de vie de chacun de vos utilisateurs peuvent être radicalement différents les uns des autres. Alors pourquoi continuer à…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Boucles de rétroactions, ou comment personnaliser vos applications</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1137">
						<header>
							<h1>Boucles de rétroactions, ou comment personnaliser vos applications</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83484863" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1137">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/boucles-de-retroactions-ou-comment-personnaliser-vos-applications.php" class="url">Boucles de rétroactions, ou comment personnaliser vos applications</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/analyse-des-donnees" rel="tag">analyse des données</a><br /><a href="http://www.paris-web.fr/2013/recherche/ergonomie" rel="tag">ergonomie</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/florian-le-goff.php">Florian Le Goff</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Florian Le Goff" src="https://www.paris-web.fr/2013/assets_c/2013/07/Florian-Le-Goff-thumb-143x143-348.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Florian Le Goff est en charge des relations avec les développeurs chez Mailjet. Il réside à Lille dans le Nord, où il co-organise la conférence TakeOff, un des principaux évènements techniques et anglophones au nord de Paris. Florian est également le co-fondateur d'ubinect, le pionnier de la gestion de cabinet médical libéral en mode web.</p></div>
</div>
