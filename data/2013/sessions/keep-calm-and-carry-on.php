...
<title>Paris Web - Keep calm and carry on</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/c.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/utilisez-le-gpu-pour-ameliorer-la-performance-de-vos-applications-web.php" title="[Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos applications Web" />
	...
	<meta property="twitter:description" content="Quel responsable d'équipe n'a jamais été confronté à cette situation particulièrement difficile où un collaborateur est soumis à un stress psychologique intense et n'arrive pas y faire face ? Dans ce…" />
	<meta property="dc:title" content="Keep calm and carry on" />
	<meta property="og:title" content="Keep calm and carry on" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/keep-calm-and-carry-on.php" />
	<meta property="og:description" content="Quel responsable d'équipe n'a jamais été confronté à cette situation particulièrement difficile où un collaborateur est soumis à un stress psychologique intense et n'arrive pas y faire face ? Dans ce…" />
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83485352" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/keep-calm-and-carry-on.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1122">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/keep-calm-and-carry-on.php" class="url">Keep calm and carry on</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/decale" rel="tag">décalé</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Quel responsable d'équipe n'a jamais été confronté à cette situation particulièrement difficile où un collaborateur est soumis à un stress psychologique intense et n'arrive pas y faire face ? Dans ce cas, comment réagir ? C'est ce que j'ai vécu il y quelques mois. Le stress d'une collaboratrice était si fort qu'il en devenait même nocif pour les autres membres de l'équipe. Avec un autre responsable du projet, nous avons essayé plusieurs méthodes afin de diminuer ce stress, malheureusement nous avons pu constater que nous n'étions pas formés pour faire face à ce genre de situation. Nous avons dans un premier temps tenté le mode compréhension/discussion. Nous avons également essayé une manière plus directive : en modifiant nous-mêmes les objectifs, en revoyant le planning. </p>

<p>Mais rien n'y faisait : le stress était là et persistait. Dans ce cas, comment gérer les personnes en situation de stress psychologique insurmontable? Telle est la question que je me suis posée. J'ai finalement trouvé une solution grâce à un échange avec un professeur d'arts plastiques : il fallait ramener cette collaboratrice dans le concret, la réalité. En effet, le stress est surtout dû à un écart entre la réalité et la vision de la réalité que se construit la personne. Pour l'aider, j'ai donc développé trois exercices basés sur des techniques de créativité (Innovation Games®, mind-map et Lego®) autour de la notion de concrétisation du problème afin de la ramener dans la réalité : <br />
(1) Accepter la limite de la quantité de travail que je peux faire,<br />
(2) Identifier les moments d'augmentation du stress, <br />
(3) Identifier les problèmes rencontrés et les comprendre. </p>

<p>La présentation définira rapidement la notion de stress, je présenterai ensuite les exercices créés et leurs résultats.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/lou-schwartz.php">Lou Schwartz</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Lou Schwartz" src="https://www.paris-web.fr/2013/assets_c/2013/08/lou_scwhartz-thumb-143x143-362.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Lou Schwartz est Ingénieur Recherche et Développement au Centre de Recherche Public Henri Tudor à Luxembourg depuis 2006 où elle s'intéresse aux questions liées à l'ergonomie, l'agilité, la personnalisation et l'amélioration de la qualité du logiciel. Ses recherches sont principalement centrées sur la façon d'améliorer la qualité des logiciels en abordant les problèmes d'utilisabilité, en particulier dans les projets agiles et le contexte spécifique de prototypage prospective. Elle se concentre avant tout sur la phase d'émergence des exigences en utilisant notamment les techniques de créativité et la conception centrée sur l'utilisateur. </p>

<p>Elle est l'un des membres fondateurs de l'Association des professionnels de l'utilisabilité France-Luxembourg (<a href="http://www.flupa.eu">FLUPA</a>).</p></div>
</div>
