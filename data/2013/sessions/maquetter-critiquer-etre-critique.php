...
<title>Paris Web - Maquetter : Critiquer &amp; être Critiqué</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/pause-dejeuner-2.php" title="Pause déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/svg-devenez-maitre-des-vecteurs.php" title="SVG, devenez maître des vecteurs" />
	...
	<meta name="twitter:title" content="Maquetter : Critiquer & être Critiqué" />
	<meta property="twitter:description" content="Le maquettage est une méthode qui permet de formaliser et de communiquer rapidement des interfaces d'un service web. Cet outil itératif est accessible à tous pour la peine que l'on prenne le temps de…" />
	<meta property="dc:title" content="Maquetter : Critiquer & être Critiqué" />
	<meta property="og:title" content="Maquetter : Critiquer & être Critiqué" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/maquetter-critiquer-etre-critique.php" />
	<meta property="og:description" content="Le maquettage est une méthode qui permet de formaliser et de communiquer rapidement des interfaces d'un service web. Cet outil itératif est accessible à tous pour la peine que l'on prenne le temps de…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Maquetter : Critiquer & être Critiqué</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1083">
						<header>
							<h1>Maquetter : Critiquer & être Critiqué</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1083">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/maquetter-critiquer-etre-critique.php" class="url">Maquetter : Critiquer & être Critiqué</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/maquettage" rel="tag">maquettage</a></dd>
    ...
    <div class="talk-description"><p>Le maquettage est une méthode qui permet de formaliser et de communiquer rapidement des interfaces d'un service web.</p>

<p>Cet outil itératif est accessible à tous pour la peine que l'on prenne le temps de représenter ses idées à l'aide d'un crayon ou d'un logiciel. <br />
Il permet également de véhiculer rapidement et efficacement ses idées.<br />
Puis quand les idées sont comprises, le travail le plus dur est ensuite d'essuyer les critiques. </p>

<p>Au cours de l'atelier, l'accent sera mis sur la création rapide de maquettes pour le web, puis sur les critiques (et leur compréhension) de ces maquettes. </p>

<p>Les objectifs en sortie de l'atelier sont triples&nbsp;:<br />
<ul><br />
<li>comprendre les critiques </li><br />
<li>apprendre à formuler les réponses</li><br />
<li>maquetter une interface</li><br />
</ul></p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/maxime-fortelle.php">Maxime Fortelle</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Maxime Fortelle" src="https://www.paris-web.fr/2013/assets_c/2013/06/maxime-fortelle-thumb-143x143-339.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Maxime est ergonome, pour la société Floralis Multicom. Passé par la Belgique, il a pu y apprendre et mettre en pratique les méthodes de la démarche centrée utilisateur dans plusieurs projets avec des sociétés comme Orange, Nespresso, Altran, Arturia, etc.</p>

<p>Aujourd’hui, il connaît toutes les disciplines liées à son métier : expérience utilisateurs, utilisabilité, ergonomie et design d’interaction. Son métier est avant tout de rendre plus simple l’utilisation du monde numérique. Pour véhiculer ce message, il est investi dans l’association FLUPA. Avec ses amis FLUPAiens, ils ont créé la conférence FLUPA UX-day et organisent régulièrement des événements sur l’ergonomie en Rhône-Alpes.<br />
Fan du monde associatif, il a rejoint l'association Web In Alps pour promouvoir les acteurs du web alpins.</p></div>
</div>
