...
<title>Paris Web - CSS3/JS Selectors: When your HTML5 Has No Class</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/introduction-1.php" title="Introduction" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/test-unitaire-mock-tdd-kezako-en-finir-avec-les-regressions.php" title="Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)" />
	...
	<meta name="twitter:title" content="CSS3/JS Selectors: When your HTML5 Has No Class" />
	<meta property="twitter:description" content=" CSS3/JS Selectors: When your HTML5 Has No Class Pick an element, any element. Style it. Manipulate it. No IDs. No classes. No jQuery necessary. We'll learn all the new features of selectors in CSS…" />
	<meta property="dc:title" content="CSS3/JS Selectors: When your HTML5 Has No Class" />
	<meta property="og:title" content="CSS3/JS Selectors: When your HTML5 Has No Class" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/css3js-selectors-when-your-html5-has-no-class-3.php" />
	<meta property="og:description" content=" CSS3/JS Selectors: When your HTML5 Has No Class Pick an element, any element. Style it. Manipulate it. No IDs. No classes. No jQuery necessary. We'll learn all the new features of selectors in CSS…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>CSS3/JS Selectors: When your HTML5 Has No Class</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1081">
						<header>
							<h1>CSS3/JS Selectors: When your HTML5 Has No Class</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1081">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/css3js-selectors-when-your-html5-has-no-class-3.php" class="url">CSS3/JS Selectors: When your HTML5 Has No Class</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2013/recherche/html5" rel="tag">HTML5</a><br /><a href="http://www.paris-web.fr/2013/recherche/javascript" rel="tag">JavaScript</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>

</dl>
</div>
		</aside>
    <div class="talk-description" lang="en"><div lang="en" class="span-6">
<p><strong>CSS3/JS Selectors: When your HTML5 Has No Class</strong></p>
<p>
...
<p><strong>Sélecteurs CSS3/JS : quand HTML5 n’a pas la classe</strong></p>
<p>
Choisissez un élément, n’importe lequel. Stylez-le. Manipulez-le. Aucune ID. Aucune classe. Pas de jQuery. Nous verrons les nouvelles fonctionnalités des sélecteurs de CSS et JavaScript, qui vous permettent de sélectionner tel nœud du DOM, tel autre nœud du DOM, et même ce nœud imaginaire du DOM, en fonction des attributs, des relations avec les autres éléments, de la position dans le DOM, ou juste la simple existence de l’élément. Les possibilités sont infinies, si vous savez comment utiliser le contenu de votre boite à outils. L’outil du moment, ce sont les sélecteurs CSS3 (et JavaScript)
</p>
</div>
<div class="box clear">
<p class="last"><abbr lang="la" title="Nota-Bene">NB</abbr> : cet atelier sera animé en anglais.</p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/estelle-weyl.php">Estelle Weyl</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Estelle Weyl" src="https://www.paris-web.fr/2013/assets_c/2013/06/estelle-weyl-thumb-143x143-317.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p>
Estelle Weyl started her professional life in architecture and then managed teen health programs. In 2000, she took the natural step of becoming a web standardista. 
</p>
<p>
She has consulted for Kodakgallery, SurveyMonkey, Yahoo!, Apple, and many others. Estelle provides tutorials and detailed grids for CSS3 and HTML5 browser support in her blog (http://standardista.com). 
</p>
<p>
She is the author of “Mobile HTML5″ (O’Reilly, July. 2013), “HTML5: The Definitive Guide” (O’Reilly, Dec. 2013) and “HTML5 and CSS3 for the Real World” (Sitepoint, 2011). She also contributed to the “Web Performance Daybook Vol. 2.”
</p>
</div>
<div lang="fr" class="span-6 last">
<p>
Estelle Weyl a commencé sa carrière professionnelle dans le milieu de l'architecture, avant de s'occuper de programmes pour la santé des adolescents. En l'an 2000, elle est naturellement devenue un aficionado de standards du Web. 
</p>
<p>
Elle a travaillé comme consultante pour Kodakgallery, SurveyMonkey, Yahoo!, Apple et de nombreux autres. Estelle créé des tutoriels et des grilles détaillées de la reconnaissance de CSS3 et HTML5 sur les principaux navigateurs, sur son blog (http://standardista.com). 
</p>
<p>
Elle est l'auteur de "Mobile HTML5" (O'Reilly, juillet 2013, "HTML: The Definitive Guide" (O'Reilly, décembre 2013) et "HTML5 et CSS3 for the Real World" (Sitepoint, 2011). Elle a également contribué au livre "Web Performance Daybook Vol. 2".</p>
</div></div>
</div>
