...
<title>Paris Web - Web Apps et sites web, le jeu des différences</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/impactful-user-experience-strategy.php" title="Impactful User Experience Strategy" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/changement-de-salle-1.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Web Apps et sites web, le jeu des différences" />
	<meta property="twitter:description" content="Les récentes évolutions de HTML, CSS et JavaScript nous conduise vers un univers que l'on qualifie d'applicatif. De nouveau groupes de travail au W3C ont d’ailleurs des noms évocateurs : System…" />
	<meta property="dc:title" content="Web Apps et sites web, le jeu des différences" />
	<meta property="og:title" content="Web Apps et sites web, le jeu des différences" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/web-apps-et-sites-web-le-jeux-des-differences.php" />
	<meta property="og:description" content="Les récentes évolutions de HTML, CSS et JavaScript nous conduise vers un univers que l'on qualifie d'applicatif. De nouveau groupes de travail au W3C ont d’ailleurs des noms évocateurs : System…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Web Apps et sites web, le jeu des différences</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1136">
						<header>
							<h1>Web Apps et sites web, le jeu des différences</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83910159" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/websites.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1136">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/web-apps-et-sites-web-le-jeux-des-differences.php" class="url">Web Apps et sites web, le jeu des différences</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/web-apps" rel="tag">web apps</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/jeremie-patonnier.php">Jérémie Patonnier</a></h2>
