...
<title>Paris Web - Des modèles de conceptions pour vos composants d'interface grâce à ARIA</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/construire-pour-le-futur.php" title="Construire pour le futur" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/redesign-dans-le-navigateur-et-pourquoi-pas.php" title="Redesign dans le navigateur ? Et pourquoi pas !" />
	...
	<meta name="twitter:title" content="Des modèles de conceptions pour vos composants d'interface grâce à…" />
	<meta property="twitter:description" content="Au cours de cet atelier, après un rapide tour d'horizon des grands types de composants d'interfaces existants et notamment ceux définis dans la spécification ARIA, nous étudierons en détail deux ou…" />
	<meta property="dc:title" content="Des modèles de conceptions pour vos composants d'interface grâce à ARIA" />
	<meta property="og:title" content="Des modèles de conceptions pour vos composants d'interface grâce à ARIA" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/des-modeles-de-conceptions-pour-vos-composants-dinterface-grace-a-aria.php" />
	<meta property="og:description" content="Au cours de cet atelier, après un rapide tour d'horizon des grands types de composants d'interfaces existants et notamment ceux définis dans la spécification ARIA, nous étudierons en détail deux ou…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Des modèles de conceptions pour vos composants d'interface grâce à ARIA</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1091">
						<header>
							<h1>Des modèles de conceptions pour vos composants d'interface grâce à ARIA</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1091">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/des-modeles-de-conceptions-pour-vos-composants-dinterface-grace-a-aria.php" class="url">Des modèles de conceptions pour vos composants d'interface grâce à ARIA</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/accessibilite" rel="tag">accessibilité</a></dd>
    ...
    <div class="talk-description"><p>Au cours de cet atelier, après un rapide tour d'horizon des grands types de composants d'interfaces existants et notamment <a href="http://www.w3.org/TR/wai-aria-practices/#aria_ex">ceux définis dans la spécification ARIA</a>, nous étudierons en détail deux ou trois grands composants, de leur sémantique de codage à leur enrichissement ARIA en passant par leur fonctionnement au clavier. Enfin, pour chacun de ces composants nous partirons à la quête du Saint-Graal&nbsp;: des solutions toutes faites déjà correctement codées ou, à défaut, que nous essayerons de corriger.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/aurelien-levy.php">Aurélien Levy</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Aurélien Levy" src="https://www.paris-web.fr/2013/assets_c/2013/08/aurelien_levy-thumb-143x143-354.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après une formation initiale de graphiste, Aurélien a complété ses connaissances par une formation de concepteur réalisateur multimédia à l’Institut d’Études Supérieures des Arts. En janvier 2004, il devient l’un des premiers "experts Accessiweb en évaluation". En 2008 il devient expert accessibilité pour le compte de la société Temesis avant d'en devenir le directeur général fin 2011.</p>

<p>Il a notamment co-rédigé le nouveau Référentiel Général d’Accessibilité pour les Administrations de la DGME dans le cadre du décret de la loi Handicap (février 2005) et animé plusieurs conférences dans le domaine de l’accessibilité (INOP, RMLL, Paris-web, CSUN, Confoo, TechDays... ). Il a contribué à la prise en compte de l’accessibilité dans des groupes comme La Poste, Science Po, Groupama ou diverses administrations comme la Présidence de la République, la DILA ou le ministère de la santé.</p></div>
</div>
