...
<title>Paris Web - Livre Électronique et Standards du Web</title>
...
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/penser-lexperience-utilisateur-mobile.php" title="Penser l'expérience utilisateur mobile" />
	...
	<meta name="twitter:title" content="Livre Électronique et Standards du Web" />
	<meta property="twitter:description" content="Le Livre Électronique est probablement le plus gros consommateur de Standards du Web actuel hors du Web lui-même. Les points de convergence entre notre moyen d'expression préféré et les eBooks sont…" />
	<meta property="dc:title" content="Livre Électronique et Standards du Web" />
	<meta property="og:title" content="Livre Électronique et Standards du Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/livre-electronique-et-standards-du-web.php" />
	<meta property="og:description" content="Le Livre Électronique est probablement le plus gros consommateur de Standards du Web actuel hors du Web lui-même. Les points de convergence entre notre moyen d'expression préféré et les eBooks sont…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Livre Électronique et Standards du Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1104">
						<header>
							<h1>Livre Électronique et Standards du Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83484921" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1104">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/livre-electronique-et-standards-du-web.php" class="url">Livre Électronique et Standards du Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/livres-numerique" rel="tag">livres numérique</a><br /><a href="http://www.paris-web.fr/2013/recherche/standards" rel="tag">standards</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Le Livre Électronique est probablement le plus gros consommateur de Standards du Web actuel hors du Web lui-même. Les points de convergence entre notre moyen d'expression préféré et les eBooks sont nombreux mais les points de divergence également.<br />
Quels sont les apports du Livre Électronique dans HTML, les CSS, les autres langages ? Quels sont les spécifications du W3C qui doivent impérativement progresser pour aider le Livre Électronique ? Pouvez-vous transformer une collection de documents Web en Livre Électronique en moins que temps que Tristan Nitot en a besoin pour passer son fameux tutu rose ?<br />
Comment le W3C et l'IDPF, le consortium chargé d'EPUB, travaillent-ils ensemble ? Le Livre Électronique et le Web évoluent-ils à la même vitesse ?</p>

<p>Bref, tout ce que vous avez voulu savoir sur les dessous Web du Livre Électronique sans jamais oser le demander.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/daniel-glazman.php">Daniel Glazman</a></h2>
