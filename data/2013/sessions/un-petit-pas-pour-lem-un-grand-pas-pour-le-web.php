...
<title>Paris Web - Un petit pas pour l'em, un grand pas pour le Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/jquery-sans-jquery.php" title="jQuery sans jQuery" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/p.php" title="Pause" />
	...
	<meta name="twitter:title" content="Un petit pas pour l'em, un grand pas pour le Web" />
	<meta property="twitter:description" content="Aujourd'hui, je parcours le Web principalement sur mon ordinateur portable, très souvent sur mon smartphone, parfois sur ma tablette et ma TV, et plutôt exceptionnellement sur ma liseuse. Ces…" />
	<meta property="dc:title" content="Un petit pas pour l'em, un grand pas pour le Web" />
	<meta property="og:title" content="Un petit pas pour l'em, un grand pas pour le Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/un-petit-pas-pour-lem-un-grand-pas-pour-le-web.php" />
	<meta property="og:description" content="Aujourd'hui, je parcours le Web principalement sur mon ordinateur portable, très souvent sur mon smartphone, parfois sur ma tablette et ma TV, et plutôt exceptionnellement sur ma liseuse. Ces…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Un petit pas pour l'em, un grand pas pour le Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1117">
						<header>
							<h1>Un petit pas pour l'em, un grand pas pour le Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/79204119" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/parisweb2013-unpetitpaspourlemungrandpaspourleweb-131010101006-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/slides-unpetitpaspourlemungrandpaspourleweb.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1117">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/un-petit-pas-pour-lem-un-grand-pas-pour-le-web.php" class="url">Un petit pas pour l'em, un grand pas pour le Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2013/recherche/responsive-design" rel="tag">responsive design</a></dd>
...
<p>L'objectif de cette conférence est d'illustrer les avantages et inconvénients d'une telle intégration complètement élastique, en espérant convaincre que les uns l'emportent suffisamment sur les autres pour améliorer notre pratique de l'intégration Web.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/nicolas-hoizey.php">Nicolas Hoizey</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Nicolas Hoizey" src="https://www.paris-web.fr/2013/assets_c/2013/06/nicolas-hoizey-thumb-143x143-341.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Tombé dans le Web aux alentours de 1996</p>

<p>Nicolas Hoizey est co-fondateur et directeur de l'innovation de Clever Age, une société de services qui se positionne sur l'ensemble de la chaine de production Web et mobile depuis plus de 10 ans.</p>

<p>S’appuyant sur 15 ans d’expérience du Web, Nicolas prône un usage pragmatique des technologies du Web, appliquant pour cela les bonnes pratiques, techniques et méthodologiques, sur les standards, l'ergonomie et l'accessibilité, la performance, la capitalisation, etc.</p>

<p>Il intervient en clientèle, chez de nombreux grands comptes et administrations, pour des missions de conseil, direction de projet et expertise, participe à la veille technologique de Clever Age, et intervient régulièrement dans des conférences (Gartner, 01 Séminaires, Benchmark Group, Microsoft TechDays, intra entreprise).<br />
</p></div>
</div>
