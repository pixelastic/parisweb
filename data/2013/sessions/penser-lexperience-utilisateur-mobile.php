...
<title>Paris Web - Penser l'expérience utilisateur mobile</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/livre-electronique-et-standards-du-web.php" title="Livre Électronique et Standards du Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/guide-de-survie-en-milieu-responsive.php" title="Guide de survie en milieu responsive" />
	...
	<meta name="twitter:title" content="Penser l'expérience utilisateur mobile" />
	<meta property="twitter:description" content="Comment penser une interaction homme-machine par essence dégradée? Qui n’existe que dans le mouvement, la rupture, l’attente? Les écrans et leurs contextes d’utilisation nous forcent à modifier nos…" />
	<meta property="dc:title" content="Penser l'expérience utilisateur mobile" />
	<meta property="og:title" content="Penser l'expérience utilisateur mobile" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/penser-lexperience-utilisateur-mobile.php" />
	<meta property="og:description" content="Comment penser une interaction homme-machine par essence dégradée? Qui n’existe que dans le mouvement, la rupture, l’attente? Les écrans et leurs contextes d’utilisation nous forcent à modifier nos…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Penser l'expérience utilisateur mobile</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1110">
						<header>
							<h1>Penser l'expérience utilisateur mobile</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83920405" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/pw2013-penser-ux-mobile-aboucher-131011102932-phpapp01.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1110">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/penser-lexperience-utilisateur-mobile.php" class="url">Penser l'expérience utilisateur mobile</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/ux" rel="tag">UX</a><br /><a href="http://www.paris-web.fr/2013/recherche/web-mobile" rel="tag">web mobile</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Comment penser une interaction homme-machine par essence dégradée? Qui n’existe que dans le mouvement, la rupture, l’attente?</p>

<p>Les écrans et leurs contextes d’utilisation nous forcent à modifier nos réflexes de conception pour être au plus proche des besoins et usages réels. Pour y parvenir, et en décortiquant les contraintes inhérentes à la mobilité et à ses supports, nous verrons ensemble à quoi particulièrement s’attacher lorsque l’on conçoit une expérience utilisateur mobile.<br />
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/amelie-boucher.php">Amélie Boucher</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Amélie Boucher" src="https://www.paris-web.fr/2013/assets_c/2013/06/amelie-boucher-thumb-143x143-322.png" width="143" height="143">

            
        </span>
<div class="speaker-bio">Amélie Boucher est consultante en Ergonomie, Architecture de l’information et UX Design.

Diplômée du Master d’Ergonomie de l’Université René Descartes (Paris 5), elle lance en 2003 le site éditorial <a href="http://www.ergolab.net">www.ergolab.net</a>. Toujours dans cette volonté de faire partager l’essence et la pratique de cette discipline, elle écrit le livre Ergonomie Web et son mémento, puis un ouvrage consacré à des études de cas (Ergonomie web illustrée), le tout aux Editions Eyrolles.</div>
</div>
