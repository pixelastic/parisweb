...
<title>Paris Web - Goûts et mauvais goût : de la subjectivité en design</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/learning-to-love-crash-course-in-emotional-ux-design.php" title="Learning to love: Crash course in emotional UX design" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ch.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Goûts et mauvais goût : de la subjectivité en design" />
	<meta property="twitter:description" content=" Découvrez pourquoi certains design sont haïs par le monde entier et pourquoi la femme de votre boss aime le violet-marron. Ça dépend des goûts, cette phrase rendrait fou n'importe quel designer,…" />
	<meta property="dc:title" content="Goûts et mauvais goût : de la subjectivité en design" />
	<meta property="og:title" content="Goûts et mauvais goût : de la subjectivité en design" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/gouts-et-mauvais-gout-de-la-subjectivite-en-design.php" />
	<meta property="og:description" content=" Découvrez pourquoi certains design sont haïs par le monde entier et pourquoi la femme de votre boss aime le violet-marron. Ça dépend des goûts, cette phrase rendrait fou n'importe quel designer,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Goûts et mauvais goût : de la subjectivité en design</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1118">
						<header>
							<h1>Goûts et mauvais goût : de la subjectivité en design</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/80974472" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://paris-web.fr/2013/design-et-subjectivite-web.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1118">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/gouts-et-mauvais-gout-de-la-subjectivite-en-design.php" class="url">Goûts et mauvais goût : de la subjectivité en design</a></span></span></h2>
...
<strong>Découvrez pourquoi certains design sont haïs par le monde entier et pourquoi la femme de votre boss aime le violet-marron.</strong>
</p>
<p>
<q>"Ça dépend des goûts"</q>, cette phrase rendrait fou n'importe quel designer, tellement elle nous plonge dans un abîme où l'argumentation n'a plus de prise. En effet, les designers aiment à penser qu'un bon design n'est pas une affaire de goûts. Un design répond à des objectifs précis, on peut donc analyser objectivement ses qualités. Le subjectif n'aurait rien à voir la dedans. Vraiment&nbsp;? Pourtant il arrive régulièrement que des designs soient décriés pour leur laideur par toute la communauté des designers. On ne reproche pas à ces réalisations des erreurs fonctionnelles (un manque d'ergonomie, une typo illisible ou des contrastes mal équilibrés), on dit juste que c'est affreusement laid. Alors est-ce que le mauvais goût existe réellement&nbsp;? Et si c'est le cas, comment éviter que notre site ne devienne la prochaine risée d'Internet&nbsp;? Pas de panique, nous tenterons d'y répondre à l'aide d'une Comic Sans.
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/jean-philippe-cabaroc.php">Jean-Philippe Cabaroc</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jean-Philippe Cabaroc" src="https://www.paris-web.fr/2013/assets_c/2013/06/jean-philippe-cabaroc-thumb-143x143-326.png" width="143" height="143">
...
<p>
Il tweet ses trouvailles sur Twitter sous le nom de <a href="https://twitter.com/Cabaroc">@cabaroc</a> <br>
et écrit ses réflexions professionnelles sur <a href="http://cabaroc.com/" title="son blog (Jean-Philippe Cabaroc)">son blog</a>.
</p></div>
</div>
