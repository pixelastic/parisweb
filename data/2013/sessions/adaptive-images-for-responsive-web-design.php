...
<title>Paris Web - Adaptive Images for Responsive Web Design</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/accueil-des-participants.php" title="Accueil des participants" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/le-web-apres-les-mots-de-passe.php" title="Le web après les mots de passe" />
	...
	<meta name="twitter:title" content="Adaptive Images for Responsive Web Design" />
	<meta property="twitter:description" content=" Adaptive Images for Responsive Web Design The open web doesn't stop at our desktop. Smart phones and tablets not only contain more computing power and better browsers than the computers that started…" />
	<meta property="dc:title" content="Adaptive Images for Responsive Web Design" />
	<meta property="og:title" content="Adaptive Images for Responsive Web Design" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/adaptive-images-for-responsive-web-design.php" />
	<meta property="og:description" content=" Adaptive Images for Responsive Web Design The open web doesn't stop at our desktop. Smart phones and tablets not only contain more computing power and better browsers than the computers that started…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Adaptive Images for Responsive Web Design</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1106">
						<header>
							<h1>Adaptive Images for Responsive Web Design</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/81314506" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1106">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/adaptive-images-for-responsive-web-design.php" class="url">Adaptive Images for Responsive Web Design</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/images" rel="tag">images</a><br /><a href="http://www.paris-web.fr/2013/recherche/responsive-design" rel="tag">responsive design</a></dd>
...
<p><strong>Adaptive Images for Responsive Web Design</strong></p>
<p>The open web doesn't stop at our desktop. Smart phones and tablets not only contain more computing power and better browsers than the computers that started the Internet economy, they have better displays. In this session presented by Christopher Schmitt, we will work through tips and tricks to develop future friendly images in our sites and apps:</p>
<ul>
<li>Icon fonts in a breeze and accessibility</li>
...
<p><strong>Des images qui s'adaptent à un design responsif</strong></p>
<p>Le web ouvert ne s'arrête pas à nos ordinateurs de bureau. Non seulement les téléphones et tablettes disposent de plus de puissance et de meilleurs navigateurs que les ordinateurs qui ont lancé l'économie en ligne, mais ils disposent en plus de meilleurs écrans. Lors de cette session présentée par Christopher Schmitt, nous verrons les trucs et astuces qui permettent de mettre en place des images pérennes pour nos sites et applications :</p>
<ul>
<li>Utiliser des polices d'icônes simplement pour plus d'accessibilité</li>
<li>Mettre en place des icônes et favoris mobiles</li>
<li>Utiliser SVG pour améliorer les performances</li>
<li>Le retour en grâce du format d'image JPEG</li>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/christopher-schmitt.php">Christopher Schmitt</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Christopher Schmitt" src="https://www.paris-web.fr/2013/assets_c/2013/06/christopher-schmitt-thumb-143x143-323.png" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p>Christopher is the founder of Heatvision.com, Inc., an Austin-based new media publishing and design firm, and co-founder of Environments for Humans, a leader in web and mobile conferences. </p>
<p>An award-winning web designer who has been working in the medium for twenty years, Christopher interned for both David Siegel and Lynda Weinman as an undergraduate at Florida State University.</p>
<p>He has a Masters in Communication for Interactive and New Communication Technologies, and is the author of six books, Including Designing Web & Mobile Graphics and CSS Cookbook, the latter was named Best Web Design Book of 2006.</p>
</div>
<div lang="fr" class="span-6 last">
<p>Christophe est le fondateur de Heatvision, Inc, une société de conception et publication dans le domaine des nouveaux média basée à Austin, et cofondateur de Environments for Humans, l'une des principales conférences sur le web et le mobile. </p>
<p>Designer web ayant remporté plusieurs prix au cours de ses vingt années de métier, Christophe a été stagiaire tant pour David Siegel que pour Lynda Weinman tandis qu'il étudiait à l'université de Floride.</p>
<p>Il a une Maîtrise en Communication pour les Nouvelles Technologies de l'Information et l'Interactivité, et est l'auteur de six livres, dont "Designing Web & Mobile Graphics" et le "CSS Cookbook", ce dernier ayant nommé Meilleur Livre de Web Design de 2006.</p>
</div></div>
</div>
