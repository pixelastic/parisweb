...
<title>Paris Web - Je code donc je teste …</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/conf-sponsor-le-retour-sur-investissement-des-demarches-qualite-web.php" title="[Conf Sponsor] Le retour sur investissement de la qualité web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/pause.php" title="Pause" />
	...
	<meta name="twitter:title" content="Je code donc je teste …" />
	<meta property="twitter:description" content="La notion de test est complètement intégrée dans le monde professionnel (R&D, panel d'utilisateurs, concept car) et plus particulièrement dans l’informatique. Historiquement, le front a longtemps été…" />
	<meta property="dc:title" content="Je code donc je teste …" />
	<meta property="og:title" content="Je code donc je teste …" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/-je-code-donc-je-teste.php" />
	<meta property="og:description" content="La notion de test est complètement intégrée dans le monde professionnel (R&D, panel d'utilisateurs, concept car) et plus particulièrement dans l’informatique. Historiquement, le front a longtemps été…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Je code donc je teste …</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1129">
						<header>
							<h1>Je code donc je teste …</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/77859376" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/je-code-donc-je-teste.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1129">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/-je-code-donc-je-teste.php" class="url">Je code donc je teste …</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>La notion de test est complètement intégrée dans le monde professionnel (R&D, panel d'utilisateurs, concept car) et plus particulièrement dans l’informatique.<br />
Historiquement, le front a longtemps été le parent pauvre du test. Passons sur les illustres « alert » et « console.log », il aura fallu attendre des outils comme Selenium pour professionnaliser la démarche.  <br />
Aujourd’hui les solutions sont abouties, complètes et utilisables et il y en a pour tous les goûts. Des tests unitaires, des tests d’intégrations en passant par les tests fonctionnels, les tests de compatibilités, les tests end2end…</p>

<p>C’est parti… Voyons ensemble la meilleure façon de les exploiter.</p>

<p>Nous avons les outils, nous n’avons plus d’excuses.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/cyril-balit.php">Cyril Balit</a></h2>
