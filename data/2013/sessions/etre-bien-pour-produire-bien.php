...
<title>Paris Web - Être bien pour produire bien</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/p.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/impactful-user-experience-strategy.php" title="Impactful User Experience Strategy" />
	...
	<meta name="twitter:title" content="Être bien pour produire bien" />
	<meta property="twitter:description" content="Quel lien peut-on raisonnablement faire entre le bien-être du travailleur et la qualité de ce qu’il produit ? Comment mesurer le bien-être d’un collaborateur ? Comment l’améliorer et mesurer l’impact…" />
	<meta property="dc:title" content="Être bien pour produire bien" />
	<meta property="og:title" content="Être bien pour produire bien" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/etre-bien-pour-produire-bien.php" />
	<meta property="og:description" content="Quel lien peut-on raisonnablement faire entre le bien-être du travailleur et la qualité de ce qu’il produit ? Comment mesurer le bien-être d’un collaborateur ? Comment l’améliorer et mesurer l’impact…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Être bien pour produire bien</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1134">
						<header>
							<h1>Être bien pour produire bien</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/80349437" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/etrebienpourproduirebienpw2013diffusion-131013040941-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://paris-web.fr/2013/etrebienpourproduirebienpw2013diffusion-131013040941-phpapp01.pptx" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1134">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/etre-bien-pour-produire-bien.php" class="url">Être bien pour produire bien</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Quel lien peut-on raisonnablement faire entre le bien-être du travailleur et la qualité de ce qu’il produit ? Comment mesurer le bien-être d’un collaborateur ? Comment l’améliorer et mesurer l’impact de ces améliorations ? <br />
C’est donc de l’humain et de son influence sur la qualité produite qu’il sera question.</p>

<p>Vous pouvez apporter de la matière à la conférence en remplissant le sondage <a href="http://pw2013.nissone.com/">Bien-être et qualité du travail</a>.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/delphine-malassingne.php">Delphine Malassingne</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Delphine Malassingne" src="https://www.paris-web.fr/2013/assets_c/2013/07/delphine-malassingne-thumb-143x143-346.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Delphine Malassingne est Responsable qualité chez Ekino. Elle y accompagne les équipes dans la production de livrables de qualité mais aussi dans la façon de produire. Son enthousiasme pour le partage de connaissance l’ont amené en parallèle à participer à des projets communautaires (w3qualité, Opquast Checklists, Paris Web, notamment).<br />
Elle essaye en parallèle “d’avoir une vie” en dessinant un peu, en calligraphiant et a même réussi à aligner trois points de couture !</p></div>
</div>
