...
<title>Paris Web - Rendre son application HTML5 accessible en 4 étapes</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/les-outils-pour-developpeurs-inclus-dans-les-navigateurs-web.php" title="Les outils pour développeurs inclus dans les navigateurs Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/venez-avec-votre-site-et-testons-le.php" title="Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos ergonomes (3 heures)" />
	...
	<meta name="twitter:title" content="Rendre son application HTML5 accessible en 4 étapes" />
	<meta property="twitter:description" content="Le HTML5 est la nouvelle frontière du Web&nbsp;: porteur de toutes les promesses, de toutes les incertitudes aussi... Celle de l’accessibilité fait partie des plus prégnantes: dans cette profusion de…" />
	<meta property="dc:title" content="Rendre son application HTML5 accessible en 4 étapes" />
	<meta property="og:title" content="Rendre son application HTML5 accessible en 4 étapes" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/rendre-son-application-html5-accessible-en-4-etapes.php" />
	<meta property="og:description" content="Le HTML5 est la nouvelle frontière du Web&nbsp;: porteur de toutes les promesses, de toutes les incertitudes aussi... Celle de l’accessibilité fait partie des plus prégnantes: dans cette profusion de…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Rendre son application HTML5 accessible en 4 étapes</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1092">
						<header>
							<h1>Rendre son application HTML5 accessible en 4 étapes</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1092">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/rendre-son-application-html5-accessible-en-4-etapes.php" class="url">Rendre son application HTML5 accessible en 4 étapes</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2013/recherche/html5" rel="tag">HTML5</a></dd>
    ...
    <div class="talk-description"><p>Le HTML5 est la nouvelle frontière du Web&nbsp;: porteur de toutes les promesses, de toutes les incertitudes aussi... Celle de l’accessibilité fait partie des plus prégnantes: dans cette profusion de nouvelles fonctionnalités, qu’est-ce qui marche&nbsp;? Par quoi commencer&nbsp;? Comment vérifier&nbsp;?</p>

<p>En partant d’une application existante, la présentation montrera comment passer du HTML4 au HTML5 complété par ARIA, en respectant les bonnes pratiques d’accessibilité&nbsp;:<br />
<ol><br />
<li>Définir les structures</li><br />
<li>Préciser les rôles</li><br />
<li>Attribuer les propriétés</li><br />
<li>Définir les interactions</li><br />
</ol><br />
À chaque étape, les effets de l’introduction du nouveau code seront vérifiés via des tests avec des technologies d’assistance. Le caractère très mouvant du HTML5 et la variabilité de son support dans les agents utilisateurs ne nous facilitant pas la tâche, les principaux pièges, et leurs solutions, seront décrits.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/jean-pierre-villain.php">Jean-Pierre Villain</a></h2>
...
<div class="speaker-bio"><p>Associé fondateur de Qelios, Jean-Pierre Villain bénéficie de près de 15 ans d'expérience dans les technologies et les langages normalisés par le W3C&nbsp;; <abbr title="Web Content Accessibility Guidelines" lang="en">WCAG</abbr> / XHTML et CSS, notamment. Spécialiste reconnu, il développe, dès 2000, une expertise en matière d'Accessibilité du Web.</p>

<p>Principal rédacteur du référentiel AccessiWeb, depuis la version 1.1 jusqu'à la version HTML5, via un partenariat avec BrailleNet, il est également le formateur des Experts AccessiWeb en Évaluation depuis 2007.</p></div>
</div>
