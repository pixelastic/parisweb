...
<title>Paris Web - [Atelier Sponsor] SEO, SMO et Social CRM les meilleures pratiques</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/venez-avec-votre-site-et-testons-le.php" title="Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos ergonomes (3 heures)" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/pause-3.php" title="Pause" />
	...
	<meta name="twitter:title" content="[Atelier Sponsor] SEO, SMO et Social CRM les meilleures pratiques" />
	<meta property="twitter:description" content="Être présent sur le web est un enjeu incontournable pour les entreprises qui souhaitent attirer des consommateurs hyper connectés via les moteurs de recherche et pléthore de réseaux sociaux. Dans ce…" />
	<meta property="dc:title" content="[Atelier Sponsor] SEO, SMO et Social CRM les meilleures pratiques" />
	<meta property="og:title" content="[Atelier Sponsor] SEO, SMO et Social CRM les meilleures pratiques" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/atelier-sponsor-seo-smo-et-social-crm-les-meilleures-pratiques.php" />
	<meta property="og:description" content="Être présent sur le web est un enjeu incontournable pour les entreprises qui souhaitent attirer des consommateurs hyper connectés via les moteurs de recherche et pléthore de réseaux sociaux. Dans ce…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Atelier Sponsor] SEO, SMO et Social CRM les meilleures pratiques</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1205">
						<header>
							<h1>[Atelier Sponsor] SEO, SMO et Social CRM les meilleures pratiques</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1205">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/atelier-sponsor-seo-smo-et-social-crm-les-meilleures-pratiques.php" class="url">[Atelier Sponsor] SEO, SMO et Social CRM les meilleures pratiques</a></span></span></h2>
...
<abbr title="utc" class="dtstart"><!-- --></abbr>
    ...
    <div class="talk-description"><p>Être présent sur le web est un enjeu incontournable pour les entreprises qui souhaitent attirer des consommateurs hyper connectés via les moteurs de recherche et pléthore de réseaux sociaux.<br />
Dans ce contexte, comment est-il possible pour l'entreprise d'assurer simplement une présence efficace lui permettant d'acquérir des clients&nbsp;? </p>

<p>Comment identifier les meilleurs media sociaux pour communiquer&nbsp;? Quels sont les nouveaux outils que le CRM traditionnel intègre pour devenir Social CRM... </p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/catherine-headley.php">Catherine Headley</a> et <a href="https://www.paris-web.fr/2013/../orateurs/vincent-dutot.php">Vincent Dutot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Catherine Headley" src="https://www.paris-web.fr/2013/assets_c/2013/09/catherine-headley-thumb-143x143-376.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p><span lang="en">Digital Strategist</span> et professeur à l'ESG Management School, elle a 14 ans d'expérience en digital marketing acquise dans la presse web anglo-saxonne ainsi que pour différents acteurs de la net économie. Elle est spécialisé en stratégie d'acquisition online et notamment en SEO.</p>

<p>Co Auteur de la boite à outils du Digital entrepreneur aux éditions Dunod.</p>

<ul>
<li><a href="http://fr.linkedin.com/in/catherineheadley">Profil Linkedin</a></li>
<li><a href="http://twitter.com/catheadley">@catheadley</a></li>
</ul></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Vincent Dutot" src="https://www.paris-web.fr/2013/assets_c/2013/09/vdutot-thumb-143x143-375.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Vincent Dutot est professeur associé en commerce électronique à l’ESG Management School, Paris, France. Il détient un Ph.D de l'Université Laval (Canada) . Ses domaines de recherche sont en social media, stratégie TI, alignement stratégique des technologies de l'information,  la diffusion des connaissances au sein des PME. Il a également travaillé comme consultant TI pour les PME, le gouvernement et dans le secteur privé pendant près de 10 ans.</p>

<p><a href="http://fr.linkedin.com/in/vincentdutot/">Profil Linkedin</a></p></div>
</div>
