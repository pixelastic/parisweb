...
<title>Paris Web - Deux ou trois choses que vous ne savez peut-être pas sur la sécurité de votre site Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ch.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/jquery-sans-jquery.php" title="jQuery sans jQuery" />
	...
	<meta name="twitter:title" content="Deux ou trois choses que vous ne savez peut-être pas sur la sécurité…" />
	<meta property="twitter:description" content="Même si vous n'êtes pas programmeur, vous êtes tous au courant des attaques XSS, CSRF, des injections SQL, etc. Mais, une fois le site Web en place et bien programmé pour éviter ces attaques, il en…" />
	<meta property="dc:title" content="Deux ou trois choses que vous ne savez peut-être pas sur la sécurité de votre site Web" />
	<meta property="og:title" content="Deux ou trois choses que vous ne savez peut-être pas sur la sécurité de votre site Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/deux-ou-trois-choses-que-vous-ne-savez-peut-etre-pas-sur-la-securite-de-votre-site-web.php" />
	<meta property="og:description" content="Même si vous n'êtes pas programmeur, vous êtes tous au courant des attaques XSS, CSRF, des injections SQL, etc. Mais, une fois le site Web en place et bien programmé pour éviter ces attaques, il en…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Deux ou trois choses que vous ne savez peut-être pas sur la sécurité de votre site Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1109">
						<header>
							<h1>Deux ou trois choses que vous ne savez peut-être pas sur la sécurité de votre site Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/77863228" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://paris-web.fr/2013/2-3-choses-securite.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1109">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/deux-ou-trois-choses-que-vous-ne-savez-peut-etre-pas-sur-la-securite-de-votre-site-web.php" class="url">Deux ou trois choses que vous ne savez peut-être pas sur la sécurité de votre site Web</a></span></span></h2>
...
<dd class="column">
15 <abbr title="heures">h</abbr> 15
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/https" rel="tag">HTTPS</a><br /><a href="http://www.paris-web.fr/2013/recherche/securite" rel="tag">sécurité</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Même si vous n'êtes pas programmeur, vous êtes tous au courant des attaques XSS, CSRF, des injections SQL, etc. Mais, une fois le site Web en place et bien programmé pour éviter ces attaques, il en reste d'autres que vous n'avez peut-être pas évaluées. Après un rappel comme quoi les attaques les plus simples sont souvent les meilleures, je parlerai :<br />
<ul><br />
<li>des attaques par déni de service, aussi bien volumétriques (force brute) que plus subtiles. C'est typiquement à votre hébergeur et à l'opérateur réseau de s'en occuper. Mais il est bon d'être au courant de ce qu'ils font.</li><br />
<li>des dangers spécifiques au DNS : vous croyez que votre nom de domaine www.jesuisleplusbeau.example mène forcément sur votre site ?<br />
Pas toujours, grâce aux attaques par empoisonnement DNS. Vous verrez pourquoi il faut demander DNSSEC à votre hébergeur.</li><br />
<li>des subtilités de HTTPS : le petit cadenas vous protège ? Vraiment ?<br />
Depuis le succès de l'opération Tulipe Noire, on ne peut plus croire les autorités de certification. Y a-t-il d'autres pistes ?</li><br />
</ul></p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/stephane-bortzmeyer.php">Stéphane Bortzmeyer</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Bortzmeyer" src="https://www.paris-web.fr/2013/assets_c/2013/08/stephane_bortzmeyer-thumb-143x143-365.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Stéphane Bortzmeyer est ingénieur R&D à l'AFNIC (Association Française pour le Nommage Internet en Coopération, registre des noms de domaines en .FR). Il s'occupe entre autre de sécurité, notamment du DNS. Sa spécialité n'est pas le Web mais il y connait quand même deux ou trois choses.</p>

<p>Avant l'AFNIC, il a travaillé chez des acteurs Internet très divers, de la web agency au centre de recherche.</p>

<p>Il tient un blog sur les réseaux, l'informatique, les normes, en <a href="http://www.bortzmeyer.org/">http://www.bortzmeyer.org/</a></p></div>
</div>
