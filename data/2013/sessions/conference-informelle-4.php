...
<title>Paris Web - Conférence informelle</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/utilisez-le-gpu-pour-ameliorer-la-performance-de-vos-applications-web.php" title="[Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos applications Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/les-methodes-dinfluence-dans-le-web-par-lexemple.php" title="Les méthodes d’influence dans le web par l’exemple" />
	...
	<meta name="twitter:title" content="Conférence informelle" />
	<meta property="twitter:description" content="Cette année, sur plusieurs créneaux, le petit auditorium sera réservé aux auditeurs et orateurs qui pourront alors compléter le programme de Paris Web avec des interventions de leur choix. Profitez…" />
	<meta property="dc:title" content="Conférence informelle" />
	<meta property="og:title" content="Conférence informelle" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/conference-informelle-4.php" />
	<meta property="og:description" content="Cette année, sur plusieurs créneaux, le petit auditorium sera réservé aux auditeurs et orateurs qui pourront alors compléter le programme de Paris Web avec des interventions de leur choix. Profitez…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Conférence informelle</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1193">
						<header>
							<h1>Conférence informelle</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1193">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/conference-informelle-4.php" class="url">Conférence informelle</a></span></span></h2>
...
30 <abbr title="minutes">mn</abbr>
    ...
    <div class="talk-description"><p>Cette année, sur plusieurs créneaux, le petit auditorium sera réservé aux auditeurs et orateurs qui pourront alors compléter le programme de Paris Web avec des interventions de leur choix.</p>

<p>Profitez de ces créneaux pour poursuivre les échanges à propos de la dernière conférence, pour parler d'un sujet qui n'est pas abordé dans le programme, pour terminer un débat initié à la pause déjeuner et l'élargir aux autres auditeurs, etc.</p>

<p>Plus d'informations sur ce format et son organisation sur place, pendant l'événement.</p></div>
	</section>
