...
<title>Paris Web - &quot;Accessibiliser&quot; avec subtilité</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/changement-de-s.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/les-7-preceptes-dun-projet-web-rate.php" title="Les 7 préceptes d'un projet web raté !" />
	...
	<meta name="twitter:title" content="Accessibiliser avec subtilité" />
	<meta property="twitter:description" content="Aujourd'hui encore, beaucoup estiment que l'accessibilité ne fait que brider la créativité et appauvrir les designs. D'autres la résument à une multitude d'exigences techniques complexes et…" />
	<meta property="dc:title" content="Accessibiliser avec subtilité" />
	<meta property="og:title" content="Accessibiliser avec subtilité" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/accessibiliser-avec-subtilite.php" />
	<meta property="og:description" content="Aujourd'hui encore, beaucoup estiment que l'accessibilité ne fait que brider la créativité et appauvrir les designs. D'autres la résument à une multitude d'exigences techniques complexes et…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>"Accessibiliser" avec subtilité</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1124">
						<header>
							<h1>"Accessibiliser" avec subtilité</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83912475" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/accesibiliser.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1124">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/accessibiliser-avec-subtilite.php" class="url">"Accessibiliser" avec subtilité</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Aujourd'hui encore, beaucoup estiment que l'accessibilité ne fait que brider la créativité et appauvrir les designs.<br />
D'autres la résument à une multitude d'exigences techniques complexes et chronophages limitant les possibilités d'interactions dans les interfaces.</p>

<p>Pour contribuer à faire tomber ces préjugés, je vous présenterai quelques astuces simples d'accessibilité permettant d'améliorer l'ergonomie et l'expérience d'utilisation de vos interfaces web.<br />
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/johan-ramon.php">Johan Ramon</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Johan Ramon" src="https://www.paris-web.fr/2013/assets_c/2013/06/johan-ramon-thumb-143x143-327.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après plusieurs années en agence Web au poste de développeur front-end puis responsable qualité, Johan rejoint la société <a href="http://www.atalan.fr">Atalan</a> en 2011 et devient consultant en accessibilité numérique.</p>

<p>Il intervient sur des missions d’assistance technique, dans la réalisation d’audits et recettes accessibilité ainsi que dans l’animation des formations techniques proposées par la société.<br />
Il est également corédacteur des notices du projet <a href="http://www.accede-web.com">AcceDe Web</a>.</p></div>
</div>
