...
<title>Paris Web - S.A.R.A.H. maison intelligente pour connecter l'internet des objets</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/pause-dejeuner.php" title="Pause déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/learning-to-love-crash-course-in-emotional-ux-design.php" title="Learning to love: Crash course in emotional UX design" />
	...
	<meta name="twitter:title" content="S.A.R.A.H. maison intelligente pour connecter l'internet des objets" />
	<meta property="twitter:description" content="Un peu de science fiction pour manipuler et faire communiquer l’internet des objets. Durant ces 15 dernières années nous avons vu émerger et se consolider le web, ses API, ses usages autour l’Open…" />
	<meta property="dc:title" content="S.A.R.A.H. maison intelligente pour connecter l'internet des objets" />
	<meta property="og:title" content="S.A.R.A.H. maison intelligente pour connecter l'internet des objets" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/sarah-maison-intelligente-pour-connecter-linternet-des-objets.php" />
	<meta property="og:description" content="Un peu de science fiction pour manipuler et faire communiquer l’internet des objets. Durant ces 15 dernières années nous avons vu émerger et se consolider le web, ses API, ses usages autour l’Open…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>S.A.R.A.H. maison intelligente pour connecter l'internet des objets</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1102">
						<header>
							<h1>S.A.R.A.H. maison intelligente pour connecter l'internet des objets</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/77860190" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/SARAH.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1102">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/sarah-maison-intelligente-pour-connecter-linternet-des-objets.php" class="url">S.A.R.A.H. maison intelligente pour connecter l'internet des objets</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/internet-des-objets" rel="tag">internet des objets</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p><strong>Un peu de science fiction pour manipuler et faire communiquer l’internet des objets.</strong></p>

<p>Durant ces 15 dernières années nous avons vu émerger et se consolider le web, ses API, ses usages autour l’Open Software. Une deuxième vague du web est apparue depuis peu autour de l'internet mobile. Il faut de nouveau normaliser les APIs et Usages.</p>

<p>Maintenant, le réel rencontre le virtuel avec l’Open Hardware&nbsp;: des objets construits comme des LEGOs, connectés et communiquant avec notre vie numérique. Une lame de fond présente depuis 2005 en train d'exploser dans notre quotidien. Mais tout est encore à normaliser...</p>

<p>Comment aborder ce Tsunami ? Quels enjeux ? Quelle est la place du métier du web dans cette aventure&nbsp;? Une avancée aussi pour l'accessibilité&nbsp;?</p>

<p>S.A.R.A.H. est un petit framework, open source, visant à faire communiquer ces objets connectés et à interagir naturellement avec eux dans la maison, au bureau, etc. via de la reconnaissance vocale, gestuelle, faciale, QRCode, NFC...</p>

<p>L’idée n’est pas de proposer une Nième box domotique, mais de combler un manque pour faire communiquer les objets simplement. Et surtout donner accès, aujourd'hui, à ces technos, qui seront les enjeux de demain. Les métiers du web changent constamment...</p>

<p>Le projet :<br />
<a href="http://encausse.net/s-a-r-a-h/">http://encausse.net/s-a-r-a-h/</a></p>

<p>La communauté :<br />
<a href="https://plus.google.com/u/0/communities/105964514508504667709">https://plus.google.com/u/0/communities/105964514508504667709</a></p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/jean-philippe-encausse.php">Jean-Philippe Encausse</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jean-Philippe Encausse" src="https://www.paris-web.fr/2013/assets_c/2013/06/jp-encausse-thumb-143x143-338.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Développeur senior Front et Back End depuis 13ans chez Jalios, éditeur d'une solution Intranet GED, CMS, Portail, Réseau Social, Collaboratif pour PME et grands comptes.</p>

<p>Anime la communauté Front End Dev:<br />
<a href="https://plus.google.com/u/0/communities/111367038232031168926">https://plus.google.com/u/0/communities/111367038232031168926</a></p>

<p>Mais aussi Geek, passionné de nouvelles technologies, web et internet des objets. </p></div>
</div>
