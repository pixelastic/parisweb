...
<title>Paris Web - Tester son JS, c'est possible !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/pause-2.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/apres-la-macro-la-micro.php" title="Après la macro, la micro !" />
	...
	<meta name="twitter:title" content="Tester son JS, c'est possible !" />
	<meta property="twitter:description" content="Si de nombreux développeurs mettent un point d'honneur à tester leur code côté serveur, force est de constater que bien peu ont franchi le cap côté client. On trouve pourtant pléthore d’outils de…" />
	<meta property="dc:title" content="Tester son JS, c'est possible !" />
	<meta property="og:title" content="Tester son JS, c'est possible !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/tester-son-js-cest-possible.php" />
	<meta property="og:description" content="Si de nombreux développeurs mettent un point d'honneur à tester leur code côté serveur, force est de constater que bien peu ont franchi le cap côté client. On trouve pourtant pléthore d’outils de…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Tester son JS, c'est possible !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1085">
						<header>
							<h1>Tester son JS, c'est possible !</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1085">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/tester-son-js-cest-possible.php" class="url">Tester son JS, c'est possible !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/javascript" rel="tag">JavaScript</a><br /><a href="http://www.paris-web.fr/2013/recherche/tests" rel="tag">tests</a></dd>
    ...
    <div class="talk-description"><p>Si de nombreux développeurs mettent un point d'honneur à tester leur code côté serveur, force est de constater que bien peu ont franchi le cap côté client. </p>

<p>On trouve pourtant pléthore d’outils de test en JavaScript, pour tous les goûts (TDD, BDD...) et tous les degrés de test (unitaire, fonctionnel et d’intégration) : nous examinerons entre autre QUnit, Jasmine, Mocha, Chai, CasperJS et Karma. </p>

<p>Mais plus important, vous découvrirez les bonnes pratiques du test JS&nbsp;:<br />
<ul><br />
<li>Comment tester de l'asynchrone ?</li><br />
<li>Tester le DOM</li><br />
<li>Mocks et stubs</li><br />
<li>Le pattern PageObject</li><br />
</ul></p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/raphael-rougeron.php">Raphaël Rougeron</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Rougeron" src="https://www.paris-web.fr/2013/assets_c/2013/07/raphael-rougeron-thumb-143x143-352.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Raphaël Rougeron est responsable technique au sein du groupe Viareport. Expert des technologies web, ses principaux centres d'intérêts sont aujourd'hui Scala et les applications riches (en Javascript&nbsp;!). Il fût également le créateur du framework PHP Stato, et contribue activement à différents projets Open Source.<br />
</p></div>
</div>
