...
<title>Paris Web - Les méthodes d’influence dans le web par l’exemple</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/conference-informelle-4.php" title="Conférence informelle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/pause-dejeuner-1.php" title="Pause déjeuner" />
	...
	<meta name="twitter:title" content="Les méthodes d’influence dans le web par l’exemple" />
	<meta property="twitter:description" content="Nous sommes tous des consommateurs, et sur internet nous consommons tous. Certains acteurs du numérique cherchent par tous les moyens à nous faire agir : acheter, échanger, participer, etc. Les…" />
	<meta property="dc:title" content="Les méthodes d’influence dans le web par l’exemple" />
	<meta property="og:title" content="Les méthodes d’influence dans le web par l’exemple" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/les-methodes-dinfluence-dans-le-web-par-lexemple.php" />
	<meta property="og:description" content="Nous sommes tous des consommateurs, et sur internet nous consommons tous. Certains acteurs du numérique cherchent par tous les moyens à nous faire agir : acheter, échanger, participer, etc. Les…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les méthodes d’influence dans le web par l’exemple</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1128">
						<header>
							<h1>Les méthodes d’influence dans le web par l’exemple</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83618666" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/les-methodes-dinfluence-dans-le-web-par-lexemple.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1128">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/les-methodes-dinfluence-dans-le-web-par-lexemple.php" class="url">Les méthodes d’influence dans le web par l’exemple</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/influence" rel="tag">influence</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/yannick-bonnieux.php">Yannick Bonnieux</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Yannick Bonnieux" src="https://www.paris-web.fr/2013/assets_c/2013/06/Yannick-Bonnieux-thumb-143x143-331.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après un parcours de plus de 10 ans dans le numérique et un Master en management à GOBELINS, l'école de l'image, Yannick a eu l’occasion d'interagir sur de multiples problématiques. Il commence sa carrière comme infographiste avant d'arriver chez Ekino et de devenir UX Designer. Ainsi il ajoute une corde à son arc pour conseiller et intégrer en amont les attentes des utilisateurs, les besoins business et faciliter l’usage dans la conception d'expériences innovantes. Les différents postes qu'il a occupés lui permettent aujourd'hui de travailler plus facilement avec les différents profils de l’agence : graphistes, développeurs, consultants marketing et techniques.</p></div>
</div>
