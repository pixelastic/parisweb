...
<title>Paris Web - Soyez responsables : construisez votre API</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/pause.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/theorie-du-flow-et-webdocumentaires.php" title="Théorie du flow et webdocumentaires" />
	...
	<meta name="twitter:title" content="Soyez responsables : construisez votre API" />
	<meta property="twitter:description" content="L'année 2012 aura été riche en effets d'annonces : la majorité de nos solutions CMS / CMF PHP migrent vers un socle Symfony2 ; les projets utilisent de plus en plus Bootstrap en socle de départ ; les…" />
	<meta property="dc:title" content="Soyez responsables : construisez votre API" />
	<meta property="og:title" content="Soyez responsables : construisez votre API" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/soyez-responsables-construisez-votre-api.php" />
	<meta property="og:description" content="L'année 2012 aura été riche en effets d'annonces : la majorité de nos solutions CMS / CMF PHP migrent vers un socle Symfony2 ; les projets utilisent de plus en plus Bootstrap en socle de départ ; les…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Soyez responsables : construisez votre API</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1113">
						<header>
							<h1>Soyez responsables : construisez votre API</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/80349525" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://paris-web.fr/2013/soyez_responsables__construisez_votre_api.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1113">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/soyez-responsables-construisez-votre-api.php" class="url">Soyez responsables : construisez votre API</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/api" rel="tag">API</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>L'année 2012 aura été riche en effets d'annonces : la majorité de nos solutions CMS / CMF PHP migrent vers un socle Symfony2 ; les projets utilisent de plus en plus Bootstrap en socle de départ ; les intégrations démarrent avec Compass / Susy ou Bourbon par défaut… Cette montée en puissance d'un leader dans chaque domaine est préoccupante dans une dynamique open-source : elle vient à l'encontre de la diversité de l'écosystème, et fragilise l'ensemble en appuyant tout sur un socle commun.</p>

<p>Pourtant, à l'usage au quotidien, on peste souvent après ces outils : pourquoi telle méthode fonctionne-t-elle ainsi ? Pourquoi mon rythme vertical n'est pas bon avec cette grille de base ? Pourquoi telle interface n'est-elle pas disponible ? C'est le problème quand on s'appuie aveuglément sur des solutions communément admises. On se retrouve à les tordre pour les faire entrer dans nos contraintes et à se battre contre elles au lieu de les utiliser.</p>

<p>Le web est riche de sa diversité. Il faut rester curieux, attentif, et ne pas s'engouffrer dans des solutions par effet de mode. Aucun outil n'est universel et il n'y a aucune raison de démarrer un projet avec telle ou telle solution par défaut. Chaque projet a ses spécificités qui le rendent unique.</p>

<p>Pour bien utiliser, il faut bien comprendre. Pour bien comprendre, il faut expérimenter. Soyez responsables, construisez vos propres outils, vos propres API pour correctement appréhender les rouages internes, et être à même de choisir une solution non-pas parce qu'elle est utilisée sur 70% des projets, mais parce qu'elle est adaptée à 100% à votre besoin.</p>

<p>Nous verrons au cours de cette conférence comment construire intelligemment un outil, une architecture capable de répondre à des besoins donnés, pour avoir le choix de l'outil et éviter de s'enfermer dans des automatismes néfastes.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/matthias-dugue.php">Matthias Dugué</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Matthias Dugué" src="https://www.paris-web.fr/2013/assets_c/2013/06/matthias.dugue-thumb-143x143-313.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Éleveur de poneys de combats depuis 1996 et dresseur de Licornes depuis 2006, MAD consacre du temps, de l'énergie et une passion sans faille à la magie du Web. Consultant Développeur aujourd'hui chez Clever Age, il parcours la toile sans relâche, à la recherche de l'élixir de qualité, de la pierre d'innovation, et de la poudre d'accessibilité. D'un optimisme sans faille, il offre son aide à qui le souhaite, et poursuit inlassablement sa quête au côté d'autres valeureux compagnons, pour libérer le web de ses démons…</p></div>
</div>
