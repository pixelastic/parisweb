...
<title>Paris Web - Le dessous des grilles</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/test-unitaire-mock-tdd-kezako-en-finir-avec-les-regressions.php" title="Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/responsive-lindispensable-revolution-des-outils-et-processus.php" title="Responsive, l’indispensable révolution des outils et processus" />
	...
	<meta name="twitter:title" content="Le dessous des grilles" />
	<meta property="twitter:description" content="Désormais, les intégrateurs ne jurent pratiquement que par les frameworks HTML/CSS. Cependant, hormis quelques particularités concernant la typographie ou les boutons, la différence entre un…" />
	<meta property="dc:title" content="Le dessous des grilles" />
	<meta property="og:title" content="Le dessous des grilles" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/le-dessous-des-grilles.php" />
	<meta property="og:description" content="Désormais, les intégrateurs ne jurent pratiquement que par les frameworks HTML/CSS. Cependant, hormis quelques particularités concernant la typographie ou les boutons, la différence entre un…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le dessous des grilles</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1084">
						<header>
	...
	<section class="s-talk-subject" id="sujet-1084">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/le-dessous-des-grilles.php" class="url">Le dessous des grilles</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2013/recherche/frameworks" rel="tag">frameworks</a><br /><a href="http://www.paris-web.fr/2013/recherche/grilles" rel="tag">grilles</a></dd>
    ...
    <div class="talk-description"><p>Désormais, les intégrateurs ne jurent pratiquement que par les frameworks HTML/CSS. Cependant, hormis quelques particularités concernant la typographie ou les boutons, la différence entre un framework et un autre framework se situe principalement dans les fichiers de définition de <i lang="en">layout</i> et de grille. En effet, ce sont les éléments agissant sur la structure de la page, c'est-à-dire des classes (les plus) spécifiques à chaque site web.</p>

<p>Pourtant, si on vous évoque fréquemment les capacités techniques de ces grilles, il est très rare de soulever le capot pour décortiquer le code et en déterminer le fonctionnement.</p>

<p>Dans cet atelier, il vous sera présenté différentes philosophies de grilles relatives aux besoins spécifiques d'un projet : compatibilité Internet Explorer, adaptabilité selon les dimensions d'un périphérique, facilité de mise en œuvre, variabilisation à l'aide de préprocesseurs...</p>

<p>Pour cela, nous décrirons en détail ce qu'il en est au niveau du code afin de montrer aux novices comment est constitué le cœur de la bête, et permettre aux plus aguerris de faire part de leurs remarques les plus pertinentes concernant les avantages et les inconvénients de chacune des approches.</p>

<p>L'objectif de l'atelier sera de lister les problématiques relatives à la conception de grilles en CSS et de montrer comment passer de la logique déclarative à la logique générative de code CSS (permise grâce aux préprocesseurs CSS).</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/bertrand-keller.php">Bertrand Keller</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Bertrand Keller" src="https://www.paris-web.fr/2013/assets_c/2013/07/bertrandkeller-avatar-thumb-143x143-345.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Maîtriser les outils d'édition web, voilà la ligne de conduite poursuivie qui m'a poussée à me frotter aux éditeur de code HTML et CSS.</p>

<p>Dans l'espoir de bien faire le web, j'ai vite compris que la phase de conception était fondamentale pour répondre aux nécessités de réaliser une page accessible et performante.</p>

<p>De sites en sites, de lectures en lectures, je cherche la formule d'un web artisanal, juste et éthique.</p>

<p>Pour cela, je participe désormais à l'animation de la communauté web de Rouen afin d'y mettre en place des groupes de réflexion sur la qualité web.</p>

<p>Ensemble, on expérimente des méthodes simples et pratiques de développement collaboratif.</p></div>
</div>
