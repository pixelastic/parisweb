...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/changement-de-salle-4.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conclusion-1.php" title="Conclusion" />
	...
	<meta property="twitter:description" content="Dans l'ordre d'apparition sur scène : LE truc qui m’énerve (millésime 2013) (François Nonnenmacher) SlimerJS (Laurent Jouanneau) La méthode Agile (non pas celle-ci, l’autre) (Marie Paccard, Sébastien…" />
	<meta property="dc:title" content="Lightning talks" />
	<meta property="og:title" content="Lightning talks" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/lightning-talks.php" />
	<meta property="og:description" content="Dans l'ordre d'apparition sur scène : LE truc qui m’énerve (millésime 2013) (François Nonnenmacher) SlimerJS (Laurent Jouanneau) La méthode Agile (non pas celle-ci, l’autre) (Marie Paccard, Sébastien…" />
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/81314505" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1154">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/lightning-talks.php" class="url">Lightning talks</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Dans l'ordre d'apparition sur scène :</p>

<ul>
<li>LE truc qui m’énerve (millésime 2013) (François Nonnenmacher)</li>
<li>SlimerJS (Laurent Jouanneau)</li>
<li>La méthode Agile (non pas celle-ci, l’autre) (Marie Paccard, Sébastien Desbenoit et Markus Gramlich)</li>
<li>Exterminons les haut de casses (Raphaël Yharrassarry)</li>
<li>Le code typographique français en 4 minutes sans respirer (Damien Alexandre)</li>
<li>Tetris ou le secret des origines de CSS Grid Layout (David Rousset)</li>
<li>Explorer le système solaire en 4 minutes&nbsp;! (David Catuhe)</li>
<li>Le challenge du Berger (Sébastien Desbenoit)</li>
<li>J'ai décidé d'arrêter de sauver le monde (Nicolas Hoffmann)</li>
<li>Le ticket 3057 (Thomas Zilliox)</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/robin-berjon.php">Robin Berjon</a> et <a href="https://www.paris-web.fr/2013/../orateurs/daniel-glazman.php">Daniel Glazman</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Robin Berjon" src="https://www.paris-web.fr/2013/assets_c/2013/09/robin-berjon-thumb-143x143-374.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Membre du W3C, Robin Berjon participe à l'élaboration de standards depuis plus de dix ans, travaillant notamment sur les APIs Javascript, le SVG, ou les technologies XML. Il est actuellement chair des groupe Device APIs qui expose des interfaces entre le web et le monde réel et Core Mobile Web Platform qui travaille à rendre la plateforme de développement Web mobile plus puissante et plus cohérente. Il est aussi membre du TAG. Il bricole souvent du Javascript pour s'amuser, et a contribué à de nombreux développements open source.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Daniel Glazman" src="https://www.paris-web.fr/2013/assets_c/2013/08/DanielGlazman-thumb-143x143-368.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Dans une autre vie, il a du être éleveur de canards gras ou linguiste, mais dans celle-ci, il n'est qu'informaticien et spécialiste des standards du web. Après élimination successive de tous les autres survivants à douze ans de standardisation, Daniel a été nommé co-président du groupe de travail CSS au W3C en avril 2008 et tente depuis cette date de faire avancer le schmillblick dans ce domaine et combattant les trolls et évitant lui-même l'enfermement en unité psy.</p></div>
</div>
