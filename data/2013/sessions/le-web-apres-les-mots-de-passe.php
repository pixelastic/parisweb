...
<title>Paris Web - Le web après les mots de passe</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/adaptive-images-for-responsive-web-design.php" title="Adaptive Images for Responsive Web Design" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/changement-de-salle-2.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Le web après les mots de passe" />
	<meta property="twitter:description" content="Cette présentation s'adresse aux concepteurs d'applications web, afin de leur donner des pistes pour rendre leurs applications plus sûres. Les défauts des mots de passe pour s'authentifier auprès des…" />
	<meta property="dc:title" content="Le web après les mots de passe" />
	<meta property="og:title" content="Le web après les mots de passe" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/le-web-apres-les-mots-de-passe.php" />
	<meta property="og:description" content="Cette présentation s'adresse aux concepteurs d'applications web, afin de leur donner des pistes pour rendre leurs applications plus sûres. Les défauts des mots de passe pour s'authentifier auprès des…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le web après les mots de passe</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1114">
						<header>
							<h1>Le web après les mots de passe</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/80978488" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/2013-10-12beyondpasswords-131014021231-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://paris-web.fr/2013/2013-10-12beyondpasswords-131014021231-phpapp01.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1114">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/le-web-apres-les-mots-de-passe.php" class="url">Le web après les mots de passe</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/authentification" rel="tag">authentification</a><br /><a href="http://www.paris-web.fr/2013/recherche/securite" rel="tag">sécurité</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Cette présentation s'adresse aux concepteurs d'applications web, afin de leur donner des pistes pour rendre leurs applications plus sûres.<br />
Les défauts des mots de passe pour s'authentifier auprès des applications web sont bien connus: les utilisa-teurs-trices doivent choisir entre un mot de passe sûr (complexe et différent pour chaque application) ou facile à retenir (simple, utilisé sur plusieurs applications). Le résultat est un véritable casse tête dans le premier cas, ou l'usurpation d'identité pour ceux qui choisissent la facilité. L'année 2012 a vu 12 million de comptes piratés (1 toutes les 3 secondes), entraînant des vols pour un montant estimé à 26 milliards de dollars.<br />
Pourtant des solutions existent, et nous présenterons leurs principales caractéristiques :<br />
<ul><br />
<li>Délégation de l'authentification auprès de serveurs d'identités, offrant la possibilité d'une authentification unique (Social Sign-In à travers Facebook, Google, Twitter et autres).</li><br />
<li>Authentification forte à l'aide de multiples facteurs ou canaux de communications (PC + mobile, empreintes digitales, token OTP, cartes à puce…)</li><br />
</ul><br />
Nous ferons un rapide panorama des protocoles disponibles ou en cours de spécification permettant ce type d'authentification: OpenID [Connect], SAML, BrowserID, OAuth, FIDO Alliance.</p>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/olivier-potonniee.php">Olivier Potonniée</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Olivier Potonniée" src="https://www.paris-web.fr/2013/assets_c/2013/06/olivier-potonniee-thumb-143x143-314.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Olivier Potonniée est ingénieur de recherche dans l'équipe Innovation et Technologie de Gemalto, basé à La Ciotat (France). Il conçoit et réalise des solutions pour sécuriser les applications web, notamment à l'aide de carte à puce. Il a rejoint Gemalto (précédemment Gemplus) en 1999, et avant ça a travaillé chez Alcatel et France Telecom R&D. Il possède une thèse en Informatique de l'université Paris VI.</p></div>
</div>
