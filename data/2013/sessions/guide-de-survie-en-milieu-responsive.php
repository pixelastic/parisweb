...
<title>Paris Web - Guide de survie en milieu responsive</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/penser-lexperience-utilisateur-mobile.php" title="Penser l'expérience utilisateur mobile" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/c.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Guide de survie en milieu responsive" />
	<meta property="twitter:description" content="Le responsive web design est une approche relativement jeune sous sa forme actuelle et manque encore de bonnes pratiques reconnues et éprouvées dans l’industrie. Du coup, à nouvelle approche,…" />
	<meta property="dc:title" content="Guide de survie en milieu responsive" />
	<meta property="og:title" content="Guide de survie en milieu responsive" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/guide-de-survie-en-milieu-responsive.php" />
	<meta property="og:description" content="Le responsive web design est une approche relativement jeune sous sa forme actuelle et manque encore de bonnes pratiques reconnues et éprouvées dans l’industrie. Du coup, à nouvelle approche,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Guide de survie en milieu responsive</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1112">
						<header>
							<h1>Guide de survie en milieu responsive</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/81583283" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/Guide_De_Survie_En_Milieu_Responsive.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1112">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/guide-de-survie-en-milieu-responsive.php" class="url">Guide de survie en milieu responsive</a></span></span></h2>
...
<dd class="column location"><a href="/lieux/">Salon d'honneur</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2013/11.php">vendredi 11</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
11 <abbr title="heures">h</abbr> 05
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/responsive-design" rel="tag">responsive design</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le responsive web design est une approche relativement jeune sous sa forme actuelle et manque encore de bonnes pratiques reconnues et éprouvées dans l’industrie. Du coup, à nouvelle approche, nouvelles questions :<br />
<ul><br />
<li>Le designer d'expérience utilisateur se demandera  «&nbsp;Quels sont les usages&nbsp;? Quel sont les bonnes pratiques RWD&nbsp;? Comment je vais adapter la méthodologie UX&nbsp;? Comment avoir une expérience qui soit cohérente sur plusieurs écrans&nbsp;?&nbsp;»</li><br />
<li>Le développeur Front se demandera «&nbsp;Comment je vais utiliser les break-points&nbsp;? Et les media queries&nbsp;? Comment je vais éviter le snifing ? Et concevoir des blocs responsive&nbsp;? Et les animations&nbsp;? Comment je vais gérer le grand-écart entre IE7 et les autres navigateurs&nbsp;? Et le débug sur les différents terminaux&nbsp;?&nbsp;»</li><br />
<li>L’architecte se demandera «&nbsp;Comment je vais garantir la meilleure productivité possible&nbsp;? Et la meilleure qualité&nbsp;? Tout en utilisant le data binding, l'injection de dépendance, les tests unitaires, etc.&nbsp;?&nbsp;»</li><br />
</ul></p>

<p>Autour d’un projet concret, nous partagerons avec vous les enseignements retirés de cette aventure qui vous permettrons d’en sortir vivant… ou pas.</p>

<p>PS : N’oubliez pas votre serviette de bain.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/cyril-balit.php">Cyril Balit</a>, <a href="https://www.paris-web.fr/2013/../orateurs/nicolas-massouh.php">Nicolas Massouh</a> et <a href="https://www.paris-web.fr/2013/../orateurs/guillaume-abel.php">Guillaume Abel</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Cyril Balit" src="https://www.paris-web.fr/2013/assets_c/2013/08/cyrilbalit-thumb-143x143-371.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Cyril Balit est architecte RIA dans la société Ekino. </p>

<p>Après un parcours atypique de biologie, du Cobol, du VB et du Java, Cyril découvre le développement web au début des années 2000 en créant le projet open source Rialto. Il s’intéresse par la suite au développement Flex et mobile. </p>

<p>Actuellement Cyril encadre une équipe de développeurs front orientée web, Flex/Flash et mobile.<br />
</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Nicolas Massouh" src="https://www.paris-web.fr/2013/assets_c/2013/08/nicolas_massouh-thumb-143x143-363.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Musicien pendant plusieurs années, Nicolas découvre le développement sur son Amstrad 464 puis y reviens bien plus tard avec la suite MX. <br />
Curieux, il triture, bidouille des lignes de code qu’il retrouve sur le web. C’est en 2009 qu’il décide de professionnaliser cela en intégrant l’IESA MULTIMEDIA. A la suite d’un stage chez Dagobert il intégre l’agence Balistik’ art pour finir par rejoindre le pôle front chez Ekino un an après.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Guillaume Abel" src="https://www.paris-web.fr/2013/assets_c/2013/08/guillaume_abel-thumb-143x143-358.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après un parcours universitaire 100% numérique et aimant être au contact d’équipes pluridisciplinaires, Guillaume devient logiquement chef de projet web en agence en 2004.Retour ligne automatique<br />
Multilingue dans le domaine du web, ce geek curieux et passionné est capable de discuter code, graphisme, marketing ou plus sérieusement du dernier Lolcat disponible sur les internets</p>

<p>Actuellement Lead UX Designer chez Ekino, il accompagne ses collègues et clients sur le design d’expérience utilisateur.</p></div>
</div>
