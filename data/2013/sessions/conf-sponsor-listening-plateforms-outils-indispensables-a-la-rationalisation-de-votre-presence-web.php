...
<title>Paris Web - [Conf Sponsor] « Listening Platforms » : outils indispensables à la rationalisation de votre présence Web ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/mobile-et-accessibilite-une-partie-a-troie.php" title="Mobile et accessibilité, une partie à Troie" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/conference-informelle-2.php" title="Conférence informelle" />
	...
	<meta name="twitter:title" content="[Conf Sponsor] « Listening Platforms » : outils indispensables à la…" />
	<meta property="twitter:description" content="La présence Web d’une marque (une entreprise ou un produit) est de plus en plus « protéiforme » : sites Web/Mobile/Tablette, sites e-Commerce, moteurs de recherche, blogs, réseaux sociaux,…" />
	<meta property="dc:title" content="[Conf Sponsor] « Listening Platforms » : outils indispensables à la rationalisation de votre présence Web ?" />
	<meta property="og:title" content="[Conf Sponsor] « Listening Platforms » : outils indispensables à la rationalisation de votre présence Web ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/conf-sponsor-listening-plateforms-outils-indispensables-a-la-rationalisation-de-votre-presence-web.php" />
	<meta property="og:description" content="La présence Web d’une marque (une entreprise ou un produit) est de plus en plus « protéiforme » : sites Web/Mobile/Tablette, sites e-Commerce, moteurs de recherche, blogs, réseaux sociaux,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Conf Sponsor] « Listening Platforms » : outils indispensables à la rationalisation de votre présence Web ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1149">
						<header>
							<h1>[Conf Sponsor] « Listening Platforms » : outils indispensables à la rationalisation de votre présence Web ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83745898" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/listening_platforms.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1149">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/conf-sponsor-listening-plateforms-outils-indispensables-a-la-rationalisation-de-votre-presence-web.php" class="url">[Conf Sponsor] « Listening Platforms » : outils indispensables à la rationalisation de votre présence Web ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/presence-web" rel="tag">présence web</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/frederic-bon.php">Frédéric Bon</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Frédéric Bon" src="https://www.paris-web.fr/2013/assets_c/2013/06/frederic-bon-thumb-143x143-337.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Frédéric à plus de 20 ans d’expérience dans les nouvelles technologies. Il a progressivement exploité son background IT pour construire de nouvelles offres marketing et monter des équipes couvrant l’ensemble de la chaîne digitale (des métiers de l’agence interactive au métier de la production 24/7).</p></div>
</div>
