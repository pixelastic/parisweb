...
<title>Paris Web - Les 7 préceptes d'un projet web raté !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/accessibiliser-avec-subtilite.php" title="&quot;Accessibiliser&quot; avec subtilité" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/conference-informelle-3.php" title="Conférence informelle" />
	...
	<meta name="twitter:title" content="Les 7 préceptes d'un projet web raté !" />
	<meta property="twitter:description" content="Il a toujours été plus facile de complètement rater un projet que d'en assurer un réussite pleine et complète. Mais quels sont les problèmes rencontrés qui, par effet boule de neige, nous conduisent…" />
	<meta property="dc:title" content="Les 7 préceptes d'un projet web raté !" />
	<meta property="og:title" content="Les 7 préceptes d'un projet web raté !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/les-7-preceptes-dun-projet-web-rate.php" />
	<meta property="og:description" content="Il a toujours été plus facile de complètement rater un projet que d'en assurer un réussite pleine et complète. Mais quels sont les problèmes rencontrés qui, par effet boule de neige, nous conduisent…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les 7 préceptes d'un projet web raté !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1133">
						<header>
							<h1>Les 7 préceptes d'un projet web raté !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/78762444" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/les-7-preceptes-dun-projet-web-rate.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1133">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/les-7-preceptes-dun-projet-web-rate.php" class="url">Les 7 préceptes d'un projet web raté !</a></span></span></h2>
...
<dd class="column">
12 <abbr title="heures">h</abbr> 30
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/decale" rel="tag">décalé</a><br /><a href="http://www.paris-web.fr/2013/recherche/gestion-de-projet" rel="tag">gestion de projet</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Il a toujours été plus facile de complètement rater un projet que d'en assurer un réussite pleine et complète. Mais quels sont les problèmes rencontrés qui, par effet boule de neige, nous conduisent à doubler les temps de production, à tripler les ressources prévues initialement ou pire, à livrer une application totalement décalée des besoins du client ?</p>

<p>Multiplicité des métiers du web, mauvaise utilisation des canaux de communication, mauvais choix de méthode et d'outils sont surement des pistes, mais je suis sur que nous pouvons faire encore mieux pour arriver au pire projet web jamais réalisé.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/julien-oger.php">Julien Oger</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Julien Oger" src="https://www.paris-web.fr/2013/assets_c/2013/06/julien.oger-thumb-143x143-309.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Chef de Projet chez GLOBALIS media systems depuis 5 ans, Julien travaille dans le web depuis une dizaine d'années pour de petits et grands comptes (BNP, Saint-Gobain, Fédération Française de couture, SNCF, etc.) sur des sujets aussi divers que de l'assistance MOA, audit organisationnel, gestion de projet au forfait, organisation de TMA.</p>

<p>Julien est également responsable de l'organisation des méthodes de travail dans la société et a participé à l'élaboration d'une méthode de travail adaptée aux besoins de GLOBALIS en empruntant à Scrum, Xtrem programming et Crystal Clear.<br />
</p></div>
</div>
