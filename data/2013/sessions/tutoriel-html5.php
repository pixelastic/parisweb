...
<title>Paris Web - Tutoriel HTML5</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/analysing-complex-user-needs-with-user-matrices.php" title="Analysing Complex User Needs with User Matrices" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/pause-dejeuner-2.php" title="Pause déjeuner" />
	...
	<meta name="twitter:title" content="Tutoriel HTML5" />
	<meta property="twitter:description" content="Découvrir les APIs JavaScript de HTML5, programmation d'applications web avec HTML5&nbsp;: persistance, offline applications, géolocalisation, orientation, dessin/animation, multimédia, programmation…" />
	<meta property="dc:title" content="Tutoriel HTML5" />
	<meta property="og:title" content="Tutoriel HTML5" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/tutoriel-html5.php" />
	<meta property="og:description" content="Découvrir les APIs JavaScript de HTML5, programmation d'applications web avec HTML5&nbsp;: persistance, offline applications, géolocalisation, orientation, dessin/animation, multimédia, programmation…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Tutoriel HTML5</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1099">
						<header>
	...
	<section class="s-talk-subject" id="sujet-1099">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/tutoriel-html5.php" class="url">Tutoriel HTML5</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/html5" rel="tag">HTML5</a><br /><a href="http://www.paris-web.fr/2013/recherche/javascript" rel="tag">JavaScript</a><br /><a href="http://www.paris-web.fr/2013/recherche/web-api" rel="tag">web API</a></dd>
    ...
    <div class="talk-description"><p>Découvrir les APIs JavaScript de HTML5, programmation d'applications web avec HTML5&nbsp;: persistance, offline applications, géolocalisation, orientation, dessin/animation, multimédia, programmation de jeux (animation, effets sonores, etc).</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/michel-buffa.php">Michel Buffa</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Michel Buffa" src="https://www.paris-web.fr/2013/assets_c/2013/08/michel-buffa-thumb-143x143-372.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Michel Buffa est enseignant chercheur à l'Université de Nice.  Il appartient à l'équipe de recherche <a href="http://wimmics.inria.fr/">WIMMICS</a> commune CNRS/INRIA, spécialisée dans le web sémantique. Il collabore avec le W3C depuis 1994, entre autres, il est l'auteur du cours HTML5 que le W3C propose en ligne, suivi à distance par des élèves du monde entier. Il s'agit d'un cours officiel du W3C donnant un certificat et disponible sur <a href="http://www.w3devcampus.com/">w3devcampus.com</a>, la première édition (Avril-Mai 2013) a été suivie par 83 personnes, la suivante (Juin-Juillet a déjà plus de 40 inscrits).</p>

<p>Michel Buffa encadre actuellement une thèse sur un Web IDE en ligne mélange de Wiki et de jsbin/jsfiddle permettant d'éditer des documents mais aussi des applications HTML5 directement dans le navigateur. Ce logiciel s'appelle WikiNext.</p>

<p>Michel Buffa enseigne HTML5 depuis 2009 en niveau master.</p></div>
</div>
