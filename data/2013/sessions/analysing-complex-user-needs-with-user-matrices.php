...
<title>Paris Web - Analysing Complex User Needs with User Matrices</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/et-si-on-enrichissait-nos-frameworks-css.php" title="Et si on enrichissait nos frameworks CSS ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/tutoriel-html5.php" title="Tutoriel HTML5" />
	...
	<meta name="twitter:title" content="Analysing Complex User Needs with User Matrices" />
	<meta property="twitter:description" content=" Analysing Complex User Needs with User Matrices Currently, our user experience tools tend to focus on “who” users are, but in many cases, user needs fall along multiple spectrums and dimensions. In…" />
	<meta property="dc:title" content="Analysing Complex User Needs with User Matrices" />
	<meta property="og:title" content="Analysing Complex User Needs with User Matrices" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/analysing-complex-user-needs-with-user-matrices.php" />
	<meta property="og:description" content=" Analysing Complex User Needs with User Matrices Currently, our user experience tools tend to focus on “who” users are, but in many cases, user needs fall along multiple spectrums and dimensions. In…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Analysing Complex User Needs with User Matrices</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1095">
						<header>
							<h1>Analysing Complex User Needs with User Matrices</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1095">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/analysing-complex-user-needs-with-user-matrices.php" class="url">Analysing Complex User Needs with User Matrices</a></span></span></h2>
...
<dd class="column">
11 <abbr title="heures">h</abbr> 00
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/ux" rel="tag">UX</a></dd>
...
<p><strong>Analysing Complex User Needs with User Matrices</strong></p>
<p>
Currently, our user experience tools tend to focus on “who” users are, but in many cases, user needs fall along multiple spectrums and dimensions. In this hands-on workshop, you will get the chance to learn how and when to use this new product design method that has been developed by Steph—a method that is an effective bridge between user research and design.
</p>
</div>
<div lang="fr" class="span-6 last">
<p><strong>Analyser les besoins utilisateurs complexes à l’aide des matrices utilisateur</strong></p>
<p>
À l’heure actuelle, nos outils d’expérience utilisateur ont tendance à se limiter à « qui » sont les utilisateurs. Mais dans de nombreux cas, les besoins de l’utilisateur se trouvent répartis sur de nombreuses variations et dimensions. Au cours de cet atelier pratique, vous pourrez apprendre comment et quand utiliser cette nouvelle méthode de conception de produit développée par Steph – une méthode qui se révèle faire une liaison efficace entre les recherches utilisateur et la conception.
</p>
</div>
<div class="box clear">
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/stephanie-troeth.php">Stephanie Troeth</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stephanie Troeth" src="https://www.paris-web.fr/2013/assets_c/2013/06/stephanie.stroeth-thumb-143x143-330.png" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p>
Steph is a user experience strategist who loves maturing ideas and making things real. She has worn many hats, including a product lead for a startup in digital publishing and a studio director at a digital agency. 
</p>
<p>
She is also known for her grassroots contributions to best web practices through the Web Standards Project and the W3C. 
</p>
<p>
Well-travelled and living on her fourth island, she speaks several flavours of English, a few languages, and possesses an indecipherable accent. 
</p>
</div>
<div lang="fr" class="span-6 last">
<p>
Steph est une stratège en expérience utilisateur qui adore mener des idées à maturité et à les réaliser. Elle a tenu plus d'un rôle par le passé, dont celui de chef de produit pour une startup autour des livres numériques, et celui de directrice de studio dans une agence web. 
</p>
<p>
Elle est également connue pour son implication dans la défense et la promotion des meilleures pratiques du développement Web, plus particulièrement au sein du Web Standards Project et du W3C. 
</p>
<p>
Une grand voyageuse qui vit désormais sur sa quatrième île, elle parle plusieurs dialectes d'anglais, quelques autres langues, et dispose d'un accent indéchiffrable.</p>
</div></div>
</div>
