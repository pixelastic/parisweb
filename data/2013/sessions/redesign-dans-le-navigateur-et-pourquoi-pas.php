...
<title>Paris Web - Redesign dans le navigateur ? Et pourquoi pas !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/des-modeles-de-conceptions-pour-vos-composants-dinterface-grace-a-aria.php" title="Des modèles de conceptions pour vos composants d'interface grâce à ARIA" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/projets-responsive-mise-en-commun-de-retours-dexperience.php" title="Projets responsive : mise en commun de retours d'expérience" />
	...
	<meta name="twitter:title" content="Redesign dans le navigateur ? Et pourquoi pas !" />
	<meta property="twitter:description" content="Aujourd'hui les navigateurs web disposent d'une batterie d'outils de développement et de débogage complète et très puissante. Cet atelier propose de mettre en œuvre l'amélioration continue du…" />
	<meta property="dc:title" content="Redesign dans le navigateur ? Et pourquoi pas !" />
	<meta property="og:title" content="Redesign dans le navigateur ? Et pourquoi pas !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/redesign-dans-le-navigateur-et-pourquoi-pas.php" />
	<meta property="og:description" content="Aujourd'hui les navigateurs web disposent d'une batterie d'outils de développement et de débogage complète et très puissante. Cet atelier propose de mettre en œuvre l'amélioration continue du…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Redesign dans le navigateur ? Et pourquoi pas !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1093">
						<header>
							<h1>Redesign dans le navigateur ? Et pourquoi pas !</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1093">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/redesign-dans-le-navigateur-et-pourquoi-pas.php" class="url">Redesign dans le navigateur ? Et pourquoi pas !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2013/recherche/integration" rel="tag">intégration</a><br /><a href="http://www.paris-web.fr/2013/recherche/navigateurs" rel="tag">navigateurs</a><br /><a href="http://www.paris-web.fr/2013/recherche/outils" rel="tag">outils</a></dd>
    ...
    <div class="talk-description"><p>Aujourd'hui les navigateurs web disposent d'une batterie d'outils de développement et de débogage complète et très puissante.</p>

<p>Cet atelier propose de mettre en œuvre l'amélioration continue du webdesign en faisant vivre les prototypes de nos «&nbsp;petits pas&nbsp;» dans le navigateur et ainsi tester directement les modifications futures de notre site web.</p>

<p>Pour participer, il est conseillé de vous munir de votre ordinateur portable et de la dernière version de Firefox ou de Chrome ainsi que de votre éditeur de texte favori.<br />
Il serait également intéressant de venir avec un projet à tester.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/stephane-verdier.php">Stéphane Verdier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Verdier" src="https://www.paris-web.fr/2013/assets_c/2013/08/stephane_verdier-thumb-143x143-366.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Webmaster/intégrateur web depuis 10 ans, fervent défenseur des standards du web, de l'accessibilité et des logiciels libres, il est également formateur depuis quelques années en intégration web et HTML/CSS.<br />
Après plusieurs années en collectivité territoriale et un passage par l'École Nationale de la Magistrature, il est fait parti aujourd'hui de la cellule web de la Communauté Urbaine de Bordeaux où il travail notamment sur des problématiques de redesign et d'améliorations continues.</p>

<p>Curieux insatiable, le web est pour lui un sujet de découverte permanent.</p></div>
</div>
