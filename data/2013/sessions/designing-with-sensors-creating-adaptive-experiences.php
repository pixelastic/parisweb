...
<title>Paris Web - Designing with Sensors: Creating Adaptive Experiences</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/changement-de-salle-3.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/multimodalite-des-interfaces-web-une-nouvelle-approche-du-design.php" title="Multimodalité &amp; interfaces. Le design est une question d'humains, pas de machine" />
	...
	<meta name="twitter:title" content="Designing with Sensors: Creating Adaptive Experiences" />
	<meta property="twitter:description" content=" Use Smart Device technology, Sensors and User Data to design a better user experience. How do we utilize sensor and user data to create experiences in the digital world? We all know that smart…" />
	<meta property="dc:title" content="Designing with Sensors: Creating Adaptive Experiences" />
	<meta property="og:title" content="Designing with Sensors: Creating Adaptive Experiences" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/designing-with-sensors-creating-adaptive-experiences.php" />
	<meta property="og:description" content=" Use Smart Device technology, Sensors and User Data to design a better user experience. How do we utilize sensor and user data to create experiences in the digital world? We all know that smart…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Designing with Sensors: Creating Adaptive Experiences</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1103">
						<header>
							<h1>Designing with Sensors: Creating Adaptive Experiences</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/83485967" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/designing-with-sensors-creating-adaptive-experiences.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1103">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/designing-with-sensors-creating-adaptive-experiences.php" class="url">Designing with Sensors: Creating Adaptive Experiences</a></span></span></h2>
...
<dd class="column">
15 <abbr title="heures">h</abbr> 05
...
<p><strong>Use Smart Device technology, Sensors and User Data to design a better user experience.</strong></p>
<p>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/avi-itzkovitch.php">Avi Itzkovitch</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Avi Itzkovitch" src="https://www.paris-web.fr/2013/assets_c/2013/08/avi_itzkovitch-thumb-143x143-355.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p>
Avi is a longtime interactive and web design professional with over ten years of experience. </p>
<p>Author of Design-It-Yourself: Web Sites (Rockport Publishers, 2003), Avi has published several articles about user experience including one in Smashing Magazine on the topic of Adaptive Design. In addition, he is often invited to speak about his publications, as well as other emerging design and UX trends. </p>
<p>Avi is currently working as an Independent UI/UX Consultant and is the owner of XG Media.
</p>
</div>
<div lang="fr" class="span-6 last">
<p>Avec plus de 10 ans d’expérience, Avi est un professionnel averti de la conception web et interactive.</p>
<p>Auteur de "Design-It-Yourself: Web Sites" (Rockport Publishers, 2003), Avi a publié de nombreux articles sur l’expérience utilisateur dans Smashing Magazine, autour de l'adaptive design. Il est par ailleurs régulièrement invité à parler de ses publications, ainsi que des tendances émergentes du design et de l'UX. </p>
<p>Avi travaille actuellement en tant que consultant UI/UX indépendant, et est à la tête de XG Media.</p>
</div></div>
</div>
