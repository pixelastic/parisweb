...
<title>Paris Web - SVG, devenez maître des vecteurs</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/maquetter-critiquer-etre-critique.php" title="Maquetter : Critiquer &amp; être Critiqué" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/les-outils-pour-developpeurs-inclus-dans-les-navigateurs-web.php" title="Les outils pour développeurs inclus dans les navigateurs Web" />
	...
	<meta name="twitter:title" content="SVG, devenez maître des vecteurs" />
	<meta property="twitter:description" content="Présent dans les spécifications HTML depuis près de 15 ans, c'est aujourd'hui seulement que le format vectoriel SVG devient une véritable alternative aux formats d'images statiques. Dans un premier…" />
	<meta property="dc:title" content="SVG, devenez maître des vecteurs" />
	<meta property="og:title" content="SVG, devenez maître des vecteurs" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/svg-devenez-maitre-des-vecteurs.php" />
	<meta property="og:description" content="Présent dans les spécifications HTML depuis près de 15 ans, c'est aujourd'hui seulement que le format vectoriel SVG devient une véritable alternative aux formats d'images statiques. Dans un premier…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>SVG, devenez maître des vecteurs</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1087">
						<header>
							<h1>SVG, devenez maître des vecteurs</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1087">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/svg-devenez-maitre-des-vecteurs.php" class="url">SVG, devenez maître des vecteurs</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/svg" rel="tag">SVG</a></dd>
    ...
    <div class="talk-description"><p>Présent dans les spécifications HTML depuis près de 15 ans, c'est aujourd'hui seulement que le format vectoriel SVG devient une véritable alternative aux formats d'images statiques.</p>

<p>Dans un premier temps, vous découvrirez à travers des exemples concrets les axes d'optimisation offerts par ce format (poids, requête HTTP, maintenabilité, dynamique graphique), ses différents modes d'intégration (<code lang="en">object</code>, fichier, <i lang="en">inline</i>, <i lang="en">base64</i>) et leurs impacts sur votre application web.</p>

<p>Dans la seconde moitié de l'atelier, nous verrons comment interagir avec le SVG en JavaScript, de la possibilité pour vos utilisateurs à personnaliser leur interface, à son utilisation comme un module applicatif (notifications, aide contextuelle).<br />
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/jonathan-rivalan.php">Jonathan Rivalan</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jonathan Rivalan" src="https://www.paris-web.fr/2013/assets_c/2013/08/jonathan_rivalan-thumb-143x143-359.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Autodidacte, Jonathan est entrée dans le web par le biais éditorial et la rédaction d'articles généralistes, puis par le seo et ses outils d'analytics, avant de s'intéresser à l'aspect technique de nos interfaces web. Développeur front-end, d'abord indépendant puis chez le client et en agence, il occupe aujourd'hui un poste d'Ingenieur r&d et interviens au sein de la société Alter Way sur des sujets orientés javascript.</p></div>
</div>
