...
<title>Paris Web - Understanding DOM and its importance for accessibility</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/pause-dejeuner-1.php" title="Pause déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/html-css-bousculez-vos-habitudes.php" title="HTML / CSS : bousculez vos habitudes ! " />
	...
	<meta name="twitter:title" content="Understanding DOM and its importance for accessibility" />
	<meta property="twitter:description" content=" Understanding DOM and its importance for accessibility When I do training on advanced accessibility, attendees are sometimes taken aback when I tell them that HTML is a “polite request”, but it is…" />
	<meta property="dc:title" content="Understanding DOM and its importance for accessibility" />
	<meta property="og:title" content="Understanding DOM and its importance for accessibility" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/wcag-412-understanding-dom-and-its-importance-for-accessibility-1.php" />
	<meta property="og:description" content=" Understanding DOM and its importance for accessibility When I do training on advanced accessibility, attendees are sometimes taken aback when I tell them that HTML is a “polite request”, but it is…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Understanding DOM and its importance for accessibility</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1100">
						<header>
							<h1>Understanding DOM and its importance for accessibility</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/84970341" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1100">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/wcag-412-understanding-dom-and-its-importance-for-accessibility-1.php" class="url">Understanding DOM and its importance for accessibility</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2013/recherche/dom" rel="tag">DOM</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge">Traduction <abbr title="français">FR</abbr></span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><div lang="en" class="span-6">
<p><strong>Understanding DOM and its importance for accessibility</strong></p>
<p>
When I do training on advanced accessibility, attendees are sometimes taken aback when I tell them that HTML is a “polite request”, but it is true.</p>
<p>As web developers we like to think that our hard work creating HTML, CSS, and JavaScript is what makes our sites so great, but the reality is that all our hard work is really just a request that says “Please, Mr. Browser, can you make this website do all the cool stuff I’ve designed here?” At the time the user’s browser actually receives your web page and all of its assets, your control of the situation entirely ceases and control for how your site really looks and operates is entirely in the hands of the browser.</p> 
<p>The user visits the site with their browser which submits a request over HTTP (or HTTPS) for a URI. The server responds by sending over the necessary files to display the page. At that point, the browser’s rendering engine turns those files into a series of objects which are then displayed on the screen. Each of those objects have specific methods and properties available to them. From these objects, assistive technologies are able to convey important information, typically through the use of an accessibility API.</p>
<p>In this session, I'll describe the interactions between HTML/ CSS/ JavaScript, the DOM, the BOM, Accessibility APIs and Assistive Technologies, providing important technical insight into accessibility.
</p>
</div>
<div lang="fr" class="span-6 last">
<p><strong>Comprendre le DOM et son importance pour l'accessibilité</strong></p>
<p>Lorsque je fais des formations sur l’accessibilité avancée, les participants sont parfois interloqués quand je leur dis que le HTML n’est qu’une « demande polie » ; c’est pourtant vrai.</p>
<p>En tant que développeurs web, nous aimons croire que la grandeur de nos sites vient de notre dur labeur à créer du code HTML, CSS et JavaScript, mais dans les faits, ce dur labeur n’est qu’une demande sous la forme « S’il vous plaît monsieur le Navigateur, pouvez-vous faire en sorte que ce site web fasse tous les trucs cool que j’ai codé ici ? » Dès que le navigateur de votre visiteur reçoit effectivement votre page web et tous ses composants, vous perdez totalement le contrôle de la situation au profit du navigateur, qui choisit la manière dont le site s’affiche et fonctionne.</p>
<p>Le navigateur avec lequel le visiteur parcours votre site demande une URI par requête HTTP (ou HTTPS). Le serveur répond en envoyant les fichiers nécessaires à l’affichage de la page. À cet instant, le moteur de rendu du navigateur transforme ces fichiers en une série d’objets qui sont ensuite affichés à l’écran. Chacun de ces objets dispose de ses propres méthodes et propriétés. À partir de ces objets, les technologies d’assistance sont capables de faire remonter les informations importantes, typiquement par le biais d’une API d’accessibilité.</p>
<p>Lors de cette session, je décrirai les interactions entre HTML/CSS/JavaScript, le DOM, le BOM, les API d’accessibilité et les technologies d’assistance, vous donnant une vision technique importante de l’accessibilité.
</p>
</div>
<div class="box clear">
<p class="last"><abbr lang="la" title="Nota-Bene">NB</abbr> : cette conférence sera animée en anglais avec traduction simultanée.</p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/karl-groves.php">Karl Groves</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Karl Groves" src="https://www.paris-web.fr/2013/assets_c/2013/08/karl_groves-thumb-143x143-361.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p>
