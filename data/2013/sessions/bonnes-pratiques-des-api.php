...
<title>Paris Web - Bonnes pratiques des API</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/changement-de-salle.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/conf-sponsor-le-retour-sur-investissement-des-demarches-qualite-web.php" title="[Conf Sponsor] Le retour sur investissement de la qualité web" />
	...
	<meta name="twitter:title" content="Bonnes pratiques des API" />
	<meta property="twitter:description" content="L'API est un peu le Graal des données mais elle a un défaut majeur : une fois publiée, vous n'en contrôlez plus les clients, et faire évoluer les bases n'est pas évident. Ce que vous construisez est…" />
	<meta property="dc:title" content="Bonnes pratiques des API" />
	<meta property="og:title" content="Bonnes pratiques des API" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/bonnes-pratiques-des-api.php" />
	<meta property="og:description" content="L'API est un peu le Graal des données mais elle a un défaut majeur : une fois publiée, vous n'en contrôlez plus les clients, et faire évoluer les bases n'est pas évident. Ce que vous construisez est…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Bonnes pratiques des API</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1130">
						<header>
							<h1>Bonnes pratiques des API</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/77859591" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/bonnes-pratiques-des-api.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1130">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/bonnes-pratiques-des-api.php" class="url">Bonnes pratiques des API</a></span></span></h2>
...
<dd class="column">
10 <abbr title="heures">h</abbr> 35
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>L'API est un peu le Graal des données mais elle a un défaut majeur : une fois publiée, vous n'en contrôlez plus les clients, et faire évoluer les bases n'est pas évident. Ce que vous construisez est là pour longtemps. Quelles sont les retours d'expériences et bonnes pratiques pour ne pas se prendre les pieds dans le tapis ?</p>

<p>Vous avez certainement déjà entendu parler de REST, mais les choses sont plus complexes que ça. Comment gérer les évolutions et les versions de l'API&nbsp;? Les formats en entrée et en sortie&nbsp;? Les variations et paramètres d'une même ressource&nbsp;? Les relations entre ressources&nbsp;? La sécurité&nbsp;? L'authentification&nbsp;? La gestion des erreurs&nbsp;? La pagination&nbsp;? L'i18n et l10n&nbsp;? Qu'est-ce que l'hypermedia&nbsp;? </p>

<p>Plus généralement, nous partons avec pour objectif premier de concevoir une API le plus tôt possible, avec des bases solides mais les plus simples possible. </p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/eric-daspet.php">Éric Daspet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Éric Daspet" src="https://www.paris-web.fr/2013/assets_c/2013/06/eric-daspet-thumb-143x143-333.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après un parcours d'expert PHP, ingénieur web à Yahoo!, consultant en technologies web, responsable innovation, expert performance web et architecte S.I., Éric est désormais directeur technique de TEA, une startup qui met sur pied un modèle ouvert de distribution de livres numériques.</p>

<p>En parallèle Éric est très attaché au partage des connaissances dans la communauté web et met en avant depuis plusieurs années la notion de qualité web. Au milieu d’articles dans la presse, d’une participation à Openweb et de nombreuses conférences, il a co-écrit le livre « PHP 5 avancé » aux éditions Eyrolles et est à l’origine des conférences Paris Web avec Stéphane et Adrien.<br />
<ul><br />
<li>Éric Daspet : <a href="http://eric.daspet.name/">http://eric.daspet.name/</a></li><br />
<li>TEA : <a href="http://www.tea-ebook.com/">http://www.tea-ebook.com/</a></li><br />
</ul></p></div>
</div>
