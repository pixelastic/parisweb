...
<title>Paris Web - Responsive, l’indispensable révolution des outils et processus</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/le-dessous-des-grilles.php" title="Le dessous des grilles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/les-croyances-limitatives.php" title="Développons notre efficacité !" />
	...
	<meta name="twitter:title" content="Responsive, l’indispensable révolution des outils et processus" />
	<meta property="twitter:description" content="Les processus et techniques habituels sont incompatibles avec la création de sites s’affichant au mieux du mobile aux ordinateurs de bureau en passant par les tablettes. Vous vous demandez comment…" />
	<meta property="dc:title" content="Responsive, l’indispensable révolution des outils et processus" />
	<meta property="og:title" content="Responsive, l’indispensable révolution des outils et processus" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/responsive-lindispensable-revolution-des-outils-et-processus.php" />
	<meta property="og:description" content="Les processus et techniques habituels sont incompatibles avec la création de sites s’affichant au mieux du mobile aux ordinateurs de bureau en passant par les tablettes. Vous vous demandez comment…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Responsive, l’indispensable révolution des outils et processus</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1096">
						<header>
							<h1>Responsive, l’indispensable révolution des outils et processus</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1096">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/responsive-lindispensable-revolution-des-outils-et-processus.php" class="url">Responsive, l’indispensable révolution des outils et processus</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/responsive-design" rel="tag">responsive design</a></dd>
    ...
    <div class="talk-description"><p>Les processus et techniques habituels sont incompatibles avec la création de sites s’affichant au mieux du mobile aux ordinateurs de bureau en passant par les tablettes. </p>

<p>Vous vous demandez comment convaincre un client que son site doit être compatible mobile et tablette ? Comment déterminer les points de rupture ? S’il existe une hauteur de page idéale sur mobile ? Ce que valent les <i lang="en">frameworks</i> CSS <i lang="en">responsive</i> ? </p>

<p>Venez trouver réponse à toutes ces questions (et à bien d’autres) et découvrir les processus, techniques et outils pour aborder la révolution du <i lang="en">responsive</i> avec sérénité.</p></div>
	</section>
