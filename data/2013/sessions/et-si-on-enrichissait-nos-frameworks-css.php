...
<title>Paris Web - Et si on enrichissait nos frameworks CSS ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/apres-la-macro-la-micro.php" title="Après la macro, la micro !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/analysing-complex-user-needs-with-user-matrices.php" title="Analysing Complex User Needs with User Matrices" />
	...
	<meta name="twitter:title" content="Et si on enrichissait nos frameworks CSS ?" />
	<meta property="twitter:description" content="Forts de leur expérience avec leurs frameworks respectifs, Nicolas et Raphaël vous proposent d'animer un workshop CSS autour de frameworks CSS légers&nbsp;: astuces, propositions, principes,…" />
	<meta property="dc:title" content="Et si on enrichissait nos frameworks CSS ?" />
	<meta property="og:title" content="Et si on enrichissait nos frameworks CSS ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/et-si-on-enrichissait-nos-frameworks-css.php" />
	<meta property="og:description" content="Forts de leur expérience avec leurs frameworks respectifs, Nicolas et Raphaël vous proposent d'animer un workshop CSS autour de frameworks CSS légers&nbsp;: astuces, propositions, principes,…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Et si on enrichissait nos frameworks CSS ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1089">
						<header>
							<h1>Et si on enrichissait nos frameworks CSS ?</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1089">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/et-si-on-enrichissait-nos-frameworks-css.php" class="url">Et si on enrichissait nos frameworks CSS ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2013/recherche/frameworks" rel="tag">frameworks</a></dd>
    ...
    <div class="talk-description"><p>Forts de leur expérience avec leurs <i lang="en">frameworks</i> respectifs, Nicolas et Raphaël vous proposent d'animer un <i lang="en">workshop</i> CSS autour de <i lang="en">frameworks</i> CSS légers&nbsp;: astuces, propositions, principes, pré-processeurs, conventions de nommage, exemples, problématiques à résoudre, compatibilité <i lang="en">cross-browsers</i>, etc. Tous les coups sont permis, et les participants vont être mis à contribution, quel que soit leur niveau ! </p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/raphael-goetter.php">Raphaël Goetter</a> et <a href="https://www.paris-web.fr/2013/../orateurs/nicolas-hoffmann.php">Nicolas Hoffmann</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Goetter" src="https://www.paris-web.fr/2013/assets_c/2013/06/raphael.goetter.1-thumb-143x143-320.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Raphaël Goetter est dompteur de CSS, intermittent du HTML, créateur d’Alsacréations et auteur chez Eyrolles à ses heures perdues.</p>
<p>Son quotidien est parsemé de missions toutes plus captivantes les unes que les autres : résoudre des problèmes CSS insolubles, faire des blagues idiotes au bureau, louer son Alsace natale et boire un bon picon-bière.</p>
<p>Il dispose par ailleurs de superpouvoirs indispensables dans le monde du Web  marcher sur les mains (eh ouais), réussir à faire des photos floues, et par dessus tout parler à l’oreille d’IE6 (avec un sonotone).</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Nicolas Hoffmann" src="https://www.paris-web.fr/2013/assets_c/2013/06/nicolas-hoffmann-thumb-143x143-329.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Nicolas (Nico pour les intimes... et pour les autres aussi !) est intégrateur depuis une dizaine d'années en web agency en Suisse. </p>

<p>C'est en 2003 qu'il découvre les CSS suite à une sombre histoire de tableaux et de templates impossibles à faire fonctionner ensemble. Depuis il est tombé amoureux des CSS mais ça c'est une autre histoire.</p>

<p>Performances web, Web Mobile, Intégration, CSS, Qualité Web, Accessibilité, etc. tout ce qui permet de faire des sites de qualité l'intéresse.</p>

<p>Co-directeur du collectif OpenWeb, il contribue également à sa quête du "Web bien fait" via des articles : sur Openweb donc, sur Alsacréations, le Train de 13H37, et plus largement à divers projets ayant trait à la qualité Web comme OPQuast, etc.</p></div>
</div>
