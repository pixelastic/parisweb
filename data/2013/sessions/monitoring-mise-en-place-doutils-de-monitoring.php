...
<title>Paris Web - Mise en place d'outils de monitoring</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/projets-responsive-mise-en-commun-de-retours-dexperience.php" title="Projets responsive : mise en commun de retours d'expérience" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/fin-de-la-journee.php" title="Fin de la journée" />
	...
	<meta name="twitter:title" content="Mise en place d'outils de monitoring" />
	<meta property="twitter:description" content="Nous verrons comment mettre en place des outils simples de collecte de données et de métriques ainsi que des outils de visualisation et des dashboards. Ces outils permettront tant la collecte de…" />
	<meta property="dc:title" content="Mise en place d'outils de monitoring" />
	<meta property="og:title" content="Mise en place d'outils de monitoring" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/monitoring-mise-en-place-doutils-de-monitoring.php" />
	<meta property="og:description" content="Nous verrons comment mettre en place des outils simples de collecte de données et de métriques ainsi que des outils de visualisation et des dashboards. Ces outils permettront tant la collecte de…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Mise en place d'outils de monitoring</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1098">
						<header>
							<h1>Mise en place d'outils de monitoring</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1098">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/monitoring-mise-en-place-doutils-de-monitoring.php" class="url">Mise en place d'outils de monitoring</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/monitoring" rel="tag">monitoring</a></dd>
    ...
    <div class="talk-description"><p>Nous verrons comment mettre en place des outils simples de collecte de données et de métriques ainsi que des outils de visualisation et des dashboards.</p>

<p>Ces outils permettront tant la collecte de métriques de sources diverses que leur exploitation.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/arnaud-limbourg.php">Arnaud Limbourg</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Arnaud Limbourg" src="https://www.paris-web.fr/2013/assets_c/2013/07/arnaud.limbourg-thumb-143x143-344.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Arnaud est Responsable Technique chez 20 Minutes où il s'occupe, entre autres, du site web, du site mobile, des applications de backoffice et d'outils internes. Pour être honnête c'est surtout son équipe qui fait tout ça et qui le fait bien.</p></div>
</div>
