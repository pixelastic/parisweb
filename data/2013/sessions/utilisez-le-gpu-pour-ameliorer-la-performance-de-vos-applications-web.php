...
<title>Paris Web - [Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos applications Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/keep-calm-and-carry-on.php" title="Keep calm and carry on" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/conference-informelle-4.php" title="Conférence informelle" />
	...
	<meta name="twitter:title" content="[Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos…" />
	<meta property="twitter:description" content="Le GPU est en de plus en plus important pour la performance de nos applications Web. Il est depuis un moment utilisé pour vous dans certains cas comme le canvas 2D ou certaines animations CSS3, nous…" />
	<meta property="dc:title" content="[Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos applications Web" />
	<meta property="og:title" content="[Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos applications Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/utilisez-le-gpu-pour-ameliorer-la-performance-de-vos-applications-web.php" />
	<meta property="og:description" content="Le GPU est en de plus en plus important pour la performance de nos applications Web. Il est depuis un moment utilisé pour vous dans certains cas comme le canvas 2D ou certaines animations CSS3, nous…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos applications Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1182">
						<header>
							<h1>[Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos applications Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/84519561" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/Utilisez_le_GPU_pour_ameliorer_la_performance.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1182">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/utilisez-le-gpu-pour-ameliorer-la-performance-de-vos-applications-web.php" class="url">[Conf Sponsor] Utilisez le GPU pour améliorer la performance de vos applications Web</a></span></span></h2>
...
<dd class="column">
12 <abbr title="heures">h</abbr> 10
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/david-catuhe.php">David Catuhe</a> et <a href="https://www.paris-web.fr/2013/../orateurs/david-rousset.php">David Rousset</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="David Catuhe" src="https://www.paris-web.fr/2013/assets_c/2013/08/catuhe_david-thumb-143x143-356.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>David Catuhe est responsable des évangélistes techniques en France. Il gère une équipe d’experts sur les technologies clientes Windows (Windows 8 et Windows Phone). Il est passionné par de nombreux sujets parmi lesquels on peut compter XAML, C#, HTML5, CSS3 et Javascript, DirectX, et Kinect (pour lequel il a écrit un livre disponible chez Microsoft Press). David se définit lui-même comme un geek. Il est notamment le créateur de hand.js et surtout de babylon.js, un moteur 3D temps réel base sur WebGL. Il écrit également sur un <a href="http://aka.ms/eternalcoding">blog technique</a> sur ses sujets favoris (Html5, 3D et JavaScript).</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="David Rousset" src="https://www.paris-web.fr/2013/assets_c/2013/08/david_rousset-thumb-143x143-357.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>David Rousset est évangéliste technique chez Microsoft France. Il s’occupe de suivre des projets autour des technologies HTML5 sur le Web et au sein des applications Windows 8. Il est également responsable du suivi technique des projets de type jeux vidéo en HTML5, Unity 3D et DirectX pour les plateformes Windows Phone 8 et Windows 8.1. Il anime fréquemment des conférences sur ce sujet. Vous pouvez le suivre sur son blog : <a href="http://blogs.msdn.com/davrous">http://blogs.msdn.com/davrous</a> ou sur Twitter : <a href="http://twitter.com/davrous">http://twitter.com/davrous</a>. Ah oui, dernier point, il est juste chiant avec tout ce qui tourne autour de Star Wars. </p></div>
</div>
