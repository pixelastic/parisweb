...
<title>Paris Web - Projets responsive : mise en commun de retours d'expérience</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/redesign-dans-le-navigateur-et-pourquoi-pas.php" title="Redesign dans le navigateur ? Et pourquoi pas !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/monitoring-mise-en-place-doutils-de-monitoring.php" title="Mise en place d'outils de monitoring" />
	...
	<meta name="twitter:title" content="Projets responsive : mise en commun de retours d'expérience" />
	<meta property="twitter:description" content="Il est logique pour un concept récent et pourtant fortement répandu, d’avoir, chacun dans son coin, la sensation de manquer de retours d’expérience sur le sujet. C’est forts de ce constat que Rudy et…" />
	<meta property="dc:title" content="Projets responsive : mise en commun de retours d'expérience" />
	<meta property="og:title" content="Projets responsive : mise en commun de retours d'expérience" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/projets-responsive-mise-en-commun-de-retours-dexperience.php" />
	<meta property="og:description" content="Il est logique pour un concept récent et pourtant fortement répandu, d’avoir, chacun dans son coin, la sensation de manquer de retours d’expérience sur le sujet. C’est forts de ce constat que Rudy et…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Projets responsive : mise en commun de retours d'expérience</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1094">
						<header>
							<h1>Projets responsive : mise en commun de retours d'expérience</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1094">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/projets-responsive-mise-en-commun-de-retours-dexperience.php" class="url">Projets responsive : mise en commun de retours d'expérience</a></span></span></h2>
...
<dd class="column">
15 <abbr title="heures">h</abbr> 50
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>

<dt class="clear span-1">Durée</dt>
<dd class="column">
1 <abbr title="heures">h</abbr> 30 <abbr title="minutes">mn</abbr>
</dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/responsive-design" rel="tag">responsive design</a></dd>
    ...
    <div class="talk-description"><p>Il est logique pour un concept récent et pourtant fortement répandu, d’avoir, chacun dans son coin, la sensation de manquer de retours d’expérience sur le sujet. C’est forts de ce constat que Rudy et Jérémie ont souhaité co-écrire le livre «&nbsp;Projet Responsive Web Design&nbsp;» (Eyrolles), afin d’inspirer les gens les plus perdus à s’appuyer sur leurs retours d’expérience à eux.</p>

<p>Ah, quel bonheur, si l’on pouvait tous profiter des retours d’expérience des autres, pour se sentir plus forts tous ensemble, et avoir la sensation tous ensemble d’acquérir de l’expérience projet&nbsp;!</p>

<p>Durant cet atelier, un document texte sera partagé à tous les participants, leur permettant de partager en temps réel leurs bonnes et mauvaises expériences, leurs conseils et leurs inspirations. Le document et les débats seront organisés autour des phases projet habituelles&nbsp;: d’abord le recueil du besoin, puis le cahier des charges… jusqu’à la mise en ligne !</p>

<p>Évidemment, le document collaboratif sera ensuite mis à disposition publiquement, en <i lang="en">Creative Commons</i>.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/jeremie-patonnier.php">Jérémie Patonnier</a> et <a href="https://www.paris-web.fr/2013/../orateurs/rudy-rigot.php">Rudy Rigot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jérémie Patonnier" src="https://www.paris-web.fr/2013/assets_c/2013/07/JeremiePatonnier-thumb-143x143-349.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Au sortir d’études d’imprimerie et d’arts appliqués, Jérémie se lance dans le Web en tant que designer web. Il découvre alors le développement informatique, trouve ça rigolo et décide de devenir développeur web. Comme ça ne lui suffit toujours pas, il décide de passer au management en devenant responsable d’équipe web. Après toutes ces tribulations, il est maintenant consultant web pour l’agence parisienne du cabinet d’expertises Clever Age. Il est également contributeur au projet Mozilla, où il participe à la documentation des technologies du Web ouvert sur le Mozilla Developer Network (<abbr>MDN</abbr>).</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Rudy Rigot" src="https://www.paris-web.fr/2013/assets_c/2013/06/rudy.rigot.1-thumb-143x143-315.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Même s’il vient initialement du back-end, Rudy s’est très rapidement trouvé intéressé par le front-end, pour plus tard gérer des projets sur l’ensemble de ces problématiques. Il faut dire qu’il a quand même un gros faible pour le front-end : il intervient beaucoup plus souvent dessus en conférences et dans ses articles, et particulièrement à propos du responsive. Avec Jérémie Patonnier, il a co-écrit le livre “Projet Responsive Web Design” en mai 2013 aux éditions Eyrolles, le premier livre à adresser la gestion de projet dans ces contextes. Il est aussi l’un des membres fondateurs des conférences Sud Web, et travaille aujourd’hui sur la prochaine aventure d’innovation de Zenexity (les gens qui ont inventé le Play framework).</p></div>
</div>
