...
<title>Paris Web - Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/css3js-selectors-when-your-html5-has-no-class-3.php" title="CSS3/JS Selectors: When your HTML5 Has No Class" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/le-dessous-des-grilles.php" title="Le dessous des grilles" />
	...
	<meta name="twitter:title" content="Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)" />
	<meta property="twitter:description" content="Vous venez de reprendre un projet : vous vous perdez dans les méandres du code source ? À chaque fois que vous ouvrez un fichier, vous vous demandez comment cela peut-il fonctionner en production ?…" />
	<meta property="dc:title" content="Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)" />
	<meta property="og:title" content="Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/test-unitaire-mock-tdd-kezako-en-finir-avec-les-regressions.php" />
	<meta property="og:description" content="Vous venez de reprendre un projet : vous vous perdez dans les méandres du code source ? À chaque fois que vous ouvrez un fichier, vous vous demandez comment cela peut-il fonctionner en production ?…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1082">
						<header>
							<h1>Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1082">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/test-unitaire-mock-tdd-kezako-en-finir-avec-les-regressions.php" class="url">Test unitaire ? Mock ? TDD ? Kezako ? (En finir avec les régressions)</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/tests" rel="tag">tests</a></dd>
    ...
    <div class="talk-description"><p>Vous venez de reprendre un projet : vous vous perdez dans les méandres du code source ? À chaque fois que vous ouvrez un fichier, vous vous demandez comment cela peut-il fonctionner en production ? Pour une raison encore inconnue, le projet ne compile plus que sur une des machines de l'équipe ? Le dernier fix que vous avez commité a rajouté plus de bugs qu’il n’en a corrigé ?</p>

<p>Si c’est le cas, suivez-moi dans la quête du <i lang="en">Test Driven Development</i>. Nous rencontrerons pléthore d'ennemis contre lesquels nous aurons à combattre : bugs, complexité, code statique, couplage fort. Ils essaieront de nous barrer la route, mais heureusement, nous pourrons compter sur nos alliés jUnit, Mockito, <i lang="en">refactoring</i> et injection/dépendance.</p>

<p>Cette session vous montrera des exemples de <i lang="en">code legacy</i> posant problème, puis nous verrons comment s’organiser au niveau du code, des outils, et de l’équipe pour reprendre en main notre projet et éviter que cela ne se reproduise sur nos prochaines réalisations.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/david-wursteisen.php">David Wursteisen</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="David Wursteisen" src="https://www.paris-web.fr/2013/assets_c/2013/06/David-Wursteisen-thumb-143x143-336.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après être tombé très tôt dans une équipe pratiquant l'eXtreme Programming, David est devenu un "Test Addicted" ! Il continue à propager la "bonne" parole en travaillant sur différents projets et en montrant tout ce qu'apporte le développement piloté par les tests.<br />
</p></div>
</div>
