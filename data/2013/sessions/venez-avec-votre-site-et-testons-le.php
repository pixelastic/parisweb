...
<title>Paris Web - Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos ergonomes (3 heures)</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/rendre-son-application-html5-accessible-en-4-etapes.php" title="Rendre son application HTML5 accessible en 4 étapes" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/atelier-sponsor-seo-smo-et-social-crm-les-meilleures-pratiques.php" title="[Atelier Sponsor] SEO, SMO et Social CRM les meilleures pratiques" />
	...
	<meta name="twitter:title" content="Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos…" />
	<meta property="twitter:description" content="Si vous n'avez pas de site vous pouvez venir aussi. Cet atelier à pour but de vous présenter et de mettre en œuvre une méthodologie de tests utilisateurs en mode DIY (Do It Yourself). Le but de ces…" />
	<meta property="dc:title" content="Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos ergonomes (3 heures)" />
	<meta property="og:title" content="Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos ergonomes (3 heures)" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/venez-avec-votre-site-et-testons-le.php" />
	<meta property="og:description" content="Si vous n'avez pas de site vous pouvez venir aussi. Cet atelier à pour but de vous présenter et de mettre en œuvre une méthodologie de tests utilisateurs en mode DIY (Do It Yourself). Le but de ces…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span><a href="https://www.paris-web.fr/2013/">Programme 2013</a></span>
				<span>Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos ergonomes (3 heures)</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1139">
						<header>
							<h1>Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos ergonomes (3 heures)</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1139">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/venez-avec-votre-site-et-testons-le.php" class="url">Votre site à l'épreuve des tests utilisateurs DIY, on vient avec nos ergonomes (3 heures)</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2013/ateliers/">Atelier</a></dd>
...
<dd class="column">
<a href="/2013/12.php">samedi 12</a>
</dd>
...
<dd class="column">
3 <abbr title="heures">h</abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/tests-utilisateurs" rel="tag">tests utilisateurs</a></dd>
    ...
    <div class="talk-description"><p>Si vous n'avez pas de site vous pouvez venir aussi. Cet atelier à pour but de vous présenter et de mettre en œuvre une méthodologie de tests utilisateurs en mode <abbr>DIY</abbr> (<i lang="en">Do It Yourself</i>). Le but de ces tests est de détecter des problèmes d'utilisabilité sur un site au cours des cycles de développement, afin de les corriger.</p>

<p>Pour l'atelier, nous nous baserons sur des sites proposés par les participants. Les «&nbsp;utilisateurs testeurs&nbsp;» seront aussi les participants. </p>

<p><strong>Venez avec votre ordinateur portable ou votre tablette pour effectuer les tests. Les salles des ateliers ne disposent pas d'ordinateur.</strong></p>

<p>Après une courte présentation de méthodologie, nous nous attaquerons à :<br />
<ul><br />
<li>La rédaction de la consigne</li><br />
<li>La mise en place d'une grille d'observation</li><br />
<li>La mise en place de la passation</li><br />
<li>La passation</li><br />
<li>L'analyse des résultats</li><br />
</ul><br />
Nous échangerons ensuite nos impressions sur ces tests utilisateurs et comment nous pourrions les améliorer ou trouver des variantes en fonctions des besoins.</p>

<p>Les sites proposés doivent être exempts de tous chatons ou de toutes représentations symboliques jugées comme mignonnes ou à la mode.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/julien-champagne.php">Julien Champagne</a> et <a href="https://www.paris-web.fr/2013/../orateurs/raphael-yharrassarry.php">Raphaël Yharrassarry</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Julien Champagne" src="https://www.paris-web.fr/2013/assets_c/2013/07/Julien%20Champagne%20photo-thumb-143x143-350.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>UX Designer depuis 2010, Julien Champagne est passionné par l'univers des start-up. Après avoir travaillé pour Dixid (conseil en ergonomie) et KMB Partners (éditeur de logiciel), il est actuellement UX Designer en freelance.</p>

<p>Julien organise également des événements autour de l'expérience utilisateur (UX) par le biais de <br />
l'association FLUPA (France-Luxembourg User experience Professionnal Association) dont il est membre actif depuis 2011 ainsi que responsable de l'antenne parisienne.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Raphaël Yharrassarry" src="https://www.paris-web.fr/2013/assets_c/2013/06/Raphael-Yharrassarry-thumb-143x143-342.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Issu d’une formation en psychologie et en ergonomie à Paris 5 en 1999, Raphaël Yharrassarry travaille depuis comme ergonome <abbr title="Interface Homme-Machine">IHM</abbr> en Freelance. Il a complété cette formation par un Mastère spécialisé en marketing au <abbr title="Conservatoire National des Arts et Métiers">CNAM</abbr>, afin de mieux comprendre les enjeux commerciaux.</p>

<p>Il réalise de nombreuses missions de conseils, de conceptions et d'évaluations sur des sujets variés allant des applications professionnelles aux services grand public sur la télévision en passant par le web et les tablettes. Il intervient aussi bien auprès de grands groupes, de <abbr title="Petites et Moyennes Entreprises">PME</abbr> que d'administrations.</p>

<p>Dans une volonté de formaliser, de partager et d'approfondir ces connaissances, il crée en 2009 un <a href="http://blocnotes.iergo.fr/">bloc-notes</a> sur l'ergonomie des <abbr>IHM</abbr> et l'expérience utilisateur. Vous pouvez le suivre sur <a href="http://twitter.com/iergo">@iErgo</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2013/ateliers/venez-avec-votre-site-et-testons-le.php&amp;ref=prez-venez-avec-votre-site-et-testons-le&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
...
<section class="news l-fixedColumn l-block l-primary">
		<article>
			<h2>L'édition 2013</h2>
			<ul>
            <li><a class="roll" href="/2013/conferences/" rel="bookmark">Les conférences 2013</a></li>
            <li><a class="roll" href="/2013/10.php" rel="bookmark">Programme du jeudi 10</a></li>
            <li><a class="roll" href="/2013/11.php" rel="bookmark">Programme du vendredi 11</a></li>

            <li><a class="roll" href="/2013/ateliers/" rel="bookmark">Les ateliers 2013</a></li>
            <li><a class="roll" href="/2013/12.php" rel="bookmark">Programme du samedi 12</a></li>
            <li><a class="roll" href="/2013/orateurs/" rel="bookmark">Les orateurs 2013</a></li>
			</ul>
        <ul class="large">
            <li><a href="http://www.paris-web.fr/2013/conferences-parisweb-2013.ics">Calendrier au format iCAL/ics des conférences 2013</a></li>
			<li><a href="http://www.paris-web.fr/2013/ateliers-parisweb-2013.ics">Calendrier au format iCAL/ics des ateliers 2013</a></li>
		</ul>
		</article>
	 </section>
