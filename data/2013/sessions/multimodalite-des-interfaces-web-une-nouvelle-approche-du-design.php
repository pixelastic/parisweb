...
<title>Paris Web - Multimodalité &amp; interfaces. Le design est une question d'humains, pas de machine</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/designing-with-sensors-creating-adaptive-experiences.php" title="Designing with Sensors: Creating Adaptive Experiences" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/conference-informelle-1.php" title="Conférence informelle" />
	...
	<meta name="twitter:title" content="Multimodalité & interfaces. Le design est une question d'humains, pas…" />
	<meta property="twitter:description" content="Sur des projets web, l'interface est souvent restreinte à un format, une taille, une technologie. Cependant, l'interface est, littéralement, la façon dont se présente une relation. Depuis…" />
	<meta property="dc:title" content="Multimodalité & interfaces. Le design est une question d'humains, pas de machine" />
	<meta property="og:title" content="Multimodalité & interfaces. Le design est une question d'humains, pas de machine" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/multimodalite-des-interfaces-web-une-nouvelle-approche-du-design.php" />
	<meta property="og:description" content="Sur des projets web, l'interface est souvent restreinte à un format, une taille, une technologie. Cependant, l'interface est, littéralement, la façon dont se présente une relation. Depuis…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Multimodalité & interfaces. Le design est une question d'humains, pas de machine</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1120">
						<header>
							<h1>Multimodalité & interfaces. Le design est une question d'humains, pas de machine</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/84519562" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/Multimodalite_et_interfaces_design_question_d_humains_pas_de_machine.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1120">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/multimodalite-des-interfaces-web-une-nouvelle-approche-du-design.php" class="url">Multimodalité & interfaces. Le design est une question d'humains, pas de machine</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/design" rel="tag">design</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/geoffrey-dorne.php">Geoffrey  Dorne </a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Geoffrey  Dorne " src="https://www.paris-web.fr/2013/assets_c/2013/06/geoffrey-dorne-thumb-143x143-325.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Geoffrey Dorne est designer, fondateur de son agence de design et de la marque Design & Human. Geoffrey est diplômé de l’Ensad et travaille le numérique et l’imprimé avec la Croix Rouge, la fondation Mozilla, la fondation Wikimedia, le Commissariat à l’Énergie Atomique, EDF, Samsung, Orange, Libération mais également de nombreuses startups, des laboratoires de recherche, des maisons d’éditions, etc. Geoffrey attache un intérêt particulier à l’humain, à la communication, aux interfaces, et à la métaphore, notamment après avoir été chercheur en design à l’EnsadLAB. En parallèle, Geoffrey conseille des entreprises et dispense des cours dans différentes écoles (la Sorbonne, l’Ensci, e-ArtSup, etc.) et écrit sur son blog <a href="http://graphism.fr">Graphism.fr</a>.</p></div>
</div>
