...
<title>Paris Web - Les outils pour développeurs inclus dans les navigateurs Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/ateliers/svg-devenez-maitre-des-vecteurs.php" title="SVG, devenez maître des vecteurs" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/ateliers/rendre-son-application-html5-accessible-en-4-etapes.php" title="Rendre son application HTML5 accessible en 4 étapes" />
	...
	<meta name="twitter:title" content="Les outils pour développeurs inclus dans les navigateurs Web" />
	<meta property="twitter:description" content="De plus en plus d'applications Web peuvent rester ouvertes pendant des heures, si ce n'est des jours, dans le navigateur des utilisateurs. Il devient donc indispensable de savoir comment traquer les…" />
	<meta property="dc:title" content="Les outils pour développeurs inclus dans les navigateurs Web" />
	<meta property="og:title" content="Les outils pour développeurs inclus dans les navigateurs Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/ateliers/les-outils-pour-developpeurs-inclus-dans-les-navigateurs-web.php" />
	<meta property="og:description" content="De plus en plus d'applications Web peuvent rester ouvertes pendant des heures, si ce n'est des jours, dans le navigateur des utilisateurs. Il devient donc indispensable de savoir comment traquer les…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les outils pour développeurs inclus dans les navigateurs Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1088">
						<header>
							<h1>Les outils pour développeurs inclus dans les navigateurs Web</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1088">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/ateliers/les-outils-pour-developpeurs-inclus-dans-les-navigateurs-web.php" class="url">Les outils pour développeurs inclus dans les navigateurs Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2013/recherche/outils" rel="tag">outils</a></dd>
    ...
    <div class="talk-description"><p>De plus en plus d'applications Web peuvent rester ouvertes pendant des heures, si ce n'est des jours, dans le navigateur des utilisateurs. Il devient donc indispensable de savoir comment traquer les fuites mémoires, comment isoler le code qui ralentit le défilement et plus globalement comment maîtriser les outils pour développeurs inclus dans les navigateurs.</p>

<p>Découvrez via cet atelier comment on peut résoudre une série de problèmes fréquemment rencontrés par les développeurs Web en maîtrisant ces outils.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/thomas-bassetto.php">Thomas Bassetto</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Thomas Bassetto" src="https://www.paris-web.fr/2013/assets_c/2013/06/thomas-bassetto-thumb-143x143-316.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Thomas est développeur Front-End chez Soundrop, à Oslo. Avant de partir dans le grand nord, il a travaillé chez Jolicloud à la création d'un système d'exploitation complet basé sur HTML5. Il a aussi travaillé chez Joshfire où il a développé de nombreuses applications pour iOS, Android, BlackBerry 10, Samsung SmartTV ainsi que LG NetTV, toujours en utilisant uniquement des technologies Web.</p>

<p>Thomas est aussi le co-organisateur de la première conférence dotJS.eu ainsi que du meetup PhoneGap Paris.</p></div>
</div>
