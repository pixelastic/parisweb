...
<title>Paris Web - HTML / CSS : bousculez vos habitudes ! </title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2013/conferences/wcag-412-understanding-dom-and-its-importance-for-accessibility-1.php" title="Understanding DOM and its importance for accessibility" />
<link rel="next bookmark" href="https://www.paris-web.fr/2013/conferences/esthetique-et-pratique-du-web-qui-rouille.php" title="Esthétique et pratique du Web qui rouille" />
	...
	<meta name="twitter:title" content="HTML / CSS : bousculez vos habitudes ! " />
	<meta property="twitter:description" content="Depuis que je fais de l'intégration (un paquet d'années), j'ai toujours été très concerné par les standards, l'accessibilité et la sémantique. Il se trouve cependant qu'avec l'expérience, on se rend…" />
	<meta property="dc:title" content="HTML / CSS : bousculez vos habitudes ! " />
	<meta property="og:title" content="HTML / CSS : bousculez vos habitudes ! " />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2013/conferences/html-css-bousculez-vos-habitudes.php" />
	<meta property="og:description" content="Depuis que je fais de l'intégration (un paquet d'années), j'ai toujours été très concerné par les standards, l'accessibilité et la sémantique. Il se trouve cependant qu'avec l'expérience, on se rend…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML / CSS : bousculez vos habitudes ! </span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1105">
						<header>
							<h1>HTML / CSS : bousculez vos habitudes ! </h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/84039028" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2013/bousculez-vos-habitudes.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1105">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2013/conferences/html-css-bousculez-vos-habitudes.php" class="url">HTML / CSS : bousculez vos habitudes ! </a></span></span></h2>
...
<dd class="column location"><a href="/lieux/">Petit auditorium</a></dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2013/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2013/recherche/html" rel="tag">HTML</a><br /><a href="http://www.paris-web.fr/2013/recherche/integration" rel="tag">intégration</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Depuis que je fais de l'intégration (un paquet d'années), j'ai toujours été très concerné par les standards, l'accessibilité et la sémantique.<br />
Il se trouve cependant qu'avec l'expérience, on se rend compte que les contraintes de production et de performances ont bien évolué en 15 ans : à force de respecter d'antiques préceptes on crée des fichiers CSS lourds, redondant, et non réutilisables. C'est pourquoi 12% des plus gros sites mondiaux comptent plus de 50 occurences de "!important".</p>

<p>Ces aberrations peuvent être évitées en utilisant judicieusement des CSS efficaces. <br />
Nicole Sullivan (ex-Yahoo!) a ouvert la voie en créant "OOCSS" (CSS orientés “objet”), d’autres tels que Jonathan Snooks ou Kaelig Deloumeau-Prigent ont suivi le mouvement.</p>

<p>Voyons quelles réelles remises en question nous attendent pour parvenir à nos fins.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2013/../orateurs/raphael-goetter.php">Raphaël Goetter</a></h2>
