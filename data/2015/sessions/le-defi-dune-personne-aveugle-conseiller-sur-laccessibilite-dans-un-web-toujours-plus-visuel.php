...
<title>Paris Web - Le défi d'une personne aveugle : conseiller sur l'accessibilité dans un web toujours plus visuel</title>
...
<link rel="next bookmark" href="https://www.paris-web.fr/2015/informelles-1-4.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Le défi d'une personne aveugle : conseiller sur l'accessibilité dans…" />
	<meta property="twitter:description" content="Retour d'expérience sur les contraintes, difficultés et avantages d'être une experte aveugle avec outils et méthode d'accompagnement" />
	<meta property="dc:title" content="Le défi d'une personne aveugle : conseiller sur l'accessibilité dans un web toujours plus visuel" />
	<meta property="og:title" content="Le défi d'une personne aveugle : conseiller sur l'accessibilité dans un web toujours plus visuel" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/le-defi-dune-personne-aveugle-conseiller-sur-laccessibilite-dans-un-web-toujours-plus-visuel.php" />
	<meta property="og:description" content="Retour d'expérience sur les contraintes, difficultés et avantages d'être une experte aveugle avec outils et méthode d'accompagnement" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le défi d'une personne aveugle : conseiller sur l'accessibilité dans un web toujours plus visuel</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1725">
						<header>
							<h1>Le défi d'une personne aveugle : conseiller sur l'accessibilité dans un web toujours plus visuel</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/141981469" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1725">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/le-defi-dune-personne-aveugle-conseiller-sur-laccessibilite-dans-un-web-toujours-plus-visuel.php" class="url">Le défi d'une personne aveugle : conseiller sur l'accessibilité dans un web toujours plus visuel</a></span></span></h2>
...
<dd class="column">
<a href="/2015/01.php">jeudi 01</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
17 <abbr title="heures">h</abbr> 00
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/accessibilite" rel="tag">Accessibilité</a><br /><a href="http://www.paris-web.fr/2015/recherche/formation" rel="tag">formation</a><br /><a href="http://www.paris-web.fr/2015/recherche/handicap" rel="tag">handicap</a><br /><a href="http://www.paris-web.fr/2015/recherche/integration" rel="tag">intégration</a><br /><a href="http://www.paris-web.fr/2015/recherche/methodologie" rel="tag">Méthodologie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Après plus de 15 ans passés au service de l'accessibilité numérique, j'expliquerai, lors de cette conférence, quels outils ont été mis en place pour me permettre, en tant que personne aveugle, d'exercer le métier que je fais aujourd'hui. En plus de l'aménagement de mon poste de travail, je parlerai des outils spécifiques mis en place, de leur accessibilité, des difficultés rencontrées durant mon parcours professionnel et de la façon dont j'ai pu les surmonter.</p>

<p>Une deuxième partie de cette conférence sera consacrée à l'utilisation d'outils accessibles, et de la mise en place d'une méthodologie et d'une formation pour un référent accessibilité aveugle. Cette formation peut être animée par une personne aveugle en toute autonomie.</p>

<p>En conclusion, les premières conséquences de cette formation seront dévoilées.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/sylvie-duchateau.php">Sylvie Duchateau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Sylvie Duchateau" src="https://www.paris-web.fr/2015/assets_c/2015/09/Sylvie%20Duchateau-thumb-143x143-523.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après des études en langues étrangères appliquées anglais-allemand et en science politique, Sylvie Duchateau a travaillé pendant 15 ans au sein de l'Association BrailleNet.
Depuis septembre 2014, elle est associée de la société Access42, www.access42.net
Elle a contribué à la rédaction des différentes versions du Référentiel AccessiWeb. Elle a coordonné la traduction française des WCAG, recommandations internationales, norme ISO, du W3C sur les contenus web, et leurs documents d'accompagnement.
Elle a effectué des sensibilisations, des formations à l'accessibilité numérique et rédigé des guides pour la création de documents accessibles. Depuis 1999, elle participe activement au groupe de travail Education and Outreach de W3C/WAI (www.w3.org/WAI/EO/).
Au sein d'Access42, elle effectue des formations, du conseil et de la sensibilisation à l'accessibilité numérique.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/le-defi-dune-personne-aveugle-conseiller-sur-laccessibilite-dans-un-web-toujours-plus-visuel.php&amp;ref=prez-le-defi-dune-personne-aveugle-conseiller-sur-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
