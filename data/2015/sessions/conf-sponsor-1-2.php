...
<title>Paris Web - [Conf Sponsor] Les données animées en temps réel : c’est quoi ? pourquoi faire ? et comment les intégrer ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/le-styleguide-bien-alimente-il-tient-ses-promesses.php" title="Le styleguide, bien alimenté il tient ses promesses" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/informelles-1-3.php" title="Informelles" />
	...
	<meta name="twitter:title" content="[Conf Sponsor] Les données animées en temps réel : c’est quoi ?…" />
	<meta property="twitter:description" content="Tous les sites mettent maintenant du CSS pour animer l’apparition du contenu car notre cerveau est très réceptif et attentif aux choses qui bougent… Mais, si au lieu de mettre des “objets inanimés…" />
	<meta property="dc:title" content="[Conf Sponsor] Les données animées en temps réel : c’est quoi ? pourquoi faire ? et comment les intégrer ?" />
	<meta property="og:title" content="[Conf Sponsor] Les données animées en temps réel : c’est quoi ? pourquoi faire ? et comment les intégrer ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/conf-sponsor-1-2.php" />
	<meta property="og:description" content="Tous les sites mettent maintenant du CSS pour animer l’apparition du contenu car notre cerveau est très réceptif et attentif aux choses qui bougent… Mais, si au lieu de mettre des “objets inanimés…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Conf Sponsor] Les données animées en temps réel : c’est quoi ? pourquoi faire ? et comment les intégrer ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1849">
						<header>
							<h1>[Conf Sponsor] Les données animées en temps réel : c’est quoi ? pourquoi faire ? et comment les intégrer ?</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/141981466" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1849">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/conf-sponsor-1-2.php" class="url">[Conf Sponsor] Les données animées en temps réel : c’est quoi ? pourquoi faire ? et comment les intégrer ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/streaming-api" rel="tag">streaming API</a><br /><a href="http://www.paris-web.fr/2015/recherche/ui" rel="tag">UI</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Tous les sites mettent maintenant du CSS pour animer l’apparition du contenu car notre cerveau est très réceptif et attentif aux choses qui bougent… Mais, si au lieu de mettre des “objets inanimés qui bougent”, nous mettions des données utiles qui évoluent en temps réel, l’impact sur nos visiteurs/utilisateurs seraient bien plus grand.</p>

<p>La bonne nouvelle c’est que le temps réel n’est plus réservé aux traders new-yorkais en chemise rayée… Il y a des données temps réel dans les réseaux sociaux, les informations, dans les stocks des super-promos, dans les prix, dans l’économie du partage, dans les transports… Bref partout ! Soit la mise à jour de la donnée a une utilité pratique / commerciale, soit vous pouvez proposer à votre utilisateur le tout dernier contenu utile !</p>

<p>Nous vous proposons d’apprendre comme transformer une UI mort-vivante en une UI pleine de vie avec des données animées en temps réel : quelles données ? Comment les communiquer efficacement à vos applications/sites web ? Comment les afficher ?</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/cedric-tran-xuan.php">Cédric Tran-Xuan</a> et <a href="https://www.paris-web.fr/2015/../orateurs/allan-denis.php">Allan Denis</a></h2>
...
<div class="speaker-bio"><p>Cédric est développeur chez <a href="http://streamdata.io/">Streamdata.io</a>. Il a 12 ans d’expériences et se réjouit lors des confs, des JUG et autres Human Talks en discutant technique et geekeries. Il aime faire des treks ou du ski de fond.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Allan Denis" src="https://www.paris-web.fr/2015/assets_c/2015/09/Allan%20Denis-thumb-143x143-511.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Allan est le product owner de <a href="http://streamdata.io">streamdata.io</a>. Il a plus de 10 ans d’expérience dans le développement mobile et distribué. Du back-end pour les produits au front-end pour les démos clients, il est multi-facette !
Il est agile en méthodo projet mais aussi sur sa moto … et il aura la larme à l'oeil si vous venez lui parler de ses années en Afrique !</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/conf-sponsor-1-2.php&amp;ref=prez-conf-sponsor-1-2&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
