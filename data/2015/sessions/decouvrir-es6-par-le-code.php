...
<title>Paris Web - Découvrir ES6 par le code</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/pause-3.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/privacy-by-designer-delivering-personalisation-privacy-from-flow-to-finish.php" title="Privacy-by-designer: delivering personalisation &amp; privacy from flow to finish" />
	...
	<meta name="twitter:title" content="Découvrir ES6 par le code" />
	<meta property="twitter:description" content="Livecoding pour transformer un code en JavaScript standard en ES6 et parcourir les nouveaux concepts: classes, promesses, generators…" />
	<meta property="dc:title" content="Découvrir ES6 par le code" />
	<meta property="og:title" content="Découvrir ES6 par le code" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/decouvrir-es6-par-le-code.php" />
	<meta property="og:description" content="Livecoding pour transformer un code en JavaScript standard en ES6 et parcourir les nouveaux concepts: classes, promesses, generators…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Découvrir ES6 par le code</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1728">
						<header>
							<h1>Découvrir ES6 par le code</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/144521293" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1728">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/decouvrir-es6-par-le-code.php" class="url">Découvrir ES6 par le code</a></span></span></h2>
...
<dd class="column">
11 <abbr title="heures">h</abbr> 15
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/babel" rel="tag">Babel</a><br /><a href="http://www.paris-web.fr/2015/recherche/javascript" rel="tag">JavaScript</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>ES6, la nouvelle version du JavaScript est à la mode. Vous avez peut-être déjà vu une conférence à ce sujet, mais comment se faire une idée en ne faisant que parcourir une liste de nouvelles syntaxes ?</p>

<p>Ici, nous allons faire du code ! En partant d'une base de code en JavaScript « standard », nous allons la transformer progressivement avec toutes les nouvelles notations.</p>

<p>Nous passerons ainsi en revue la plupart des nouveaux concepts. En commençant par les facilités de syntaxe mais en étudiant aussi les nouveaux paradigmes comme les classes, les promesses jusqu'aux generators.</p>

<p>Le livecoding sera réalisé avec un environnement de build avec Gulp, Webpack et Babel. Rien que vous ne puissiez reproduire chez vous le soir même !</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/matthieu-lux.php">Matthieu Lux</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Matthieu Lux" src="https://www.paris-web.fr/2015/assets_c/2015/05/Matthieu%20Lux-thumb-143x143-477.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Développeur, formateur et responsable de l'offre web au sein de l'agence lyonnaise de Zenika.</p>

<p>Après une solide expérience dans le monde Java, je suis focalisé aujourd'hui sur le monde du Web et du JavaScript. Plus précisément, mes technologies de prédilection sont actuellement Angular, Gulp, Yeoman, Node et React.</p>

<p>J'ai également donné un certain nombre de talks sur Angular au MixIt, mais aussi au DevoxxFR et même au <a href="https://www.youtube.com/watch?v=Mk2WwSxK218">ngEurope</a></p>

<p>J'organise également le LyonJS, le meetup JavaScript de Lyon <a href="http://www.meetup.com/LyonJS/">http://www.meetup.com/LyonJS/</a></p>

<p>J'ai enfin créé un générateur Yeoman <a href="https://github.com/Swiip/generator-gulp-angular">generator-gulp-angular</a> qui propose le démarrage de projets basées sur les technologies Angular &amp; Gulp.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/decouvrir-es6-par-le-code.php&amp;ref=prez-decouvrir-es6-par-le-code&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
