...
<title>Paris Web - Evaluer l'UX : des méthodes simples mais efficaces !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/tester-laccessibilite-de-son-site-web-avec-nvda.php" title="Tester l'accessibilité de son site Web avec NVDA" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/le-prototypage-rapide.php" title="Le prototypage rapide" />
	...
	<meta name="twitter:title" content="Evaluer l'UX : des méthodes simples mais efficaces !" />
	<meta property="twitter:description" content="Découvrez des méthodes clés pour évaluer l'UX et apprenez à les appliquer dans vos projets." />
	<meta property="dc:title" content="Evaluer l'UX : des méthodes simples mais efficaces !" />
	<meta property="og:title" content="Evaluer l'UX : des méthodes simples mais efficaces !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/evaluer-lux-des-methodes-simples-mais-efficaces.php" />
	<meta property="og:description" content="Découvrez des méthodes clés pour évaluer l'UX et apprenez à les appliquer dans vos projets." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Evaluer l'UX : des méthodes simples mais efficaces !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1739">
						<header>
							<h1>Evaluer l'UX : des méthodes simples mais efficaces !</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/gsi47IAHoR2A5w" 
	...
	<section class="s-talk-subject" id="sujet-1739">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/evaluer-lux-des-methodes-simples-mais-efficaces.php" class="url">Evaluer l'UX : des méthodes simples mais efficaces !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/methodologie" rel="tag">Méthodologie</a><br /><a href="http://www.paris-web.fr/2015/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>L’expérience utilisateur (UX) est devenu un facteur concurrentiel crucial sur le marché des produits et systèmes interactifs. Améliorer l’expérience utilisateur durant le cycle de développement d’un produit nécessite notamment de savoir l’évaluer. Or, les méthodes traditionnelles d’évaluation de l’utilisabilité ne sont pas adaptées à l’évaluation de l’UX. Parfois méconnues des professionnels, plusieurs méthodes existent pour évaluer l’UX.</p>

<p>Dans cet atelier, nous proposerons d'abord une vue globale des méthodes d’évaluation de l’UX, des plus classiques aux plus innovantes. Vous saurez ainsi sélectionner les méthodes les plus adaptées à votre projet et vos ressources. 
Nous nous centrerons ensuite sur 3 méthodes d'évaluation simples mais efficaces et vous découvrirez de manière pragmatique comment les utiliser pour évaluer l'UX dans vos projets.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/carine-lallemand.php">Carine Lallemand</a> et <a href="https://www.paris-web.fr/2015/../orateurs/guillaume-gronier.php">Guillaume Gronier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Carine Lallemand" src="https://www.paris-web.fr/2015/assets_c/2015/05/Carine%20Lallemand-thumb-143x143-485.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Carine est chercheur en psychologie et ergonomie des interactions homme-machine (IHM) à l'Université de Luxembourg. Spécialisée dans la conception et l’évaluation de l’expérience utilisateur (UX), elle mobilise les théories psychologiques pour promouvoir une approche expérientielle du design des systèmes interactifs. Impliquée depuis plusieurs années dans l'association FLUPA, elle intervient fréquemment dans l’organisation et l'animation d’évènements sur l'expérience utilisateur. Depuis 2012, Carine enseigne l’ergonomie des IHM à l’Université de Lorraine. Enfin, elle rédige le <a href="http://uxmind.eu">blog UXMind</a> afin de faire le lien entre recherche et pratique en transférant les résultats des travaux académiques sur l'UX vers le monde professionnel.</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Guillaume Gronier" src="https://www.paris-web.fr/2015/assets_c/2015/05/guillaume_gronier_2012_450-thumb-143x143-483.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Psychologue depuis 2001, docteur en psychologie et ergonomie depuis 2006, Guillaume Gronier est actuellement Senior Researcher au Luxembourg Institute of Science and Technology (LIST). Ses principaux domaines de recherche concernent la psychologie et l’ergonomie cognitive ; l’ergonomie des IHM (expérience utilisateur, utilisabilité, conception centrée utilisateur…) ; l’acceptation des technologies de l’information et de la communication ; et le travail collaboratif, en présence et assistée par ordinateur. Il est l’auteur ou le co-auteur d’une cinquantaine d’articles nationaux et internationaux, parus dans des actes de conférences ou des journaux scientifiques. Il gère et contribue à différents projets de recherche, nationaux ou européens. En parallèle, il enseigne la psychologie du travail, la psychologie cognitive et l’ergonomie des IHM dans différentes universités : Université de Lorraine (Metz et Nancy), Université Libre de Bruxelles et à la Hochschule für Technik und Wirtschaft des Saarlandes.
Il a contribué à fonder l’association FLUPA (France-Luxembourg User Experience Professionals’ Association) avec une poignée de passionnés de l’UX en 2008, qu'il a présidé entre 2010 et 2014. Il en est aujourd’hui le vice-président.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/evaluer-lux-des-methodes-simples-mais-efficaces.php&amp;ref=prez-evaluer-lux-des-methodes-simples-mais-efficac&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
