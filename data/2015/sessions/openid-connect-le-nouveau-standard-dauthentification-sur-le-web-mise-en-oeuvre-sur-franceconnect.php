...
<title>Paris Web - OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur FranceConnect</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/le-run-ou-la-tierce-maintenance-applicative.php" title="Le « RUN » (ou la Tierce Maintenance Applicative)" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/pause-dejeuner.php" title="Pause déjeuner" />
	...
	<meta name="twitter:title" content="OpenID Connect, le nouveau standard d'authentification sur le web :…" />
	<meta property="twitter:description" content="OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur le projet FranceConnect." />
	<meta property="dc:title" content="OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur FranceConnect" />
	<meta property="og:title" content="OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur FranceConnect" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/openid-connect-le-nouveau-standard-dauthentification-sur-le-web-mise-en-oeuvre-sur-franceconnect.php" />
	<meta property="og:description" content="OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur le projet FranceConnect." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur FranceConnect</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1748">
						<header>
							<h1>OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur FranceConnect</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/143169752" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1748">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/openid-connect-le-nouveau-standard-dauthentification-sur-le-web-mise-en-oeuvre-sur-franceconnect.php" class="url">OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur FranceConnect</a></span></span></h2>
...
<dd class="column">
12 <abbr title="heures">h</abbr> 35
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/identite" rel="tag">identité</a><br /><a href="http://www.paris-web.fr/2015/recherche/securite" rel="tag">sécurité</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>FranceConnect est un nouvel outil visant à améliorer l'accès aux administrations françaises en facilitant l'authentification et l'identification des usagers.
Pour cela, nous avons mis en oeuvre le protocole OpenID Connect.</p>

<p>Ce protocole ouvert basé sur OAuth2, successeur de OpenID, et soutenu par des grands acteurs, permet à une application cliente d'utiliser n'importe quel fournisseur d'identité pourvu qu'il implémente aussi ce standard.</p>

<p>Nous verrons dans cette présentation quels sont les cas d'usages de ce protocole (authentification sur le web, sur des applications mobiles…), quels sont ses avantages et inconvénients, et comment le mettre en oeuvre avec Node.js.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/francois-petitit.php">François Petitit</a></h2>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/openid-connect-le-nouveau-standard-dauthentification-sur-le-web-mise-en-oeuvre-sur-franceconnect.php&amp;ref=prez-openid-connect-le-nouveau-standard-dauthentif&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
