...
<title>Paris Web - Observer les utilisateurs en condition réelle pour mieux comprendre les enjeux du contexte et les besoins</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/amelioration-progressive-de-la-theorie-a-la-pratique.php" title="Amélioration progressive de la théorie à la pratique" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/faire-son-testament-numerique.php" title="Faire son testament numérique" />
	...
	<meta name="twitter:title" content="Observer les utilisateurs en condition réelle pour mieux comprendre…" />
	<meta property="twitter:description" content="Observer les utilisateurs en condition réelle pour mieux comprendre les enjeux du contexte ainsi que les besoins des utilisateurs." />
	<meta property="dc:title" content="Observer les utilisateurs en condition réelle pour mieux comprendre les enjeux du contexte et les besoins" />
	<meta property="og:title" content="Observer les utilisateurs en condition réelle pour mieux comprendre les enjeux du contexte et les besoins" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/observer-un-utilisateur-dans-son-milieu-naturel-pour-mieux-concevoir.php" />
	<meta property="og:description" content="Observer les utilisateurs en condition réelle pour mieux comprendre les enjeux du contexte ainsi que les besoins des utilisateurs." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Observer les utilisateurs en condition réelle pour mieux comprendre les enjeux du contexte et les besoins</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1740">
						<header>
							<h1>Observer les utilisateurs en condition réelle pour mieux comprendre les enjeux du contexte et les besoins</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/HpkRTftsRuPP5p" 
	...
	<section class="s-talk-subject" id="sujet-1740">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/observer-un-utilisateur-dans-son-milieu-naturel-pour-mieux-concevoir.php" class="url">Observer les utilisateurs en condition réelle pour mieux comprendre les enjeux du contexte et les besoins</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2015/recherche/methodologie" rel="tag">Méthodologie</a><br /><a href="http://www.paris-web.fr/2015/recherche/observation" rel="tag">observation</a><br /><a href="http://www.paris-web.fr/2015/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>Lorsque l'on souhaite développer un nouveau produit (ou en améliorer un existant) la tendance est de produire des éléments avant même de comprendre l'usage actuel.</p>

<p>Prendre le temps d'observer, c'est se donner l'avantage d'éviter toute spéculation sur une utilisation potentielle du produit. Cela nous permet de nous confronter à la réalité telle quelle est vécue par les utilisateurs dans leur contexte d'usage.</p>

<p>Cet atelier a pour but de donner les principaux réflexes à avoir pour réaliser de bonnes observations et en retirer des données qualitatives qui permettront une conception plus proche des réels besoins utilisateurs.</p>

<p>L'atelier s'effectuera en deux temps : une première partie théorique expliquera comment réaliser une bonne observation et sera illustrée par des retours d'expérience. La deuxième partie se voudra pratique, les participants seront amenés à construire une grille d'observation et à l'appliquer sur une vidéo montrant l'utilisation d'un produit.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/julien-champagne.php">Julien Champagne</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Julien Champagne" src="https://www.paris-web.fr/2015/assets_c/2015/09/Julien%20Champagne-thumb-143x143-515.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>UX Designer passionné par les nouvelles technologies, il réalise de nombreuses missions pour différentes agences et annonceurs, allant de l'interface métier aux applications grands publics.</p>

<p>Son but est de sensibiliser les différents acteurs à l'importance de la compréhension des besoins utilisateurs au travers d'événements organisés avec l'association FLUPA dont il est membre depuis 2011.</p>

<p>Il est également enseignant depuis 3 ans dans de nombreuses écoles parisiennes (formation multimédia, ingénieur…) où il partage avec passion ses connaissances sur l'UX.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/observer-un-utilisateur-dans-son-milieu-naturel-pour-mieux-concevoir.php&amp;ref=prez-observer-un-utilisateur-dans-son-milieu-natur&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
