...
<title>Paris Web - Quoi de neuf sous le ciel de la sécurité du web et des internets</title>
...
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/death-and-ux-digital-afterlife-and-digital-legacy.php" title="Death and UX: Digital Afterlife and Digital Legacy" />
	...
	<meta name="twitter:title" content="Quoi de neuf sous le ciel de la sécurité du web et des internets" />
	<meta property="twitter:description" content="Sensibiliser les développeurs web aux bonnes pratiques pour livrer une appli web conforme à l'état de l'art et aux normes." />
	<meta property="dc:title" content="Quoi de neuf sous le ciel de la sécurité du web et des internets" />
	<meta property="og:title" content="Quoi de neuf sous le ciel de la sécurité du web et des internets" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/quoi-de-neuf-sous-le-ciel-de-la-securite-du-web-et-des-internets.php" />
	<meta property="og:description" content="Sensibiliser les développeurs web aux bonnes pratiques pour livrer une appli web conforme à l'état de l'art et aux normes." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Quoi de neuf sous le ciel de la sécurité du web et des internets</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1716">
						<header>
							<h1>Quoi de neuf sous le ciel de la sécurité du web et des internets</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/142169444" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1716">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/quoi-de-neuf-sous-le-ciel-de-la-securite-du-web-et-des-internets.php" class="url">Quoi de neuf sous le ciel de la sécurité du web et des internets</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/securite" rel="tag">sécurité</a><br /><a href="http://www.paris-web.fr/2015/recherche/w3c" rel="tag">W3C</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Chacun d'entre nous se sent de plus en plus concerné par les enjeux de la sécurité et de la confiance dans les outils connectés. Les applications web méritent que l'on prenne en compte ces nouvelles attentes des utilisateurs.</p>

<p>Afin de contrer la pratique honteuse qui consiste à ne penser à la sécurité qu'à la fin des projets, cette présentation tentera de sensibiliser les développeurs web aux risques et attaques du web (en remontant des couches hardwares aux couches softwares). Puis nous reverrons les outils mis à disposition pour blinder son développement web (bonnes pratiques de l'OWASP, normes W3C implémentées dans les navigateurs, frameworks spécialisés en sécurité incluant le chiffrement, l'authentification, la permission). Enfin, nous discuterons des fonctionnalités en discussion au W3C, relatives à la sécurité.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/virginie-galindo.php">Virginie Galindo</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Virginie Galindo" src="https://www.paris-web.fr/2015/assets_c/2015/05/vgalindo-thumb-143x143-260-thumb-143x143-462.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Virginie promeut la sécurité du web depuis 3 années maintenant, chair du groupe W3C Web Crypto, W3C Web Security Interest Group et élue à l'Advisory Board du W3C.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/quoi-de-neuf-sous-le-ciel-de-la-securite-du-web-et-des-internets.php&amp;ref=prez-quoi-de-neuf-sous-le-ciel-de-la-securite-du-w&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
