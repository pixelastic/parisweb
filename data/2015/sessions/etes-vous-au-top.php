...
<title>Paris Web - Êtes-vous au top ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/informelles-1-3.php" title="Informelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/changement-de-salle-3.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Êtes-vous au top ?" />
	<meta property="twitter:description" content="Comment s'entrainer, être  plus affuté, au top de son « art », avec un jeu d'activités à pratiquer régulièrement." />
	<meta property="dc:title" content="Êtes-vous au top ?" />
	<meta property="og:title" content="Êtes-vous au top ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/etes-vous-au-top.php" />
	<meta property="og:description" content="Comment s'entrainer, être  plus affuté, au top de son « art », avec un jeu d'activités à pratiquer régulièrement." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Êtes-vous au top ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1756">
						<header>
							<h1>Êtes-vous au top ?</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/143791974" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1756">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/etes-vous-au-top.php" class="url">Êtes-vous au top ?</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Alors que nous mettons tous nos efforts pour livrer un travail de qualité dans nos projets, nous ne prenons jamais le temps nécessaire pour faire le point sur notre manière de travailler et notre niveau de performance pendant le projet. Nous avons même parfois l’impression à l’issue du projet que nous aurions pu mieux faire. Peut-être manquons-nous d’entrainement ? Comment savoir et, d’ailleurs, comment faire pour nous entrainer ? Sur qui nous baser les athlètes ? Les musiciens ? Les chirurgiens ? Ce n’est pas non plus en prenant des projets « à côté », parce que ce ne sont que des projets en plus !</p>

<p>Je vous propose de découvrir différentes approches d’entrainement, pour augmenter vos capacités cognitives, analytiques, créatives, empathiques. Un petit arsenal pour vous exercer régulièrement seul ou en équipe et être au top de votre forme.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/natacha-hennocq.php">Natacha Hennocq</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Natacha Hennocq" src="https://www.paris-web.fr/2015/assets_c/2015/09/Natacha%20Hennocq-thumb-143x143-519.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Natacha Hennocq est une UX designer chevronée, en charge de l'expérience utilisateur globale multi-écran sur le portail Orange depuis 7 ans.</p>

<p>Après des études en neurophysiologie, en écologie théorique et biologie de l'évolution, elle se tourne vers une autre forme de résolution de problème, appliquée au design interactif, à l'architecture de l'information, la recherche utilisateur. Elle dispense des formations en interne et enseigne dans différents établissements parisiens, dont l'IESA, et co-anime un meetup XX+UX à Paris.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/etes-vous-au-top.php&amp;ref=prez-etes-vous-au-top&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
