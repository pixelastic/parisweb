...
<title>Paris Web - Webperf 2.0</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/pause-dejeuner.php" title="Pause déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/confessions-dun-serial-killer.php" title="Confessions d'un serial killer" />
	...
	<meta name="twitter:title" content="Webperf 2.0" />
	<meta property="twitter:description" content="Venez découvrir pourquoi les anciennes règles webperf sont dépassées alors qu'HTTP2 débarque et que la moitié du surf se fait sur mobile." />
	<meta property="dc:title" content="Webperf 2.0" />
	<meta property="og:title" content="Webperf 2.0" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/webperf-20.php" />
	<meta property="og:description" content="Venez découvrir pourquoi les anciennes règles webperf sont dépassées alors qu'HTTP2 débarque et que la moitié du surf se fait sur mobile." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Webperf 2.0</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1720">
						<header>
							<h1>Webperf 2.0</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/145318582" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
...
<a href="https://github.com/stefounet/webperf2.0" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1720">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/webperf-20.php" class="url">Webperf 2.0</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/html" rel="tag">HTML</a><br /><a href="http://www.paris-web.fr/2015/recherche/http" rel="tag">HTTP</a><br /><a href="http://www.paris-web.fr/2015/recherche/performance-web" rel="tag">Performance web</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Les règles webperf édictées en 2007 et 2009 par Steve Souders sont-elles encore d'actualité alors qu'HTTP/2.0 pointe le bout de son nez et que la moitié du surf se fait sur mobile ? Venez le découvrir !</p>

<p>Après une courte introduction sur ce qu'est la webperf et pourquoi il est essentiel d'avoir un site rapide, nous ferons le point sur les règles de base et pourquoi elles existent comme ça (concaténation, minification, sharding, spriting, etc.)
Nous ferons l'examen de ces règles pour découvrir pourquoi certaines ne sont plus d'actualités à cause du mobile et du HTTP2. </p>

<p>Le coeur de la présentation sera consacré aux nouveautés en terme de webperf :</p>

<ul>
<li>Formats d'image (webp, jpeg-xr, libjpeg)</li>
<li>Protocoles &amp; RFC : SPDY, HTTP2.0, QUIC, resources hints (preload, prerender, preconnect)</li>
<li>Font loading</li>
<li>HTML5 : async, defer, postpone/lazyload, picture, service worker</li>
<li>Outils de mesures et de diagnostic</li>
</ul>

<p>Le but est de comprendre ce qui nous attend avec les nouveaux navigateurs et de repartir avec une vision nouvelle des chantiers webperf sur lesquels vous allez travailler !</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/stephane-rios.php">Stéphane Rios</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Rios" src="https://www.paris-web.fr/2015/assets_c/2015/09/Stephane%20Rios-thumb-143x143-522.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Pendant 10 ans, Stéphane Rios a été directeur technique (CTO) de RueDuCommerce.com, leader du e-commerce français.</p>

<p>Il a accompagné et soutenu la croissance d'un site web qui a vu chaque année son trafic doubler. Membre du Comité de Direction, il a activement participé au succès de l'un des rares pure-players du e-commerce devenu profitable.</p>

<p>Obsédé de l'octet en trop, du gaspillage de temps et d'énergie, Stéphane Rios a hissé RueDuCommerce en tête des classements des sites performants avant de se lancer dans l'aventure Fasterize. Il a géré des équipes techniques conséquentes tout en restant un geek passionné de développement et d'architectures web hautement disponibles et performantes.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/webperf-20.php&amp;ref=prez-webperf-20&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
