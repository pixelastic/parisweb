...
<title>Paris Web - ES6 c'est maintenant, les gens !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conclusion.php" title="Conclusion" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/tester-laccessibilite-de-son-site-web-avec-nvda.php" title="Tester l'accessibilité de son site Web avec NVDA" />
	...
	<meta name="twitter:title" content="ES6 c'est maintenant, les gens !" />
	<meta property="twitter:description" content="Rien de plus facile aujourd'hui que d'utiliser ES6, côté serveur comme client (IE9+). Utilisons ses nouveautés !" />
	<meta property="dc:title" content="ES6 c'est maintenant, les gens !" />
	<meta property="og:title" content="ES6 c'est maintenant, les gens !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/es6-cest-maintenant-les-gens.php" />
	<meta property="og:description" content="Rien de plus facile aujourd'hui que d'utiliser ES6, côté serveur comme client (IE9+). Utilisons ses nouveautés !" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>ES6 c'est maintenant, les gens !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1729">
						<header>
							<h1>ES6 c'est maintenant, les gens !</h1>
						</header>
...
<a href="http://tdd.github.io/parisweb-2015-workshop/" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1729">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/es6-cest-maintenant-les-gens.php" class="url">ES6 c'est maintenant, les gens !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/javascript" rel="tag">JavaScript</a><br /><a href="http://www.paris-web.fr/2015/recherche/langage" rel="tag">langage</a></dd>
    ...
    <div class="talk-description"><p>Grâce à des transpileurs de qualité comme Babel, il est possible depuis déjà 2014 d'utiliser la majorité des nouveautés de ES6 partout où ES5 est disponible. Donc Node.js / io.js et, côté navigateurs, IE9+ et tous les autres…</p>

<p>Code plus concis, plus performant, plus propre, plus puissant : ES6 réconcilie beaucoup de monde avec JavaScript, et fait pleurer de joie celles et ceux qui n'avaient pas besoin d'être converti-e-s.</p>

<p>Dans cet atelier, nous allons découvrir et pratiquer autant de nouveautés ES6 que le temps nous le permettra, histoire de démystifier la bête, vous prouver que ça marche déjà, et vous donner envie de sauter le pas dès maintenant !</p>
</div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/es6-cest-maintenant-les-gens.php&amp;ref=prez-es6-cest-maintenant-les-gens&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
