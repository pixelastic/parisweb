...
<title>Paris Web - Découper son application monolithique : Pourquoi ? Comment ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/pasdecalaisfr-histoire-dune-demarche-daccessibilite.php" title="Pasdecalais.fr, histoire d'une démarche d'accessibilité" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/informelles-2-4.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Découper son application monolithique : Pourquoi ? Comment ?" />
	<meta property="twitter:description" content="Si elles ont leurs avantages au début d'un projet (une seule base de code, une seule suite de tests, une seule façon de déployer) les applications monolithiques ont néanmoins de nombreux…" />
	<meta property="dc:title" content="Découper son application monolithique : Pourquoi ? Comment ?" />
	<meta property="og:title" content="Découper son application monolithique : Pourquoi ? Comment ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/decouper-son-application-monolithique-pourquoi-comment.php" />
	<meta property="og:description" content="Si elles ont leurs avantages au début d'un projet (une seule base de code, une seule suite de tests, une seule façon de déployer) les applications monolithiques ont néanmoins de nombreux…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Découper son application monolithique : Pourquoi ? Comment ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1864">
						<header>
							<h1>Découper son application monolithique : Pourquoi ? Comment ?</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/144521294" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
...
<a href="https://speakerdeck.com/odolbeau/slicing-up-a-monolithic-application-why-and-how" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1864">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/decouper-son-application-monolithique-pourquoi-comment.php" class="url">Découper son application monolithique : Pourquoi ? Comment ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/decoupage" rel="tag">découpage</a><br /><a href="http://www.paris-web.fr/2015/recherche/microservices" rel="tag">microservices</a><br /><a href="http://www.paris-web.fr/2015/recherche/soa" rel="tag">soa</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Si elles ont leurs avantages au début d'un projet (une seule base de code, une seule suite de tests, une seule façon de déployer) les applications monolithiques ont néanmoins de nombreux inconvénients lorsque le projet grossit.</p>

<p>Ça tombe bien, la mode est aux micro-services, au SOA et autres buzzwords de ce genre. :)</p>

<p>Sous forme d'un retour d'expérience, nous verrons ensemble quels sont ces problèmes et en quoi les micro-services sont une excellente alternative.</p>

<p>Nous verrons ensuite pourquoi et comment BlaBlaCar a décidé de découper son application actuelle et quels ont été les impacts techniques mais également humains et organisationnels.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/benjamin-fraud.php">Benjamin Fraud</a> et <a href="https://www.paris-web.fr/2015/../orateurs/olivier-dolbeau.php">Olivier Dolbeau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Benjamin Fraud" src="https://www.paris-web.fr/2015/assets_c/2015/08/benjamin-fraud-thumb-143x143-510.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Dévelopeur @BlaBlaCar, Amateur de musique progressive &amp; Inventeur du théorème de l'hésitation.</p>

<p>Développeur chez BlaBlaCar depuis mai 2014, il est passionné par Brigitte, sa plante verte. Il a découvert le monde du Web un peu par hasard, et a très vite attrapé le virus du "Moi aussi j'veux faire du HTML". D'abord développeur à ses heures perdues, il consacre désormais ses journées à apprendre toujours plus, avec le sérieux d'un moine Bouddhiste influencé par 9gag. Il se passionne également pour les Lego Technic, avec lesquels il ambitionne de créer des drones pour les vendre à Amazon. Bercé depuis des années par le rock progressif, il apprécie la complexité de cette musique et déverse toute sa sensibilité artistique jusque dans son code, qui soyons honnête, est magnifique.</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Olivier Dolbeau" src="https://www.paris-web.fr/2015/assets_c/2015/08/olivier-dolbeau-thumb-143x143-509.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Web Developer / Architect, Symfony2 fan, #swarrot maintainer, be[a|e]r lover.</p>

<p>Quand il ne traîne pas dans des salles de concert ou dans un bar à siroter quelques pintes, Olivier prend parfois le temps de se rendre dans les locaux de BlaBlaCar où il bosse comme Architecte web après avoir passé quelques années côté développement.
Fan d'ElasticSearch, amoureux de RabbitMQ, il contribue également autant que possible au monde de l'open source. Etant feignant (parmi de nombreuses autres qualités), Olivier aime également automatiser tout ce qui peut l'être, de l'intégration continue à l'installation de serveurs.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/decouper-son-application-monolithique-pourquoi-comment.php&amp;ref=prez-decouper-son-application-monolithique-pourquo&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
