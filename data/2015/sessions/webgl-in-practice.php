...
<title>Paris Web - WebGL in practice</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/desendettement-de-code-javascript-le-guide-anti-crise.php" title="Désendettement de code Javascript : le guide anti-crise" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/creer-et-partager-sa-single-page-application-en-1h-avec-react-nodejs-pouchdb-et-npm.php" title="Créer et partager sa single-page application en 1h avec React, Node.js, PouchDB et NPM" />
	...
	<meta name="twitter:title" content="WebGL in practice" />
	<meta property="twitter:description" content="Build compelling 3D applications in the browser with Three.js #webgl" />
	<meta property="dc:title" content="WebGL in practice" />
	<meta property="og:title" content="WebGL in practice" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/webgl-in-practice.php" />
	<meta property="og:description" content="Build compelling 3D applications in the browser with Three.js #webgl" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>WebGL in practice</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1733">
						<header>
							<h1>WebGL in practice</h1>
						</header>
...
<a href="http://www.paris-web.fr/2015/presentations/Paris%20Web%2015%20-%20WebGL%20in%20practice.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">Télécharger le PDF</span></a>

<a href="https://docs.google.com/presentation/d/1GDpVrW4WI0BrNRqEsjscU34v-zu8Ldmv9mvL3Hxs1ug/present#slide=id.p" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1733">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/webgl-in-practice.php" class="url">WebGL in practice</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/3d" rel="tag">3D</a><br /><a href="http://www.paris-web.fr/2015/recherche/javascript" rel="tag">JavaScript</a><br /><a href="http://www.paris-web.fr/2015/recherche/webgl" rel="tag">WebGL</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><p>In this workshop you will get your hands onto all that's needed to level up your web applications with the power of the third dimension.</p>

<p>You will learn the basics to get an interactive 3D world on screen with Three.js, how to load 3D models from various formats and tips and tricks to gain the best performance.</p>

<p>Outline:</p>

<ol start='1'>
<li>Light, camera, action - Three.js basics</li>
<li>Loading 3D Models from various formats: OBJ/MTL, JSON and more</li>
<li>Interactivity: Move it around</li>
<li>Advanced Three.js: Particle Systems, Stereoscopic rendering, Web VR</li>
<li>Performance tricks: Memory management and tweaks</li>
</ol>
</div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/webgl-in-practice.php&amp;ref=prez-webgl-in-practice&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
