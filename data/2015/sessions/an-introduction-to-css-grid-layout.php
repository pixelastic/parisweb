...
<title>Paris Web - An Introduction to CSS Grid Layout</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/la-crypto-pour-les-devs-petit-etat-des-lieux-des-outils-daujourdhui-et-des-techniques-de-demain.php" title="La crypto pour les devs : petit état des lieux des outils d'aujourd'hui et des techniques de demain" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/changement-de-salle-1-2.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="An Introduction to CSS Grid Layout" />
	<meta property="twitter:description" content="Learn how CSS Grid Layout will change the way we use grid systems on the web, with practical examples." />
	<meta property="dc:title" content="An Introduction to CSS Grid Layout" />
	<meta property="og:title" content="An Introduction to CSS Grid Layout" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/an-introduction-to-css-grid-layout.php" />
	<meta property="og:description" content="Learn how CSS Grid Layout will change the way we use grid systems on the web, with practical examples." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>An Introduction to CSS Grid Layout</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1737">
						<header>
							<h1>An Introduction to CSS Grid Layout</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/143791969" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
...
<a href="https://speakerd.s3.amazonaws.com/presentations/58789e8c1da64a65b32009c35243be2b/css-grid-50-parisweb-2015.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">Télécharger le PDF</span></a>

<a href="https://speakerdeck.com/rachelandrew/css-grid-layout-for-paris-web" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1737">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/an-introduction-to-css-grid-layout.php" class="url">An Introduction to CSS Grid Layout</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/css" rel="tag">CSS</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><p>Since the early days of the web, designers have been trying to lay out web pages using grid systems. Likewise, almost every CSS framework attempts to implement some kind of grid system, using floats and often leaning on preprocessors. The CSS Grid Layout module brings us a native CSS Grid system for the first time — a grid system that does not rely on document source order, and can create complex layouts which are easily redefined with media queries. Following along with practical examples, you’ll learn how Grid works, and how it can be used to implement modern layouts and responsive designs.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/rachel-andrew.php">Rachel Andrew</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Rachel Andrew" src="https://www.paris-web.fr/2015/assets_c/2015/05/Rachel%20Andrew-thumb-143x143-479.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Rachel Andrew lives in Bristol, England. She is one half of web development company edgeofmyseat.com, the company behind Perch CMS. Her day to day work can include anything from product development to devops to CSS, and she writes about all of these subjects on her blog at rachelandrew.co.uk.</p>

<p>Rachel has been working on the web since 1996 and writing about the web for almost as long. Her books include the bestselling CSS Anthology from Sitepoint and recent ventures into self-publishing have seen her write The Profitable Side Project Handbook, and CSS3 Layout Modules, 2nd edition. She is a regular columnist for A List Apart as well as other publications online and print. When not writing, Rachel often acts as a technical editor for other authors.</p>

<p>Rachel is a keen distance runner and likes to try and encourage people to come for a run when attending conferences, with varying degrees of success! You can find her on Twitter as @rachelandrew.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/an-introduction-to-css-grid-layout.php&amp;ref=prez-an-introduction-to-css-grid-layout&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
