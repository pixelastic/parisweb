...
<title>Paris Web - Creating a Culture of Code Quality</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/de-grands-pouvoirs-impliquent-de-grandes-responsabilites.php" title="De grands « pouvoirs » impliquent de grandes « responsabilités »" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/informelles-1-2.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Creating a Culture of Code Quality" />
	<meta property="twitter:description" content="High-quality code doesn't just happen, it requires an engineering culture that supports continual improvement." />
	<meta property="dc:title" content="Creating a Culture of Code Quality" />
	<meta property="og:title" content="Creating a Culture of Code Quality" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/creating-a-culture-of-code-quality.php" />
	<meta property="og:description" content="High-quality code doesn't just happen, it requires an engineering culture that supports continual improvement." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Creating a Culture of Code Quality</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1727">
						<header>
							<h1>Creating a Culture of Code Quality</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/145318581" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1727">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/creating-a-culture-of-code-quality.php" class="url">Creating a Culture of Code Quality</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/automatisation" rel="tag">automatisation</a><br /><a href="http://www.paris-web.fr/2015/recherche/culture" rel="tag">culture</a><br /><a href="http://www.paris-web.fr/2015/recherche/linting" rel="tag">linting</a><br /><a href="http://www.paris-web.fr/2015/recherche/qualite" rel="tag">qualité</a><br /><a href="http://www.paris-web.fr/2015/recherche/tests" rel="tag">tests</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><p>Quality isn't something that just happens, even with the best engineers. It requires bottom-up and top-down support in the engineering organization, champions to drive it forward, and a clear vision to sustain it. </p>

<p>Quality can be thought of concentric circles of increasing scope.</p>

<p>Compilation: Use an opinionated compiler and make it run in a strict mode.</p>

<p>Linting: Build or use an AST linter to enforce coding styles and conventions.</p>

<p>Unit tests: Verify function and object contracts in a sandboxed environment.</p>

<p>Integration tests: Blackbox testing of application functionality ensures core product flows are working before deployment.</p>

<p>Build tools: Enable developers to leverage all of the above seamlessly with a high quality build system.</p>

<p>Documentation: Reduce the overhead of 1on1 training and make it easy for people to self-improve.</p>

<p>Culture: Quality is the responsibility of every engineer. </p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/david-west.php">David West</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="David West" src="https://www.paris-web.fr/2015/assets_c/2015/05/David%20West-thumb-143x143-474.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>David is an engineer on Pinterest's web platform team. He is a member of Pinterest's Testing X-team, a cross-functional team at Pinterest dedicated to improving code quality and reliability across the company. David was previously an engineering manager at Trulia and engineer at other Silicon Valley companies. He's also an avid gamer and the proud owner of an 8-year-old chinchilla.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/creating-a-culture-of-code-quality.php&amp;ref=prez-creating-a-culture-of-code-quality&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
