...
<title>Paris Web - WebGL and WebVR: 3D web today and tomorrow</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/design-de-soi-valoriser-son-identite-et-son-expertise-sur-le-web.php" title="Design de soi : valoriser son identité et son expertise sur le web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/informelles-2-5.php" title="Informelles" />
	...
	<meta name="twitter:title" content="WebGL and WebVR: 3D web today and tomorrow" />
	<meta property="twitter:description" content="The web gets deeper - discover 3D and VR on the web" />
	<meta property="dc:title" content="WebGL and WebVR: 3D web today and tomorrow" />
	<meta property="og:title" content="WebGL and WebVR: 3D web today and tomorrow" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/webgl-and-webvr-3d-web-today-and-tomorrow.php" />
	<meta property="og:description" content="The web gets deeper - discover 3D and VR on the web" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>WebGL and WebVR: 3D web today and tomorrow</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1747">
						<header>
							<h1>WebGL and WebVR: 3D web today and tomorrow</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/146476185" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1747">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/webgl-and-webvr-3d-web-today-and-tomorrow.php" class="url">WebGL and WebVR: 3D web today and tomorrow</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/3d" rel="tag">3D</a><br /><a href="http://www.paris-web.fr/2015/recherche/webgl" rel="tag">WebGL</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><p>The web has been mostly two-dimensional so far — and so we've design and conceptualised it pretty much as — literally — a page. A rectangle that we're filling with content in a visually pleasing and functional way.</p>

<p>We've even started to imitate three dimensions by using CSS 3D transitions and parallax scrolling — but we've not quite cut it yet.</p>

<p>In the meantime, mostly in the background WebGL has become fairly widely™ available and most people know that it exists but only a few people have actually used it.</p>

<p>While there's a flood of proof-of-concepts and toy demos, we're still mostly thinking of the web as "pages" in an infinite collection of books.</p>

<p>I'd like to change that. I'd like to take your hand and run with you into this whole universe of possibilities that WebGL gives you as of today. I'll even show some interesting use cases beyond demos and games.</p>

<p>Once we've taken a short breath from running through the third dimension, we'll go one step ahead: Instead of seeing the web on the screen in front of us, we'll go in. With WebVR we're having amazing ways of placing the action around the user — though, that's very bleeding edge right now and there's still some open questions… that makes it even more important to actually talk and think about this together; your ideas are wanted!</p>

<p>We'll then do one more thing: "We have to go deeper!" - Inception style! We'll do some live coding inside a virtual 3D space using WebGL and WebVR - so we'll code 3D stuff while being in a virtual 3D world.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/martin-naumann.php">Martin Naumann</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Martin Naumann" src="https://www.paris-web.fr/2015/assets_c/2015/05/Martin%20Naumann-thumb-143x143-487.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Martin is open source contributor and web evangelist by heart from Zurich
with a decade experience from the trenches of software engineering in multiple fields.</p>

<p>He works as a software engineer at Archilogic in front- and backend.
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/webgl-and-webvr-3d-web-today-and-tomorrow.php&amp;ref=prez-webgl-and-webvr-3d-web-today-and-tomorrow&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
