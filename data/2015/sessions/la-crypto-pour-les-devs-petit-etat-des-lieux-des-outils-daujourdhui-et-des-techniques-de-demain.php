...
<title>Paris Web - La crypto pour les devs : petit état des lieux des outils d'aujourd'hui et des techniques de demain</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/pause-1-1.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/an-introduction-to-css-grid-layout.php" title="An Introduction to CSS Grid Layout" />
	...
	<meta name="twitter:title" content="La crypto pour les devs : petit état des lieux des outils…" />
	<meta property="twitter:description" content="Venez découvrir la crypto sans souci : tour d'horizon des outils et techniques pour assurer la confidentialité de vos données !" />
	<meta property="dc:title" content="La crypto pour les devs : petit état des lieux des outils d'aujourd'hui et des techniques de demain" />
	<meta property="og:title" content="La crypto pour les devs : petit état des lieux des outils d'aujourd'hui et des techniques de demain" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/la-crypto-pour-les-devs-petit-etat-des-lieux-des-outils-daujourdhui-et-des-techniques-de-demain.php" />
	<meta property="og:description" content="Venez découvrir la crypto sans souci : tour d'horizon des outils et techniques pour assurer la confidentialité de vos données !" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>La crypto pour les devs : petit état des lieux des outils d'aujourd'hui et des techniques de demain</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1719">
						<header>
							<h1>La crypto pour les devs : petit état des lieux des outils d'aujourd'hui et des techniques de demain</h1>
						</header>
...
<a href="http://talks.m4dz.net/crypto-pour-les-devs/#/" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1719">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/la-crypto-pour-les-devs-petit-etat-des-lieux-des-outils-daujourdhui-et-des-techniques-de-demain.php" class="url">La crypto pour les devs : petit état des lieux des outils d'aujourd'hui et des techniques de demain</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/securite" rel="tag">sécurité</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Plus que jamais, nous avons besoin de sécuriser nos échanges et de renforcer notre confiance dans nos outils pour garder nos données à l'abri des yeux indiscrets. Peut-être que franchir le pas vous semble insurmontable. Peut-être que vous vous dites que tout ça reste une affaire de groupes d'hacktivistes éclairés. Plus probablement, il vous manque sans doute juste une connaissance simple de l'univers du chiffrement, et de la fantastique boîte à outils qui l'accompagne.</p>

<p>Alors profitons-en, on embarque pour un tour d'horizon de la cryptographie : chiffrement, techniques, outils… Nous regarderons quels outils existent, pourquoi et comment les utiliser. Et parce que le web ne serait pas parfait s'il n'était pas ouvert, nous nous intéresserons aussi bien aux clients « lourds » qu'aux alternatives web (et il en y en a plein). </p>

<p>Mieux : puisque nous ferons le tour des techniques, observons les outils que le W3C met à notre portée de devs, avec l'API WebCrypto : ajouter du chiffrement et une gestion fine de la sécurisation se révèle désormais beaucoup plus pratique.</p>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/matthias-dugue.php">Matthias Dugué</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Matthias Dugué" src="https://www.paris-web.fr/2015/assets_c/2015/09/Matthias%20Dugue-thumb-143x143-518.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Matthias est Dev UI chez Cozy Cloud et éleveur de licornes de combats depuis 1996. Il passe ses journées à implémenter, dans la joie et la qualité, l'interface qui sera la plus simple possible à utiliser. Il a malheureusement une fâcheuse tendance à danser et humhumer durant son coding time, ce qui peut facilement porter sur les nerfs de ses collègues (mais fait fuir les bugs, on ne peut pas tout avoir).</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/la-crypto-pour-les-devs-petit-etat-des-lieux-des-outils-daujourdhui-et-des-techniques-de-demain.php&amp;ref=prez-la-crypto-pour-les-devs-petit-etat-des-lieux-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
