...
<title>Paris Web - [Conf Surprise] - Conférence LSF</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/changement-de-salle-4.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conclusion.php" title="Conclusion" />
	...
	<meta name="twitter:title" content="[Conf Surprise] - Conférence LSF" />
	<meta property="twitter:description" content="Qui a vraiment inventé la LSF, comment se « démènent les interprètes pour décrypter les conf », pourquoi elle ne peut pas être internationale ou comment on signe « WebSocket » ou « skeuomorphisme »,…" />
	<meta property="dc:title" content="[Conf Surprise] - Conférence LSF" />
	<meta property="og:title" content="[Conf Surprise] - Conférence LSF" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conf-surprise.php" />
	<meta property="og:description" content="Qui a vraiment inventé la LSF, comment se « démènent les interprètes pour décrypter les conf », pourquoi elle ne peut pas être internationale ou comment on signe « WebSocket » ou « skeuomorphisme »,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Conf Surprise] - Conférence LSF</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1876">
						<header>
							<h1>[Conf Surprise] - Conférence LSF</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/146682822" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1876">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conf-surprise.php" class="url">[Conf Surprise] - Conférence LSF</a></span></span></h2>
...
<dd class="column">
17 <abbr title="heures">h</abbr> 20
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Qui a vraiment inventé la LSF, comment se « démènent les interprètes pour décrypter les conf », pourquoi elle ne peut pas être internationale ou comment on signe « WebSocket » ou « skeuomorphisme », autant de petites choses à découvrir dans la conférence surprise sur la LSF.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/sandrine-schwartz.php">Sandrine Schwartz</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Sandrine Schwartz" src="https://www.paris-web.fr/2015/assets_c/2016/02/Sandrine-Schwartz-thumb-143x143-554.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Au début des années 80, des paillettes se sont mises à scintiller dans les yeux de la petite Sandrine quand son père a ramené à la maison un Texas Instrument 99/4A. Cela aurait pu faire d’elle une informaticienne plus tard, mais elle s’est orientée vers un autre métier où il faut aussi maîtriser des codes et éviter les bugs quand on compile : interprète français-LSF (Langue des Signes Française).</p>

<p>Depuis bientôt 20 ans, elle exerce à Paris ce métier-passion, qu’elle enseigne également à l’université à des jeunes padawans et en parallèle, elle n’a jamais arrêté d’étudier.</p>

<p>Après quelques diplômes, beaucoup de conférences et de MOOCs, une thèse de doctorat en linguistique (sur la LSF tactile des sourdaveugles), cette année, elle termine un master en sciences criminelles et espère ensuite s’orienter vers l’épidémiologie et l’informatique. En attendant, elle mène une veille technologeek assidue faisant d’elle une Interprète 2.0 ravie de venir interpréter les licornes de Paris Web tous les ans.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conf-surprise.php&amp;ref=prez-conf-surprise&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
