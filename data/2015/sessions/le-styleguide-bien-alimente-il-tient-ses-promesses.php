...
<title>Paris Web - Le styleguide, bien alimenté il tient ses promesses</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/pause-2.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/conf-sponsor-1-2.php" title="[Conf Sponsor] Les données animées en temps réel : c’est quoi ? pourquoi faire ? et comment les intégrer ?" />
	...
	<meta name="twitter:title" content="Le styleguide, bien alimenté il tient ses promesses" />
	<meta property="twitter:description" content="Envisager le concept de styleguide pour en comprendre les enjeux." />
	<meta property="dc:title" content="Le styleguide, bien alimenté il tient ses promesses" />
	<meta property="og:title" content="Le styleguide, bien alimenté il tient ses promesses" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/le-styleguide-bien-alimente-il-tient-ses-promesses.php" />
	<meta property="og:description" content="Envisager le concept de styleguide pour en comprendre les enjeux." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le styleguide, bien alimenté il tient ses promesses</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1735">
						<header>
							<h1>Le styleguide, bien alimenté il tient ses promesses</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/145318192" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/lirjTLISFuLyeQ" 
	...
	<section class="s-talk-subject" id="sujet-1735">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/le-styleguide-bien-alimente-il-tient-ses-promesses.php" class="url">Le styleguide, bien alimenté il tient ses promesses</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/bonnes-pratiques" rel="tag">Bonnes pratiques</a><br /><a href="http://www.paris-web.fr/2015/recherche/charte-graphique" rel="tag">charte graphique</a><br /><a href="http://www.paris-web.fr/2015/recherche/codestyle" rel="tag">codestyle</a><br /><a href="http://www.paris-web.fr/2015/recherche/coherence" rel="tag">cohérence</a><br /><a href="http://www.paris-web.fr/2015/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2015/recherche/da" rel="tag">DA</a><br /><a href="http://www.paris-web.fr/2015/recherche/equipe" rel="tag">équipe</a><br /><a href="http://www.paris-web.fr/2015/recherche/front-end" rel="tag">front-end</a><br /><a href="http://www.paris-web.fr/2015/recherche/html" rel="tag">HTML</a><br /><a href="http://www.paris-web.fr/2015/recherche/styleguide" rel="tag">styleguide</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Il n'y a encore pas si longtemps, le travail de l'intégrateur était de transformer une maquette graphique en rendu HTML, et si possible, au pixel près.
Avec l'arrivée de nouveaux intervenants, de nouvelles pratiques techniques et de collaboration en équipe, conserver une cohérence graphique tout au long d'un projet devient un véritable objectif de réussite.
L'objectif d'un styleguide est de mettre en musique le travail d'un UX, d'un DA, d'un développeur front-end, puis d'un développeur back-end, en passant par le chef de projet et bien évidemment le client, et de pouvoir le voir se concrétiser pas à pas.</p>

<p>Les développeurs vont devoir alimenter ce styleguide interactif, le soigner, le bichonner et vérifier son bon développement : c'est un gage à la fois de réussite et de maintenance dans le temps.</p>

<p>Je vous propose de traiter ce sujet au travers d'un exemple concret : le nouveau site de Relais et Châteaux, conceptualisé par Ogilvy One et mis en oeuvre par C2iS.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/laurent-guitton.php">Laurent Guitton</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Laurent Guitton" src="https://www.paris-web.fr/2015/assets_c/2015/09/Laurent%20Guitton%202015-thumb-143x143-516.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Je suis arrivé dans ce métier au début des années 2000, après quelques années d'amateurisme essayant de faire passer mes premières lignes de CSS dans des navigateurs aujourd'hui disparus, avec pour ambition de devenir un de ces "intégristes" de la communauté du code propre et universel. 
Aujourd'hui à la tête d'une équipe de 6 intégrateurs / développeurs Front-End chez C2iS, agence interactive lyonnaise, et toujours les mains dans le code, j'essaie toujours et encore de faire partager en interne comme en externe mes motivations premières, tout en touchant à toutes les nouveautés propres à nos métiers.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/le-styleguide-bien-alimente-il-tient-ses-promesses.php&amp;ref=prez-le-styleguide-bien-alimente-il-tient-ses-prom&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
