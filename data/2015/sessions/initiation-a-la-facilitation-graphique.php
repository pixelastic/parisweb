...
<title>Paris Web - Initiation à la facilitation graphique</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/adoptez-un-workflow-web.php" title="Adoptez un workflow web !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/desendettement-de-code-javascript-le-guide-anti-crise.php" title="Désendettement de code Javascript : le guide anti-crise" />
	...
	<meta name="twitter:title" content="Initiation à la facilitation graphique" />
	<meta property="twitter:description" content="Venez découvrir en quoi la pensée visuelle aide à la compréhension entre les individus et à créer des cadres interactifs fun et sérieux" />
	<meta property="dc:title" content="Initiation à la facilitation graphique" />
	<meta property="og:title" content="Initiation à la facilitation graphique" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/initiation-a-la-facilitation-graphique.php" />
	<meta property="og:description" content="Venez découvrir en quoi la pensée visuelle aide à la compréhension entre les individus et à créer des cadres interactifs fun et sérieux" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Initiation à la facilitation graphique</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1741">
						<header>
							<h1>Initiation à la facilitation graphique</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1741">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/initiation-a-la-facilitation-graphique.php" class="url">Initiation à la facilitation graphique</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/facilitation-graphique" rel="tag">facilitation graphique</a><br /><a href="http://www.paris-web.fr/2015/recherche/pensee-visuelle" rel="tag">pensée visuelle</a></dd>
    ...
    <div class="talk-description"><p>Vous devez animer une réunion avec votre(vos) client(s), votre équipe et/ou vos collègues, que faites-vous ?</p>

<ul>
<li>Vous présentez vos idées à partir d’un PowerPoint au risque que tout le monde ne vous écoute pas</li>
<li>Vous donnez un paquet de Post-Its à chacun et animez une séance de brainstorming avec le risque que trop d’idées se dégagent</li>
<li>Vous organisez un jeu d’Innovation : c’est ludique, c’est fun, mais certains auraient préféré une bonne réunion descendante (voir réponse 1)</li>
<li>Vous restez silencieux, à l’écoute et illustrez la complexité des idées exprimées à la seule force de votre crayon</li>
</ul>

<p>Je vous propose de découvrir cette 4e option : la facilitation graphique. Vous ne savez pas dessiner ? C’est possible, mais vous avez d’autres qualités innées qui feront de vous un bon « architecte visuel des idées »</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/romain-couturier.php">Romain Couturier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Romain Couturier" src="https://www.paris-web.fr/2015/assets_c/2015/05/Romain%20Couturier-thumb-143x143-465.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Romain Couturier est coach agile et facilitateur graphique. En tant qu’artisan du changement, il accompagne les équipes et les organisations dans leur transition et évolution vers l’agilité dans les milieux IT. D’abord développeur chez un éditeur puis directeur technique dans une startup, il est confronté à la dure réalité des cycles de production logicielle, de la vision produit jusqu’au déploiement chez les utilisateurs. Alors organisé en méthodes traditionnelles de gestion de projet, il devient un véritable goulet d’étranglement pour les autres. En 2007, il tombe par hasard sur « l’agilité » et y trouvera enfin des réponses pour structurer de manière collaborative la production de livrable grâce à l’implication de ses équipes Début 2012, Romain Couturier fonde Terre d’Agile. Il travaille désormais à unifier les équipes, trouver et développer de la valeur ajoutée produit avec les responsables métier et encourager les managers à déployer des contextes d'amélioration continue</p>

<p>Membre actif du CARA Lyon et co-fondateur de Mix-IT, il est également activement impliqué dans les actions de diffusion et de promotion de l’agilité principalement à Lyon et en Rhône-Alpes. En 2012, il rejoint la Fédération Agile.</p>
</div>
</div>
