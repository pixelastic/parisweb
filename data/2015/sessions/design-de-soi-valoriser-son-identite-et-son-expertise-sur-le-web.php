...
<title>Paris Web - Design de soi : valoriser son identité et son expertise sur le web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/changement-de-salle-1.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/webgl-and-webvr-3d-web-today-and-tomorrow.php" title="WebGL and WebVR: 3D web today and tomorrow" />
	...
	<meta name="twitter:title" content="Design de soi : valoriser son identité et son expertise sur le web" />
	<meta property="twitter:description" content="Valorisez votre expertise sur le web de façon positive, efficace et pérenne, et favorisez ainsi vos objectifs professionnels." />
	<meta property="dc:title" content="Design de soi : valoriser son identité et son expertise sur le web" />
	<meta property="og:title" content="Design de soi : valoriser son identité et son expertise sur le web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/design-de-soi-valoriser-son-identite-et-son-expertise-sur-le-web.php" />
	<meta property="og:description" content="Valorisez votre expertise sur le web de façon positive, efficace et pérenne, et favorisez ainsi vos objectifs professionnels." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span><a href="https://www.paris-web.fr/2015/">Programme 2015</a></span>
				<span>Design de soi : valoriser son identité et son expertise sur le web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1721">
						<header>
							<h1>Design de soi : valoriser son identité et son expertise sur le web</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/142169449" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/HHHpcArsrtq8fG" 
	...
	<section class="s-talk-subject" id="sujet-1721">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/design-de-soi-valoriser-son-identite-et-son-expertise-sur-le-web.php" class="url">Design de soi : valoriser son identité et son expertise sur le web</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2015/conferences/">Conférence</a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/#conferences">Auditorium Blin</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2015/02.php">vendredi 02</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
15 <abbr title="heures">h</abbr> 10
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>

<dt class="clear span-1">Durée</dt>
<dd class="column">
50 <abbr title="minutes">mn</abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/communication" rel="tag">communication</a><br /><a href="http://www.paris-web.fr/2015/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2015/recherche/e-reputation" rel="tag">e-réputation</a><br /><a href="http://www.paris-web.fr/2015/recherche/identite" rel="tag">identité</a><br /><a href="http://www.paris-web.fr/2015/recherche/individu" rel="tag">individu</a><br /><a href="http://www.paris-web.fr/2015/recherche/semiotique" rel="tag">sémiotique</a><br /><a href="http://www.paris-web.fr/2015/recherche/storytelling" rel="tag">storytelling</a><br /><a href="http://www.paris-web.fr/2015/recherche/vie-privee" rel="tag">Vie privée</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Être visible sur le web est un atout professionnel de poids : votre portfolio, votre blog et votre présence sur les réseaux sociaux donnent à voir non seulement ce que vous faites, mais également qui vous êtes. Or, Internet sait tout et n'oublie jamais : aussi, y communiquer en son nom de manière positive, efficace et pérenne est un exercice difficile, dont dépend en grande partie votre réputation numérique.</p>

<p>En tant que professionnel·le du web, vous ne pouvez pas faire l'impasse dessus, quelles que soient vos aspirations professionnelles (trouver un nouvel emploi, créer votre entreprise, développer votre clientèle, etc.). C'est pourquoi il est important de choisir soigneusement les mots et les images qui parleront pour vous lorsqu'autrui se renseignera à votre propos sans que vous soyez dans la pièce.</p>

<p>C'est là que ce que j'appelle le « design de soi » entre en jeu.</p>

<p>Loin de tout charabia marketing, le design de soi est une démarche créative et pragmatique centrée sur votre identité et votre expertise : elle vous donnera les moyens de mieux définir votre image de marque personnelle et de la communiquer de façon efficace, responsable et sensée.</p>

<p>Cette conférence n'entend pas délivrer une marche à suivre universelle, mais vous offrir des pistes de réflexion en amont d'un travail de design de soi.</p>

<p>Comment réconcilier la dimension professionnelle de votre présence sur le web et votre envie d'y partager vos centres d'intérêts personnels ? Faut-il fixer des limites à cette « extimité » ?</p>

<p>Comment parler de vous-même et de vos succès sur le web sans paraître égocentrique ou vaniteux ?</p>

<p>Enfin, comment valoriser votre expertise par rapport à celle de vos pairs, tout en gardant des liens étroits avec eux ?</p>

<p>Voici quelques-unes des questions auxquelles nous réfléchirons ensemble.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/marie-guillaumet.php">Marie Guillaumet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marie Guillaumet" src="https://www.paris-web.fr/2015/assets_c/2015/05/Marie%20Guillaumet-thumb-143x143-467.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Passionnée par le web côté « front-end », Marie est web designer et intégratrice web en agence. Au quotidien, elle s'emploie à réconcilier design, accessibilité et performance.</p>

<p>Formée à Sciences Po Grenoble et au Celsa, Marie attache de l'importance à la sémantique et à la sémiotique des projets web auxquels elle contribue.</p>

<p>Accro à Paris Web, elle y a déjà animé un atelier dédié à la macro-typographie sur le web, en compagnie de Vincent Valentin, en 2012.</p>

<p>Quand elle n’est pas clouée à son ordinateur, Marie aime vagabonder en bord de mer, prendre des photos et arpenter les vide-greniers à la recherche de livres consacrés aux loutres.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/design-de-soi-valoriser-son-identite-et-son-expertise-sur-le-web.php&amp;ref=prez-design-de-soi-valoriser-son-identite-et-son-e&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
...
<section class="news l-fixedColumn l-block l-primary">
		<article>
			<h2>L'édition 2015</h2>
			<ul>
            <li><a class="roll" href="/2015/conferences/" rel="bookmark">Les conférences 2015</a></li>
            <li><a class="roll" href="/2015/01.php" rel="bookmark">Programme du jeudi 01</a></li>
            <li><a class="roll" href="/2015/02.php" rel="bookmark">Programme du vendredi 02</a></li>

            <li><a class="roll" href="/2015/ateliers/" rel="bookmark">Les ateliers 2015</a></li>
            <li><a class="roll" href="/2015/03.php" rel="bookmark">Programme du samedi 03</a></li>
            <li><a class="roll" href="/2015/orateurs/" rel="bookmark">Les orateurs 2015</a></li>
			</ul>
        <ul class="large">
            <li><a href="http://www.paris-web.fr/2015/conferences-parisweb-2015.ics">Calendrier au format iCAL/ics des conférences 2015</a></li>
			<li><a href="http://www.paris-web.fr/2015/ateliers-parisweb-2015.ics">Calendrier au format iCAL/ics des ateliers 2015</a></li>
		</ul>
		</article>
	 </section>
