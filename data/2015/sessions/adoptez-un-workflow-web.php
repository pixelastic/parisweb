...
<title>Paris Web - Adoptez un workflow web !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/le-prototypage-rapide.php" title="Le prototypage rapide" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/initiation-a-la-facilitation-graphique.php" title="Initiation à la facilitation graphique" />
	...
	<meta name="twitter:title" content="Adoptez un workflow web !" />
	<meta property="twitter:description" content="DRY, KISS, GIT, GULP, SASS, SMACSS, etoussa… Faites du bien à votre workflow web !" />
	<meta property="dc:title" content="Adoptez un workflow web !" />
	<meta property="og:title" content="Adoptez un workflow web !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/adoptez-un-workflow-web.php" />
	<meta property="og:description" content="DRY, KISS, GIT, GULP, SASS, SMACSS, etoussa… Faites du bien à votre workflow web !" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Adoptez un workflow web !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1752">
						<header>
							<h1>Adoptez un workflow web !</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1752">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/adoptez-un-workflow-web.php" class="url">Adoptez un workflow web !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/methodologie" rel="tag">Méthodologie</a><br /><a href="http://www.paris-web.fr/2015/recherche/optimisation" rel="tag">optimisation</a><br /><a href="http://www.paris-web.fr/2015/recherche/outils" rel="tag">Outils</a><br /><a href="http://www.paris-web.fr/2015/recherche/performance" rel="tag">performance</a></dd>
    ...
    <div class="talk-description"><p>Le web est enfin sorti de l’ère de la bricole. Il est révolu le temps du graphiste ou de l’informaticien bidouilleur.</p>

<p>Architecte de l’information, ergonome, UX/UI designer, frontend/backend developer, CM, PM, etc. le web se spécialise et, dans la foulée, se professionnalise. Il devient un vrai travail d’équipe pluridisciplinaire. Il répond à des besoins de plus en plus complexes dans des environnements de plus en plus variés.</p>

<p>Pour faire face à ces défis, les outils se multiplient et de nouvelles méthodes voient le jour. On parle de performance, optimisation, modularité, maintenabilité, « scalabilité », productivité, et il est grand temps d’intégrer un workflow web, un vrai, de qualité ! Sur base de cas concrets, cet atelier combine les approches méthodologiques et techniques modernes.</p>

<p>À l’issue de celui-ci, DRY, KISS, BEM, SMACSS, SASS, BOWER, GRUNT, GULP, GIT… ne seront plus des gros mots ou des termes confus mais bien les clés de votre futur flux de production web !</p>
</div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/adoptez-un-workflow-web.php&amp;ref=prez-adoptez-un-workflow-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
