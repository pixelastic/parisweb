...
<title>Paris Web - DIY : une console de jeux web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/vers-une-bonne-pratique-du-pair-design.php" title="Vers une bonne pratique du Pair Design" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/csp-content-security-policy.php" title="CSP : Content Security Policy" />
	...
	<meta name="twitter:title" content="DIY : une console de jeux web" />
	<meta property="twitter:description" content="Créer votre propre console de jeux et profiter ainsi de toute la richesse et la créativité du web dans votre salon, rien de plus facile." />
	<meta property="dc:title" content="DIY : une console de jeux web" />
	<meta property="og:title" content="DIY : une console de jeux web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/diy-une-console-de-jeux-web.php" />
	<meta property="og:description" content="Créer votre propre console de jeux et profiter ainsi de toute la richesse et la créativité du web dans votre salon, rien de plus facile." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>DIY : une console de jeux web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1736">
						<header>
							<h1>DIY : une console de jeux web</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/145317924" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1736">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/diy-une-console-de-jeux-web.php" class="url">DIY : une console de jeux web</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Avec la montée en puissance des standards du Web, il est désormais possible de créer des jeux vidéo directement dans son navigateur, qui n'ont plus tant de choses à envier aux distributions classiques. Si c'est sur la bonne voie d'un point de vue software, qu'en est-il du hardware ? Cela ne semble pas aussi simple et prometteur…</p>

<p>Pas si sûr ! Voyons comment, avec un budget serré et un peu de débrouillardise, on peut créer soi-même une console de jeux web dans son salon ouverte à de multiples possibilités.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/alvin-berthelot.php">Alvin Berthelot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Alvin Berthelot" src="https://www.paris-web.fr/2015/assets_c/2015/05/2014-photo-Alvin-Berthelot-thumb-143x143-441-thumb-143x143-458.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Alvin Berthelot est un développeur depuis plus de 10 ans sur des projets et des technologies hétérogènes, qui n'ont qu'un seul point commun, l'utilisation du web.</p>

<p>Agiliste convaincu, toujours à la recherche d'une « autre façon de travailler ». Façon, qui saura faire preuve de pragmatisme ayant pour objectif l’efficience collective, mais aussi l’accomplissement personnel.</p>

<p>Sa curiosité, son envie de partager les savoirs, ses 2 casquettes développeur/agiliste et son polyglottisme technologique lui permettent de mélanger les disciplines et ainsi de parler de tout… et surtout de n'importe quoi :)</p>

<p>Il travaille (tout de même de manière sérieuse) en tant qu'indépendant pour sa structure <a href="http://www.webyousoon.com" title="webyousoon">webyousoon</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/diy-une-console-de-jeux-web.php&amp;ref=prez-diy-une-console-de-jeux-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
