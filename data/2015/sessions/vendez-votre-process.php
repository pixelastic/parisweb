...
<title>Paris Web - Vendez votre méthodologie</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/cha.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/conf-sponsor-2-1.php" title="[Conf Sponsor] Vorlon.JS : un outil pour simplifier le debug web sur toutes les plateformes" />
	...
	<meta name="twitter:title" content="Vendez votre méthodologie" />
	<meta property="twitter:description" content="Convaincre son client en vendant le process plutôt que le produit." />
	<meta property="dc:title" content="Vendez votre méthodologie" />
	<meta property="og:title" content="Vendez votre méthodologie" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/vendez-votre-process.php" />
	<meta property="og:description" content="Convaincre son client en vendant le process plutôt que le produit." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Vendez votre méthodologie</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1722">
						<header>
							<h1>Vendez votre méthodologie</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/145317706" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1722">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/vendez-votre-process.php" class="url">Vendez votre méthodologie</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2015/recherche/methodologie" rel="tag">Méthodologie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Rien n’est moins évident pour un client que de savoir si le design qu’on lui vend est le bon, il n’est pas formé pour ça. Le designer en revanche, lui, l’est, il est donc indispensable qu’il démontre à son client que son travail répond à ses besoins. Car en réalité les clients n’achètent pas vos créations, ils achètent votre méthodologie. En général, ce que l’on a l’habitude de montrer, c’est un beau produit fignolé, mais votre client veut comprendre pourquoi il est aussi génial que vous le dites. Si vous voulez qu’il soit aussi enthousiaste que vous et qu’il vous fasse confiance, montrez-lui ce que vous connaissez par cœur, révélez vos secrets de fabrication et vendez votre méthodologie.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/jean-philippe-cabaroc.php">Jean-Philippe Cabaroc</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jean-Philippe Cabaroc" src="https://www.paris-web.fr/2015/assets_c/2015/05/cabaroc-portrait-thumb-143x143-475.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Designer et directeur artistique, Jean-Philippe Cabaroc aime les designs qui racontent une histoire. Il a fondé son studio de création graphique en 2009 après avoir travaillé 5 ans en agence de communication. Intervenant sur des projets transversaux associant web et print, son travail donne une place importante à l’émotion pour véhiculer le contenu. Passionné par la création visuelle, il a co-fondé avec cinq de ses confrères le premier podcast français consacré au webdesign, The Walking Web. Il tweete sur ses trouvailles et son process créatif sous le nom de @cabaroc et écrit ses réflexions professionnelles sur son blog.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/vendez-votre-process.php&amp;ref=prez-vendez-votre-process&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
