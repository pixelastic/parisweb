...
<title>Paris Web - « Acceptation Générale » mon prénom, mon adresse, mon domaine seront-ils acceptés par tous les formulaires ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/le-dev-front-a-mach-1-au-quotidien.php" title="[Conf Sponsor] Le dev front à Mach 1 au quotidien" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/pause-1-1.php" title="Pause" />
	...
	<meta name="twitter:title" content="« Acceptation Générale » mon prénom, mon adresse, mon domaine…" />
	<meta property="twitter:description" content="Qui n'a jamais été confronté à un refus d'un identificateur, p. ex. une adresse électronique, par un formulaire web trop et mal zélé ?" />
	<meta property="dc:title" content="« Acceptation Générale » mon prénom, mon adresse, mon domaine seront-ils acceptés par tous les formulaires ?" />
	<meta property="og:title" content="« Acceptation Générale » mon prénom, mon adresse, mon domaine seront-ils acceptés par tous les formulaires ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/acceptation-generale-mon-prenom-mon-adresse-mon-domaine-seront-ils-acceptes-par-tous-les-formulaires.php" />
	<meta property="og:description" content="Qui n'a jamais été confronté à un refus d'un identificateur, p. ex. une adresse électronique, par un formulaire web trop et mal zélé ?" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>« Acceptation Générale » mon prénom, mon adresse, mon domaine seront-ils acceptés par tous les formulaires ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1734">
						<header>
							<h1>« Acceptation Générale » mon prénom, mon adresse, mon domaine seront-ils acceptés par tous les formulaires ?</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/144521296" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1734">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/acceptation-generale-mon-prenom-mon-adresse-mon-domaine-seront-ils-acceptes-par-tous-les-formulaires.php" class="url">« Acceptation Générale » mon prénom, mon adresse, mon domaine seront-ils acceptés par tous les formulaires ?</a></span></span></h2>
...
<dd class="column">
10 <abbr title="heures">h</abbr> 45
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/bonnes-pratiques" rel="tag">Bonnes pratiques</a><br /><a href="http://www.paris-web.fr/2015/recherche/formulaire" rel="tag">formulaire</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Bien des formulaires sur le web aujourd'hui testent les données entrées et en refusent certaines. "Unsafe character" parce que j'ai voulu utiliser mon prénom (avec l'accent sur le e), "Invalid domain" (parce que c'est un nom en .alsace et que l'auteur du formulaire a copié/collé un code JavaScript qui limite arbitrairement les TLD à quatre caractères), "Wrong email syntax" (parce que l'auteur du formulaire n'a pas lu la norme sur les adresses de courrier et a tenté de deviner quels caractères étaient acceptables).</p>

<p>Pourquoi teste-t-on ?  La réponse n'est pas si évidente que cela, nombre de ces tests sont inutiles. Et, si on teste, où trouver la référence de la syntaxe, plutôt que de la réinventer en mal (un petit tour sur les forums permet de trouver plein de codes de test <em>faux</em>) ?</p>

<p>On parlera donc des contraintes sur les identificateurs, des normes qui les décrivent, des avantages et des inconvénients qu'il y a à les tester dans un formulaire web et des bonnes façons de faire.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/stephane-bortzmeyer.php">Stéphane Bortzmeyer</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Bortzmeyer" src="https://www.paris-web.fr/2015/assets_c/2015/05/Stephane%20Bortzmeyer-thumb-143x143-497.jpg" width="143" height="143">

            <span class="speaker-badge">Parle le DNS</span>
        </span>
...
<p>Il tient un blog sur les réseaux, l'informatique, les normes : <a href="http://www.bortzmeyer.org/">bortzmeyer.org</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/acceptation-generale-mon-prenom-mon-adresse-mon-domaine-seront-ils-acceptes-par-tous-les-formulaires.php&amp;ref=prez-acceptation-generale-mon-prenom-mon-adresse-m&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
