...
<title>Paris Web - Créer et partager sa single-page application en 1h avec React, Node.js, PouchDB et NPM</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/webgl-in-practice.php" title="WebGL in practice" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/et-dans-20-ans-je-fais-quoi.php" title="Et dans 20 ans, je fais quoi ?" />
	...
	<meta name="twitter:title" content="Créer et partager sa single-page application en 1h avec React,…" />
	<meta property="twitter:description" content="Comment créer et partager sa première web application installable en une ligne de commande." />
	<meta property="dc:title" content="Créer et partager sa single-page application en 1h avec React, Node.js, PouchDB et NPM" />
	<meta property="og:title" content="Créer et partager sa single-page application en 1h avec React, Node.js, PouchDB et NPM" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/creer-et-partager-sa-single-page-application-en-1h-avec-react-nodejs-pouchdb-et-npm.php" />
	<meta property="og:description" content="Comment créer et partager sa première web application installable en une ligne de commande." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Créer et partager sa single-page application en 1h avec React, Node.js, PouchDB et NPM</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1755">
						<header>
							<h1>Créer et partager sa single-page application en 1h avec React, Node.js, PouchDB et NPM</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1755">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/creer-et-partager-sa-single-page-application-en-1h-avec-react-nodejs-pouchdb-et-npm.php" class="url">Créer et partager sa single-page application en 1h avec React, Node.js, PouchDB et NPM</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/javascript" rel="tag">JavaScript</a><br /><a href="http://www.paris-web.fr/2015/recherche/nodejs" rel="tag">nodejs</a><br /><a href="http://www.paris-web.fr/2015/recherche/npm" rel="tag">npm</a></dd>
    ...
    <div class="talk-description"><p>Node.js est une plateforme de choix pour réaliser son application web. Elle vient avec un écosystème très riche de paquets pour construire son application web. De plus, son framework phare, Express, est facile à appréhender et bien outillé. En quelques minutes on peut coder un serveur d’application web.</p>

<p>PouchDB est une petite base de données qu’on peut embarquer dans son application. Son interface est très simple et ses concepts de base peuvent être acquis en quelques minutes. De plus, celle-ci peut être embarquée dans votre application.  Nous n'aurons pas besoin de déployer et configurer un service dédié pour stocker nos données</p>

<p>React permet de créer des composants pour l'interface graphique, le client chargé dans le navigateur. Nous assemblerons ces composants grâce à l'outil browserify pour construire une jolie interface.</p>

<p>NPM est le gestionnaire de paquets de Node. On verra comment, grâce à lui, on peut partager nos composants React et surtout notre application.</p>

<p>Vous prenez tout ça, vous mélangez le tout et vous obtenez une application web moderne que vous pouvez publier sur le dépôt officiel de Nodes.js. À la fin de l'atelier, vous aurez donc créé et publié votre application web. Grâce à ça n'importe qui pourra l'installer et la démarrer en deux lignes de commande !</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/frank-rousseau.php">Frank Rousseau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Frank Rousseau" src="https://www.paris-web.fr/2015/assets_c/2015/05/Frank%20Rousseau-thumb-143x143-498.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Frank Rousseau participe depuis de nombreuses années à la communauté du logiciel libre. De 2006 à 2008, il a animé Dolebraï une des premières webradio à ne diffuser que des musique libres. Après un long moment à animer à une communauté autour du spectacle, il revient aux joies du code en proposant cette fois Newebe, un projet de réseau social distribué. 
Projet porteur qui l’amènera en 2012 à co-fonder Cozy Cloud, une société distribuant son produit principal, une interface pour serveur personnel privé, sous licence libre.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/creer-et-partager-sa-single-page-application-en-1h-avec-react-nodejs-pouchdb-et-npm.php&amp;ref=prez-creer-et-partager-sa-single-page-application-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
