...
<title>Paris Web - Le prototypage rapide</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/evaluer-lux-des-methodes-simples-mais-efficaces.php" title="Evaluer l'UX : des méthodes simples mais efficaces !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/adoptez-un-workflow-web.php" title="Adoptez un workflow web !" />
	...
	<meta name="twitter:title" content="Le prototypage rapide" />
	<meta property="twitter:description" content="Le prototypage rapide, c'est s'exprimer directement dans le langage des interfaces. Voyons pourquoi et comment." />
	<meta property="dc:title" content="Le prototypage rapide" />
	<meta property="og:title" content="Le prototypage rapide" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/le-prototypage-rapide.php" />
	<meta property="og:description" content="Le prototypage rapide, c'est s'exprimer directement dans le langage des interfaces. Voyons pourquoi et comment." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le prototypage rapide</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1750">
						<header>
							<h1>Le prototypage rapide</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1750">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/le-prototypage-rapide.php" class="url">Le prototypage rapide</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/prototypage" rel="tag">prototypage</a><br /><a href="http://www.paris-web.fr/2015/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>En tant que designers, une des plus grandes difficultés du métier, c'est de bien se faire comprendre de nos clients et des gens qui se servent de nos productions. Et quand il s'agit de travailler sur une interface, il est hasardeux de ne communiquer qu'avec des mots ou des images fixes.</p>

<p>Le prototypage rapide, c'est l'idée que le design d'interface est un langage dans lequel le designer doit pouvoir s'exprimer directement. Une interface, ça ne se décrit pas, ça se montre – et il existe des outils pour passer directement de l'idée à la démonstration.</p>

<p>Je compte présenter rapidement les idées et l'histoire du prototypage rapide, avant de faire la démonstration des méthodes et des outils actuels.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/louis-jean-teitelbaum.php">Louis-Jean Teitelbaum</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Louis-Jean Teitelbaum" src="https://www.paris-web.fr/2015/assets_c/2015/05/Louis-Jean%20Teitelbaum-thumb-143x143-470.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Louis-Jean est concepteur UX, développeur et chercheur. Il a fait de l'UX son premier métier après des recherches en sociologie et en histoire sur les interfaces graphiques, et sur les différents métiers de la conception d'interfaces. Il s'est mis au développement (web front-end, Ruby on Rails et iOS) pour comprendre comment ça marchait, et de fil en aiguille, est devenu designer et développeur de sites, de jeux et d'applications.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/le-prototypage-rapide.php&amp;ref=prez-le-prototypage-rapide&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
