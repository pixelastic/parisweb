...
<title>Paris Web - Le jour où l'on n'aura plus besoin de l'accessibilité</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/vie-privee-surveillance-dependance-aux-gafas-faut-il-reinventer-le-web-pour-eviter-la-dystopie.php" title="Vie privée, surveillance, dépendance aux GAFAs, faut-il réinventer le web pour éviter la dystopie ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/informelles.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Le jour où l'on n'aura plus besoin de l'accessibilité" />
	<meta property="twitter:description" content="L'intelligence artificielle pourrait révolutionner les technologies d'assistance… Jusqu'à faire disparaître le besoin d'accessibilité ?" />
	<meta property="dc:title" content="Le jour où l'on n'aura plus besoin de l'accessibilité" />
	<meta property="og:title" content="Le jour où l'on n'aura plus besoin de l'accessibilité" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/le-jour-ou-lon-naura-plus-besoin-de-laccessibilite.php" />
	<meta property="og:description" content="L'intelligence artificielle pourrait révolutionner les technologies d'assistance… Jusqu'à faire disparaître le besoin d'accessibilité ?" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le jour où l'on n'aura plus besoin de l'accessibilité</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1751">
						<header>
							<h1>Le jour où l'on n'aura plus besoin de l'accessibilité</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/142169448" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/8n0A2ZoEV00rnu" 
	...
	<section class="s-talk-subject" id="sujet-1751">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/le-jour-ou-lon-naura-plus-besoin-de-laccessibilite.php" class="url">Le jour où l'on n'aura plus besoin de l'accessibilité</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/accessibilite" rel="tag">Accessibilité</a><br /><a href="http://www.paris-web.fr/2015/recherche/futur" rel="tag">futur</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>L'être humain a une capacité inégalée à percevoir, comprendre, et utiliser les informations disponibles dans les contenus numériques -- du moins, tant que ses facultés sensorielles et cognitives le lui permettent. Pour contourner les déficiences de tous types, et réduire le handicap, les utilisateurs peuvent s'appuyer sur des technologies dites d'assistance, qui vont par exemple vocaliser les textes, transcrire les contenus audio, ou permettre de piloter une interface par la voix, l'oeil, ou différentes parties du corps.</p>

<p>Ces technologies d'assistance sont une chance formidable pour les utilisateurs handicapés, et ont de nombreux arguments à faire valoir : constamment disponibles, infatigables, impartiales, multi-compétentes… Mais elles ont un énorme défaut, par rapport aux besoins humains: elles sont désespérément stupides, et limitées. Pour fonctionner correctement, on doit les alimenter avec des contenus et interfaces accessibles. Et ça, c'est pas gagné…</p>

<p>Mais ce n'est peut-être pas une fatalité. Les progrès récents de l'intelligence artificielle et du machine learning, associés au big data, autorisent tous les espoirs: et si les technologies d'assistance finissaient par égaler les capacités humaines de perception et de compréhension?</p>

<p>Cette conférence propose, humblement, d’explorer cette hypothèse, en faisant l’inventaire de quelques technologies, issues des laboratoires ou déjà sur le marché, qui pourraient rendre ce rêve bien réel. Ce n’est pas encore possible, mais demain cela arrivera. Et l’on n’aura plus besoin de l’accessibilité…</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/olivier-nourry.php">Olivier Nourry</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Olivier Nourry" src="https://www.paris-web.fr/2015/assets_c/2015/09/Olivier%20Nourry-thumb-143x143-521.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Je me suis pris l'accessibilité en pleine face, un beau matin de 2005. Depuis, je passe mon temps à sensibiliser, former, aider, cajoler, engueuler, celles et ceux qui, en créant du web, ont le pouvoir de le rendre meilleur, pour tous.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/le-jour-ou-lon-naura-plus-besoin-de-laccessibilite.php&amp;ref=prez-le-jour-ou-lon-naura-plus-besoin-de-laccessib&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
