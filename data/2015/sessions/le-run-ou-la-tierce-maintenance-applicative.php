...
<title>Paris Web - Le « RUN » (ou la Tierce Maintenance Applicative)</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/-hey-tu-peux-reprendre-ce-projet.php" title="« Hey, tu peux reprendre ce projet ? »" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/openid-connect-le-nouveau-standard-dauthentification-sur-le-web-mise-en-oeuvre-sur-franceconnect.php" title="OpenID Connect, le nouveau standard d'authentification sur le web : mise en oeuvre sur FranceConnect" />
	...
	<meta name="twitter:title" content="Le « RUN » (ou la Tierce Maintenance Applicative)" />
	<meta property="twitter:description" content="En phase de « RUN », illustrer les différents types de maintenance à partir d’analogie avec des classiques du cinéma." />
	<meta property="dc:title" content="Le « RUN » (ou la Tierce Maintenance Applicative)" />
	<meta property="og:title" content="Le « RUN » (ou la Tierce Maintenance Applicative)" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/le-run-ou-la-tierce-maintenance-applicative.php" />
	<meta property="og:description" content="En phase de « RUN », illustrer les différents types de maintenance à partir d’analogie avec des classiques du cinéma." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le « RUN » (ou la Tierce Maintenance Applicative)</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1742">
						<header>
							<h1>Le « RUN » (ou la Tierce Maintenance Applicative)</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/143791973" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/ak2Ppjt09vjYeY" 
	...
	<section class="s-talk-subject" id="sujet-1742">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/le-run-ou-la-tierce-maintenance-applicative.php" class="url">Le « RUN » (ou la Tierce Maintenance Applicative)</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Après avoir mis en ligne un nouveau site web, on entre dans une phase dite de « RUN » ou plus précisément en Tierce Maintenance Applicative (TMA). Il s’agit d’assurer une maintenance corrective, mais pas seulement… Il faut prendre en compte la maintenance préventive, la maintenance adaptative, le support fonctionnel, l’exploitation, etc.</p>

<p>Or il y a souvent des confusions entre toutes ces notions. Je propose de partager leur définition et quelques bonnes pratiques de mise en œuvre, tout en illustrant la spécificité de chacune de ces maintenances à partir de situations empruntées aux classiques du cinéma.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/leila-touati.php">Leila Touati</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Leila Touati" src="https://www.paris-web.fr/2015/assets_c/2015/05/Leila%20Touati-thumb-143x143-488.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>J’ai débuté ma carrière en tant que développeuse chez Capgemini Télecoms &amp; Médias il y a 15 ans, puis j’ai évolué vers le poste de responsable de bureau d’étude pour SFR. À la Direction Technique d’Orange en 2008, j’ai travaillé sur les premiers services embarqués sur mobile de la marque. Enfin, depuis trois ans, je travaille pour l’agence web eEkino. Je suis en charge du pilotage opérationnel de projets de réalisation d’applications web pour La Poste et Renault.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/le-run-ou-la-tierce-maintenance-applicative.php&amp;ref=prez-le-run-ou-la-tierce-maintenance-applicative&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
