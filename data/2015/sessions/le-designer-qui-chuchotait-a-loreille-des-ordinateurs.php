...
<title>Paris Web - Le designer qui chuchotait à l'oreille des ordinateurs</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/informelles-2-3.php" title="Informelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/pause-dejeuner-1.php" title="Pause déjeuner" />
	...
	<meta name="twitter:title" content="Le designer qui chuchotait à l'oreille des ordinateurs" />
	<meta property="twitter:description" content="Terminal, mon ami ! Pour les graphistes qui veulent apprendre à chuchoter à l'oreille des ordinateurs…" />
	<meta property="dc:title" content="Le designer qui chuchotait à l'oreille des ordinateurs" />
	<meta property="og:title" content="Le designer qui chuchotait à l'oreille des ordinateurs" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/le-designer-qui-chuchotait-a-loreille-des-ordinateurs.php" />
	<meta property="og:description" content="Terminal, mon ami ! Pour les graphistes qui veulent apprendre à chuchoter à l'oreille des ordinateurs…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le designer qui chuchotait à l'oreille des ordinateurs</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1745">
						<header>
							<h1>Le designer qui chuchotait à l'oreille des ordinateurs</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/145317794" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
...
<a href="http://slides.com/thierrymichel/le-designer-qui-chuchotait-l-oreille-des-ordinateurs#/" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1745">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/le-designer-qui-chuchotait-a-loreille-des-ordinateurs.php" class="url">Le designer qui chuchotait à l'oreille des ordinateurs</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/outils" rel="tag">Outils</a><br /><a href="http://www.paris-web.fr/2015/recherche/performance" rel="tag">performance</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Le web change et se spécialise un peu plus chaque jour.
Ces dernières années, de nombreux outils accessibles via la ligne de commande (Git, node.js, Sass, Gulp…) ont vu le jour.</p>

<p>Souvent perçue par les designers comme un truc de nerd magicien, comme étant le meilleur moyen d'inoculer Alzheimer à votre disque dur ou comme servant juste à afficher la matrice… la console permet de se libérer des interfaces graphiques.</p>

<p>Rapidité d'exécution, automatisation de tâches, accès distant… le Terminal est un excellent moyen de devenir le meilleur ami de vos ordinateurs en parlant le même langage !</p>

<p>Au programme, partage d'expérience pour les graphistes (et autres curieux) par un graphiste, devenu webdesigner, devenu front-end developer, sur le pourquoi du comment utiliser la console. Atterrissage en douceur garanti…</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/thierry-michel.php">Thierry Michel</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Thierry Michel" src="https://www.paris-web.fr/2015/assets_c/2015/05/Thierry%20Michel-thumb-143x143-464.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>HTML/CSS ninja, Sass and jQuery lover, pixel addict. 
Je forme les futurs développeurs front-end @cepegra et j'élève des champions pour @skillsbelgium…</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/le-designer-qui-chuchotait-a-loreille-des-ordinateurs.php&amp;ref=prez-le-designer-qui-chuchotait-a-loreille-des-ord&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
