...
<title>Paris Web - Vie privée, surveillance, dépendance aux GAFAs, faut-il réinventer le web pour éviter la dystopie ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/pause.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/le-jour-ou-lon-naura-plus-besoin-de-laccessibilite.php" title="Le jour où l'on n'aura plus besoin de l'accessibilité" />
	...
	<meta name="twitter:title" content="Vie privée, surveillance, dépendance aux GAFAs, faut-il réinventer le…" />
	<meta property="twitter:description" content="Et si on réinventait l'Internet en sortant des GAFAs et de la publicité ciblée avec des SIRCUS, S.I. Redonnant Contrôle aux UtilisateurS ?" />
	<meta property="dc:title" content="Vie privée, surveillance, dépendance aux GAFAs, faut-il réinventer le web pour éviter la dystopie ?" />
	<meta property="og:title" content="Vie privée, surveillance, dépendance aux GAFAs, faut-il réinventer le web pour éviter la dystopie ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/vie-privee-surveillance-dependance-aux-gafas-faut-il-reinventer-le-web-pour-eviter-la-dystopie.php" />
	<meta property="og:description" content="Et si on réinventait l'Internet en sortant des GAFAs et de la publicité ciblée avec des SIRCUS, S.I. Redonnant Contrôle aux UtilisateurS ?" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Vie privée, surveillance, dépendance aux GAFAs, faut-il réinventer le web pour éviter la dystopie ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1711">
						<header>
							<h1>Vie privée, surveillance, dépendance aux GAFAs, faut-il réinventer le web pour éviter la dystopie ?</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/146682821" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/9qlLuRvLVv9THL" 
	...
	<section class="s-talk-subject" id="sujet-1711">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/vie-privee-surveillance-dependance-aux-gafas-faut-il-reinventer-le-web-pour-eviter-la-dystopie.php" class="url">Vie privée, surveillance, dépendance aux GAFAs, faut-il réinventer le web pour éviter la dystopie ?</a></span></span></h2>
...
<dd class="column location"><a href="/lieux/#conferences">Salle Mœbius</a></dd>
...
<dd class="column">
16 <abbr title="heures">h</abbr> 20
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/hebergement" rel="tag">Hébergement</a><br /><a href="http://www.paris-web.fr/2015/recherche/logiciel-libre" rel="tag">logiciel libre</a><br /><a href="http://www.paris-web.fr/2015/recherche/vie-privee" rel="tag">Vie privée</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Que reste-t-il de la promesse initiale du web ? Celle d'un accès libre à l'information, au savoir, au partage ? L'idée que chacun pouvait lire <em>et</em> écrire librement à l'intention de tous ? </p>

<p>Alléchés par la gratuité de services gratuits sans cesse plus cools au premier abord, nous sommes devenus largement dépendants de grands services difficiles à quitter. Ces services nous pistent à chaque instant, compilent nos préférences, lisent nos messages, scrutent nos contacts, surveillent ce qui nous préoccupe, savent où nous nous déplaçons. </p>

<p>Nous pensons être leurs clients, nous pensons être des rois. Mais nous ne sommes que la matière première qui est vendue à ceux qui payent pour nous ces services, les annonceurs publicitaires.</p>

<p>Nous sommes des cochons qui croient que la nourriture qui les engraisse leur est offerte car le monde tourne autour d'eux, négligeant de s'intéresser au fermier qui surveille leur courbe de poids, ignorant tout de l'abattoir et de la boucherie.</p>

<p>Nous, internautes, nous sommes les cochons du numérique, engraissés à coup de vidéos de chatons, bientôt débités en andouillettes, saucissons industriels et jambons sous cellophane.</p>

<p>Mais nous, à Paris-Web, nous sommes plus que cela. Nous sommes ceux qui font le web. Peut-on imaginer un web plus respectueux des valeurs originelles ? Un web qui ne dépouille pas les usagers de leurs données personnelles ? Un web qui respecte ses usagers ? Un web qui ne se soumette pas à la surveillance de masse mise en place par la loi Renseignement ?</p>

<p>À quoi ressemblerait ce web ? Sur quels principes serait-il bâti ? C'est ce que je vous propose de voir ensemble. Parmi les 7 principes :</p>

<ol start='1'>
<li>Auto-hébergement</li>
<li>Logiciel libre</li>
<li>Chiffrement</li>
<li>Dire non à la gratuité</li>
<li>Ergonomie &amp; UX</li>
<li>Standards</li>
<li>Killer feature</li>
</ol>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/tristan-nitot.php">Tristan Nitot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Tristan Nitot" src="https://www.paris-web.fr/2015/assets_c/2015/05/Tristan%20Nitot-thumb-143x143-476.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Co-fondateur et ancien président de Mozilla Europe, co-fondateur du projet OpenWeb, auteur de Standblog.org, membre du CNNum, auteur d'un livre sur la vie privée et la surveillance de masse (en cours), co-fondateur de Ni-Pigeons-Ni-Espions (contre le PJL Renseignement).</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/vie-privee-surveillance-dependance-aux-gafas-faut-il-reinventer-le-web-pour-eviter-la-dystopie.php&amp;ref=prez-vie-privee-surveillance-dependance-aux-gafas-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
