...
<title>Paris Web - Bons robots, mauvais robots : un intense trafic</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/informelles-2-1.php" title="Informelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/vers-une-bonne-pratique-du-pair-design.php" title="Vers une bonne pratique du Pair Design" />
	...
	<meta name="twitter:title" content="Bons robots, mauvais robots : un intense trafic" />
	<meta property="twitter:description" content="Le web n'est pas parcouru que par des humains, mais aussi par des robots! Bons ou mauvais… Qui sont-ils ? Quels sont leurs réseaux ?" />
	<meta property="dc:title" content="Bons robots, mauvais robots : un intense trafic" />
	<meta property="og:title" content="Bons robots, mauvais robots : un intense trafic" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/bons-robots-mauvais-robots-un-intense-trafic.php" />
	<meta property="og:description" content="Le web n'est pas parcouru que par des humains, mais aussi par des robots! Bons ou mauvais… Qui sont-ils ? Quels sont leurs réseaux ?" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Bons robots, mauvais robots : un intense trafic</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1724">
						<header>
							<h1>Bons robots, mauvais robots : un intense trafic</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/143169748" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
...
<a href="http://francois.hodierne.net/2015/bons-robots-mauvais-robots/" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1724">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/bons-robots-mauvais-robots-un-intense-trafic.php" class="url">Bons robots, mauvais robots : un intense trafic</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/hebergement" rel="tag">Hébergement</a><br /><a href="http://www.paris-web.fr/2015/recherche/http" rel="tag">HTTP</a><br /><a href="http://www.paris-web.fr/2015/recherche/robots" rel="tag">robots</a><br /><a href="http://www.paris-web.fr/2015/recherche/securite" rel="tag">sécurité</a><br /><a href="http://www.paris-web.fr/2015/recherche/spam" rel="tag">spam</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le trafic généré par les robots est souvent ignoré par les webmasters, car il n'est communément pas reporté par les outils de statistiques (comme Google Analytics). Pourtant, cette activité représente une importante partie des requêtes sur le serveur et, si elle n'est pas correctement contrôlée, elle peut peser sur les coûts et les performances.</p>

<p>Pire, de mauvais ou vilains robots, aux intentions inavouables, se baladent en permanence sur le web, posant de nombreux problèmes de sécurité : brute forcing, security scanning, spamming, harvesting, scrapping.</p>

<ul>
<li>Quelles sont les bonnes pratiques permettant de reconnaître un bon robot ?</li>
<li>Comment opèrent les mauvais robots et à quels dangers nous exposent-ils ?</li>
<li>Quelles stratégies mettre en place pour les contrôler ?</li>
</ul>

<p>En tant que webmaster de multiples sites webs, je m'intéresse à ces problématiques depuis plusieurs années et je travaille sur des outils permettant de les analyser. Je partagerais ce que j'ai appris : chiffres, conseils, anecdotes.</p>

<p>Un sujet rarement abordé !</p>
</div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/bons-robots-mauvais-robots-un-intense-trafic.php&amp;ref=prez-bons-robots-mauvais-robots-un-intense-trafic&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
