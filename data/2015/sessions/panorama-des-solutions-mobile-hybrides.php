...
<title>Paris Web - Panorama des solutions mobile hybrides</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/informelles-1-4.php" title="Informelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conclusion-de-la-premiere-journee.php" title="Conclusion de la première journée" />
	...
	<meta name="twitter:title" content="Panorama des solutions mobile hybrides" />
	<meta property="twitter:description" content="Les statistiques d’utilisation des téléphones mobiles sont en constante progression et trois choix se dessinent actuellement pour délivrer du contenu sur le Web. Un site responsive, un site dédié…" />
	<meta property="dc:title" content="Panorama des solutions mobile hybrides" />
	<meta property="og:title" content="Panorama des solutions mobile hybrides" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/panorama-des-solutions-mobile-hybrides.php" />
	<meta property="og:description" content="Les statistiques d’utilisation des téléphones mobiles sont en constante progression et trois choix se dessinent actuellement pour délivrer du contenu sur le Web. Un site responsive, un site dédié…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Panorama des solutions mobile hybrides</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1889">
						<header>
							<h1>Panorama des solutions mobile hybrides</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/146682823" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/k3hmQkrNbUyWtN" 
	...
	<section class="s-talk-subject" id="sujet-1889">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/panorama-des-solutions-mobile-hybrides.php" class="url">Panorama des solutions mobile hybrides</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Les statistiques d’utilisation des téléphones mobiles sont en constante progression et trois choix se dessinent actuellement pour délivrer du contenu sur le Web. Un site responsive, un site dédié mobile ou une application disponible sur un store. Et dans ce dernier cas, vous serez très vite confronté aux contraintes des différents systèmes d’exploitation : Android, iOS et Windows Phone – pour les majoritaires. 
Dans ce contexte, beaucoup d’outils de développement émergent avec un seul objectif : réutiliser les compétences des développeurs Web et mutualiser le code entre les différentes plate-formes. 
Cette présentation se base sur le retour d’expérience réussie autour de la mise en place de prototypes et de projets client chez Ekino. Je vais vous exposer les solutions que nous n’avons pas retenues en expliquant nos choix. Puis je vais parcourir plus en détail les solutions que nous avons testées : Apache Cordova, Ionic, SuperSonic, ReactNative, etc. 
Nous verrons que l’expression “Write once, run everywhere” n’est pas toujours vrai. 
Le but est qu’à la sortie de cette conférence, je vous aie aidé à faire vos choix techniques, en fonction de vos projets et de vos compétences !</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/mickael-dumand.php">Mickael Dumand</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Mickael Dumand" src="https://www.paris-web.fr/2015/assets_c/2015/08/mickael-dumand-thumb-143x143-508.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après un DUT Services et Réseaux de Communication, Mickael a effectué une année de licence en alternance en tant que développeur au sein d'une petite agence. Travaillant depuis 5 ans en agence, il ne compte plus le nombre de problématiques différentes abordées : sites évènementiels, configurateur, réalité augmentée, RFID, Kinect, streaming, 3D, borne multitouch, application mobile, etc. 
Curieux et autodidacte, il aime mettre ses compétences techniques au service de la créativité.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/panorama-des-solutions-mobile-hybrides.php&amp;ref=prez-panorama-des-solutions-mobile-hybrides&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
