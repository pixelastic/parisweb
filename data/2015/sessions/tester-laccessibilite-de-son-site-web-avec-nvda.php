...
<title>Paris Web - Tester l'accessibilité de son site Web avec NVDA</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/es6-cest-maintenant-les-gens.php" title="ES6 c'est maintenant, les gens !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/evaluer-lux-des-methodes-simples-mais-efficaces.php" title="Evaluer l'UX : des méthodes simples mais efficaces !" />
	...
	<meta name="twitter:title" content="Tester l'accessibilité de son site Web avec NVDA" />
	<meta property="twitter:description" content="Venez apprendre les rudiments du lecteur d'écran NVDA pour tester l'accessibilité dans une formule atelier où vous serez la vedette!" />
	<meta property="dc:title" content="Tester l'accessibilité de son site Web avec NVDA" />
	<meta property="og:title" content="Tester l'accessibilité de son site Web avec NVDA" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/tester-laccessibilite-de-son-site-web-avec-nvda.php" />
	<meta property="og:description" content="Venez apprendre les rudiments du lecteur d'écran NVDA pour tester l'accessibilité dans une formule atelier où vous serez la vedette!" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Tester l'accessibilité de son site Web avec NVDA</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1732">
						<header>
							<h1>Tester l'accessibilité de son site Web avec NVDA</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/key/4AtQTOTSPZsOmO" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
</iframe>
	
<a href="http://www.paris-web.fr/2015/presentations/parisweb2015-nvda-a11y-testing-dboudreau-final.pptx" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1732">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/tester-laccessibilite-de-son-site-web-avec-nvda.php" class="url">Tester l'accessibilité de son site Web avec NVDA</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/accessibilite" rel="tag">Accessibilité</a><br /><a href="http://www.paris-web.fr/2015/recherche/approche" rel="tag">approche</a><br /><a href="http://www.paris-web.fr/2015/recherche/ecran" rel="tag">écran</a><br /><a href="http://www.paris-web.fr/2015/recherche/experience" rel="tag">expérience</a><br /><a href="http://www.paris-web.fr/2015/recherche/introduction" rel="tag">introduction</a><br /><a href="http://www.paris-web.fr/2015/recherche/lecteur" rel="tag">lecteur</a><br /><a href="http://www.paris-web.fr/2015/recherche/methodologie" rel="tag">Méthodologie</a></dd>
    ...
    <div class="talk-description"><p>Les tests d'accessibilité à l'aide de barres d'outils intégrées aux navigateurs Web représentent déjà une tâche ardue pour la plupart d'entre nous; ajoutez à cela des exigences de test avec lecteurs d'écran et pour la plupart, le tout devient rapidement bien trop compliqué pour y mettre l'effort. Pourtant, ce n'est pas du tout sorcier! </p>

<p>Cet atelier pratique d'introduction à l'usage du lecteur d'écran NVDA est destiné à ceux et celles qui ne se considèrent pas forcément experts en la matière, mais qui doivent tout de même parfois mesurer le niveau d'accessibilité de leurs projets. </p>

<p>Ensembles, nous établirons les bases de ce qui pourrait devenir votre prochain cadre méthodologie de tests pour l'accessibilité. Aucun ninja skill requis! Apportez vos laptops et vos pires craintes à propos de l'utilisation de lecteurs d'écran, afin que nous puissions les pourfendre à grands coups de techniques éprouvées (pourfendre vos craintes, pas vos laptops)!</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/denis-boudreau.php">Denis Boudreau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Denis Boudreau" src="https://www.paris-web.fr/2015/assets_c/2015/05/Denis%20Boudreau-thumb-143x143-469.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Denis est consultant senior et stratège en accessibilité à l'emploi de la boîte ontarienne Simply Accessible, et un expert invité du World Wide Web Consortium (W3C) dans différents groupes de travail. Il fait la promotion de l'inclusion sociale sur le Web depuis 2001 et dirige la conférence annuelle a11yMTL à Montréal, depuis 2010. Il "tweete" activement à propos d'accessibilité, d'inclusion numérique et de UX au <a href="https://twitter.com/dboudreau" title="@dboudreau">@dboudreau</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/tester-laccessibilite-de-son-site-web-avec-nvda.php&amp;ref=prez-tester-laccessibilite-de-son-site-web-avec-nv&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
