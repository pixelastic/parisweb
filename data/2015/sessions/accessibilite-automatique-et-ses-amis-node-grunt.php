...
<title>Paris Web - Accessibilité automatique et ses amis Node, Grunt…</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/ateliers/et-dans-20-ans-je-fais-quoi.php" title="Et dans 20 ans, je fais quoi ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/ateliers/amelioration-progressive-de-la-theorie-a-la-pratique.php" title="Amélioration progressive de la théorie à la pratique" />
	...
	<meta name="twitter:title" content="Accessibilité automatique et ses amis Node, Grunt…" />
	<meta property="twitter:description" content="Mettez en place des tests de qualité de code, performance et accessibilité dans un environnement NodeJs, Grunt." />
	<meta property="dc:title" content="Accessibilité automatique et ses amis Node, Grunt…" />
	<meta property="og:title" content="Accessibilité automatique et ses amis Node, Grunt…" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/ateliers/accessibilite-automatique-et-ses-amis-node-grunt.php" />
	<meta property="og:description" content="Mettez en place des tests de qualité de code, performance et accessibilité dans un environnement NodeJs, Grunt." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Accessibilité automatique et ses amis Node, Grunt…</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1712">
						<header>
							<h1>Accessibilité automatique et ses amis Node, Grunt…</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1712">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/ateliers/accessibilite-automatique-et-ses-amis-node-grunt.php" class="url">Accessibilité automatique et ses amis Node, Grunt…</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2015/ateliers/">Atelier</a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/#ateliers">Voir le plan</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2015/03.php">samedi 03</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
14 <abbr title="heures">h</abbr> 30
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>

<dt class="clear span-1">Durée</dt>
<dd class="column">
1 <abbr title="heure">h</abbr> 30 <abbr title="minutes">mn</abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/accessibilite" rel="tag">Accessibilité</a><br /><a href="http://www.paris-web.fr/2015/recherche/automatisation" rel="tag">automatisation</a><br /><a href="http://www.paris-web.fr/2015/recherche/grunt" rel="tag">grunt</a><br /><a href="http://www.paris-web.fr/2015/recherche/nodejs" rel="tag">nodejs</a><br /><a href="http://www.paris-web.fr/2015/recherche/tests" rel="tag">tests</a></dd>
    ...
    <div class="talk-description"><p><strong>Prérequis pour participer à l'atelier :</strong> installer node.js ou à défaut installer VirtualBox. </p>

<p>Passage en revue de quelques solutions de tests d’accessibilité, de performance front et de qualité de code, basées sur un environnement Node.js, NPM, Grunt. Ce type de solution est un moyen moderne de déployer des tests en phase de développement pour un projet soucieux de qualité de code et d’accessibilité.</p>

<p>Nous  avons testé et mis en place ces outils dans le cadre de développement d’application Orange. Cet atelier sera un retour d’expérience dans le déploiement de tels outils. 
Cet atelier permettra à chacun de mettre en place et  s’approprier des  solutions  de tests :</p>

<ul>
<li>Un linter de code adapté aux règles basiques </li>
<li>Un linter d’accessibilité, pour aller plus loin</li>
<li>Puis, un outil avec des règles d’accessibilité plus élaborées validant le code statique des pages</li>
<li>Enfin, un outil capable valider l’accessibilité du code généré (avec un navigateur <em>headless</em> comme PhantomJS)</li>
</ul>

<p>On peut voir que la complexité augmentera de manière progressive.</p>

<p>Nous comptons montrer par la pratique l’intérêt de tels outils dans la mise en place d’un processus d’amélioration continue de l’accessibilité, de la performance et du code front dans le développement.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/vincent-aniort.php">Vincent Aniort</a> et <a href="https://www.paris-web.fr/2015/../orateurs/loic-laussel.php">Loïc Laussel</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Vincent Aniort" src="https://www.paris-web.fr/2015/assets_c/2015/09/Vincent%20Aniort-thumb-143x143-524.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Tombé dedans très tôt, suite à des études de biochimie (comme quoi !), il a tout fait : premier site « pro » en 1996 avec Notepad, monte, comme on disait à l’époque, une agence de communication multimédia, travaille en free-lance comme intégrateur, développeur, chef de projet, formateur…
Un accident de la vie le pousse à faire le « choix » d’un web accessible. Dès lors, suite à sa formation  Expert AccessiWeb, il se lance dans un web pour tous aussi en assistance à maîtrise d’ouvrage,  en évaluation et en développements front et globalement dans la mise en accessibilité…
Depuis 7 ans, il travaille Orange, en tant que Expert en accessibilité.
Il participe, à la première traduction autorisée des WCAG 2.0 (en français), au projet AccedePDF et AccedeWeb et au référentiel Opquast pour le compte de l’APF (Association des Paralysés de France), association pour laquelle il milite ardemment !
Son boulot reste toujours un plaisir et une passion dont il parle volontiers !</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Loïc Laussel" src="https://www.paris-web.fr/2015/assets_c/2015/09/Loic%20Laussel-thumb-143x143-517.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Au départ, développeur back (PHP, Java...) puis j'ai compris que c'était mal, le côté obscur !
Depuis, je me suis soigné, je fais du front et je travaille actuellement chez Orange dans un service d'accessibilité et d'ergonomie pour lequel je développe des outils d'accessibilité.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/ateliers/accessibilite-automatique-et-ses-amis-node-grunt.php&amp;ref=prez-accessibilite-automatique-et-ses-amis-node-gr&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
