...
<title>Paris Web - Service workers : reprendre le contrôle du navigateur</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/changement-de-salle-1-1.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/conferences/le-dev-front-a-mach-1-au-quotidien.php" title="[Conf Sponsor] Le dev front à Mach 1 au quotidien" />
	...
	<meta name="twitter:title" content="Service workers : reprendre le contrôle du navigateur" />
	<meta property="twitter:description" content="À la découverte des Service Workers, une des dernières briques manquantes pour combler le fossé entre les app mobiles et le web ?" />
	<meta property="dc:title" content="Service workers : reprendre le contrôle du navigateur" />
	<meta property="og:title" content="Service workers : reprendre le contrôle du navigateur" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/service-workers-reprendre-le-controle-du-navigateur.php" />
	<meta property="og:description" content="À la découverte des Service Workers, une des dernières briques manquantes pour combler le fossé entre les app mobiles et le web ?" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Service workers : reprendre le contrôle du navigateur</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1714">
						<header>
							<h1>Service workers : reprendre le contrôle du navigateur</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/144521297" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
...
<a href="https://docs.google.com/presentation/d/1hKQLmKrZU9pUVNYAp_loxxeuNeYtiqasVHn6IH2zcmk/" onClick="recordOutboundLink(this, 'Téléchargements', 'Diaporama');return false;" title="Le diaporama."><span class="badge">Afficher le diaporama</span></a>

</p>
</section>

	
	<section class="s-talk-subject" id="sujet-1714">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/service-workers-reprendre-le-controle-du-navigateur.php" class="url">Service workers : reprendre le contrôle du navigateur</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2015/conferences/mini-conferences/">Mini-<abbr title="conférence">conf</abbr></a></dd>
...
<dd class="column">
10 <abbr title="heures">h</abbr> 30
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/html" rel="tag">HTML</a><br /><a href="http://www.paris-web.fr/2015/recherche/javascript" rel="tag">JavaScript</a><br /><a href="http://www.paris-web.fr/2015/recherche/mobile" rel="tag">mobile</a><br /><a href="http://www.paris-web.fr/2015/recherche/offline" rel="tag">offline</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>On nous a promis des applications web, mais nous n'y sommes toujours pas. J'utilise du JavaScript et le navigateur me sert de plateforme de développement et d'exécution, mais je n'ai pas de liens, pas d'URL, pas de convergence entre ce que j'ai dans mon navigateur et dans mon app store. Symptôme évident : les popups « Clique <em>OK</em> pour télécharger l'application, ou clique <em>Annuler</em> pour continuer sur le site web » sont toujours là…</p>

<p>Pourtant, en ce moment, nos navigateurs sont en train de combler un des derniers fossés entre le web et les app mobiles. Cette année, demain, nous allons pouvoir faire du web, en ligne ou hors ligne, en reprenant le contrôle du navigateur et des interactions réseau.</p>

<p>Ça s'appelle <em>Service Workers</em> et ça va nous apporter tout ce que AppCache nous avait promis, de façon utilisable, et bien plus encore : cache sur lequel on peut compter, interception des requêtes web, gestion des montées en version…</p>

<p>Nous allons voir à quoi ça ressemble, quelles opportunités nous sont ouvertes, comment l'utiliser, pourquoi… et enfin rassembler les app mobiles et le web.</p>

<p>Et si nous ajoutions la capacité à nos sites web de continuer à fonctionner en déconnecté ?
Et si nous faisions enfin des app web, et pas simplement à base de JavaScript ?
Les éléments pour s'y préparer sont là, avec une quinzaine de minutes pour ouvrir les yeux et avoir envie de s'y plonger.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/eric-daspet.php">Éric Daspet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Éric Daspet" src="https://www.paris-web.fr/2015/assets_c/2015/05/eric-daspet-thumb-143x143-463.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après avoir géré la technique de la startup qu'il a co-fondé il y a quatre ans, Éric continue son bout de chemin en accompagnant équipes techniques et produit à plonger dans le web sans s'y perdre.</p>

<p>Par le passé il a co-écrit le bestseller <em>PHP 5 avancé</em>, pu explorer les performances web à Yahoo, et co-fondé les conférences Paris-Web. Convaincu de la nécessité d'un web ouvert, il sera ravi de parler avec vous d'API, de performance web, de livre numérique, de recrutement, de start-up, de vie privée, d'identité numérique, d'architectures décentralisées et surtout, de tout ce qu'il ne connait pas encore.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/service-workers-reprendre-le-controle-du-navigateur.php&amp;ref=prez-service-workers-reprendre-le-controle-du-navi&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
