...
<title>Paris Web - [Conf Sponsor] Vorlon.JS : un outil pour simplifier le debug web sur toutes les plateformes</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2015/conferences/vendez-votre-process.php" title="Vendez votre méthodologie" />
<link rel="next bookmark" href="https://www.paris-web.fr/2015/informelles-2-3.php" title="Informelles" />
	...
	<meta name="twitter:title" content="[Conf Sponsor] Vorlon.JS : un outil pour simplifier le debug web sur…" />
	<meta property="twitter:description" content="Le web est omniprésent sur toutes les plateformes. Les technologies Web sont devenues extrêmement puissantes et performantes avec des ajouts récents comme WebGL, ES6, Web Audio, WebRTC, les modules…" />
	<meta property="dc:title" content="[Conf Sponsor] Vorlon.JS : un outil pour simplifier le debug web sur toutes les plateformes" />
	<meta property="og:title" content="[Conf Sponsor] Vorlon.JS : un outil pour simplifier le debug web sur toutes les plateformes" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2015/conferences/conf-sponsor-2-1.php" />
	<meta property="og:description" content="Le web est omniprésent sur toutes les plateformes. Les technologies Web sont devenues extrêmement puissantes et performantes avec des ajouts récents comme WebGL, ES6, Web Audio, WebRTC, les modules…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Conf Sponsor] Vorlon.JS : un outil pour simplifier le debug web sur toutes les plateformes</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1863">
						<header>
							<h1>[Conf Sponsor] Vorlon.JS : un outil pour simplifier le debug web sur toutes les plateformes</h1>
						</header>
...
<section class="s-talk-talk">
    ...
    <p class="clearfix">
			...
			<iframe src="//player.vimeo.com/video/143169747" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1863">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2015/conferences/conf-sponsor-2-1.php" class="url">[Conf Sponsor] Vorlon.JS : un outil pour simplifier le debug web sur toutes les plateformes</a></span></span></h2>
...
<dd class="column">
12 <abbr title="heures">h</abbr> 15
...
<dd class="column location"><a href="http://www.paris-web.fr/2015/recherche/front-end" rel="tag">front-end</a><br /><a href="http://www.paris-web.fr/2015/recherche/outils" rel="tag">outils</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le web est omniprésent sur toutes les plateformes. Les technologies Web sont devenues extrêmement puissantes et performantes avec des ajouts récents comme WebGL, ES6, Web Audio, WebRTC, les modules de layout CSS… J’en passe et des meilleurs ! <br />
On côtoie donc plus jamais le fameux « natif ». Mais l’expérience de debug n’est pas toujours heureuse et simple.</p>

<p>C’est pour cela que nous avons décidé d’écrire un outil open-source et cross-plateformes pour simplifier l’expérience de debug web, notamment sur mobile. Nous vous présenterons le framework que nous avons écrit, son utilisation et comment écrire des plug-ins pour étendre son fonctionnement. Ramenez vos téléphones sous Android, iOS (et soyons fous sous Windows Phone !), on va les débugger ensemble dans la joie et la bonne humeur.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2015/../orateurs/etienne-margraff.php">Étienne Margraff</a> et <a href="https://www.paris-web.fr/2015/../orateurs/david-rousset.php">David Rousset</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Étienne Margraff" src="https://www.paris-web.fr/2015/assets_c/2015/09/etienne-margraff-thumb-143x143-513.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Evangéliste HTML5 et Mobilité chez Microsoft France, Etienne fait du développement dans l'univers des technologies Microsoft depuis plusieurs années. Geek passionné par la techno, Etienne joue entre autre avec HTML5, Javascript et la mobilité avec Cordova. Il touche un peu à la 3D avec une contribution sur <a href="www.babylonjs.com">BabylonJS</a> et est co-créateur de l’outil open-source <a href="http://www.vorlonjs.io">Vorlon.js</a>, un outil cross-plateforme pour débugger le web.</p>

<p>Vous pouvez le retrouver sur <a href="http://blogs.msdn.com/b/emargraff">son blog</a> et sur <a href="http://www.twitter.com/meulta">twitter</a>.</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="David Rousset" src="https://www.paris-web.fr/2015/assets_c/2015/09/david-rousset-thumb-143x143-512.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>David est ‘Program Manager’ chez Microsoft Corp autour des standard du web et de Microsoft Edge. Il est co-auteur des frameworks <a href="http://babylonjs.com/">Babylon.js</a> et <a href="http://vorlonjs.com/">Vorlon.js</a>. Vous pouvez le retrouver sur <a href="http://blogs.msdn.com/davrous">son blog</a> ou sur <a href="https://twitter.com/davrous">twitter</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2015/conferences/conf-sponsor-2-1.php&amp;ref=prez-conf-sponsor-2-1&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
