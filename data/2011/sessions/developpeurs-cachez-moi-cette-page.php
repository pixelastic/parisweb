...
<title>Paris Web - Développeurs, cachez-moi cette page !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/principes-dingenierie-du-developpement-web.php" title="Principes d’ingénierie du développement Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/vive-les-tableaux-de-mise-en-page.php" title="Vive les tableaux de mise en page !" />
	...
	<meta name="twitter:title" content="Développeurs, cachez-moi cette page !" />
	<meta property="twitter:description" content="L'une des contraintes les plus complexes à résoudre lorsqu'on développe une application web consiste à ne pas générer deux fois la même page. Pour y parvenir, la plupart des développeurs ont recours…" />
	<meta property="dc:title" content="Développeurs, cachez-moi cette page !" />
	<meta property="og:title" content="Développeurs, cachez-moi cette page !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/developpeurs-cachez-moi-cette-page.php" />
	<meta property="og:description" content="L'une des contraintes les plus complexes à résoudre lorsqu'on développe une application web consiste à ne pas générer deux fois la même page. Pour y parvenir, la plupart des développeurs ont recours…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Développeurs, cachez-moi cette page !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-226">
						<header>
							<h1>Développeurs, cachez-moi cette page !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/http-caching-111015020328-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/03-samedi/SA-AM-05-HHamon/developpeurs_cachez-moi_cette_page.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-226">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/developpeurs-cachez-moi-cette-page.php" class="url">Développeurs, cachez-moi cette page !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/http" rel="tag">HTTP</a><br /><a href="http://www.paris-web.fr/2011/recherche/performance" rel="tag">Performance</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/hugo-hamon.php">Hugo Hamon</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Hugo Hamon" src="https://www.paris-web.fr/2011/assets_c/2011/07/hugo-hamon-thumb-143x143-141.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Hugo Hamon est responsable des formations chez <span lang="en">Sensio Labs</span>. Passionné par <abbr>PHP</abbr> et le Web en général depuis 10 ans, il est aujourd'hui impliqué dans l'Association Française des Utilisateurs de <abbr>PHP</abbr> et intervient comme orateur international lors de conférences <abbr>PHP</abbr>. En plus de son activité professionnelle, Hugo Hamon contribue au code et à la documentation du <span lang="en">framework Symfony</span> et rédige des ouvrages pour les éditions Eyrolles.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/developpeurs-cachez-moi-cette-page.php&amp;ref=prez-developpeurs-cachez-moi-cette-page&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
