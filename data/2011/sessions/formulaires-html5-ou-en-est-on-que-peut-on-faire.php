...
<title>Paris Web - Formulaires HTML5 : où en est-on ? Que peut-on faire ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/je-veux-un-vrai-sous-titrage.php" title="Je veux un VRAI sous-titrage !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/repas.php" title="Déjeuner" />
	...
	<meta name="twitter:title" content="Formulaires HTML5 : où en est-on ? Que peut-on faire ?" />
	<meta property="twitter:description" content="Les formulaires HTML5 introduisent pleins de nouveautés qui peuvent être utilisées dès aujourd'hui. Nous allons voir quelles sont ces nouveautés, comment les utiliser et quel est le support actuel…" />
	<meta property="dc:title" content="Formulaires HTML5 : où en est-on ? Que peut-on faire ?" />
	<meta property="og:title" content="Formulaires HTML5 : où en est-on ? Que peut-on faire ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/formulaires-html5-ou-en-est-on-que-peut-on-faire.php" />
	<meta property="og:description" content="Les formulaires HTML5 introduisent pleins de nouveautés qui peuvent être utilisées dès aujourd'hui. Nous allons voir quelles sont ces nouveautés, comment les utiliser et quel est le support actuel…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Formulaires HTML5 : où en est-on ? Que peut-on faire ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-318">
						<header>
							<h1>Formulaires HTML5 : où en est-on ? Que peut-on faire ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xppcq1?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb28_MounirLamouri_formulairesHTML5_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
	...
	<section class="s-talk-subject" id="sujet-318">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/formulaires-html5-ou-en-est-on-que-peut-on-faire.php" class="url">Formulaires HTML5 : où en est-on ? Que peut-on faire ?</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Les formulaires HTML5 introduisent pleins de nouveautés qui peuvent être utilisées dès aujourd'hui. Nous allons voir quelles sont ces nouveautés, comment les utiliser et quel est le support actuel des différents navigateurs.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/mounir-lamouri.php">Mounir Lamouri</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Mounir Lamouri" src="https://www.paris-web.fr/2011/assets_c/2011/07/mounir-lamouri-thumb-143x143-151.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Diplômé du département Informatique de l'<abbr title="Institut National des Sciences Appliquées">INSA</abbr> de Lyon en 2010, Mounir travaille depuis pour Mozilla dans l'équipe "content". Cette équipe est chargée de maintenir et d'améliorer le support du DOM et du HTML dans Gecko, le moteur de rendu de Firefox. Plus spécifiquement, Mounir a entre autre pour charge l'implémentation des formulaires HTML5 dans Gecko. </p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/formulaires-html5-ou-en-est-on-que-peut-on-faire.php&amp;ref=prez-formulaires-html5-ou-en-est-on-que-peut-on-fa&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
