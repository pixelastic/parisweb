...
<title>Paris Web - Javascript as a Programming Language</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/lopendata-une-evolution-culturelle-politique-et-technique.php" title="L'OpenData : une évolution culturelle, politique et technique" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/html5-pour-lecriture-dapplications-cross-devices-challenges-et-solutions.php" title="HTML5 pour l’écriture d’applications cross-devices : challenges et solutions" />
	...
	<meta name="twitter:title" content="Javascript as a Programming Language" />
	<meta property="twitter:description" content=" How to setup up a stable javascript continuous integration environment and why you need it. Through a real life example, the talk explains all the benefits of having a development process that…" />
	<meta property="dc:title" content="Javascript as a Programming Language" />
	<meta property="og:title" content="Javascript as a Programming Language" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/javascript-as-a-programming-language.php" />
	<meta property="og:description" content=" How to setup up a stable javascript continuous integration environment and why you need it. Through a real life example, the talk explains all the benefits of having a development process that…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Javascript as a Programming Language</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-274">
						<header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpkork?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb20_MarcoCedaro_Javascript_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/javascriptasaprogramminglanguage-parisweb-111014083736-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-GA-05-MCedaro/javascript_as_a_programming_language.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-274">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/javascript-as-a-programming-language.php" class="url">Javascript as a Programming Language</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/javascript" rel="tag">Javascript</a></dd>
...
<p>How to setup up a stable javascript continuous integration environment and why you need it. 
</p><p>
Through a real life example, the talk explains all the benefits of having a development process that brings real control over javascript codebase. A deep analysis of developer and webapps needs and of the tools that fit those requirements.</p>
</div><div lang="fr" class="span-6 last"><p>Comment mettre en place en environnement d'intégration continue stable pour JavaScript, et pourquoi vous en avez besoin.</p><p>A l'aide d'exemple réels, cette conférence expliquera les bénéfices amenés par un processus de développement qui offre un réel contrôle sur son code JavaScript. Il s'agit d'une analyse en profondeur des besoins des développeurs et des applications, ainsi que des outils.</p></div>
<div class="box clear">
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/marco-cedaro.php">Marco Cedaro</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marco Cedaro" src="https://www.paris-web.fr/2011/assets_c/2011/07/marco-cedaro-thumb-143x143-159.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><div lang="en" class="span-6">
<p>
Marco is a lazy developer with two kids, and meteoropathy insane passion for lo-fi music. Frontend developer since 1998, he worked at Yoox Group since 2006 and recently moved to Spreaker.
</p>
<p>
In the last couple of years his effort were focused on clientside platform develoment and architectural management.
</p>
<p>
He is involved in the organization of frontend meetups with From The Front.
</p>
</div>
<div lang="fr" class="span-6 last">
<p>Marco est un développeur fainéant, avec deux enfants, la météoropathie et une passion effrénée pour la musique lo-fi. Développeur côté client depuis 1998, il a travaillé chez Yoox Group depuis 2006, et a récemment bougé pour Spreaker.</p>
<p>
Ces dernières années, il a concentré ses efforts sur le développement côté client, et gestion de l'architecture.</p>
<p>
Il est impliqué dans l'organisation de rencontres de développeurs côté client avec From The Front.
</p>
</div></div>
</div>
