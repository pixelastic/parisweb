...
<title>Paris Web - Comment argumenter en faveur d'un poste de responsable qualité web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/simply-responsive-css3.php" title="Simply Responsive CSS3" />
	...
	<meta name="twitter:title" content="Comment argumenter en faveur d'un poste de responsable qualité web" />
	<meta property="twitter:description" content=" Si le poste de Responsable qualité web commence - à peine - à se faire connaître, il est important de se poser la question de sa rentabilité. Comment peut-on vendre un tel poste support (qui…" />
	<meta property="dc:title" content="Comment argumenter en faveur d'un poste de responsable qualité web" />
	<meta property="og:title" content="Comment argumenter en faveur d'un poste de responsable qualité web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/comment-argumenter-en-faveur-dun-poste-de-responsable-qualite-web.php" />
	<meta property="og:description" content=" Si le poste de Responsable qualité web commence - à peine - à se faire connaître, il est important de se poser la question de sa rentabilité. Comment peut-on vendre un tel poste support (qui…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Comment argumenter en faveur d'un poste de responsable qualité web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-367">
						<header>
							<h1>Comment argumenter en faveur d'un poste de responsable qualité web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/03-samedi/SA-PM-10-DMalassingne/comment_argumenter_en_faveur_poste_responsable_qualite_web.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-367">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/comment-argumenter-en-faveur-dun-poste-de-responsable-qualite-web.php" class="url">Comment argumenter en faveur d'un poste de responsable qualité web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/metier" rel="tag">Métier</a><br /><a href="http://www.paris-web.fr/2011/recherche/qualite" rel="tag">Qualité</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/delphine-malassingne.php">Delphine Malassingne</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Delphine Malassingne" src="https://www.paris-web.fr/2011/assets_c/2011/07/delphine-thumb-143x143-165.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Après une formation artistique, Delphine a souhaité exercer son goût pour la communication par l’image via le webdesign. Passionnée par toutes les problématiques d’interface, c’est naturellement qu’elle s’est ouverte à l’ergonomie, à l’expérience utilisateur, au référencement naturel, etc. Un passage sur le forum Webmaster Hub l’a mise sur la voie des standards du web et de l’accessibilité.
</p>
<p>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/comment-argumenter-en-faveur-dun-poste-de-responsable-qualite-web.php&amp;ref=prez-comment-argumenter-en-faveur-dun-poste-de-res&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
