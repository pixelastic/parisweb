...
<title>Paris Web - Améliorer le confort d'utilisation des sites web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/stockage-anodin-de-donnees-personnelles-conciliez-legal-et-ethique.php" title="Stockage anodin de données personnelles : conciliez légal et éthique" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/le-cout-des-sites-web-html5-versus-flash.php" title="Flash ou HTML5 ? Quelle techno choisir et pour quel prix." />
	...
	<meta name="twitter:title" content="Améliorer le confort d'utilisation des sites web" />
	<meta property="twitter:description" content="Tous les gens qui font du web savent comment régler l'affichage d'un site web, connaissent les CSS utilisateurs, les options de zoom. Mais dans le monde réel, qui sait fixer ce genre de préférences,…" />
	<meta property="dc:title" content="Améliorer le confort d'utilisation des sites web" />
	<meta property="og:title" content="Améliorer le confort d'utilisation des sites web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/ameliorer-le-confort-dutilisation-des-sites-web.php" />
	<meta property="og:description" content="Tous les gens qui font du web savent comment régler l'affichage d'un site web, connaissent les CSS utilisateurs, les options de zoom. Mais dans le monde réel, qui sait fixer ce genre de préférences,…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Améliorer le confort d'utilisation des sites web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-360">
						<header>
							<h1>Améliorer le confort d'utilisation des sites web</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-360">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/ameliorer-le-confort-dutilisation-des-sites-web.php" class="url">Améliorer le confort d'utilisation des sites web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/accessibilite" rel="tag">Accessibilité</a><br /><a href="http://www.paris-web.fr/2011/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>Tous les gens qui font du web savent comment régler l'affichage d'un site web, connaissent les CSS utilisateurs, les options de zoom. Mais dans le monde réel, qui sait fixer ce genre de préférences, entre autres ?</p>

<p>Stéphane Deschamps partagera un retour d'expérience tiré d'une question a priori simple : peut-on aller plus loin que simplement travailler sur l'accessibilité des sites web pour augmenter le confort d'utilisation ? Il montrera comment, sur la base de cette question, on peut tirer une bibliothèque distribuable en Javascript.</p></div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/ameliorer-le-confort-dutilisation-des-sites-web.php&amp;ref=prez-ameliorer-le-confort-dutilisation-des-sites-w&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
