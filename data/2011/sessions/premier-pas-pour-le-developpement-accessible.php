...
<title>Paris Web - Premier pas pour le développement accessible</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/la-lisibilite-des-contenus.php" title="La lisibilité des contenus" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/travaillons-avec-le-web.php" title="Travaillons avec le Web" />
	...
	<meta name="twitter:title" content="Premier pas pour le développement accessible" />
	<meta property="twitter:description" content="Les recommandations pour la production de contenus accessibles (WCAG) existent maintenant depuis plus de 10 ans mais l'accessibilité fait toujours cruellement défaut dans la majorité des productions…" />
	<meta property="dc:title" content="Premier pas pour le développement accessible" />
	<meta property="og:title" content="Premier pas pour le développement accessible" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/premier-pas-pour-le-developpement-accessible.php" />
	<meta property="og:description" content="Les recommandations pour la production de contenus accessibles (WCAG) existent maintenant depuis plus de 10 ans mais l'accessibilité fait toujours cruellement défaut dans la majorité des productions…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Premier pas pour le développement accessible</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-363">
						<header>
							<h1>Premier pas pour le développement accessible</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-363">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/premier-pas-pour-le-developpement-accessible.php" class="url">Premier pas pour le développement accessible</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/accessibilite" rel="tag">Accessibilité</a></dd>
    ...
    <div class="talk-description"><p>Les recommandations pour la production de contenus accessibles (<abbr title="Web Content Accessibility Guidelines" lang="en">WCAG</abbr>) existent maintenant depuis plus de 10 ans mais l'accessibilité fait <br />
toujours cruellement défaut dans la majorité des productions web en France et dans le monde. Manque de volonté&nbsp;? Manque de compétences&nbsp;? Manque de temps ou d'argent ? Les raisons invoquées sont multiples et variées, certaines à tort, d'autre à raisons.</p>

<p>Certes il existe des listes de tests de conformité <abbr>WCAG</abbr> (<abbr title="Référentiel Général d'Accessibilité pour les Administrations">RGAA</abbr>, Accessiweb, <acronym title="Unified Web Evaluation Methodology" lang="en">UWEM</acronym>...) mais celles ci sont surtout orientées vérification à postériori de la production. Il reste cependant à inventer des outils tels qu'une liste permettant de savoir simplement quels sont les premiers pas nécessaires pour se mettre sur la voie d'un site accessible. Peu importe le test qu'ils permettent de satisfaire, ces premiers pas sont des choses à faire impérativement lors de la production d'un site, ils pourraient par exemple indiquer précisément les éléments ou attributs indispensables et la façon de les utiliser.</p>

<p>Nous débattrons au cours de cet atelier d'une première liste et essayerons ensemble de l'enrichir.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/aurelien-levy.php">Aurélien Levy</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Aurélien Levy" src="https://www.paris-web.fr/2011/assets_c/2011/08/aurelien-levy-thumb-143x143-41-thumb-143x143-175.jpg" width="143" height="143">
...
<p>A titre personnel, il est également un des correspondants en France du <abbr title="Web Standards Project" lang="en">WaSP</abbr>-<abbr title="International Liaison Group" lang="en">ILG</abbr> ce qui l’amène à organiser régulièrement des <a class="spip_out" href="http://france.w3cafe.org/">W3Cafés</a>.</p>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/premier-pas-pour-le-developpement-accessible.php&amp;ref=prez-premier-pas-pour-le-developpement-accessible&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
