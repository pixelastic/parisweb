...
<title>Paris Web - L'OpenData : une évolution culturelle, politique et technique</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/repas-3.php" title="Déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/javascript-as-a-programming-language.php" title="Javascript as a Programming Language" />
	...
	<meta name="twitter:title" content="L'OpenData : une évolution culturelle, politique et technique" />
	<meta property="twitter:description" content="Vous souhaitez libérer des données&nbsp;? Qu'est-ce qu'une donnée&nbsp;? Qu'entend-on par «&nbsp;libération&nbsp;»&nbsp;? Comment favoriser la réutilisation de vos données pour en décupler leur…" />
	<meta property="dc:title" content="L'OpenData : une évolution culturelle, politique et technique" />
	<meta property="og:title" content="L'OpenData : une évolution culturelle, politique et technique" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/lopendata-une-evolution-culturelle-politique-et-technique.php" />
	<meta property="og:description" content="Vous souhaitez libérer des données&nbsp;? Qu'est-ce qu'une donnée&nbsp;? Qu'entend-on par «&nbsp;libération&nbsp;»&nbsp;? Comment favoriser la réutilisation de vos données pour en décupler leur…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L'OpenData : une évolution culturelle, politique et technique</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-258">
						<header>
							<h1>L'OpenData : une évolution culturelle, politique et technique</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpli6g?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb23_DavidLarlet_OpenDataDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
	...
	<section class="s-talk-subject" id="sujet-258">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/lopendata-une-evolution-culturelle-politique-et-technique.php" class="url">L'OpenData : une évolution culturelle, politique et technique</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Vous souhaitez libérer des données&nbsp;? Qu'est-ce qu'une donnée&nbsp;? Qu'entend-on par «&nbsp;libération&nbsp;»&nbsp;? Comment favoriser la réutilisation de vos données pour en décupler leur valeur&nbsp;? Quelles sont les bonnes pratiques dans ce domaine&nbsp;? Quelles sont les conditions de réutilisation&nbsp;? Quels sont les outils existants&nbsp;? Quelles sont les sources actuelles&nbsp;? Locales&nbsp;? Nationales&nbsp;? Comment croiser ces données pour proposer un service innovant aux utilisateurs&nbsp;? Comment les hackers-citoyens peuvent-ils s'approprier ces données&nbsp;?</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/david-larlet.php">David Larlet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="David Larlet" src="https://www.paris-web.fr/2011/assets_c/2011/07/david-larlet-thumb-143x143-143.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>David est un geek. Il aime contrôler, partager, discuter, découvrir et transmettre. En partie à travers ses interventions liées à l'ouverture du Web et aux moyens techniques permettant son élaboration mais aussi par l'organisation d'événements comme les rencontres <a href="http://rencontres.django-fr.org">Django</a> ou <a href="http://sudweb.fr/">SudWeb</a>. Il lui arrive sporadiquement d'alimenter son blog : <a href="http://www.biologeek.com/">biologeek.com</a> et de gazouiller&nbsp;: <a href="https://twitter.com/#!/davidbgk">@davidbgk</a>.</p>

<p>David est aussi un architecte du Web. Freelance depuis 4 ans, il s'implique dans des projets innovants en mettant à profit son expérience pour améliorer l'expérience utilisateur et proposer une approche qualitative du développement web.</p>

<p>Lorsqu'il n'est pas devant un écran, David randonne et prend des photos. Il passe actuellement une année au Japon pour découvrir de nouvelles cultures, de nouveaux points de vue.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/lopendata-une-evolution-culturelle-politique-et-technique.php&amp;ref=prez-lopendata-une-evolution-culturelle-politique-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
