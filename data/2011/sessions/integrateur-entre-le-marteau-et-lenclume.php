...
<title>Paris Web - Intégrateur : entre le marteau et l'enclume</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/le-cout-des-sites-web-html5-versus-flash.php" title="Flash ou HTML5 ? Quelle techno choisir et pour quel prix." />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/dompter-le-web-mobile.php" title="Dompter le Web Mobile" />
	...
	<meta name="twitter:title" content="Intégrateur : entre le marteau et l'enclume" />
	<meta property="twitter:description" content=" Vous réalisez vos intégrations avec soin et amour&nbsp;: idéalement valides, sémantiques et accessibles. Mais pourquoi faut-il que le 'dev' saccage cela&nbsp;!? À partir d'exemples concrets nous…" />
	<meta property="dc:title" content="Intégrateur : entre le marteau et l'enclume" />
	<meta property="og:title" content="Intégrateur : entre le marteau et l'enclume" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/integrateur-entre-le-marteau-et-lenclume.php" />
	<meta property="og:description" content=" Vous réalisez vos intégrations avec soin et amour&nbsp;: idéalement valides, sémantiques et accessibles. Mais pourquoi faut-il que le 'dev' saccage cela&nbsp;!? À partir d'exemples concrets nous…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Intégrateur : entre le marteau et l'enclume</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-355">
						<header>
							<h1>Intégrateur : entre le marteau et l'enclume</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/03-samedi/SA-PM-09-RDuhem_Verdiere/integrateur_entre_le_marteau_et_enclume.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-355">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/integrateur-entre-le-marteau-et-lenclume.php" class="url">Intégrateur : entre le marteau et l'enclume</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/romy-duhem-verdiere.php">Romy Duhem-Verdière</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Romy Duhem-Verdière" src="https://www.paris-web.fr/2011/assets_c/2011/07/orateur_romy-thumb-143x143-69-thumb-143x143-167.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Intervenant entre l'intégrateur et le développeur backend, Romy réceptionne la maquette HTML/CSS/JS qu'elle dynamise en préalable aux développements back spécifiques. Elle participe depuis plusieurs années au développement collaboratif d'un outil libre de publication web. Dans ce cadre, elle recherche autant la qualité que la souplesse du code structurel, pour plus de modularité et de ré-employabilité.
</p>
<p>
Développeuse web front, d'abord intégratrice indépendante, aujourd'hui consultante pour <a href="http://www.clever-age.com/">Clever Age</a>, Romy documente et partage ses réflexions sur son <a href="http://romy.tetue.net/">blog</a> depuis 1999.
</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/integrateur-entre-le-marteau-et-lenclume.php&amp;ref=prez-integrateur-entre-le-marteau-et-lenclume&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
