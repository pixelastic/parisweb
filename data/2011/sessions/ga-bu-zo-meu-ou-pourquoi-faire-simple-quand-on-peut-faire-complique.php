...
<title>Paris Web - Ga, Bu, Zo, Meu, ou pourquoi faire simple quand on peut faire compliqué ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/la-sagesse-du-web.php" title="La Sagesse du Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/pause-3.php" title="Pause" />
	...
	<meta name="twitter:title" content="Ga, Bu, Zo, Meu, ou pourquoi faire simple quand on peut faire…" />
	<meta property="twitter:description" content="Les 5 dernières années ont vu un nombre de changements technologiques impressionnants, qui changent la manière de concevoir, coder, déployer, opérer, distribuer et monnayer les applications.…" />
	<meta property="dc:title" content="Ga, Bu, Zo, Meu, ou pourquoi faire simple quand on peut faire compliqué ?" />
	<meta property="og:title" content="Ga, Bu, Zo, Meu, ou pourquoi faire simple quand on peut faire compliqué ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/ga-bu-zo-meu-ou-pourquoi-faire-simple-quand-on-peut-faire-complique.php" />
	<meta property="og:description" content="Les 5 dernières années ont vu un nombre de changements technologiques impressionnants, qui changent la manière de concevoir, coder, déployer, opérer, distribuer et monnayer les applications.…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Ga, Bu, Zo, Meu, ou pourquoi faire simple quand on peut faire compliqué ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-240">
						<header>
							<h1>Ga, Bu, Zo, Meu, ou pourquoi faire simple quand on peut faire compliqué ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpk048?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb21_PatrickChanezon_GaBuZoMeu_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
	...
	<section class="s-talk-subject" id="sujet-240">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/ga-bu-zo-meu-ou-pourquoi-faire-simple-quand-on-peut-faire-complique.php" class="url">Ga, Bu, Zo, Meu, ou pourquoi faire simple quand on peut faire compliqué ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/kiss" rel="tag">KISS</a><br /><a href="http://www.paris-web.fr/2011/recherche/technologie" rel="tag">Technologie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Les 5 dernières années ont vu un nombre de changements technologiques impressionnants, qui changent la manière de concevoir, coder, déployer, opérer, distribuer et monnayer les applications. Certaines tendances facilitent la création d'applications simples et élégantes, alors que d'autres créent de nouvelles complexités que les développeurs doivent gérer.</p>

<p>Nous proposons un tour d'horizon des ces tendances technologiques sous forme d'un dialogue entre un Shadok et un Gibi.</p>

<ul>
  <li>Componentisation du web&nbsp;: APIs <abbr>REST</abbr> et Javascript, Gadgets Javascript, Infrastructure comme un Service (<abbr>IaaS</abbr> accessible sous forme d'APIs).</li>
  <li>Commencer par l'<abbr>API</abbr>, puis écrire les clients&nbsp;: Interface Utilisateur de <span lang="en">NewTwitter</span> construite a partir de l'API, comme les clients mobiles.</li>
  <li>Plate Forme de Nuages qui permettent une montée en charge facile (<abbr>PaaS</abbr>)&nbsp;: rendre une appli scalable représentait 90% du travail il y a 5 ans, maintenant les <abbr>PaaS</abbr> nuages + bases de données NoSQL réduisent ça a 20%, le reste peut être passé à concevoir les interactions utilisateur.</li>
  <li>Standardisation des clients, mais multiplication des facteurs de forme: du cote de chez Gibi ça se standardise autour de 2 plate formes&nbsp;: <abbr>html5</abbr> vs android &amp; <abbr>ios</abbr>. Mais du cote de Shadoko on souligne que l'appli doit tourner sur de nombreux facteurs de formes&nbsp;: <span lang="en">laptop, desktop, phone, tablets</span>. Les dernières années le serveur s'est simplifié, mais la complexité se retrouve côté client&nbsp;: tout <abbr>html5</abbr>/<abbr>css3</abbr> avec Titanium ou Phonegap, ou natif?</li>
  <li>Synchronicite&nbsp;: Shadoko cite Steve Jobs et <span lang="en">iCloud</span> pour arguer (ZoMeuGaGa) d'un retour au client serveur, aux architectures à la Lotus Notes, la synchronisation et ses problèmes. Gibi prône <abbr>HTML5</abbr> et des applications connectées la plupart du temps.</li>
  <li>Social/geo/mobile&nbsp;: 3 axes qui rendent les applications plus intéressantes, le challenge étant de rester simple. Facebook (Shadok) vs Twitter, Path et Foursquare (Gibi) comme exemples mobiles avec un focus bien précis.</li>
  <li>Monétisation&nbsp;: multiplication des marketplaces pour les applis, Shadoko se régale, Gibi compte ses revenus.</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/patrick-chanezon.php">Patrick Chanezon</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Patrick Chanezon" src="https://www.paris-web.fr/2011/assets_c/2011/07/patrick-chanezon-thumb-143x143-102.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Patrick Chanezon a rejoint Google en 2005, il fait partie de l'équipe de relations développeurs pour l'informatique en nuage et les applications à San Francisco. Auparavant, il s'occupait des relations développeurs pour créer et accroître les écosystèmes de développeurs autour de HTML5, OpenSocial, Google Checkout et de l'<abbr>API</abbr> AdWords.</p>

<p>Auparavant, il était architecte logiciel chez Sun Microsystems sur le serveur de portail de Sun, les blogs et les flux de syndication RSS et a reçu le prix du Président pour avoir aidé à lancer <a href="blogs.sun.com">blogs.sun.com</a>.</p>

<p>Précédemment, il a passé 5 ans chez AOL et Netscape où il dirigeait l'équipe du portail MyNetscape, et 2 ans chez Accenture comme expert Lotus Notes.</p>

<p>Il a co-fondé le projet open source ROME, et la communauté open source française <abbr title="OSS Get-Together Paris">OSSGTP</a>.</p>

<p>Lorsqu'il ne programme pas et n'est pas en train de lire un livre, son principal centre d'intérêt est de passer du temps avec sa femme et ses 3 enfants.</p>

<p>Patrick a un diplôme d'ingénieur, spécialité génie logiciel, de l'École Centrale de Lyon, promotion 1993.</p>

<p>Vous pouvez en apprendre plus sur <a href="http://wordpress.chanezon.com/">son blog</a> ou son flux d'activité sur <a href="http://twitter.com/chanezon">@chanezon</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/ga-bu-zo-meu-ou-pourquoi-faire-simple-quand-on-peut-faire-complique.php&amp;ref=prez-ga-bu-zo-meu-ou-pourquoi-faire-simple-quand-o&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
