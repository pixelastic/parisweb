...
<title>Paris Web - Comment améliorer les performances avec l'usage mixé d'hébergeurs, CDN et Clouds ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/les-gouts-et-les-couleurs.php" title="Les goûts et les couleurs" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/pause-1.php" title="Pause" />
	...
	<meta name="twitter:title" content="Comment améliorer les performances avec l'usage mixé d'hébergeurs,…" />
	<meta property="twitter:description" content="Est-il possible d'améliorer les performances et optimiser les coûts avec l'usage mixé d'hébergeurs, CDN et Clouds ? Tous les éditeurs sont aujourd'hui à la recherche d'une solution permettant de…" />
	<meta property="dc:title" content="Comment améliorer les performances avec l'usage mixé d'hébergeurs, CDN et Clouds ?" />
	<meta property="og:title" content="Comment améliorer les performances avec l'usage mixé d'hébergeurs, CDN et Clouds ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/est-il-possible-dameliorer-les-performances-et-optimiser-les-couts-avec-lusage-mixe-dhebergeurs-cdn-.php" />
	<meta property="og:description" content="Est-il possible d'améliorer les performances et optimiser les coûts avec l'usage mixé d'hébergeurs, CDN et Clouds ? Tous les éditeurs sont aujourd'hui à la recherche d'une solution permettant de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Comment améliorer les performances avec l'usage mixé d'hébergeurs, CDN et Clouds ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-238">
						<header>
							<h1>Comment améliorer les performances avec l'usage mixé d'hébergeurs, CDN et Clouds ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xnl50v?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb07_StephaneEnten_JulienCoulonDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-PA-02-SEnten_JCoulon/usage_mix_hebergeurs_CDN_clouds.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-238">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/est-il-possible-dameliorer-les-performances-et-optimiser-les-couts-avec-lusage-mixe-dhebergeurs-cdn-.php" class="url">Comment améliorer les performances avec l'usage mixé d'hébergeurs, CDN et Clouds ?</a></span></span></h2>
...
<dd class="column location"><a href="/lieux/">Petit amphithéâtre</a></dd>
...
<dd class="column">
10 <abbr title="heures">h</abbr> 10
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/performance" rel="tag">Performance</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Est-il possible d'améliorer les performances et optimiser les coûts avec l'usage mixé d'hébergeurs, CDN et Clouds ?</p>

<p>Tous les éditeurs sont aujourd'hui à la recherche d'une solution permettant de maximiser les performances. Cedexis, "l'aiguilleur du net", a développé un service unique de monitoring communautaire (<acronym>RUM</acronym>) qui génère quotidiennement plus d'un milliard de mesures en temps réel provenant de millions d'internautes. En adossant à ces données, un service breveté de <span lang="en">load-balancing</span> DNS applicatif, Cedexis apporte des réponses pour atteindre l'objectif d'une expérience utilisateur optimale.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/stephane-enten.php">Stéphane Enten</a> et <a href="https://www.paris-web.fr/2011/../orateurs/julien-coulon.php">Julien Coulon</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Enten" src="https://www.paris-web.fr/2011/assets_c/2011/07/stephane-enten-thumb-143x143-106.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Professionnel expérimenté d’Internet, Stéphane Enten s’est intéressé aux services hautement disponibles et à grande échelle depuis 1998 en évoluant du marché de l’accès (Club-Internet <span lang="en">Free</span>) au marché du contenu/hébergement (Multimania/Gandi). Stéphane se fait fort d’un parcours industriel soutenu assurant un travail efficace et fluide de dimensionnement ainsi qu’un sens du service client sans pareil. Avant de rejoindre Cedexis en tant que Vice-Président Opérations, Stéphane Enten était Vice-Président Ingénierie chez <span lang="en">Dailymotion</span> où il était responsable de la construction et du maintien en conditions opérationnelles de l'une des plus grandes infrastructures mondiales de site vidéo communautaire.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Julien Coulon" src="https://www.paris-web.fr/2011/assets_c/2011/07/julien-coulon-thumb-143x143-133.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Julien Coulon a fait ses premiers pas dans l'internet en 1992 chez France Télécom Hébergement avant de partir en 1996 faire de l’analyse stratégique pendant deux ans pour l'opérateur à New York. De retour en France, il est en charge de la partie Internet et Minitel de France 98, puis développe l'activité hébergement. En 2000, il participe au montage de Langages Virtuels, start-up de webconférence rachetée par Genesys Conferencing. Il rejoint le <abbr>CDN</abbr> Akamai en 2002 pour lancer l'activité e-Commerce, Média, Télécom, <span lang="en">Social Networking</span> et réussi à positionner l'entreprise comme le leader incontournable de la diffusion de contenus et accélération d’application sur le marché français. </p>

<p>Mi-2009, il fonde Cedexis, «&nbsp;Les aiguilleurs du Net&nbsp;», solution de monitoring communautaire qu’il est possible de coupler à un service breveté de routage de flux en temps réel entièrement paramétrable. Cedexis divise les temps d’affichage, optimise les coûts, améliore le référencement et donc le chiffre d’affaire des éditeurs de contenus sur tous les supports <abbr>IP</abbr>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/est-il-possible-dameliorer-les-performances-et-optimiser-les-couts-avec-lusage-mixe-dhebergeurs-cdn-.php&amp;ref=prez-est-il-possible-dameliorer-les-performances-e&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
