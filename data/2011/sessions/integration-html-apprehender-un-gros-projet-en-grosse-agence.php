...
<title>Paris Web - Intégration HTML : appréhender un gros projet en grosse agence</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/dompter-le-web-mobile.php" title="Dompter le Web Mobile" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/fast-and-furious-enough---lean-startup-workshop-define-and-test-your-first-mvp-to-launch-faster.php" title="Fast and Furious Enough - Définissez et testez rapidement votre premier MVP en utilisant des pratiques issues de Lean Startup" />
	...
	<meta name="twitter:title" content="Intégration HTML : appréhender un gros projet en grosse agence" />
	<meta property="twitter:description" content=" S'il y a une chose que j'ai appris en travaillant sur de gros projets du type Météo France ou Le Louvre avec des dizaines voir des centaines de pages à déployer, c'est la nécessité d'une méthode.…" />
	<meta property="dc:title" content="Intégration HTML : appréhender un gros projet en grosse agence" />
	<meta property="og:title" content="Intégration HTML : appréhender un gros projet en grosse agence" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/integration-html-apprehender-un-gros-projet-en-grosse-agence.php" />
	<meta property="og:description" content=" S'il y a une chose que j'ai appris en travaillant sur de gros projets du type Météo France ou Le Louvre avec des dizaines voir des centaines de pages à déployer, c'est la nécessité d'une méthode.…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Intégration HTML : appréhender un gros projet en grosse agence</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-366">
						<header>
							<h1>Intégration HTML : appréhender un gros projet en grosse agence</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-366">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/integration-html-apprehender-un-gros-projet-en-grosse-agence.php" class="url">Intégration HTML : appréhender un gros projet en grosse agence</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/florian-boudot.php">Florian Boudot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Florian Boudot" src="https://www.paris-web.fr/2011/assets_c/2011/07/florian-boudot-thumb-143x143-158.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Florian commence par faire du webdesign dans une petite agence en alternance avec une formation plutôt technique et ça lui plaît pas mal. A cette époque où c'est le webdesigner qui intègre ses propres créas à base de <code>&lt;table&gt;</code>, il commence à se passionner pour cette étape de la production web.
</p>
<p>
La découverte d’un poste d’intégrateur HTML (et seulement intégrateur) chez Wcube (futur Publicis Modem) en 2005 l’enchante et il laisse le côté créa du webdesign pour se consacrer au CSS et à l’HTML. Abordés sous l’angle d’une grosse agence , les projets sont tout de suite à une plus grande échelle, avec plus de contraintes et d'exigence. Développer de meilleures méthodes de production devient alors une quête ! <!-- (…)une alors quête *easteregg* -->
</p>
<p>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/integration-html-apprehender-un-gros-projet-en-grosse-agence.php&amp;ref=prez-integration-html-apprehender-un-gros-projet-e&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
