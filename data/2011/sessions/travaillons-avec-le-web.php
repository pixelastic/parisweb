...
<title>Paris Web - Travaillons avec le Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/premier-pas-pour-le-developpement-accessible.php" title="Premier pas pour le développement accessible" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/typography-for-programmers.php" title="Typography for Programmers" />
	...
	<meta name="twitter:title" content="Travaillons avec le Web" />
	<meta property="twitter:description" content="Pendant près de 10 ans, j'ai eu l'opportunité de travailler à distance dans des organisations internationales (avec Opera et le W3C). Je partagerai pendant cet atelier les astuces, les trucs, les…" />
	<meta property="dc:title" content="Travaillons avec le Web" />
	<meta property="og:title" content="Travaillons avec le Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/travaillons-avec-le-web.php" />
	<meta property="og:description" content="Pendant près de 10 ans, j'ai eu l'opportunité de travailler à distance dans des organisations internationales (avec Opera et le W3C). Je partagerai pendant cet atelier les astuces, les trucs, les…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Travaillons avec le Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-371">
						<header>
							<h1>Travaillons avec le Web</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-371">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/travaillons-avec-le-web.php" class="url">Travaillons avec le Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>Pendant près de 10 ans, j'ai eu l'opportunité de travailler à distance dans des organisations internationales (avec Opera et le <abbr>W3C</abbr>). Je partagerai pendant cet atelier les astuces, les trucs, les techniques simples permettant de rendre le travail à distance plus agréable et efficace. Cet atelier pourrait être l'occasion pour que collectivement nous créons ensemble un petit guide utilisable par la communauté francophone (sur github, ou bitbucket&nbsp;?).</p>
<div class="box clear">
<p class="last"><abbr lang="la" title="Nota-Bene">NB</abbr>&nbsp;: c'est facultatif, mais il est recommandé de disposer d'un compte Github pour suivre cet atelier.</p>
</div></div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/travaillons-avec-le-web.php&amp;ref=prez-travaillons-avec-le-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
