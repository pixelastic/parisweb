...
<title>Paris Web - Comment gérer ses relations client simplement quand on débute</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/svg-et-le-web-design-moderne.php" title="SVG et le web design moderne" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/ces-indices-dans-les-css-qui-indiquent-que-votre-projet-web-est-mal-parti.php" title="Ces indices dans les CSS qui indiquent que votre projet web est mal parti" />
	...
	<meta name="twitter:title" content="Comment gérer ses relations client simplement quand on débute" />
	<meta property="twitter:description" content=" Une grande partie des travailleurs du web exercent leur métier en freelance, et si le savoir faire coté métier est bien présent, ça n'est pas toujours une partie de plaisir de gérer l'aspect…" />
	<meta property="dc:title" content="Comment gérer ses relations client simplement quand on débute" />
	<meta property="og:title" content="Comment gérer ses relations client simplement quand on débute" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/comment-gerer-ses-relations-client-simplement-quand-on-debute.php" />
	<meta property="og:description" content=" Une grande partie des travailleurs du web exercent leur métier en freelance, et si le savoir faire coté métier est bien présent, ça n'est pas toujours une partie de plaisir de gérer l'aspect…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Comment gérer ses relations client simplement quand on débute</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-377">
						<header>
							<h1>Comment gérer ses relations client simplement quand on débute</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-377">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/comment-gerer-ses-relations-client-simplement-quand-on-debute.php" class="url">Comment gérer ses relations client simplement quand on débute</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/julien-dubedout.php">Julien Dubedout</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Julien Dubedout" src="https://www.paris-web.fr/2011/assets_c/2011/08/julien-dubedou-thumb-143x143-180.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Julien Dubedout est directeur artistique chez <span lang="en">The Roxane Company</span>, après avoir été directeur artistique chez Publicis Modem, webdesigner freelance, et formateur sur les outils Adobe à Toulouse.</p>

<p>Majoritairement autodidacte, il touche à tous les domaines afférents à la création web&nbsp;: <span lang="en">front-end development</span>, accessibilité, ergonomie, <abbr>CMS</abbr>. Photographe amateur, il s'intéresse aux aspects juridiques des métiers de la création et de l'image. Très présent sur les forums d'entraide de graphistes, il a créé le blog d'infos pour freelances <a href="http://mariejulien.com/">mariejulien.com</a> et est président de l'association métiers graphiques, à l'origine de l'initiative <a href="http://briefingroom.fr/">briefingroom.fr</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/comment-gerer-ses-relations-client-simplement-quand-on-debute.php&amp;ref=prez-comment-gerer-ses-relations-client-simplement&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
