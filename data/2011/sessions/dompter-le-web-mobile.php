...
<title>Paris Web - Dompter le Web Mobile</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/integrateur-entre-le-marteau-et-lenclume.php" title="Intégrateur : entre le marteau et l'enclume" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/integration-html-apprehender-un-gros-projet-en-grosse-agence.php" title="Intégration HTML : appréhender un gros projet en grosse agence" />
	...
	<meta name="twitter:title" content="Dompter le Web Mobile" />
	<meta property="twitter:description" content=" Le Web Mobile apporte des problématiques aussi nouvelles qu'inombrables ainsi que son lot de bugs inconnus… Nous verrons dans cet atelier les différents outils qui sont à notre disposition et…" />
	<meta property="dc:title" content="Dompter le Web Mobile" />
	<meta property="og:title" content="Dompter le Web Mobile" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/dompter-le-web-mobile.php" />
	<meta property="og:description" content=" Le Web Mobile apporte des problématiques aussi nouvelles qu'inombrables ainsi que son lot de bugs inconnus… Nous verrons dans cet atelier les différents outils qui sont à notre disposition et…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Dompter le Web Mobile</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-359">
						<header>
							<h1>Dompter le Web Mobile</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/dompterlewebmobile-111015100730-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/03-samedi/SA-PM-08-YVanGoethem/dompter_le_web_mobile.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-359">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/dompter-le-web-mobile.php" class="url">Dompter le Web Mobile</a></span></span></h2>
...
Nous verrons dans cet atelier les différents outils qui sont à notre disposition et comment en faire bon usage pour tacler ces nouveaux challenges.<br />Cet atelier abordera les équivalents des inspecteurs sur navigateur desktop, les manières de loguer, les émulateurs, etc…
</p><p>
Du matériel sera à votre disposition, cependant si vous disposez d'un PC/Mac et d'appareils dotés de navigateurs (iPhone, Android, WebOS, Nokia, Windows, etc…) vous êtes invité à les amener.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/yves-van-goethem.php">Yves Van Goethem</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Yves Van Goethem" src="https://www.paris-web.fr/2011/assets_c/2011/07/yves-thumb-143x143-168.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>C’est en tant que Développeur Web Mobile chez <a href="http://soundcloud.com hreflang="en" lang="en">SoundCloud</a> à Berlin qu’évolue Yves, hacker mélomane de son état.</p>
<p>Passionné du web depuis sa prime jeunesse, il participe activement à la promotion des standards et de l’accessibilité notamment à travers l’organisation de Paris-Web mais aussi d’autres initiatives telles que <a href="http://groups.google.fr/group/webdevfr">webdevfr</a> et la contribution à des projets open-source comme <a href="http://www.mozilla.com/" hreflang="en" lang="en">Mozilla Firefox</a>.</p>
<p>Ses jeunes mais néanmoins lourds bagages se sont remplis tour à tour de LÉGO®, d’électrotechnique, d’administration réseaux, d’entrepreunariat mais aussi de son grand faible pour les bières de son pays natal : le royaume de Belgique.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/dompter-le-web-mobile.php&amp;ref=prez-dompter-le-web-mobile&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
