...
<title>Paris Web - Développer pour le mobile en pratique : outils et techniques</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/planification-ou-iteration-specialisation-ou-heterogeneite-transmission-orale-ou-ecrite-deux-jeux-po.php" title="Planification ou itération ? Spécialisation ou hétérogénéité ? Transmission orale ou écrite ? Deux jeux pour nous amuser et en parler" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/simply-responsive-css3.php" title="Simply Responsive CSS3" />
	...
	<meta name="twitter:title" content="Développer pour le mobile en pratique : outils et techniques" />
	<meta property="twitter:description" content="Concevoir un site ou une application web pour le mobile n'a rien à voir avec le web classique. Pourtant, les techniques et processus débordent aujourd'hui sur le web de bureau ! Cet atelier…" />
	<meta property="dc:title" content="Développer pour le mobile en pratique : outils et techniques" />
	<meta property="og:title" content="Développer pour le mobile en pratique : outils et techniques" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/developper-pour-le-mobile-en-pratique-outils-et-techniques.php" />
	<meta property="og:description" content="Concevoir un site ou une application web pour le mobile n'a rien à voir avec le web classique. Pourtant, les techniques et processus débordent aujourd'hui sur le web de bureau ! Cet atelier…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Développer pour le mobile en pratique : outils et techniques</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-249">
						<header>
							<h1>Développer pour le mobile en pratique : outils et techniques</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/presentation-111021062452-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/03-samedi/SA-PM-12-GChampenois/mobile_en_pratique.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-249">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/developper-pour-le-mobile-en-pratique-outils-et-techniques.php" class="url">Développer pour le mobile en pratique : outils et techniques</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/mobile" rel="tag">Mobile</a></dd>
    ...
    <div class="talk-description"><p>Concevoir un site ou une application web pour le mobile n'a rien à voir avec le web classique. Pourtant, les techniques et processus débordent aujourd'hui sur le web de bureau !
</p><p>
Cet atelier commencera donc par un rappel des notions et contraintes qui font la particularité du web mobile, suivi par un tour d'horizon des différents <span lang="en">frameworks</span> et outils disponibles. Enfin, l'analyse de différents sites et applications nous permettra de réfléchir à ce qui fonctionne bien ou pas, et pourquoi.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/goulven-champenois.php">Goulven Champenois</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Goulven Champenois" src="https://www.paris-web.fr/2011/assets_c/2011/07/goulven-champenois-thumb-143x143-140.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Intégrateur, développeur PHP, expert accessibilité, passionné d'ergonomie, Goulven Champenois suit avec intérêt les évolutions technologiques, mobile et performances web en tête.
</p><p>
Formé en grande partie grâce aux sites <a lang="en" href="http://openweb.eu.org/">openweb</a> et <a href="http://www.pompage.net/">pompage</a>, il rejoint ce projet en 2006. Trouvant le temps trop long entre deux éditions de Paris Web, il participe à l'organisation de <a href="http://sudweb.fr/">SudWeb</a> en 2011.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/developper-pour-le-mobile-en-pratique-outils-et-techniques.php&amp;ref=prez-developper-pour-le-mobile-en-pratique-outils-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
