...
<title>Paris Web - Ces indices dans les CSS qui indiquent que votre projet web est mal parti</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/comment-gerer-ses-relations-client-simplement-quand-on-debute.php" title="Comment gérer ses relations client simplement quand on débute" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/dejeuner.php" title="Déjeuner" />
	...
	<meta name="twitter:title" content="Ces indices dans les CSS qui indiquent que votre projet web est mal…" />
	<meta property="twitter:description" content="Lorsqu'un développeur web front-end expérimenté récupère un ancien projet, il lui faut souvent quelques minutes seulement pour sentir si le projet va être problématique, car certains indices…" />
	<meta property="dc:title" content="Ces indices dans les CSS qui indiquent que votre projet web est mal parti" />
	<meta property="og:title" content="Ces indices dans les CSS qui indiquent que votre projet web est mal parti" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/ces-indices-dans-les-css-qui-indiquent-que-votre-projet-web-est-mal-parti.php" />
	<meta property="og:description" content="Lorsqu'un développeur web front-end expérimenté récupère un ancien projet, il lui faut souvent quelques minutes seulement pour sentir si le projet va être problématique, car certains indices…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Ces indices dans les CSS qui indiquent que votre projet web est mal parti</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-384">
						<header>
							<h1>Ces indices dans les CSS qui indiquent que votre projet web est mal parti</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-384">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/ces-indices-dans-les-css-qui-indiquent-que-votre-projet-web-est-mal-parti.php" class="url">Ces indices dans les CSS qui indiquent que votre projet web est mal parti</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2011/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>Lorsqu'un développeur web <span lang="en">front-end</span> expérimenté récupère un ancien projet, il lui faut souvent quelques minutes seulement pour sentir si le projet va être problématique, car certains indices permettent de sentir cela.
</p><p>
Lors de l’atelier, nous nous baserons sur l'échange et l'expérience des les participants pour essayer de faire émerger quelques règles simples et facilement utilisable par un non spécialiste permettant de signaler que quelque chose ne va pas dans le projet, et nous proposerons quelques pistes de travail pour remédier au problème rencontré.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/olivier-gendrin.php">Olivier Gendrin</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Olivier Gendrin" src="https://www.paris-web.fr/2011/assets_c/2011/07/olivier-thumb-143x143-163.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Autodidacte, Olivier a appris les standards grâce aux sites <a href="http://openweb.eu.org/" lang="en">Openweb</a>,	<a href="http://www.pompage.net/">Pompage</a>,	<a href="http://www.spip.net/fr/"><abbr>SPIP</abbr></a> et les listes de discussion qui leur sont attachées.</p>
<p>Ses nombreux engagements associatifs (éducation populaire, théâtre) lui donnent une sensibilité naturelle à l’accessibilité et ses concepts, qu’il essaie de faire transparaître dans ses développements et ses conseils.</p>  
<p>Il travaille actuellement comme référent standards et accessibilité chez <a href="http://www.novactive.com/">Novactive</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/ces-indices-dans-les-css-qui-indiquent-que-votre-projet-web-est-mal-parti.php&amp;ref=prez-ces-indices-dans-les-css-qui-indiquent-que-vo&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
