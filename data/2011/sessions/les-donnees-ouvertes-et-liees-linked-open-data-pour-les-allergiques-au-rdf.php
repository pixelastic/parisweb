...
<title>Paris Web - Les données ouvertes et liées (Linked Open Data) pour les allergiques au RDF</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/maitrisez-limprevu-et-le-facteur-humain-dans-votre-conduite-de-qualite-la-charte-cateea.php" title="Maîtrisez l'imprévu et le facteur humain dans votre conduite de qualité : la charte CATEEA" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/table-ronde-des-navigateurs.php" title="Table ronde des navigateurs" />
	...
	<meta name="twitter:title" content="Les données ouvertes et liées (Linked Open Data) pour les allergiques…" />
	<meta property="twitter:description" content="Le web sémantique est un sujet qui polarise. D'un côté, les fanatiques, de l'autre, les allergiques. Un cas pratique pourrait peut-être réconcilier tout le monde, à condition sans doute de réussir à…" />
	<meta property="dc:title" content="Les données ouvertes et liées (Linked Open Data) pour les allergiques au RDF" />
	<meta property="og:title" content="Les données ouvertes et liées (Linked Open Data) pour les allergiques au RDF" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/les-donnees-ouvertes-et-liees-linked-open-data-pour-les-allergiques-au-rdf.php" />
	<meta property="og:description" content="Le web sémantique est un sujet qui polarise. D'un côté, les fanatiques, de l'autre, les allergiques. Un cas pratique pourrait peut-être réconcilier tout le monde, à condition sans doute de réussir à…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les données ouvertes et liées (Linked Open Data) pour les allergiques au RDF</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-251">
						<header>
							<h1>Les données ouvertes et liées (Linked Open Data) pour les allergiques au RDF</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xojr68?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb10_OlivierThereaux_LinkedOpenData.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-PA-07-OThereaux/donnees_ouvertes_liees.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-251">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/les-donnees-ouvertes-et-liees-linked-open-data-pour-les-allergiques-au-rdf.php" class="url">Les données ouvertes et liées (Linked Open Data) pour les allergiques au RDF</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/opendata" rel="tag">OpenData</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le web sémantique est un sujet qui polarise. D'un côté, les fanatiques, de l'autre, les allergiques. Un cas pratique pourrait peut-être réconcilier tout le monde, à condition sans doute de réussir à explorer le sujet sans presque mentionner  les mots «&nbsp;<abbr>RDF</abbr>&nbsp;» ou «&nbsp;Ontologie&nbsp;». Relevons le défi: dans cette session, nous explorerons l'adoption par la <span lang="en">BBC</span> des principes de «&nbsp;données ouvertes et liées&nbsp;» (<span lang="en">Linked Open Data</span>), et ses conséquences sur cette organisation, sa présence en ligne, mais aussi et surtout sa culture.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/olivier-thereaux.php">Olivier Thereaux</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Olivier Thereaux" src="https://www.paris-web.fr/2011/assets_c/2011/07/olivier-thereaux-thumb-143x143-109.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Tombé dans le web quand il n'était encore qu'un petit normand étudiant à Paris, <a href="http://olivier.thereaux.net/">Olivier</a> s'est <a href="http://www.w3.org/People/olivier">retrouvé au <abbr>W3C</abbr></a>, au Japon, un peu par hasard. Tour à tour développeur, évangéliste de bonnes pratiques du web puis en charge des outils open source du W3C, il s'attelle en parallèle à démocratiser l'art et la culture en co-créant <a lang="en" href="http://www.tokyoartbeat.com/">Tokyo Art Beat</a>. Après une escale de quelques années à Montréal passées à jouer au sein de l'agence <a href="http://lab.pheromone.ca/">Phéromone</a> avec cette drôle de bête qu'est l'innovation, il a maintenant posé ses bagages à Londres où il manie ces deux obsessions - web et innovation - à la <a lang="en" href="http://www.bbc.co.uk/rd/prototyping">BBC</a>.<br />
</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/les-donnees-ouvertes-et-liees-linked-open-data-pour-les-allergiques-au-rdf.php&amp;ref=prez-les-donnees-ouvertes-et-liees-linked-open-dat&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
