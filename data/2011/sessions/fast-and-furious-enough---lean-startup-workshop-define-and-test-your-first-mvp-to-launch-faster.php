...
<title>Paris Web - Fast and Furious Enough - Définissez et testez rapidement votre premier MVP en utilisant des pratiques issues de Lean Startup</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/integration-html-apprehender-un-gros-projet-en-grosse-agence.php" title="Intégration HTML : appréhender un gros projet en grosse agence" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/client-developpeur-comment-bien-rediger-un-contrat-de-developpement-de-site-ou-dapplication-pour-evi.php" title="Client-développeur : comment  bien rédiger un contrat de développement de site ou d'application pour éviter de perdre de l'argent" />
	...
	<meta name="twitter:title" content="Fast and Furious Enough - Définissez et testez rapidement votre…" />
	<meta property="twitter:description" content="Comment proposer une expérience à la fois simple, facile et réellement innovante à vos futurs utilisateurs&nbsp;? Comment tester la pertinence de sa solution au plus tôt en utilisant le prototypage…" />
	<meta property="dc:title" content="Fast and Furious Enough - Définissez et testez rapidement votre premier MVP en utilisant des pratiques issues de Lean Startup" />
	<meta property="og:title" content="Fast and Furious Enough - Définissez et testez rapidement votre premier MVP en utilisant des pratiques issues de Lean Startup" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/fast-and-furious-enough---lean-startup-workshop-define-and-test-your-first-mvp-to-launch-faster.php" />
	<meta property="og:description" content="Comment proposer une expérience à la fois simple, facile et réellement innovante à vos futurs utilisateurs&nbsp;? Comment tester la pertinence de sa solution au plus tôt en utilisant le prototypage…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Fast and Furious Enough - Définissez et testez rapidement votre premier MVP en utilisant des pratiques issues de Lean Startup</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-370">
						<header>
							<h1>Fast and Furious Enough - Définissez et testez rapidement votre premier MVP en utilisant des pratiques issues de Lean Startup</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-370">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/fast-and-furious-enough---lean-startup-workshop-define-and-test-your-first-mvp-to-launch-faster.php" class="url">Fast and Furious Enough - Définissez et testez rapidement votre premier MVP en utilisant des pratiques issues de Lean Startup</a></span></span></h2>
...
<dd class="column">
14 <abbr title="heures">h</abbr> 50
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/prototypage" rel="tag">Prototypage</a></dd>
    ...
    <div class="talk-description"><p>Comment proposer une expérience à la fois simple, facile et réellement innovante à vos futurs utilisateurs&nbsp;?<br />
<strong>Comment tester la pertinence de sa solution au plus tôt en utilisant
le prototypage papier&nbsp;?</strong>
</p>
<p>
Comment définir et vérifier ses hypothèses à partir d'indicateurs mesurables&nbsp;?
</p>
<p>
Nous vous proposons de travailler sur ces 3 questions sous la forme d’un atelier vous permettant d’utiliser certaines pratiques issues du mouvement lean-startup, mais aussi du <span lang="en">systems thinking</span> et du <span lang="en">design thinking</span> pour lancer au plus tôt des produits web qui attaquent de vrais enjeux. 
</p>
<p>
Dans cet atelier vous allez&nbsp;:
</p>
<ul>
<li>Identifier un problème et proposer une nouvelle idée de produit permettant de corriger ce problème</li>
<li>Définir des hypothèses de travail et les indicateurs que vous souhaitez mesurer</li>
<li>Concevoir les premiers écrans de votre MVP en réalisant un prototype papier</li>
<li>Recueillir les premiers résultats de votre MVP</li>
<li>Inspecter les résultats et adapter votre stratégie en fonction</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/mathieu-gandin.php">Mathieu Gandin</a> et <a href="https://www.paris-web.fr/2011/../orateurs/thomas-lissajoux.php">Thomas Lissajoux</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Licorne timide" src="/img/nophoto.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Mathieu Gandin est coach agile chez Octo Technology. Il aide des équipes à délivrer des produits logiciel grâce à une approche lean et agile, il anime régulièrement des atelier pour accélérer l'idéation et le lancement de sites web. Ces centres d'intérêt concernent le coaching d'équipe, les pratiques de développement logiciel et la facilitation de <span lang="en">brainstorm</span> afin de créer de nouveaux produits logiciels. Il est un intervenant régulier des conférences nationales et internationales telles que Agile France, XP Days Benelux.</p></div>
</div>
...
<div class="speaker-bio"><p>
Thomas Lissajoux est coach agile chez Octo Technology. Il aide des équipes à délivrer des produits logiciel grâce à une approche lean et agile, il anime régulièrement des atelier pour accélérer l'idéation et le lancement de sites web. Ces centres d'intérêt concernent le coaching d'équipe, la gestion de portefeuille de produit et l'expérience utilisateur. Il est un intervenant régulier des conférences nationales et internationales telles que Agile Tour, Agile France, Agile Brazil, UPA.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/fast-and-furious-enough---lean-startup-workshop-define-and-test-your-first-mvp-to-launch-faster.php&amp;ref=prez-fast-and-furious-enough---lean-startup-worksh&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
