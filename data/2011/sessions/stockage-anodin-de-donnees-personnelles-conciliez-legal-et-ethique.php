...
<title>Paris Web - Stockage anodin de données personnelles : conciliez légal et éthique</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/creation-et-partages-darchives-web-personnelles.php" title="Création et partages d'archives Web personnelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/ameliorer-le-confort-dutilisation-des-sites-web.php" title="Améliorer le confort d'utilisation des sites web" />
	...
	<meta name="twitter:title" content="Stockage anodin de données personnelles : conciliez légal et éthique" />
	<meta property="twitter:description" content="Vos utilisateurs se montrent probablement méfiants avec vos cookies. Combien d'applications web sont-elles cassées parce qu'un de vos clients utilise une extension bloquant les cookies&nbsp;? C'est…" />
	<meta property="dc:title" content="Stockage anodin de données personnelles : conciliez légal et éthique" />
	<meta property="og:title" content="Stockage anodin de données personnelles : conciliez légal et éthique" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/stockage-anodin-de-donnees-personnelles-conciliez-legal-et-ethique.php" />
	<meta property="og:description" content="Vos utilisateurs se montrent probablement méfiants avec vos cookies. Combien d'applications web sont-elles cassées parce qu'un de vos clients utilise une extension bloquant les cookies&nbsp;? C'est…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Stockage anodin de données personnelles : conciliez légal et éthique</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-261">
						<header>
							<h1>Stockage anodin de données personnelles : conciliez légal et éthique</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-261">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/stockage-anodin-de-donnees-personnelles-conciliez-legal-et-ethique.php" class="url">Stockage anodin de données personnelles : conciliez légal et éthique</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2011/ateliers/presentations/">Présentation</a></dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/stockage-des-donnees" rel="tag">Stockage des données</a></dd>
    ...
    <div class="talk-description"><p>Vos utilisateurs se montrent probablement méfiants avec vos cookies. Combien d'applications web sont-elles cassées parce qu'un de vos clients utilise une extension bloquant les cookies&nbsp;? C'est le reflet de leur volonté de contrôler leur vie privée, sans vraiment comprendre la porte technique de leurs actions.</p>

<p>Le cookie n'est pourtant qu'un glaçon posé sur un iceberg. Il ne contient que quelques octets de données et l'utilisateur a un contrôle total sur sa durée de vie. Au contraire, vos clients remplissent vos fichiers journaux et ceux des régies publicitaires opérant sur votre domaine.</p>

<p>Dès que vous collectez une information personnelle, vous avez le devoir d'en assurer sa sécurité, son intégrité mais aussi sa péremption. Ensemble, nous nous pencherons sur plusieurs moteurs de blogs, CMS et autres plate-formes de publication en ligne.</p>

<p>Nous établirons une stratégie et des outils pour instaurer un droit à l'oubli automatique et prouver à tous que vous prenez la confidentialité de vos internautes très au sérieux&nbsp;!</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/florian-le-goff.php">Florian Le Goff</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Florian Le Goff" src="https://www.paris-web.fr/2011/assets_c/2011/07/florian-le-goff-thumb-143x143-138.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Formé à l'étude et à la conception de réseaux, Florian Le Goff a passé plusieurs années à administrer des applications web dans le monde des opérateurs de télécommunication. Il est maintenant co-fondateur et responsable de l'architecture technique d'un éditeur logiciel dans la santé, <a href="http://www.9h37.fr/">9H37</a> <abbr title="Société par actions simplifiées ">SAS</abbr>.</p>

<p>Les traces qu'il laisse l'ont toujours intéressé, du point de vue philosophique comme technique. Inspiré par les campagnes de l'<abbr title="Electronic Frontier Fondation" lang="en">EFF</abbr>, c'est finalement en manipulant des données médicales qu'il commence à vraiment réfléchir à comment concilier respect de la vie privée et nécessité technique de la rétention de données.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/stockage-anodin-de-donnees-personnelles-conciliez-legal-et-ethique.php&amp;ref=prez-stockage-anodin-de-donnees-personnelles-conci&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
