...
<title>Paris Web - Industrialisation de l'intégration Web : la révolution de l'artisan devenu ouvrier</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/lightning-talks.php" title="Lightning talks" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/immediate-inspiration.php" title="Immediate Inspiration" />
	...
	<meta name="twitter:title" content="Industrialisation de l'intégration Web : la révolution de l'artisan…" />
	<meta property="twitter:description" content="Le développement Web frontend – multiplicité de compétences – est l'apanage des experts … ou des stagiaires. Développer, c'est Java, C# ou PHP. L'omniprésence des interfaces recourant à HTML induit…" />
	<meta property="dc:title" content="Industrialisation de l'intégration Web : la révolution de l'artisan devenu ouvrier" />
	<meta property="og:title" content="Industrialisation de l'intégration Web : la révolution de l'artisan devenu ouvrier" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/industrialisation-mecanisation-des-esprits-ou-automatisation-des-procedes.php" />
	<meta property="og:description" content="Le développement Web frontend – multiplicité de compétences – est l'apanage des experts … ou des stagiaires. Développer, c'est Java, C# ou PHP. L'omniprésence des interfaces recourant à HTML induit…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Industrialisation de l'intégration Web : la révolution de l'artisan devenu ouvrier</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-288">
						<header>
							<h1>Industrialisation de l'intégration Web : la révolution de l'artisan devenu ouvrier</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xp5wtt?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb13_ThomasParisotDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/artisan-industriel-111014013023-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-PA-01-TParisot/industrialisation_integration_web.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-288">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/industrialisation-mecanisation-des-esprits-ou-automatisation-des-procedes.php" class="url">Industrialisation de l'intégration Web : la révolution de l'artisan devenu ouvrier</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/integration" rel="tag">Intégration</a><br /><a href="http://www.paris-web.fr/2011/recherche/metier" rel="tag">Métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le développement Web frontend – multiplicité de compétences – est l'apanage des experts … ou des stagiaires. Développer, c'est Java, C# ou PHP.</p>

<p>L'omniprésence des interfaces recourant à HTML induit un recours à des points de repère, tant pour les développeurs, les chefs de projet que les acheteurs. C'est une des idées qui en est ressortie de l'atelier “<a href="http://www.paris-web.fr/2010/programme/industrialiser-lartisanat-de-lintegration-html.php">Industrialiser l'artisanat du développement HTML</a>” à Paris Web 2010.</p>

<p>Depuis, l'eau a coulé sous les ponts et une liste de bonnes pratiques de développement frontend est en cours de réalisation. Nous verrons comment et pourquoi l'alimenter, entre autre pour des besoins d'industrialisation des projets.</p>

<p>L'industrialisation, c'est aussi un mot qui inquiète, surtout lorsque cela concerne un des pans du développement Web proche du modèle de l'artisanat. Est-ce le retour du travail à la chaîne ? Est-ce une spécialisation ou une déresponsabilisation ? Ou pire, est-ce un moyen d'apporter une réponse unique à des besoins multiples ?</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/thomas-parisot.php">Thomas Parisot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Thomas Parisot" src="https://www.paris-web.fr/2011/assets_c/2011/09/thomas-parisot-thumb-143x143-186.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Consultant Web indépendant chez CyneticMonkey.</p>

<p>Thomas intervient à différents niveaux : accompagnement de projets, conseil technique et fonctionnel, développement Web (<span lang="en">frontend, backend</span>), développement Web mobile, performances Web.</p>

<p>En n’oubliant pas que les journées ne font que 24 heures, Thomas est l’auteur du livre «&nbsp;Réussir son blog professionnel&nbsp;» (Eyrolles, septembre 2009), contribue à l’écosystème WordPress et symfony tout en étant vacataire au Master Communication Publique et Politique (<abbr>CPP</abbr>) de Bordeaux.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/industrialisation-mecanisation-des-esprits-ou-automatisation-des-procedes.php&amp;ref=prez-industrialisation-mecanisation-des-esprits-ou&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
