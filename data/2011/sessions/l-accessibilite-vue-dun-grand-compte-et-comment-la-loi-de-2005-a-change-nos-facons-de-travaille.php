...
<title>Paris Web - L’accessibilité vue d’un grand compte et comment la loi de 2005 a changé nos façons de travailler</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/ouvrir-le-web-un-bug-a-la-fois.php" title="Ouvrir le Web un bug à la fois" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/tester-vos-services-mythes-et-realites-1.php" title="Tester vos services, mythes et réalités !" />
	...
	<meta name="twitter:title" content="L’accessibilité vue d’un grand compte et comment la loi de 2005 a…" />
	<meta property="twitter:description" content="Le groupe SNCF s'engage jour après jour à offrir à l'ensemble de ses clients un accès facilité au sein de ses gares et à ses trains. Sur Internet aussi l'accessibilité est devenue une préoccupation…" />
	<meta property="dc:title" content="L’accessibilité vue d’un grand compte et comment la loi de 2005 a changé nos façons de travailler" />
	<meta property="og:title" content="L’accessibilité vue d’un grand compte et comment la loi de 2005 a changé nos façons de travailler" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/l-accessibilite-vue-dun-grand-compte-et-comment-la-loi-de-2005-a-change-nos-facons-de-travaille.php" />
	<meta property="og:description" content="Le groupe SNCF s'engage jour après jour à offrir à l'ensemble de ses clients un accès facilité au sein de ses gares et à ses trains. Sur Internet aussi l'accessibilité est devenue une préoccupation…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L’accessibilité vue d’un grand compte et comment la loi de 2005 a changé nos façons de travailler</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-328">
						<header>
							<h1>L’accessibilité vue d’un grand compte et comment la loi de 2005 a changé nos façons de travailler</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xojwjg?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb09_ArthurRigaud_AccessibiliteGrandCompte.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/sncfparisweb-111017133814-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-PA-07-ARigaud/accessibilite_vue_dun_grand_compte.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-328">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/l-accessibilite-vue-dun-grand-compte-et-comment-la-loi-de-2005-a-change-nos-facons-de-travaille.php" class="url">L’accessibilité vue d’un grand compte et comment la loi de 2005 a changé nos façons de travailler</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le groupe <abbr>SNCF</abbr> s'engage jour après jour à offrir à l'ensemble de ses clients un accès facilité au sein de ses gares et à ses trains.</p>

<p>Sur Internet aussi l'accessibilité est devenue une préoccupation de tous les instants pour les différents sites de <abbr>SNCF</abbr>.</p>

<p>Avec un parc de site très hétérogène, certaines composantes du groupe ont été plus rapides que d’autres à mettre en place une vraie politique en matière d’accessibilité numérique.</p>

<p>Forts de l’expérience acquise par des pionniers comme TER-SNCF.com (labellisé Argent Accessiweb en 2007), les différentes entités du groupe travaillent désormais toutes pour une meilleure accessibilité des sites.  </p>

<p>Que ce soit par la formation et la sensibilisation des salariés, le choix de prestataires, la conception des nouvelles fonctionnalités, le développement&nbsp;: l'accessibilité numérique est désormais ancrée dans les pratiques de l'entreprise au bénéfice quotidien des clients.</p>

<p>C'est même devenu l'un des axes de travail en commun entre les différentes entités du groupe sur Internet.</p>

<p>Dans le cadre de l'ouverture à la concurrence, l'accessibilité numérique et l'expertise acquise en cette matière par le groupe <abbr>SNCF</abbr> permettra de se différencier.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/arthur-rigaud.php">Arthur Rigaud</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Arthur Rigaud" src="https://www.paris-web.fr/2011/assets_c/2011/07/arthur-rigaud-thumb-143x143-154.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Arthur Rigaud, 35 ans, intégrateur web chez VSC Technologies depuis 2006. <br />
Spécialisé dans le développement de sites depuis 10 ans (Maximiles, Primus Télécommunications) <br />
Passionné par les standards et les problématiques d'accessibilité sur Internet il devient Expert en évaluation AccessiWeb et membre du groupe de travail AccessiWeb en mai 2008. </p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/l-accessibilite-vue-dun-grand-compte-et-comment-la-loi-de-2005-a-change-nos-facons-de-travaille.php&amp;ref=prez-l-accessibilite-vue-dun-grand-compte-et-comme&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
