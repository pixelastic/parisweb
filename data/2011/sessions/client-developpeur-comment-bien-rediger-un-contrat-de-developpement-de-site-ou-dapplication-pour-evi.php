...
<title>Paris Web - Client-développeur : comment  bien rédiger un contrat de développement de site ou d'application pour éviter de perdre de l'argent</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/fast-and-furious-enough---lean-startup-workshop-define-and-test-your-first-mvp-to-launch-faster.php" title="Fast and Furious Enough - Définissez et testez rapidement votre premier MVP en utilisant des pratiques issues de Lean Startup" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/coffeescript-le-javascript-simple-et-elegant.php" title="CoffeeScript, le Javascript simple et élégant" />
	...
	<meta name="twitter:title" content="Client-développeur : comment  bien rédiger un contrat de…" />
	<meta property="twitter:description" content="Ce sujet est né de la coïncidence de deux événements, mi-mai 2011. Premier événement : deux nouveaux clients m'ont contacté la semaine passée. Ils ont, l'un et l'autre, perdu environ un an et dépensé…" />
	<meta property="dc:title" content="Client-développeur : comment  bien rédiger un contrat de développement de site ou d'application pour éviter de perdre de l'argent" />
	<meta property="og:title" content="Client-développeur : comment  bien rédiger un contrat de développement de site ou d'application pour éviter de perdre de l'argent" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/client-developpeur-comment-bien-rediger-un-contrat-de-developpement-de-site-ou-dapplication-pour-evi.php" />
	<meta property="og:description" content="Ce sujet est né de la coïncidence de deux événements, mi-mai 2011. Premier événement : deux nouveaux clients m'ont contacté la semaine passée. Ils ont, l'un et l'autre, perdu environ un an et dépensé…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Client-développeur : comment  bien rédiger un contrat de développement de site ou d'application pour éviter de perdre de l'argent</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-378">
						<header>
							<h1>Client-développeur : comment  bien rédiger un contrat de développement de site ou d'application pour éviter de perdre de l'argent</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-378">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/client-developpeur-comment-bien-rediger-un-contrat-de-developpement-de-site-ou-dapplication-pour-evi.php" class="url">Client-développeur : comment  bien rédiger un contrat de développement de site ou d'application pour éviter de perdre de l'argent</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>Ce sujet est né de la coïncidence de deux événements, mi-mai 2011. </p>

<p>Premier événement : deux nouveaux clients m'ont contacté la semaine passée. Ils ont, l'un et l'autre, perdu environ un an et dépensé plusieurs dizaines de milliers d'euros pour obtenir un site ou une appliction que finalement ils n'obtiendront pas. Il en découlera des procédures judiciaires, des expertises, du temps écoulé, de l'argent supplémentaire dépensé et, pour les professionnels, une réputation ruinée.</p>

<p>Second événement : à Sud Web l'un des orateurs avait pour thème l'achat de prestations IT et Web. Mais à aucun moment il n'a évoqué la question de comment s'écrit un contrat.</p>

<p>Or, un contrat bien négocié, qui ménage les intérêts des parties, est gage de réussite du projet et, donc, de réduction des risques contentieux.<br />
Et rédiger des contrats ou traiter des contentieux IT, c'est ce que je fais tous les jours.<br />
J'ai donc quelques trucs, astuces et idées à transmettre.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/marc-lipskier.php">Marc Lipskier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marc Lipskier" src="https://www.paris-web.fr/2011/assets_c/2011/08/marc-lipskier-thumb-143x143-176.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Né en 1970, Marc est avocat au Barreau de Paris depuis 1998. En plus du contentieux informatique et commercial, Marc a développé une forte expérience en matière de structures d'entreprises.
</p>
<p>
Issu d'une famille de scientifiques, passionné d’innovation et de technologies, Marc a fondé en janvier 2009 la Ruche d'Avocats innovants <a href="http://www.bambooandbees.com">Bamboo & Bees</a>, notamment dédiée aux entreprises du secteur de l'intelligence et de la création (internet, télécommunications, informatique, télévision, radio, cinéma, jeux vidéo, livre, photographie, musique,…). 
</p>
<p>
Il a tenu la chronique juridique de l’édition française de <span lang="en">Technology Review</span>, revue mensuelle publiée par le <abbr title="Massachusetts Institute of Technology " lang="en">M.I.T</span>
</p>
<p>
Il anime un séminaire de droit des entreprises innovantes à l’Ecole Nationale des Mines de Paris.
</p>
<p>
Il est l'un des mentors du Camping de Silicon Sentier.
</p>
<p>
Marc a été speaker du TEDx Alsace 2010 et de SudWeb 2011.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/client-developpeur-comment-bien-rediger-un-contrat-de-developpement-de-site-ou-dapplication-pour-evi.php&amp;ref=prez-client-developpeur-comment-bien-rediger-un-co&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
