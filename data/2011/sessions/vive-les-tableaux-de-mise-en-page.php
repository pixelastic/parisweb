...
<title>Paris Web - Vive les tableaux de mise en page !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/developpeurs-cachez-moi-cette-page.php" title="Développeurs, cachez-moi cette page !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/la-lisibilite-des-contenus.php" title="La lisibilité des contenus" />
	...
	<meta name="twitter:title" content="Vive les tableaux de mise en page !" />
	<meta property="twitter:description" content=" Le design web en 2011 consiste encore à se battre avec des positionnements flottants, absolus, relatifs, des clear, des problèmes de compatibilité, des hacks, des bidouilles, des bugs d'affichage et…" />
	<meta property="dc:title" content="Vive les tableaux de mise en page !" />
	<meta property="og:title" content="Vive les tableaux de mise en page !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/vive-les-tableaux-de-mise-en-page.php" />
	<meta property="og:description" content=" Le design web en 2011 consiste encore à se battre avec des positionnements flottants, absolus, relatifs, des clear, des problèmes de compatibilité, des hacks, des bidouilles, des bugs d'affichage et…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Vive les tableaux de mise en page !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-352">
						<header>
							<h1>Vive les tableaux de mise en page !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/table-layout-final-111015072407-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/03-samedi/SA-AM-04-RGoetter/vive_les_tableaux_de_mise_en_page.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-352">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/vive-les-tableaux-de-mise-en-page.php" class="url">Vive les tableaux de mise en page !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/css3" rel="tag">CSS3</a><br /><a href="http://www.paris-web.fr/2011/recherche/html5" rel="tag">HTML5</a></dd>
...
<p>
On ne devrait plus en être là aujourd'hui. C'est du rôle des CSS de nous offrir des solutions simples, intuitives et stables (<abbr title="Note de la Rédaction">NDLR</abbr>&nbsp;: genre "<abbr title="Keep It Simple and Smart" lang="en">KISS</abbr>" quoi).
</p>
<p>
Les propositions CSS3 avant-gardistes telles que <span lang="en">Flexible box model</span> et <span lang="en">Grid Layout</span> ne seront pas utilisables en production avant un bon bout de temps.
En attendant, si la solution était sous nos yeux depuis des années&nbsp;? Et si l'avenir (proche) des CSS étaient les tableaux de mise en page&nbsp;?
</p>
<p>
Note&nbsp;: ça parlera (un peu) de tableaux HTML bien fichus, linéarisables, toussa et aussi (surtout) de CSS <code>display: table</code>, de ses avantages et inconvénients.
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/raphael-goetter.php">Raphaël Goetter</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Goetter" src="https://www.paris-web.fr/2011/assets_c/2011/07/orateur_raphael_goetter-thumb-143x143-54-thumb-143x143-166.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Webdesigner alsacien (chez <a href="http://www.alsacreations.fr/">Alsacréations</a>) papa de deux adorables enfants, passionné d'accessibilité numérique, de bonnes pratiques et de standards web. Expert et Formateur en langages web HTML et CSS auprès de groupes nationaux et internationaux.
</p>
<p>
Auteur de divers livres techniques dans le domaine du Web&nbsp;:
</p>
<ul>
<li>"CSS avancées - vers HTML5 et CSS3" (Eyrolles)</li>
<li>"CSS2 - Pratique du design web" (Eyrolles)</li>
<li>"Memento CSS3" (Eyrolles)</li>
<li>"Memento CSS2" (Eyrolles)</li>
<li>"Memento XHTML" (Eyrolles)</li>
</ul>
<p>
Créateur et administrateur du site <a href="http://www.alsacreations.com">Alsacreations.com</a>, communauté libre d'apprentissage web dont le trafic dépassait les 25000 visites uniques quotidiennes en 2011.
</p>
<p>
...
<p>
Et à ses heures perdues (sic) administrateur de divers sites personnels ou associatifs tels que <a href="http://goetter.fr">Goetter.fr</a>, <a href="http://ie7nomore.com">IE7nomore.com</a> ou <a href="http://slconstantia.com">SLConstantia.com</a>.
</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/vive-les-tableaux-de-mise-en-page.php&amp;ref=prez-vive-les-tableaux-de-mise-en-page&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
