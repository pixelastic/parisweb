...
<title>Paris Web - Le KISS des OS</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/la-typo-mon-navigateur-et-moi.php" title="La typo, mon navigateur et moi" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/le-web-developpement-durable-green-it-a-toutes-les-sauces.php" title="Le web développement durable : Green IT à toutes les sauces" />
	...
	<meta name="twitter:title" content="Le KISS des OS" />
	<meta property="twitter:description" content="Le format de 15 minutes de l'intervention va tenter de traiter de façon simple et élégante (le KISS, au format court et anglais) des standards ouverts (les OS, Open Standards)&nbsp;: un format inédit…" />
	<meta property="dc:title" content="Le KISS des OS" />
	<meta property="og:title" content="Le KISS des OS" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/le-kiss-des-os.php" />
	<meta property="og:description" content="Le format de 15 minutes de l'intervention va tenter de traiter de façon simple et élégante (le KISS, au format court et anglais) des standards ouverts (les OS, Open Standards)&nbsp;: un format inédit…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le KISS des OS</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-317">
						<header>
							<h1>Le KISS des OS</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpjswk?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb19_Thierry Stœhr_KISSosDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-PA-04-TStoehr/kiss_des_os.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-317">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/le-kiss-des-os.php" class="url">Le KISS des OS</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/kiss" rel="tag">KISS</a><br /><a href="http://www.paris-web.fr/2011/recherche/standards" rel="tag">Standards</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le format de 15 minutes de l'intervention va tenter de traiter de façon simple et élégante (le KISS, au format court et anglais) des standards ouverts (les OS, <span lang="en">Open Standards</span>)&nbsp;: un format inédit pour évoquer le «&nbsp;pourquoi&nbsp;», le «&nbsp;comment&nbsp;», le «&nbsp;pour qui&nbsp;» et le «&nbsp;tout le reste&nbsp;» des <abbr>OS</abbr> qui sont la colonne vertébrale des <abbr title="Systèmes d'Information">SI</abbr>. Sans formation accélérée, sans déformation exagérée et sans formatage particulier, une transformation de son point de vue sur les formats ouverts est possible&nbsp;!</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/thierry-stoehr.php">Thierry Stœhr</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Thierry Stœhr" src="https://www.paris-web.fr/2011/assets_c/2011/07/thierry-stoehr-thumb-143x143-174.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Thierry Stœhr travaille à l'université Paris-Diderot. Il est fortement impliqué dans le logiciel libre depuis 1998, notamment au travers de l'AFUL (association francophone des utilisateurs de logiciels libres) dont il a été secrétaire, président et un des actuels vice-président. Il a cocréée le site Formats-Ouverts en juillet 2004 : il l'anime depuis plus de 7 ans à propos du sujet des formats, avec plus de 2700 articles en ligne sur le blog. Il donne aussi des conférences, assure des formations et fait des interventions à propos du logiciel libre en général et à propos des formats en particulier.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/le-kiss-des-os.php&amp;ref=prez-le-kiss-des-os&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
