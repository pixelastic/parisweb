...
<title>Paris Web - Immediate Inspiration</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/industrialisation-mecanisation-des-esprits-ou-automatisation-des-procedes.php" title="Industrialisation de l'intégration Web : la révolution de l'artisan devenu ouvrier" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/la-sagesse-du-web.php" title="La Sagesse du Web" />
	...
	<meta name="twitter:title" content="Immediate Inspiration" />
	<meta property="twitter:description" content="As web industry professionals, we rarely experience a shortage of creativity itself. What tends to be elusive and fleeting is inspiration - often when we need it the most for important projects.…" />
	<meta property="dc:title" content="Immediate Inspiration" />
	<meta property="og:title" content="Immediate Inspiration" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/immediate-inspiration.php" />
	<meta property="og:description" content="As web industry professionals, we rarely experience a shortage of creativity itself. What tends to be elusive and fleeting is inspiration - often when we need it the most for important projects.…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Immediate Inspiration</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-308">
						<header>
							<h1>Immediate Inspiration</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xozeyk?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb12_DenisJacobsDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/presentationpariswebinspirationimmediate-111027201050-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-GA-01-DJacobs/immediate_inspiration.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-308">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/immediate-inspiration.php" class="url">Immediate Inspiration</a></span></span></h2>
...
<dd class="column">
 9 <abbr title="heures">h</abbr> 10
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/metier" rel="tag">Métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge">Traduction <abbr title="français">FR</abbr></span></dd>

</dl>
</div>
		</aside>
    <div class="talk-description"><div lang="en" class="span-6"><p>As web industry professionals, we rarely experience a shortage of creativity itself. What tends to be elusive and fleeting is inspiration - often when we need it the most for important projects. Wouldn't it be great to be able to have a reliable method to evoke and tap into creative inspiration at will to spur the process of ideation and production? This talk will explore the concepts around the sources of inspiration and ideas and practices for eliminating blocks and accessing the spark when you need it to develop and execute great work.</p>
</div><div lang="fr" class="span-6 last"><p>En tant que professionnels, il nous arrive rarement de tomber à court de créativité. C'est surtout l'inspiration qui nous échappe et se fait fugace -- le plus souvent au moment où nous en avons le plus besoin, pour des projets importants. Il nous faudrait disposer d'une méthode fiable que nous pourrions invoquer afin de puiser à la demander l'inspiration créatrice qui relance le processus de réflexion et de production ? Cette conférence explorera les concepts liés aux sources d'inspiration et d'idées, et les moyens d'éliminer les points bloquants afin de déclencher l'étincelle au moment où nous avons besoin d'elle, afin de concevoir et réaliser nos projets.</p></div>
<div class="box clear">
<p class="last"><abbr lang="la" title="Nota-Bene">NB</abbr>&nbsp;: cette conférence sera en anglais avec traduction simultanée.</p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/denise-jacobs.php">Denise Jacobs</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Denise Jacobs" src="https://www.paris-web.fr/2011/assets_c/2011/08/denise-jacobs-thumb-143x143-179.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><div lang="en" class="span-6">Denise R. Jacobs is a web industry veteran with over 14 years of experience, ranging from software localization project management, enterprise website implementation, and web design/development technical training. 

<p>Currently, she is finally doing what she likes best: being an Author, Speaker, Web Designer, and Consultant. Denise wrote <a href="http://cssdetectiveguide.com/" hreflang="en">The CSS Detective Guide</a> and is a contributing author to <a href="http://interactwithwebstandards.com/" hreflang="en">Interact with Web Standards</a> : A holistic approach to Web Design. </p>

<p>Denise is passionate about teaching novices about the web and giving people the knowledge, tools, resources to feel more empowered around their websites through consulting, writing books and articles, leading workshops and trainings, and presenting at conferences. </p>

<p>Denise also develops curricula for the Web Standards Project Education Task Force (<a href="http://interact.webstandards.org/" hreflang="en">WaSP InterAct</a>), and is a member of the <a href="http://socialmediaclubsf.org/" hreflang="en">Social Media Club South Florida</a> organizing committee. Denise was nominated for .Net Magazine’s 2010 Best of the Web “Standards Champion” award.<br />
</div><br />
<div lang="fr" class="span-6 last">Denise R. Jacobs est une vétéran de l'industrie web, avec plus de 14 années d'expérience, allant de la gestion de projet de localisation de logiciels, la mise en oeuvre site d'entreprises, à la création de formation sur la conception de sites Web et le développement technique. </p>

<p>Actuellement, elle fait enfin ce qu'elle aime le plus : être une auteure, conférencière, conceptrice de sites Web, et consultants. Denise a écrit <a href="http://cssdetectiveguide.com/" hreflang="en">The CSS Detective</a>, et contribue à <a href="http://interactwithwebstandards.com/" hreflang="en">Interact with Web Standards</a>: A holistic approach to Web Design. </p>

<p>Denise adore enseigner le Web aux novices, et donner aux gens les connaissances, les outils  et les ressources pour se sentir plus autonomes avec leurs sites Web par le biais de ses conseils, ses livres et articles, ses ateliers et formations, et ses présentations en conférences. </p>

<p>Denise conçois également des cours pour la Web Standards Project Education Task Force (<a href="http://interact.webstandards.org/" hreflang="en">WaSP  InterAct</a>), et est membre du  comité d'organisation du <a href="http://socialmediaclubsf.org/" hreflang="en"> social Media Club de Floride du Sud</a>. Denise a été nominée pour le prix de Défenseur des Standards du magazine .Net lors de leurs Best of the Web 2010.</div></p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/immediate-inspiration.php&amp;ref=prez-immediate-inspiration&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
