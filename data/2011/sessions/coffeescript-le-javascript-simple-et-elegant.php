...
<title>Paris Web - CoffeeScript, le Javascript simple et élégant</title>
...
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/planification-ou-iteration-specialisation-ou-heterogeneite-transmission-orale-ou-ecrite-deux-jeux-po.php" title="Planification ou itération ? Spécialisation ou hétérogénéité ? Transmission orale ou écrite ? Deux jeux pour nous amuser et en parler" />
	...
	<meta name="twitter:title" content="CoffeeScript, le Javascript simple et élégant" />
	<meta property="twitter:description" content=" La critique principale adressée à l'encontre de Javascript est sa syntaxe parfois obscure. Jeremy Ashkenas, est parti de ce constat pour créer Coffeescript. Ce langage qui compile en Javascript et…" />
	<meta property="dc:title" content="CoffeeScript, le Javascript simple et élégant" />
	<meta property="og:title" content="CoffeeScript, le Javascript simple et élégant" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/coffeescript-le-javascript-simple-et-elegant.php" />
	<meta property="og:description" content=" La critique principale adressée à l'encontre de Javascript est sa syntaxe parfois obscure. Jeremy Ashkenas, est parti de ce constat pour créer Coffeescript. Ce langage qui compile en Javascript et…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>CoffeeScript, le Javascript simple et élégant</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-221">
						<header>
							<h1>CoffeeScript, le Javascript simple et élégant</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-221">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/coffeescript-le-javascript-simple-et-elegant.php" class="url">CoffeeScript, le Javascript simple et élégant</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/jonathan-blanchet.php">Jonathan Blanchet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jonathan Blanchet" src="https://www.paris-web.fr/2011/assets_c/2011/07/jonathan-blanchet-thumb-143x143-94.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
Passionné par le web depuis déjà quelques années, je suis passé par un IUT Informatique , une licence, puis une formation plus orientée multimédia à l'école des Gobelins (CRMA).
Professionnel depuis 5 ans, j'ai travaillé et travaille encore avec des technologies multiples telles que Ruby on Rails, PHP, NodeJS côté serveur et le trio HTML/CSS/JS côté client.
Je suis depuis juin 2010, Freelance au sein du collectif collectif <a href="http://lab212.org/">Lab212</a> aux côtés de huit autres développeurs, graphistes et artistes d'horizons différents.
</p>
<p>
J'essaie d'y mettre en œuvre mes connaissances actuelles, tout en continuant à enrichir celles-ci au contact de mes collègues et nouveaux clients...<br />
Mes missions au sein du collectif vont de la conception à la réalisation d'applications web diverses et variées.
</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/coffeescript-le-javascript-simple-et-elegant.php&amp;ref=prez-coffeescript-le-javascript-simple-et-elegant&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
