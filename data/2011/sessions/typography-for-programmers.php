...
<title>Paris Web - Typography for Programmers</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/ateliers/travaillons-avec-le-web.php" title="Travaillons avec le Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/svg-et-le-web-design-moderne.php" title="SVG et le web design moderne" />
	...
	<meta name="twitter:title" content="Typography for Programmers" />
	<meta property="twitter:description" content=" A good proportion of web design today descends from print/graphic design and these influences are becoming even more prevalent. Typography for the web is now all the rage especially as we are…" />
	<meta property="dc:title" content="Typography for Programmers" />
	<meta property="og:title" content="Typography for Programmers" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/typography-for-programmers.php" />
	<meta property="og:description" content=" A good proportion of web design today descends from print/graphic design and these influences are becoming even more prevalent. Typography for the web is now all the rage especially as we are…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Typography for Programmers</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-294">
						<header>
							<h1>Typography for Programmers</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/typography-for-developers-110911040703-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/03-samedi/SA-AM-08-MDugonjic/typography_for_programmers.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-294">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/typography-for-programmers.php" class="url">Typography for Programmers</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/typographie" rel="tag">Typographie</a></dd>
    ...
    <div class="talk-description"><div lang="en" class="span-6"><p>
...
This workshop should teach every programmer and possibly a few web design students about how to design a web page with type and impress fellow designers using just the good old HTML and CSS with a spice of simple mathematics.</p>
</div>
<div lang="fr" class="span-6 last"><p>Une large portion du web design actuel descend de l'impression et du graphisme, et ces influences se font de plus en plus sentir. La typographie pour le web est un sujet à la mode, particulièrement depuis que nous sommes (enfin) en mesure d'utiliser des polices autres que les sempiternels grands noms, comme Arial, Verdana ou Georgia. De fait, une solide connaissance des bases de la typographie devrait être un pré-requis pour tout professionnel de l'Internet actuel.</p><p>Cet atelier devrait apprendre à tous les programmeurs, et même à certains étudiant en web design, à concevoir une page web à l'aide de polices, et à impressionner leurs camarades juste en utiliser nos bons vieux langages HTML et CSS, avec une pincée de mathématiques élémentaires.</p></div>
<div class="box clear">
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/marko-dugonjic.php">Marko Dugonjic</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marko Dugonjic" src="https://www.paris-web.fr/2011/assets_c/2011/07/marko-dugonjic-thumb-143x143-137.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Marko Dugonjic is web/interface designer from Croatia since 2000. Before he went the freelance path in 2009., he worked as a Front-End Lead at the award winning agency Web.Burza <http://web.burza.hr/> and also as a User Experience Director in media publishing company Adria Media Zagreb <http://adriamedia.hr/>. He is the author of Typetester <http://typetester.org/>, an online application for testing screen type. Nowadays Marko runs his own user interface studio Creative Nights <http://creativenights.com/> serving local and international clients such as T-Com, T-Mobile, QBN.com, Krop Creative Jobs...</p>

<p>His speciality is user-experience design, UI design and front-end development. Marko occasionally writes about web design topics at <a href="http://maratz.com/">http://maratz.com/</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/typography-for-programmers.php&amp;ref=prez-typography-for-programmers&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
