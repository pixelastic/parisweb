...
<title>Paris Web - KISS dans une grande entreprise ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/accessibilite-soyons-agiles.php" title="Accessibilité : soyons agiles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/les-gouts-et-les-couleurs.php" title="Les goûts et les couleurs" />
	...
	<meta name="twitter:title" content="KISS dans une grande entreprise ?" />
	<meta property="twitter:description" content="La plus grosse difficulté quand les équipes de développement sont nombreuses et importantes, c'est de s'assurer de l'homogénéité des pratiques pour des questions de maintenabilité, de qualité,…" />
	<meta property="dc:title" content="KISS dans une grande entreprise ?" />
	<meta property="og:title" content="KISS dans une grande entreprise ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/kiss-dans-une-grande-entreprise.php" />
	<meta property="og:description" content="La plus grosse difficulté quand les équipes de développement sont nombreuses et importantes, c'est de s'assurer de l'homogénéité des pratiques pour des questions de maintenabilité, de qualité,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>KISS dans une grande entreprise ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-297">
						<header>
							<h1>KISS dans une grande entreprise ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xnfif6?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb06_StephaneDeschamp_KISSDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/kissgrandeentreprise-111110132107-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-GA-01-SDeschamp/kiss_grande_entreprise.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-297">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/kiss-dans-une-grande-entreprise.php" class="url">KISS dans une grande entreprise ?</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>La plus grosse difficulté quand les équipes de développement sont nombreuses et importantes, c'est de s'assurer de l'homogénéité des pratiques pour des questions de maintenabilité, de qualité, d'accessibilité, de facilité à retrouver des compétences.</p>

<p>Le Groupe France Télécom-Orange comporte une instance nommée <acronym>ISAD</acronym> (<span lang="en">Information System Architecture and Design</span>) dont le travail est précisément de garantir des pratiques communes.</p>

<p>Pour ce faire, <acronym>ISAD</acronym> fournit des versions d'Eclipse packagées avec une liste de plugins normalisée, ainsi que des préconisations et du code réutilisable, l'idée étant de simplifier les installations de nouveaux arrivants, de mutualiser les pratiques. Bref&nbsp;: adopter une philosophie qui veut se rapprocher de <acronym title="Keep It Simple and Smart" lang="en">KISS</acronym>.</p>

<p>Nous présenterons les environnements de développement prépackagés, ainsi que la démarche de normalisation/préconisation, et finirons par des outils et des livrables spécialement dédiés à  l'accessibilité et à l'ergonomie des sites web.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/stephane-deschamps.php">Stéphane Deschamps</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Deschamps" src="https://www.paris-web.fr/2011/assets_c/2011/07/stephane-thumb-143x143-142.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Stéphane est développeur Web client depuis 1999. Il contribue depuis plusieurs années à promouvoir la qualité du Web, et a été successivement membre du comité éditorial d’<a href="http://evolt.org/" hreflang="en">Evolt</a>, co-administrateur de <a href="http://pompage.net/">Pompage</a>, puis fondateur et président de Paris-Web. Il est aussi membre du collectif <a href="http://openweb.eu.org/">Openweb</a>.</p>

<p>Il est actuellement expert technique dans le Groupe <a href="http://orange.com/">France Télécom - Orange</a> en charge de questions d’accessibilité et d’interopérabilité des sites Web. C'est à ce titre qu'il intervient cette année.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/kiss-dans-une-grande-entreprise.php&amp;ref=prez-kiss-dans-une-grande-entreprise&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
