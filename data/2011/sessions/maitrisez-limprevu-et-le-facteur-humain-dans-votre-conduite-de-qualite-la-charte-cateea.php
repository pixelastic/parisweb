...
<title>Paris Web - Maîtrisez l'imprévu et le facteur humain dans votre conduite de qualité : la charte CATEEA</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/pause-8.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/les-donnees-ouvertes-et-liees-linked-open-data-pour-les-allergiques-au-rdf.php" title="Les données ouvertes et liées (Linked Open Data) pour les allergiques au RDF" />
	...
	<meta name="twitter:title" content="Maîtrisez l'imprévu et le facteur humain dans votre conduite de…" />
	<meta property="twitter:description" content="Dans votre gestion de projet web, vous aurez beau avoir avec vous une équipe de super-experts éclairés, il y a des chances que tout le monde ne se retrouve pas totalement dans le résultat final,…" />
	<meta property="dc:title" content="Maîtrisez l'imprévu et le facteur humain dans votre conduite de qualité : la charte CATEEA" />
	<meta property="og:title" content="Maîtrisez l'imprévu et le facteur humain dans votre conduite de qualité : la charte CATEEA" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/maitrisez-limprevu-et-le-facteur-humain-dans-votre-conduite-de-qualite-la-charte-cateea.php" />
	<meta property="og:description" content="Dans votre gestion de projet web, vous aurez beau avoir avec vous une équipe de super-experts éclairés, il y a des chances que tout le monde ne se retrouve pas totalement dans le résultat final,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Maîtrisez l'imprévu et le facteur humain dans votre conduite de qualité : la charte CATEEA</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-244">
						<header>
							<h1>Maîtrisez l'imprévu et le facteur humain dans votre conduite de qualité : la charte CATEEA</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/k11jFg8M3iOy3u2BFCm?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWebExportFinal02_Cateea_Rudy_Rigot_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/cateea-111014174021-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-GA-07-RRigot/charte_CATEEA.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-244">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/maitrisez-limprevu-et-le-facteur-humain-dans-votre-conduite-de-qualite-la-charte-cateea.php" class="url">Maîtrisez l'imprévu et le facteur humain dans votre conduite de qualité : la charte CATEEA</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/kiss" rel="tag">KISS</a><br /><a href="http://www.paris-web.fr/2011/recherche/metier" rel="tag">Métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Dans votre gestion de projet web, vous aurez beau avoir avec vous une équipe de super-experts éclairés, il y a des chances que tout le monde ne se retrouve pas totalement dans le résultat final, product owner compris...<br />
"Oui, là, on avait l'intention de rendre cette fonctionnalité accessible, mais en fait, au final on n'a pas trop pu..." (et l'intégrateur grince des dents).</p>

<p>Pourtant, vous les aviez bien peaufinées, vos specs, et vous vous rappelez comme tout le monde était motivé de bonnes intentions pour construire un site génial ! Mais, les décisions qui n'ont pu se prendre que sur le moment, les contraintes de staffing, et le facteur humain n'ont pas eu d'autre choix que d'altérer la qualité du produit, et ce malgré la qualité des expertises en jeu (et vu que j'aime bien le pathétique, j'appelle ça : "la déception d'expertise").</p>

<p>C'est pourquoi je propose une tentative de réponse très KISS à cet effet nocif et usuel, par l'engagement de toutes les personnes ayant un impact sur le projet (PM, PO, responsable dispo, etc, ...) autour d'une charte simple et non-contractuelle, permettant d'organiser logiquement les phases d'imprévu, afin de donner les moyens aux experts les plus pertinents du projet d'apporter les réponses aux questions pertinentes, et de sauvegarder la qualité du résultat final. Cette charte (qui peut avoir des résultats impressionnants en projets réels), se prénomme <abbr>CATEEA</abbr> (<span lang="en">Collaborative Achievement Through Everyone's Expertise Acknowledgement</span>), et tente de répondre à un maximum de conditions initiales de projets.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/rudy-rigot.php">Rudy Rigot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Rudy Rigot" src="https://www.paris-web.fr/2011/assets_c/2011/07/rudy-rigot-thumb-143x143-105.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Rudy Rigot est consultant et responsable du pôle des outils et projets internes pour l'agence parisienne de <a lang="en" href="http://www.clever-age.com/">Clever Age</a>, et réalise pour divers clients notamment des missions de conseil, de formations, ou des missions de gestion de projet fonctionnelle et/ou technique. C'est sous cette dernière casquette qu'il voit souvent des projets tourner au compromis de qualité malgré des situations de départ parfois particulièrement prometteuses.</p>

<p>Rudy est aussi le rédacteur du blog au ton décalé "<a href="http://rudyonweb.net/">Rudy on web</a>", qui parle de web, mais aussi d'autres sujets moins intéressants, bien sûr ! ;)</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/maitrisez-limprevu-et-le-facteur-humain-dans-votre-conduite-de-qualite-la-charte-cateea.php&amp;ref=prez-maitrisez-limprevu-et-le-facteur-humain-dans-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
