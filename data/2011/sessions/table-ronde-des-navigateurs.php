...
<title>Paris Web - Table ronde des navigateurs</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/les-donnees-ouvertes-et-liees-linked-open-data-pour-les-allergiques-au-rdf.php" title="Les données ouvertes et liées (Linked Open Data) pour les allergiques au RDF" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/principes-dingenierie-du-developpement-web.php" title="Principes d’ingénierie du développement Web" />
	...
	<meta name="twitter:title" content="Table ronde des navigateurs" />
	<meta property="twitter:description" content="Certains ont qualifié le renouveau d'innovation à tour de bras dans le monde des navigateurs de nouvelle guerre des navigateurs. Nous nous proposons d'explorer au cours de cette table ronde comment…" />
	<meta property="dc:title" content="Table ronde des navigateurs" />
	<meta property="og:title" content="Table ronde des navigateurs" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/table-ronde-des-navigateurs.php" />
	<meta property="og:description" content="Certains ont qualifié le renouveau d'innovation à tour de bras dans le monde des navigateurs de nouvelle guerre des navigateurs. Nous nous proposons d'explorer au cours de cette table ronde comment…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Table ronde des navigateurs</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-237">
						<header>
							<h1>Table ronde des navigateurs</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpg6zl?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb16_TableRondeNavigateurs.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
	...
	<section class="s-talk-subject" id="sujet-237">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/table-ronde-des-navigateurs.php" class="url">Table ronde des navigateurs</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2011/conferences/">Conférence</a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/">Grand amphithéâtre</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2011/14.php">vendredi 14</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
16 <abbr title="heures">h</abbr> 50
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/html5" rel="tag">HTML5</a><br /><a href="http://www.paris-web.fr/2011/recherche/mobile" rel="tag">Mobile</a><br /><a href="http://www.paris-web.fr/2011/recherche/navigateurs" rel="tag">Navigateurs</a><br /><a href="http://www.paris-web.fr/2011/recherche/technologie" rel="tag">Technologie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Certains ont qualifié le renouveau d'innovation à tour de bras dans le monde des navigateurs de nouvelle guerre des navigateurs. Nous nous proposons d'explorer au cours de cette table ronde comment les développeurs de navigateurs associent innovation et standardisation, compétition et collaboration.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/dominique-hazael-massieux.php">Dominique Hazael-Massieux</a>, <a href="https://www.paris-web.fr/2011/../orateurs/david-rousset.php">David Rousset</a>, <a href="https://www.paris-web.fr/2011/../orateurs/karl-dubost.php">Karl Dubost</a>, <a href="https://www.paris-web.fr/2011/../orateurs/paul-rouget.php">Paul Rouget</a> et <a href="https://www.paris-web.fr/2011/../orateurs/sam-dutton.php">Sam Dutton</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Dominique Hazael-Massieux" src="https://www.paris-web.fr/2011/assets_c/2011/07/dominique-hazael-massieux-thumb-143x143-117.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Dom travaille au <abbr>W3C</abbr> depuis 11 ans, où il est, entre autres choses, responsable de l’activité Web Mobile du <abbr>W3C</abbr>, en charge du groupe de travail sur les APIs pour les terminaux. Il a écrit avec François Daoust un livre sur le développement et le <span lang="en">design Web</span> pour les appareils mobiles, «&nbsp;Relever le défi du Web mobile&nbsp;».</p>

<p>Il pratique aussi le développement d’applications <span lang="en">Web</span> pour le <abbr>W3C</abbr>, ce qui lui permet de garder un point de vue pragmatique sur la mise en application des technologies qu’il contribue à standardiser.</p>

<p>Dom est aussi passionné de l’open source, des systèmes ouverts et de tiramisu.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="David Rousset" src="https://www.paris-web.fr/2011/assets_c/2011/07/david-rousset-thumb-143x143-155.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Fana de la ligne de code depuis tout petit, David intègre Microsoft en 2000 après une formation d'ingénieur en informatique à Orsay. Il est aujourd'hui en charge de la relation technique avec les développeurs Web chez Microsoft France dans la division <abbr title="Developer and Platform Evangelism" lang="en">DPE</abbr>. À ce titre, il anime de nombreuses conférences plénières et techniques aux Microsoft Days et TechDays. Il rencontre également de nombreux clients pour l'évaluation des technologies "en avant de phase".</p>

<p>Ses domaines de compétences tournent autour d'ASP.NET, Windows Azure, Silverlight et bien sûr HTML5. Vous pouvez le retrouver ici&nbsp;: <a href="http://blogs.msdn.com/davrous">http://blogs.msdn.com/davrous</a>.</p>

<p>Accessoirement, c'est un timbré de StarWars et du HomeCinema.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Paul Rouget" src="https://www.paris-web.fr/2011/assets_c/2011/07/paul-rouget-thumb-143x143-147.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><div lang="en" class="span-6">
...
</div><div lang="fr" class="span-6 last">
Paul Rouget est l'un des développeurs de Firefox, et un <span lang="en">Technology Evangelist</span> chez Mozilla. Il joue un rôle important dans la combinaison des toutes dernières technologies ouvertes du Web. Son objectif est de repousser les limites de l'Internet et de s'assurer qu'il continue à se développer en tant que plate-forme ouverte et accessible à tous. Paul travaille en étroite collaboration avec l'équipe de la plate-forme de Mozilla pour explorer les manières dont les nouvelles technologies peuvent continuer à améliorer Firefox. Il s'est impliqué dans le projet Mozilla dès 2003, à la fois en tant que bénévole et comme employé.
</div></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Sam Dutton" src="https://www.paris-web.fr/2011/assets_c/2011/07/sam-dutton-thumb-143x143-99.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><div lang="en" class="span-6">
Sam Dutton is a Developer Advocate for Chrome at Google in London.
Before Google, he worked for the BBC, ITN and Decca Records. Sam has designed and coded numerous websites, built desktop applications with C++ and the Qt framework, and has some experience of Symbian, Android and iOS.  He is a governor at Ravenstone School in London and is passionate about improving the ICT curriculum. Sam grew up in rural South Australia, did a BA at Sydney University and now lives in Balham, south London with his wife and daughter. 
</div><div lang="fr" class="span-6 last">
Sam Dutton est un Developer Advocate pour Chrome chez Google, à Londres.
Avant Google, il a travaillé pour la <abbr title"British Broadcasting Corporation">BBC</abbr>, <abbr title="Independent Television News">ITN</abbr> et Decca Records. Sam a conçu et codé de nombreux sites Web, construit des applications de bureau en C++ et le framework Qt, et a une certaine expérience de Symbian, Android et <abbr title="iPhone OS">iOS</abbr>. Il est directeur de la Ravenstone School de Londres, et se passionne pour l'amélioration du programme d'études des technologies de l'information. Sam a grandi en milieu rural au sud de l'Australie, a suivi une formation artistique à l'Université de Sydney et vit maintenant à Balham, au sud de Londres, avec sa femme et sa fille.
</div></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/table-ronde-des-navigateurs.php&amp;ref=prez-table-ronde-des-navigateurs&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
