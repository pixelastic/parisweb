...
<title>Paris Web - Le web développement durable : Green IT à toutes les sauces</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/le-kiss-des-os.php" title="Le KISS des OS" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/repas-2.php" title="Déjeuner" />
	...
	<meta name="twitter:title" content="Le web développement durable : Green IT à toutes les sauces" />
	<meta property="twitter:description" content="Quel est l'impact de nos métiers du numérique au plan environnemental, sociétal et économique ? Le motif écologique orientant les décisions vers la dématérisalisation est-il viable ? Les interfaces…" />
	<meta property="dc:title" content="Le web développement durable : Green IT à toutes les sauces" />
	<meta property="og:title" content="Le web développement durable : Green IT à toutes les sauces" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/le-web-developpement-durable-green-it-a-toutes-les-sauces.php" />
	<meta property="og:description" content="Quel est l'impact de nos métiers du numérique au plan environnemental, sociétal et économique ? Le motif écologique orientant les décisions vers la dématérisalisation est-il viable ? Les interfaces…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le web développement durable : Green IT à toutes les sauces</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-321">
						<header>
							<h1>Le web développement durable : Green IT à toutes les sauces</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpfv2p?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb17_Clouzeau_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/pw2011-devdurable-04-111014022829-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-GA-04-CClouzeau/le_web_developpement_durable.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-321">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/le-web-developpement-durable-green-it-a-toutes-les-sauces.php" class="url">Le web développement durable : Green IT à toutes les sauces</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/green-it" rel="tag">Green IT</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Quel est l'impact de nos métiers du numérique au plan environnemental, sociétal et économique ?<br />
Le motif écologique orientant les décisions vers la dématérisalisation est-il viable ?<br />
Les interfaces numériques, les développements informatiques, les hébergeurs, l'obsolescence des applications et des matériels : tous influencent nos comportements et nos habitudes. De leur fabrication à leur utilisation, les technologies de l'information et de la communication ont une empreinte sur notre environnement.</p>

<p>Le Green IT, nous en mangeons quotidiennement et à toutes les sauces. Pouvons-nous l'embrasser ?<br />
*<span lang="en">kiss the green</span>*</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/christophe-clouzeau.php">Christophe Clouzeau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Christophe Clouzeau" src="https://www.paris-web.fr/2011/assets_c/2011/07/christophe-clouzeau-thumb-143x143-170.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Gérant, <abbr>UX</abbr> ergonome à forte sensibilité pour le respect des standards du web et des normes d'accessibilité numérique.</p>

<p>De formation en écoles d'art et de multimédia (Estienne + Gobelins), son parcours professionnel englobe l'ensemble des métiers de l'image : livre, presse, communication, image de synthèse, audiovisuel, offline. Il tombe dans la marmite du web en 1996 pour ne plus en sortir.<br />
Tour à tour chef de projet artistique et associé d'agences de communication, il assume aujourd'hui la direction d'une agence spécialisée dans le design interactif et le développement durable : <a href="http://www.neoma-interactive.com/">Neoma Interactive</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/le-web-developpement-durable-green-it-a-toutes-les-sauces.php&amp;ref=prez-le-web-developpement-durable-green-it-a-toute&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
