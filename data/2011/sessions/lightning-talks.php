...
<title>Paris Web - Lightning talks</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/tester-vos-services-mythes-et-realites-1.php" title="Tester vos services, mythes et réalités !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/industrialisation-mecanisation-des-esprits-ou-automatisation-des-procedes.php" title="Industrialisation de l'intégration Web : la révolution de l'artisan devenu ouvrier" />
	...
	<meta property="twitter:description" content=" 10 Lightning talks, 4 minutes par présentation et pas une seconde de plus. Pas de Liens Sans Autorisation m'a tuer (PDF), par Thierry Stoehr La Glande Assistée par Ordinateur (PDF), par Laurence…" />
	<meta property="dc:title" content="Lightning talks" />
	<meta property="og:title" content="Lightning talks" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/lightning-talks.php" />
	<meta property="og:description" content=" 10 Lightning talks, 4 minutes par présentation et pas une seconde de plus. Pas de Liens Sans Autorisation m'a tuer (PDF), par Thierry Stoehr La Glande Assistée par Ordinateur (PDF), par Laurence…" />
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpqxvq?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb30_Lightningtalks_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
	...
	<section class="s-talk-subject" id="sujet-304">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/lightning-talks.php" class="url">Lightning talks</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><div class="span-12 last description">

<p>10 Lightning talks, 4 minutes par présentation et pas une seconde de plus.  </p>

<ul>
<li><strong>Pas de Liens Sans Autorisation m'a tuer</strong> (<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-GA-08-Lightning/ltpdlsa.pdf" title="Support de présentation PDF">PDF</a>), par Thierry Stoehr</li> 
<li><strong>La Glande Assistée par Ordinateur</strong> (<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-GA-08-Lightning/la_glande_assistee_par_ordinateur.pdf" title="Support de présentation PDF">PDF</a>), par Laurence Vagner<li>
<li><strong>Ack, better than grep</strong> (<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-GA-08-Lightning/ack_better_than_grep.pdf" title="Support de présentation PDF">PDF</a>), par Anthony Ricaud</li>
<li><strong>L'amusante frénésie des pages à largeurs fixes</strong> (<a href="http://pleaseresize.me/">support</a>), par Rudy Rigot</li>
<li><strong>Comment faire un sac de laptop en 30s</strong>, par Karl Dubost</li>
<li><strong>Pdf.js</strong>, par Vivien Nicolas</li>
<li><strong>BootToGecko</strong>, par Mounir Lamouri</li>
<li><strong>Ligthning Failconf</strong>, par Benjamin Lorteau</li>
<li><strong>L'accessibilité : un truc réservé aux riches ?</strong> (<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-GA-08-Lightning/accessibilite_un_truc_de_riche.pdf" title="Support de présentation PDF">PDF</a>), par Jean-Philippe Simonnet</li>
<li><strong>W3C Sentaï Team</strong> (<a href="http://jeremie.patonnier.net/post/2011/10/18/Paris-Web-2011-%3A-SVG-et-Typographie">support</a>), par Jérémie Patonnier</li>
</ul>
</div>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/daniel-glazman.php">Daniel Glazman</a> et <a href="https://www.paris-web.fr/2011/../orateurs/robin-berjon.php">Robin Berjon</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Daniel Glazman" src="https://www.paris-web.fr/2011/assets_c/2011/07/daniel-glazman-thumb-143x143-172.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Daniel Glazman (<a href="http://www.twitter.com/glazou">@glazou</a>) co-préside le CSS <span lang="en">Working Group</span> du <span lang="en">World Wide Web Consortium</span> (<abbr>W3C</abbr>) et dirige Disruptive Innovations, l'entreprise qui a publié les éditeurs web Nvu et BlueGriffon. </p>

<p>Connu tant pour son affection des canards sous toutes leurs formes que pour sa capacité à dormir une heure l'après-midi du second jour de Paris Web, il tente désespérément de faire oublier qu'il écrit des logiciels depuis maintenant 35 ans et des standards du Web depuis 17, ce qui indique tout de même une sérieuse attaque neuronale. </p>

<p>Il animera avec <a href="http://www.paris-web.fr/orateurs/robin-berjon.php">Robin Berjon</a> la session de «&nbsp;<a href="http://www.paris-web.fr/2011/conferences/lightning-talks.php" lang="en">Lightning Talks</a>&nbsp;», l'œil rivé sur le chronomètre, le doigt scotché sur le bouton de coupure du microphone et l'esprit branché sur le pot qui ne manquera pas de suivre cette session mémorable.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Robin Berjon" src="https://www.paris-web.fr/2011/assets_c/2011/07/robin-berjon-thumb-143x143-125.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Robin Berjon (<a href='http://twitter.com/robinberjon'>@robinberjon</a>) participe à l'élaboration de standards au W3C depuis de nombreuses années, travaillant notamment sur les APIs Javascript, le <abbr>SVG</abbr>, ou les technologies <abbr>XML</abbr>. Il est actuellement chair du groupe Device APIs qui expose des interfaces entre le web et le monde réel. Il bricole souvent du Javascript pour s'amuser, et a contribué à de nombreux développements open source.</p></div>
</div>
