...
<title>Paris Web - Accessibilité : soyons agiles</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/introduction-pa.php" title="Introduction" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/kiss-dans-une-grande-entreprise.php" title="KISS dans une grande entreprise ?" />
	...
	<meta name="twitter:title" content="Accessibilité : soyons agiles" />
	<meta property="twitter:description" content="Après une quinzaine d'années de pratique, la boîte à outils de l'accessibilité des projets Web est bien fournie&nbsp;: standards, checklists, méthodes d'application, expertise, tests utilisateurs,…" />
	<meta property="dc:title" content="Accessibilité : soyons agiles" />
	<meta property="og:title" content="Accessibilité : soyons agiles" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/accessibilite-soyons-agiles.php" />
	<meta property="og:description" content="Après une quinzaine d'années de pratique, la boîte à outils de l'accessibilité des projets Web est bien fournie&nbsp;: standards, checklists, méthodes d'application, expertise, tests utilisateurs,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Accessibilité : soyons agiles</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-270">
						<header>
							<h1>Accessibilité : soyons agiles</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xn6rbd?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWebExportFinal03_Accessibilite_soyons_agiles.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/sppw201120111011-111014100428-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-PA-01-ESloim_LDenis/accessibilite_soyons_agiles.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-270">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/accessibilite-soyons-agiles.php" class="url">Accessibilité : soyons agiles</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/accessibilite" rel="tag">Accessibilité</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Après une quinzaine d'années de pratique, la boîte à outils de l'accessibilité des projets Web est bien fournie&nbsp;: standards, <span lang="en">checklists</span>, méthodes d'application, expertise, tests utilisateurs, validateurs, canaux de <span lang="en">feedback</span>... Mais l'existence d'outils n'empêche pas les échecs et les difficultés récurrentes.<br />
Et si ce n'était pas une question d'outillage mais de choix et de bon emploi des outils&nbsp;? Comment en effet choisir l'outil le plus adéquat et en faire le bon usage selon le contexte&nbsp;?<br />
Dans cette conférence, nous partirons d'observations pratiques pour suggérer quelques principes stratégiques de gestion intelligente et efficiente de l'accessibilité. L'objectif est de produire des sites accessibles sans surcoût et sans (trop) faire souffrir les équipes projet.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/elie-sloim.php">Élie Sloïm</a> et <a href="https://www.paris-web.fr/2011/../orateurs/laurent-denis.php">Laurent Denis</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Élie Sloïm" src="https://www.paris-web.fr/2011/assets_c/2011/07/elie-sloim-thumb-143x143-135.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Élie Sloïm est directeur de la société <a href="http://www.temesis.com/">Temesis</a>, spécialisée sur la qualité et l'accessibilité des sites Internet. Il dirige depuis 2004 le projet <abbr>Opquast</abbr> (<span lang="en">Open Quality Standards</span>). Le projet <abbr>Opquast</abbr> inclut des référentiels (<abbr>Opquast</abbr> bonnes pratiques) et des outils de gestion de projet orientés qualité (<abbr>Opquast</abbr> <span lang="en">Reporting</span>). </p>

<p>Élie Sloïm est consultant, formateur et conférencier. À ce titre, il intervient dans de nombreuses manifestations, entreprises et cursus de formation en France et à l'étranger. Il s'est spécialisé sur la création de référentiels. Il a notamment travaillé sur la production du <abbr title="Réferentiel Général d'Accessibilité pour les Administrations">RGAA</abbr>, des bonnes pratiques <abbr>Opquast</abbr>, et de nombreux autres référentiels publics ou privés. </p>

<p>Auteur de plus d'une centaine d'articles sur la qualité Web, il assure la direction actuelle du projet <span lang="en">OpenWeb</span>. Il est également l'auteur avec les contributeurs du projet <abbr>Opquast</abbr> du memento «&nbsp;Site Web&nbsp;: les bonnes pratiques », publié chez <a href="http://www.eyrolles.com/">Eyrolles</a> et préfacier des ouvrages "<abbr>CSS2</abbr>" par Raphaël Goetter et "Ergonomie Web" par Amélie Boucher.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Laurent Denis" src="https://www.paris-web.fr/2011/assets_c/2011/07/orateur_laurent_denis-thumb-143x143-37-thumb-143x143-157.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Laurent Denis a longtemps exercé comme enseignant en milieu universitaire et scolaire. C’est dans le cadre de ses activités d’enseignement qu’il a été amené à s’intéresser puis à se spécialiser sur l’accessibilité, les formats Web standards et les technologies <abbr>CSS</abbr> dès la fin des années 90. Rédacteur en chef du projet <span lang="en">OpenWeb</span> entre 2002 et 2010, il a publié de très nombreux articles sur ces technologies. Sa connaissance et sa pratique des normes et des spécifications en font l’un des tous premiers spécialistes francophones sur les standards du Web. Habitué à titre personnel à naviguer quotidiennement avec des outils de synthèse vocale, passionné par les enjeux du Web mobile, il possède une double compétence théorique et appliquée de l’accessibilité et de la qualité Web. </p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/accessibilite-soyons-agiles.php&amp;ref=prez-accessibilite-soyons-agiles&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
