...
<title>Paris Web - Optimizing your layout for phones and tablets using viewport and media queries</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/pause-2.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/tester-lutilisabilite-de-son-site-web-quand-on-na-pas-de-budget.php" title="Tester l'ergonomie de son site même sans budget" />
	...
	<meta name="twitter:title" content="Optimizing your layout for phones and tablets using viewport and…" />
	<meta property="twitter:description" content="With mobile web browsing becoming widespread, users expect their favorite sites to just work on their mobile device of choice. Exciting times, especially as there are a number of new hooks in modern…" />
	<meta property="dc:title" content="Optimizing your layout for phones and tablets using viewport and media queries" />
	<meta property="og:title" content="Optimizing your layout for phones and tablets using viewport and media queries" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/optimizing-your-layout-for-phones-and-tablets-using-viewport-and-media-queries.php" />
	<meta property="og:description" content="With mobile web browsing becoming widespread, users expect their favorite sites to just work on their mobile device of choice. Exciting times, especially as there are a number of new hooks in modern…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Optimizing your layout for phones and tablets using viewport and media queries</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-280">
						<header>
							<h1>Optimizing your layout for phones and tablets using viewport and media queries</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xqb4iz?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb33_AndreasBovens_Optimizingyourlayout_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/parisweb-pres-111013085104-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-GA-03-ABovens/Optimizing_your_layout_for_phones_and_tablets_using_viewport_and_media_queries.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-280">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/optimizing-your-layout-for-phones-and-tablets-using-viewport-and-media-queries.php" class="url">Optimizing your layout for phones and tablets using viewport and media queries</a></span></span></h2>
...
<dd class="column">
11 <abbr title="heures">h</abbr> 25
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/mobile" rel="tag">Mobile</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge">Traduction <abbr title="français">FR</abbr></span></dd>
    ...
    <div class="talk-description"><div class="span-6" lang="en"><p>With mobile web browsing becoming widespread, users expect their favorite sites to "just work" on their mobile device of choice. Exciting times, especially as there are a number of new hooks in modern mobile browsers that help web designers to create compelling experiences on phones and tablets.</p>
<p>In my talk, I will cover the various features of the viewport meta tag, and look at how they allow you to control mobile browsers' zoom behaviors. I'll also connect this to Opera's CSS Device Adaptation proposal, which brings this feature to CSS in the form of the @viewport rule.</p>
<p>Furthermore, I will explain how viewport can be combined with media queries to create super-flexible layouts that work nicely across different browsing contexts and devices, and explore various strategies to dealing with different screen sizes and pixel densities.</p>
</div><div class="span-6 last" lang="fr"><p>Maintenant que le fait de naviguer sur Internet à en étant mobile est devenu une réalité, les utilisateurs s'attendent à ce que leurs sites préférés fonctionnent sans problème sur leur appareil mobile. Nous entrons dans une ère passionnante, car les navigateurs mobiles modernes disposent de nombreuses fonctionnalités qui aident les designers web à concevoir une expérience mobile (sur téléphone ou tablette) plus intéressante.</p><p>Lors de cette conférence, je parlerai des différentes possibilités offertes par la balise meta "viewport", et montrerait comme elle vous permettent de contrôler le comportement du zoom des navigateurs mobiles. Je ferai également le lien avec la proposition d'Opera nommée CSS Device Adaptation, qui apporte cette fonctionnalité aux CSS, sous la forme d'une règle @viewport.</p></div>
<div class="box clear">
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/andreas-bovens.php">Andreas Bovens</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Andreas Bovens" src="https://www.paris-web.fr/2011/assets_c/2011/07/andreas-bovens-thumb-143x143-131.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><div class="span-6" lang="en">
<p>
<a href="http://twitter.com/#!/andreasbovens/">Andreas</a> is based in Oslo, from where he heads up Opera Software's <a href="http://twitter.com/#!/odevrel/">Developer Relations & Tools team</a>. The team evangelizes open web standards through <a href="http://dev.opera.com/">publications</a> and conference presentations, takes care of product management of developer tools such as Opera Dragonfly and the <a href="http://www.opera.com/developer/tools/mobile/">Opera Mobile Emulator</a>, and focuses on solving compatibility issues so sites work well in all Opera products.
</p>
<p>
In a previous life, Andreas did a master in Japanese studies, researched Japanese copyright law at Meiji and Keio University, and was a <abbr>QA</abbr> engineer and web evangelist at Opera's Tokyo office. He loves espresso, and picks up his banjo from time to time.</p></div>
<div class="span-6 last" lang="fr">
<p>
<a href="http://twitter.com/#!/andreasbovens/">Andreas</a> est basé à Oslo, d'où il dirige l'équipe <a href="http://twitter.com/#!/odevrel/">Relations développeurs et Outils</a> d'Opera Software. L'équipe fait la promotion des standards ouverts du Web par le biais de <a href="http://dev.opera.com/">publications</a> et de présentations en conférence, s'occupe de la gestion d'outils de développement tels qu'Opera Dragonfly et l'<a href="http://www.opera.com/developer/tools/mobile/">émulateur Opera Mobile</a>, et se concentre sur la résolution de problèmes de compatibilité des sites afin qu'il fonctionnent correctement avec l'ensemble des produits de l'Opéra.
</p><p>
Dans une vie antérieure, Andreas a fait un master en japonais, des recherches sur le droit d'auteur japonais aux universités Meiji et Keio, et était ingénieur qualité et évangéliste Web au bureau à Tokyo Opera. Il aime le café expresso, et grattouille son banjo de temps à autres.</p>
</div></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/optimizing-your-layout-for-phones-and-tablets-using-viewport-and-media-queries.php&amp;ref=prez-optimizing-your-layout-for-phones-and-tablets&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
