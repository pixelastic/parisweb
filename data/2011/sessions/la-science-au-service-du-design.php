...
<title>Paris Web - Les neurosciences au service du design numérique</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/html5-apis-where-no-man-has-gone-before.php" title="HTML5 APIs: Where no man has gone before" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/petite-arithmetique-de-lux-choisir-renoncer-construire.php" title="Petite arithmétique de l’UX : choisir, renoncer, construire" />
	...
	<meta name="twitter:title" content="Les neurosciences au service du design numérique" />
	<meta property="twitter:description" content="Est-ce possible de construire l'engagement d'un utilisateur ? Les neurosciences au service du design numérique. Quelles techniques ont permis de générer 60% d'augmentation des taux de conversion chez…" />
	<meta property="dc:title" content="Les neurosciences au service du design numérique" />
	<meta property="og:title" content="Les neurosciences au service du design numérique" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/la-science-au-service-du-design.php" />
	<meta property="og:description" content="Est-ce possible de construire l'engagement d'un utilisateur ? Les neurosciences au service du design numérique. Quelles techniques ont permis de générer 60% d'augmentation des taux de conversion chez…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les neurosciences au service du design numérique</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-322">
						<header>
							<h1>Les neurosciences au service du design numérique</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xnd3m4?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb05_MarcVanRymenantDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-PA-05-MVanRymenant/neurosciences.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-322">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/la-science-au-service-du-design.php" class="url">Les neurosciences au service du design numérique</a></span></span></h2>
...
<dd class="column">
14 <abbr title="heures">h</abbr> 10
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Est-ce possible de construire l'engagement d'un utilisateur ?<br />
Les neurosciences au service du design numérique.</p>

<ul>
	<li>Quelles techniques ont permis de générer 60% d'augmentation des taux de conversion chez ING direct&nbsp;?</li>
<li>Quelles techniques ont permis d'augmenter le nombre de devis online de <abbr>MMA</abbr> de 120.000 unités en un an&nbsp;?</li>
<li>Quelles techniques ont permis de diminuer de 29% les appels intrusifs de eBay&nbsp;?</li>
</ul> 

<p>Cette conférence permettra de faire découvrir les techniques innovantes qui sont en coulisse de ces succès&nbsp;: une méthodologie centrée sur l'analyse des comportements humains, des techniques de pointes permettant de prédire objectivement les comportements des utilisateurs face aux écrans : analyses de l'activité cérébrale (est-ce que l'utilisateur comprend les écrans, est-ce que les zones de plaisir sont activées, est-ce que l'utilisateur connais déjà les informations présentées...), de l'activité oculaire... </p>

<blockquote>
<p>Le comportement humain devient un outil primordial pour réussir ses projets digitaux et atteindre ses propres objectifs.<br />
<strong>Eric Schmidt (CEO Google)</strong></p>
</blockquote></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/marc-van-rymenant.php">Marc Van Rymenant</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marc Van Rymenant" src="https://www.paris-web.fr/2011/assets_c/2011/07/marc-van-rymenant-thumb-143x143-162.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Je suis le fondateur d'une société créée en 1997, spécialisée en neuro-sciences appliquées aux médias digitaux. </p>

<p>Mon parcours est particulier. Pendant mes études comme Ingénieur Civil (Ingénieur des Mines en France), j'ai été confronté à la création d'un software pour une bibliothèque. Si notre solution a été retenue par le jury technique (nos professeurs, IBM, ...), le bibliothécaire, lui a préféré mettre en compétition les 4 solutions développées (dont la nôtre). Ses critères étaient simples : il allait choisir la solution la plus utilisée par les utilisateurs et celle lui créant le moins de support. </p>

<p>Verdict : nous avons perdu !!! Cela m'a pris la tête et j'ai commencé à étudier les sciences cognitives en parallele afin de comprendre ce phénomène. 10 ans plus tard, ma passion donnait naissance à <span lang="en">Netway</span>. La particularité de notre approche est de lier le scientifique au design afin de générer des résultats <span lang="en">business</span> concrets. </p>

<p>Nous avons introduit le <span lang="en">eyetracking</span> en Europe en 2000. Aujourd'hui nous complétons des mesures de <span lang="en">Advanced Eyetracking</span> par du <span lang="en">BrainTracking</span> (analyse de ce qui se passe dans le cerveau par l'intermédiaire de matériel IRM Fonctionnel).<br />
</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/la-science-au-service-du-design.php&amp;ref=prez-la-science-au-service-du-design&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
