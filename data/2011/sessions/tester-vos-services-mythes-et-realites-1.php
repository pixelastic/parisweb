...
<title>Paris Web - Tester vos services, mythes et réalités !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/l-accessibilite-vue-dun-grand-compte-et-comment-la-loi-de-2005-a-change-nos-facons-de-travaille.php" title="L’accessibilité vue d’un grand compte et comment la loi de 2005 a changé nos façons de travailler" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/lightning-talks.php" title="Lightning talks" />
	...
	<meta name="twitter:title" content="Tester vos services, mythes et réalités !" />
	<meta property="twitter:description" content="Le but de cette conférence est de faire le point sur les différentes méthodes d'évaluation des interfaces. Le point de départ est l'affirmation de Jakob Nielsen : 5 utilisateurs suffisent pour…" />
	<meta property="dc:title" content="Tester vos services, mythes et réalités !" />
	<meta property="og:title" content="Tester vos services, mythes et réalités !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/tester-vos-services-mythes-et-realites-1.php" />
	<meta property="og:description" content="Le but de cette conférence est de faire le point sur les différentes méthodes d'évaluation des interfaces. Le point de départ est l'affirmation de Jakob Nielsen : 5 utilisateurs suffisent pour…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Tester vos services, mythes et réalités !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-267">
						<header>
							<h1>Tester vos services, mythes et réalités !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xppgcn?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb29_RaphaelYharrassarry_Mythes_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/testervosservicesparisweb2011-111017025958-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-PA-08-RYharrassarry/tester_vos_services_mythes_et_realites.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-267">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/tester-vos-services-mythes-et-realites-1.php" class="url">Tester vos services, mythes et réalités !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/ergonomie" rel="tag">Ergonomie</a><br /><a href="http://www.paris-web.fr/2011/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le but de cette conférence est de faire le point sur les différentes méthodes d'évaluation des interfaces. Le point de départ est l'affirmation de Jakob Nielsen : <q>5 utilisateurs suffisent pour trouver 85 % des problèmes d’ergonomie</q>. Cette affirmation est souvent reprise en oubliant de préciser le contexte théorique qui date de 1993. Depuis les études sur le sujet, notamment une série d’études «&nbsp;<span lang="en">Comparative usability evaluation</span>&nbsp;» de Rolf Molich, ont été nombreuses ce qui permet de répondre à des questions comme : </p>

<ul>
	<li>Combien de participants sont nécessaires pour trouver le plus de problèmes critiques ?</li>
	<li>Peut-on trouver tous les problèmes ?</li>
	<li>Est ce qu’il y a des différences de qualités entre les résultats obtenus par les différentes méthodes ?</li>
</ul>

<p>Dans un deuxième temps, nous aborderons une partie pratique en répondant à la question : Quelle méthode à quel moment du projet ? La réponse est donc basée sur trois méthodologies "simples et élégantes" :</p>

<ol>
	<li>En début de projet : une méthode d'inspection des <abbr title="Interfaces homme machine">IHM</abbr> "à ma façon".</li>
	<li>En cours de projet : des tests utilisateurs.</li>
	<li>En fin de projet, pour valider la prise en main : Une méthodologie d'évaluation basée sur la norme ISO 20282 "Facilité d’emploi des produits quotidiens."</li>
</ol>

<p>Pour conclure, nous répondrons de manière précise à la question "Combien d’utilisateurs faut-il pour trouver 85 % des problèmes d’ergonomie ?" avec l'aide d'un outil statistique.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/raphael-yharrassarry.php">Raphaël Yharrassarry</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Yharrassarry" src="https://www.paris-web.fr/2011/assets_c/2011/07/raphael-thumb-143x143-160.jpg" width="143" height="143">
...
<p>Dans une volonté de formaliser, de partager et d'approfondir ces connaissances, il crée en 2009 un <a href="http://blocnotes.iergo.fr/">bloc-notes sur l'ergonomie</a> des <abbr title="Interfaces homme machine">IHM</abbr> et l'expérience utilisateur. Vous pouvez le suivre sur <a href="http://twitter.com/iergo">iErgo</a>.  </p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/tester-vos-services-mythes-et-realites-1.php&amp;ref=prez-tester-vos-services-mythes-et-realites-1&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
