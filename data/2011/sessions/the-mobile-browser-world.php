...
<title>Paris Web - The mobile browser world</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/pause-4.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/la-typo-mon-navigateur-et-moi.php" title="La typo, mon navigateur et moi" />
	...
	<meta name="twitter:title" content="The mobile browser world" />
	<meta property="twitter:description" content="In this presentation, PPK will describe the mobile browser world, its 10 to 15 important browsers, their relations, the difference between normal and proxy browsers, and how to go about deciding on a…" />
	<meta property="dc:title" content="The mobile browser world" />
	<meta property="og:title" content="The mobile browser world" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/the-mobile-browser-world.php" />
	<meta property="og:description" content="In this presentation, PPK will describe the mobile browser world, its 10 to 15 important browsers, their relations, the difference between normal and proxy browsers, and how to go about deciding on a…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>The mobile browser world</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-312">
						<header>
							<h1>The mobile browser world</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpqipc?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb31_PeterPaulKoch_Mobilebrowser_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/parisweb-111017093114-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-GA-03-PPKoch/the_mobile_browser_world.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-312">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/the-mobile-browser-world.php" class="url">The mobile browser world</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge">Traduction <abbr title="français">FR</abbr></span></dd>
    ...
    <div class="talk-description"><div lang="en" class="span-6"><p>In this presentation, <abbr>PPK</abbr> will describe the mobile browser world, its 10 to 15 important browsers, their relations, the difference between normal and proxy browsers, and how to go about deciding on a starting point for your mobile web endeavors. He'll try to make sense of a confusing ecosystem that web developers will need to learn to know better, and he will go way beyond just iPhone and Android.</p>
</div><div lang="fr" class="span-6 last"><p>Lors de cette présentation, <abbr>PPK</abbr> décrira le monde du mobile, ces 10 à 15 principaux navigateurs, leurs relations, les différences entre les navigateurs normaux et ceux fonctionnant par proxy, et expliquera comment s'y prendre pour choisir un point de départ pour vos efforts côté mobile. Il tentera donner du sens à l'écosystème confus que les développeurs web doivent apprendre à mieux connaître, et ira bien plus loin que les systèmes iPhone et Android.</p></div>
<div class="box clear">
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/peter-paul-koch.php">Peter-Paul Koch</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Peter-Paul Koch" src="https://www.paris-web.fr/2011/assets_c/2011/07/ppk-thumb-143x143-156.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><div lang="en" class="span-6">Peter-Paul Koch is a mobile platform strategist, consultant, and trainer in Amsterdam, the Netherlands. He specialises in <abbr>HTML</abbr>,<abbr>CSS</abbr>, JavaScript, and browser compatibility.

<p>He has won international renown with his browser compatibility <a href="http://www.quirksmode.org/compatibility.html" hreflang="en">research</a>, has founded <a href="http://fronteers.nl/" hreflang="en">Fronteers</a>, the Dutch association of front-end professionals, and advises mobile and desktop browser vendors on their implementation of Web standards.</p>

<p>In 2009 he shifted from traditional desktop browsers and sites to the mobile Web, and he never looked back. He discovered that mobile devices and browsers are in even more need of description than their desktop counterparts, and set himself to the task.</p>

<p>On the Web he is universally known as ppk.</p>

<p>He feels like Caesar when he talks about himself in the third person, but he will not conquer Gaul. More importantly, he will not write his memoirs in Latin.<br />
</div><div lang="fr" class="span-6 last">Peter-Paul Koch est stratège sur les plate-formes mobiles, consultant et formateur à Amsterdam, aux Pays-Bas. Il se spécialise dans les langages <abbr>HTML</abbr>, <abbr>CSS</abbr> et JavaScript, et la compatibilité des navigateurs.</p>

<p>Il a acquis une renommée internationale avec ses <a href="http://www.quirksmode.org/compatibility.html" hreflang="en">recherches</ a> sur la compatibilité des navigateurs, a fondé <a href="http://fronteers.nl/ hreflang="en">Fronteers</a>, l'association néerlandaise des professionnels du développement côté client, et conseille les éditeurs de navigateurs sur leur mise en œuvre des standards du Web.</p>

<p>En 2009, il a changé ses intérêt pour passer des navigateurs de bureau traditionnels à l'Internet mobile, et continue de s'y passionner. Il a découvert que les appareils mobiles et leurs navigateurs ont encore plus besoin d'un descriptif exhaustif que leurs contreparties traditionnelles, et s'est attelé à la tâche.</p>

<p>Sur le Web, il est connu de tous par l'acronyme PPK.</p>

<p>Il se sent un peu comme Jules César quand il parle de lui à la troisième personne, mais il ne cherche pas à conquérir la Gaule. Plus important encore, il ne compte pas écrire ses mémoires en latin.</div></p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/the-mobile-browser-world.php&amp;ref=prez-the-mobile-browser-world&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
