...
<title>Paris Web - HTML5 APIs: Where no man has gone before</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/repas-1.php" title="Déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/la-science-au-service-du-design.php" title="Les neurosciences au service du design numérique" />
	...
	<meta name="twitter:title" content="HTML5 APIs: Where no man has gone before" />
	<meta property="twitter:description" content="This talk aims to introduce you to the plethora of APIs HTML5 and related technologies offer us. Sure, HTML5 brings eye-candy and we'll look at that, but there's so much more to it when it comes to…" />
	<meta property="dc:title" content="HTML5 APIs: Where no man has gone before" />
	<meta property="og:title" content="HTML5 APIs: Where no man has gone before" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/html5-apis-where-no-man-has-gone-before.php" />
	<meta property="og:description" content="This talk aims to introduce you to the plethora of APIs HTML5 and related technologies offer us. Sure, HTML5 brings eye-candy and we'll look at that, but there's so much more to it when it comes to…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5 APIs: Where no man has gone before</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-242">
						<header>
							<h1>HTML5 APIs: Where no man has gone before</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xnd3c7?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb04_RobertNymanDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/html5apis-wherenomanhasgonebefore-parisweb-111013050140-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-GA-05-RNyman/HTML5_APIs.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-242">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/html5-apis-where-no-man-has-gone-before.php" class="url">HTML5 APIs: Where no man has gone before</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/html5" rel="tag">HTML5</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge">Traduction <abbr title="français">FR</abbr></span></dd>
    ...
    <div class="talk-description"><div class="span-6" lang="en"><p>This talk aims to introduce you to the plethora of <abbr>APIs</abbr> HTML5 and related technologies offer us. Sure, HTML5 brings eye-candy and we'll look at that, but there's so much more to it when it comes to building day-to-day web sites and web applications.</p></div>
<div class="span-6 last" lang="fr"><p>
<strong>Les <abbr>API</abbr> HTML5&nbsp;: là l'homme n'a jamais posé le pied</strong>. <br />
Cette présentation vise à vous initier à la pléthore d'<abbr title="Application programming interface">API</abbr> que HTML5 et les technologies connexes nous offrent. Bien sûr, <abbr title="HyperText Markup Language 5">HTML5</abbr> propose son lot d'apports purement esthétiques et nous allons les examiner, mais il y a tellement plus de choses à découvrir dès qu'il s'agit de parler de la conception de sites web au jour le jour, et d'applications web.</p>
</div>
<div class="box clear">
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/robert-nyman.php">Robert Nyman</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Robert Nyman" src="https://www.paris-web.fr/2011/assets_c/2011/07/robert-nyman-thumb-143x143-104.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><div class="span-6" lang="en">
Robert is a Technical Evangelist for Mozilla and a strong believer in <abbr title="HyperText Markup Language 5">HTML5</abbr> and the Open Web. He has been working since 1999 with Front End development for the web, in Sweden and in New York City, and was one of the Technical Editors (the JavaScript parts) for the book <a href="http://introducinghtml5.com/">Introducing HTML5</a>. Robert regularly blogs at <a href="http://robertnyman.com">http://robertnyman.com</a>, tweets as <a href="https://twitter.com/robertnyman">@robertnyman</a> and he loves to travel and meet people.
</div>
<div class="span-6 last">
Robert est <span lang="en">Technical Evangelist</span> chez Mozilla, et croit fermement en <abbr title="HyperText Markup Language 5">HTML5</abbr> et le Web ouvert. Il a travaillé depuis 1999 comme développeur front-end pour le Web, en Suède et à New York, et a été l'un des rédacteurs techniques (pour les parties JavaScript) du le livre <a href="http://introducinghtml5.com/">Introducing HTML5</a>. Robert écrit régulièrement sur son blog <a href="http://robertnyman.com">http://robertnyman.com</a>, tweete sous le nom de <a href="https://twitter.com/robertnyman">@robertnyman</a>, et aime voyager afin de rencontrer des gens.
</div></div>
</div>
