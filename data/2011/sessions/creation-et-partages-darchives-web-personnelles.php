...
<title>Paris Web - Création et partages d'archives Web personnelles</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/dejeuner.php" title="Déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/ateliers/stockage-anodin-de-donnees-personnelles-conciliez-legal-et-ethique.php" title="Stockage anodin de données personnelles : conciliez légal et éthique" />
	...
	<meta name="twitter:title" content="Création et partages d'archives Web personnelles" />
	<meta property="twitter:description" content="Les fameuses erreurs 404 et plus généralement les liens qui disparaissent sont un problème majeur pour tout site web qui cherche une certaine pérennité. S'il est difficile d'archiver tout le web, ce…" />
	<meta property="dc:title" content="Création et partages d'archives Web personnelles" />
	<meta property="og:title" content="Création et partages d'archives Web personnelles" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/ateliers/creation-et-partages-darchives-web-personnelles.php" />
	<meta property="og:description" content="Les fameuses erreurs 404 et plus généralement les liens qui disparaissent sont un problème majeur pour tout site web qui cherche une certaine pérennité. S'il est difficile d'archiver tout le web, ce…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Création et partages d'archives Web personnelles</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-223">
						<header>
							<h1>Création et partages d'archives Web personnelles</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-223">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/ateliers/creation-et-partages-darchives-web-personnelles.php" class="url">Création et partages d'archives Web personnelles</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/archivage" rel="tag">Archivage</a></dd>
    ...
    <div class="talk-description"><p>Les fameuses "erreurs 404" et plus généralement les liens qui disparaissent sont un problème majeur pour tout site web qui cherche une certaine pérennité. 
</p><p>
...
Dans cette présentation, je montrerai comment créer de telles archives "personnelles" et comment la fédération de ces archives pourraient conduire à un archivage du web qui, étant décentralisé, s’appuierait pleinement sur l'architecture du web.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/eric-van-der-vlist.php">Éric van der Vlist</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Éric van der Vlist" src="https://www.paris-web.fr/2011/assets_c/2011/07/eric-van-der-vlist-thumb-143x143-139.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Éric van der Vlist est un consultant indépendant. Il s'intéresse plus particulièrement aux techniques de mises en œuvre sur le web et son expertise en matière de technologies <abbr>XML</abbr> est reconnue au niveau mondial.
</p><p>
Créateur du site <a href="http://xmlfr.org">XMLfr</a>, il est également auteur de plusieurs livres consacrées à <abbr>XML</abbr> et au Web 2.0 publiés par O'Reilly et Wrox.
</p><p>
Éric est basé à Paris et vous pouvez le joindre par <a href="mailto:vdv@dyomedea.com">mail</a> ou le rencontrer dans une des nombreuses conférences auxquelles il participe&nbsp;!</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/ateliers/creation-et-partages-darchives-web-personnelles.php&amp;ref=prez-creation-et-partages-darchives-web-personnell&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
