...
<title>Paris Web - La Sagesse du Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/immediate-inspiration.php" title="Immediate Inspiration" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/ga-bu-zo-meu-ou-pourquoi-faire-simple-quand-on-peut-faire-complique.php" title="Ga, Bu, Zo, Meu, ou pourquoi faire simple quand on peut faire compliqué ?" />
	...
	<meta name="twitter:title" content="La Sagesse du Web" />
	<meta property="twitter:description" content="Le Web social est un domaine expérimental, émergeant où les valeurs humaines de base sont parfois facilement remplacées par des règles d'affaire peu intéressante pour l'usager. Je m'adresse à la fois…" />
	<meta property="dc:title" content="La Sagesse du Web" />
	<meta property="og:title" content="La Sagesse du Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/la-sagesse-du-web.php" />
	<meta property="og:description" content="Le Web social est un domaine expérimental, émergeant où les valeurs humaines de base sont parfois facilement remplacées par des règles d'affaire peu intéressante pour l'usager. Je m'adresse à la fois…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>La Sagesse du Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-227">
						<header>
							<h1>La Sagesse du Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpn6fc?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb27_SagesseWeb_CelineDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/lasagessewebvf-111013161521-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-PA-02-CCelines/la_sagesse_du_web.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-227">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/la-sagesse-du-web.php" class="url">La Sagesse du Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/metier" rel="tag">Métier</a><br /><a href="http://www.paris-web.fr/2011/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Le Web social est un domaine expérimental, émergeant où les valeurs humaines de base sont parfois facilement remplacées par des règles d'affaire peu intéressante pour l'usager.</p>

<p>Je m'adresse à la fois aux utilisateurs et aux créateurs de services Web. Les utilisateurs adoptent différents services qui occupent une grande partie de leur temps, cependant ces services sont très rarement conçus avec pour objectif de respecter le bien-être humain, ou de s'inscrire dans un écosystème de façon éthique. Très souvent ces services sont mit en ligne avec pour objectif de collectionner le maximum d'usagers, et d'occuper le maximum de leur temps en ligne sans pour autant prévoir faire de leur temps hors-ligne une expérience intéressante. À l'aide de métaphores et d'histoires modernes, je tente de sensibiliser les créateurs de services web à mieux comprendre comment le web fonctionne, et cela nous sert à notre avantage.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/celine-celines.php">Célinecélines</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Célinecélines" src="https://www.paris-web.fr/2011/assets_c/2011/07/celine-celines-thumb-143x143-171.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Célinecélines est une <span lang="en">designer</span> d'interaction, et architecte d'information. Elle a, par le passé, fait plusieurs métiers dans le domaine du web et eut un parcours artistique dans la vidéo numérique, les installations interactives et la performance. Son parcours a commencé en tant que <span lang="en">designer</span> visuel et artiste-vidéo. Son métier principal est le <span lang="en">design</span> cognitif et intuitif. Consultante en <span lang="en">design web</span> (petit écran et grand écran), elle est active au sein des <span lang="en">Creative Commons</span> (Montréal et Beirut).  Née au Liban, elle a grandi à Montréal, étudié à Paris, travaillé à New-York. De culture mixte et native du Web, le voyage et les cueillettes d'histoires lui servent à comprendre qui nous sommes. </p>

<p>Partisane des cultures libres et ouvertes, au sein des <span lang="en">Creative Commons International</span>, elle encourage le partage des connaissances. Elle s'intéresse à l'étude de l'Homme, anthropologue expérimentale elle est en quête de trouver des moyens de partager les idées, de saisir la culture et de la transmettre avec son langage particulier. Son expertise se trouve dans sa grande capacité à s'adapter partout où elle va, à capter la culture et le langage des villes ou des endroits au sein desquels elle évolue et participe. </p>

<p>Célinecélines a le don de garder son enthousiasme intact tout au long d'une réalisation, de mettre en ligne et de poursuivre l'étude d'un site ou d'un service avec une inlassable énergie contagieuse.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/la-sagesse-du-web.php&amp;ref=prez-la-sagesse-du-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
