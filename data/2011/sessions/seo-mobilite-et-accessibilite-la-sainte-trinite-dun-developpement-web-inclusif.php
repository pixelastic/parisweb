...
<title>Paris Web - SEO, mobilité et accessibilité : la sainte trinité d'un développement Web inclusif</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/html5-pour-lecriture-dapplications-cross-devices-challenges-et-solutions.php" title="HTML5 pour l’écriture d’applications cross-devices : challenges et solutions" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/pause-7.php" title="Pause" />
	...
	<meta name="twitter:title" content="SEO, mobilité et accessibilité : la sainte trinité d'un développement…" />
	<meta property="twitter:description" content="La mobilité est un enjeu qui révolutionne les pratiques actuelles de l'industrie du Web. L'optimisation pour les moteurs de recherche (SEO) occupe une place de choix dans les préoccupations des…" />
	<meta property="dc:title" content="SEO, mobilité et accessibilité : la sainte trinité d'un développement Web inclusif" />
	<meta property="og:title" content="SEO, mobilité et accessibilité : la sainte trinité d'un développement Web inclusif" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/seo-mobilite-et-accessibilite-la-sainte-trinite-dun-developpement-web-inclusif.php" />
	<meta property="og:description" content="La mobilité est un enjeu qui révolutionne les pratiques actuelles de l'industrie du Web. L'optimisation pour les moteurs de recherche (SEO) occupe une place de choix dans les préoccupations des…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>SEO, mobilité et accessibilité : la sainte trinité d'un développement Web inclusif</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-310">
						<header>
							<h1>SEO, mobilité et accessibilité : la sainte trinité d'un développement Web inclusif</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpi8vr?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb18_DenisBoudreau_mobiliteaccessibiliteDailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/seo-webmobile-accessibilite-parisweb-111027222422-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-GA-06-DBoudreau/SEO_mobilite_accessibilite.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-310">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/seo-mobilite-et-accessibilite-la-sainte-trinite-dun-developpement-web-inclusif.php" class="url">SEO, mobilité et accessibilité : la sainte trinité d'un développement Web inclusif</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/accessibilite" rel="tag">Accessibilité</a><br /><a href="http://www.paris-web.fr/2011/recherche/mobile" rel="tag">Mobile</a><br /><a href="http://www.paris-web.fr/2011/recherche/seo" rel="tag">SEO</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>La mobilité est un enjeu qui révolutionne les pratiques actuelles de l'industrie du Web. L'optimisation pour les moteurs de recherche (<abbr>SEO</abbr>) occupe une place de choix dans les préoccupations des responsables de sites Web, mais son caractère aléatoire en rebute plusieurs. Les standards d'accessibilité apportent une série de nouvelles préoccupations qui viennent non seulement supporter, mais aussi optimiser les pratiques de mobilité et de <abbr>SEO</abbr>. Lors de cette présentation, le conférencier invite à revisiter les bases pour établir plusieurs parallèles entre les trois pratiques. De l'exercice émerge une approche de développement où chacun y trouve son compte et ce, dans le meilleur intérêt de ceux pour qui sont développés les sites web : les utilisateurs finaux.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/denis-boudreau.php">Denis Boudreau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Denis Boudreau" src="https://www.paris-web.fr/2011/assets_c/2011/07/denis-boudreau-thumb-143x143-123.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Consultant, formateur et conférencier, Denis Boudreau est président de la Coopérative de solidarité AccessibilitéWeb, co-rédacteur des standards gouvernementaux d’accessibilité <abbr title="Standard du gouvernement du Québec sur les ressources informationnelles">SGQRI</abbr> 008 et expert invité du <abbr>W3C</abbr> au sein du <span lang="en">Education and Outreach Working Group</span> (EOWG) et de la <span lang="en">Accessibility Task Force</span> du <span lang="en">HTML5 Working Group</span> (HTMLWG). Dans ses temps libres, il agit comme vice-président communications du Groupe de travail sur les normes et standards en technologies de l’information pour l’apprentissage, l’éducation et la formation à distance (GTN-Québec) et comme président de Communautique, un organisme communautaire dont la mission est de soutenir la participation citoyenne en favorisant la maîtrise de l’information et l’appropriation des technologies de l’information et des communications.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/seo-mobilite-et-accessibilite-la-sainte-trinite-dun-developpement-web-inclusif.php&amp;ref=prez-seo-mobilite-et-accessibilite-la-sainte-trini&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
