...
<title>Paris Web - Tester l'ergonomie de son site même sans budget</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/optimizing-your-layout-for-phones-and-tablets-using-viewport-and-media-queries.php" title="Optimizing your layout for phones and tablets using viewport and media queries" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/je-veux-un-vrai-sous-titrage.php" title="Je veux un VRAI sous-titrage !" />
	...
	<meta name="twitter:title" content="Tester l'ergonomie de son site même sans budget" />
	<meta property="twitter:description" content="Faire des tests d'utilisabilité semble toujours être une pratique réservée aux grosses entreprises capables d'y allouer des budgets importants. Pourtant, même à petite échelle, il est possible de…" />
	<meta property="dc:title" content="Tester l'ergonomie de son site même sans budget" />
	<meta property="og:title" content="Tester l'ergonomie de son site même sans budget" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/tester-lutilisabilite-de-son-site-web-quand-on-na-pas-de-budget.php" />
	<meta property="og:description" content="Faire des tests d'utilisabilité semble toujours être une pratique réservée aux grosses entreprises capables d'y allouer des budgets importants. Pourtant, même à petite échelle, il est possible de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Tester l'ergonomie de son site même sans budget</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-299">
						<header>
							<h1>Tester l'ergonomie de son site même sans budget</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xo97x8?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/TesterErgonomieMauriceSvay.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/commenttesterlergonomiedesonsitememesansbudget-111012180308-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-PA-03-MSvay/tester_ergonomie_de_son_site_sans_buget.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-299">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/tester-lutilisabilite-de-son-site-web-quand-on-na-pas-de-budget.php" class="url">Tester l'ergonomie de son site même sans budget</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Faire des tests d'utilisabilité semble toujours être une pratique réservée aux grosses entreprises capables d'y allouer des budgets importants. Pourtant, même à petite échelle, il est possible de tester son site Web et d'obtenir des résultats intéressants. Cette présentation proposera un retour d'expérience sur les méthodes et outils peu coûteux à disposition.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/maurice-svay.php">Maurice Svay</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Maurice Svay" src="https://www.paris-web.fr/2011/assets_c/2011/07/maurice-thumb-143x143-119.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Designer pour le Web, Maurice jongle avec un crayon, Photoshop et le code pour créer des interfaces agréables et utilisables. Après avoir été Lead Designer chez Netvibes, il met ses compétences au service des transports écologiques chez <a href="http://www.covoiturage.fr">Covoiturage.fr</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/tester-lutilisabilite-de-son-site-web-quand-on-na-pas-de-budget.php&amp;ref=prez-tester-lutilisabilite-de-son-site-web-quand-o&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
