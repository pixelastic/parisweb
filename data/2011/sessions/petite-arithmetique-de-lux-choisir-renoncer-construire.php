...
<title>Paris Web - Petite arithmétique de l’UX : choisir, renoncer, construire</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/la-science-au-service-du-design.php" title="Les neurosciences au service du design numérique" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/un-navigateur-comment-ca-marche.php" title="Un navigateur, comment ça marche ?" />
	...
	<meta name="twitter:title" content="Petite arithmétique de l’UX : choisir, renoncer, construire" />
	<meta property="twitter:description" content="Le seul fait d’exister ne suffisant plus pour réussir, chaque service cherche à se démarquer auprès des usagers. Cette conférence abordera les perspectives données par la simplicité de l’expérience…" />
	<meta property="dc:title" content="Petite arithmétique de l’UX : choisir, renoncer, construire" />
	<meta property="og:title" content="Petite arithmétique de l’UX : choisir, renoncer, construire" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/petite-arithmetique-de-lux-choisir-renoncer-construire.php" />
	<meta property="og:description" content="Le seul fait d’exister ne suffisant plus pour réussir, chaque service cherche à se démarquer auprès des usagers. Cette conférence abordera les perspectives données par la simplicité de l’expérience…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Petite arithmétique de l’UX : choisir, renoncer, construire</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-302">
						<header>
							<h1>Petite arithmétique de l’UX : choisir, renoncer, construire</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpmom5?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb25_PetiteArithmetique_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/arithmetique-ux-final-120330143513-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-GA-06-NBenfedda_ABoucher/arithmetique-UX-final.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-302">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/petite-arithmetique-de-lux-choisir-renoncer-construire.php" class="url">Petite arithmétique de l’UX : choisir, renoncer, construire</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Le seul fait d’exister ne suffisant plus pour réussir, chaque service cherche à se démarquer auprès des usagers. Cette conférence abordera les perspectives données par la simplicité de l’expérience utilisateur. Mais comment parvenir à la simplicité&nbsp;? Peut-on seulement en décider&nbsp;?</p>

<p>Pour y répondre, nous évoquerons comment fournir un service tout en tenant compte des capacités attentionnelles des internautes et des contextes d’usage&nbsp;: comment trouver l’équilibre entre forme et fonction? S’agit-il seulement de supprimer des choses à l’écran&nbsp;? Comment satisfaire des usages novices tout en laissant place aux usages avancés&nbsp;? ...</p>

<p>Au final, théories et exemples illustrant les quelques dynamiques indispensables pour créer<br />
des services en ligne simples, qui respectent et pensent vraiment aux utilisateurs.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/nacera-benfedda.php">Nacéra Benfedda</a> et <a href="https://www.paris-web.fr/2011/../orateurs/amelie-boucher.php">Amélie Boucher</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Nacéra Benfedda" src="https://www.paris-web.fr/2011/assets_c/2011/07/nacera-benfadda-thumb-143x143-153.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Directrice produit de Viadeo, en charge de l'évolution du site.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Amélie Boucher" src="https://www.paris-web.fr/2011/assets_c/2011/07/amelie-boucher-thumb-143x143-145.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Ergonome et Architecte de l'information, Amélie Boucher conçoit et évalue des interfaces web et mobiles (e-commerce, éditorial, portails, outils ou encore applications métier). Suite à un Master d'ergonomie obtenu en 2003 à l'Université René Descartes (Paris Ⅴ), elle lance le site <a href="http://www.ergolab.net">www.ergolab.net</a>.</p>

<p>Toujours dans cette volonté de faire partager l'essence et la pratique de cette discipline, elle écrit en 2007 le livre "Ergonomie Web" ainsi que son mémento, puis plus récemment un ouvrage d'études de cas : "Ergonomie web illustrée", le tout aux éditions Eyrolles.</p>

<p>Elle dirige aujourd'hui l'Expérience Utilisateur chez Viadeo.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/petite-arithmetique-de-lux-choisir-renoncer-construire.php&amp;ref=prez-petite-arithmetique-de-lux-choisir-renoncer-c&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
