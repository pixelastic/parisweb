...
<title>Paris Web - Un navigateur, comment ça marche ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/petite-arithmetique-de-lux-choisir-renoncer-construire.php" title="Petite arithmétique de l’UX : choisir, renoncer, construire" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/pause-5.php" title="Pause" />
	...
	<meta name="twitter:title" content="Un navigateur, comment ça marche ?" />
	<meta property="twitter:description" content="On lui donne des milliers de lignes de code, on lui envoie plein de médias, on lui demande de faire le grand écart entre Wikipédia et une version web d'un OS. Et pourtant, on ne le connaît pas…" />
	<meta property="dc:title" content="Un navigateur, comment ça marche ?" />
	<meta property="og:title" content="Un navigateur, comment ça marche ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/un-navigateur-comment-ca-marche.php" />
	<meta property="og:description" content="On lui donne des milliers de lignes de code, on lui envoie plein de médias, on lui demande de faire le grand écart entre Wikipédia et une version web d'un OS. Et pourtant, on ne le connaît pas…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Un navigateur, comment ça marche ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-326">
						<header>
							<h1>Un navigateur, comment ça marche ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xp69td?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb14_Anthony Ricaud_DailyMotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/pres-111013051318-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/01-jeudi/JE-PA-06-ARicaud/un_navigateur_comment_ca_marche.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-326">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/un-navigateur-comment-ca-marche.php" class="url">Un navigateur, comment ça marche ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2011/recherche/navigateurs" rel="tag">Navigateurs</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>On lui donne des milliers de lignes de code, on lui envoie plein de médias, on lui demande de faire le grand écart entre Wikipédia et une version web d'un <abbr>OS</abbr>. Et pourtant, on ne le connaît pas vraiment alors qu'il est au centre de nos métiers.</p>

<p>Dans cette session, nous verrons un peu ce qui passe au cours de la vie d'une page web et comment les instructions que l'on donne à un navigateur sont transformées. On parlera sans doute de trafic réseau, de construction de la page à partir du <abbr>HTML</abbr>, d'interprétation des <abbr>CSS</abbr> et de rendu à l'écran, de modification de la page via JavaScript. Et peut-être verra-t-on Michel Chevalet…</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/anthony-ricaud.php">Anthony Ricaud</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Anthony Ricaud" src="https://www.paris-web.fr/2011/assets_c/2011/07/anthony-ricaud-thumb-143x143-146.jpg" width="143" height="143">
...
<p>De temps en temps, il blogue sur <a href="http://hanblog.info">http://hanblog.info</a>.</p>

<p>Cette biographie collective a été rédigée via <abbr>IRC</abbr> : irc.freenode.net ##openweb.<br />
</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/un-navigateur-comment-ca-marche.php&amp;ref=prez-un-navigateur-comment-ca-marche&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
