...
<title>Paris Web - HTML5 pour l’écriture d’applications cross-devices : challenges et solutions</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2011/conferences/javascript-as-a-programming-language.php" title="Javascript as a Programming Language" />
<link rel="next bookmark" href="https://www.paris-web.fr/2011/conferences/seo-mobilite-et-accessibilite-la-sainte-trinite-dun-developpement-web-inclusif.php" title="SEO, mobilité et accessibilité : la sainte trinité d'un développement Web inclusif" />
	...
	<meta name="twitter:title" content="HTML5 pour l’écriture d’applications cross-devices : challenges et…" />
	<meta property="twitter:description" content="HTML5 et ses amis CSS3 et SVG sont particulièrement intéressants à l’heure de la multiplication des périphériques (PC, tablettes et téléphones). En effet, 2 choix s’offrent aux développeurs pour…" />
	<meta property="dc:title" content="HTML5 pour l’écriture d’applications cross-devices : challenges et solutions" />
	<meta property="og:title" content="HTML5 pour l’écriture d’applications cross-devices : challenges et solutions" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2011/conferences/html5-pour-lecriture-dapplications-cross-devices-challenges-et-solutions.php" />
	<meta property="og:description" content="HTML5 et ses amis CSS3 et SVG sont particulièrement intéressants à l’heure de la multiplication des périphériques (PC, tablettes et téléphones). En effet, 2 choix s’offrent aux développeurs pour…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5 pour l’écriture d’applications cross-devices : challenges et solutions</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-303">
						<header>
							<h1>HTML5 pour l’écriture d’applications cross-devices : challenges et solutions</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xpluyp?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="http://videos.paris-web.fr/2011/ParisWeb24_DavidRousset_Dailymotion.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/html5devcrossdeviceparisweb-111017093008-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/2011/02-vendredi/VE-PA-06-DRousset/html5_ecriture_application_cross-devices.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-303">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2011/conferences/html5-pour-lecriture-dapplications-cross-devices-challenges-et-solutions.php" class="url">HTML5 pour l’écriture d’applications cross-devices : challenges et solutions</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2011/../orateurs/david-rousset.php">David Rousset</a></h2>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2011/conferences/html5-pour-lecriture-dapplications-cross-devices-challenges-et-solutions.php&amp;ref=prez-html5-pour-lecriture-dapplications-cross-devi&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
