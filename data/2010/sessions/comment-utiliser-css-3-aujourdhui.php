...
<title>Paris Web - CSS 3 aujourd’hui : quoi et comment ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/mettre-en-forme-texte-web.php" title="Mettre en forme un texte pour le web ? Facile !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/Internationalisation-du-front-end.php" title="Internationalisation du Front" />
	...
	<meta name="twitter:title" content="CSS 3 aujourd’hui : quoi et comment ?" />
	<meta property="twitter:description" content="La future norme CSS 3 apporte de magnifiques nouveaux outils aux web designers. Malheureusement tout est loin d'être standardisé, les fabricants de navigateurs commencent tout juste à l'implémenter…" />
	<meta property="dc:title" content="CSS 3 aujourd’hui : quoi et comment ?" />
	<meta property="og:title" content="CSS 3 aujourd’hui : quoi et comment ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/comment-utiliser-css-3-aujourdhui.php" />
	<meta property="og:description" content="La future norme CSS 3 apporte de magnifiques nouveaux outils aux web designers. Malheureusement tout est loin d'être standardisé, les fabricants de navigateurs commencent tout juste à l'implémenter…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>CSS 3 aujourd’hui : quoi et comment ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-127">
						<header>
							<h1>CSS 3 aujourd’hui : quoi et comment ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xgv2fe?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-127">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/comment-utiliser-css-3-aujourdhui.php" class="url">CSS 3 aujourd’hui : quoi et comment ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/css" rel="tag">CSS</a></dd>
    ...
    <div class="talk-description"><p>La future norme CSS 3 apporte de magnifiques nouveaux outils aux web designers. Malheureusement tout est loin d'être standardisé, les fabricants de navigateurs commencent tout juste à l'implémenter et les utilisateurs sont loin de tous utiliser un navigateur de dernière génération.</p>

<p>Et pourtant, malgré tous ces obstacles il est possible de commencer à utiliser CSS 3 dès aujourd'hui. Pendant cet atelier, je vous propose de voir ensemble concrètement ce qu'il est possible d'utiliser et comment cela peut être mis en œuvre.</p>

<div class="box">
<p class="last">
Pour suivre au mieux cet atelier il vous conseillé d'apporter votre ordinateur portable pour tester directement les techniques évoquées. 
</p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/jeremie-patonnier.php">Jérémie Patonnier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jérémie Patonnier" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur-jeremie-pattonier-thumb-143x143-65.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Responsable de l’équipe de développement Web de la Direction Internet France de BNP Paribas Personal Finance</p>

<p>Au sortir de ses études de communication, Jérémie a commencé sa carrière dans le Web en 2000 en temps que Web Designer. Il a tenu ce poste pendant 3 ans. Il a ensuite intégré une autre Web Agency en 2003 en temps qu’Intégrateur/Développeur, et est maintenant en charge de l’équipe de développement Web de BNP Paribas Personal Finance (anciennement Cetelem) depuis fin 2006. Il a volontairement fait évoluer son poste au travers des différentes facettes du métier Internet afin d’avoir une vue d’ensemble complète de la chaine de production Internet, de la conception à la mise en œuvre.</p></div>
</div>
