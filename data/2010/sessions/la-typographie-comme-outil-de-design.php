...
<title>Paris Web - La typographie comme outil de design</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/innover-de-9-a-5.php" title="Innover de 9 à 5" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/html5-cest-maintenant-ie6-inclus.php" title="HTML5 c’est maintenant (IE6 inclus)" />
	...
	<meta name="twitter:title" content="La typographie comme outil de design" />
	<meta property="twitter:description" content="Les webmasters, surtout les plus anciens, restent souvent persuadés qu'un site Web ne peut être composé qu'en Times ou en Arial. Parent pauvre du design sur Internet, la typographie ne fait que…" />
	<meta property="dc:title" content="La typographie comme outil de design" />
	<meta property="og:title" content="La typographie comme outil de design" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/la-typographie-comme-outil-de-design.php" />
	<meta property="og:description" content="Les webmasters, surtout les plus anciens, restent souvent persuadés qu'un site Web ne peut être composé qu'en Times ou en Arial. Parent pauvre du design sur Internet, la typographie ne fait que…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>La typographie comme outil de design</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-52">
						<header>
							<h1>La typographie comme outil de design</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xfpaqk?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-GA-01.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-52">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/la-typographie-comme-outil-de-design.php" class="url">La typographie comme outil de design</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/david-rault.php">David Rault</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="David Rault" src="https://www.paris-web.fr/2010/assets_c/2010/07/david-rault-thumb-143x143-10.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Graphiste, journaliste et photographe, David Rault devient directeur artistique au sein d'une agence de conception de sites Internet en 1995. Il voyage et travaille régulièrement entre Paris, New York et Tokyo jusqu'au début des années 2000, lorsqu'il devient enseignant en typographie à l'École supérieure d'art et de design (ESAD) d'Amiens, où il restera quatre ans. Parallèlement, il rédige des cours de typographie pour des écoles privées parisiennes, écrit régulièrement articles et critiques pour le journal Libération ou Amazon.fr, réalise le graphisme de dizaines de sites Internet pour le compte de la société Symbioz Design dont il est également le directeur, et il est invité à deux reprises au Festival international de la bande dessinée d'Angoulême pour participer à des conférences (dont une table ronde avec l'auteur Scott McCloud en 2000).</p>

<p>Également présentateur et animateur de conférences de presse dans plusieurs festivals de cinéma depuis 1999 (dont le Festival du film américain de Deauville et le Festival International de Marrakech), David Rault a réalisé trois courts-métrages dont Monde Extérieur en 2002, sur un scénario de Michel Houellebecq, avec Melvil Poupaud et Kad et Olivier. Il s'installe à Istanbul fin 2004, où il exerce la profession de directeur de création en freelance au sein d'une agence de branding et de packaging&nbsp;; il remporte le Bronze Award à Monaco lors de la cérémonie des Pentawards 2008, compétition annuelle internationale de design packaging.</p>

<p>Membre de l'Atypi (Association Typographique Internationale), son «&nbsp;Guide pratique de choix typographique&nbsp;» paraît en mars 2009 aux éditions Atelier Perrousseaux, dont il devient directeur de collection en avril de la même année. Il prépare actuellement un recueil de photographies et une monographie du typographe et affichiste Roger Excoffon, à paraitre tous deux courant 2011.</p></div>
</div>
