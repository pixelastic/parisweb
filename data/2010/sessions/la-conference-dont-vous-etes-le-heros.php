...
<title>Paris Web - La conférence dont vous êtes le héros</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/demystifying-the-ux-toolbox-creating-an-effective-framework.php" title="Demystifying the UX toolbox: creating an effective framework" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/remerciements.php" title="Remerciements" />
	...
	<meta name="twitter:title" content="La conférence dont vous êtes le héros" />
	<meta property="twitter:description" content="Le principe de la table ronde à Paris Web a fait long feu : cette année nous allons tenter d'inverser les rôles et de donner plus largement la parole à l'assistance. Cette conférence sera inventée en…" />
	<meta property="dc:title" content="La conférence dont vous êtes le héros" />
	<meta property="og:title" content="La conférence dont vous êtes le héros" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/la-conference-dont-vous-etes-le-heros.php" />
	<meta property="og:description" content="Le principe de la table ronde à Paris Web a fait long feu : cette année nous allons tenter d'inverser les rôles et de donner plus largement la parole à l'assistance. Cette conférence sera inventée en…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>La conférence dont vous êtes le héros</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-174">
						<header>
							<h1>La conférence dont vous êtes le héros</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xhh6sr?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-174">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/la-conference-dont-vous-etes-le-heros.php" class="url">La conférence dont vous êtes le héros</a></span></span></h2>
...
<abbr title="utc" class="dtstart"><!-- --></abbr>
    ...
    <div class="talk-description"><p>Le principe de la table ronde à Paris Web a fait long feu : cette année nous allons tenter d'inverser les rôles et de donner plus largement la parole à l'assistance.</p>

<p>Cette conférence sera inventée en direct avec vous. Ce sera l'occasion de poser des questions à la cantonade, de parler d'un sujet qui vous tient à cœur, de jeter une idée et de l'éprouver en groupe…</p></div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/la-conference-dont-vous-etes-le-heros.php&amp;ref=prez-la-conference-dont-vous-etes-le-heros&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
