...
<title>Paris Web - Un player vidéo accessible, si c’est possible !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/mini-conferences/building-usability-into-accessibility.php" title="Building usability into accessibility" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/le-web-un-metier-de-valeur.php" title="Le web, un métier de valeur" />
	...
	<meta name="twitter:title" content="Un player vidéo accessible, si c’est possible !" />
	<meta property="twitter:description" content="Un lecteur accessible se doit d’être utilisable par tous et dans tous les contextes tout en se conformant aux recommandations actuellement en vigueur, les WCAG 2.0. Cette mini conférence est un…" />
	<meta property="dc:title" content="Un player vidéo accessible, si c’est possible !" />
	<meta property="og:title" content="Un player vidéo accessible, si c’est possible !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/mini-conferences/un-player-video-accessible-si-cest-possible.php" />
	<meta property="og:description" content="Un lecteur accessible se doit d’être utilisable par tous et dans tous les contextes tout en se conformant aux recommandations actuellement en vigueur, les WCAG 2.0. Cette mini conférence est un…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Un player vidéo accessible, si c’est possible !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-109">
						<header>
							<h1>Un player vidéo accessible, si c’est possible !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggpuq?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-PA-06.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-109">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/mini-conferences/un-player-video-accessible-si-cest-possible.php" class="url">Un player vidéo accessible, si c’est possible !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/accessibilite" rel="tag">Accessibilité</a></dd>
    ...
    <div class="talk-description"><p>Un lecteur accessible se doit d’être utilisable par tous et dans tous les contextes tout en se conformant aux recommandations actuellement en vigueur, les WCAG 2.0.</p>

<p>Cette mini conférence est un retour d'expérience sur notre démarche, en interne chez France Télécom, de développement et mise en place d'un lecteur vidéo accessible.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/vincent-aniort.php">Vincent Aniort</a> et <a href="https://www.paris-web.fr/2010/../orateurs/david-molina.php">David Molina</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Vincent Aniort" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_vincent-aniort-thumb-143x143-70.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Tombé dedans très tôt, suite à des études de biochimie (comme quoi !), il a tout fait : premier site « pro » en 1996 avec <span lang="en">Notepad</span>, monte, comme on disait à l’époque, une agence de communication multimédia, travaille en <span lang="en">free-lance</span> comme intégrateur, développeur, chef de projet, formateur…</p>

<p>Un accident de la vie le pousse à faire le « choix » d’un web accessible. Dès lors, suite à son diplôme universitaire Accessibilité des sites Web pour les personnes handicapées : Expert AccessiWeb , Université Pierre et Marie Curie (Paris <abbr title="6">&#8549;</abbr>) en 2005-2006, il fait aussi de l’assistance à maîtrise d’ouvrage, évaluation et mise en accessibilité…</p>

<p>Il n’y a que travailler dans une grosse boîte qu’il n’avait pas fait !<br />
Eh bien depuis trois ans c’est chose faite chez France Télécom – Orange, en tant que chef de projet en accessibilité.<br />
Il participe, en 2009, à la première traduction autorisée des <abbr>WCAG</abbr> 2.0 (en Français) pour le compte de l’<abbr title="Association des Paralysés de France,">APF</abbr>, association pour laquelle il milite ardemment !</p>

<p>Son boulot reste toujours un plaisir et une passion dont il parle volontiers !</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="David Molina" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_david-molina-thumb-143x143-71.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Issu de la première promotion des «&nbsp;experts Accessiweb en évaluation&nbsp;», il est intervenu dans différentes entreprises pour auditer, conseiller et pérenniser des solutions accessibles.</p>

<p>Toujours soucieux de partager ses expériences, il a animé des séminaires sur diverses thématiques telles que : «&nbsp;Les enjeux de l'accessibilité, l'expérience France Telecom&nbsp;», «&nbsp;Maintenance de site Web&nbsp;» ou «&nbsp;Développement Web Front Office&nbsp;».</p>

<p>David a passé dix années chez SQLI Paris puis Toulouse en tant qu'intégrateur, ergonome, chef de projet puis responsable de l'offre Agency (design, ergonomie, intégration). Il est actuellement expert accessibilité et ergonomie chez France Telecom.</p></div>
</div>
