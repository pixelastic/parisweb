...
<title>Paris Web - Les erreurs les plus fréquentes en accessibilité du Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/repas-4.php" title="repas" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/tirer-parti-des-peripheriques-mobiles-dans-une-application-web-qui-a-dit-quil-fallait-coder-plusieur.php" title="Tirer parti des périphériques mobiles dans une application web : qui a dit qu’il fallait coder plusieurs versions natives ?" />
	...
	<meta name="twitter:title" content="Les erreurs les plus fréquentes en accessibilité du Web" />
	<meta property="twitter:description" content="Certains prétendent que les sites Web se suivent, mais ne se ressemblent pas. Mais est-ce bien le cas? Au cours des sept dernières années, l'équipe d'AccessibilitéWeb a réalisé plus de 850 audits,…" />
	<meta property="dc:title" content="Les erreurs les plus fréquentes en accessibilité du Web" />
	<meta property="og:title" content="Les erreurs les plus fréquentes en accessibilité du Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/les-erreurs-les-plus-frequentes-en-accessibilite-du-web.php" />
	<meta property="og:description" content="Certains prétendent que les sites Web se suivent, mais ne se ressemblent pas. Mais est-ce bien le cas? Au cours des sept dernières années, l'équipe d'AccessibilitéWeb a réalisé plus de 850 audits,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les erreurs les plus fréquentes en accessibilité du Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-43">
						<header>
							<h1>Les erreurs les plus fréquentes en accessibilité du Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh3hj4?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-43">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/les-erreurs-les-plus-frequentes-en-accessibilite-du-web.php" class="url">Les erreurs les plus fréquentes en accessibilité du Web</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/denis-boudreau.php">Denis Boudreau</a></h2>
