...
<title>Paris Web - Internautes sous surveillance : retours de la réalité pour un web meilleur</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/la-conception-universelle-est-ce-toujours-possible.php" title="La conception universelle, est-ce toujours possible ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/le-javascript-server-side-faire-un-point.php" title="Le javascript server side, faire un point" />
	...
	<meta name="twitter:title" content="Internautes sous surveillance : retours de la réalité pour un web…" />
	<meta property="twitter:description" content="La conception web est encore aujourd'hui largement menée entre experts, considérant qu'il suffit de notre propre expérience d'internautes pour savoir se mettre à la place de nos utilisateurs. Bien…" />
	<meta property="dc:title" content="Internautes sous surveillance : retours de la réalité pour un web meilleur" />
	<meta property="og:title" content="Internautes sous surveillance : retours de la réalité pour un web meilleur" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/internautes-sous-surveillance-retours-de-la-realite-pour-un-web-meilleur.php" />
	<meta property="og:description" content="La conception web est encore aujourd'hui largement menée entre experts, considérant qu'il suffit de notre propre expérience d'internautes pour savoir se mettre à la place de nos utilisateurs. Bien…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Internautes sous surveillance : retours de la réalité pour un web meilleur</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-49">
						<header>
							<h1>Internautes sous surveillance : retours de la réalité pour un web meilleur</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggsab?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-GA-02.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-49">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/internautes-sous-surveillance-retours-de-la-realite-pour-un-web-meilleur.php" class="url">Internautes sous surveillance : retours de la réalité pour un web meilleur</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ergonomie" rel="tag">Ergonomie</a><br /><a href="http://www.paris-web.fr/2010/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>La conception web est encore aujourd'hui largement menée entre experts, considérant qu'il suffit de notre propre expérience d'internautes pour savoir se mettre à la place de nos utilisateurs. Bien sûr, la réalité est toute autre et démontre à chaque détour de site web la méconnaissance des attentes et usages des internautes. Et pour cause! Il est quasi-impossible d'atteindre un bon niveau d'ergonomie sans leur aide.</p>

<p>Une expérience utilisateur réussie passant nécessairement par une confrontation au réel, nous verrons donc comment mener l'enquête pour guider un projet web et repérer ses points d'accroche.</p>

<p>Nous verrons aussi à travers les exemples présentés que ce que l’on peut prendre pour du détail impacte fortement l’expérience vécue des utilisateurs. Un bon prétexte pour revoir quelques règles essentielles d'ergonomie des pages web !</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/amelie-boucher.php">Amélie Boucher</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Amélie Boucher" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_amelie-boucher-2-thumb-143x143-33.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Consultante en Ergonomie et Architecture de l'information, Amélie Boucher conçoit et évalue des interfaces web et mobiles (e-commerce, éditorial, portails, outils ou encore applications métier). Suite à un Master d'ergonomie obtenu en 2003 à l'Université René Descartes (Paris <abbr title="5">&#8548;</abbr>), elle lance le site <a href="http://www.ergolab.net/">www.ergolab.net</a>.</p>

<p>Toujours dans cette volonté de faire partager l'essence et la pratique de cette discipline, elle écrit en 2007 le livre Ergonomie Web ainsi que son mémento (aux éditions Eyrolles), et participe régulièrement à des conférences pour diffuser la bonne parole.</p>

<p>Elle dirige aujourd'hui le pôle Ergonomie de l'agence Altima.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/internautes-sous-surveillance-retours-de-la-realite-pour-un-web-meilleur.php&amp;ref=prez-internautes-sous-surveillance-retours-de-la-r&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
