...
<title>Paris Web - Espace construit et espace virtuel, un retour vers le futur ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/introduction-pa.php" title="Introduction" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/la-conception-universelle-est-ce-toujours-possible.php" title="La conception universelle, est-ce toujours possible ?" />
	...
	<meta name="twitter:title" content="Espace construit et espace virtuel, un retour vers le futur ?" />
	<meta property="twitter:description" content="À l’heure du développement à marche forcée des réseaux sociaux sur le web, peut‑être serait‑il opportun d’analyser les erreurs et les solutions apportées par notre environnement immédiat afin de ne…" />
	<meta property="dc:title" content="Espace construit et espace virtuel, un retour vers le futur ?" />
	<meta property="og:title" content="Espace construit et espace virtuel, un retour vers le futur ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/le-web-lespace-public.php" />
	<meta property="og:description" content="À l’heure du développement à marche forcée des réseaux sociaux sur le web, peut‑être serait‑il opportun d’analyser les erreurs et les solutions apportées par notre environnement immédiat afin de ne…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Espace construit et espace virtuel, un retour vers le futur ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-80">
						<header>
							<h1>Espace construit et espace virtuel, un retour vers le futur ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh6vuv?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu_PA_01.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-80">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/le-web-lespace-public.php" class="url">Espace construit et espace virtuel, un retour vers le futur ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>À l’heure du développement à marche forcée des réseaux sociaux sur le web, peut‑être serait‑il opportun d’analyser les erreurs et les solutions apportées par notre environnement immédiat afin de ne pas répéter l’histoire ? Dans cette optique, Fabien Basmaison dressera un parallèle entre les développements urbains et architecturaux, et les développements possibles du web en tant qu’espace public.</p>

<p>S’adapter aux contraintes d’un projet en répondant rapidement à des problématiques locales, travailler sur l’existant et l’améliorer progressivement en fonction des retours de ses utilisateurs, favoriser les flux de déplacement en permettant à tous de circuler librement (sans pour autant déplacer le problème), participation active nécessaire de tous les acteurs… Les analogies ne manquent pas.</p>

<p>S’arrêter pour s’orienter, simplement…</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/fabien-basmaison.php">Fabien Basmaison</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Fabien Basmaison" src="https://www.paris-web.fr/2010/assets_c/2010/07/fabien-thumb-143x143-31.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Fabien Basmaison est architecte diplômé de l’<a href="http://www.toulouse.archi.fr/fr/"><abbr title="École nationale supérieure d'architecture de Toulouse">ENSAT</abbr></a> au sein de laquelle il collabore avec les chercheurs du <a href="http://w3.toulouse.archi.fr/li2a/"><abbr title="Laboratoire d'informatique appliquée à l'architecture">Li2a</abbr></a> durant ses études. Il développe depuis toujours un lien permanent avec les technologies numériques et navigue donc entre les deux mondes en permanence, notamment comme membre de <a href="http://www.pompage.net/">pompage</a> ou ancien membre de <a href="http://www.paris-web.fr/">Paris‑Web</a>.</p>

<p>En 2006, il décide de migrer vers la Chine afin de relever le challenge le plus fou qui soit – ou plus probablement sur une crise de folie qui dure depuis : introduire les standards du web dans l’Internet chinois.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/le-web-lespace-public.php&amp;ref=prez-le-web-lespace-public&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
