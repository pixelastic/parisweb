...
<title>Paris Web - Tirer parti des périphériques mobiles dans une application web : qui a dit qu’il fallait coder plusieurs versions natives ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/les-erreurs-les-plus-frequentes-en-accessibilite-du-web.php" title="Les erreurs les plus fréquentes en accessibilité du Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/comment-convaincre-un-client-de-la-qualite-de-votre-prestation.php" title="Comment convaincre un client de la qualité de votre prestation ?" />
	...
	<meta name="twitter:title" content="Tirer parti des périphériques mobiles dans une application web : qui…" />
	<meta property="twitter:description" content="Le web mobile est en train d&#8217;exploser, d&#8217;autant que les principaux périphériques proposent désormais de « vrais » navigateurs, de l&#8217;iPhone à Androïd, de Mimo à PalmOS, et même les…" />
	<meta property="dc:title" content="Tirer parti des périphériques mobiles dans une application web : qui a dit qu’il fallait coder plusieurs versions natives ?" />
	<meta property="og:title" content="Tirer parti des périphériques mobiles dans une application web : qui a dit qu’il fallait coder plusieurs versions natives ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/tirer-parti-des-peripheriques-mobiles-dans-une-application-web-qui-a-dit-quil-fallait-coder-plusieur.php" />
	<meta property="og:description" content="Le web mobile est en train d&#8217;exploser, d&#8217;autant que les principaux périphériques proposent désormais de « vrais » navigateurs, de l&#8217;iPhone à Androïd, de Mimo à PalmOS, et même les…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Tirer parti des périphériques mobiles dans une application web : qui a dit qu’il fallait coder plusieurs versions natives ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-47">
						<header>
							<h1>Tirer parti des périphériques mobiles dans une application web : qui a dit qu’il fallait coder plusieurs versions natives ?</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-47">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/tirer-parti-des-peripheriques-mobiles-dans-une-application-web-qui-a-dit-quil-fallait-coder-plusieur.php" class="url">Tirer parti des périphériques mobiles dans une application web : qui a dit qu’il fallait coder plusieurs versions natives ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/javascript" rel="tag">JavaScript</a><br /><a href="http://www.paris-web.fr/2010/recherche/technologie" rel="tag">Technologie</a></dd>
    ...
    <div class="talk-description"><p>Le web mobile est en train d&#8217;exploser, d&#8217;autant que les principaux périphériques proposent désormais de « vrais » navigateurs, de l&#8217;iPhone à Androïd, de Mimo à PalmOS, et même les nouveaux Blackberry.</p>

<p>S&#8217;il est déjà bien d&#8217;exploiter des feuilles de style mobiles pour adapter l&#8217;expérience utilisateur, on souhaite souvent accéder aux capacités du périphérique (géolocalisation, vibreur, accéléromètre…) et offrir une expérience globale aussi « native » que possible.</p>

<p>Il n&#8217;est pas pour autant nécessaire de développer des versions natives distinctes ! Des <span lang="en">frameworks</span> existent pour un déploiement universel, et cerise sur le gâteau : ça se passe en JavaScript !</p>

<p>Cet atelier vous fera faire un tour d&#8217;horizon des principaux <span lang="en">frameworks</span> actifs, exemples et démonstrations à l&#8217;appui.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/christophe-porteneuve.php">Christophe Porteneuve </a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Christophe Porteneuve " src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_christophe-porteneuve-thumb-143x143-67.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Christophe Porteneuve est un accro des standards depuis 2000, de Ruby depuis 2005, de Mac et Paris-Web depuis 2006 et du web mobile depuis 2008. Auteur de plusieurs ouvrages de référence autour de JavaScript, contributeur à Prototype, directeur technique de l'agence Ciblo et président 2008-2009 de Paris-Web, il adore le JavaScript avancé, HTML5, Canvas, WebGL, les effets basés CSS accélérés par le matériel, les graphes interactifs en SVG et les applications web qui sont aux petits soins avec les périphériques mobiles.</p>

<p>Il vit à Paris avec sa femme Élodie.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/tirer-parti-des-peripheriques-mobiles-dans-une-application-web-qui-a-dit-quil-fallait-coder-plusieur.php&amp;ref=prez-tirer-parti-des-peripheriques-mobiles-dans-un&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
