...
<title>Paris Web - Méthode Daisy : les CSS feuille à feuille</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/mini-conferences/estimer-laccessibilite-de-son-site-15-minutes-top-chrono.php" title="Estimer l’accessibilité de son site, 15 minutes top chrono !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/mini-conferences/le-kit-de-ux-pour-standardiser-les-documents-de-conception-et-simplifier-la-communication-entre-les-.php" title="Le Kit documentaire de conception pour simplifier la communication projet" />
	...
	<meta name="twitter:title" content="Méthode Daisy : les CSS feuille à feuille" />
	<meta property="twitter:description" content="Produire l'habillage CSS d'un site en équipe est souvent galère. Sans être obligé d'adopter un framework et devoir former tous les intégrateurs sur ce moule, on peut déjà mettre un peu de méthode en…" />
	<meta property="dc:title" content="Méthode Daisy : les CSS feuille à feuille" />
	<meta property="og:title" content="Méthode Daisy : les CSS feuille à feuille" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/mini-conferences/methode-daisy-les-css-feuille-a-feuille.php" />
	<meta property="og:description" content="Produire l'habillage CSS d'un site en équipe est souvent galère. Sans être obligé d'adopter un framework et devoir former tous les intégrateurs sur ce moule, on peut déjà mettre un peu de méthode en…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Méthode Daisy : les CSS feuille à feuille</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-105">
						<header>
							<h1>Méthode Daisy : les CSS feuille à feuille</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh699t?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/daisy-101020152642-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-PA-05.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-105">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/mini-conferences/methode-daisy-les-css-feuille-a-feuille.php" class="url">Méthode Daisy : les CSS feuille à feuille</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/css" rel="tag">CSS</a></dd>
    ...
    <div class="talk-description"><p>Produire l'habillage CSS d'un site en équipe est souvent galère. Sans être obligé d'adopter un framework et devoir former tous les intégrateurs sur ce moule, on peut déjà mettre un peu de méthode en répartissant le code en différentes feuilles de styles conventionnelles, indépendantes et interchangeables. De cette façon, elles sont aussi ré-utilisables d'un site à l'autre, ce qui permet de capitaliser plutôt que de tout recommencer à chaque projet.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/romy-duhem-verdiere.php">Romy Duhem Verdière</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Romy Duhem Verdière" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_romy-thumb-143x143-69.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Développeuse web front, elle contribue depuis 5 ans au développement collaboratif d'un outil libre de publication web. Elle recherche toujours le meilleur compromis entre les contraintes de production qui réclament une efficacité immédiate et la ré-employabilité du code entre les différents intervenants, à travers le temps et dans un but de redistribution.</p>

<p>Elle documente et partage ses réflexions sur <a href="http://romy.tetue.net/">son blog</a> depuis 1999 et, quand elle ne code pas, elle cuisine les légumes oubliés et en régale autant ses convives que les internautes.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/mini-conferences/methode-daisy-les-css-feuille-a-feuille.php&amp;ref=prez-methode-daisy-les-css-feuille-a-feuille&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
