...
<title>Paris Web - Méthodologie du Design d’expérience utilisateur</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/reusable-code-for-good-or-for-awesome.php" title="Reusable Code, for good or for awesome!" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/css3-photoshop-avenir-web-designer.php" title="CSS3/Photoshop : quel avenir pour le métier de web designer ? " />
	...
	<meta name="twitter:title" content="Méthodologie du Design d’expérience utilisateur" />
	<meta property="twitter:description" content="Le Design d'expérience utilisateur est une pratique de conception globale pour le web. De nombreux professionnels du web l'utilisent quotidiennement pour la conception de leurs projets et la font…" />
	<meta property="dc:title" content="Méthodologie du Design d’expérience utilisateur" />
	<meta property="og:title" content="Méthodologie du Design d’expérience utilisateur" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/methodologie-du-design-dexperience-utilisateur.php" />
	<meta property="og:description" content="Le Design d'expérience utilisateur est une pratique de conception globale pour le web. De nombreux professionnels du web l'utilisent quotidiennement pour la conception de leurs projets et la font…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Méthodologie du Design d’expérience utilisateur</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-68">
						<header>
							<h1>Méthodologie du Design d’expérience utilisateur</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggtmo?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/ux-methode-parisweb-v3-101015023419-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-PA-08.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-68">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/methodologie-du-design-dexperience-utilisateur.php" class="url">Méthodologie du Design d’expérience utilisateur</a></span></span></h2>
...
<dd class="column">
16 <abbr title="heures">h</abbr> 05
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>Le Design d'expérience utilisateur est une pratique de conception globale pour le web. De nombreux professionnels du web l'utilisent quotidiennement pour la conception de leurs projets et la font ainsi évoluer collectivement depuis 15 ans. Des dizaines d'ouvrages, de conférences et de séminaires sont proposés chaque année sur le sujet, enrichissant ainsi progressivement sa pratique et son approche méthodologique. Aujourd'hui, le Design d'expérience utilisateur est utilisé par tous les concepteurs web, qu'ils soient designers indépendants, intégrés à une agence digitale ou engagés dans une aventure entrepreneuriale.</p>

<p>Le but de cette conférence est de donner une vision synthétique – structurée en 5 étapes – de la méthodologie du Design d'expérience utilisateur :</p>

<ol>
<li>Découverte : recherches utilisateurs, personas, benchmark…</li>
<li>Concept : génération d'idées, esquisses, modélisation de la stratégie…</li>
<li>Organisation : périmètre fonctionnel, management des contenus, organisation de site…</li>
<li>Design : architecture d'information, design d'interaction, prototypes…</li>
<li>Suivi : gestion des livrables et de la documentation, suivi du production…</li>
</ol>

<p>Cette conférence est destinée à toutes les personnes, débutantes ou expérimentées, impliquées dans la conception et la production de solutions digitales.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/matthieu-mingasson.php">Matthieu Mingasson</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Matthieu Mingasson" src="https://www.paris-web.fr/2010/assets_c/2010/07/Matthieu_Mingasson-thumb-143x143-17.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Matthieu Mingasson dirige le département du design d'expérience utilisateur chez Ogilvy Interactive depuis janvier 2007 et est intervenant à l'Ecole de l'Image des Gobelins.</p>

<p>Il a débuté sa carrière dans les années 80 dans la presse grand public, tout d'abord au sein du magazine Rolling Stone, puis du Nouvel Observateur, de Challenges. Il s'est consacré ensuite à la presse d'entreprise en tant que Directeur artistique pour l'agence Textuel, au sein de laquelle il a affirmé son goût de la structuration de l'information. A partir du milieu des années 90, il s'est consacré exclusivement à la réalisation conceptuelle, technique et informationnelle de nombreux projets web (Witness, VNU, Agefi, Skai.gr, Oreillyschool...). Depuis 2007, il développe le département d'expérience utilisateur au sein d'Ogilvy au service de grands comptes (Nestlé, Mattel, IBM, Vuitton, LVMH, AutoDistribution…).</p>

<p>Matthieu Mingasson est membre de l'Information Architecture Institute.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/methodologie-du-design-dexperience-utilisateur.php&amp;ref=prez-methodologie-du-design-dexperience-utilisateu&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
