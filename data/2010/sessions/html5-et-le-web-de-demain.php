...
<title>Paris Web - HTML5 et le web de demain</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/laccessibilite-dans-une-chaine-de-production-web.php" title="L’accessibilité dans une chaîne de production Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/pause.php" title="pause" />
	...
	<meta name="twitter:title" content="HTML5 et le web de demain" />
	<meta property="twitter:description" content="L'arrivée progressive d'HTML5 et des nombreuses technologies qui l'accompagnent ouvre la voie à un usage du Web permettant la création d'applications Web aux fonctionnalités poussées. Le Web de…" />
	<meta property="dc:title" content="HTML5 et le web de demain" />
	<meta property="og:title" content="HTML5 et le web de demain" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/html5-et-le-web-de-demain.php" />
	<meta property="og:description" content="L'arrivée progressive d'HTML5 et des nombreuses technologies qui l'accompagnent ouvre la voie à un usage du Web permettant la création d'applications Web aux fonctionnalités poussées. Le Web de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5 et le web de demain</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-84">
						<header>
							<h1>HTML5 et le web de demain</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xhavgn?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu_GA_05.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-84">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/html5-et-le-web-de-demain.php" class="url">HTML5 et le web de demain</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/html5" rel="tag">HTML5</a></dd>
    ...
    <div class="talk-description"><p>L'arrivée progressive d'HTML5 et des nombreuses technologies qui l'accompagnent ouvre la voie à un usage du Web permettant la création d'applications Web aux fonctionnalités poussées.</p>

<p>Le Web de demain n'est plus celui d'une interface graphique limitée. Le déploiement de CSS3, la possibilité d'utiliser enfin ses propres polices de caractères, le support des balises &lt;canvas&gt; et &lt;video&gt;, et l'arrivée tant attendue de SVG sur l'ensemble des navigateurs laissent le champ entièrement libre à l'imagination.</p>

<p>Fini aussi le temps du clic et du formulaire pour seules interactions possibles. Les APIs permettant une intégration plus forte avec le terminal de l'utilisateur (géolocalisation, accéléromètre) ou avec les données de l'utilisateur (calendrier, liste de contacts), aujourd'hui encore l'apanage des applications natives, feront partie intégrante de l'expérience Web de demain, forcément mobile&nbsp;!</p>

<p>La possibilité d'exécuter les applications Web dans un contexte local, sous forme de widgets ou d'applications "offlines", permettront de gommer les dernières différences entre les applications natives d'aujourd'hui et les applications Web de Demain, tout en offrant quelques éléments de réponse aux problèmes de sécurité et de respect de la vie privée de l'utilisateur.</p>

<p>Nous nous proposons de passer en revue ces différentes avancées, qui convertiront bon nombre de développeurs/intégrateurs Web d'aujourd'hui en développeurs d'applications de demain.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/robin-berjon.php">Robin Berjon</a>, <a href="https://www.paris-web.fr/2010/../orateurs/dominique-hazael-massieux.php">Dominique Hazael-Massieux</a> et <a href="https://www.paris-web.fr/2010/../orateurs/francois-daoust.php">François Daoust</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Robin Berjon" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_robin_berjon-thumb-143x143-36.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Robin Berjon est depuis longtemps passionné par les standards ouverts et l'Open Source. Il a contribué de diverses façons à bon nombre de groupes et de spécifications dans les domaines Web et XML, ainsi qu'à divers projets autour de Perl et Javascript. Quand il ne vend pas ses services de consultant indépendant, il lit, écrit, et se fait mordre par son chat ou piétiner par sa fille.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Dominique Hazael-Massieux" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_dominique_hazael_massieux-thumb-143x143-40.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Dom travaille au W3C depuis 10 ans, où il est, entre autres choses, Responsable de l’activité Web Mobile du W3C, et co-auteur (avec François Daoust) d’un livre sur le Web mobile à paraître.</p>

<p>Il pratique aussi le développement d’applications Web pour le W3C, ce qui lui permet de garder un point de vue pragmatique sur la mise en application des technologies qu’il contribue à standardiser.</p>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="François Daoust" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_francois_daoust-thumb-143x143-38.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>François Daoust a passé sept années dans l'ambiance feutrée d'une start-up à développer un moteur de recherche destiné aux opérateurs de réseaux mobiles. Cette aventure l'a mené sur le campus de Microsoft, d'où il a rejoint le W3C en décembre 2007.</p>

<p>Il passe désormais son temps à réconcilier théorie et pratique au sein de l'Initiative pour le Web Mobile, et voit le Web partout. Il maintient le validateur mobileOK du W3C, donne des cours en ligne sur les Bonnes Pratiques pour le Web Mobile, participe au groupe de travail éponyme et suit avec intérêt les évolutions du Web.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/html5-et-le-web-de-demain.php&amp;ref=prez-html5-et-le-web-de-demain&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
