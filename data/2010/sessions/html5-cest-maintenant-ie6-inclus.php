...
<title>Paris Web - HTML5 c’est maintenant (IE6 inclus)</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/la-typographie-comme-outil-de-design.php" title="La typographie comme outil de design" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/rendre-une-application-dentreprise-accessible-contraintes-et-pragmatisme.php" title="Rendre une application d'entreprise accessible : contraintes et pragmatisme" />
	...
	<meta name="twitter:title" content="HTML5 c’est maintenant (IE6 inclus)" />
	<meta property="twitter:description" content="La spécification HTML5 sera finalisée en 2020 et la majorité de vos utilisateurs n'ont pas de navigateur supportant HTML5. Pourtant nous allons voir ensemble qu'il est possible et rentable de passer…" />
	<meta property="dc:title" content="HTML5 c’est maintenant (IE6 inclus)" />
	<meta property="og:title" content="HTML5 c’est maintenant (IE6 inclus)" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/html5-cest-maintenant-ie6-inclus.php" />
	<meta property="og:description" content="La spécification HTML5 sera finalisée en 2020 et la majorité de vos utilisateurs n'ont pas de navigateur supportant HTML5. Pourtant nous allons voir ensemble qu'il est possible et rentable de passer…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5 c’est maintenant (IE6 inclus)</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-63">
						<header>
							<h1>HTML5 c’est maintenant (IE6 inclus)</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh9c18?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-PA-01.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-63">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/html5-cest-maintenant-ie6-inclus.php" class="url">HTML5 c’est maintenant (IE6 inclus)</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/html5" rel="tag">HTML5</a></dd>
    ...
    <div class="talk-description"><p>La spécification HTML5 sera finalisée en 2020 et la majorité de vos utilisateurs n'ont pas de navigateur supportant HTML5. Pourtant nous allons voir ensemble qu'il est possible et rentable de passer à HTML5 immédiatement. Nouvelle sémantique, nouveaux formulaires, géolocalisation, glisser/déposer, vidéo, localStorage, etc. tous ces apports sont déjà simulables à partir d'IE6, nous verrons comment, à quel prix et pour quel bénéfice.</p></div>
	</section>
