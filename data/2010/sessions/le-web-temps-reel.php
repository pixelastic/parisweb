...
<title>Paris Web - Le web temps réel</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/comment-ca-cest-pas-du-flash.php" title="Comment ça c’est pas du Flash ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/mettre-en-forme-texte-web.php" title="Mettre en forme un texte pour le web ? Facile !" />
	...
	<meta name="twitter:title" content="Le web temps réel" />
	<meta property="twitter:description" content="Chaque jour qui passe, la notion d'instantanéité du web prend de plus en plus d'ampleur. Twitter et Facebook ont notamment participé à la vulgarisation de ces nouveaux usages. Techniquement,…" />
	<meta property="dc:title" content="Le web temps réel" />
	<meta property="og:title" content="Le web temps réel" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/le-web-temps-reel.php" />
	<meta property="og:description" content="Chaque jour qui passe, la notion d'instantanéité du web prend de plus en plus d'ampleur. Twitter et Facebook ont notamment participé à la vulgarisation de ces nouveaux usages. Techniquement,…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le web temps réel</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-60">
						<header>
							<h1>Le web temps réel</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-60">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/le-web-temps-reel.php" class="url">Le web temps réel</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/technologie" rel="tag">Technologie</a><br /><a href="http://www.paris-web.fr/2010/recherche/websockets" rel="tag">Websockets</a></dd>
    ...
    <div class="talk-description"><p>Chaque jour qui passe, la notion d'instantanéité du web prend de plus en plus d'ampleur.<br />
Twitter et Facebook ont notamment participé à la vulgarisation de ces nouveaux usages.<br />
Techniquement, l'arrivée des Websockets côté client et des frameworks événementiels (Node.js, EventMachine, Twisted) côté serveur font du web "temps-réel" un concept de plus en plus facile à mettre en place pour le développeur lambda. <br />
Que ce soit pour un système de chat, de notifications en temps réel ou pour des outils de collaboration en temps réel, les usages se multiplient et le développeur Web de demain devra maîtriser ces techniques pour répondre au mieux aux besoins de ses clients.<br />
A travers cet atelier nous apprendrons donc à utiliser ces nouvelles techniques ainsi que les outils disponibles pour faciliter leur usage.<br />
Enfin nous étudierons les solutions à notre disposition afin de conserver un fonctionnement "normal" côté client pour les navigateurs ne supportant pas encore ces nouvelles technologies.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/jonathan-blanchet.php">Jonathan Blanchet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jonathan Blanchet" src="https://www.paris-web.fr/2010/assets_c/2010/07/jonathan-blanchet-thumb-143x143-23.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Je suis un jeune passionné du web, après une formation de développeur (IUT informatique), je me suis orienté vers les spécialités multimédia (licence en Irlande) puis vers les problématiques d'ergonomie et conception (concepteur réalisateur multimédia en apprentissage aux Gobelins).</p>

<p>Après deux ans comme développeur PHP dans le cadre de mon apprentissage aux Gobelins, j'ai effectué deux ans en tant que développeur Web pour le compte de la société Eyeka où j'ai eu l'occasion de me spécialiser dans la partie Ruby on Rails des développements tout en restant investi dans les problématiques d'intégration et de développement côté client (HTML/CSS/JS).</p>

<p>Je suis, depuis le mois de juin 2010, freelance au sein du collectif <a href="http://lab212.org/">Lab212</a> au côté de huit autres développeurs, graphistes et artistes d'horizons différents.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/le-web-temps-reel.php&amp;ref=prez-le-web-temps-reel&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
