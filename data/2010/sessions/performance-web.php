...
<title>Paris Web - Performance Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/prototypage-papier.php" title="Prototypage papier et design itératif" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/html5-pour-mon-ordinateur-et-mon-mobile.php" title="HTML5 pour mon ordinateur et mon mobile" />
	...
	<meta name="twitter:title" content="Performance Web" />
	<meta property="twitter:description" content="Votre page est envoyée en moins d'une seconde mais l'utilisateur attend plus de 4 secondes avant de pouvoir utiliser votre site ? Les utilisateurs google ne restent pas alors que votre contenu est…" />
	<meta property="dc:title" content="Performance Web" />
	<meta property="og:title" content="Performance Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/performance-web.php" />
	<meta property="og:description" content="Votre page est envoyée en moins d'une seconde mais l'utilisateur attend plus de 4 secondes avant de pouvoir utiliser votre site ? Les utilisateurs google ne restent pas alors que votre contenu est…" />
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xguqi5?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-57">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/performance-web.php" class="url">Performance Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/performance" rel="tag">Performance</a><br /><a href="http://www.paris-web.fr/2010/recherche/technologie" rel="tag">Technologie</a></dd>
    ...
    <div class="talk-description"><p>Votre page est envoyée en moins d'une seconde mais l'utilisateur attend plus de 4 secondes avant de pouvoir utiliser votre site ? Les utilisateurs google ne restent pas alors que votre contenu est pertinent ? Alors vous avez un problème de performances qui influe sur votre chiffre d'affaire, et que nous pouvons commencer à résoudre : venez apprendre des autres ou bien donnez moi une ou plusieurs pages à optimiser.<br />
Après une présentation théorique sur les performances Web, nous étudierons vos cas, ou à défaut de volontaires, quelques grands sites.</p>

<p>Vous viendrez ou vous avez un site à soumettre ? Dites-moi ce qui vous intéresse ou <a href="https://spreadsheets.google.com/viewform?formkey=dHk4c3Q1SDdKMS1LdFRjOVFGRmhIc0E6MQ">remplissez ce formulaire</a>. Nous étudierons en priorité vos sites, surtout si vous êtes capables de les modifier en direct.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/jean-pierre-vincent.php">Jean-Pierre Vincent</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jean-Pierre Vincent" src="https://www.paris-web.fr/2010/assets_c/2010/07/jean-pierre-vincent-thumb-143x143-22.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Jean-Pierre Vincent développe pour le Web depuis 2000 : développeur PHP chez <a href="http://houra.fr/">houra.fr</a> puis intégrateur, développeur frontend et enfin Webdev manager chez Kelkoo et Yahoo!, il officie maintenant en tant que lead Web developer dans une startup à mi-chemin entre le site traditionnel et l'application Web : <a href="http://timeofmylife.com/">timeofmylife.com</a>.</p>

<p>Il se passionne actuellement pour les recherches sur les performances Web et l'adaptation des technos Web pour concurrencer les applications natives, HTML5 et JavaScript en tête, tout en gardant à l'esprit les problèmes de rentabilité et de compatibilité. Afin de redonner à la communauté ce qu'elle lui a enseigné, il fait des conférences à l'occasion et entretient un blog de veille technologique : <a href="http://braincracking.org">http://braincracking.org</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/performance-web.php&amp;ref=prez-performance-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
