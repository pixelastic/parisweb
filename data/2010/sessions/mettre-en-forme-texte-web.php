...
<title>Paris Web - Mettre en forme un texte pour le web ? Facile !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/le-web-temps-reel.php" title="Le web temps réel" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/comment-utiliser-css-3-aujourdhui.php" title="CSS 3 aujourd’hui : quoi et comment ?" />
	...
	<meta name="twitter:title" content="Mettre en forme un texte pour le web ? Facile !" />
	<meta property="twitter:description" content="Qui n’a jamais constaté combien les rédacteurs d’un site web étaient attachés à faire des pages ayant le look qui leur convienne. De vraies affiches de Kermesse ! L’objectif de cet atelier sera de…" />
	<meta property="dc:title" content="Mettre en forme un texte pour le web ? Facile !" />
	<meta property="og:title" content="Mettre en forme un texte pour le web ? Facile !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/mettre-en-forme-texte-web.php" />
	<meta property="og:description" content="Qui n’a jamais constaté combien les rédacteurs d’un site web étaient attachés à faire des pages ayant le look qui leur convienne. De vraies affiches de Kermesse ! L’objectif de cet atelier sera de…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Mettre en forme un texte pour le web ? Facile !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-125">
						<header>
							<h1>Mettre en forme un texte pour le web ? Facile !</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-125">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/mettre-en-forme-texte-web.php" class="url">Mettre en forme un texte pour le web ? Facile !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/contenu" rel="tag">Contenu</a></dd>
    ...
    <div class="talk-description"><p>Qui n’a jamais constaté combien les rédacteurs d’un site web étaient attachés à faire des pages ayant le look qui leur convienne. De vraies affiches de Kermesse !</p>

<p>L’objectif de cet atelier sera de donner les outils pour mettre en valeur l’intelligence des rédacteurs pour trouver le sens d’un texte et le rendre évident par sa mise en forme.</p>

<p>Du coup, nous parlerons de « mise en sens » d’un texte, c’est-à-dire, de mise en forme sémantique.</p>

<p>L’atelier s’adresse :</p>

<ul>
	<li>À ceux qui se prennent encore la tête pour mettre un texte en ligne.</li>
	<li>À ceux qui forment des gens qui auront à mettre du texte en ligne (avec un <abbr>CMS</abbr> par exemple).</li>
</ul>

<p>Pour en savoir plus, vous pouvez lire « <a href="http://www.pyrat.net/Rediger-pour-Internet-les-grandes-regles">Rédiger pour Internet : les grandes règles</a> ».</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/jacques-pyrat.php">Jacques Pyrat</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jacques Pyrat" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_jacques-pyrat-thumb-143x143-61.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Passionné de typographie depuis 20 ans, Jacques Pyrat finit naturellement par adopter le <abbr>CMS</abbr> <abbr>SPIP</abbr> pour ses qualités typographiques.</p>

<p>Concepteur de sites web depuis 1995, il s’intéresse dès 2002 à l’accessibilité des contenus pour tous.</p>

<p>Formateur, il est amené à rencontrer de nombreux rédacteurs de sites.</p>

<p>De là, il développe une méthode invitant les rédacteurs à se mettre au service du contenu du message à faire passer à ses lecteurs.</p>

<p>Père de 4 enfants, il vit avec son épouse en Périgord où il exerce le métier de créateur de sites web sous <abbr>SPIP</abbr>.</p>

<ul>
<li>Son entreprise : <a href="http://www.pyrat.net/">http://www.pyrat.net/</a></li>
<li>Son blog : <a href="http://blog.pyrat.eu/">http://blog.pyrat.eu/</a></li>
<li>Sa veille : <a href="http://delicious.com/jpyrat">http://delicious.com/jpyrat</a></li>
</ul></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/mettre-en-forme-texte-web.php&amp;ref=prez-mettre-en-forme-texte-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
