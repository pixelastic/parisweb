...
<title>Paris Web - Le jeu de la valeur métier</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/xp-game.php" title="XP Game" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/card-sorting.php" title="Ne perdez plus vos internautes : faites du « card sorting »" />
	...
	<meta name="twitter:title" content="Le jeu de la valeur métier" />
	<meta property="twitter:description" content="Contexte Vous êtes impliqués dans la planification de projet, mais connaissez-vous la Valeur Métier qu’ils vous apportent et à vos clients ? Comment priorisez-vous vos projets ? Connaissez-vous le…" />
	<meta property="dc:title" content="Le jeu de la valeur métier" />
	<meta property="og:title" content="Le jeu de la valeur métier" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/le-jeu-de-la-valeur-metier.php" />
	<meta property="og:description" content="Contexte Vous êtes impliqués dans la planification de projet, mais connaissez-vous la Valeur Métier qu’ils vous apportent et à vos clients ? Comment priorisez-vous vos projets ? Connaissez-vous le…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le jeu de la valeur métier</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-61">
						<header>
							<h1>Le jeu de la valeur métier</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-61">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/le-jeu-de-la-valeur-metier.php" class="url">Le jeu de la valeur métier</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p><strong>Contexte</strong></p>

<p>Vous êtes impliqués dans la planification de projet, mais connaissez-vous la Valeur Métier qu’ils vous apportent et à vos clients ?</p>

<p>Comment priorisez-vous vos projets ?</p>

<p>Connaissez-vous le Modèle de Valeur Métier de votre organisation ?</p>

<p><strong>Objectifs</strong></p>

<p>Comprendre le point de vue du Directeur de Projet, du client et apprendre à produire les bons produits avec les bonnes fonctionnalités au bon moment avec un maximum de valeur.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/laurent-morisseau.php">Laurent Morisseau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Laurent Morisseau" src="https://www.paris-web.fr/2010/assets_c/2010/07/laurent-morisseau-thumb-143x143-24.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après 15 ans dans le développement logiciel passés en société de services puis chez un grand compte, Laurent Morisseau se spécialise dans les méthodes agiles: Scrum, XP, Kanban. Fondateur de Morisseau Consulting en 2008, il est depuis impliqué au quotidien sur des projets opérationnels en tant que coach agile, consultant pour les organisations et formateur. </p>

<p>Scrum Practitioner certifié, c'est un acteur actif de la communauté agile: Fondateur des communautés AgileRennes et président de l'association AgileBreizh, administrateur du French Scrum User Group et organisateur Agile Tour.</p>

<p>Enfin, c'est un conférencier et un facilitateur reconnu intervenant régulièrement dans les conférences Agile France, Agile Tour et XP Days.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/le-jeu-de-la-valeur-metier.php&amp;ref=prez-le-jeu-de-la-valeur-metier&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
