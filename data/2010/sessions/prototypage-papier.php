...
<title>Paris Web - Prototypage papier et design itératif</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/referencement-et-utilisabilite-des-objectifs-differents-des-methodes-qui-convergent.php" title="Référencement et utilisabilité : des objectifs différents, des méthodes qui convergent" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/performance-web.php" title="Performance Web" />
	...
	<meta name="twitter:title" content="Prototypage papier et design itératif" />
	<meta property="twitter:description" content="L’objectif de cet atelier est de faire découvrir une forme de conception participative et itérative simple à mettre en œuvre car ne nécessitant pas de développements lourds, l’essentiel de cette…" />
	<meta property="dc:title" content="Prototypage papier et design itératif" />
	<meta property="og:title" content="Prototypage papier et design itératif" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/prototypage-papier.php" />
	<meta property="og:description" content="L’objectif de cet atelier est de faire découvrir une forme de conception participative et itérative simple à mettre en œuvre car ne nécessitant pas de développements lourds, l’essentiel de cette…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Prototypage papier et design itératif</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-136">
						<header>
							<h1>Prototypage papier et design itératif</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-136">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/prototypage-papier.php" class="url">Prototypage papier et design itératif</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>L’objectif de cet atelier est de faire découvrir une forme de conception participative et itérative simple à mettre en œuvre car ne nécessitant pas de développements lourds, l’essentiel de cette démarche se basant sur du découpage, des crayonnés, du collage, du pliage et un peu de système D.</p>

<p>Cette session de 3 heures se déroulera comme suit :</p>

<ul>
<li>Une introduction sur la conception centrée utilisateur (30mn)</li>
<li>La présentation d’un brief fictif et des personas qui lui sont associées (30mn)</li>
<li>En se fondant sur les objectifs associés à chaque personas les participants conçoivent puis réalisent sous forme de prototype papier leur réponse au brief. (1h30)</li>
<li> En fin de session chaque prototype est testé et évalué par le groupe (30mn)</li>
</ul>

<p>Cet atelier se destine à un public pouvant être complètement novice en conception, mais disposant malgré tout d’une petite culture interactive.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/vincentmayol.php">Vincent Mayol</a></h2>
...
<div class="speaker-bio"><p>Vincent a mis de côté depuis 9 ans le monde passionnant de l'histoire contemporaine pour se lancer dans l’univers trépidant du digital. Ce revirement l’a amené à rejoindre Duke en 2006, puis à se spécialiser dans les domaines de l’expérience utilisateur et de l’architecture de l’information. Dans ce cadre il est intervenu notamment pour McDonald's, SNCF, Levi's et Nike.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/prototypage-papier.php&amp;ref=prez-prototypage-papier&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
