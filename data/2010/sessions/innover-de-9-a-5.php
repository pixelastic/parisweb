...
<title>Paris Web - Innover de 9 à 5</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/css3-photoshop-avenir-web-designer.php" title="CSS3/Photoshop : quel avenir pour le métier de web designer ? " />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/la-typographie-comme-outil-de-design.php" title="La typographie comme outil de design" />
	...
	<meta name="twitter:title" content="Innover de 9 à 5" />
	<meta property="twitter:description" content="«&nbsp;Innovation&nbsp;». Les organisations n'ont que ce mot à la bouche – dans leur mission, leur slogan, leur rapport aux actionnaires, et dans les envolées des managers quand ils haranguent leurs…" />
	<meta property="dc:title" content="Innover de 9 à 5" />
	<meta property="og:title" content="Innover de 9 à 5" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/innover-de-9-a-5.php" />
	<meta property="og:description" content="«&nbsp;Innovation&nbsp;». Les organisations n'ont que ce mot à la bouche – dans leur mission, leur slogan, leur rapport aux actionnaires, et dans les envolées des managers quand ils haranguent leurs…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Innover de 9 à 5</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-91">
						<header>
							<h1>Innover de 9 à 5</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggt6n?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/201010pariswebinnovation-101015102125-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-GA-06.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-91">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/innover-de-9-a-5.php" class="url">Innover de 9 à 5</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>«&nbsp;Innovation&nbsp;». Les organisations n'ont que ce mot à la bouche – dans leur mission, leur slogan, leur rapport aux actionnaires, et dans les envolées des managers quand ils haranguent leurs troupes. Mais dans l'enfer du métro-boulot-dodo, le joli mot perd vite de sa superbe et les beaux espoirs se cassent souvent les dents sur les réalités de la vie en entreprise.</p>

<p>À quoi ça ressemble, au juste, l'innovation&nbsp;? Comment ça marche&nbsp;? Innover, c'est une nature, ou peut-on décider d'être innovant&nbsp;? Une culture et une structure d'innovation, ça ressemble à quoi&nbsp;?</p>

<p>Autant de question que l'entreprise que nous prendrons comme cas d'espèce a dû se poser&nbsp;: cette agence web, entreprise par nature dédiée à garder ses employés le plus occupés possible, a pris un virage vers l'innovation. Un bilan de ses succès – et ses échecs – démarrera notre conversation.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/olivier-thereaux.php">Olivier Thereaux</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Olivier Thereaux" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_olivier_thereaux-thumb-143x143-55.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Ayant appris le Web sous la devise «&nbsp;le premier qui me fait une page qui ne passe pas au validateur se prend deux baffes&nbsp;», <a href="http://www.google.fr/search?q=olivier+Thereaux">Olivier</a> s'est presque naturellement retrouvé au W3C comme développeur, évangeliste des bonnes pratiques du Web et finalement en charge des services Open Source du consortium - tout en s'attelant à promouvoir l'art et la culture sur le Web comme co-fondateur et geek-en-chef du réseau ArtBeat.<br />
<!--<br />
Globe-trotteur et touche à tout, il a vécu à Paris et Tokyo et se promène maintenant à Montréal où il accompagne l'agence Phēromone et ses clients dans leur vision de produit et services Web.<br />
--></p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/innover-de-9-a-5.php&amp;ref=prez-innover-de-9-a-5&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
