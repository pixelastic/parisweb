...
<title>Paris Web - Ne perdez plus vos internautes : faites du « card sorting »</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/le-jeu-de-la-valeur-metier.php" title="Le jeu de la valeur métier" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/mettre-en-place-la-gestion-de-la-qualite-web.php" title="Mettre en place la gestion de la qualité web" />
	...
	<meta name="twitter:title" content="Ne perdez plus vos internautes : faites du « card sorting »" />
	<meta property="twitter:description" content="Trop souvent dans un projet web, on se rend compte au moment de la rédaction qu’il y a trop de contenu, que l’on se répète, que l’organisation n’est pas fluide. Que faire pour définir les bonnes…" />
	<meta property="dc:title" content="Ne perdez plus vos internautes : faites du « card sorting »" />
	<meta property="og:title" content="Ne perdez plus vos internautes : faites du « card sorting »" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/card-sorting.php" />
	<meta property="og:description" content="Trop souvent dans un projet web, on se rend compte au moment de la rédaction qu’il y a trop de contenu, que l’on se répète, que l’organisation n’est pas fluide. Que faire pour définir les bonnes…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Ne perdez plus vos internautes : faites du « card sorting »</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-122">
						<header>
							<h1>Ne perdez plus vos internautes : faites du « card sorting »</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-122">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/card-sorting.php" class="url">Ne perdez plus vos internautes : faites du « card sorting »</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>Trop souvent dans un projet web, on se rend compte au moment de la rédaction qu’il y a trop de contenu, que l’on se répète, que l’organisation n’est pas fluide. Que faire pour définir les bonnes rubriques, employer des labels pertinents et organiser les informations afin que l’utilisateur trouve rapidement et facilement ce qu’il recherche ?</p>

<p>Deux possibilités :</p>

<ul>
<li>S’inspirer de la sagesse du <abbr title="Docteur">Dr.</abbr> <span lang="en">House</span> et tenter de s’immiscer dans le cerveau humain afin de trouver <strong>la</strong> solution ;</li>
<li>Éteindre la <abbr>TV</abbr> et adopter le « <span lang="en">card sorting</span> » (tri de cartes).</li>
</ul>

<p>A l’issue de cet atelier vous saurez comment :</p>

<ul>
<li>Optimiser l’architecture de votre site en fonction de la logique de vos utilisateurs ;</li>
<li>Avoir un retour d’expérience concret et de nombreux <span lang="en">guidelines</span> sur le « <span lang="en">card sorting</span> ».</li>
</ul>

<p>L&#8217;atelier permettra également aux trois intervenants de faire un « <span lang="en">card sorting</span> » en direct avec les personnes présentes dans la salle.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/eric-mazzone.php">Eric Mazzone</a>, <a href="https://www.paris-web.fr/2010/../orateurs/marie-baudy.php">Marie Baudy</a> et <a href="https://www.paris-web.fr/2010/../orateurs/gautier-barrere.php">Gautier Barrère</a></h2>
...
<div class="speaker-bio"><p>Eric MAZZONE, consultant, <a href="http://www.promexis.com">société Promexis s.a</a>.</p>

<p>En mission au Centre Informatique de l'Etat luxembourgeois, Eric renforce l'équipe en charge de la définition du processus et du contrôle Qualité de la présence Internet de l’Etat luxembourgeois.</p>

<p>En tant qu’ergonome, sa priorité est de garantir que les produits fournis correspondent et sont adaptés aux spécificités des utilisateurs.</p></div>
</div>
...
<div class="speaker-bio"><p>Ergonome pour le Web, et plus particulièrement pour les sites de l’état du Luxembourg depuis 2009.</p>

<p>Marie est titulaire depuis 2006 d’un master 2 Interface homme machine de l’ENAC de Toulouse.</p>

<p>Elle a fait ses armes dans une SSII en tant que développeuse et conceptrice d’interface en utilisant notamment des techniques centrées utilisateurs.</p>

<p>Elle veille aujourd’hui à la qualité des sites étatiques, de leur conception à leur mise en ligne et leur évolution.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Gautier Barrère" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_gautier-barrere-thumb-143x143-74.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Ergonome, spécialiste « Human factor / User experience » logiciels interactifs et Web</p>

<p>Titulaire du DESS d’ergonomie de l’université Paris V, Gautier Barrère travaille d’abord en tant qu’indépendant pour divers clients dans la zone BENELUX.<br />
Au fil des années, il attache de plus en plus d’importance à la prise en compte de l’expérience utilisateur au sein des projets Web de grandes institutions.<br />
Il est désormais responsable de l'équipe "Présence Internet" du Centre des technologies de l'information de l'Etat au sein du gouvernement luxembourgeois. </p></div>
</div>
