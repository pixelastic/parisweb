...
<title>Paris Web - CSS3/Photoshop : quel avenir pour le métier de web designer ? </title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/methodologie-du-design-dexperience-utilisateur.php" title="Méthodologie du Design d’expérience utilisateur" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/innover-de-9-a-5.php" title="Innover de 9 à 5" />
	...
	<meta name="twitter:title" content="CSS3/Photoshop : quel avenir pour le métier de web designer ? " />
	<meta property="twitter:description" content="Photoshop, bien que destiné à la manipulation de photos a toujours été l'outil préféré des web designers. Aujourd'hui la plupart utilisent l'utilise pour en tirer des maquettes ou des éléments…" />
	<meta property="dc:title" content="CSS3/Photoshop : quel avenir pour le métier de web designer ? " />
	<meta property="og:title" content="CSS3/Photoshop : quel avenir pour le métier de web designer ? " />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/css3-photoshop-avenir-web-designer.php" />
	<meta property="og:description" content="Photoshop, bien que destiné à la manipulation de photos a toujours été l'outil préféré des web designers. Aujourd'hui la plupart utilisent l'utilise pour en tirer des maquettes ou des éléments…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>CSS3/Photoshop : quel avenir pour le métier de web designer ? </span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-82">
						<header>
							<h1>CSS3/Photoshop : quel avenir pour le métier de web designer ? </h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xhfqhy?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/pariswebfinal-101018041311-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-PA-09.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-82">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/css3-photoshop-avenir-web-designer.php" class="url">CSS3/Photoshop : quel avenir pour le métier de web designer ? </a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/design" rel="tag">Design</a></dd>
    ...
    <div class="talk-description"><p>Photoshop, bien que destiné à la manipulation de photos a toujours été l'outil préféré des web designers. Aujourd'hui la plupart utilisent l'utilise pour en tirer des maquettes ou des éléments graphiques d'une très grande qualité. Avec l'arrivée des CSS3, le donne risque de changer. En effet, si les CSS3 rencontrent déjà un grand succès, c'est parce qu'ils s'adressent en grande partie à ces mêmes designers, en proposant de nombreuses fonctions qui permettent maintenant de créer des éléments graphiques sans avoir besoin de recourir aux images. Certains vont même jusqu'à faire des maquettes directement dans le navigateur sans avoir besoin de passer par Photoshop&nbsp;! </p>

<p>Cela dit, au-delà des innovations intéressantes que les CSS3 apportent, se pose un problème. Quid du métier de web designer&nbsp;? En France notamment, on a tendance à séparer le métier de web designer qui resterait du côté graphique, donc attitré à Photoshop et le métier d'intégrateur qui est responsable du HTML et des CSS. Avec les CSS3, le web designer ne peut plus ne pas connaître les CSS. A la limite, il ne peux plus ne pas y toucher. Mais de l'autre côté, l'intégrateur va-t-il accepter que le designer se mette à coder&nbsp;? Et si, finalement, ces deux métiers ne faisaient plus qu'un dans un proche avenir&nbsp;? Et si le web designer devenait l'expert "front end"&nbsp;? </p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/francis-chouquet.php">Francis Chouquet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Francis Chouquet" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_francis_chouquet-thumb-143x143-39.png" width="143" height="143">
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/css3-photoshop-avenir-web-designer.php&amp;ref=prez-css3-photoshop-avenir-web-designer&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
