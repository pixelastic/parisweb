...
<title>Paris Web - Rendre une application d'entreprise accessible : contraintes et pragmatisme</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/html5-cest-maintenant-ie6-inclus.php" title="HTML5 c’est maintenant (IE6 inclus)" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/macrotypographie-page-web.php" title="La macrotypographie de la page Web" />
	...
	<meta name="twitter:title" content="Rendre une application d'entreprise accessible : contraintes et…" />
	<meta property="twitter:description" content="Le but est de démontrer qu'il est possible de rendre accessible une application d'entreprise existante malgré de fortes contraintes (techniques, politiques, ergonomiques), en adoptant une démarche…" />
	<meta property="dc:title" content="Rendre une application d'entreprise accessible : contraintes et pragmatisme" />
	<meta property="og:title" content="Rendre une application d'entreprise accessible : contraintes et pragmatisme" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/rendre-une-application-dentreprise-accessible-contraintes-et-pragmatisme.php" />
	<meta property="og:description" content="Le but est de démontrer qu'il est possible de rendre accessible une application d'entreprise existante malgré de fortes contraintes (techniques, politiques, ergonomiques), en adoptant une démarche…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Rendre une application d'entreprise accessible : contraintes et pragmatisme</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-100">
						<header>
							<h1>Rendre une application d'entreprise accessible : contraintes et pragmatisme</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh9c1q?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-100">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/rendre-une-application-dentreprise-accessible-contraintes-et-pragmatisme.php" class="url">Rendre une application d'entreprise accessible : contraintes et pragmatisme</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/accessibilite" rel="tag">Accessibilité</a></dd>
    ...
    <div class="talk-description"><p>Le but est de démontrer qu'il est possible de rendre accessible une application d'entreprise existante malgré de fortes contraintes (techniques, politiques, ergonomiques), en adoptant une démarche pragmatique et constructive.</p>

<p>La démarche pragmatique, c'est d'abord expliquer et convaincre, éliminer les points les plus bloquants, communiquer sur les résultats.</p>

<p>Le sujet sera illustré d'un cas concret concernant une application RH.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/tanguy-loheac.php">Tanguy Loheac</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Tanguy Loheac" src="https://www.paris-web.fr/2010/assets_c/2010/09/orateur-tanguy_loheac-thumb-143x143-80.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Actuellement expert accessibilité chez Sanofi-aventis où il intervient dans la sensibilisation, l'audit et le support technique, Tanguy a travaillé à BrailleNet en tant que formateur et chef de projet sur le Guide AccessiWeb. Durant cette période, il a également participé à des travaux du W3C sur des documents de sensibilisation.</p>

<p>Diplômé de l'Institut Supérieur de Gestion (ISG Paris), et titulaire d'un diplôme de Chef de Projet Informatique de l'Isaip d'Angers, il a une forte propension au voyage : six mois aux USA, six mois en Espagne, trois mois au Japon.</p>

<p>Ses passions : l'écriture, le jeu d'échecs, la guitare et le chant.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/rendre-une-application-dentreprise-accessible-contraintes-et-pragmatisme.php&amp;ref=prez-rendre-une-application-dentreprise-accessible&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
