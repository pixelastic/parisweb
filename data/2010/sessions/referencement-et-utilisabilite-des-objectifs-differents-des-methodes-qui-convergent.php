...
<title>Paris Web - Référencement et utilisabilité : des objectifs différents, des méthodes qui convergent</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/prendre-en-compte-les-handicaps-cognitifs.php" title="Prendre en compte les handicaps cognitifs" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/prototypage-papier.php" title="Prototypage papier et design itératif" />
	...
	<meta name="twitter:title" content="Référencement et utilisabilité : des objectifs différents, des…" />
	<meta property="twitter:description" content="Référencement, utilisabilité et accessibilité n'ont pas les mêmes finalités. Le référencement vise à maximiser la visibilité des sites web dans les pages de résultats des moteurs, alors que…" />
	<meta property="dc:title" content="Référencement et utilisabilité : des objectifs différents, des méthodes qui convergent" />
	<meta property="og:title" content="Référencement et utilisabilité : des objectifs différents, des méthodes qui convergent" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/referencement-et-utilisabilite-des-objectifs-differents-des-methodes-qui-convergent.php" />
	<meta property="og:description" content="Référencement, utilisabilité et accessibilité n'ont pas les mêmes finalités. Le référencement vise à maximiser la visibilité des sites web dans les pages de résultats des moteurs, alors que…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Référencement et utilisabilité : des objectifs différents, des méthodes qui convergent</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-134">
						<header>
							<h1>Référencement et utilisabilité : des objectifs différents, des méthodes qui convergent</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xgul6j?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/atelierparisweb2010-101018072610-phpapp02" 
	...
	<section class="s-talk-subject" id="sujet-134">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/referencement-et-utilisabilite-des-objectifs-differents-des-methodes-qui-convergent.php" class="url">Référencement et utilisabilité : des objectifs différents, des méthodes qui convergent</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ergonomie" rel="tag">Ergonomie</a><br /><a href="http://www.paris-web.fr/2010/recherche/seo" rel="tag">SEO</a></dd>
    ...
    <div class="talk-description"><p>Référencement, utilisabilité et accessibilité n'ont pas les mêmes finalités. Le référencement vise à maximiser la visibilité des sites web dans les pages de résultats des moteurs, alors que l'utilisabilité et l'accessibilité cherchent à permettre un accès universel et à faciliter l'expérience utilisateur lors de la consultation des sites. L'optimisation pour les moteurs de recherche peut parfois être perçue comme allant à l'encontre d'une bonne accessibilité ou d'une bonne utilisabilité. L'objectif de cette conférence sera de vous montrer qu'il n'en est rien, et qu'accessibilité et référencement ont plus de points communs qu'il n'y paraît…</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/sebastien-billard.php">Sébastien Billard</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Sébastien Billard" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_sebastien-billard-thumb-143x143-63.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Consultant SEO senior chez <a href="http://www.relevanttraffic.fr/">Relevant Traffic France</a>, Sébastien Billard accompagne depuis 9 ans les entreprises et institutions dans leur référencement naturel, par la fourniture de recommandations et de formations.</p>

<p>Il est également l’auteur du blog «&nbsp;<a href="http://s.billard.free.fr/referencement/">Référencement Design et Cie</a>&nbsp;» qu'il anime depuis 2005 et enseigne le référencement aux étudiants du <a href="http://www.univ-lille3.fr/fr/ufr-idist/formation/master-icd">Master IDEMM de l’université de Lille 3</a>.</p>

<p>Sébastien prône une approche holistique du référencement, celui-ci devant faire partie intégrante de la communication des organisations et participer à l'ergonomie générale des sites.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/referencement-et-utilisabilite-des-objectifs-differents-des-methodes-qui-convergent.php&amp;ref=prez-referencement-et-utilisabilite-des-objectifs-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
