...
<title>Paris Web - HTML5 pour mon ordinateur et mon mobile</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/performance-web.php" title="Performance Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/le-web-analytics-au-service-de-lutilisabilite.php" title="Le Web Analytics au service de l’utilisabilité" />
	...
	<meta name="twitter:title" content="HTML5 pour mon ordinateur et mon mobile" />
	<meta property="twitter:description" content="La révolution HTML5 est en marche à la fois les navigateurs desktop et les navigateurs mobiles. Pourtant, peut-on développer les mêmes applications web HTML5 sur toutes les plateformes, et de la même…" />
	<meta property="dc:title" content="HTML5 pour mon ordinateur et mon mobile" />
	<meta property="og:title" content="HTML5 pour mon ordinateur et mon mobile" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/html5-pour-mon-ordinateur-et-mon-mobile.php" />
	<meta property="og:description" content="La révolution HTML5 est en marche à la fois les navigateurs desktop et les navigateurs mobiles. Pourtant, peut-on développer les mêmes applications web HTML5 sur toutes les plateformes, et de la même…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5 pour mon ordinateur et mon mobile</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-130">
						<header>
							<h1>HTML5 pour mon ordinateur et mon mobile</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh43oe?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-130">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/html5-pour-mon-ordinateur-et-mon-mobile.php" class="url">HTML5 pour mon ordinateur et mon mobile</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/html5" rel="tag">HTML5</a></dd>
    ...
    <div class="talk-description"><p>La révolution HTML5 est en marche à la fois les navigateurs desktop et les navigateurs mobiles. Pourtant, peut-on développer les mêmes applications web HTML5 sur toutes les plateformes, et de la même manière? Nous verrons à-travers des exemples concrets, les possibilités offertes par les deux types de plateformes, et ce qui peut les différencier. Nous développerons une petite application dans l'esprit des Coding Dojo, donc si vous avez envie de prendre le clavier et coder une partie de cette application, vous serez les bienvenu(e)s.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/francois-petitit.php">François Petitit</a> et <a href="https://www.paris-web.fr/2010/../orateurs/mickael-morier.php">Mickaël Morier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="François Petitit" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur-francois-petit-thumb-143x143-58.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Ingénieur en informatique et consultant au sein d'OCTO Technology, un cabinet de conseil en architecture de S.I., son activité professionnelle lui a notamment permis de travailler chez des grandes entreprises sur l'industrialisation des développements Web.</p>

<p>Passionné par le Web, il s'interesse notamment aux dernières évolutions en terme de développement de véritables applications sur cette plateforme, et en parallèle à la problématique de support des différents types de clients, des terminaux mobiles aux desktops, et plus récemment les nouvelles télévisions intelligentes.<br />
</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Mickaël Morier" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur-mickael-morier-thumb-143x143-57.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Passionné d’Internet depuis ses débuts dans l’informatique, Mickaël <br />
Morier est ingénieur ESIEA et consultant chez <a href="http://www.octo.com/">OCTO Technology</a>. Ses premiers développements web étaient personnels mais ont donné lieu par la suite à des réalisations en agence web et en junior entreprise avec une volonté grandissante de respecter et de promouvoir les standards du web.</p>

<p>Depuis la fin de ses études, Mickaël poursuivi son intérêt pour les technologies Web en conseillant et réalisant des applications web pour diverses grandes entreprises et s'intéresse depuis quelques temps à la mobilité. Les technologies Web et la mobilité sont deux sujets sur lesquels il a écrit <a href="http://blog.octo.com/author/mmo/">quelques articles sur OCTO talks&nbsp;!</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/html5-pour-mon-ordinateur-et-mon-mobile.php&amp;ref=prez-html5-pour-mon-ordinateur-et-mon-mobile&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
