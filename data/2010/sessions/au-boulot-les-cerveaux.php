...
<title>Paris Web - Au boulot les cerveaux !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/mini-conferences/comment-un-vigneron-etranger-utilise-le-web-pour-sintegrer-dans-la-france-rurale.php" title="Comment un vigneron étranger utilise le web pour s'intégrer dans la France rurale" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/repas-2.php" title="repas" />
	...
	<meta name="twitter:title" content="Au boulot les cerveaux !" />
	<meta property="twitter:description" content="Graphistes, développeurs, chef de projet, il nous est tous arrivé de nous retrouver face à un conflit humain pouvant mettre en péril le projet sur lequel nous collaborons. Pourtant bon nombre de…" />
	<meta property="dc:title" content="Au boulot les cerveaux !" />
	<meta property="og:title" content="Au boulot les cerveaux !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/mini-conferences/au-boulot-les-cerveaux.php" />
	<meta property="og:description" content="Graphistes, développeurs, chef de projet, il nous est tous arrivé de nous retrouver face à un conflit humain pouvant mettre en péril le projet sur lequel nous collaborons. Pourtant bon nombre de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Au boulot les cerveaux !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-190">
						<header>
							<h1>Au boulot les cerveaux !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggq38?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/finalcerveau-101019052220-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-PA-04.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-190">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/mini-conferences/au-boulot-les-cerveaux.php" class="url">Au boulot les cerveaux !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>Graphistes, développeurs, chef de projet, il nous est tous arrivé de nous retrouver face à un conflit humain pouvant mettre en péril le projet sur lequel nous collaborons.</p>

<p>Pourtant bon nombre de situations critiques peuvent être évitées si on a conscience du mécanisme mental de nos collaborateurs. En effet, de nos choix de carrière à ceux devant la machine à café : bon nombre de nos comportements extérieurs et de nos émotions sont conditionnés par le fonctionnement de notre cerveau. Virginie vous propose donc un aperçu rapide de nos différents cerveaux et quelques clés pour mieux utiliser ces connaissances.</p>

<p>Ce sujet tout public s'adresse tout particulièrement aux curieux qui souhaitent tirer profit d'une meilleure compréhension de leur entourage professionnel.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/virginie-caplet.php">Virginie Caplet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Virginie Caplet" src="https://www.paris-web.fr/2010/assets_c/2010/10/orateur_virginie-caplet-thumb-143x143-83.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après des études dans la programmation, Virginie s'est rapidement orientée dans le web il y a plus de 9 ans.</p>

<p>Graphiste web depuis plus de 7 ans et freelance depuis plus de 3 ans, Virginie recherche sans cesse comment être créative tout en restant en accord avec les technologies actuelles. Ainsi son travail est organisé autour d'une communication active avec les développeurs mais aussi les chefs de projet, l'équipe commerciale et les clients. Elle a ainsi pu apprécier sans cesse les avantages et les inconvénients de l'empathie dans le milieu professionnel.</p>

<p>En 2008, elle rencontre Audrey Akoun, professeur à l'Ecole Française de l'Heuristique, à Paris. La découverte de l'heuristique et des mécanismes de notre cerveau via la cartographie mentale l'ont particulièrement intéressée au point de l'appliquer aux métiers du web.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/mini-conferences/au-boulot-les-cerveaux.php&amp;ref=prez-au-boulot-les-cerveaux&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
