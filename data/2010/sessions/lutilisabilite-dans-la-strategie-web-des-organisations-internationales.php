...
<title>Paris Web - L’utilisabilité dans la stratégie web des organisations internationales</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/pause-pa.php" title="pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/lets-interface.php" title="Let’s interface - how to make people as excited about tech as we are" />
	...
	<meta name="twitter:title" content="L’utilisabilité dans la stratégie web des organisations…" />
	<meta property="twitter:description" content="Comment appréhender ses utilisateurs dans le contexte mondial d’une organisation internationale comme l’ONU ? Quelle attitude avoir par rapport aux médias sociaux quand on est la Commission…" />
	<meta property="dc:title" content="L’utilisabilité dans la stratégie web des organisations internationales" />
	<meta property="og:title" content="L’utilisabilité dans la stratégie web des organisations internationales" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/lutilisabilite-dans-la-strategie-web-des-organisations-internationales.php" />
	<meta property="og:description" content="Comment appréhender ses utilisateurs dans le contexte mondial d’une organisation internationale comme l’ONU ? Quelle attitude avoir par rapport aux médias sociaux quand on est la Commission…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L’utilisabilité dans la stratégie web des organisations internationales</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-75">
						<header>
							<h1>L’utilisabilité dans la stratégie web des organisations internationales</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh72te?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-75">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/lutilisabilite-dans-la-strategie-web-des-organisations-internationales.php" class="url">L’utilisabilité dans la stratégie web des organisations internationales</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ergonomie" rel="tag">Ergonomie</a><br /><a href="http://www.paris-web.fr/2010/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>Comment appréhender ses utilisateurs dans le contexte mondial d’une organisation internationale comme l’ONU ? Quelle attitude avoir par rapport aux médias sociaux quand on est la Commission européenne ?</p>

<p>A partir de bons et de mauvais exemples, cette présentation s’attache à comprendre pourquoi les sites web d’organisations européennes ou internationales ont pendant longtemps négligé les notions d’utilisabilité et d’accessibilité, et pourquoi cette situation est en train d’évoluer dans le bon sens.</p>

<p>Les stratégies web qui découlent de ces nouvelles pratiques traduisent, dans une certaine mesure, le degré d’intérêt que ces organisations portent aux préoccupations quotidiennes des citoyens qu’elles sont censées servir.</p>

<p>La présentation sera suivie d'un test interactif avec le public.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/aurelie-valtat.php">Aurélie Valtat</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Aurélie Valtat" src="https://www.paris-web.fr/2010/assets_c/2010/07/aurelie-valtat-thumb-143x143-42.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Aurélie est une experte en communication institutionnelle et politique, avec une connaissance approfondie des outils de communication en ligne. Elle est actuellement responsable de communication en ligne à Eurocontrol, une organisation intergouvernementale chargée d'harmoniser le ciel européen. Elle conseille par ailleurs des dirigeants d'entreprise sur leur stratégie web pour Webtonic, une agence web basée à Bruxelles, et enseigne l'écriture web et la stratégie web à l'Université de Haute Bretagne II à Rennes.<br />
 <br />
Aurélie a commencé sa carrière dans la communication à l'Alliance Française de Bruxelles, puis au Centre du patrimoine mondial de l'UNESCO. Elle retourne à Bruxelles en 2005 pour diriger la communication du lobby postal européen PostEurop, avant de rejoindre Eurocontrol en 2007.<br />
 <br />
Aurélie est diplômée de l'Institut d'Etudes Politiques de Paris. Elle possède également un DESS d'administration internationale et une licence d'ethnologie.<br />
 <br />
Aurélie est mariée, a deux enfants, et passe beaucoup trop de temps devant son ordinateur, si vous demandez leur avis.<br />
 <br />
Sa bio en ligne: <a href="http://be.linkedin.com/in/aurelievaltat">http://be.linkedin.com/in/aurelievaltat</a><br />
Son blog: <a href="http://contentbites.posterous.com/">http://contentbites.posterous.com/</a><br />
Son actualité: <a href="http://twitter.com/avaltat">http://twitter.com/avaltat</a></p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/lutilisabilite-dans-la-strategie-web-des-organisations-internationales.php&amp;ref=prez-lutilisabilite-dans-la-strategie-web-des-orga&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
