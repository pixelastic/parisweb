...
<title>Paris Web - Le javascript server side, faire un point</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/internautes-sous-surveillance-retours-de-la-realite-pour-un-web-meilleur.php" title="Internautes sous surveillance : retours de la réalité pour un web meilleur" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/pause-ga.php" title="pause" />
	...
	<meta name="twitter:title" content="Le javascript server side, faire un point" />
	<meta property="twitter:description" content="nodeJS, claypool, aptana Jaxer, APE, map reduce en nosql, yql... Les serveurs ou frameworks javascript server side sont de plus en plus nombreux et évolués, une tendance de fond est en train…" />
	<meta property="dc:title" content="Le javascript server side, faire un point" />
	<meta property="og:title" content="Le javascript server side, faire un point" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/le-javascript-server-side-faire-un-point.php" />
	<meta property="og:description" content="nodeJS, claypool, aptana Jaxer, APE, map reduce en nosql, yql... Les serveurs ou frameworks javascript server side sont de plus en plus nombreux et évolués, une tendance de fond est en train…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le javascript server side, faire un point</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-96">
						<header>
							<h1>Le javascript server side, faire un point</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggsky?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-PA-01.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-96">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/le-javascript-server-side-faire-un-point.php" class="url">Le javascript server side, faire un point</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/javascript" rel="tag">JavaScript</a></dd>
    ...
    <div class="talk-description"><p>nodeJS, claypool, aptana Jaxer, APE, map reduce en nosql, yql... Les serveurs ou frameworks javascript server side sont de plus en plus nombreux et évolués, une tendance de fond est en train d'émerger. Et la mise en avant des outils dans la communauté progresse rapidement.</p>

<p>La promesse d'un seul langage sur le client et le serveur d'une application web est très attirante alors que HTML5, les websockets, les webworker, les local storage sont en train de se faire une place dans le futur du web.</p>

<p>Cette conférence a pour but de vous permettre de mieux appréhender cet écosystème à travers son historique, l'exposé des standards émergeant, des avantages et défauts des différentes solutions et paterns proposés et en présentant les briques communes à tout ces nouveaux outils.</p>

<p>Quels projets pouvez vous entreprendre sur ces technologies ?<br />
Est-ce possible à intégrer en production ?<br />
L'administration et l'intégration de ces outils au SI d'une entreprise est il possible ?<br />
Ces technologies vont elles s'implanter ou rester des expérimentations de techniciens sous stéroïdes ?<br />
Dans quelle direction aller pour commencer ?</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/quentin-adam.php">Quentin Adam</a></h2>
...
<div class="speaker-bio"><p>Geek depuis de longues années, <a href="http://twitter.com/waxzce">Quentin ADAM</a> programme depuis son adolescence pour le web. Une expérience qui lui a permis de fonder et diriger Kan OP, une jeune start up de service web depuis 2008, et qui lui permet de fonder aujourd'hui une nouvelle société qui propose des services dans le domaine du cloud computing.</p>

<p>Fan d'open source et de technologie libre et standard, il a longtemps travaillé en PHP avant de se consacrer aux technologies Java. Aujourd'hui, il travaille principalement sur les plateformes innovantes et Java, principalement sur les liens entre plateformes et langages, les environnements d'exécution alternatifs et l'intégration de jeunes technologies dans un <abbr title="système d'information">SI</abbr>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/le-javascript-server-side-faire-un-point.php&amp;ref=prez-le-javascript-server-side-faire-un-point&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
