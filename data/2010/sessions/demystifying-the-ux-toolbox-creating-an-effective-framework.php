...
<title>Paris Web - Demystifying the UX toolbox: creating an effective framework</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/le-web-vu-dun-client-grand-compte.php" title="Le web vu d’un client grand compte" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/la-conference-dont-vous-etes-le-heros.php" title="La conférence dont vous êtes le héros" />
	...
	<meta name="twitter:title" content="Demystifying the UX toolbox: creating an effective framework" />
	<meta property="twitter:description" content=" When companies or organisations embrace User Experience (UX) and its tools, such as personas and wireframing, inevitably these activities become over-formalized into a process that favours easy…" />
	<meta property="dc:title" content="Demystifying the UX toolbox: creating an effective framework" />
	<meta property="og:title" content="Demystifying the UX toolbox: creating an effective framework" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/demystifying-the-ux-toolbox-creating-an-effective-framework.php" />
	<meta property="og:description" content=" When companies or organisations embrace User Experience (UX) and its tools, such as personas and wireframing, inevitably these activities become over-formalized into a process that favours easy…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Demystifying the UX toolbox: creating an effective framework</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-98">
						<header>
							<h1>Demystifying the UX toolbox: creating an effective framework</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xi0zks?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/parisweb-ux-101015100808-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-GA-07.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-98">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/demystifying-the-ux-toolbox-creating-an-effective-framework.php" class="url">Demystifying the UX toolbox: creating an effective framework</a></span></span></h2>
...
<dd class="column">
<a href="/2010/15.php">vendredi 15</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
15 <abbr title="heures">h</abbr> 30
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><div class="span-6">
<p>
...
<p>
Une fois que les sociétés et organisations ont décidé d'adopter l'UX (expérience utilisateur) et ses outils, tels que les personas et le prototypage, inévitablement, ces activités tendent à trop se formaliser autour d'un processus qui favorise un établissement rapide des coûts et de la planification, sans forcément remettre le problème en contexte. Il est plus aisé de se concentrer sur une liste de points à livrer que de prendre le temps de découvrir la meilleure solution face à un problème donné.
</p><p>
Quelles sont les compétences en matière d'UX dont nous avons besoin pour un type particulier de projet ? À quel moment les spécifications fonctionnelles sont-elles nécessaires ? Quand pouvez-vous vous baser sur une feuille et un croquis -- et toutes les autres possibilités : prototypage réel, sur papier, interactif ? Quelles sont les méthodes d'approche de l'utilisateur les plus appropriées ?
</p><p>
Ensemble, nous examinerons l'ensemble des outils liés à l'UX, ainsi que ses méthodes d'évaluation, afin de nous permettre de construire notre propre jeu d'outils, celui qui fonctionnera pour nos propres besoins.
</p>
</div>
<div class="box clear">
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/stephanie-troeth.php">Stephanie Troeth</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stephanie Troeth" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_stephanie_troeth-thumb-143x143-35.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Steph est stratège en expérience utilisateur, et a tenu plus d'un rôle par le passé, dont celui de chef de produit pour une startup autour des livres numériques, et celui de Directrice de l'Intéractivité/la Technologie dans une agence montréalaise, où elle a mené une équipe pluridisciplinaire de chefs de projets, de designers d'interface, de graphistes, et des développeurs côté client comme côté serveur.</p>

<p>Pendant près de 10 ans, elle s'est impliquée dans la défense et la promotion des meilleures pratiques du développement Web, plus particulièrement au sein du <span lang="en">Web Standards Project</span>, où elle a participé à la mise en place de projets comme l'<span lang="en">Internation Liaison Group</span>, le <span lang="en">WaSP Interact Curriculum</span>, a fait partie de l'équipe fondatrice de l'<span lang="en">Open Web Education Alliance</span>.</p>

<p>Son expertise se retrouve dans sa grande capacité à mener des idées à maturité et à les réaliser. Une grand voyageuse qui vit désormais sur sa troisième île, elle parle plusieurs dialectes d'anglais, quelques autres langages, et dispose d'un accent indéchiffrable.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/demystifying-the-ux-toolbox-creating-an-effective-framework.php&amp;ref=prez-demystifying-the-ux-toolbox-creating-an-effec&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
