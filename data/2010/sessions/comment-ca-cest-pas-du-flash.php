...
<title>Paris Web - Comment ça c’est pas du Flash ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/remerciements.php" title="Remerciements" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/le-web-temps-reel.php" title="Le web temps réel" />
	...
	<meta name="twitter:title" content="Comment ça c’est pas du Flash ?" />
	<meta property="twitter:description" content="Les moteurs JavaScript récents sont ultra-rapides, on commence à pouvoir faire de vraies animations en CSS, on peut dessiner en bitmap comme en vectoriel dans plein de navigateurs, et la vraie 3D…" />
	<meta property="dc:title" content="Comment ça c’est pas du Flash ?" />
	<meta property="og:title" content="Comment ça c’est pas du Flash ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/comment-ca-cest-pas-du-flash.php" />
	<meta property="og:description" content="Les moteurs JavaScript récents sont ultra-rapides, on commence à pouvoir faire de vraies animations en CSS, on peut dessiner en bitmap comme en vectoriel dans plein de navigateurs, et la vraie 3D…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Comment ça c’est pas du Flash ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-46">
						<header>
							<h1>Comment ça c’est pas du Flash ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xgs8m4?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-46">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/comment-ca-cest-pas-du-flash.php" class="url">Comment ça c’est pas du Flash ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/technologie" rel="tag">Technologie</a></dd>
    ...
    <div class="talk-description"><p>Les moteurs JavaScript récents sont ultra-rapides, on commence à pouvoir faire de vraies animations en CSS, on peut dessiner en bitmap comme en vectoriel dans plein de navigateurs, et la vraie 3D accélérée sans plugin est en train de poindre le bout de son nez…</p>

<p>En somme, Flash n’a plus guère d'argument côté effets visuels. D'autant qu'il prend, au final, beaucoup plus de ressources que ses alternatives.</p>

<p>Alors, qu'est-ce que vous attendez pour vous y mettre ? Cet atelier fera un tour d'horizon des possibilités, exemples à l'appui, afin de vous mettre le pied à l'étrier.</p></div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/comment-ca-cest-pas-du-flash.php&amp;ref=prez-comment-ca-cest-pas-du-flash&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
