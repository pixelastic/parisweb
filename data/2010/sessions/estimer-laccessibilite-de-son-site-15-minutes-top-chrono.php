...
<title>Paris Web - Estimer l’accessibilité de son site, 15 minutes top chrono !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/a-lheure-de-youtube-et-de-google-earth-le-texte-est-il-le-parent-pauvre-du-web.php" title="Le texte : parent pauvre du web ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/mini-conferences/methode-daisy-les-css-feuille-a-feuille.php" title="Méthode Daisy : les CSS feuille à feuille" />
	...
	<meta name="twitter:title" content="Estimer l’accessibilité de son site, 15 minutes top chrono !" />
	<meta property="twitter:description" content="Dans cette mini-conférence nous vous montrerons qu'en à peine 15 minutes, avec un minimum de connaissances et les bons outils, on peut tout à fait se faire une idée de l'accessibilité d'un site. Au…" />
	<meta property="dc:title" content="Estimer l’accessibilité de son site, 15 minutes top chrono !" />
	<meta property="og:title" content="Estimer l’accessibilité de son site, 15 minutes top chrono !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/mini-conferences/estimer-laccessibilite-de-son-site-15-minutes-top-chrono.php" />
	<meta property="og:description" content="Dans cette mini-conférence nous vous montrerons qu'en à peine 15 minutes, avec un minimum de connaissances et les bons outils, on peut tout à fait se faire une idée de l'accessibilité d'un site. Au…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Estimer l’accessibilité de son site, 15 minutes top chrono !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-103">
						<header>
							<h1>Estimer l’accessibilité de son site, 15 minutes top chrono !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh6fg0?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
				
				 <a href="https://www.strongspace.com/padawan/parisweb/pw2010/Jeudi_PA_14h00.mp4" onClick="recordOutboundLink(this, 'Téléchargements', 'Vidéos');return false;" title="Vidéo au format MP4">Télécharger la vidéo</a>
	...
	<section class="s-talk-subject" id="sujet-103">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/mini-conferences/estimer-laccessibilite-de-son-site-15-minutes-top-chrono.php" class="url">Estimer l’accessibilité de son site, 15 minutes top chrono !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/accessibilite" rel="tag">Accessibilité</a></dd>
    ...
    <div class="talk-description"><p>Dans cette mini-conférence nous vous montrerons qu'en à peine 15 minutes, avec un minimum de connaissances et les bons outils, on peut tout à fait se faire une idée de l'accessibilité d'un site. Au cours de la présentation, un des intervenants réalisera en direct l'évaluation d'un site pendant que l'autre commentera en direct chacune des opérations réalisées.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/laurent-denis.php">Laurent Denis</a> et <a href="https://www.paris-web.fr/2010/../orateurs/aurelien-levy.php">Aurélien Levy</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Laurent Denis" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_laurent_denis-thumb-143x143-37.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Laurent Denis a longtemps exercé comme enseignant en milieu universitaire et scolaire. C’est dans le cadre de ses activités d’enseignement qu’il a été amené à s’intéresser puis à se spécialiser sur l’accessibilité, les formats Web standards et les technologies CSS dès la fin des années 90.</p>

<p>Rédacteur en chef du projet <a class="spip_out" href="http://openweb.eu.org">OpenWeb</a>, il a publié divers articles sur ces technologies.</p>

<p>Il est l’un des auteurs du Référentiel général d’Accessibilité pour les Administrations (RGAA), et par ailleurs Expert AccessiWeb en Evaluation.</p>

<p>Associé <a class="spip_out" href="http://www.temesis.com/">Temesis</a> depuis 2005, il est chargé au sein de la société de piloter les activités de formation de la société et d’assister les grands comptes dans leur démarche accessibilité.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Aurélien Levy" src="https://www.paris-web.fr/2010/assets_c/2010/07/aurelien-levy-thumb-143x143-41.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après une formation initiale de graphiste, Aurélien a complété ses connaissances par une formation de concepteur réalisateur multimédia à l’Institut Supérieur des Arts. En janvier 2004, il devient l’un des premiers "experts Accessiweb en évaluation". Il est depuis septembre 2008 expert accessibilité pour le compte de la société Temesis.</p>

<p>Il a notamment co-rédigé le nouveau Référentiel Général d’Accessibilité pour les Administrations de la <abbr title="Direction Générale de la Modernisation de l’État">DGME</abbr> dans le cadre du décret de la loi Handicap (février 2005) et animé plusieurs conférences dans le domaine de l’accessibilité (<abbr title="Innovation Publiques">INOP</abbr>, <abbr title="Rencontres mondiales du Logiciel Libre">RMLL</abbr>, réunions des experts du Groupe de Travail Accessiweb, Paris-web 2007,... ). Il a contribué à la prise en compte de l’accessibilité dans des groupes comme <span lang="en">Merck Sharp &amp; Dohme-Chibret</span>, <span lang="en">Mistergooddeal</span>, Crédit agricole, la Documentation Française et l’<abbr title="Office National des Forêts">ONF</abbr>.</p>

<p>A titre personnel, il est également un des correspondants en France du <abbr lang="en" title="Web Standards Project">WaSP</abbr>-<abbr lang="en" title="International Liaison Group">ILG</abbr> ce qui l’amène à organiser régulièrement des <a class="spip_out" href="http://france.w3cafe.org/">W3Cafés</a>.</p>

<p>Il est l’auteur de multiples articles au travers de son blog (<span lang="en"><a class="spip_out" href="http://www.fairytells.net/">Fairytells</a></span>) ou d’<span lang="en"><a class="spip_out" href="http://openweb.eu.org/">OpenWeb</a></span>.</p>

<p>Enfin, il est l’initiateur de <a class="spip_out" href="http://www.web-pour-tous.org/spip.php?page=petition-accessibilite">la pétition "pour l’accessibilité numérique"</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/mini-conferences/estimer-laccessibilite-de-son-site-15-minutes-top-chrono.php&amp;ref=prez-estimer-laccessibilite-de-son-site-15-minutes&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
