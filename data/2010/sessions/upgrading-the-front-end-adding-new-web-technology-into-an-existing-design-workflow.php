...
<title>Paris Web - Upgrading The Front End: adding new web technology into an existing design workflow</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/pause-3.php" title="pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/un-framework-html-est-il-possible.php" title="Un framework html est-il possible ?" />
	...
	<meta name="twitter:title" content="Upgrading The Front End: adding new web technology into an existing…" />
	<meta property="twitter:description" content=" Web designers are required to understand more and more about the front end web stack. All along we've had to wrestle with cross-browser issues, CSS layouts, and the limitations of web typography.…" />
	<meta property="dc:title" content="Upgrading The Front End: adding new web technology into an existing design workflow" />
	<meta property="og:title" content="Upgrading The Front End: adding new web technology into an existing design workflow" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/upgrading-the-front-end-adding-new-web-technology-into-an-existing-design-workflow.php" />
	<meta property="og:description" content=" Web designers are required to understand more and more about the front end web stack. All along we've had to wrestle with cross-browser issues, CSS layouts, and the limitations of web typography.…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Upgrading The Front End: adding new web technology into an existing design workflow</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-40">
						<header>
							<h1>Upgrading The Front End: adding new web technology into an existing design workflow</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xhgdbm?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-GA-03.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-40">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/upgrading-the-front-end-adding-new-web-technology-into-an-existing-design-workflow.php" class="url">Upgrading The Front End: adding new web technology into an existing design workflow</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/design" rel="tag">Design</a></dd>
...
<p>Web designers are required to understand more and more about the front end web stack. All along we've had to wrestle with cross-browser issues, CSS layouts, and the limitations of web typography.</p>

<p>But the rapidly-changing web has added more new tricks in recent years. The fast-paced development of CSS3, HTML5, and the increasing viability of custom web fonts and the mobile web are rapidly making our old skills seem outdated.</p>

<p>In this talk we will examine strategies for adjusting our workflows to include these new technologies, while at the same time providing fallbacks for browsers that haven't caught up yet.</p>

</div><div class="span-6 last">

<p>Il est de plus en plus demandé aux webdesigners de connaître toutes les technologies liées au navigateur. En parallèle, nous devons nous battre avec les problèmes de compatibilité entre les navigateurs, les mises en page CSS3, et les limites de la typographie sur le Web.</p>

<p>Mais le web évolue toujours plus rapidement, et de nouvelles possibilités se sont ajoutées ces dernières années. Le développement rapide de CSS3 et de HTML5, ainsi que la crédibilité grandissante des « custom web fonts » et du web mobile, font que nos compétences semblent dépassées.</p>

<p>Durant cette conférence, nous examinerons les stratégies permettant d'adapter nos processus pour y inclure ces nouvelles technologies, tout en tenant compte des navigateurs qui ne sont pas encore au goût du jour.</p>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/dave-shea.php">Dave Shea</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Dave Shea" src="https://www.paris-web.fr/2010/assets_c/2010/07/dave-shea-thumb-143x143-5.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p><span lang="en">Dave Shea</span> est le créateur et jardinier du célèbre site <a href="http://www.csszengarden.com/" hreflang="en">csszengarden.com</a>, et coauteur du livre « Le Zen des CSS » avec Molly Holzschlag (2005).</p>

<p>Il travaille au quotidien sur des projets de tous types par le biais de <a hreflang="en" href="http://www.brightcreative.com/">Bright Creative</a>, son studio personnel basé à Vancouver, au Canada. Il a la chance de compter parmi ses clients des sociétés comme Joyent, Google, CNet et Six Apart, entre autres. Il participe à des conférences et ateliers dans le monde entier. Vous l'avez peut-être croisé à <span lang="en">SXSW, Carson Workshops, FITC, Web Directions</span>, ou d'autres.</p>

<p><small>Crédit photo à <a href="http://www.flickr.com/photos/plasticbag/3365928996/">Tom Coates</a>.</small></p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/upgrading-the-front-end-adding-new-web-technology-into-an-existing-design-workflow.php&amp;ref=prez-upgrading-the-front-end-adding-new-web-techno&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
