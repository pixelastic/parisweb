...
<title>Paris Web - Le web vu d’un client grand compte</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/pause-5.php" title="pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/demystifying-the-ux-toolbox-creating-an-effective-framework.php" title="Demystifying the UX toolbox: creating an effective framework" />
	...
	<meta name="twitter:title" content="Le web vu d’un client grand compte" />
	<meta property="twitter:description" content="L'exposition des enjeux, des organisations et des cultures de grands comptes de l'énergie pourrait permettre de mieux comprendre les attentes et les impératifs des clients. Le point de vue client et…" />
	<meta property="dc:title" content="Le web vu d’un client grand compte" />
	<meta property="og:title" content="Le web vu d’un client grand compte" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/le-web-vu-dun-client-grand-compte.php" />
	<meta property="og:description" content="L'exposition des enjeux, des organisations et des cultures de grands comptes de l'énergie pourrait permettre de mieux comprendre les attentes et les impératifs des clients. Le point de vue client et…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le web vu d’un client grand compte</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-70">
						<header>
							<h1>Le web vu d’un client grand compte</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh9c30?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-PA-08.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-70">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/le-web-vu-dun-client-grand-compte.php" class="url">Le web vu d’un client grand compte</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>L'exposition des enjeux, des organisations et des cultures de grands comptes de l'énergie pourrait permettre de mieux comprendre les attentes et les impératifs des "clients". Le point de vue "client" et les attentes des prestataires seront expliqués et également pourquoi il y a autant d’interlocuteurs, pourquoi il faille travailler dans l’urgence, pourquoi les clients ne connaissent pas internet, pourquoi les délais sont si courts…</p>

<p>Cette présentation doit vous permettre  de comprendre le raisonnement des "clients" et  de partager des clés de lecture  de leurs conduites.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/pascal-aubin.php">Pascal Aubin</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Pascal Aubin" src="https://www.paris-web.fr/2010/assets_c/2010/07/pascal_aubin-thumb-143x143-19.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Responsable Maitrise d'ouvrage web du marché énergie france particulier de GDF SUEZ.<br />
Pascal a commencé en 1999 en tant que webdesigner et chef de projet web au sein de sa commune, puis chez EDF pour s'occuper du site B2B (business to business, marché entreprises). Il a participé à la mise en oeuvre des standards web sur ce site en 2004.<br />
Il est très attaché à la qualité des Interfaces Homme-Machine, à l'utilisabilité. Son cheval de bataille est d'orienté les applications vers les utilisateurs.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/le-web-vu-dun-client-grand-compte.php&amp;ref=prez-le-web-vu-dun-client-grand-compte&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
