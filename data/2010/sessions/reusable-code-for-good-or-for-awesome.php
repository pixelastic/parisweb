...
<title>Paris Web - Reusable Code, for good or for awesome!</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/pause-1.php" title="pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/methodologie-du-design-dexperience-utilisateur.php" title="Méthodologie du Design d’expérience utilisateur" />
	...
	<meta name="twitter:title" content="Reusable Code, for good or for awesome!" />
	<meta property="twitter:description" content=" What sets reusable JavaScript apart from other JavaScript? How can we make our code developer-friendly, fast, robust &amp; compatible? In this talk we'll cover testing, code structure, working with…" />
	<meta property="dc:title" content="Reusable Code, for good or for awesome!" />
	<meta property="og:title" content="Reusable Code, for good or for awesome!" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/reusable-code-for-good-or-for-awesome.php" />
	<meta property="og:description" content=" What sets reusable JavaScript apart from other JavaScript? How can we make our code developer-friendly, fast, robust &amp; compatible? In this talk we'll cover testing, code structure, working with…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Reusable Code, for good or for awesome!</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-56">
						<header>
							<h1>Reusable Code, for good or for awesome!</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xgmaoy?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-GA-05.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-56">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/reusable-code-for-good-or-for-awesome.php" class="url">Reusable Code, for good or for awesome!</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/javascript" rel="tag">JavaScript</a></dd>
...
</div><div class="span-6 last"><!-- <h3><abbr title="version française">VF</abbr> : Du code réutilisable, parce que c'est bien ou parce que c'est génial !</h3> -->

<p>Quelle est la différence entre le code JavaScript réutilisable et celui qui ne l'est pas ? Comment pouvons-nous rendre notre code plus accessible aux développeurs, plus rapide, plus robuste tout en restant compatible ?</p>

<p>Lors de cette conférence, Jake Archibald parlera de tests, de structure de code, du travail avec les compresseurs, de la documentation, de la mesure des performances, le tout en se concentrant sur la conception d'API.</p>

<p>L'API détermine la réussite ou l'échec du code réutilisable. C'est elle qui permet aux autres développeurs d'utiliser votre application ; si elle est trop compliquée à utiliser, ils ne parviendront pas à exploiter pleinement ce que vous avez conçu.</p>

<p>Nous analyserons les API existantes, noterons leurs échecs et leurs succès, observerons les motifs récurrents qu'elles utilisent, et comment les utilisateurs en font usage.</p>

<p>En analysant leurs réussites et leurs échecs en production, nous seront à même de découvrir ce qui fait que du code peut être agréable à utiliser et réutiliser.</p>

</div>
<div class="box clear"><p class="last"><abbr lang="la" title="nota bene">N.B.</abbr> : cette conférence sera en anglais, avec traduction simultanée.</p></div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/jake-archibald.php">Jake Archibald</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jake Archibald" src="https://www.paris-web.fr/2010/assets_c/2010/07/jake-archibald-thumb-143x143-21.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p><span lang="en">Jake Archibald</span> est un développeur client à la <abbr lang="en">BBC</abbr>, travaillant sur le projet <span lang="en">Glow</span>, une bibliothèque développée pour répondre aux standards de design et d'accessibilité de la société. Il travaille également au sein des groupes de travail de la <abbr lang="en">BBC</abbr>, qui étudient et développent les Règles et Directives de la société, avec une emphase sur les standards du Web et l'utilisabilité.</p>

<p>En dehors de son travail à la <abbr lang="en">BBC</abbr>, <span lang="en">Jake</span> est un photographe enthousiaste, un adepte de la retouche photo, et un fan de sports moto.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/reusable-code-for-good-or-for-awesome.php&amp;ref=prez-reusable-code-for-good-or-for-awesome&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
