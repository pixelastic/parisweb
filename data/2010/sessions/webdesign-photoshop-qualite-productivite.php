...
<title>Paris Web - Webdesign et Photoshop : qualité et productivité</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/web-semantique-un-bapteme-technique.php" title="Web sémantique, un baptême technique" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/html5-et-css3-dans-la-vraie-vie.php" title="Plus belle la vie avec HTML5 et CSS3" />
	...
	<meta name="twitter:title" content="Webdesign et Photoshop : qualité et productivité" />
	<meta property="twitter:description" content="La qualité web est un tout, et si il est plus ou moins acquis qu'il faut faire un code propre, valide et accessible, il n'en est pas forcement de même pour les sources ou les livrables en design.…" />
	<meta property="dc:title" content="Webdesign et Photoshop : qualité et productivité" />
	<meta property="og:title" content="Webdesign et Photoshop : qualité et productivité" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/webdesign-photoshop-qualite-productivite.php" />
	<meta property="og:description" content="La qualité web est un tout, et si il est plus ou moins acquis qu'il faut faire un code propre, valide et accessible, il n'en est pas forcement de même pour les sources ou les livrables en design.…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Webdesign et Photoshop : qualité et productivité</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-128">
						<header>
							<h1>Webdesign et Photoshop : qualité et productivité</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xgtz9h?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-128">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/webdesign-photoshop-qualite-productivite.php" class="url">Webdesign et Photoshop : qualité et productivité</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/design" rel="tag">Design</a><br /><a href="http://www.paris-web.fr/2010/recherche/qualite" rel="tag">Qualité</a></dd>
    ...
    <div class="talk-description"><p>La qualité web est un tout, et si il est plus ou moins acquis qu'il faut faire un code propre, valide et accessible, il n'en est pas forcement de même pour les sources ou les livrables en design. Pourtant, tout comme pour le code, il existe des bonnes pratiques à mettre en œuvre dans vos fichiers, pour gagner en optimisation, qualité et productivité.</p>

<p>Cet atelier vise à vous faire découvrir des aspects méconnus de Photoshop qui vous permettront de gagner du temps et de livrer des fichiers efficace à l'intégrateur, ou de vous faciliter la tâche si vous intégrez vous même vos maquettes, ou si les maquettes nécessitent de nombreuses itérations.</p>

<p>Il ne s'agit pas de simples trucs et astuces mais d'une méthodologie orientée production web qui met à profit des fonctions poussées de Photoshop (variables d'images, scripts JavaScript…).</p>

<p>Le sujet Photoshop <abbr title="versus" lang="en">vs</abbr> Illustrator en webdesign sera également abordé.</p>

<p>Une bonne connaissance de Photoshop est recommandée pour profiter au mieux de l'atelier. Il s'agit d'un atelier purement technique, et l'aspect création de sera pas abordé.</p>

<div class="box">
<p class="last">
Pour suivre au mieux cet atelier il vous conseillé d'apporter votre ordinateur portable accompagné d'une version récente de Photoshop. </p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/julien-dubedout.php">Julien Dubedout</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Julien Dubedout" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_julien-dubedout-thumb-143x143-68.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p><a href="http://www.inkboy.fr">Julien Dubedout</a> est directeur artistique chez Publicis Modem, après avoir été webdesigner freelance à Toulouse. Tombé dans photoshop quand il était petit (1998) il a également été formateur en webdesign et sur les outils adobe en entreprise, dans des centres de formation ou des écoles de graphisme.</p>

<p>Spécialiste des outils de la creative suite (et partisan du moindre effort :) ), il a développé des techniques pragmatiques afin d'être le plus productif possible en utilisant au mieux les différents logiciels et en optimisant les fichiers sources pour qu'ils soient parfaitement intégrés au workflow, en prenant notamment en compte la phase de modification client et celle de l'intégration HTML.</p>

<p>Majoritairement autodidacte (bien que titulaire d'un BTS communication visuelle/multimédia), il touche à tous les domaines afférents à la création web : front-end development, accessibilité, ergonomie, CMS, et il s'intéresse également à la photographie et aux aspects juridiques des métiers de la création. Il a créé le <a href="http://www.mariejulien.com">blog d'infos pour freelances</a> et est président de l'association métiers graphiques.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/webdesign-photoshop-qualite-productivite.php&amp;ref=prez-webdesign-photoshop-qualite-productivite&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
