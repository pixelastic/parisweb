...
<title>Paris Web - La macrotypographie de la page Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/rendre-une-application-dentreprise-accessible-contraintes-et-pragmatisme.php" title="Rendre une application d'entreprise accessible : contraintes et pragmatisme" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/pause-2.php" title="pause" />
	...
	<meta name="twitter:title" content="La macrotypographie de la page Web" />
	<meta property="twitter:description" content="Si la typographie désigne à l'origine une technique d'impression à l'aide de caractères mobiles en métal, elle recouvre aujourd'hui tous les paramètres de la composition d'un document écrit, de…" />
	<meta property="dc:title" content="La macrotypographie de la page Web" />
	<meta property="og:title" content="La macrotypographie de la page Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/macrotypographie-page-web.php" />
	<meta property="og:description" content="Si la typographie désigne à l'origine une technique d'impression à l'aide de caractères mobiles en métal, elle recouvre aujourd'hui tous les paramètres de la composition d'un document écrit, de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>La macrotypographie de la page Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-117">
						<header>
							<h1>La macrotypographie de la page Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xfpf08?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/macrotypopageweb-101020051812-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-GA-02.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-117">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/macrotypographie-page-web.php" class="url">La macrotypographie de la page Web</a></span></span></h2>
...
<dd class="column">
 9 <abbr title="heures">h</abbr> 55
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/typographie" rel="tag">Typographie</a></dd>
    ...
    <div class="talk-description"><p>Si la typographie désigne à l'origine une technique d'impression à l'aide de caractères mobiles en métal, elle recouvre aujourd'hui tous les paramètres de la composition d'un document écrit, de l'échelle du caractère à celle de la page, voire du livre dans le cas du papier. On peut donc distinguer dans cette discipline la branche qui s'attache au caractère et à son dessin, de celle qui se préoccupe de la mise en page, et c'est cette dernière qui nous intéresse ici.</p>

<p>Les fondations de la mise en page telle que nous la connaissons actuellement remontent aux premiers codex, ancêtres de nos livres modernes. C'est sur cette base que se sont développées toutes les règles et habitudes de mise en page appliquées par les copistes, puis les typographes et les graphistes depuis des siècles. Naturellement, de nombreux réflexes de conception propres au livre et au support papier au sens large ont été importés vers la page Web.</p>

<p>À travers un dialogue entre page Web et papier, cette conférence veut aborder tous les paramètres de la macrotypographie (concept de page, marges, grilles, dimensionnement des blocs, etc.) et leur impact sur la lisibilité et l'esthétique ; nous chercherons à prendre du recul vis-à-vis de nos réflexes de conception pour mieux exploiter les spécificités du média Web et d'employer avec discernement la richesse de la typographie « classique » pour guider et enrichir la conception de pages claires et utiles, mais aussi originales et esthétiques.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/anne-sophie-fradier.php">Anne-Sophie Fradier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Anne-Sophie Fradier" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_anne_sophie_fradier-thumb-143x143-47.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Amoureuse de la lettre avant tout, j'ai exploré le design Web en autodidacte pendant plusieurs années avant de renouer avec ma passion première pour le papier, la calligraphie et la typographie.</p>

<p>Si mon métier est la traduction (j'ai notamment traduit CSS Zen Garden de Dave Shea et Molly Holzschlag), je m'intéresse surtout aux moyens de dépasser la querelle qui renvoie dos à dos papier et écran quand il s'agit de typographie.</p>

<p>Mon sport préféré ? Vendre le concept de livre électronique à un ancien de l'Imprimerie nationale.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/macrotypographie-page-web.php&amp;ref=prez-macrotypographie-page-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
