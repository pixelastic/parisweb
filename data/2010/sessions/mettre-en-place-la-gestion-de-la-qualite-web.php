...
<title>Paris Web - Mettre en place la gestion de la qualité web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/card-sorting.php" title="Ne perdez plus vos internautes : faites du « card sorting »" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/web-semantique-un-bapteme-technique.php" title="Web sémantique, un baptême technique" />
	...
	<meta name="twitter:title" content="Mettre en place la gestion de la qualité web" />
	<meta property="twitter:description" content="Le but de cet atelier est plus de partager un expérience que de transmettre des connaissances. J'y présenterait comment et pourquoi la société dans laquelle je travaille – un grand groupe financier –…" />
	<meta property="dc:title" content="Mettre en place la gestion de la qualité web" />
	<meta property="og:title" content="Mettre en place la gestion de la qualité web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/mettre-en-place-la-gestion-de-la-qualite-web.php" />
	<meta property="og:description" content="Le but de cet atelier est plus de partager un expérience que de transmettre des connaissances. J'y présenterait comment et pourquoi la société dans laquelle je travaille – un grand groupe financier –…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Mettre en place la gestion de la qualité web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-123">
						<header>
							<h1>Mettre en place la gestion de la qualité web</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-123">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/mettre-en-place-la-gestion-de-la-qualite-web.php" class="url">Mettre en place la gestion de la qualité web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/qualite" rel="tag">Qualité</a></dd>
    ...
    <div class="talk-description"><p>Le but de cet atelier est plus de partager un expérience que de transmettre des connaissances.</p>

<p>J'y présenterait comment et pourquoi la société dans laquelle je travaille – un grand groupe financier – à choisi de mettre en place la gestion de la qualité web.</p>

<p>Il s'agira ensuite de détailler les différents aspects de la mission du qualiticien web et en particulier l'exercice de l'audit : comment faire un audit de qualité web mais surtout, quelle analyse en faire et comment en exploiter les résultats.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/delphine-malassingne.php">Delphine Malassingne</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Delphine Malassingne" src="https://www.paris-web.fr/2010/assets_c/2010/07/delphine-thumb-143x143-43.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>
					Après une formation artistique, Delphine a souhaité exercer son goût pour la communication par l’image via le webdesign.
					Passionnée par toutes les problématiques d’interface, c’est naturellement qu’elle s’est ouverte à l’ergonomie,
					à l’expérience utilisateur, au référencement naturel, etc.
					Un passage sur le forum Webmaster Hub l’a mise sur la voie des standards du web et de l’accessibilité.
				</p>
				<p>
					Intégrateur depuis 2001, elle assure maintenant le suivi et la gestion de la qualité web au sein d’une société financière.
				</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/mettre-en-place-la-gestion-de-la-qualite-web.php&amp;ref=prez-mettre-en-place-la-gestion-de-la-qualite-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
