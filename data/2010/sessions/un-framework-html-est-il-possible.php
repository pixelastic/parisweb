...
<title>Paris Web - Un framework html est-il possible ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/upgrading-the-front-end-adding-new-web-technology-into-an-existing-design-workflow.php" title="Upgrading The Front End: adding new web technology into an existing design workflow" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/mini-conferences/comment-un-vigneron-etranger-utilise-le-web-pour-sintegrer-dans-la-france-rurale.php" title="Comment un vigneron étranger utilise le web pour s'intégrer dans la France rurale" />
	...
	<meta name="twitter:title" content="Un framework html est-il possible ?" />
	<meta property="twitter:description" content="L'intégrateur dispose de frameworks CSS. Le développeur back-end de nombre de frameworks de développement, agrémentés de gestion de données, ou de CMS enrichis de briques génériques. Mais au milieu…" />
	<meta property="dc:title" content="Un framework html est-il possible ?" />
	<meta property="og:title" content="Un framework html est-il possible ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/un-framework-html-est-il-possible.php" />
	<meta property="og:description" content="L'intégrateur dispose de frameworks CSS. Le développeur back-end de nombre de frameworks de développement, agrémentés de gestion de données, ou de CMS enrichis de briques génériques. Mais au milieu…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Un framework html est-il possible ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-185">
						<header>
							<h1>Un framework html est-il possible ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggq8v?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/z-101019160439-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-PA-03.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-185">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/un-framework-html-est-il-possible.php" class="url">Un framework html est-il possible ?</a></span></span></h2>
...
<dd class="column location"><a href="/lieux/">Voir le plan</a></dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/design" rel="tag">Design</a></dd>
    ...
    <div class="talk-description"><p>L'intégrateur dispose de frameworks CSS. Le développeur back-end de nombre de frameworks de développement, agrémentés de gestion de données, ou de CMS enrichis de briques génériques. </p>

<p>Mais au milieu de la chaîne, le développeur front-end semble condamné à recommencer à zéro à chaque projet, balloté entre les contraintes issues du design fonctionnel d'une part, et les contraintes techniques imposées par les développeurs. </p>

<p>Industrialiser le développement de sites web suppose un maximum de standardisation et de réutilisation de composants. C'est cette réutilisation qui permet de conjuguer rapidité et qualité constante. </p>

<p>A travers plusieurs projets, j'ai cherché à mettre en place un outil qui permette cela pour le développement front-end. </p>

<p>Constitué d'un cadre orienté contenu, et conçu de retours d'expérience en situation de production, il propose une organisation et des mécanismes facilitant la mise en place d'un front, et permettant des gains de temps en situation de production tout en préservant les libertés des développeurs. </p>

<p>Une implémentation opérationnelle et utilisable dans le cadre d'un CMS permet déjà d'évaluer son intérêt en situation. J'aborderai la possibilité de généraliser ce cadre et ces mécanismes à travers des implémentations dans d'autres langages de gabarit.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/cedric-morin.php">Cédric Morin</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Cédric Morin" src="https://www.paris-web.fr/2010/assets_c/2010/09/orateur_cedric-morin-thumb-143x143-82.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Cédric Morin est consultant freelance en développements web et core-développeur du projet libre SPIP. </p>

<p>Geek biberonné au C64 et aux premiers IBM PC, il s'est égaré 10 ans dans l'industrie automobile. En 2005 il revient à ses premières amours, et découvre le Web. Il y travaille en équipe dans un contexte de production de sites, et devient contributeur de SPIP (Système de publication pour Internet). </p>

<p>Il intervient maintenant en freelance sur des projets techniques construits autour de cette plateforme, tout en développant assidument de nouvelles fonctionnalités et de nouveaux outils dans son écosystème libre. </p>

<p>Passionné de technique, toujours à la recherche d'un défi à relever, il essaye notamment de mettre en place des outils pour démocratiser les technologies, simplifier et améliorer les processus de développement pour celles et ceux dont c'est le métier.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/un-framework-html-est-il-possible.php&amp;ref=prez-un-framework-html-est-il-possible&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
