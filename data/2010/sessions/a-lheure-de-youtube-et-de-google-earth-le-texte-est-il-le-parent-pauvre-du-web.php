...
<title>Paris Web - Le texte : parent pauvre du web ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/repas-1.php" title="repas" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/mini-conferences/estimer-laccessibilite-de-son-site-15-minutes-top-chrono.php" title="Estimer l’accessibilité de son site, 15 minutes top chrono !" />
	...
	<meta name="twitter:title" content="Le texte : parent pauvre du web ?" />
	<meta property="twitter:description" content="Quelle est la place du texte dans l'expérience utilisateur ? Quel est le rôle du texte dans le référencement, la publicité, l'accessibilité ? Quel est l'impact des mots sur les taux de conversion ?…" />
	<meta property="dc:title" content="Le texte : parent pauvre du web ?" />
	<meta property="og:title" content="Le texte : parent pauvre du web ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/a-lheure-de-youtube-et-de-google-earth-le-texte-est-il-le-parent-pauvre-du-web.php" />
	<meta property="og:description" content="Quelle est la place du texte dans l'expérience utilisateur ? Quel est le rôle du texte dans le référencement, la publicité, l'accessibilité ? Quel est l'impact des mots sur les taux de conversion ?…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le texte : parent pauvre du web ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-88">
						<header>
							<h1>Le texte : parent pauvre du web ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggskb?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-GA-04.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-88">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/a-lheure-de-youtube-et-de-google-earth-le-texte-est-il-le-parent-pauvre-du-web.php" class="url">Le texte : parent pauvre du web ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/contenu" rel="tag">Contenu</a></dd>
    ...
    <div class="talk-description"><p>Quelle est la place du texte dans l'expérience utilisateur ?<br />
Quel est le rôle du texte dans le référencement, la publicité, l'accessibilité ?<br />
Quel est l'impact des mots sur les taux de conversion ?<br />
Une vidéo est-elle automatiquement plus attractive que du simple texte ?<br />
Le haut débit généralisé et le HTML riche signifient-ils la mort prochaine des contenus textuels ?</p>

<p>A travers quelques données statistiques et plusieurs cas concrets, je voudrais souligner la place centrale du texte dans la réalité d'Internet.<br />
Et, à partir de ce constat, déboucher sur quelques recommandations pour une maîtrise avancée des contenus rédactionnels.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/jean-marc-hardy.php">Jean-Marc Hardy</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jean-Marc Hardy" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_jean-marc-Hardy-thumb-143x143-73.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Jean-Marc Hardy a démarré sa carrière en agence de communication. En 2001, alors qu'il était responsable du département web au sein de l'agence Qwentès, il a créé le site redaction.be. Comme journaliste de formation, il désirait s'interroger sur les conséquences des nouveaux médias sur les métiers de la rédaction. Le dossier "Existe-t-il une écriture web ?", réalisé à l'époque, reste accessible en ligne.</p>

<p>Entre-temps, Jean-Marc Hardy a entrepris de créer toute une activité centrée sur la stratégie éditoriale sur le web. Il s'est entouré de collaborateurs de qualité et a fondé le label 60questions.net qui offre des formations et du conseil en stratégie éditoriale, architecture d'information, ergonomie et référencement, rédaction pour le web, évaluation de la qualité des sites web.</p>

<p>Jean-Marc Hardy est également l'auteur du livre "Réussir son site web en 60 fiches", publié aux éditions DUNOD. Le but de cet ouvrage est de développer une vision large de la qualité web, à l'intersection des métiers informatiques, graphiques, journalistiques et marketing.</p>

<p>Jean-Marc Hardy enseigne ou a enseigné dans plusieurs hautes écoles : Saint-Louis, ICHEC, EPFC et l'Université de Metz.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/a-lheure-de-youtube-et-de-google-earth-le-texte-est-il-le-parent-pauvre-du-web.php&amp;ref=prez-a-lheure-de-youtube-et-de-google-earth-le-tex&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
