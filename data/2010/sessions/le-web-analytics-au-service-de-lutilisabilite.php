...
<title>Paris Web - Le Web Analytics au service de l’utilisabilité</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/html5-pour-mon-ordinateur-et-mon-mobile.php" title="HTML5 pour mon ordinateur et mon mobile" />
	...
	<meta name="twitter:title" content="Le Web Analytics au service de l’utilisabilité" />
	<meta property="twitter:description" content="L'objectif de cette session est de présenter de manière pratique les indicateurs à suivre et les types de mesures à effectuer sur un site afin d'améliorer sa performance : Présentation du Web…" />
	<meta property="dc:title" content="Le Web Analytics au service de l’utilisabilité" />
	<meta property="og:title" content="Le Web Analytics au service de l’utilisabilité" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/le-web-analytics-au-service-de-lutilisabilite.php" />
	<meta property="og:description" content="L'objectif de cette session est de présenter de manière pratique les indicateurs à suivre et les types de mesures à effectuer sur un site afin d'améliorer sa performance : Présentation du Web…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le Web Analytics au service de l’utilisabilité</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-132">
						<header>
							<h1>Le Web Analytics au service de l’utilisabilité</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/parisweb2010-webanalytics-101016122119-phpapp02" 
	...
	<section class="s-talk-subject" id="sujet-132">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/le-web-analytics-au-service-de-lutilisabilite.php" class="url">Le Web Analytics au service de l’utilisabilité</a></span></span></h2>
...
<dd class="column">
15 <abbr title="heures">h</abbr> 40
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ergonomie" rel="tag">Ergonomie</a></dd>
    ...
    <div class="talk-description">L'objectif de cette session est de présenter de manière pratique les indicateurs à suivre et les types de mesures à effectuer sur un site afin d'améliorer sa performance :
<ul>
<li>Présentation du Web Analytics : mesure d'audience et tracking de campagne
<li>les principaux KPIs et leur pertinence en fonction de cas pratiques : <ul>
   <li>consommation de l'information : taux de rebond, temps passé sur le site, PV/Visites…</li>
   <li>parcours utilisateurs et identification de défaillances dans l'utilisation d'un site</li>
   <li>définition des objectifs d'un site : inscription newsletter, flux RSS, demande de devis, contact, vente, atteinte d'une page en particulier…</li></ul></li>
<li>Segmenter les visiteurs en fonction de quels critères et pour quoi faire ?  <ul>
   <li>critères de provenance : moteurs, referers, campagnes mail, epub, etc.</li>
   <li>critères quali : membres / non membres, déjà client ou déjà visiteurs</li>
   <li>critères technologiques : sous Chrome, FF, resolution, OS…</li></ul></li>
<li>Optimisation de la conversion : A/B testing et multivariable testing <ul>
   <li>présentation de Google Website Optimizer</li>
   <li>que peut-on/faut-il tester ? Dans quel but ?</li>
   <li>entrer dans un process d'optimisations itératives</li></ul></li>
</ul>

Pour les participants qui souhaitent faire une analyse en live de leur compte Google Analytics, merci de me contacter sur <a href="mailto:olivier+parisweb@resoneo.com">olivier+parisweb@resoneo.com</a></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/olivier-de-segonzac.php">Olivier de Segonzac</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Olivier de Segonzac" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_olivier_segonzac-thumb-143x143-52.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Olivier de Segonzac est depuis 2004 Directeur Associé de <a href="http://www.resoneo.com/" style="text-transform:uppercase;">Resoneo</a>, Agence conseil en stratégie et <span lang="en">marketing</span> pour le <span lang="en">e-business</span>, une des sept agences françaises « <a href="http://www.google.fr/analytics/authorized_consultants.html?#r=Europe&amp;s=France&amp;p=Analytics" lang="en">Google Analytics Certified Partner</a> ».</p>

<p>Auparavant, il a a travaillé comme chef de projet Web au sein d'un organisme financier de 2000 à 2004.</p>

<p>Olivier fait également partie du comité standards de la <a href="http://www.webanalyticsassociation.org/"><abbr title=" Web Analytics Association">WAA</abbr></a> en France et communique avec quelques collègues ses trucs et astuces <span lang="en">Google Analytics</span> sur <a href="http://www.wagablog.com/">Wagablog</a> depuis 2007.</p>

<p>Vous pouvez suivre sa veille quotidienne sur son <span lang="en">twitter</span> : <a href="http://twitter.com/5eg">5eg</a>.</p></div>
</div>
