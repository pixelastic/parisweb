...
<title>Paris Web - La conception universelle, est-ce toujours possible ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/le-web-lespace-public.php" title="Espace construit et espace virtuel, un retour vers le futur ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/internautes-sous-surveillance-retours-de-la-realite-pour-un-web-meilleur.php" title="Internautes sous surveillance : retours de la réalité pour un web meilleur" />
	...
	<meta name="twitter:title" content="La conception universelle, est-ce toujours possible ?" />
	<meta property="twitter:description" content="La plate-forme web a beaucoup changé ces dernières années. Il y a à peine trois ans que l'iPhone était le plus grand défi pour les pratiquants de la conception universelle. En 2010, par contre, il y…" />
	<meta property="dc:title" content="La conception universelle, est-ce toujours possible ?" />
	<meta property="og:title" content="La conception universelle, est-ce toujours possible ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/la-conception-universelle-est-ce-toujours-possible.php" />
	<meta property="og:description" content="La plate-forme web a beaucoup changé ces dernières années. Il y a à peine trois ans que l'iPhone était le plus grand défi pour les pratiquants de la conception universelle. En 2010, par contre, il y…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>La conception universelle, est-ce toujours possible ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-120">
						<header>
							<h1>La conception universelle, est-ce toujours possible ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggt4c?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-GA-01.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-120">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/la-conception-universelle-est-ce-toujours-possible.php" class="url">La conception universelle, est-ce toujours possible ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>La plate-forme web a beaucoup changé ces dernières années. Il y a à peine trois ans que l'iPhone était le plus grand défi pour les pratiquants de la conception universelle. En 2010, par contre, il y a des mobiles, des tablettes, des nouveaux navigateurs et des systèmes d'exploitation presque innombrables, chacun avec ses propres capacités et limites. Sans compter les besoins et les préférences des personnes handicapées et des seniors.</p>

<p>Comment peut-on créer des sites beaux et accessibles par souris, clavier, doigt et lecteur d'écran, tout en utilisant au mieux éléments d’HTML5 et de CSS3 ? Nous allons appliquer les leçons de l'iPhone et l'iPad, comprendre le défi des éléments &lt;canvas&gt;, &lt;audio&gt; et &lt;video&gt;, et voir ce qui est nécessaire pour créer un seul site pour tous (ou presque).</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/matt-may.php">Matt May</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Matt May" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_matt_may-thumb-143x143-49.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Matt May est évangéliste de l'accessibilité chez Adobe, et l'auteur (avec Wendy Chisholm) de <i>Universal Design for Web Applications</i> (O'Reilly, 2008). Il a été spécialiste en accessibilité chez W3C/WAI, et fut l'un des fondateurs du groupe de travail de l'accessibilité chez le Web Standards Project, et de la société Blue Flavor. Il habite à Seattle.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/la-conception-universelle-est-ce-toujours-possible.php&amp;ref=prez-la-conception-universelle-est-ce-toujours-pos&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
