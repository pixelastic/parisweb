...
<title>Paris Web - Comment convaincre un client de la qualité de votre prestation ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/tirer-parti-des-peripheriques-mobiles-dans-une-application-web-qui-a-dit-quil-fallait-coder-plusieur.php" title="Tirer parti des périphériques mobiles dans une application web : qui a dit qu’il fallait coder plusieurs versions natives ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/prendre-en-compte-les-handicaps-cognitifs.php" title="Prendre en compte les handicaps cognitifs" />
	...
	<meta name="twitter:title" content="Comment convaincre un client de la qualité de votre prestation ?" />
	<meta property="twitter:description" content="Cet atelier est destiné aux indépendants ainsi qu'aux entreprises ne disposant pas d'un service dédié à la prospection. Entre le neveu du patron qui travaille pour rien et le concurrent qui casse les…" />
	<meta property="dc:title" content="Comment convaincre un client de la qualité de votre prestation ?" />
	<meta property="og:title" content="Comment convaincre un client de la qualité de votre prestation ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/comment-convaincre-un-client-de-la-qualite-de-votre-prestation.php" />
	<meta property="og:description" content="Cet atelier est destiné aux indépendants ainsi qu'aux entreprises ne disposant pas d'un service dédié à la prospection. Entre le neveu du patron qui travaille pour rien et le concurrent qui casse les…" />
	...
	<div role="search">
		...
		<div class="l-block l-primary clearfix">
			...
			<nav class="l-primary-nav" id="menu" role="navigation" tabindex="-1">
				...
				<ul name="menu">
					<li><a href="/2016/conferences/" class="s-schedule">Conférences</a></li>
					<li><a href="/2016/ateliers/" class="s-schedule active">Ateliers</a></li>
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span><a href="https://www.paris-web.fr/2010/">Programme 2010</a></span>
				<span>Comment convaincre un client de la qualité de votre prestation ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-50">
						<header>
							<h1>Comment convaincre un client de la qualité de votre prestation ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/qualite-prestation-101017115052-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
</iframe>
	...
	<section class="s-talk-subject" id="sujet-50">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/comment-convaincre-un-client-de-la-qualite-de-votre-prestation.php" class="url">Comment convaincre un client de la qualité de votre prestation ?</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2010/ateliers/">Atelier</a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/lieux-ateliers.php">Voir le plan</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2010/16.php">samedi 16</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
14 <abbr title="heures">h</abbr> 00
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a><br /><a href="http://www.paris-web.fr/2010/recherche/qualite" rel="tag">Qualité</a></dd>
    ...
    <div class="talk-description"><p>Cet atelier est destiné aux indépendants ainsi qu'aux entreprises ne disposant pas d'un service dédié à la prospection.</p>

<p>Entre le neveu du patron qui travaille pour rien et le concurrent qui casse les prix, il n'est pas évident de défendre ses tarifs.<br />
Facilement remis en cause par le client, ils correspondent pourtant à la qualité de la prestation fournie.</p>

<ul>
<li>Comment la mettre en avant ?</li>
<li>Quelles assurances le client a-t-il à travailler avec vous ?</li>
<li>Comment peut-il être sûr que le produit fini réponde à ses attentes ?</li>
</ul>

<p>Au cours de cet atelier, nous vous présenterons différentes méthodologies et process issus de notre expérience.<br />
Faciles à mettre en œuvre, ils donneront un maximum d'assurance à votre prospect pour le rassurer quant à la valeur de la prestation qu'il achète.<br />
Nous espérons pouvoir compter sur vos propres retours d'expérience pour enrichir la discussion et rendre notre présentation plus exhaustive.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/loic-mathaud.php">Loïc Mathaud</a> et <a href="https://www.paris-web.fr/2010/../orateurs/corinne-schillinger.php">Corinne Schillinger</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Loïc Mathaud" src="https://www.paris-web.fr/2010/assets_c/2010/07/loic-mathaud-thumb-143x143-26.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p><a href="http://bballizlife.com/">Loïc Mathaud</a> est le cofondateur de <a href="http://www.kayuko.net/">Kayuko</a>, une agence de développement web au sein de laquelle il occupe entre autres les rôles de chef de projet et de responsable développement.</p>

<p>Titulaire d'un DUT Mesures physiques, il a continué des études au sein d'un IUP orienté réseau, électronique et communication pour finir par un master en informatique. Il est lui aussi tombé dans le web par hasard, s'y est pris de passion et a appris de manière autodidacte tout ce qu'il met en pratique aujourd'hui. Bien que développeur dit backend, il est sensibilisé à tout ce qui touche aux bonnes pratiques frontend et y porte une attention particulière dans les projets qu'il mène.</p>

<p>Aimant travailler au sein de petites équipes composées de passionnés, il met en place des projets pour des clients aux profils divers, allant de la TPE à de grandes organisations. Actuellement investi dans des projets de fundraising online auprès d'organismes associatifs, il peut allier sa passion et sa vision du web avec ses valeurs de partage.</p>

<p>Valeurs qu'il met aussi en pratique en tant que membre de l'équipe de développement du framework php <a href="http://jelix.org/">Jelix</a> et depuis peu comme le <abbr title="Gentil Organisateur">GO</abbr> des <a href="http://aperoentrepreneurs.com/">apéroentrepreneurs</a> à Saint-Etienne.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Corinne Schillinger" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_corinne-schillinger-thumb-143x143-32.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Issue dune filière plutôt technique (DUT Services &amp; Réseaux de Communication), Corinne poursuit ses études dans un domaine plus artistique et complète son profil en décrochant en 2005 une maîtrise de Concepteur Designer Graphique et Multimédia.</p>

<p>Après avoir testé le portage salarial pendant 2 ans, elle fait un saut chez alsacréations avant de se lancer et de créer sa propre agence web, <a href="http://www.inseo.fr/">inseo</a> en mai 2009.</p>

<p>Occupant les rôles de chef de projet, de webdesigner et d'intégrateur, elle alterne avec plaisir petits projets et prestations de grande envergure s'étalant sur plusieurs mois.</p>

<p>Elle profite ses moments de libre pour modérer le forum <a href="http://alsacreations.com/">alsacréations</a>, participer à la communauté francophone de <a href="http://cmsmadesimple.fr/">CMS Made Simple</a> et rattraper ses lectures en retard.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/comment-convaincre-un-client-de-la-qualite-de-votre-prestation.php&amp;ref=prez-comment-convaincre-un-client-de-la-qualite-de&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
...
<section class="news l-fixedColumn l-block l-primary">
		<article>
			<h2>L'édition 2010</h2>
			<ul>
            <li><a class="roll" href="/2010/conferences/" rel="bookmark">Les conférences 2010</a></li>
            <li><a class="roll" href="/2010/14.php" rel="bookmark">Programme du jeudi 14</a></li>
            <li><a class="roll" href="/2010/15.php" rel="bookmark">Programme du vendredi 15</a></li>

            <li><a class="roll" href="/2010/ateliers/" rel="bookmark">Les ateliers 2010</a></li>
            <li><a class="roll" href="/2010/16.php" rel="bookmark">Programme du samedi 16</a></li>
            <li><a class="roll" href="/2010/orateurs/" rel="bookmark">Les orateurs 2010</a></li>
			</ul>
        <ul class="large">
            <li><a href="http://www.paris-web.fr/2010/conferences-parisweb-2010.ics">Calendrier au format iCAL/ics des conférences 2010</a></li>
			<li><a href="http://www.paris-web.fr/2010/ateliers-parisweb-2010.ics">Calendrier au format iCAL/ics des ateliers 2010</a></li>
		</ul>
		</article>
	 </section>
