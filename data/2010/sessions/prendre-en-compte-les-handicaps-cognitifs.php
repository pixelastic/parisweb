...
<title>Paris Web - Prendre en compte les handicaps cognitifs</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/comment-convaincre-un-client-de-la-qualite-de-votre-prestation.php" title="Comment convaincre un client de la qualité de votre prestation ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/referencement-et-utilisabilite-des-objectifs-differents-des-methodes-qui-convergent.php" title="Référencement et utilisabilité : des objectifs différents, des méthodes qui convergent" />
	...
	<meta name="twitter:title" content="Prendre en compte les handicaps cognitifs" />
	<meta property="twitter:description" content="Pour prendre en compte les handicaps lors de la conception d'un site Web, il convient de connaître la nature des différents types de déficiences et, surtout, les difficultés qu'ils peuvent engendrer…" />
	<meta property="dc:title" content="Prendre en compte les handicaps cognitifs" />
	<meta property="og:title" content="Prendre en compte les handicaps cognitifs" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/prendre-en-compte-les-handicaps-cognitifs.php" />
	<meta property="og:description" content="Pour prendre en compte les handicaps lors de la conception d'un site Web, il convient de connaître la nature des différents types de déficiences et, surtout, les difficultés qu'ils peuvent engendrer…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Prendre en compte les handicaps cognitifs</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-131">
						<header>
							<h1>Prendre en compte les handicaps cognitifs</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-131">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/prendre-en-compte-les-handicaps-cognitifs.php" class="url">Prendre en compte les handicaps cognitifs</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/accessibilite" rel="tag">Accessibilité</a></dd>
    ...
    <div class="talk-description"><p>Pour prendre en compte les handicaps lors de la conception d'un site Web, il convient de connaître la nature des différents types de déficiences et, surtout, les difficultés qu'ils peuvent engendrer pour les utilisateurs du site. Cette approche est particulièrement difficile pour les handicaps cognitifs.</p>

<p>Les directives pour l'accessibilité des contenus Web (WCAG 2.0) comptent de nombreux critères qui peuvent apporter des réponses aux déficiences cognitives. Certains sont très simples à mettre en œuvre, d'autres sont plus complexes. Cependant, que des pages soient techniquement accessibles (répondant à l'ensemble des critères) ne suffira pas. Il conviendra d'être particulièrement attentif aussi aux règles d'ergonomie.</p>

<p>L'atelier se déclinera en 4 temps :</p>

<ul>
<li>principaux types de handicaps cognitifs ;</li>
<li>directives WCAG concernées ;</li>
<li>règles d'ergonomie à respecter ;</li>
<li>exemples et solutions.</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/monique-brunel.php">Monique Brunel</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Monique Brunel" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_monique-brunel-thumb-143x143-59.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Avec des diplômes d'institutrice primaire et de gestion d'une bibliothèque, Monique Brunel a exercé la profession de secrétaire-bibliothécaire dans divers établissements scolaires. Perte d'emploi et découverte d'Internet ont coïncidé en 1999, c'était une belle occasion de découvrir de nouveaux horizons et de mettre en ligne un site pour un club d'athlétisme. Le doigt était mis dans l'engrenage.<br />
Son goût pour le partage des connaissances a trouvé à s'exprimer via Usenet d'abord (où elle reçoit ses premières vraies leçons sur les CSS par Fabrice Bonny à l'époque où OpenWeb était en gestation), au travers d'une participation à des projets communautaires ensuite (les forums Webmaster-Hub et Alsacréations, le projet Opquast, le collectif OpenWeb, l'encyclopédie Wikipédia, l'annuaire Dmoz...).</p>

<p>Elle a fait son apprentissage en autodidacte via le Web et la  lecture de quelques ouvrages. En 2004, elle a suivi la formation AccessiWeb d'expert en évaluation de l'accessibilité des sites Web.</p>

<p>Elle s'est un jour déclarée en campagne pour des sites Web de qualité, conformes et accessibles.<br />
En mars 2006, elle se lançait à son tour dans l'aventure du bloging avec <a href="http://blog.webatou.info/">Blog Webatou</a>. Elle partage aussi le résultat de sa veille via <a href="http://twitter.com/webatou">Twitter</a> et <a href="http://identi.ca/webatou/all">identi.ca</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/prendre-en-compte-les-handicaps-cognitifs.php&amp;ref=prez-prendre-en-compte-les-handicaps-cognitifs&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
