...
<title>Paris Web - Let’s interface - how to make people as excited about tech as we are</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/lutilisabilite-dans-la-strategie-web-des-organisations-internationales.php" title="L’utilisabilité dans la stratégie web des organisations internationales" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/repas.php" title="repas" />
	...
	<meta name="twitter:title" content="Let’s interface - how to make people as excited about tech as we are" />
	<meta property="twitter:description" content=" Do you have the feeling that nobody listens to you in your company? That all those cool folk on the web do great things but you don't ever get the time to do the same? That somehow, somewhere you..." />
	<meta property="dc:title" content="Let’s interface - how to make people as excited about tech as we are" />
	<meta property="og:title" content="Let’s interface - how to make people as excited about tech as we are" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/lets-interface.php" />
	<meta property="og:description" content=" Do you have the feeling that nobody listens to you in your company? That all those cool folk on the web do great things but you don't ever get the time to do the same? That somehow, somewhere you..." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Let’s interface - how to make people as excited about tech as we are</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-78">
						<header>
							<h1>Let’s interface - how to make people as excited about tech as we are</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggtma?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/lets-interface-parisweb-2010-101014072051-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-GA-03.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-78">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/lets-interface.php" class="url">Let’s interface - how to make people as excited about tech as we are</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2010/conferences/">Conférence</a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/">Grand amphithéâtre</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2010/14.php">jeudi 14</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
11 <abbr title="heures">h</abbr> 20
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><div lang="en" class="span-6">
<p>
Do you have the feeling that nobody listens to you in your company? That all those cool folk on the web do great things but you don't ever get the time to do the same? That somehow, somewhere you get the feeling that a lot of the stuff you read about in web magazines sounds familiar? In this session Chris Heilmann will tell you a few tricks and ideas how to change that. You will learn:
</p>
<ul>
	<li>how you can get yourself heard</li>
	<li>how you can impress people who are not in the know of what web developers and designers really do</li>
	<li>how to prepare complex technical materials to make them interesting for everybody</li>
	<li>how to sell yourself as an expert instead of a delivery person</li>
	<li>how to prepare your products so others can build on them instead of pestering you to apply fixes for them</li>
	<li>how to develop a healthy scepticism about new technologies</li>
	<li>how to spot bullshit in announcements</li>
</ul>
<p>
Progress and innovation is not effective if we fail to sell it to the people who fund the bills. If you want to turn from subject matter expert to effective innovator in your company and the web then you need to learn how to be a translator, librarian and listening station for information that is available on the web. Here you will learn how to.
</p>
</div>
<div class="span-6 last">
<p>
Avez-vous le sentiment que personne ne vous écoute dans votre société ? Que tous les gens cools du Web font des projets géniaux mais que vous n'avez jamais le temps d'en faire autant ? Que d'une manière ou d'une autre, vous avez l'impression que ce que vous lisez dans les magazines en ligne vous est familier ? Lors de cette session, Chris Heilman vous donner quelques astuces et idées pour changer cela. Vous apprendrez :
</p>
<ul>
<li>à vous faire entendre ;</li>
<li>à impressionner ceux qui n'ont pas idée de ce que les développeurs et designer web font vraiment :</li>
<li>à arranger du contenu technique complexe pour le rendre intéressant au plus grand nombre ;</li>
<li>à vous vendre en tant qu'expert plutôt qu'en tant qu'exécutant ;</li>
<li>à préparer vos productions de telle sorte que d'autres pourront les étendre plutôt que de vous harceler pour les améliorer ;</li>
<li>à développer une une saine méfiance face aux nouvelles technologies ;</li>
<li>à repérer les foutaises dans les annonces.</li>
</ul>
<p>
Le progrès et l'innovation n'ont un sens que l'on parvient à les vendre à ceux qui signent les chèques. Si vous voulez passer du stade d'expert sur un sujet précis à celui d'innovateur efficace au sein de votre société et de la communauté web, alors il vous faut apprendre à interpréter, conserver et rester à l'écoute de ce qu'il se passe sur le Web. Cette conférence vous montrera comment.
</p>
</div>
<div class="box clear">
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/christian-heilmann.php">Christian Heilmann</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Christian Heilmann" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_chris-heilmann-thumb-143x143-60.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Chris Heilman est évangéliste technique sénior chez Yahoo, et a écrit le manuel de l'évangéliste technique. Avant qu'il ne prenne cette courageuse décision, il n'y avait pas d'évangélisme chez Yahoo!, et aujourd'hui la société profite du regard neuf que ce métier lui apporte. Chris a prouvé par le passé qu'il pouvait prendre en charge de gros projets et passer des heures et des jours à corriger de petits problèmes.</p>

<p>Ces jours-ci, il se concentre sur le partage de ses connaissances, et tente d'aider les débutants à ne pas tomber dans les mêmes pièges qu'il a dû surmonter afin d'arriver à son poste actuel. Il a été élu orateur le plus inspirant par le Zeitgeist de SlideShare en 2009, et passe la majeure partie de son temps en avion, passant d'un hackday à un barcamp ou une conférence.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/lets-interface.php&amp;ref=prez-lets-interface&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
