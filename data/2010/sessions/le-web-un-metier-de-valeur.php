...
<title>Paris Web - Le web, un métier de valeur</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/mini-conferences/un-player-video-accessible-si-cest-possible.php" title="Un player vidéo accessible, si c’est possible !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/html5-et-ses-amis-nouvelles-apis.php" title="HTML5 et ses amis : nouvelles APIs" />
	...
	<meta name="twitter:title" content="Le web, un métier de valeur" />
	<meta property="twitter:description" content="Les métiers du web deviennent de plus en plus techniques. Les connaissances et la réflexion nécessaires pour réaliser un site de qualité peuvent dépasser ce que l'on voit dans des projets plus…" />
	<meta property="dc:title" content="Le web, un métier de valeur" />
	<meta property="og:title" content="Le web, un métier de valeur" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/le-web-un-metier-de-valeur.php" />
	<meta property="og:description" content="Les métiers du web deviennent de plus en plus techniques. Les connaissances et la réflexion nécessaires pour réaliser un site de qualité peuvent dépasser ce que l'on voit dans des projets plus…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le web, un métier de valeur</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-53">
						<header>
							<h1>Le web, un métier de valeur</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh9c2f?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/parisweb2010-webmtierdevaleur-101015100950-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-PA-07.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-53">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/le-web-un-metier-de-valeur.php" class="url">Le web, un métier de valeur</a></span></span></h2>
...
<dd class="column">
14 <abbr title="heures">h</abbr> 20
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>Les métiers du web deviennent de plus en plus techniques. Les connaissances et la réflexion nécessaires pour réaliser un site de qualité peuvent dépasser ce que l'on voit dans des projets plus classiques.</p>

<p>Ensemble, nous allons parler du métier lui-même, de sa valeur.</p>

<ul>
<li>Votre travail respecte t-il vos valeurs votre éthique ?</li>
<li>Pouvez-vous faire pencher la balance sur les décisions importantes ?</li>
<li>Livrez-vous un produit de qualité ?</li>
<li>Quelles sont vos responsabilités dans la chaîne de réalisation ?</li>
<li>Êtes-vous bien payé, bien considéré ?</li>
</ul>

<p>Ces questions sont toutes liées, elles sont attachées à la valeur que nous attribuons et que les autres attribuent à notre métier.</p>

<p>Six ans après un article au titre provocateur « Le web c’est pour les stagiaires » le décalage entre les aspirations des intervenants et le niveau d’expertise requis par rapport à la valorisation de leurs métiers est encore plus grand. Il est temps d’en parler et d’y remédier, parce que c’est bénéfique pour tous : intégrateurs, graphistes, fournisseurs, clients, direction et utilisateurs.</p>

<p>Au travers de cette conférence nous verrons comment améliorer les choses, comment et pourquoi valoriser le métier est nécessaire pour tout le monde, du développeur à l'utilisateur en passant par le donneur d'ordre fonctionnel.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/eric-daspet.php">Éric Daspet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Éric Daspet" src="https://www.paris-web.fr/2010/assets_c/2010/07/eric-daspet-thumb-143x143-11.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après plusieurs années en expert et chef de projet autour de PHP et de l’Open Source, Éric a travaillé àYahoo! sur les technologies web client. Il s’occupe maintenant de projets web et d’innovation en tant que consultant et architecte pour SQLI.</p>

<p>En parallèle Éric est très attaché au partage des connaissances dans la communauté web et met en avant depuis plusieurs années la notion de qualité web. Au milieu d’articles dans la presse, d’une participation à Openweb et de nombreuses conférences, il a co-écrit le livre «&nbsp;PHP5 avancé&nbsp;» aux éditions Eyrolles et est à l’origine des conférences Paris Web avec Stéphane et Adrien.</p>

<p>Il s’est dernièrement spécialisé sur les questions de performance des sites web. Après des publications en ligne sur la question il prépare un nouveau livre pour début 2011.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/le-web-un-metier-de-valeur.php&amp;ref=prez-le-web-un-metier-de-valeur&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
