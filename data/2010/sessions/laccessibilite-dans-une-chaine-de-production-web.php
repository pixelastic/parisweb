...
<title>Paris Web - L’accessibilité dans une chaîne de production Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/mini-conferences/le-kit-de-ux-pour-standardiser-les-documents-de-conception-et-simplifier-la-communication-entre-les-.php" title="Le Kit documentaire de conception pour simplifier la communication projet" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/html5-et-le-web-de-demain.php" title="HTML5 et le web de demain" />
	...
	<meta name="twitter:title" content="L’accessibilité dans une chaîne de production Web" />
	<meta property="twitter:description" content="Les standards d’accessibilité des contenus Web pour les personnes handicapées bouleversent de nombreuses habitudes au sein des organisations qui entreprennent de les intégrer à leurs pratiques de…" />
	<meta property="dc:title" content="L’accessibilité dans une chaîne de production Web" />
	<meta property="og:title" content="L’accessibilité dans une chaîne de production Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/laccessibilite-dans-une-chaine-de-production-web.php" />
	<meta property="og:description" content="Les standards d’accessibilité des contenus Web pour les personnes handicapées bouleversent de nombreuses habitudes au sein des organisations qui entreprennent de les intégrer à leurs pratiques de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L’accessibilité dans une chaîne de production Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-45">
						<header>
							<h1>L’accessibilité dans une chaîne de production Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh8h8x?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu_PA_07.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-45">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/laccessibilite-dans-une-chaine-de-production-web.php" class="url">L’accessibilité dans une chaîne de production Web</a></span></span></h2>
...
<dd class="column">
14 <abbr title="heures">h</abbr> 55
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/accessibilite" rel="tag">Accessibilité</a></dd>
    ...
    <div class="talk-description"><p>Les standards d’accessibilité des contenus Web pour les personnes handicapées bouleversent de nombreuses habitudes au sein des organisations qui entreprennent de les intégrer à leurs pratiques de développement Web. Les exigences de ces standards remettent en question des pratiques souvent jusque-là jugées adéquates, éprouvées et optimales.</p>

<p>La volonté d’intégrer ces nouvelles préoccupations de qualité au sein d’une équipe de production entraîne parfois des changements susceptibles de déstabiliser la rentabilité d'une production de site Web. Bien que les principes appliqués dans la pratique d'accessibilité ne soient pas difficiles à mettre en œuvre, grands sont les risques de tomber dans certains pièges.</p>

<p>Dans le cadre de cette présentation, le conférencier propose un modèle théorique de chaîne de production Web et explique en quoi l'accessibilité est une pratique qui, contrairement aux autres pratiques liées au Web, est transversale et dont les principes touchent toutes les spécialisations du Web, allant de l'analyse au contrôle qualité. En se basant sur le modèle théorique proposé, un découpage de WCAG 2.0 sera proposé en fonction des responsabilités des différents intervenants, afin de faciliter l'intégration de la pratique dans une chaîne de production Web.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/vincent-francois.php">Vincent François</a> et <a href="https://www.paris-web.fr/2010/../orateurs/denis-boudreau.php">Denis Boudreau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Vincent François" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_vincent-francois-thumb-143x143-72.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Issu de la toute première cohorte d’experts formés au Québec en accessibilité du Web, ingénieur d'État de formation, Vincent François est cofondateur de la Coopérative AccessibilitéWeb, pour laquelle il intervient à titre de directeur général et d’expert certifié.</p>

<p>Depuis 2003, il œuvre dans le domaine l'accessibilité en venant du monde de la programmation et du code source. Ses responsabilités principales concernent la gestion de la coopérative, la formation et la recherche et développement en accessibilité.</p>

<p>Webmestre de différents mouvements sociaux ou environnementaux, il possède aussi une solide expérience de plus de 23 ans en programmation dans différents langages et en intégration.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Denis Boudreau" src="https://www.paris-web.fr/2010/assets_c/2010/07/denis-boudreau-thumb-143x143-25.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Issu de la toute première cohorte d’experts formés au Québec en accessibilité du Web, Denis Boudreau s’intéresse à l’accessibilité pour les personnes handicapées sur le Web depuis 2001. En 2006, il participe à la fondation de la Coopérative AccessibilitéWeb et, après quelques années en son sein à titre de directeur-général. C’est dorénavant à titre de président et d’expert certifié qu’il intervient dans les activités de la Coopérative.</p>

<p>Impliqué depuis le début dans la démarche de l’Administration gouvernementale québécoise en matière d’accessibilité, il est l’un des principaux rédacteurs du standard d’accessibilité du Web pour les personnes handicapées (SGQRI 008) en voie d’être adopté par le gouvernement du Québec.</p>

<p>Il est aussi membre expert invité de l’International Standards Organization (ISO), participe au développement du HTML5 à titre d’expert invité au groupe de travail HTML du World Wide Web Consortium (W3C) et agit comme vice-président communications et développement du Groupe québécois de travail sur les normes et standards en technologies de l’information pour l’apprentissage, l’éducation et la formation (GTN-Québec).</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/laccessibilite-dans-une-chaine-de-production-web.php&amp;ref=prez-laccessibilite-dans-une-chaine-de-production-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
