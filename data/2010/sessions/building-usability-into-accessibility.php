...
<title>Paris Web - Building usability into accessibility</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/mini-conferences/etude-de-cas-sur-la-mise-en-accessibilite-dun-site-web.php" title="Étude de cas sur la mise en accessibilité d’un site Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/mini-conferences/un-player-video-accessible-si-cest-possible.php" title="Un player vidéo accessible, si c’est possible !" />
	...
	<meta name="twitter:title" content="Building usability into accessibility" />
	<meta property="twitter:description" content=" With Accessibility it is possible to get too focused on compliance with specific mandates and rules. This is similar to a software developer getting too focused on the technical details when…" />
	<meta property="dc:title" content="Building usability into accessibility" />
	<meta property="og:title" content="Building usability into accessibility" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/mini-conferences/building-usability-into-accessibility.php" />
	<meta property="og:description" content=" With Accessibility it is possible to get too focused on compliance with specific mandates and rules. This is similar to a software developer getting too focused on the technical details when…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Building usability into accessibility</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-173">
						<header>
							<h1>Building usability into accessibility</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggrk1?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-GA-05.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-173">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/mini-conferences/building-usability-into-accessibility.php" class="url">Building usability into accessibility</a></span></span></h2>
...
<dd class="column">
13 <abbr title="heures">h</abbr> 45
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>

<dt class="clear span-1">Durée</dt>
<dd class="column">
30 <abbr title="minutes">mn</abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/accessibilite" rel="tag">Accessibilité</a><br /><a href="http://www.paris-web.fr/2010/recherche/ergonomie" rel="tag">Ergonomie</a></dd>
...
<p>With Accessibility it is possible to get too focused on compliance with specific mandates and rules.  This is similar to a software developer getting too focused on the technical details when implementing a design.  Usability and thinking from the user's point of view is the established solution to this in the software development process. Applying this user-centric approach to accessibility is equally effective.</p>

<p>In the absence of usability practitioners it is still possible to meet functional requirements, yet in practice end up with a product that is totally unusable.</p>

<p>This talk explores, with examples, the marriage between the two disciplines of accessibility and usability.</p>

</div><div class="span-6 last">

<p>Avec l'accessibilité il arrive d'être trop concentré sur le respect de demandes spécifiques et de règles. Cela est comparable à un développeur logiciel qui se concentrais trop sur des détails techniques quand il intègre un design. L'utilisabilité et le fait de penser d'après le point de vue de l'utilisateur est la solution établie qui permet d'accomplir ce développement logiciel. Et cela marche aussi quand on utilise cette approche pour l'accessibilité.</p>

<p>En l'absence de référents utilisabilité il est toujours possible d'atteindre les attentes fonctionnelles, mais dans la pratique, ce produit ne sera aucunement fonctionnel.</p>

<p>Cette mini-conférence abordera avec des exemples le relations entre ces deux disciplines : accessibilité et utilisabilité.</p>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/james-taylor.php">James Taylor</a> et <a href="https://www.paris-web.fr/2010/../orateurs/christophe-jolif.php">Christophe Jolif</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="James Taylor" src="https://www.paris-web.fr/2010/assets_c/2010/08/orateur-james_taylor-thumb-143x143-79.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>James est le responsable accessibilité pour IBM Hursley et les laboratoires ILOG. Il fait partie de l'équipe UX où il utilise sa connaissance de l'utilisabilité produit et de l'accessibilité pour livrer des produits faciles d'utilisation pour tous.</p>

<p>James à toujours été un passionné par l'utilisabilité, et ce depuis l'université où il étudiait l'informatique et la psychologie à la fin des années 90. Depuis il a travaillé sur en ensemble de produits, les plus récents étant des produits qui s'orientent vers le business du traitement de l'évènement et la prise de décisions. Les produits qui sont destinés à des gens moins techniques requièrent des standards très élevés d'utilisabilité, ce qui les rend d'autant plus intéressants.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Christophe Jolif" src="https://www.paris-web.fr/2010/assets_c/2010/08/orateur-christophe_jolif-thumb-143x143-78.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Christophe Jolif a travaillé pour ILOG et IBM pendant plus d'une décennie en tant que qu'ingénieur logiciel et architecte sur des composants visuels avancés pour le Web. Il a également participé à plusieurs groupes de travail autour des technologies Web et en particulier au groupe de travail sur SVG du W3C et à l'Open Ajax Alliance.</p>

<p>Plus récemment en tant que responsable développement du produit, Christophe a participé à la conception et l'implémentation de stratégies d'accessibilité pour IBM ILOG Elixir afin de permettre aux personnes avec handicap de profiter pleinement des possibilités d'exploration et d'analyse des données qu'offrent les composants visuels avancés sur le Web.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/mini-conferences/building-usability-into-accessibility.php&amp;ref=prez-building-usability-into-accessibility&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
