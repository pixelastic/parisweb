...
<title>Paris Web - Industrialiser l’artisanat de l’intégration HTML</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/html5-et-css3-dans-la-vraie-vie.php" title="Plus belle la vie avec HTML5 et CSS3" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/repas-4.php" title="repas" />
	...
	<meta name="twitter:title" content="Industrialiser l’artisanat de l’intégration HTML" />
	<meta property="twitter:description" content="L'intégration HTML, et la qualité du livrable final, dépend essentiellement de l'intégrateur et de son expérience. Qui n'a jamais réécrit une feuille de style parce qu'on n'aimait pas l'organisation…" />
	<meta property="dc:title" content="Industrialiser l’artisanat de l’intégration HTML" />
	<meta property="og:title" content="Industrialiser l’artisanat de l’intégration HTML" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/industrialiser-lartisanat-de-lintegration-html.php" />
	<meta property="og:description" content="L'intégration HTML, et la qualité du livrable final, dépend essentiellement de l'intégrateur et de son expérience. Qui n'a jamais réécrit une feuille de style parce qu'on n'aimait pas l'organisation…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Industrialiser l’artisanat de l’intégration HTML</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-135">
						<header>
							<h1>Industrialiser l’artisanat de l’intégration HTML</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/industrialiser-artisanat-integration-html-101016073637-phpapp01" 
	...
	<section class="s-talk-subject" id="sujet-135">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/industrialiser-lartisanat-de-lintegration-html.php" class="url">Industrialiser l’artisanat de l’intégration HTML</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/metier" rel="tag">Métier</a></dd>
    ...
    <div class="talk-description"><p>L'intégration HTML, et la qualité du livrable final, dépend essentiellement de l'intégrateur et de son expérience.<br />
Qui n'a jamais réécrit une feuille de style parce qu'on n'aimait pas l'organisation de son prédécesseur ? Qui n'a jamais ajouté du code plutôt que modifier l'existant, afin d'éviter l'effet Mikado ?</p>

<p>Cet atelier technique a plusieurs buts :</p>

<ul>
<li>dresser un état de l'art de l'intégration HTML</li>
...
<p>Nous tenterons de répondre à ces questions :</p>

<ul>
<li>comment bâtir des CSS indépendantes et réutilisables ? − #frameworks, #oocss, #css</li>
<li>quand et comment utiliser un préprocesseur CSS ? − #css, #preprocessor, #less</li>
<li>comment dialoguer avec le graphiste ? − #industrialisation, #process</li>
<li>comment dialoguer avec le développeur ? − #industrialisation, #process</li>
<li>comment détecter les régressions et assurer une qualité de code en CSS ? − #tdd, #industrialisation, #qa</li>
</ul>

<p>Chaque question sera introduite par quelques slides (max 5 minutes) afin de lancer la discussion et aider à formaliser un guide de bonnes pratiques, soyons utopistes, universelles.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/thomas-parisot.php">Thomas Parisot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Thomas Parisot" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_thomas_parisot-thumb-143x143-48.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Consultant Web, accessibilité et respect des standards chez Clever Age.</p>

<p>Thomas intervient à différents niveaux : intégration graphique, accessibilité, widgets, missions de conseil, développement frontend/backend et performances.</p>

<p>Il fait également partie de la cellule d’expertise et contribue à la vitrine technique de Clever Age via son blog ou en animant des petits déjeuners client et des réunions techniques.</p>

<p>En n’oubliant pas que les journées ne font que 24 heures, Thomas est l’auteur du livre « Réussir son blog professionnel » (Eyrolles, septembre 2009), contribue à l’écosystème WordPress et symfony tout en étant vacataire à l’université de Bordeaux.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/industrialiser-lartisanat-de-lintegration-html.php&amp;ref=prez-industrialiser-lartisanat-de-lintegration-htm&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
