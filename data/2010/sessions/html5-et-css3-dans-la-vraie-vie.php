...
<title>Paris Web - Plus belle la vie avec HTML5 et CSS3</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/webdesign-photoshop-qualite-productivite.php" title="Webdesign et Photoshop : qualité et productivité" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/industrialiser-lartisanat-de-lintegration-html.php" title="Industrialiser l’artisanat de l’intégration HTML" />
	...
	<meta name="twitter:title" content="Plus belle la vie avec HTML5 et CSS3" />
	<meta property="twitter:description" content="Vous n’avez pas encore sauté le pas HTML 5 / CSS 3 ? Par manque de temps ? Par méconnaissance ? Par frilosité ? Juste pour nous contrarier ? Pascale et Raphaël vous proposent d'en découvrir les…" />
	<meta property="dc:title" content="Plus belle la vie avec HTML5 et CSS3" />
	<meta property="og:title" content="Plus belle la vie avec HTML5 et CSS3" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/html5-et-css3-dans-la-vraie-vie.php" />
	<meta property="og:description" content="Vous n’avez pas encore sauté le pas HTML 5 / CSS 3 ? Par manque de temps ? Par méconnaissance ? Par frilosité ? Juste pour nous contrarier ? Pascale et Raphaël vous proposent d'en découvrir les…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Plus belle la vie avec HTML5 et CSS3</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-133">
						<header>
							<h1>Plus belle la vie avec HTML5 et CSS3</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xgq6ps?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/presentation-101016150218-phpapp01" 
	...
	<section class="s-talk-subject" id="sujet-133">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/html5-et-css3-dans-la-vraie-vie.php" class="url">Plus belle la vie avec HTML5 et CSS3</a></span></span></h2>
...
<dd class="column">
10 <abbr title="heures">h</abbr> 50
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2010/recherche/html5" rel="tag">HTML5</a></dd>
    ...
    <div class="talk-description"><p>Vous n’avez pas encore sauté le pas HTML 5 / CSS 3 ? Par manque de temps ? Par méconnaissance ? Par frilosité ? Juste pour nous contrarier ?</p>

<p>Pascale et Raphaël vous proposent d'en découvrir les grandes lignes (de code), démêleront le vrai du faux (et les nombreuses idées reçues) et partageront avec vous leurs expériences.</p>

<div class="box">
<p class="last">
Pour suivre au mieux cet atelier il vous conseillé d'apporter votre ordinateur portable accompagné d’outils de développement, l’atelier étant agrémenté d'exercices pratiques et de démonstrations. 
</p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/raphael-goetter.php">Raphaël Goetter</a> et <a href="https://www.paris-web.fr/2010/../orateurs/pascale-lambert-charreteur.php">Pascale Lambert-Charreteur</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Goetter" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_raphael_goetter-thumb-143x143-54.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Webdesigner de profession (chez Alsacréations), je cumule deux passions créatives : la conception Web et la Photographie.</p>

<p>Auteur des ouvrages web de référence «&nbsp;CSS2 - Pratique du design web&nbsp;» publié chez Eyrolles (3è édition en janvier 2009), du «&nbsp;Memento CSS&nbsp;» et du «&nbsp;Memento XHTML&nbsp;», chez le même éditeur.</p>

<p>Membre du collectif Openweb, référence francophone en matière de standards web.</p>

<p>Formateur expert en langages web (X)HTML et CSS auprès de groupes nationaux et internationaux.</p>

<p>Créateur et administrateur du site Alsacreations.com, communauté d'apprentissage web dont le trafic quotidien dépassait les 20000 visites uniques en 2010.</p>

<p>Passionné de photographie, et auteur d'un livre technique d'apprentissage : «&nbsp;Le B.-A. BA de la photo de bébé&nbsp;», publié chez Dunod en 2009.</p>

<p>Administrateur de plusieurs sites personnels ou associatifs tels que <a href="http://goetter.fr/">Goetter.fr</a>, <a href="http://www.polychromies.com/">Polychromies.com</a>, <a href="http://ie7nomore.com/">IE7nomore.com</a> ou <a href="http://www.slconstantia.com/">SLConstantia.com</a>.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Pascale Lambert-Charreteur" src="https://www.paris-web.fr/2010/assets_c/2010/08/orateur_pascale-lambert-charreteur-thumb-143x143-76.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Enseignante et formatrice <abbr title="Technologies de l'Information et de la Communication dans l'Enseignement">TICE</abbr> dans l'académie de Rouen, Pascale assure aussi une mission de conseil en accessibilité auprès de son Rectorat.</p>

<p>Elle milite pour le respect des standards et les bonnes pratiques du web depuis une dizaine d'années au travers de <a href="http://css.mammouthland.net/">son blog et de son site dédié au langage CSS</a>. Elle est co-fondatrice de la liste de discussion <a href="http://fr.groups.yahoo.com/group/pompeurs/">Pompeurs-CSS</a> et fait partie des administrateurs du collectif <a href="http://openweb.eu.org/">OpenWeb</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/html5-et-css3-dans-la-vraie-vie.php&amp;ref=prez-html5-et-css3-dans-la-vraie-vie&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
