...
<title>Paris Web - Comment un vigneron étranger utilise le web pour s'intégrer dans la France rurale</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/un-framework-html-est-il-possible.php" title="Un framework html est-il possible ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/mini-conferences/au-boulot-les-cerveaux.php" title="Au boulot les cerveaux !" />
	...
	<meta name="twitter:title" content="Comment un vigneron étranger utilise le web pour s'intégrer dans la…" />
	<meta property="twitter:description" content="Un nouveau venu en France qui monte sa propre entreprise doit choisir comment mieux utiliser l'Internet pour développer son réseau. Ceci est doublement vrai dans un endroit rural comme le sud de la…" />
	<meta property="dc:title" content="Comment un vigneron étranger utilise le web pour s'intégrer dans la France rurale" />
	<meta property="og:title" content="Comment un vigneron étranger utilise le web pour s'intégrer dans la France rurale" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/mini-conferences/comment-un-vigneron-etranger-utilise-le-web-pour-sintegrer-dans-la-france-rurale.php" />
	<meta property="og:description" content="Un nouveau venu en France qui monte sa propre entreprise doit choisir comment mieux utiliser l'Internet pour développer son réseau. Ceci est doublement vrai dans un endroit rural comme le sud de la…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Comment un vigneron étranger utilise le web pour s'intégrer dans la France rurale</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-114">
						<header>
							<h1>Comment un vigneron étranger utilise le web pour s'intégrer dans la France rurale</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xheaol?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/commentunvignerontrangerutiliselewebpour-101018124816-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/ven-GA-04.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-114">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/mini-conferences/comment-un-vigneron-etranger-utilise-le-web-pour-sintegrer-dans-la-france-rurale.php" class="url">Comment un vigneron étranger utilise le web pour s'intégrer dans la France rurale</a></span></span></h2>
...
<dd class="column">
12 <abbr title="heures">h</abbr> 00
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ergonomie" rel="tag">Ergonomie</a></dd>
    ...
    <div class="talk-description"><p>Un nouveau venu en France qui monte sa propre entreprise doit choisir comment mieux utiliser l'Internet pour développer son réseau. Ceci est doublement vrai dans un endroit rural comme le sud de la France. Ce n'est pas Paris, où l'on peut sortir et rencontrer du monde un peu au hasard. La campagne est plus fermée. Même l'Internet offre moins d'opportunités car beaucoup de sites sont dirigés vers des audience dans les métropoles comme Paris, New York, et San Francisco. Quel site répond aux besoins de la campagne&nbsp;?</p>

<p>Nous étudions comment l'Internet peut être un outil qui promeut l'intégration comme il peut renforcer la ségrégation dans la France rurale.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/ryan-oconnell.php">Ryan O'Connell</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Ryan O'Connell" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_ryan-oconnell-thumb-143x143-62.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Quand Ryan O'Connell avait 19 ans, il s'est lancé comme vigneron dans le Languedoc Roussillon.  Un passionné de vin sans formation technique, Ryan est arrivé dans le sud de la France où il a créé le Domaine O'Vineyards avec ses parents.  Il a vite été reconnu par les critiques pour la qualité de ses vins comme pour ses efforts à amener les vignerons sur le web.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/mini-conferences/comment-un-vigneron-etranger-utilise-le-web-pour-sintegrer-dans-la-france-rurale.php&amp;ref=prez-comment-un-vigneron-etranger-utilise-le-web-p&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
