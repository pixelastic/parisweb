...
<title>Paris Web - HTML5 et ses amis : nouvelles APIs</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/conferences/le-web-un-metier-de-valeur.php" title="Le web, un métier de valeur" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/pause-4.php" title="pause" />
	...
	<meta name="twitter:title" content="HTML5 et ses amis : nouvelles APIs" />
	<meta property="twitter:description" content="Les nouveaux standards sont bien plus qu'un ensemble de nouveaux tags HTML. Nous explorerons ici les différentes nouvelles API offertes par l'OpenWeb, comme WebGL, la File API, les WebSockets ou…" />
	<meta property="dc:title" content="HTML5 et ses amis : nouvelles APIs" />
	<meta property="og:title" content="HTML5 et ses amis : nouvelles APIs" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/conferences/html5-et-ses-amis-nouvelles-apis.php" />
	<meta property="og:description" content="Les nouveaux standards sont bien plus qu'un ensemble de nouveaux tags HTML. Nous explorerons ici les différentes nouvelles API offertes par l'OpenWeb, comme WebGL, la File API, les WebSockets ou…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5 et ses amis : nouvelles APIs</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-155">
						<header>
							<h1>HTML5 et ses amis : nouvelles APIs</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xggtj7?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-155">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/conferences/html5-et-ses-amis-nouvelles-apis.php" class="url">HTML5 et ses amis : nouvelles APIs</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/html5" rel="tag">HTML5</a><br /><a href="http://www.paris-web.fr/2010/recherche/javascript" rel="tag">JavaScript</a></dd>
    ...
    <div class="talk-description"><p>Les nouveaux standards sont bien plus qu'un ensemble de nouveaux tags <abbr>HTML</abbr>.<br />
Nous explorerons ici les différentes nouvelles API offertes par l'OpenWeb, comme WebGL, la <span lang="en">File</span> <abbr>API</abbr>, les <span lang="en">WebSockets</span> ou encore l'<span lang="en">history</span> <abbr>API</abbr>.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/paul-rouget.php">Paul Rouget</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Paul Rouget" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_paul_rouget-thumb-143x143-50.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Paul travaille pour Mozilla en tant que tech evangelist.<br />
Son activité préférée est de jouer au petit chimiste avec les nouvelles technologies web et de voir jusqu'où l'on peut pousser les standards d'aujourd'hui et de demain.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/conferences/html5-et-ses-amis-nouvelles-apis.php&amp;ref=prez-html5-et-ses-amis-nouvelles-apis&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
