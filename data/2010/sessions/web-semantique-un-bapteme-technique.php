...
<title>Paris Web - Web sémantique, un baptême technique</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/mettre-en-place-la-gestion-de-la-qualite-web.php" title="Mettre en place la gestion de la qualité web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/webdesign-photoshop-qualite-productivite.php" title="Webdesign et Photoshop : qualité et productivité" />
	...
	<meta name="twitter:title" content="Web sémantique, un baptême technique" />
	<meta property="twitter:description" content="Résumé : Le web sémantique combine un jeu de langages permettant de publier des données liées et la sémantique des schémas de ces données. De plus en plus d’organisations privées et publiques…" />
	<meta property="dc:title" content="Web sémantique, un baptême technique" />
	<meta property="og:title" content="Web sémantique, un baptême technique" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/web-semantique-un-bapteme-technique.php" />
	<meta property="og:description" content="Résumé : Le web sémantique combine un jeu de langages permettant de publier des données liées et la sémantique des schémas de ces données. De plus en plus d’organisations privées et publiques…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Web sémantique, un baptême technique</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-124">
						<header>
							<h1>Web sémantique, un baptême technique</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-124">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/web-semantique-un-bapteme-technique.php" class="url">Web sémantique, un baptême technique</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/web-semantique" rel="tag">Web sémantique</a></dd>
    ...
    <div class="talk-description"><p>Résumé : Le web sémantique combine un jeu de langages permettant de publier des données liées et la sémantique des schémas de ces données. De plus en plus d’organisations privées et publiques participent à ce web de données en publiant dans ces langages des données ouvertes et leurs modèles de données.</p>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/web-semantique-un-bapteme-technique.php&amp;ref=prez-web-semantique-un-bapteme-technique&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
