...
<title>Paris Web - Le Kit documentaire de conception pour simplifier la communication projet</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/mini-conferences/methode-daisy-les-css-feuille-a-feuille.php" title="Méthode Daisy : les CSS feuille à feuille" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/conferences/laccessibilite-dans-une-chaine-de-production-web.php" title="L’accessibilité dans une chaîne de production Web" />
	...
	<meta name="twitter:title" content="Le Kit documentaire de conception pour simplifier la communication…" />
	<meta property="twitter:description" content="A l’heure des standards et de la prolifération d’outils de sketching/wireframing/prototyping, où le vocabulaire de l’ergonomie côtoie celui du marketing, du design et de la technique, il est…" />
	<meta property="dc:title" content="Le Kit documentaire de conception pour simplifier la communication projet" />
	<meta property="og:title" content="Le Kit documentaire de conception pour simplifier la communication projet" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/mini-conferences/le-kit-de-ux-pour-standardiser-les-documents-de-conception-et-simplifier-la-communication-entre-les-.php" />
	<meta property="og:description" content="A l’heure des standards et de la prolifération d’outils de sketching/wireframing/prototyping, où le vocabulaire de l’ergonomie côtoie celui du marketing, du design et de la technique, il est…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le Kit documentaire de conception pour simplifier la communication projet</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-113">
						<header>
							<h1>Le Kit documentaire de conception pour simplifier la communication projet</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xh8h78?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/telechargements/jeu-PA-06.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-113">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/mini-conferences/le-kit-de-ux-pour-standardiser-les-documents-de-conception-et-simplifier-la-communication-entre-les-.php" class="url">Le Kit documentaire de conception pour simplifier la communication projet</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Lieu</dt>
<dd class="column location"></dd>
...
<dd class="column">
14 <abbr title="heures">h</abbr> 35
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2010/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>A l’heure des standards et de la prolifération d’outils de sketching/wireframing/prototyping, où le vocabulaire de l’ergonomie côtoie celui du marketing, du design et de la technique, il est nécessaire de définir des normes et méthodologies de représentation et de formalisation (comme dans de nombreux corps de métiers : électronique, chimie,  bâtiment… ) qui faciliteront le partage et la réflexion, de la stratégie aux spécifications jusqu’au suivi de prod et aux tests.</p>

<p>Nous présenterons un kit de 10 documents clés afin de mieux formaliser les enjeux de conception, mieux décrire les parcours utilisateurs, et les comportements d’interface. Ce kit est issu d'une demarche methodologique de conduite de projet. Il propose un framework à vocation universelle et se base sur un language visuel. Il permet de poser les bonnes questions et de fédérer les intervenants projet autour de la vision de l'utilisateur.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/christophe-cotin-valois.php">Christophe Cotin Valois</a> et <a href="https://www.paris-web.fr/2010/../orateurs/cedric-magnin.php">Cédric Magnin</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Christophe Cotin Valois" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_christophe_cotin_valois-thumb-143x143-53.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Christophe COTIN VALOIS, 34 ans, Directeur de Création, responsable du pôle Architecture d'information – DIGITAS.</p>

<p>Diplômé d’esthétique de la communication et de l’école de l’Image GOBELINS, Christophe a débuté comme Directeur Artistique junior puis Architecte d’information chez IBM E-business Services (1998-2001) où il a eu l’occasion de travailler sur les premiers gros portails  et systèmes d’informations français (L'Equipe, Bouygues Telecom, Carrefour, La Tribune); ensuite comme consultant designer UX freelance pour les agences et ses annonceurs (Pages Jaunes, C-Discount, Longchamp). En 2006 il intègre DIGITAS pour développer le pôle UX/IA et instaurer une méthodologie dans l’agence.</p>

<p>Depuis 1998,  son travail a constamment porté sur les problématiques de conception et d’innovation avec l’expérience utilisateur comme objectif. Dès 2001, il a commencé à enseigner une nouvelle méthode issue des best practices IBM à l’Ecole des Gobelins et dans diverses écoles multimédia. Cette méthodologie a été appliquée à la refonte de nombreux projets de marketing serviciel et relationnel (C+VOD, Nissan, Lancôme, Renault).</p>

<p>Christophe est membre de l’Information Architecte Institute.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Cédric Magnin" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_cedric-magnin-thumb-143x143-66.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Cédric MAGNIN, Architecte d’information – DIGITAS</p>

<p>Cédric découvre le Web en 2004 dans une agence interactive multimédia. Il prend vite goût au développement web front-office et se forme grâce à Alsacréations et Pompage.</p>

<p>Il intègre DIGITAS (Business interactif à l’époque) et fait des standards et de la qualité les dénominateurs communs de ses travaux. Il participe à l’instauration de cette démarche dans l’agence au pôle front-end où il travaille sur les grands comptes de l’agence. En 2008, il rejoint l’équipe de Christophe COTIN VALOIS comme architecte de l’information, sur des comptes comme Nissan Europe, Whirlpool et Orange.</p>

<p>Cédric fut membre de l'association Paris-Web de 2007 à 2009.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/mini-conferences/le-kit-de-ux-pour-standardiser-les-documents-de-conception-et-simplifier-la-communication-entre-les-.php&amp;ref=prez-le-kit-de-ux-pour-standardiser-les-documents-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
