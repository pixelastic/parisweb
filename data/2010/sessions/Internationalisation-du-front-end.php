...
<title>Paris Web - Internationalisation du Front</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2010/ateliers/comment-utiliser-css-3-aujourdhui.php" title="CSS 3 aujourd’hui : quoi et comment ?" />
<link rel="next bookmark" href="https://www.paris-web.fr/2010/ateliers/xp-game.php" title="XP Game" />
	...
	<meta name="twitter:title" content="Internationalisation du Front" />
	<meta property="twitter:description" content="Aujourd'hui la quasi-totalité des CMS proposent des fonctionnalités d'internationalisation afin de réaliser des sites disponibles en plusieurs langues. Mais qu'en est-il du coté de l’intégrateur ?…" />
	<meta property="dc:title" content="Internationalisation du Front" />
	<meta property="og:title" content="Internationalisation du Front" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2010/ateliers/Internationalisation-du-front-end.php" />
	<meta property="og:description" content="Aujourd'hui la quasi-totalité des CMS proposent des fonctionnalités d'internationalisation afin de réaliser des sites disponibles en plusieurs langues. Mais qu'en est-il du coté de l’intégrateur ?…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Internationalisation du Front</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-137">
						<header>
							<h1>Internationalisation du Front</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/pw10-101016121527-phpapp02" 
	...
	<section class="s-talk-subject" id="sujet-137">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2010/ateliers/Internationalisation-du-front-end.php" class="url">Internationalisation du Front</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2010/../orateurs/yannick-croissant.php">Yannick Croissant</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Yannick Croissant" src="https://www.paris-web.fr/2010/assets_c/2010/07/orateur_yannick_croissant-thumb-143x143-51.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Yannick Croissant est intégrateur web au pôle sport de l'agence interactive de TF1 depuis maintenant quatre ans. Travaillant dans une petite agence mais aussi dans une grande entreprise, il a été très vite confronté aux nombreuses contraintes de production qui en découlent.</p>

<p>Œuvrant pour des clients tels que le Paris Saint-Germain ou l'Olympique de Marseille, il essaye d'allier la qualité, les performances et l'accessibilité sur ses différents projets (et ce n'est pas tous les jours facile).</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2010/ateliers/Internationalisation-du-front-end.php&amp;ref=prez-Internationalisation-du-front-end&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
