...
<title>Paris Web - HTML5.1 + web platform APIs</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/pause-vendredi-1040.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/css-et-edition-wysiwyg-lamour-vache.php" title="CSS et édition WYSIWYG, l'amour vache" />
	...
	<meta name="twitter:title" content="HTML5.1 + web platform APIs" />
	<meta property="twitter:description" content="Find out what's new with HTML5.1 and beyond, and get smart about the Push, Gamepad, Web Speech, Pointer Lock and Vibration APIs from W3C" />
	<meta property="dc:title" content="HTML5.1 + web platform APIs" />
	<meta property="og:title" content="HTML5.1 + web platform APIs" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/html51-web-platform-apis.php" />
	<meta property="og:description" content="Find out what's new with HTML5.1 and beyond, and get smart about the Push, Gamepad, Web Speech, Pointer Lock and Vibration APIs from W3C" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5.1 + web platform APIs</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1985">
						<header>
	...
	<section class="s-talk-subject" id="sujet-1985">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/html51-web-platform-apis.php" class="url">HTML5.1 + web platform APIs</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2016/recherche/standards" rel="tag">standards</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><p>The W3C is responsible for some of the oldest and most important web standards, as well as many of the newest and most innovative.</p>
<p>In this talk, Léonie Watson will take a lightening look at what's happening in web standards, from the technologies we use every day to the latest APIs. Find out what's new in HTML5.1, and what the future holds for HTML.</p>
<p>Get the latest on web notifications with the Push API, speech input/output with the Web Speech API, game interaction with the Gamepad and Vibration APIs, and event handling with Pointer Events and the Pointer Lock API.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/leonie-watson.php">Léonie Watson</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Léonie Watson" src="https://www.paris-web.fr/2016/assets_c/2016/05/Leonie_watson_143-thumb-143x143-625.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Léonie Watson began using the internet in 1993, turned it into a web design career in 1997, and (despite losing her eyesight along the way) has been enjoying herself thoroughly ever since.</p>
<p>Léonie is a Senior Accessibility Engineer with The Paciello Group (TPG) and owner of LJWatson Consulting. <br />Amongst other things she is co-chair of the W3C Web Platform Working Group, and a member of the ARIA and SVG working groups.</p>
<p>In her spare time Léonie blogs on tink.uk, writes for Smashing magazine, SitePoint.com and Net magazine. She also loves cooking, dancing and drinking tequila (although not necessarily in that order)!</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/html51-web-platform-apis.php&amp;ref=prez-html51-web-platform-apis&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
