...
<title>Paris Web - Getting Physical with the Beacon-Enabled Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/eco-conception-mon-site-web-au-regime.php" title="Éco-conception : mon site web au régime" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/informelle-jeudi-1510.php" title="Informelle" />
	...
	<meta name="twitter:title" content="Getting Physical with the Beacon-Enabled Web" />
	<meta property="twitter:description" content="Learn about beacons, the physical web, and how they can be leveraged to enhance a visit to a cultural site like a greenhouse or a museum." />
	<meta property="dc:title" content="Getting Physical with the Beacon-Enabled Web" />
	<meta property="og:title" content="Getting Physical with the Beacon-Enabled Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/getting-physical-with-the-beacon-enabled-web.php" />
	<meta property="og:description" content="Learn about beacons, the physical web, and how they can be leveraged to enhance a visit to a cultural site like a greenhouse or a museum." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Getting Physical with the Beacon-Enabled Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2008">
						<header>
							<h1>Getting Physical with the Beacon-Enabled Web</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2008">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/getting-physical-with-the-beacon-enabled-web.php" class="url">Getting Physical with the Beacon-Enabled Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/iot" rel="tag">IoT</a><br /><a href="http://www.paris-web.fr/2016/recherche/mobile" rel="tag">mobile</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Are you a web developer who has heard of beacons but hasn't used them because the thought of building a native app makes you hide in a particularly dark corner? Well, hide no more.</p>
<p>Previously, you needed to develop a mobile app to interface with beacons, as they primarily broadcast their UUID, which you need to pair with content within the app. With Eddystone, Google's beacon protocol, however, web developers have a completely new and exciting technique to enhance the ways with which people interact with their surroundings. <br />Pairing beacons with a beautiful website lets us experience the world around us in a great new way, bridging the web, mobile, and physical realms.</p>
<p>Jen Looper explains how to use your web skills to build innovative sites that answer a beacon's broadcast. Jen will demo a full-featured use case for enhancing a visit to a cultural site that will pick up a beacon signal, open a URL, and unlock both web content and a treasure box installed on location, containing a token for the visitor.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/jen-looper.php">Jen Looper</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jen Looper" src="https://www.paris-web.fr/2016/assets_c/2016/05/jen_looper_143-thumb-143x143-623.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Jen Looper est Developer Advocate chez Telerik (Progress), située à Boston, qui travaille depuis plus de 15 ans en tant que développeur web et mobile, spécialisée dans la création d'applications mobiles iOS et Android. Elle est multiculturaliste multilingue qui essaie chaque jour d'apprendre quelque chose de nouveau. Visitez son site internet: <a href="http://www.ladeezfirstmedia.com">http://www.ladeezfirstmedia.<wbr />com</a>, ou contactez-la sur Twitter <a href="https://twitter.com/jenlooper">@jenlooper</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/getting-physical-with-the-beacon-enabled-web.php&amp;ref=prez-getting-physical-with-the-beacon-enabled-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
