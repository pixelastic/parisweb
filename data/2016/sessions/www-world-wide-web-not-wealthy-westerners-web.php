...
<title>Paris Web - WWW: World Wide Web, not Wealthy Westerners' Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/accueil-des-participants-1.php" title="Accueil des participants" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/laccessibilite-decomplexee---ce-quelle-peut-faire-pour-vous.php" title="L'accessibilité décomplexée - ce qu'elle peut faire pour vous" />
	...
	<meta name="twitter:title" content="WWW: World Wide Web, not Wealthy Westerners' Web" />
	<meta property="twitter:description" content="There are challenges to web access in Asia and Africa that we need to understand" />
	<meta property="dc:title" content="WWW: World Wide Web, not Wealthy Westerners' Web" />
	<meta property="og:title" content="WWW: World Wide Web, not Wealthy Westerners' Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/www-world-wide-web-not-wealthy-westerners-web.php" />
	<meta property="og:description" content="There are challenges to web access in Asia and Africa that we need to understand" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>WWW: World Wide Web, not Wealthy Westerners' Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1987">
						<header>
							<h1>WWW: World Wide Web, not Wealthy Westerners' Web</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1987">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/www-world-wide-web-not-wealthy-westerners-web.php" class="url">WWW: World Wide Web, not Wealthy Westerners' Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/webperf" rel="tag">webperf</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><p>As the population and economies of the West stay static, the developing economies are seeing huge expansion, and a rising youthful population that have grown up with the Web. But there are challenges to web access in Asia and Africa that we need to understand if we want to reach the next 4 billion people with fast, performant sites.</p>
<p>Bruce will bring facts and figures from his years living in Asia and from working for Opera (often the only browser that people can use) to show you how to bring your brands to new markets.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/bruce-lawson.php">Bruce Lawson</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Bruce Lawson" src="https://www.paris-web.fr/2016/assets_c/2016/05/Bruce_Lawson_143-thumb-143x143-598.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Bruce is an open web standards advocate for Opera, the European browser. He's previously been tech lead for a large UK legal website, a tarot card reader, guitarist, tutor to a princess and Bollywood movie extra. Follow him at <a href="https://twitter.com/brucel">@brucel</a>, read him at <a href="http://www.brucelawson.co.uk/)">brucelawson.co.uk</a>, get him drunk at the bar.</p>
<p>Bruce est évangéliste des standards du web ouvert pour Opera, le navigateur européen. Auparavant, il a été chef technique pour un site web juridique Britannique à fort trafic, lecteur de cartes à tarot, guitariste, tuteur d'une princesse et figurant pour des films à Bollywood. Suivez-le sur <a href="https://twitter.com/brucel">@brucel</a>, lisez-le sur <a href="http://www.brucelawson.co.uk/)"><span>brucelawson.co.uk</span></a>, faites-le boire au bar.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/www-world-wide-web-not-wealthy-westerners-web.php&amp;ref=prez-www-world-wide-web-not-wealthy-westerners-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
