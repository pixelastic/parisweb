...
<title>Paris Web - L'accessibilité décomplexée - ce qu'elle peut faire pour vous</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/www-world-wide-web-not-wealthy-westerners-web.php" title="WWW: World Wide Web, not Wealthy Westerners' Web" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-vendredi-0950.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="L'accessibilité décomplexée - ce qu'elle peut faire pour vous" />
	<meta property="twitter:description" content="Adoptons un point de vue iconoclaste, voire... totalement décomplexé, sur l'accessibilité !" />
	<meta property="dc:title" content="L'accessibilité décomplexée - ce qu'elle peut faire pour vous" />
	<meta property="og:title" content="L'accessibilité décomplexée - ce qu'elle peut faire pour vous" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/laccessibilite-decomplexee---ce-quelle-peut-faire-pour-vous.php" />
	<meta property="og:description" content="Adoptons un point de vue iconoclaste, voire... totalement décomplexé, sur l'accessibilité !" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L'accessibilité décomplexée - ce qu'elle peut faire pour vous</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1999">
						<header>
							<h1>L'accessibilité décomplexée - ce qu'elle peut faire pour vous</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1999">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/laccessibilite-decomplexee---ce-quelle-peut-faire-pour-vous.php" class="url">L'accessibilité décomplexée - ce qu'elle peut faire pour vous</a></span></span></h2>
...
<dd class="column">
 9 <abbr title="heures">h</abbr> 00
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2016/recherche/methodologie" rel="tag">méthodologie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Plusieurs années de développement de composants accessibles, ça vous change une personne. <br />Mais plus important, cela change le regard qu'on peut avoir sur l'accessibilité, la façon dont on se sert de l'accessibilité, la manière dont on l'apprend, dont on la transmet et la façon... dont on la vend.</p>
<p>Et si on pouvait mieux faire en accessibilité en se posant des questions que l'on n'a pas osé se poser franchement ? <br />Et si on renversait complètement certains points de vue ? <br />Bienvenue de l'autre côté du miroir où, qui sait... chacun devra peut-être s'éloigner du jardin de l'accessibilité pour mieux s'en approcher.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/nicolas-hoffmann.php">Nicolas Hoffmann</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Nicolas Hoffmann" src="https://www.paris-web.fr/2016/assets_c/2016/05/nicolas_hoffmann_143-thumb-143x143-624.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Nicolas est développeur front-end et auteur de composants accessibles depuis plusieurs années.</p>
<p>Directeur du collectif OpenWeb, conférencier à divers événements comme Paris Web, Accessiday ou Web In Alps, il est également l'auteur du micro-framework CSS Röcssti et de plus d'une cinquantaine d'articles sur divers sujets comme la conception de CSS, Google Analytics, la qualité Web, etc.</p>
<p>Son quotidien est de dompter les CSS ainsi que toutes les joyeusetés du front-end par les sabres lasers de l'amélioration progressive et de l'accessibilité, le tout avec un niveau d'exigence qualitatif proche de la très haute horlogerie suisse. Une sorte de Jedi numérique en devenir, mais allez savoir pourquoi, il est surnommé le « suisse-allemand de la qualité web ».</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/laccessibilite-decomplexee---ce-quelle-peut-faire-pour-vous.php&amp;ref=prez-laccessibilite-decomplexee---ce-quelle-peut-f&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
