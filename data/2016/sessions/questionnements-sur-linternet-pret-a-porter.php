...
<title>Paris Web - Questionnements sur l'Internet prêt-à-porter</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-jeudi-1650.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/quand-les-militaires-se-prennent-au-jeu-du-design-sprint.php" title="Quand les militaires se prennent au jeu du design sprint" />
	...
	<meta name="twitter:title" content="Questionnements sur l'Internet prêt-à-porter" />
	<meta property="twitter:description" content="L'industrialisation de nos métiers a tendance à produire des interfaces clonées. Comment le designer peut tenter d'apporter du sens ?" />
	<meta property="dc:title" content="Questionnements sur l'Internet prêt-à-porter" />
	<meta property="og:title" content="Questionnements sur l'Internet prêt-à-porter" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/questionnements-sur-linternet-pret-a-porter.php" />
	<meta property="og:description" content="L'industrialisation de nos métiers a tendance à produire des interfaces clonées. Comment le designer peut tenter d'apporter du sens ?" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Questionnements sur l'Internet prêt-à-porter</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1994">
						<header>
							<h1>Questionnements sur l'Internet prêt-à-porter</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1994">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/questionnements-sur-linternet-pret-a-porter.php" class="url">Questionnements sur l'Internet prêt-à-porter</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>« On ne va pas ré-inventer la roue ». Combien de projets commencent ainsi, pour se terminer par la production d'un clone du concurrent, ou du dernier site à la mode ? Comment en vouloir à ceux qui prennent ce type de raccourcis ? Comment ne pas être séduits par ces innombrables UI Kits, disponibles gratuitement ou presque, qui semblent être une réponse rêvée à un besoin de design.</p>
<p>C'est vrai qu'ils sont rutilants, pétillants, bref irrésistibles.</p>
<p>Mais choisirait-on une paire de chaussures en se trompant volontairement de pointure ? Bien que fascinante, l'industrialisation de nos métiers à ce travers : une uniformisation des interfaces et un lissage des expériences. On sait de mieux en mieux produire des dispositifs interactifs propres et bien rangés, efficaces et bien peignés, mais qui sont autant de coquilles vides et interchangeables. Quel rôle le designer a à jouer dans cette bataille ?</p>
<p>Nous verrons dans cette conférence comment il peut tenter d'apporter du sens, non seulement aux expériences proposées aux utilisateurs mais aussi à son travail. Pour que ce projet ne soit pas juste le énième.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/amelie-boucher.php">Amélie Boucher</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Amélie Boucher" src="https://www.paris-web.fr/2016/assets_c/2016/05/Amelie-Boucher-thumb-143x143-578.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Amélie Boucher est experte en UX Design. <br />Elle pratique depuis 12 ans l'expérience utilisateur web et mobile pour des missions variées : e-commerce, éditorial, réseaux sociaux, logiciels et applications métier...</p>
<p>Engagée dans la promotion de la discipline en France, elle est l'auteur de trois livres sur le sujet : Ergonomie web, Ergonomie web illustrée et Expérience utilisateur mobile, le tout aux éditions Eyrolles.</p>
<p>Elle monte en 2013 un studio de design : L'UX sur le gâteau.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/questionnements-sur-linternet-pret-a-porter.php&amp;ref=prez-questionnements-sur-linternet-pret-a-porter&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
