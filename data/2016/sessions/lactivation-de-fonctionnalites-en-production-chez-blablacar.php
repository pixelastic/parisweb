...
<title>Paris Web - L'activation de fonctionnalités en production chez BlaBlaCar</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/laudio-na-pas-dit-son-dernier-mot.php" title="L'audio n'a pas dit son dernier mot" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/informelle-vendredi-1615.php" title="Informelle" />
	...
	<meta name="twitter:title" content="L'activation de fonctionnalités en production chez BlaBlaCar" />
	<meta property="twitter:description" content="Comment rendre heureux les devs, les ops et le produit ? Facile, mettez en place des features flags ! &lt;3" />
	<meta property="dc:title" content="L'activation de fonctionnalités en production chez BlaBlaCar" />
	<meta property="og:title" content="L'activation de fonctionnalités en production chez BlaBlaCar" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/lactivation-de-fonctionnalites-en-production-chez-blablacar.php" />
	<meta property="og:description" content="Comment rendre heureux les devs, les ops et le produit ? Facile, mettez en place des features flags ! &lt;3" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L'activation de fonctionnalités en production chez BlaBlaCar</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1992">
						<header>
							<h1>L'activation de fonctionnalités en production chez BlaBlaCar</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1992">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/lactivation-de-fonctionnalites-en-production-chez-blablacar.php" class="url">L'activation de fonctionnalités en production chez BlaBlaCar</a></span></span></h2>
...
<dd class="column">
16 <abbr title="heures">h</abbr> 15
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/programmation" rel="tag">programmation</a><br /><a href="http://www.paris-web.fr/2016/recherche/retour-dexperience" rel="tag">retour d'expérience</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Grâce aux feature flags, vous pouvez tester en prod ! \o/<br />Grâce aux feature flags, l'effet Capital ne sera plus un problème pour vous (ou presque) ! \o/ <br />Grâce aux feature flags, finis les bugs en prod ! \o/</p>
<p>Nous aimons les feature flags et nous saurons vous les faire aimer également !</p>
<p>Que ce soit sur le web ou sur le mobile, comptez sur nous pour décrire comment et pourquoi mettre en place des feature flags partout et tout le temps. Gérer l'activation ou l'impact d'une fonctionnalité en production est un casse tête pour tout le monde. Est-ce qu'une mise en production est nécessaire pour changer une configuration ? Comment gérer le pourcentages des utilisateurs éligibles à une fonctionnalité ? Activer une fonctionnalité en test uniquement pour un lot d'utilisateurs ? Ou alors comment couper une fonctionnalité instable ou trop gourmande en ressources serveur lors d'un pic de trafic ?</p>
<p>Nous allons vous montrer comment à BlaBlaCar nous gérons l'activation en direct de nos fonctionnalités ainsi que nos différentes mises en production.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/benjamin-de-bernardi.php">Benjamin De Bernardi</a> et <a href="https://www.paris-web.fr/2016/../orateurs/olivier-dolbeau.php">Olivier Dolbeau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Benjamin De Bernardi" src="https://www.paris-web.fr/2016/assets_c/2016/05/Benjamin_De_Bernardi143-thumb-143x143-596.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Lead Engineer <a href="https://twitter.com/BlaBlaCar">@BlaBlaCar</a>, fan de bermudas &amp; tongs.</p>
<p>Chez BlaBlaCar depuis 2014, Benjamin De Bernardi travaille majoritairement sur les problématiques lié à la croissance de BlaBlaCar et plus en détail sur des sujets en lien avec la recherche, le prix et le matching.</p>
<p>Amoureux de bière, il passe la plupart de son temps à discuter code/architecture dans des bars après ses heures de travail avec plus ou moins de sérieux en fonction de la qualité du breuvage.</p>
<p>Touche à tout technologique, il connecte son appartement à l'internet pendant ses heures perdues, de sa machine à laver qui envoie des push jusqu'au système d'éclairage fait maison.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Olivier Dolbeau" src="https://www.paris-web.fr/2016/assets_c/2016/05/Olivier_Dolbeau_143-thumb-143x143-619.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Quand il ne traîne pas dans des salles de concert ou dans un bar à siroter quelques pintes, Olivier prend parfois le temps de se rendre dans les locaux de BlaBlaCar où il bosse comme Architecte web après avoir passé quelques années côté développement.</p>
<p>Fan d'ElasticSearch, amoureux de RabbitMQ, il contribue également autant que possible au monde de l'open source. Etant feignant (parmi de nombreuses autres qualités), <br />Olivier aime également automatiser tout ce qui peut l'être, de l'intégration continue à l'installation de serveurs.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/lactivation-de-fonctionnalites-en-production-chez-blablacar.php&amp;ref=prez-lactivation-de-fonctionnalites-en-production-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
