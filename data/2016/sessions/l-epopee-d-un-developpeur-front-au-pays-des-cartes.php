...
<title>Paris Web - L'épopée d'un développeur front au pays des cartes</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/informelle-vendredi-1535.php" title="Informelle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/une-graphiste-parmi-les-devs.php" title="Une graphiste parmi les devs" />
	...
	<meta name="twitter:title" content="L'épopée d'un développeur front au pays des cartes" />
	<meta property="twitter:description" content="Une vue large des principes de bases, des technologies et des languages utilisés dans la carto web." />
	<meta property="dc:title" content="L'épopée d'un développeur front au pays des cartes" />
	<meta property="og:title" content="L'épopée d'un développeur front au pays des cartes" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/l-epopee-d-un-developpeur-front-au-pays-des-cartes.php" />
	<meta property="og:description" content="Une vue large des principes de bases, des technologies et des languages utilisés dans la carto web." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L'épopée d'un développeur front au pays des cartes</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2027">
						<header>
							<h1>L'épopée d'un développeur front au pays des cartes</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2027">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/l-epopee-d-un-developpeur-front-au-pays-des-cartes.php" class="url">L'épopée d'un développeur front au pays des cartes</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/cartographie" rel="tag">cartographie</a><br /><a href="http://www.paris-web.fr/2016/recherche/developpement" rel="tag">développement</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Un jour, on se réveille et on veut faire des cartes (interactives), mais le chemin est long et semé d'embûches.</p>
<p>Ce talk décrit cette aventure et les découvertes que j'ai faites en tant que développeur front. Je vous montre donc comment éviter les faux-pas, quelques fondamentaux incontournables, d'où on vient et où on va.</p>
<p>Je vous parle de l'histoire de la longitude, de pourquoi on a mis la Terre entière dans un carré et comment on cartographie le Pôle Nord. Des tuiles jusqu'à WebGL, je vous propose de disséquer les composants d'une carte sur le web.</p>
<p>GeoJSON, PostGIS, Overpass, graticule ne seront plus des termes barbares mais vos alliés pour construire des cartes et des datavizs belles et efficaces.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/erik-escoffier.php">Erik Escoffier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Erik Escoffier" src="https://www.paris-web.fr/2016/assets_c/2016/05/Erik-Escoffier-thumb-143x143-577.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Erik had an epiphany two years ago when looking at old maps in a library in Berlin - since then he's been obsessed with cartography.</p>
<p>First as a multimedia developer, then a frontender, he's been tinkering since about 8 years with a broad set of technologies and languages (Javascript, node, Unity3D, Haxe, augmented reality, interactive installations...), and is now fully dedicated to experiment with maps and geographical data. After working as a community technologist at CartoDB in Madrid, he's now a front-end and maps developer.</p>
<p>When he's not coding, Erik likes books, mountains, running and belgian beer (in that exact order).</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/l-epopee-d-un-developpeur-front-au-pays-des-cartes.php&amp;ref=prez-l-epopee-d-un-developpeur-front-au-pays-des-c&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
