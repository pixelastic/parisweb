...
<title>Paris Web - Développement artisanal d'un logiciel en 20 itérations</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/progressive-web-apps-le-futur-du-web-arrive.php" title="Progressive Web Apps : le futur du web arrive" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/informelle-vendredi-1145.php" title="Informelle" />
	...
	<meta name="twitter:title" content="Développement artisanal d'un logiciel en 20 itérations" />
	<meta property="twitter:description" content="Le développement itératif d'une billetterie en ligne c'est plus que de l'agile : il faut savoir tester, coder, refactorer... en équipe !" />
	<meta property="dc:title" content="Développement artisanal d'un logiciel en 20 itérations" />
	<meta property="og:title" content="Développement artisanal d'un logiciel en 20 itérations" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/developpement-artisanal-dun-logiciel-en-20-iterations.php" />
	<meta property="og:description" content="Le développement itératif d'une billetterie en ligne c'est plus que de l'agile : il faut savoir tester, coder, refactorer... en équipe !" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Développement artisanal d'un logiciel en 20 itérations</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2012">
						<header>
							<h1>Développement artisanal d'un logiciel en 20 itérations</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2012">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/developpement-artisanal-dun-logiciel-en-20-iterations.php" class="url">Développement artisanal d'un logiciel en 20 itérations</a></span></span></h2>
...
<dd class="column">
11 <abbr title="heures">h</abbr> 45
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/methodologie" rel="tag">méthodologie</a><br /><a href="http://www.paris-web.fr/2016/recherche/retour-dexperience" rel="tag">retour d'expérience</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Retour d'expérience d'un projet de refonte d'une billetterie en ligne sur dix mois.<br />L'enjeu attendu était les performances du back-end pour tenir la charge lors de l'ouverture des ventes. <br />L'enjeu réel a été de maintenir la base de code aussi bien back-end que front-end au fil des itérations.</p>
<p>Une équipe composée d'un Tech Lead et de quatre développeurs a réussi à livrer un produit maintenable en plus d'être bien conçu.</p>
<p>Après une brève présentation de l'architecture et des technologies utilisées, nous vous présenterons la méthodologie mise en place de l'itération 0 à l'itération 20. Nous vous expliquerons en quoi Software Craftsmanship est une extension naturelle des méthodologies agiles, et ce que les pratiques ont apporté à l'équipe de développement, au métier et à la DSI.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/damien-beaufils.php">Damien Beaufils</a> et <a href="https://www.paris-web.fr/2016/../orateurs/abel-andre.php">Abel André</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Damien Beaufils" src="https://www.paris-web.fr/2016/assets_c/2016/05/Damien_Beaufils_143-thumb-143x143-599.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Damien est développeur depuis 10 ans et membre de la tribu Software Craftsmanship chez OCTO Technology. <br />Convaincu qu'un logiciel bien conçu est nécessaire en plus d'un logiciel fonctionnel, il intervient en tant que Tech Lead chez ses clients, ou en tant que formateur sur les pratiques telles que Test Driven Development.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Abel André" src="https://www.paris-web.fr/2016/assets_c/2016/05/Abel-Andre-thumb-143x143-585.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Passionné de développement et agiliste confirmé, Abel intervient dans des projets de delivery agile et transmet les bonnes pratiques promues par la tribu Software Craftsmanship d'OCTO Technology.</p>
<p>Convaincu de par son expérience que les réalisations agiles nécessitent avant tout une excellence technique et un fort esprit d'équipe, Abel privilégie les pratiques d'eXtreme Programming chez ses clients.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/developpement-artisanal-dun-logiciel-en-20-iterations.php&amp;ref=prez-developpement-artisanal-dun-logiciel-en-20-it&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
