...
<title>Paris Web - Éco-conception : mon site web au régime</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-jeudi-1500.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/getting-physical-with-the-beacon-enabled-web.php" title="Getting Physical with the Beacon-Enabled Web" />
	...
	<meta name="twitter:title" content="Éco-conception : mon site web au régime" />
	<meta property="twitter:description" content="Doper l'expérience utilisateur de vos sites grâce à l'écoconception." />
	<meta property="dc:title" content="Éco-conception : mon site web au régime" />
	<meta property="og:title" content="Éco-conception : mon site web au régime" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/eco-conception-mon-site-web-au-regime.php" />
	<meta property="og:description" content="Doper l'expérience utilisateur de vos sites grâce à l'écoconception." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Éco-conception : mon site web au régime</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2004">
						<header>
							<h1>Éco-conception : mon site web au régime</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2004">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/eco-conception-mon-site-web-au-regime.php" class="url">Éco-conception : mon site web au régime</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2016/recherche/webperf" rel="tag">webperf</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>En 20 ans, le poids des pages web a été multiplié par 115 ! Cette obésité se paye au prix fort, temps en terme d'expérience utilisateur et de budget qu'au niveau des impacts environnementaux.</p>
<p>À l'échelle mondiale, on parle désormais d'un 6ème continent numérique pour l'empreinte environnementale de l'Internet. <br />Il faut dire qu'elle est déjà deux fois plus importante que celle de la France ! Heureusement, la démarche d'écoconception permet de dégraisser les sites web et autres services en ligne.</p>
<p>Après une courte introduction sur ce qu'est l'éco-conception et pourquoi cette démarche est désormais essentielle, nous étudierons ensemble plusieurs cas d'école et passerons en revue les principales bonnes pratiques à mettre en œuvre, à chaque étape du projet : conception fonctionnelle, conception graphique et ergonomie, architecture technique, développement, hébergement, etc....</p>
<p>Nous ferons également le lien avec les bonnes pratiques de performances web et d'accessibilité. <br />Nous partagerons également avec vous des résultats concrets et quantifiés de missions récentes. <br />Par exemple : comment nous avons divisé par 11 le poids d'une page d'accueil en 5 secondes et sans toucher une seule ligne de code.</p>
<p>Cette conférence s'adresse autant aux chefs de projets qu'aux développeurs, concepteurs UX, intégrateurs et autres graphistes.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/frederic-bordage.php">Frédéric Bordage</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Frédéric Bordage" src="https://www.paris-web.fr/2016/assets_c/2016/05/frederic_bordage_143-thumb-143x143-605.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Frédéric aide de grandes entreprises privées et publiques à éco-concevoir leurs logiciels et notamment leurs sites web et services en ligne. Considéré comme le précurseur du domaine en France, il est l'auteur du livre « éco-conception web : les 115 bonnes pratiques » publié chez Eyrolles et du service en ligne www.ecoindex.fr.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/eco-conception-mon-site-web-au-regime.php&amp;ref=prez-eco-conception-mon-site-web-au-regime&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
