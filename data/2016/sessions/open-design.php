...
<title>Paris Web - Open Design</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/pourquoi-le-web-devrait-sinteresser-au-livre-numerique.php" title="Pourquoi le web devrait s'intéresser au livre numérique" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/ux-et-ethique.php" title="UX et éthique" />
	...
	<meta name="twitter:title" content="Open Design" />
	<meta property="twitter:description" content="Open Design : les initiatives existantes et des pistes de collaboration autour du design graphique, des fontes libres et de l'objet libre." />
	<meta property="dc:title" content="Open Design" />
	<meta property="og:title" content="Open Design" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/open-design.php" />
	<meta property="og:description" content="Open Design : les initiatives existantes et des pistes de collaboration autour du design graphique, des fontes libres et de l'objet libre." />
...
<body>
	...
	<section class="s-talk-subject" id="sujet-1997">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/open-design.php" class="url">Open Design</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/design" rel="tag">design</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>« Open Source » est une expression qui peut nous être familière, mais qu'en est-il pour « Open Design » ? Comment pourrait-on définir l'Open Design ?</p>
<p>Les dessous de la création en design sont souvent secrets pour protéger le processus de conception aussi bien que les techniques utilisées, pour en garder l'exclusivité, pour que les œuvres originales ne soient pas dupliquées. Comment remettre en question cette vision et ouvrir les pratiques de création? Où il sera question des initiatives existantes et de pistes de collaboration autour du design graphique, des fontes libres et de l'objet libre.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/my-le.php">My Lê</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="My Lê" src="https://www.paris-web.fr/2016/assets_c/2016/05/my-le-thumb-143x143-581.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Designer inspirée par les domaines de l'art, l'illustration, la typographie, la calligraphie, My cherche à diffuser les pratiques de design graphique et artistiques.</p>
<p>Elle est attachée à partager les projets, les logiciels et les services libre et open source. Elle donne des ateliers d'initiation HTML &amp; CSS en tant que bénévole Mozilla.</p></div>
</div>
