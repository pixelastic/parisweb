...
<title>Paris Web - WCAG.next - where do we go from here?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/le-deploiement-manuel-non-merci-jessaie-darreter.php" title="Le déploiement manuel : non merci, j'essaie d'arrêter !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/informelle-vendredi-1430.php" title="Informelle" />
	...
	<meta name="twitter:title" content="WCAG.next - where do we go from here?" />
	<meta property="twitter:description" content="Deque System's Principle Accessibility Strategist John Foliot provide some insights and future milestones towards WCAG.next" />
	<meta property="dc:title" content="WCAG.next - where do we go from here?" />
	<meta property="og:title" content="WCAG.next - where do we go from here?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/wcagnext-where-do-we-go-from-here.php" />
	<meta property="og:description" content="Deque System's Principle Accessibility Strategist John Foliot provide some insights and future milestones towards WCAG.next" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span><a href="https://www.paris-web.fr/2016/">Programme 2016</a></span>
				<span>WCAG.next - where do we go from here?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2018">
						<header>
							<h1>WCAG.next - where do we go from here?</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2018">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/wcagnext-where-do-we-go-from-here.php" class="url">WCAG.next - where do we go from here?</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2016/conferences/">Conférence</a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/">Salle Mœbius</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2016/30.php">vendredi 30</a>
</dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2016/recherche/standards" rel="tag">standards</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>

</dl>
</div>
		</aside>
    <div class="talk-description" lang="en"><p>The W3C's Web Content Accessibility Guidelines (WCAG) 2.0 were first published on December 11th, 2008, and have become the defacto standard for web accessibility around the planet.</p>
<p>The Specification has become an ISO standard, is referenced directly by laws and legislation in numerous countries (while serving as a template for other regional laws), and has become a well known (if sometimes less understood) Specification in the web developer's toolbox today.</p>
<p>But December 2008 was a long time ago on the web: the hottest mobile device was the iPhone 3G, HTML5 was still mostly a WHAT WG specification, ARIA was in it's early days of being drafted (with no support anywhere), and the hot browsers of the day were Internet Explorer 6/7 (58.4%) and Firefox 2 (31.1%).</p>
<p>Boy, have things changed!</p>
<p>And yet, WCAG 2.0 remains WCAG 2.0, and accessibility experts at the W3C recognized that without keeping up with the times, WCAG 2.0 would soon be a dated specification, with gaps and holes, and serious issues left unaddressed. BUT, because WCAG 2.0 has been referenced by laws and legislation around the planet, updating WCAG 2.0 is problematic - the W3C could not change the WCAG specification without stepping on those laws. <br />But there is a plan to move forward! Join Deque System's Principal Accessibility Strategist John Foliot, as he takes us through the history, the hiccups, the dilemmas and decisions as the W3C moves forward in keeping web accessibility requirements, techniques and best practices current, to best service the millions of Persons with Disabilities on the web today.</p>
<p>Learn how far we've come in the areas of accessibility on the mobile platform, accessibility for users with low vision, and the amazing progress being made for users with various forms of cognitive disability.</p>
<p>John will also provide some insights and future milestones we can all anticipate towards an enhanced web accessibility standard, and the future of WCAG.next.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/john-foliot.php">John Foliot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="John Foliot" src="https://www.paris-web.fr/2016/assets_c/2016/05/john_foliot_143-thumb-143x143-622.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>John Foliot is an internationally recognized Web Accessibility Specialist and champion for the cause of web standards and universal accessibility. He has provided consultation services to government agencies, educational institutions and private sector companies since 1998. He has previously provided accessibility consulting to the Government of Canada, and has held accessibility related positions at JPMorgan Chase and Stanford University. His wealth of Digital Accessibility experience and insight enables him to provide stakeholders with applicable, simple and accessible strategies and solutions to everyday challenges in website design.</p>
<p>John is currently at Deque Systems Inc., where he is a Principal Accessibility Strategist and official corporate representative for Deque at the W3C. He is an active Contributor to W3C Working Groups for HTML5, the Accessible Platform Architecture, and WCAG and related topics; W3C Community Groups for WAI-Engage, Media/Timed-Text and related topics, and was an invited speaker at the W3C Television on the Web Interest Group. Working within the W3C HTML5 Accessibility Task Force, John was co-facilitator of the Media Sub Group, and has contributed directly to the HTML5 Standard at the W3C.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/wcagnext-where-do-we-go-from-here.php&amp;ref=prez-wcagnext-where-do-we-go-from-here&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
...
<section class="news l-fixedColumn l-block l-primary">
		<article>
			<h2>L'édition 2016</h2>
			<ul>
            <li><a class="roll" href="/2016/conferences/" rel="bookmark">Les conférences 2016</a></li>
            <li><a class="roll" href="/2016/29.php" rel="bookmark">Programme du jeudi 29</a></li>
            <li><a class="roll" href="/2016/30.php" rel="bookmark">Programme du vendredi 30</a></li>
            <li><a class="roll" href="/2016/ateliers/" rel="bookmark">Les ateliers 2016</a></li>
            <li><a class="roll" href="/2016/01.php" rel="bookmark">Programme du samedi 01</a></li>
            <li><a class="roll" href="/2016/orateurs/" rel="bookmark">Les orateurs 2016</a></li>
			</ul>
        <ul class="large">
            <li><a href="http://www.paris-web.fr/2016/conferences-parisweb-2016.ics">Calendrier au format iCAL/ics des conférences 2016</a></li>
