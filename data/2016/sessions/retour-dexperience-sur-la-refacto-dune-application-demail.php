...
<title>Paris Web - Retour d'expérience sur la refactorisation d'une application (d'e-mail)</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/nodejs-partout.php" title="[Conf Sponsor] Node.js partout" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/informelle-jeudi-1620.php" title="Informelle" />
	...
	<meta name="twitter:title" content="Retour d'expérience sur la refactorisation d'une application…" />
	<meta property="twitter:description" content="Corriger une dette technique avec le moins de perte et de panique : c'est possible? Avec un peu de méthode et un grand sourire : tout passe!" />
	<meta property="dc:title" content="Retour d'expérience sur la refactorisation d'une application (d'e-mail)" />
	<meta property="og:title" content="Retour d'expérience sur la refactorisation d'une application (d'e-mail)" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/retour-dexperience-sur-la-refacto-dune-application-demail.php" />
	<meta property="og:description" content="Corriger une dette technique avec le moins de perte et de panique : c'est possible? Avec un peu de méthode et un grand sourire : tout passe!" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Retour d'expérience sur la refactorisation d'une application (d'e-mail)</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1996">
						<header>
							<h1>Retour d'expérience sur la refactorisation d'une application (d'e-mail)</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1996">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/retour-dexperience-sur-la-refacto-dune-application-demail.php" class="url">Retour d'expérience sur la refactorisation d'une application (d'e-mail)</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2016/recherche/metier" rel="tag">métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Votre équipe a passé six mois à re-factoriser une application et vous vous rendez compte que le problème est ailleurs : à chaque correction de bug, un nouveau apparaît et ce malgré la pertinence des correctifs. <br />Il se trouve que votre application est trop vieille. Trop de développeurs sont passés par là, la logique du développement s'est perdue en route (manque de cohérence). <br />Une solution s'impose, mais personne n'ose en parler : IL FAUT TOUT REFAIRE.</p>
<p>À cette idée : « panique » se suivent les pensées :</p>
<ul>
<li>OMG !</li>
<li>6 mois de perdus,</li>
<li>il faut virer tous les développeurs, ces incompétents,</li>
<li>il faut externaliser le développement,</li>
<li>« je vous avez dit qu'il fallait prendre CE framework ! »,</li>
<li>jamais on n'y arrivera... PAS DE PANIQUE.</li>
</ul>
<p>Repartir de zéro n'est pas toujours une solution. Il faut réussir à recoller les morceaux, quitte à tout casser, pendant le moins de temps possible. C'est inévitable, mais faisons ça raisonnablement. Cette conférence tentera de répondre (intelligement) aux questions suivantes pour arriver à vos fins :</p>
<ul>
<li>Comment présenter la chose à ses managers sans les faire paniquer ?</li>
<li>Jusqu'où peut-on aller dans la casse ?</li>
<li>À partir de quand on s'égare ?</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/noelie-andrieu.php">Noëlie Andrieu</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Noëlie Andrieu" src="https://www.paris-web.fr/2016/assets_c/2016/05/Noelie-Andrieu-thumb-143x143-587.jpeg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Développeur Javascript depuis 2002, Noëlie est passée de l'agence de communication, jusqu'au logiciel libre (Cozycloud) en passant pas la case blog (Skyblog).</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/retour-dexperience-sur-la-refacto-dune-application-demail.php&amp;ref=prez-retour-dexperience-sur-la-refacto-dune-applic&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
