...
<title>Paris Web - L'audio n'a pas dit son dernier mot</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-vendredi-1605.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/lactivation-de-fonctionnalites-en-production-chez-blablacar.php" title="L'activation de fonctionnalités en production chez BlaBlaCar" />
	...
	<meta name="twitter:title" content="L'audio n'a pas dit son dernier mot" />
	<meta property="twitter:description" content="L'audio a de véritables atouts à exploiter avec le web et ses technos. Il est temps de marier l'audio aux interfaces et repenser son design." />
	<meta property="dc:title" content="L'audio n'a pas dit son dernier mot" />
	<meta property="og:title" content="L'audio n'a pas dit son dernier mot" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/laudio-na-pas-dit-son-dernier-mot.php" />
	<meta property="og:description" content="L'audio a de véritables atouts à exploiter avec le web et ses technos. Il est temps de marier l'audio aux interfaces et repenser son design." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L'audio n'a pas dit son dernier mot</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1991">
						<header>
							<h1>L'audio n'a pas dit son dernier mot</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1991">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/laudio-na-pas-dit-son-dernier-mot.php" class="url">L'audio n'a pas dit son dernier mot</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2016/recherche/iot" rel="tag">IoT</a><br /><a href="http://www.paris-web.fr/2016/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Souvent délaissé, l'audio pourrait bientôt se relever aux oreilles de tous pour montrer ses véritables atouts. Grâce à la maturité des outils de speech to text, du développement de la reconnaissance vocale, l'audio est proche de se débarrasser de ses handicaps, pour devenir SEO-friendly, concourir à l'accessibilité du web et s'inscrire dans les interactions hommes/machines qui se développent autour de l'Internet des objets.</p>
<p>D'autre part, les webradios, les offres de podcast, et les plateformes de streaming se sont installées dans des usages circonscrits depuis une décennie, sans repenser totalement l'expérience qu'elles proposent à leurs publics. Rencontrer le code, les algos et l'UX est un enjeu.</p>
<p>Que signifierait « designer l'audio » ? A la fois les contenus, leurs formats, les interfaces, les interactions, les images, les couleurs et les émotions du son ? De l'écoute à la prise de parole, quelle place pour l'utilisateur à l'heure du smart(micro)phone roi, et des outils de production de diffusion audio en mode saas ? La conférence mettra en lumière les pratiques et les innovations émergentes qui tentent de dessiner les contours de la radio et l'audio « orienté web ».</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/carine-fillot.php">Carine Fillot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Carine Fillot" src="https://www.paris-web.fr/2016/assets_c/2016/05/Carine-Fillot-thumb-143x143-584.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p><span style="line-height: 1.62;">Ado, Carine Fillot découvre la radio des années 90, avec ses libres antennes aux coups de téléphones encore filaires, et rejoint Radio France en 1997 pour la création du Mouv', la radio jeune du groupe.</span></p>
<p>En parallèle, elle se forme aux métiers de l'Internet et du multimédia, et monte la webradio associative Kill the Fm, qui développe webzine, stream musical et offre de podcast. Le projet rassemble des audiophiles et bloggeurs. Elle y forme les participants aux pratiques de la radio (animation, interview, montage, émissions).</p>
<p>Après une carrière d'animatrice et de productrice, Carine rejoint en 2012 la direction des Nouveaux Médias de Radio France comme chargée éditoriale de programmes web (longformats, webdocss, vidéos interactives, son 3d) et s'initie à l'agilité web autour du projet de plateforme musicale RF8.</p>
<p>En Septembre 2015, Radio France lui confie une mission sur l'innovation ouverte au sein de la direction du Numérique, pour initier des collaborations externes autour de ses enjeux (voiture connectée, iot, innovation sonore, etc). Carine lance sa micro-entreprise <a href="http://tactactac.fr/">TacTacTac.fr</a>, avec une première offre de formation à la radio « orientée web » avec une approche participative et numérique, et quitte Radio France l'été 2016 pour se consacrer à un projet de création d'entreprise autour du son et du web.</p>
<p></p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/laudio-na-pas-dit-son-dernier-mot.php&amp;ref=prez-laudio-na-pas-dit-son-dernier-mot&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
