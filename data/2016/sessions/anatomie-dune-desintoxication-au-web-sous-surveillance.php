...
<title>Paris Web - Anatomie d'une désintoxication au Web sous surveillance</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/ouverture-des-conferences-s2.php" title="Ouverture des conférences" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/webassembly-la-cible-de-compilation-pour-le-web.php" title="WebAssembly, la cible de compilation pour le web" />
	...
	<meta name="twitter:title" content="Anatomie d'une désintoxication au Web sous surveillance" />
	<meta property="twitter:description" content="Vous n'aimez pas qu'on s'immisce dans votre intimité ? Et si vous commenciez par respecter la vie privée de « vos » internautes ?" />
	<meta property="dc:title" content="Anatomie d'une désintoxication au Web sous surveillance" />
	<meta property="og:title" content="Anatomie d'une désintoxication au Web sous surveillance" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/anatomie-dune-desintoxication-au-web-sous-surveillance.php" />
	<meta property="og:description" content="Vous n'aimez pas qu'on s'immisce dans votre intimité ? Et si vous commenciez par respecter la vie privée de « vos » internautes ?" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Anatomie d'une désintoxication au Web sous surveillance</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1986">
						<header>
							<h1>Anatomie d'une désintoxication au Web sous surveillance</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1986">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/anatomie-dune-desintoxication-au-web-sous-surveillance.php" class="url">Anatomie d'une désintoxication au Web sous surveillance</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/vie-privee" rel="tag">vie privée</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>La monétisation d'informations personnelles est aujourd'hui le modèle économique dominant sur le Web.</p>
<p>À mon grand dam, dans la mesure où je n'aime pas trop que des multinationales non-imposables viennent mettre leur gros nez numérique dans mes petites affaires. <br />Saviez-vous qu'on peut obtenir une bonne approximation de votre QI en analysant la liste de vos derniers « like » et prédir la durée de votre relation de couple à partir de la structure du graphe de vos amis sur Facebook ?</p>
<p>Google et ses amis disposent de plus d'informations sur vous que vous ne le croyez. Lesquelles, et comment sont elles utilisées ? Nous valorisons notre intimité.</p>
<p>Pourtant, en tant que professionnel·le·s du Web, nous nous rendons complices des <abbr title="Google Amazon Facebook Apple et consorts">GAFAs</abbr> en leur communiquant -- par incompétence, paresse ou inconscience -- des masses de données sensibles sur « nos » internautes. Comment désintoxiquer nos pages Web des mouchards qui les infestent, et apporter à la vie privée de nos utilisateurs, l'attention qu'elle mérite ?</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/thibault-jouannic.php">Thibault Jouannic</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Thibault Jouannic" src="https://www.paris-web.fr/2016/assets_c/2016/05/Thibault%20Jouannic-thumb-240x240-492-thumb-143x143-618.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>A choisi de devenir développeur pour changer le monde sans quitter son fauteuil.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/anatomie-dune-desintoxication-au-web-sous-surveillance.php&amp;ref=prez-anatomie-dune-desintoxication-au-web-sous-sur&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
