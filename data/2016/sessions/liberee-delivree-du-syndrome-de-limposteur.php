...
<title>Paris Web - Libérée, délivrée... du syndrome de l'imposteur</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-jeudi-1020.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/conf-sponsor.php" title="[Conf Sponsor]" />
	...
	<meta name="twitter:title" content="Libérée, délivrée... du syndrome de l'imposteur" />
	<meta property="twitter:description" content="Comment j'ai lancé mon premier projet open source alors que je ne m'en serais pas crue capable." />
	<meta property="dc:title" content="Libérée, délivrée... du syndrome de l'imposteur" />
	<meta property="og:title" content="Libérée, délivrée... du syndrome de l'imposteur" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/liberee-delivree-du-syndrome-de-limposteur.php" />
	<meta property="og:description" content="Comment j'ai lancé mon premier projet open source alors que je ne m'en serais pas crue capable." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Libérée, délivrée... du syndrome de l'imposteur</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1989">
						<header>
							<h1>Libérée, délivrée... du syndrome de l'imposteur</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1989">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/liberee-delivree-du-syndrome-de-limposteur.php" class="url">Libérée, délivrée... du syndrome de l'imposteur</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Avant, j'avais plein d'excuses pour ne pas publier de code : il y a forcément mieux qui existe, le code va être tellement moche que personne ne voudra y toucher, et puis de toute façon ça va servir à rien<span style="color: #252525; font-family: sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 22.4px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; display: inline !important; float: none; background-color: #ffffff;">....</span></p>
<p>Bref, j'étais retenue par un bien beau syndrome de l'imposteur.</p>
<p>Puis un jour, alors toute jeune maman, j'ai fait un petit truc sous excel pour résoudre un de mes problèmes pratiques au quotidien (un obscur calcul de salaire de nounou). Je l'ai amélioré et partagé pour aider d'autres jeunes parents qui galéraient comme moi.</p>
<p>De fil en aiguille, le petit truc excel s'est transformé en belle application web, les pull requests ont commencé à arriver....</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/agnes-haasser.php">Agnès Haasser</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Agnès Haasser" src="https://www.paris-web.fr/2016/assets_c/2016/05/Agnes-Haasser-thumb-143x143-588.jpeg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Agnès Haasser est développeuse web depuis 2010, polyvalente avec un penchant marqué pour le beau CSS et l'orthographe. <br />Après un petit tour en SSII et en agence web, elle travaille maintenant à Lyon, chez TEA, pour développer le livre numérique en France et l'habitude du goûter de 16 h chez ses collègues.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/liberee-delivree-du-syndrome-de-limposteur.php&amp;ref=prez-liberee-delivree-du-syndrome-de-limposteur&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
