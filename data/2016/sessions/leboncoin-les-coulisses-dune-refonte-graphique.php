...
<title>Paris Web - Leboncoin, les coulisses d'une refonte graphique</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/pause-dejeuner-vendredi.php" title="Pause déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/conf-sponsor-2.php" title="[Conf Sponsor]" />
	...
	<meta name="twitter:title" content="Leboncoin, les coulisses d'une refonte graphique" />
	<meta property="twitter:description" content="Comment moderniser son design sans décevoir 25 millions d'utilisateurs par mois: les coulisses de la refonte RWD de Leboncoin" />
	<meta property="dc:title" content="Leboncoin, les coulisses d'une refonte graphique" />
	<meta property="og:title" content="Leboncoin, les coulisses d'une refonte graphique" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/leboncoin-les-coulisses-dune-refonte-graphique.php" />
	<meta property="og:description" content="Comment moderniser son design sans décevoir 25 millions d'utilisateurs par mois: les coulisses de la refonte RWD de Leboncoin" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Leboncoin, les coulisses d'une refonte graphique</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1988">
						<header>
							<h1>Leboncoin, les coulisses d'une refonte graphique</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1988">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/leboncoin-les-coulisses-dune-refonte-graphique.php" class="url">Leboncoin, les coulisses d'une refonte graphique</a></span></span></h2>
...
<dd class="column">
13 <abbr title="heures">h</abbr> 30
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Depuis 10 ans, leboncoin arborait un look simple et désuet.</p>
<p>En 2015 le projet de refondre le design des applications et du site -- en rendant ce dernier responsive au passage ! -- est lancé.</p>
<p>Après la mise en production de la nouvelle version il y a quelques mois, nous vous proposons de revenir sur le chemin parcouru : nos erreurs, nos galères, nos réussites, et ce que nous avons appris.</p>
<p>Au programme : de l'UX, de la technique, un peu d'histoire, des moments de doute et beaucoup de passion.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/jeremie-pereira.php">Jérémie Pereira</a> et <a href="https://www.paris-web.fr/2016/../orateurs/margaux-chenard.php">Margaux Chenard</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jérémie Pereira" src="https://www.paris-web.fr/2016/assets_c/2016/05/Je%CC%81re%CC%81mie_Pereira_143-thumb-143x143-609.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après un diplôme universitaire d'informatique, et 4 ans passés en tant que développeur web en agence, Jérémie Pereira rejoint l'aventure Leboncoin en 2012, en tant que développeur PHP.</p>
<p>En 2015, Jérémie se voit confier la responsabilité du projet de refonte du site. L'objectif étant de moderniser le site web, notamment en rendant ce dernier responsive. Il est alors chargé de la gestion des aspects techniques du projet.</p>
<p>Passionné par les technologies du web, il est aujourd'hui lead développeur dans l'équipe front-end.</p></div>
</div>
...
<div class="speaker-bio"><p>Diplômée d'école de commerce, Margaux Chenard rejoint l'aventure Leboncoin en 2014, en tant que Chef de produit B2C.</p>
<p>En 2015, Margaux s'est vue confier la responsabilité du projet de refonte du site. L'objectif étant de moderniser le site web, notamment en rendant ce dernier responsive. Elle est alors chargé de coordonner les aspects produit et UX de ce projet.</p>
<p>Elle est aujourd'hui en charge des aspects produit pour les comptes professionnels et particuliers.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/leboncoin-les-coulisses-dune-refonte-graphique.php&amp;ref=prez-leboncoin-les-coulisses-dune-refonte-graphiqu&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
