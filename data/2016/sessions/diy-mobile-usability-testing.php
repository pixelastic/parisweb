...
<title>Paris Web - DIY Mobile Usability Testing</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/la-blockchain-quand-lindividu-sert-au-collectif-malgre-lui.php" title="La blockchain, quand l'individu sert au collectif... malgré lui" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-jeudi-1210.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="DIY Mobile Usability Testing" />
	<meta property="twitter:description" content="A cheap, portable, easy to make and outrageously fun way of capturing your usability studies with mobile devices. What's not to like!" />
	<meta property="dc:title" content="DIY Mobile Usability Testing" />
	<meta property="og:title" content="DIY Mobile Usability Testing" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/diy-mobile-usability-testing.php" />
	<meta property="og:description" content="A cheap, portable, easy to make and outrageously fun way of capturing your usability studies with mobile devices. What's not to like!" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>DIY Mobile Usability Testing</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2019">
						<header>
							<h1>DIY Mobile Usability Testing</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2019">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/diy-mobile-usability-testing.php" class="url">DIY Mobile Usability Testing</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/mobile" rel="tag">mobile</a><br /><a href="http://www.paris-web.fr/2016/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><p>Usability testing is an interaction designer's bread and butter, but applying it to the study of mobile applications and websites brings considerable challenges.</p>
<p>Which device should we use for testing? Can we use an emulator? How do we prototype for mobile? Can we just recycle the tasks we use for desktop software tests? Do we test in the lab or in the wild? How do we record screen, fingers and facial expressions?</p>
<p>We don't intend to answer all those questions in just one session: that would be madness! We'll focus instead on the last one.</p>
<p>Follow us in our quest to set up a mobile usability testing environment on a tight budget. We'll show you how others do it. We'll roam around electronics and professional video stores searching for brackets and webcams.</p>
<p>We'll put our DIY skills to the test and waste a lot of silicon trying to build our mobile recording device. We'll scour the Internet for free software, and we'll finish off building the lab and running a usability test in front of your eyes. If we can do it, so can you!</p>
<p>You'll come out of this session knowing exactly what you need to do to run and record usability tests with mobile devices.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/bernard-tyers.php">Bernard Tyers</a> et <a href="https://www.paris-web.fr/2016/../orateurs/belen-barros-pena.php">Belen Barros Pena</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Bernard Tyers" src="https://www.paris-web.fr/2016/assets_c/2016/06/Bernard-Tyers-thumb-143x143-636.jpeg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Bernard Tyers started life as a real "nerd": sysadmin first, then telecommunications engineer building 3G networks with Nokia. <br />One day, he realised that the most important part of technology is the people who use it.</p>
<p>He quit his job, went back to school, and came out converted into a user researcher.<br />He is now part of the digital team at the UK Home Office.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Belen Barros Pena" src="https://www.paris-web.fr/2016/assets_c/2016/06/Belen-Barros-Pena-thumb-143x143-635.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>I have been an interaction designer and user researcher since 2007. In that time, I have done pretty much everything: from websites and web applications to mobile operating systems. <br />But all along I've had a soft spot for the "democratisation" of user-centered design techniques.</p>
<p>The "DIY mobile usability testing" project follows that spirit, and aims to prove that running studies with mobile devices doesn't need to be difficult or expensive, can be done by anybody, and it is a lot of fun.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/diy-mobile-usability-testing.php&amp;ref=prez-diy-mobile-usability-testing&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
