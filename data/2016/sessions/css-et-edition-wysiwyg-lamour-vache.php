...
<title>Paris Web - CSS et édition WYSIWYG, l'amour vache</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/html51-web-platform-apis.php" title="HTML5.1 + web platform APIs" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/informelle-vendredi-1045.php" title="Informelle" />
	...
	<meta name="twitter:title" content="CSS et édition WYSIWYG, l'amour vache" />
	<meta property="twitter:description" content="CSS et édition Wysiwyg, c'est l'amour vache. Difficile à implémenter et compliqué à matérialiser en UI. Pourquoi et comment ?" />
	<meta property="dc:title" content="CSS et édition WYSIWYG, l'amour vache" />
	<meta property="og:title" content="CSS et édition WYSIWYG, l'amour vache" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/css-et-edition-wysiwyg-lamour-vache.php" />
	<meta property="og:description" content="CSS et édition Wysiwyg, c'est l'amour vache. Difficile à implémenter et compliqué à matérialiser en UI. Pourquoi et comment ?" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>CSS et édition WYSIWYG, l'amour vache</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2000">
						<header>
							<h1>CSS et édition WYSIWYG, l'amour vache</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2000">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/css-et-edition-wysiwyg-lamour-vache.php" class="url">CSS et édition WYSIWYG, l'amour vache</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2016/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Pour une fois, il ne s'agit pas de canard mais de bovins.</p>
<p>En effet, la première remarque qui atteint en général le cerveau quand on tente d'éditer des CSS dans un outil de production Web <abbr title="What You See Is What You Get">WYSIWYG</abbr> est en général « meuuuh ? ». Nous allons vous expliquer en quoi les CSS sont historiquement et techniquement un langage très compliqué à manipuler dans un tel environnement.</p>
<p>Nous en profiterons pour jeter un œil sur les nouveautés en cours ou à venir dans les CSS et nous les confronterons à l'UI et l'UX. BlueGriffon sera utilisé pour illustrer le propos mais il ne s'agit aucunement d'une retape sur le produit.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/daniel-glazman.php">Daniel Glazman</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Daniel Glazman" src="https://www.paris-web.fr/2016/assets_c/2016/05/Daniel_Glazman_143-thumb-143x143-601.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Daniel Glazman (<a href="https://twitter.com/glazou">@glazou</a>) a co-présidé le CSS Working Group du World Wide Web Consortium (W3C) de 2008 à fin 2015 et dirige Disruptive Innovations, l'entreprise qui a publié les éditeurs web Nvu et BlueGriffon.</p>
<p>Connu tant pour son affection des canards sous toutes leurs formes que pour sa capacité à dormir une heure l'après-midi du second jour de Paris Web, il tente désespérément de faire oublier qu'il écrit des logiciels depuis maintenant 35 ans et des standards du Web depuis 20 ans, ce qui indique tout de même une sérieuse attaque neuronale.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/css-et-edition-wysiwyg-lamour-vache.php&amp;ref=prez-css-et-edition-wysiwyg-lamour-vache&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
