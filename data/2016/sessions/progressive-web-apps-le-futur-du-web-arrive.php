...
<title>Paris Web - Progressive Web Apps : le futur du web arrive</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-vendredi-1135.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/developpement-artisanal-dun-logiciel-en-20-iterations.php" title="Développement artisanal d'un logiciel en 20 itérations" />
	...
	<meta name="twitter:title" content="Progressive Web Apps : le futur du web arrive" />
	<meta property="twitter:description" content="Venez découvrir comment le Web peut proposer une expérience proche du natif sur mobile sans les inconvénients des magasins d'applications." />
	<meta property="dc:title" content="Progressive Web Apps : le futur du web arrive" />
	<meta property="og:title" content="Progressive Web Apps : le futur du web arrive" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/progressive-web-apps-le-futur-du-web-arrive.php" />
	<meta property="og:description" content="Venez découvrir comment le Web peut proposer une expérience proche du natif sur mobile sans les inconvénients des magasins d'applications." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Progressive Web Apps : le futur du web arrive</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2001">
						<header>
							<h1>Progressive Web Apps : le futur du web arrive</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2001">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/progressive-web-apps-le-futur-du-web-arrive.php" class="url">Progressive Web Apps : le futur du web arrive</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/responsive" rel="tag">responsive</a><br /><a href="http://www.paris-web.fr/2016/recherche/web-app" rel="tag">web app</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Une Progressive Web App, c'est un site web responsive dopé aux Service Workers qui commence sa vie dans un onglet via une simple URL et qui termine sur l'écran d'accueil comme une « vraie app ».</p>
<p>Ce nouveau concept nous promet un Web avec des notifications push, de la synchro en arrière-plan et un mode hors-ligne. Le débat Natif vs. Web est clairement relancé et au cours de cette session, je vous propose de découvrir pourquoi.</p>
<p>Nous aborderons le fonctionnement de base d'un Service Worker, les dix attributs des <abbr title="Progressive Web App">PWA</abbr> et nous verrons différentes expérimentations développées par la communauté.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/hubert-sablonniere.php">Hubert Sablonnière</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Hubert Sablonnière" src="https://www.paris-web.fr/2016/assets_c/2016/05/Hubert_Sablonniere_143-thumb-143x143-607.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Hubert est développeur Web et passionné d'HTML, CSS et JavaScript.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/progressive-web-apps-le-futur-du-web-arrive.php&amp;ref=prez-progressive-web-apps-le-futur-du-web-arrive&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
