...
<title>Paris Web - WebAssembly, la cible de compilation pour le web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/anatomie-dune-desintoxication-au-web-sous-surveillance.php" title="Anatomie d'une désintoxication au Web sous surveillance" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-jeudi-1020.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="WebAssembly, la cible de compilation pour le web" />
	<meta property="twitter:description" content="WebAssembly, une nouvelle cible de compilation destinée au web pour transpiler des programmes natifs vers le Web, nous dévoile ses secrets." />
	<meta property="dc:title" content="WebAssembly, la cible de compilation pour le web" />
	<meta property="og:title" content="WebAssembly, la cible de compilation pour le web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/webassembly-la-cible-de-compilation-pour-le-web.php" />
	<meta property="og:description" content="WebAssembly, une nouvelle cible de compilation destinée au web pour transpiler des programmes natifs vers le Web, nous dévoile ses secrets." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>WebAssembly, la cible de compilation pour le web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2013">
						<header>
							<h1>WebAssembly, la cible de compilation pour le web</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2013">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/webassembly-la-cible-de-compilation-pour-le-web.php" class="url">WebAssembly, la cible de compilation pour le web</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Les navigateurs principaux se sont réunis pour la spécification d'un nouveau standard W3C d'une nouvelle cible de compilation pour le web, WebAssembly.</p>
<p>Évolution naturelle d'asm.js, WebAssembly, ou wasm pour les intimes, permet d'exécuter des programmes écrits dans des langages natifs directement au sein d'un navigateur avec des performances élevées et garanties.</p>
<p>Qu'est-ce qu'est WebAssembly, concrètement ? À quels besoins son usage répond-il ? Comment interagit-il avec le reste de la Web Platform, en particulier avec JavaScript ? Peut-on l'utiliser dès aujourd'hui et si oui, comment ? S'agit-il de la mort annoncée de JavaScript ?</p>
<p>C'est ce à quoi nous essayerons de répondre lors de cette conférence.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/benjamin-bouvier.php">Benjamin Bouvier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Benjamin Bouvier" src="https://www.paris-web.fr/2016/assets_c/2016/05/Benjamin_Bouvier_143-thumb-143x143-595.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Benjamin est ingénieur logiciel à Mozilla Corporation, dans l'équipe travaillant sur l'implémentation de JavaScript dans la machine virtuelle de Firefox, Spidermonkey.</p>
<p>Récemment, Benjamin a participé à l'implémentation de SIMD.js pour donner la possibilité d'effectuer du calcul parallèle dans le navigateur, a amélioré la vitesse de compilation et d'exécution d'asm.js (le sous-ensemble hautement optimisable de JavaScript) et a participé aux discussions et à l'implémentation de WebAssembly dans Firefox.</p>
<p>Sur son temps libre, il apprend le ukulélé et essaie de redonner le contrôle de leurs données aux utilisateurs en implémentant des services libres auto-hébergeables, comme Kresus, une application web de finances personnelles.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/webassembly-la-cible-de-compilation-pour-le-web.php&amp;ref=prez-webassembly-la-cible-de-compilation-pour-le-w&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
