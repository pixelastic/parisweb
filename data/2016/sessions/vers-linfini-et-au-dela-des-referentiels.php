...
<title>Paris Web - Vers l'infini et au delà des référentiels</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/informelle-vendredi-1330.php" title="Informelle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-vendredi-1420.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Vers l'infini et au delà des référentiels" />
	<meta property="twitter:description" content="Les trucs et astuces pour améliorer l'accessibilité de vos sites au delà de la simple conformité RGAA" />
	<meta property="dc:title" content="Vers l'infini et au delà des référentiels" />
	<meta property="og:title" content="Vers l'infini et au delà des référentiels" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/vers-linfini-et-au-dela-des-referentiels.php" />
	<meta property="og:description" content="Les trucs et astuces pour améliorer l'accessibilité de vos sites au delà de la simple conformité RGAA" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Vers l'infini et au delà des référentiels</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2030">
						<header>
							<h1>Vers l'infini et au delà des référentiels</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2030">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/vers-linfini-et-au-dela-des-referentiels.php" class="url">Vers l'infini et au delà des référentiels</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Être conforme au RGAA c'est bien mais être conforme et réellement utilisable c'est mieux.</p>
<p>Au cours de cette mini conférence nous verrons ensemble quelques points simples qui améliorent l'accessibilité d'un site pour tous les utilisateurs mais qui pourtant ne sont pas requis par le RGAA.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/aurelien-levy.php">Aurélien Levy</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Aurélien Levy" src="https://www.paris-web.fr/2016/assets_c/2016/05/aurelien_levy-thumb-143x143-611.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après une formation initiale de graphiste, Aurélien a complété ses connaissances par une formation de concepteur réalisateur multimédia à l'Institut Supérieur des Arts. En janvier 2004, il devient l'un des premiers "experts Accessiweb en évaluation". Depuis 2008 il a rejoint la société Temesis donc il est désormais directeur général.</p>
<p>Il a notamment co-rédigé la version 1 et 2 du Référentiel Général d'Accessibilité pour les Administrations et animé plusieurs conférences dans le domaine de l'accessibilité (INOP, RMLL, Tech Days, CSUN, Paris-web,... ). Il contribue à la prise en compte de l'accessibilité dans des entités publics et privés comme La Poste, La Présidence de la République, Pages Jaunes, Le Défenseur des Droits ou Service-public</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/vers-linfini-et-au-dela-des-referentiels.php&amp;ref=prez-vers-linfini-et-au-dela-des-referentiels&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
