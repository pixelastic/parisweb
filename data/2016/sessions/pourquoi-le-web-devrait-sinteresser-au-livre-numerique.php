...
<title>Paris Web - Pourquoi le web devrait s'intéresser au livre numérique</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/organisez-des-cryptoparties.php" title="Organisez des cryptoparties !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/open-design.php" title="Open Design" />
	...
	<meta name="twitter:title" content="Pourquoi le web devrait s'intéresser au livre numérique" />
	<meta property="twitter:description" content="Beaucoup de spécifications sur la publication numérique pourraient se décider sans vous. Il n'est pas certain que vous le vouliez vraiment..." />
	<meta property="dc:title" content="Pourquoi le web devrait s'intéresser au livre numérique" />
	<meta property="og:title" content="Pourquoi le web devrait s'intéresser au livre numérique" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/pourquoi-le-web-devrait-sinteresser-au-livre-numerique.php" />
	<meta property="og:description" content="Beaucoup de spécifications sur la publication numérique pourraient se décider sans vous. Il n'est pas certain que vous le vouliez vraiment..." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Pourquoi le web devrait s'intéresser au livre numérique</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2020">
						<header>
							<h1>Pourquoi le web devrait s'intéresser au livre numérique</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2020">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/pourquoi-le-web-devrait-sinteresser-au-livre-numerique.php" class="url">Pourquoi le web devrait s'intéresser au livre numérique</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2016/recherche/edition" rel="tag">édition</a><br /><a href="http://www.paris-web.fr/2016/recherche/standards" rel="tag">standards</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Après en avoir emprunté les langages et essayé de construire des spécifications dédiées, le monde du livre numérique a décidé de se rapprocher du web et d'y contribuer.</p>
<p>Aujourd'hui, l'International Digital Publishing Forum et le W3C collaborent à l'amélioration des spécifications concernant la publication numérique : typographie, inflexions sémantiques, publications web portables voire même réglages utilisateurs sont autant de choses qui pourraient se décider sans vous.</p>
<p>Seulement, la culture du livre numérique n'est pas forcément celle du web... et il serait peut-être préférable que vous veniez jouer les grands frères pour aider notre communauté à grandir.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/jiminy-panoz.php">Jiminy Panoz</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jiminy Panoz" src="https://www.paris-web.fr/2016/assets_c/2016/05/Jiminy_Panoz_143-thumb-143x143-610.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Jiminy Panoz est un développeur et designer de livres numériques. <br />Depuis 4 ans, il propose d'accompagner les auteurs et les éditeurs dans leur transition numérique. Son objectif prioritaire est d'aider la communauté du livre numérique à fournir un travail de qualité.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/pourquoi-le-web-devrait-sinteresser-au-livre-numerique.php&amp;ref=prez-pourquoi-le-web-devrait-sinteresser-au-livre-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
