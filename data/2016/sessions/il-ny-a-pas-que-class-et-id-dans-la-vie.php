...
<title>Paris Web - Il n'y a pas que class et id dans la vie</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/informelle-jeudi-1620.php" title="Informelle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-jeudi-1650.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Il n'y a pas que class et id dans la vie" />
	<meta property="twitter:description" content="La tendance est au lissage des CSS, avec des classes partout. Si on jouait avec de vrais sélecteurs bien poilus, pour voir les avantages ?" />
	<meta property="dc:title" content="Il n'y a pas que class et id dans la vie" />
	<meta property="og:title" content="Il n'y a pas que class et id dans la vie" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/il-ny-a-pas-que-class-et-id-dans-la-vie.php" />
	<meta property="og:description" content="La tendance est au lissage des CSS, avec des classes partout. Si on jouait avec de vrais sélecteurs bien poilus, pour voir les avantages ?" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Il n'y a pas que class et id dans la vie</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2010">
						<header>
							<h1>Il n'y a pas que class et id dans la vie</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2010">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/il-ny-a-pas-que-class-et-id-dans-la-vie.php" class="url">Il n'y a pas que class et id dans la vie</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2016/recherche/css" rel="tag">CSS</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Les sélecteurs d'attributs et de parenté sont généralement sous-utilisés et parfois mêmes inconnus au bataillon -- notamment dans l'univers back-end. Pourtant ce sont des sélecteurs puissants, pratiques et bien plus pertinents que des classes.</p>
<p>Et -- à l'instar d'Ebay l'an passé -- on peut s'en servir pour induire une corrélation entre le HTML et le CSS, afin de tenter de garantir un peu d'accessibilité et de qualité. <br />Ce sont également de merveilleux obstacles, générant des situations d'apprentissage intéressantes pour peu que la démarche soit réfléchie.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/gael-poupard.php">Gaël Poupard</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Gaël Poupard" src="https://www.paris-web.fr/2016/assets_c/2016/05/Gael-Poupard-thumb-143x143-579.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Gaël Poupard est graphiste et intégrateur web opérant sur Nantes. Sa quête de qualité l'amène à se cultiver sans cesse, sur papier ou au détour des blogs.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/il-ny-a-pas-que-class-et-id-dans-la-vie.php&amp;ref=prez-il-ny-a-pas-que-class-et-id-dans-la-vie&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
