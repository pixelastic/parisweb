...
<title>Paris Web - UX et éthique</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/open-design.php" title="Open Design" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/pause-dejeuner-jeudi.php" title="Pause déjeuner" />
	...
	<meta name="twitter:title" content="UX et éthique" />
	<meta property="twitter:description" content="Quelles possibilités s'offrent aux UX Designers pour garder un comportement le plus éthique possible ?" />
	<meta property="dc:title" content="UX et éthique" />
	<meta property="og:title" content="UX et éthique" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/ux-et-ethique.php" />
	<meta property="og:description" content="Quelles possibilités s'offrent aux UX Designers pour garder un comportement le plus éthique possible ?" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>UX et éthique</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2024">
						<header>
							<h1>UX et éthique</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2024">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/ux-et-ethique.php" class="url">UX et éthique</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/metier" rel="tag">métier</a><br /><a href="http://www.paris-web.fr/2016/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Quand on commence à travailler comme UX designer, on se dit que notre travail qui n'est pas toujours très valorisé, va avoir un impact faible voir nul sur le monde. Avec le temps et l'expérience, notre vision de notre responsabilité change radicalement.</p>
<p>Si ne pas prendre en compte les utilisateurs dans les processus de conception peut avoir des effets dévastateurs, qu'en est-il de la responsabilité du concepteur ? Que doit faire l'UX designer fasse à la loi ? Ne vous a-t-on jamais demandé de cacher ces conditions générales de vente que l'utilisateur ne saurait voir ? Que faire quand les contraintes de conception, les injonctions vont visiblement à l'encontre du bien-être de l'utilisateur ?</p>
<p>Notre travail a un impact direct sur le comportement de l'utilisateur, sur santé mentale, physique ou financière. Observer les utilisateurs est à la base de l'UX, il faut le faire sans les tromper et ni leur nuire.</p>
<p>À partir de cas concrets, nous verrons quelles possibilités s'offrent aux UX Designers et à l'ensemble de la chaîne de conception pour garder un comportement le plus éthique possible !</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/raphael-yharrassarry.php">Raphaël Yharrassarry</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Yharrassarry" src="https://www.paris-web.fr/2016/assets_c/2016/05/Raphael-Yharrassarry-thumb-143x143-583.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>En tant que freelance, Raphaël Yharrassarry conçoit, depuis le dernier millénaire, des expériences utilisateurs mémorables. Issue d'un cursus en psychologie et en ergonomie, il a complété sa formation par un Master spécialisé en marketing, afin de mieux comprendre les enjeux business.</p>
<p>Il réalise des missions de conseils, de conceptions et d'évaluations sur des sujets variés allant des applications professionnelles aux services grand public sur la télévision en passant par le Web ou le design de services.</p>
<p>Depuis 2009, il essaye de partager son expérience et ses connaissances sur son bloc-notes. Ce qui l'a amené par la suite à enseigner dans diverses écoles et notamment à superviser une formation en UX Design. Il est aussi président de l'association FLUPA, qui coordonne de nombreux événements autour de l'UX en France et au Luxembourg.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/ux-et-ethique.php&amp;ref=prez-ux-et-ethique&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
