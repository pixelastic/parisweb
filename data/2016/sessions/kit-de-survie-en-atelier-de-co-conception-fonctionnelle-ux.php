...
<title>Paris Web - Kit de survie en atelier de co-conception fonctionnelle UX</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/ne-passons-pas-a-cote-des-choses-simples.php" title="Ne passons pas à côté des choses simples" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/informelle-vendredi-1535.php" title="Informelle" />
	...
	<meta name="twitter:title" content="Kit de survie en atelier de co-conception fonctionnelle UX" />
	<meta property="twitter:description" content="Décryptons ensemble les facteurs d'un workshop efficace et les conseils pour éviter les syncopes en phase de conception." />
	<meta property="dc:title" content="Kit de survie en atelier de co-conception fonctionnelle UX" />
	<meta property="og:title" content="Kit de survie en atelier de co-conception fonctionnelle UX" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/kit-de-survie-en-atelier-de-co-conception-fonctionnelle-ux.php" />
	<meta property="og:description" content="Décryptons ensemble les facteurs d'un workshop efficace et les conseils pour éviter les syncopes en phase de conception." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Kit de survie en atelier de co-conception fonctionnelle UX</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2029">
						<header>
							<h1>Kit de survie en atelier de co-conception fonctionnelle UX</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2029">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/kit-de-survie-en-atelier-de-co-conception-fonctionnelle-ux.php" class="url">Kit de survie en atelier de co-conception fonctionnelle UX</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/retour-dexperience" rel="tag">retour d'expérience</a><br /><a href="http://www.paris-web.fr/2016/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>L'animation d'atelier avec les utilisateurs n'est jamais si évidente, surtout en débutant sa carrière dans la conception web.</p>
<p>Ces worksphops réunissent généralement plusieurs acteurs du projet d'expertise totalement différente (utilisateur final, client, chef de projet, expert fonctionnel, expert technique, web designer...) afin de définir les fonctionnalités du produit et l'expérience attendue.</p>
<p>Au fil des échanges, ils s'assurent que l'outil spécifié correspond véritablement au besoin initial, quitte à faire émerger de nouveaux besoins ou abandonner certaines fonctionnalités parfois inutiles. C'est en soi que la phase de conception fonctionnelle est déterminante pour les autres étapes du projet puisqu'on y construit les bases et documents de référence pour l'équipe.</p>
<p>Pour un acteur fonctionnel débutant, il y a d'autant plus de raison de stresser : connaître les acteurs à impliquer aux ateliers, planifier les étapes, anticiper les incompréhensions fonctionnelles, proposer des idées, mettre en avant le besoin utilisateur devant les contraintes techniques, imaginer des participations collectives, ludiques....</p>
<p>Dans cette présentation, nous nous baserons sur des retours d'UX designer, de consultant fonctionnel en herbe pour discuter ensemble des moyens d'entreprendre sereinement ces ateliers de conception.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/emeline-racon.php">Emeline Racon</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Emeline Racon" src="https://www.paris-web.fr/2016/assets_c/2016/05/Emeline-Racon-thumb-143x143-582.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Diplômée de l'école nationale supérieure de cognitique (Ensc) à Bordeaux, Emeline a évolué dans le milieu de l'ergonomie IHM. Travaillant depuis 4 ans sur différentes missions dans l'administration et le service public, elle exerce au sein du pôle UX et Design de CGI. Elle prend le temps de participer au lab' d'innovation et aux meetups  parisiens, sans oublier sa passion première, la danse</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/kit-de-survie-en-atelier-de-co-conception-fonctionnelle-ux.php&amp;ref=prez-kit-de-survie-en-atelier-de-co-conception-fon&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
