...
<title>Paris Web - Web security by design</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/pause-dejeuner-jeudi.php" title="Pause déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/the-invisible-interface-designing-the-screenless-experience.php" title="The Invisible Interface: Designing the Screenless Experience" />
	...
	<meta name="twitter:title" content="Web security by design" />
	<meta property="twitter:description" content="Alors que le règlement européen nécessite d'intégrer la protection de la vie privée par défaut dès la conception, profitons-en pour embarquer également la sécurité... tout en gardant une approche…" />
	<meta property="dc:title" content="Web security by design" />
	<meta property="og:title" content="Web security by design" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/web-security-by-design.php" />
	<meta property="og:description" content="Alors que le règlement européen nécessite d'intégrer la protection de la vie privée par défaut dès la conception, profitons-en pour embarquer également la sécurité... tout en gardant une approche…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Web security by design</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1998">
						<header>
							<h1>Web security by design</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1998">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/web-security-by-design.php" class="url">Web security by design</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/securite" rel="tag">sécurité</a><br /><a href="http://www.paris-web.fr/2016/recherche/ux" rel="tag">UX</a><br /><a href="http://www.paris-web.fr/2016/recherche/vie-privee" rel="tag">vie privée</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>

</dl>
</div>
		</aside>
    <div class="talk-description" lang="en"><p>Nous allons parler de sécurité... sans se faire peur ni mal à la tête ! <br />Nous allons voir que la sécurité peut être simple et intégrée dans le cycle de vie d'une application.</p>
<p>Et avec le nouveau règlement européen relatif à la protection des données personnelles, chacun va devoir démontrer sa capacité à protéger ces données. Nous pensons que c'est une opportunité pour intégrer la sécurité dans cette démarche de conformité et de protection de la vie privée.</p>
<p>Nous partagerons quelques retours d'expérience, menant à des principes simples à appliquer et des solutions à utiliser au quotidien pour le développement aussi bien que pour le test... le tout avec le plus d'outils Open Source possibles !</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/jeremie-jourdin.php">Jérémie Jourdin</a> et <a href="https://www.paris-web.fr/2016/../orateurs/benjamin-leroux.php">Benjamin Leroux</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jérémie Jourdin" src="https://www.paris-web.fr/2016/assets_c/2016/05/Je%CC%81re%CC%81mie_Jourdin_143-thumb-143x143-608.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Jérémie a plus de 15 ans d'expérience dans le domaine de la sécurité. Après 12 ans passés à réaliser des audits et des tests d'intrusion, Jérémie est aujourd'hui Directeur Technique chez aDvens.<br /><br />Il est l'architecte du Centre Opérationnel de Sécurité (SOC) d'aDvens et responsable du développement du Firewall Open Source « Vulture ».</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Benjamin Leroux" src="https://www.paris-web.fr/2016/assets_c/2016/05/Benjamin_Leroux_143-thumb-143x143-597.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Benjamin Leroux est manager au sein d'Advens. Il a plus de 12 ans d'expérience dans le domaine de la sécurité et accompagne au quotidien de nombreux RSSI et DSI dans la définition et la mise en œuvre de leur stratégie de sécurité. Il se spécialise dans la définition d'approches sectorielles de la sécurité. Benjamin représente Advens au CESIN, le Club des Experts de la Sécurité de l'Information et du Numérique, ainsi que dans d'autres groupes d'échange autour de la cyber-sécurité.</p>
<p>Retrouvez Benjamin sur <a href="https://twitter.com/ben_lrx">@ben_lrx</a>.</p></div>
</div>
