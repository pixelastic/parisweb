...
<title>Paris Web - Le déploiement manuel : non merci, j'essaie d'arrêter !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/changement-de-salle-vendredi-1420.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/conferences/wcagnext-where-do-we-go-from-here.php" title="WCAG.next - where do we go from here?" />
	...
	<meta name="twitter:title" content="Le déploiement manuel : non merci, j'essaie d'arrêter !" />
	<meta property="twitter:description" content="Publier son site manuellement en FTP, c'est bien. Déployer automatiquement à partir des sources, c'est mieux. Et facile. Et plus sûr." />
	<meta property="dc:title" content="Le déploiement manuel : non merci, j'essaie d'arrêter !" />
	<meta property="og:title" content="Le déploiement manuel : non merci, j'essaie d'arrêter !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/le-deploiement-manuel-non-merci-jessaie-darreter.php" />
	<meta property="og:description" content="Publier son site manuellement en FTP, c'est bien. Déployer automatiquement à partir des sources, c'est mieux. Et facile. Et plus sûr." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le déploiement manuel : non merci, j'essaie d'arrêter !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2011">
						<header>
							<h1>Le déploiement manuel : non merci, j'essaie d'arrêter !</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2011">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/le-deploiement-manuel-non-merci-jessaie-darreter.php" class="url">Le déploiement manuel : non merci, j'essaie d'arrêter !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/industrialisation" rel="tag">industrialisation</a><br /><a href="http://www.paris-web.fr/2016/recherche/methodologie" rel="tag">méthodologie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Quand on apprend à créer des sites web, on apprend souvent comment déployer son site en FTP.  En agence, on doit travailler avec d'autres personnes et il devient nécessaire de versionner tout le projet et d'automatiser le processus de "build".</p>
<p>Déployer manuellement en FTP est toujours possible, mais il est facile de faire des erreurs ou de dépendre d'une unique personne : la tâche étant rendue plus complexe par l'industrialisation du projet. Heureusement les outils ont beaucoup évolué et il n'est pas très difficile de nos jours d'automatiser la mise en (pré)production de nos sites !</p>
<p>Nous partirons d'un cas d'exemple : un site statique généré grâce à Jekyll et Grunt, dont le code source est hébergé sur GitLab. On s'intéressera tout d'abord au système de "continuous integration" (CI) de GitLab. On verra qu'il est possible de vérifier automatiquement et systématiquement que le processus de "build" est fonctionnel. C'est quand même beaucoup mieux qu'une documentation pas mise à jour depuis 6 mois !</p>
<p>Avec GitLab CI, il est très facile d'utiliser Docker pour maîtriser son environnement de "build", vous pensez bien qu'on ne se privera pas de le faire ! L'étape suivante est le déploiement en lui-même : Quand le déclencher ? Comment éviter un downtime de notre site ? Que se passe-t-il si la procédure de déploiement échoue ? Nous répondrons à ces questions en présentant deux solutions pour deux usages : "Deployer" et "lftp".</p>
<p>À l'issue de cette conférence, vous saurez comment augmenter la qualité de vos projets web à grands renforts d'automatisation ! Et vous pourrez vous concentrer sur ce qui compte vraiment : faire de belles applications et réagir rapidemment aux retours des clients.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/david-sferruzza.php">David Sferruzza</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="David Sferruzza" src="https://www.paris-web.fr/2016/assets_c/2016/05/David_Sferruzza_143-thumb-143x143-602.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>David Sferruzza est responsable R&amp;D chez Escale, une agence web nantaise innovante, et prépare une thèse doctorale à l'Université de Nantes. Sa formation d'ingénieur généraliste (Icam) et sa passion pour le développement (et notamment la programmation fonctionnelle) lui offrent une double vision qui est bien utile quand il s'agit d'industrialiser des projets web.</p>
<p>En ce moment, il aime bien développer en Scala, Haskell et Nix des outils liés de près ou de loin au web.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/le-deploiement-manuel-non-merci-jessaie-darreter.php&amp;ref=prez-le-deploiement-manuel-non-merci-jessaie-darre&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
