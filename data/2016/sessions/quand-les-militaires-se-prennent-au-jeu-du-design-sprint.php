...
<title>Paris Web - Quand les militaires se prennent au jeu du design sprint</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2016/conferences/questionnements-sur-linternet-pret-a-porter.php" title="Questionnements sur l'Internet prêt-à-porter" />
<link rel="next bookmark" href="https://www.paris-web.fr/2016/informelle-jeudi-1700.php" title="Informelle" />
	...
	<meta name="twitter:title" content="Quand les militaires se prennent au jeu du design sprint" />
	<meta property="twitter:description" content="Design Sprint pour un service destiné aux militaires : 50 participants, 5 jours, 1 prototype" />
	<meta property="dc:title" content="Quand les militaires se prennent au jeu du design sprint" />
	<meta property="og:title" content="Quand les militaires se prennent au jeu du design sprint" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2016/conferences/quand-les-militaires-se-prennent-au-jeu-du-design-sprint.php" />
	<meta property="og:description" content="Design Sprint pour un service destiné aux militaires : 50 participants, 5 jours, 1 prototype" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Quand les militaires se prennent au jeu du design sprint</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-2005">
						<header>
							<h1>Quand les militaires se prennent au jeu du design sprint</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-2005">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2016/conferences/quand-les-militaires-se-prennent-au-jeu-du-design-sprint.php" class="url">Quand les militaires se prennent au jeu du design sprint</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2016/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2016/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Retour d'expérience sur la mise en place d'un Design Sprint avec des militaires : comment faciliter la collaboration d'une cinquantaine de participants (utilisateurs, clients et designers) et créer un prototype en 5 jours.</p>
<p>La problématique : les militaires appelés à partir en OPération EXtérieure doivent accomplir une série de tâches administratives précédant leur départ. Ces parcours et leur relation avec les différents services s'avèrent très complexes et irritants dans un contexte déjà stressant.</p>
<p>Les personnes touchées par cette problématique étant nombreuses, il a été décidé d'organiser un Design Sprint d'une semaine afin de réunir toutes les parties prenantes, et en particulier les militaires issus des 3 armées afin de les faire participer à la conception de leur futur outil, un portail web.</p>
<p>Notre rôle en tant que designers (4 UX designers + 1 Directeur Artistique) a été d'animer les différents ateliers de conception, de revoir les parcours utilisateurs avec les militaires et de construire progressivement un prototype sous la forme de wireframes et de maquettes graphiques.</p>
<p>Les semaines qui ont suivi ce Design Sprint ont permis d'aboutir à un prototype plus détaillé, la réalisation de l'ensemble des wireframes et d'une planche de composants graphiques qui ont servi de base aux premiers développements.</p>
<p>Ce que nous souhaitons illustrer à travers ce retour d'expérience :</p>
<ul>
<li>Le processus d'un Design Sprint</li>
<li>L'approche collaborative avec les utilisateurs et plus largement l'ensemble des parties prenantes (commanditaire, utilisateurs, consultants, designers)</li>
<li>L'expérience humaine : la rencontre des militaires et des designers, coupés du monde sur une base de défense pendant 5 jours.</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2016/../orateurs/marie-amelie-cotillon.php">Marie-Amélie Cotillon</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marie-Amélie Cotillon" src="https://www.paris-web.fr/2016/assets_c/2016/06/Marie-Amelie-Cotillon-thumb-143x143-631.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après 12 ans passés en agence web en tant que Directrice artistique, Marie-Amélie Cotillon est Responsable du Studio de Création chez Backelite depuis 2012.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2016/conferences/quand-les-militaires-se-prennent-au-jeu-du-design-sprint.php&amp;ref=prez-quand-les-militaires-se-prennent-au-jeu-du-de&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
