...
<title>Paris Web - La performance sur les sites mobiles</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/introduction-2.php" title="Introduction" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/les-grilles-macro-typo-sur-le-web-facile.php" title="Les grilles macro-typo sur le web ? Facile !" />
	...
	<meta name="twitter:title" content="La performance sur les sites mobiles" />
	<meta property="twitter:description" content="Le mobile arrive ! Ah non pardon, il est déjà là et vos utilisateurs essayent déjà de s'en servir pour visiter votre site prévu pour navigateur de bureau. Or les études montrent qu'ils ne sont pas…" />
	<meta property="dc:title" content="La performance sur les sites mobiles" />
	<meta property="og:title" content="La performance sur les sites mobiles" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/la-performance-sur-les-sites-mobiles.php" />
	<meta property="og:description" content="Le mobile arrive ! Ah non pardon, il est déjà là et vos utilisateurs essayent déjà de s'en servir pour visiter votre site prévu pour navigateur de bureau. Or les études montrent qu'ils ne sont pas…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>La performance sur les sites mobiles</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-781">
						<header>
							<h1>La performance sur les sites mobiles</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/parisweb2012-121030101901-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/JPVincent_performances_sur_site_mobile.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-781">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/la-performance-sur-les-sites-mobiles.php" class="url">La performance sur les sites mobiles</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/mobile" rel="tag">mobile</a><br /><a href="http://www.paris-web.fr/2012/recherche/performance" rel="tag">performance</a></dd>
    ...
    <div class="talk-description"><p>Le mobile arrive ! Ah non pardon, il est déjà là et vos utilisateurs essayent déjà de s'en servir pour visiter votre site prévu pour navigateur de bureau.</p>
<p>Or les études montrent qu'ils ne sont pas plus patients sur mobile qu'ils ne le sont sur bureau et quittent rapidement et à jamais votre site s'il ne s'affiche pas en quelques secondes. Au travers de cette <strong>session technique</strong> nous verrons :</p>
<ul>
<li>Comment rendre réactifs les sites d'aujourd'hui pour qu'ils soient utilisables sur mobile ;</li>
<li>quelle stratégie choisir : mobile first, site dédié, déploiement en webapp, responsive design, etc. ;</li>
<li>quelles techniques précises utiliser.</li>
</ul>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/jean-pierre-vincent.php">Jean-Pierre Vincent</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jean-Pierre Vincent" src="https://www.paris-web.fr/2012/assets_c/2012/08/jean-pierre-vincent2-thumb-143x143-210.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Expert technique indépendant sur les technologies du Front. Consultant, formateur, auteur.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/la-performance-sur-les-sites-mobiles.php&amp;ref=prez-la-performance-sur-les-sites-mobiles&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
