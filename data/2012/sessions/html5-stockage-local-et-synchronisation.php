...
<title>Paris Web - HTML5 : stockage local et synchronisation</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/un-site-efficace-six-questions-six-outils-pour-y-repondre.php" title="Un site efficace ? Six questions, six outils pour y répondre" />
	...
	<meta name="twitter:title" content="HTML5 : stockage local et synchronisation" />
	<meta property="twitter:description" content="Les nouvelles APIs HTML5 ouvrent aux développeurs web des horizons nouveaux. Le stockage en local, tout d'abord, permet aujourd'hui de concevoir des applications pouvant fonctionner sans connexion.…" />
	<meta property="dc:title" content="HTML5 : stockage local et synchronisation" />
	<meta property="og:title" content="HTML5 : stockage local et synchronisation" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/html5-stockage-local-et-synchronisation.php" />
	<meta property="og:description" content="Les nouvelles APIs HTML5 ouvrent aux développeurs web des horizons nouveaux. Le stockage en local, tout d'abord, permet aujourd'hui de concevoir des applications pouvant fonctionner sans connexion.…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5 : stockage local et synchronisation</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-792">
						<header>
							<h1>HTML5 : stockage local et synchronisation</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/html5localstoragepush-120411071043-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/HTML5-stockage-local-et-synchronisation.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-792">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/html5-stockage-local-et-synchronisation.php" class="url">HTML5 : stockage local et synchronisation</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/html5" rel="tag">HTML5</a><br /><a href="http://www.paris-web.fr/2012/recherche/stockage" rel="tag">stockage</a><br /><a href="http://www.paris-web.fr/2012/recherche/web-api" rel="tag">web API</a></dd>
    ...
    <div class="talk-description"><p>Les nouvelles APIs HTML5 ouvrent aux développeurs web des horizons nouveaux. Le stockage en local, tout d'abord, permet aujourd'hui de concevoir des applications pouvant fonctionner sans connexion.</p>

<p>Vous découvrirez les <strong>différents types</strong> de stockage disponibles et l'état actuel de <strong>leur implémentation</strong> dans les différents navigateurs, ainsi que des techniques de synchronisation client-serveur.</p>

<p>Les <strong>WebSockets</strong> permettent quant à eux, grâce à la communication bidirectionnelle, de pousser des données depuis le serveur et ainsi d'envisager le développement de meilleures applications de travail collaboratif.</p>

<p>Nous verrons aussi les "<span lang="en">Server-Sent Events</span>" autre technologie de "PUSH" intéressante.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/raphael-rougeron.php">Raphaël Rougeron</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Rougeron" src="https://www.paris-web.fr/2012/assets_c/2012/09/raphaelrougeron-thumb-143x143-258.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Raphaël Rougeron est chef de projet technique au sein du groupe Viareport. Expert des technologies web, ses principaux centres d'intérêts sont aujourd'hui Scala et les applications riches (en Javascript !). Il est également le créateur du framework PHP Stato, et contribue activement à différents projets Open Source.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/html5-stockage-local-et-synchronisation.php&amp;ref=prez-html5-stockage-local-et-synchronisation&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
