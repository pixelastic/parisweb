...
<title>Paris Web - Le tournant des CSS vers le Layout</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/introduction-1.php" title="Introduction" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/future-reading-nouveaux-espaces-patterns-et-tendances-pour-les-architectes-de-linformation.php" title="Future Reading : nouveaux espaces, patterns et tendances pour les architectes de l’information " />
	...
	<meta name="twitter:title" content="Le tournant des CSS vers le Layout" />
	<meta property="twitter:description" content="Les CSS sont en train de changer à très grande vitesse en 2012 par introduction de nouvelles fonctionnalités majeures comme les grilles, les modèles, les régions et exclusions, les variables, les…" />
	<meta property="dc:title" content="Le tournant des CSS vers le Layout" />
	<meta property="og:title" content="Le tournant des CSS vers le Layout" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/le-tournant-des-css-vers-le-layout.php" />
	<meta property="og:description" content="Les CSS sont en train de changer à très grande vitesse en 2012 par introduction de nouvelles fonctionnalités majeures comme les grilles, les modèles, les régions et exclusions, les variables, les…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le tournant des CSS vers le Layout</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-682">
						<header>
							<h1>Le tournant des CSS vers le Layout</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xvam92?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/2012/slides/D_Glazmann-conf-20121018.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-682">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/le-tournant-des-css-vers-le-layout.php" class="url">Le tournant des CSS vers le Layout</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/css" rel="tag">CSS</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Les <strong>CSS</strong> sont en train de changer à très grande vitesse en 2012 par introduction de nouvelles fonctionnalités majeures comme 
</p>
<ul>
	<li>les grilles,</li>
	<li>les modèles,</li>
	<li>les régions et exclusions,</li>
	<li>les variables,</li>
	<li>les fonctionnalités avancées de fontes…</li>
</ul>
<p>
Avec un engagement précoce des éditeurs de navigateurs, ces nouveauté vont arriver vite, très vite, non seulement sur la table de travail des designers mais également dans les sites en production. 
</p>
<p>
Soyez à la @page ou soyez "visibility: hidden".</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/daniel-glazman.php">Daniel Glazman</a></h2>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/le-tournant-des-css-vers-le-layout.php&amp;ref=prez-le-tournant-des-css-vers-le-layout&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
