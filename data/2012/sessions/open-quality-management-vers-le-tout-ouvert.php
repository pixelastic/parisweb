...
<title>Paris Web - Open quality management : vers le tout ouvert !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/the-real-me.php" title="The Real Me" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/webgl-la-3d-cest-maintenant-dans-votre-navigateur.php" title="WebGL, la 3D, c'est maintenant dans votre navigateur" />
	...
	<meta name="twitter:title" content="Open quality management : vers le tout ouvert !" />
	<meta property="twitter:description" content="Open data, Open Web, Open source : l'époque est à l'ouverture des données, du code source et des formats. Mais est-ce si évident et quel bénéfice peut-on en attendre ? À quelles conditions ? Le…" />
	<meta property="dc:title" content="Open quality management : vers le tout ouvert !" />
	<meta property="og:title" content="Open quality management : vers le tout ouvert !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/open-quality-management-vers-le-tout-ouvert.php" />
	<meta property="og:description" content="Open data, Open Web, Open source : l'époque est à l'ouverture des données, du code source et des formats. Mais est-ce si évident et quel bénéfice peut-on en attendre ? À quelles conditions ? Le…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Open quality management : vers le tout ouvert !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-701">
						<header>
							<h1>Open quality management : vers le tout ouvert !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xwglzp?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/SP_OQM-TOUT-OUVERT-PW_2012-6.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-701">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/open-quality-management-vers-le-tout-ouvert.php" class="url">Open quality management : vers le tout ouvert !</a></span></span></h2>
...
<dd class="column location"><a href="/lieux/">Salle Concorde</a></dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/gestion-de-projet" rel="tag">gestion de projet</a><br /><a href="http://www.paris-web.fr/2012/recherche/methodologie" rel="tag">méthodologie</a><br /><a href="http://www.paris-web.fr/2012/recherche/open-data" rel="tag">open data</a></dd>
    ...
    <div class="talk-description"><p>Open data, Open Web, Open source : l'époque est à l'ouverture des données, du code source et des formats. Mais est-ce si évident et <strong>quel bénéfice peut-on en attendre ?</strong> À quelles conditions ?</p>

<p>Le lâcher prise sur les savoirs et les savoir-faire bouleverse les modes de fonctionnement. Pour certains, l'ouverture est même vécue comme une tyrannie. Pour d'autres, c'est un simple effet de mode.</p>

<p>Mais <strong>l'ouverture ne se décrète pas. C'est une approche qui n'est pérenne que si elle est maîtrisée.</strong> Nul ne sait si ce mouvement est durable mais la question clé est celle de l'intégration éventuelle de cette approche dans le management des organisations.</p>

<p>En pratique, est-il possible de faire de l'ouverture des données, du code source des formats ou des savoir-faire un véritable levier d'amélioration de la qualité et de l'efficacité ? Existe-t-il des conditions propices à la réussite d'une telle approche et, si oui, lesquelles ?</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/elie-sloim.php">Élie Sloïm</a> et <a href="https://www.paris-web.fr/2012/../orateurs/pascal.php">Pascal Romain</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Élie Sloïm" src="https://www.paris-web.fr/2012/assets_c/2012/08/elie-sloim-thumb-143x143-249.jpg" width="143" height="143">
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Pascal Romain" src="https://www.paris-web.fr/2012/assets_c/2012/09/pascalromain-thumb-143x143-257.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Né en 1974. Titulaire d’un DEA d’histoire et d’archéologie du Proche-Orient sur l'histoire du backgammon. Attaché de conservation du patrimoine et ingénieur de la fonction publique territoriale. Développeur ou chef de projet informatique au sein de sociétés de service. </p>

<p>En charge des projets de numérisation et de valorisation numériques au sein des Archives départementales de la Gironde entre 2006 et 2009, chef de projet informatique documentaire au sein de la Direction des système d’information du Conseil général de la Gironde depuis 2010, en charge de la coordination des projets d’ouverture de données publiques et d’archivage électronique. </p>

<p>Co-animateur du premier référentiel de bonnes pratiques open data et co-responsable du site <a href="http://datalocale.fr/">datalocale.fr</a>.<br />
</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/open-quality-management-vers-le-tout-ouvert.php&amp;ref=prez-open-quality-management-vers-le-tout-ouvert&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
