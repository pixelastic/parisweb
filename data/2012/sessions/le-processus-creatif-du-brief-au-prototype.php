...
<title>Paris Web - Le processus créatif du brief au prototype</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/le-projet-web-dont-vous-etes-le-heros-agile.php" title="Le projet web dont vous êtes le héros agile" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/pause-1.php" title="Pause" />
	...
	<meta name="twitter:title" content="Le processus créatif du brief au prototype" />
	<meta property="twitter:description" content=" Le but de cet atelier est de démystifier la création dans un processus de réalisation de site. Cet atelier très ludique sera donc l'occasion pour tous les profils de s'essayer à l'exercice de…" />
	<meta property="dc:title" content="Le processus créatif du brief au prototype" />
	<meta property="og:title" content="Le processus créatif du brief au prototype" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/le-processus-creatif-du-brief-au-prototype.php" />
	<meta property="og:description" content=" Le but de cet atelier est de démystifier la création dans un processus de réalisation de site. Cet atelier très ludique sera donc l'occasion pour tous les profils de s'essayer à l'exercice de…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le processus créatif du brief au prototype</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-801">
						<header>
							<h1>Le processus créatif du brief au prototype</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-801">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/le-processus-creatif-du-brief-au-prototype.php" class="url">Le processus créatif du brief au prototype</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/prototypage" rel="tag">prototypage</a><br /><a href="http://www.paris-web.fr/2012/recherche/zoning" rel="tag">zoning</a></dd>
...
Le but de cet atelier est de démystifier la création dans un processus de réalisation de site. Cet atelier très ludique sera donc l'occasion pour tous les profils de s'essayer à l'exercice de création. 
</p>
<p>
L'objectif est simple : reproduire et expliquer le processus créatif nécessaire à la réponse d'un brief de la direction artistique au prototype en passant par la conception rédaction.
</p>
<p>
Ainsi, c'est tous ensemble que nous répondrons au brief proposé par la société Changez d'Ère, société novatrice proposant des voyages dans le temps à ses clients. Cette société prospère souhaite privilégier les voyages dans les années 80 auprès de sa clientèle car c'est un segment qu'elle peine encore à développer face à des voyages au temps des dinosaures et à l'époque médiévale. 
</p>
<p>
Dans une première partie, nous découvrirons le brief, pratiquerons un brainstorming et en dresserons un <span lang="en">mind mapping</span> qu'il nous faudra épurer par la suite. À partir de ce squelette sémantique, nous définirons les axes de création qui nous servirons de canevas par la suite.
</p>
<p>
Ensuite nous nous prêterons à l'exercice de la recherche de codes visuels, par la réflexion mais aussi via le net. Une fois les codes repérés, nous définirons les axes. L'idéal serait de répartir les axes dans les îlots et de voir comment les choix créatifs peuvent faire varier les fondamentaux du site comme les proto, les ébauches et les choix de mises en page.
</p>
<p>
Bien sur, aucun bisounours ne sera blessé pendant cet atelier :)
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/virginie-caplet.php">Virginie Caplet</a> et <a href="https://www.paris-web.fr/2012/../orateurs/marie-alhomme-virginie-caplet.php">Marie Alhomme</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Virginie Caplet" src="https://www.paris-web.fr/2012/assets_c/2012/08/virginie-thumb-143x143-229.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après des études dans la programmation, Virginie s'est rapidement spécialisée dans le graphisme. Graphiste web depuis plus de 8 ans, Virginie recherche sans cesse comment être créative tout en restant en accord avec les technologies actuelles.</p>

<p>Sous ses airs de férue de technologie, Virginie est une mamie qui agit dans l’ombre pour mettre à exécution son plan diabolique : recouvrir la planète de tricot et de peluches handmade, pour un monde tout doux et hypoallergénique.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Marie Alhomme" src="https://www.paris-web.fr/2012/assets_c/2012/08/marie-alhomme-thumb-143x143-237.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Marie Alhomme est webdesigner et intégratrice depuis 12 ans, dont 8 en indépendante en tant que PouipouiDesign. Elle s'implique dans de nombreux projets visant à promouvoir les bons usages et les technologies du Web, qu'il s'agisse de traduction sur pompage.net ou de l'organisation de W3Café ou de Sud Web.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/le-processus-creatif-du-brief-au-prototype.php&amp;ref=prez-le-processus-creatif-du-brief-au-prototype&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
