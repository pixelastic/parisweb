...
<title>Paris Web - Les tendances dans le web design, faut-il les suivre ou les fuir ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/il-etait-une-fois-une-maquette.php" title="Il était une fois une maquette" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/lightning-talks.php" title="Lightning talks" />
	...
	<meta name="twitter:title" content="Les tendances dans le web design, faut-il les suivre ou les fuir ?" />
	<meta property="twitter:description" content="D'où qu'elles viennent les tendances ont une influence toujours plus grande sur notre travail quotidien. Sont-elles bénéfiques ou au contraire faut-il les fuir ? A travers cette conférence, nous…" />
	<meta property="dc:title" content="Les tendances dans le web design, faut-il les suivre ou les fuir ?" />
	<meta property="og:title" content="Les tendances dans le web design, faut-il les suivre ou les fuir ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/les-tendances-dans-le-web-design-faut-il-les-suivre-ou-les-fuir.php" />
	<meta property="og:description" content="D'où qu'elles viennent les tendances ont une influence toujours plus grande sur notre travail quotidien. Sont-elles bénéfiques ou au contraire faut-il les fuir ? A travers cette conférence, nous…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les tendances dans le web design, faut-il les suivre ou les fuir ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-677">
						<header>
							<h1>Les tendances dans le web design, faut-il les suivre ou les fuir ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xwsc4e?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/parisweb-tendances-webdesign-presentation-121019081245-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/ParisWeb-tendances-webdesign-presentation.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-677">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/les-tendances-dans-le-web-design-faut-il-les-suivre-ou-les-fuir.php" class="url">Les tendances dans le web design, faut-il les suivre ou les fuir ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/design" rel="tag">design</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>D'où qu'elles viennent les tendances ont une influence toujours plus grande sur notre travail quotidien. </p>

<p>Sont-elles bénéfiques ou au contraire faut-il les fuir ? A travers cette conférence, nous apprendrons à mieux connaître ces tendances, à les appréhender. Nous verrons quand et comment les utiliser, mais aussi quand et comment s'en passer, et ainsi aller chercher la créativité loin de nos écrans. </p>

<p>Nous attirerons l'attention sur le fait qu'aujourd'hui, nous sommes très influencés par tout ce que nous voyons sur le web. A travers notamment tous ces sites qui nous proposent des listes interminables de tendances à suivre pour être « dans le coup » ou encore les galeries CSS. </p>

<p>Les tendances ont un sens et une utilité, dans le webdesign comme dans d'autres secteurs tels que la mode ou les beaux-arts. </p>

<p>Nous tenterons donc de livrer quelques idées et conseils pour apprendre à être un designer avec sa propre personnalité et qui sait tirer profit de ce qui l'entoure, que ce soit sur le web ou dans la vie de tous les jours.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/sebastien-desbenoit.php">Sébastien Desbenoit</a> et <a href="https://www.paris-web.fr/2012/../orateurs/francis-chouquet.php">Francis Chouquet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Sébastien Desbenoit" src="https://www.paris-web.fr/2012/assets_c/2012/08/S_bastien%20sur%20le%20pont%20Charles-thumb-143x143-220.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Sébastien Desbenoit est aujourd'hui web designer chez ThinkInnovation après des études de mathématiques et avoir travaillé dans l'art contemporain&nbsp;!</p>

<p>Passionné de vulgarisation, il tient le blog <a href="http://internetetmoi.fr/">Internet &amp; Moi</a> qui propose une explication pour le grand public de sujets liés au web.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Francis Chouquet" src="https://www.paris-web.fr/2012/assets_c/2012/08/francis-chouquet-thumb-143x143-247.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Web Designer depuis 2006, Francis Chouquet possède plusieurs casquettes qui lui ont permis de faire ce métier. Diplômé d'une école de commerce, il a passé plusieurs années en SSII à vendre et à installer des ERP ou des solutions logistiques pour les grands groupes.</p>

<p>Puis, en 2002, il a choisi de rester dans l'univers informatique mais en revenant à ses premières amours, le graphisme. Il a alors suivi plusieurs cours aux Beaux Arts de Bâle pour apprendre et comprendre les bases de ce métier pour progressivement arriver logiquement au web design qui s'est facilement et rapidement imposé comme son domaine de prédilection.</p>

<p>En 2006, il va également découvrir WordPress dont il fera des tutoriels sur son blog (www.fran6art.com), ainsi qu'un DVD de formation (Elephorm). Il est également le co-auteur du livre « Le Campus WordPress », premier ouvrage francophone sur WordPress, paru chez Pearson.</p>

<p>Aujourd'hui, il vit pleinement de son activité de web designer free-lance et ses clients sont Libération, Lemonde.fr, Groupama ainsi que de nombreuses autres sociétés dans des domaines aussi variés que la santé, l'architecture ou le conseil.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/les-tendances-dans-le-web-design-faut-il-les-suivre-ou-les-fuir.php&amp;ref=prez-les-tendances-dans-le-web-design-faut-il-les-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
