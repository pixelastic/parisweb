...
<title>Paris Web - Le livre numérique : et si c’était du web ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/webgl-la-3d-cest-maintenant-dans-votre-navigateur.php" title="WebGL, la 3D, c'est maintenant dans votre navigateur" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/une-journee-acceleree-en-pure-mobilite-une-idee-fixe.php" title="Une journée accélérée en pure mobilité : une idée fixe ?" />
	...
	<meta name="twitter:title" content="Le livre numérique : et si c’était du web ?" />
	<meta property="twitter:description" content="Quel est le lien entre le livre numérique et le web, me direz vous ? Beaucoup de choses ! Le livre numérique utilise les principales techniques du web pour son fonctionnement, en utilisant le HTML…" />
	<meta property="dc:title" content="Le livre numérique : et si c’était du web ?" />
	<meta property="og:title" content="Le livre numérique : et si c’était du web ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/le-livre-numerique-et-si-ctait-du-web.php" />
	<meta property="og:description" content="Quel est le lien entre le livre numérique et le web, me direz vous ? Beaucoup de choses ! Le livre numérique utilise les principales techniques du web pour son fonctionnement, en utilisant le HTML…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le livre numérique : et si c’était du web ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-673">
						<header>
							<h1>Le livre numérique : et si c’était du web ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xvdrsc?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/lelivrenumriqueetsictaitduweb-121018101019-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/livre_num%C3%A9rique-MikaelRandy.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-673">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/le-livre-numerique-et-si-ctait-du-web.php" class="url">Le livre numérique : et si c’était du web ?</a></span></span></h2>
...
<dd class="column">
11 <abbr title="heures">h</abbr> 55
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/livre-numerique" rel="tag">livre numérique</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Quel est le lien entre <strong>le livre numérique et le web</strong>, me direz vous ? </p>

<p>Beaucoup de choses !<br />
Le livre numérique utilise les principales techniques du web pour son fonctionnement, en utilisant le HTML pour son contenu, le CSS pour sa mise en forme.</p>

<p>Nous allons soulever le capot pour y voir les technologies web, comment elles sont utilisées, <strong>les spécificités</strong> et les opportunités offertes. </p>

<p>Nous parlerons aussi <strong>standardisation</strong>, convergence de formats et des raisons d’avoir un format propre à certains types de contenu quand bien même il s’agit de technologies web standard.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/mikael-randy.php">Mikael Randy</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Mikael Randy" src="https://www.paris-web.fr/2012/assets_c/2012/08/Mikaelrandy-thumb-143x143-216.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Côté pile, Mikael Randy est un développeur web spécialisé en PHP qui a travaillé pendant 6 ans dans une SSII spécialisée dans le développement d’application web avec Symfony, comme architecte logiciel. Il a rejoint l’équipe TEA pour mettre en place un nouveau système de diffusion du livre numérique, plus ouvert et respectueux du lecteur.</p>

<p>Côté face, il est administrateur du site PHPFrance, coordinateur de l’antenne lyonnaise de l’AFUP (Association Française des Utilisateurs de PHP) et passe ses heures perdues à tester et étudier les évolutions des langages web.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/le-livre-numerique-et-si-ctait-du-web.php&amp;ref=prez-le-livre-numerique-et-si-ctait-du-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
