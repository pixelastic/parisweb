...
<title>Paris Web - The Real Me</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/readme-un-fichier-nomme-plaisir.php" title="README, un fichier nommé plaisir" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/open-quality-management-vers-le-tout-ouvert.php" title="Open quality management : vers le tout ouvert !" />
	...
	<meta name="twitter:title" content="The Real Me" />
	<meta property="twitter:description" content=" While some companies use their brand as an opaque facade to hide their questionable practices, others are opening up to their audience and sharing their true personality. The result is a more honest…" />
	<meta property="dc:title" content="The Real Me" />
	<meta property="og:title" content="The Real Me" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/the-real-me.php" />
	<meta property="og:description" content=" While some companies use their brand as an opaque facade to hide their questionable practices, others are opening up to their audience and sharing their true personality. The result is a more honest…" />
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xwsvjk?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/the-real-me.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-691">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/the-real-me.php" class="url">The Real Me</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2012/recherche/personas" rel="tag">personas</a><br /><a href="http://www.paris-web.fr/2012/recherche/storytelling" rel="tag">storytelling</a></dd>
...
<p>While some companies use their brand as an opaque facade to hide their questionable practices, others are opening up to their audience and sharing their true personality. The result is a more honest relationship with customers. Through real world examples, you'll see the key benefits personality creates for companies.</p>
<p>We'll discuss <strong>how to create Design Personas</strong>, the starting point for brand personality, and discover the relationship between brand voice and tone.</p>
</div>
<div lang="fr" class="span-6 last">
<p>
Alors que certaines sociétés utilisent leur marque comme une façade opaque vouée à masquer des pratiques discutables, d’autres s’ouvrent à leur auditoire et partagent leur véritable personnalité. Le résultat : une relation plus honnête avec les clients. Au travers d’exemples réels, vous verrez quels sont les bénéfices clés à tirer d’une personnalité pour les entreprises.
</p>
<p>
Nous verrons <strong>comment créer des <em lang="en">Design Personas</em></strong>, le point de départ pour une personnalité de marque, et comment découvrir la relation entre la voix d’une marque et son ton.</p>
</div>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/aarron-walter.php">Aarron Walter</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Aarron Walter" src="https://www.paris-web.fr/2012/assets_c/2012/08/aarron-walter-thumb-143x143-192.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p>
<a href="http://aarronwalter.com/">Aarron Walter</a> is the lead user experience designer for <a href="http://mailchimp.com/">MailChimp</a>, where he socializes with primates and ponders ways to make interfaces more human. Aarron is the author of <a href="http://www.abookapart.com/products/designing-for-emotion">Designing for Emotion</a>, the purple stripe in the rainbow of knowledge from <a href="http://abookapart.com/">A Book Apart</a>. He lives with his wife and son in Athens, Georgia, and is a wannabe barista. He tweets about design under the moniker <a href="http://twitter.com/aarron">@aarron on Twitter</a>.
</p>
</div>
<div lang="fr" class="span-6 last">
<p>
<a href="http://aarronwalter.com/">Aarron Walter</a> est le responsable de l’expérience utilisateur chez <a href="http://mailchimp.com/">MailChimp</a>, où il entretient des relations sociales avec des primates et s’interroge sur les façons d’humaniser davantage les interfaces. Aaron est l’auteur de <a href="http://www.abookapart.com/products/designing-for-emotion">Designing for Emotion</a>, la bande violette dans l’arc-en-ciel de connaissance de <a href="http://abookapart.com/">A Book Apart</a>. Il vit avec sa femme et son fils à Athens, Géorgie, et se prend pour un barista. Il tweete sur le design sous le nom <a href="http://twitter.com/aarron">@aarron on Twitter</a>.
</p>
</div></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/the-real-me.php&amp;ref=prez-the-real-me&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
