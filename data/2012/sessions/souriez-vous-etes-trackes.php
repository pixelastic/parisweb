...
<title>Paris Web - Souriez (?) vous êtes trackés !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/influence-du-bauhaus-dans-le-digital-par-lexemple.php" title="Influence du Bauhaus dans le digital par l’exemple" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/comprendre-lautisme-pour-ameliorer-les-projets-transmedias.php" title="Comprendre l'autisme pour améliorer les projets transmédias" />
	...
	<meta name="twitter:title" content="Souriez (?) vous êtes trackés !" />
	<meta property="twitter:description" content="Sites web, applications mobiles, webapp... et demain internet des objets, la question de la confidentialité des données personnelles et du tracking des usagers fait de plus en plus le devant de…" />
	<meta property="dc:title" content="Souriez (?) vous êtes trackés !" />
	<meta property="og:title" content="Souriez (?) vous êtes trackés !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/souriez-vous-etes-trackes.php" />
	<meta property="og:description" content="Sites web, applications mobiles, webapp... et demain internet des objets, la question de la confidentialité des données personnelles et du tracking des usagers fait de plus en plus le devant de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Souriez (?) vous êtes trackés !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-680">
						<header>
							<h1>Souriez (?) vous êtes trackés !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xw0mjg?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-680">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/souriez-vous-etes-trackes.php" class="url">Souriez (?) vous êtes trackés !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/identite-numerique" rel="tag">identité numérique</a><br /><a href="http://www.paris-web.fr/2012/recherche/privacy" rel="tag">privacy</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Sites web, applications mobiles, webapp... et demain internet des objets, la question de la confidentialité des données personnelles et du tracking des usagers fait de plus en plus le devant de l’actualité.</p>
<p>
Cette conférence vise à balayer les apports et les dangers de la convergence des données et des technologies :
</p>
<ul>
<li>Qu’est ce que le profilage (utilisation des cookies, publicité comportementale,...) ?<br />D’où proviennent les données ?<br />Enjeux, apports et dangers. </li>
<li>Vers une amplification du phénomène ? La preuve par l’exemple : 
<ul>
<li>Évolutions technologiques (HTML5...) et convergence des sources de données</li>
<li>Apparition de nouveaux usages :  services sans contact, tv connectées, usages de la tablette en complément de la tv... </li>
<li>Tendance au partage des données personnelles</li>
</ul>
</li>
<li>Perspectives : quelles alternatives et pistes de solutions (initiative Do Not Track...) ?</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/stephane-lebarque.php">Stéphane Lebarque</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Lebarque" src="https://www.paris-web.fr/2012/assets_c/2012/08/stephane-lebarque-thumb-143x143-222.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p><a href="https://twitter.com/slebarque">Stéphane Lebarque</a> diplômé de l'ESIEA, après diverses expériences en SSII, Agence web et la participation à une création d'entreprise, a rejoint la Société de Conseil et de Réalisation Logicielle <a href="http://www.niji.fr/">Niji</a> en 2006. Il intervient à différents niveaux dans l'Agence Digitale de Niji, <a href="http://www.dsquare.fr/">Dsquare</a> :</p>
 
<ul>
	<li>Avant ventes</li>
	<li>Participation aux montages de projets collaboratifs dans le cadre d’appels à projets du Pôle de Compétitivité Images & Réseaux et de projets de Recherche & Développement du FUI</li>
	<li>Direction de missions de conseil et d’étude sur les nouvelles technologies et l’innovation</li>
	<li>Management d’équipes Design & Delivery pour la création d'expériences numériques multi-écrans aussi bien Web, Mobile que TV dans le cadre de projets au forfait pour des clients variés : startup, collectivités locales, opérateurs, grands comptes.</li>
</ul> 

<p>La convergence numérique est au cœur de sa mission quotidienne. Les opportunités et les dangers de cette convergence alimentent sa réflexion. Il a d’ailleurs été amené à partager son analyse sur la question lors du <a href="http://www.rdst.org/index.php?option=com_content&view=article&id=5006">colloque du Réseau Droits, Sciences et Techniques</a> organisé sous l'égide du CNRS au Palais du Luxembourg en 2011.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/souriez-vous-etes-trackes.php&amp;ref=prez-souriez-vous-etes-trackes&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
