...
<title>Paris Web - Applications mobiles : utiliser le web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/hacktivisme-hacker-la-politique-et-les-ong.php" title="Hacktivisme : hacker la politique et les ONG" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/10-new-year-s-resolutions-designers.php" title="How Designers Destroyed the World" />
	...
	<meta name="twitter:title" content="Applications mobiles : utiliser le web" />
	<meta property="twitter:description" content="Développer une application métier complexe à destination de terminaux mobiles : et si nous la développions à base de technologies web, une seule fois pour tous les terminaux, pour une application qui…" />
	<meta property="dc:title" content="Applications mobiles : utiliser le web" />
	<meta property="og:title" content="Applications mobiles : utiliser le web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/applications-mobiles-utiliser-le-web.php" />
	<meta property="og:description" content="Développer une application métier complexe à destination de terminaux mobiles : et si nous la développions à base de technologies web, une seule fois pour tous les terminaux, pour une application qui…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Applications mobiles : utiliser le web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-700">
						<header>
							<h1>Applications mobiles : utiliser le web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xx656w?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-700">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/applications-mobiles-utiliser-le-web.php" class="url">Applications mobiles : utiliser le web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/html5" rel="tag">HTML5</a><br /><a href="http://www.paris-web.fr/2012/recherche/javascript" rel="tag">Javascript</a><br /><a href="http://www.paris-web.fr/2012/recherche/mobile" rel="tag">mobile</a></dd>
    ...
    <div class="talk-description"><p>Développer une application métier complexe à destination de <strong>terminaux mobiles</strong> : et si nous la développions à base de technologies web, une seule fois pour tous les terminaux, pour une application qui n’a pas besoin d’être installée ? </p>

<p>C’est le choix que nous avons fait. Nous aborderons lors de ce retour les enjeux et les raisons d’un tel choix, les spécificités d’une application mobile comme le mode déconnecté, <strong>la valeur ajoutée du web par rapport au natif</strong>, les technologies que l’on peut mettre en œuvre ainsi que les difficultés rencontrées.</p>

<ul>
<li>Qu’est-ce qu’une application mobile ?</li>
<li>Pourquoi faire du web et non du natif ?</li>
<li>Quels sont les enjeux ?</li>
<li>Quelle différences ?</li>
<li>Peut-on tout faire ?</li>
<li>Quelles sont les difficultés ?</li>
<li>Qu’est-ce que ça implique côté technique ?</li>
<li>Ce que nous avons tenté, pourquoi</li>
<li>Ce que nous avons réussi ou échoué</li>
<li>Notre retour d’expérience</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/bruno-michel.php">Bruno Michel</a> et <a href="https://www.paris-web.fr/2012/../orateurs/anne-sophie-tranchet.php">Anne-Sophie Tranchet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Bruno Michel" src="https://www.paris-web.fr/2012/assets_c/2012/10/bruno-michel-143-thumb-143x143-268.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Le jour, Bruno Michel est le directeur technique d’af83. Il travaille à construire des plateformes et applications web innovantes pour des grands comptes et des startups.</p>

<p>La nuit, il s’implique dans les communautés Open Source. Il est le principal développeur et un des administrateurs du site LinuxFr.org. Il est également le président de Ruby France, un des traducteurs du site officiel de Ruby et participe à de nombreux événements. Il a en particulier organisé le premier Paris.JS.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Anne-Sophie Tranchet" src="https://www.paris-web.fr/2012/assets_c/2012/08/Tranchet_AS-thumb-143x143-225.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Il y a quelques années, jeune lycéenne, Anne-Sophie Tranchet est tombée par hasard dans le monde du logiciel libre. </p>

<p>N'ayant de toute façon rien de mieux à faire, elle a alors continué dans la voie de l'informatique.</p>

<p>Un master et un rapide passage en SSII plus tard, elle a finalement trouvé sa place dans l’équipe technique de TEA pour développer des solutions autour du livre numérique. </p>

<p>Ça tombe bien, c’est son passe-temps favori.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/applications-mobiles-utiliser-le-web.php&amp;ref=prez-applications-mobiles-utiliser-le-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
