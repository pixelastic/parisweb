...
<title>Paris Web - 1001 techniques pour faire exploser un projet web (et comment les éviter)</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/optimisation-des-images-png-et-jpg-compression-deflate-extreme-des-fichiers-statiques.php" title="Optimisation des images .png et .jpg, compression Deflate extrême des fichiers statiques" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/ami-freelance-tu-aurais-besoin-dun-petit-recadrage.php" title="Ami freelance, tu aurais besoin d'un petit recadrage" />
	...
	<meta name="twitter:title" content="1001 techniques pour faire exploser un projet web (et comment les…" />
	<meta property="twitter:description" content=" On a tous vécu un projet catastrophique qui a bien failli mal finir. Si vous avez encore envie de mettre des baffes au client qui a décidé de changer toutes les couleurs au dernier moment, au…" />
	<meta property="dc:title" content="1001 techniques pour faire exploser un projet web (et comment les éviter)" />
	<meta property="og:title" content="1001 techniques pour faire exploser un projet web (et comment les éviter)" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/1001-techniques-pour-faire-exploser-un-projet-web-et-comment-les-eviter.php" />
	<meta property="og:description" content=" On a tous vécu un projet catastrophique qui a bien failli mal finir. Si vous avez encore envie de mettre des baffes au client qui a décidé de changer toutes les couleurs au dernier moment, au…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>1001 techniques pour faire exploser un projet web (et comment les éviter)</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-788">
						<header>
							<h1>1001 techniques pour faire exploser un projet web (et comment les éviter)</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/paris-webninja-v8-121031182403-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/paris-webninja-v8-121031182403-phpapp02.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-788">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/1001-techniques-pour-faire-exploser-un-projet-web-et-comment-les-eviter.php" class="url">1001 techniques pour faire exploser un projet web (et comment les éviter)</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/gestion-de-projet" rel="tag">gestion de projet</a><br /><a href="http://www.paris-web.fr/2012/recherche/methodes-agiles" rel="tag">méthodes agiles</a><br /><a href="http://www.paris-web.fr/2012/recherche/metier" rel="tag">métier</a></dd>
...
<p>
Venez apprendre les 1001 techniques ninjas pour saborder un projet web, et les meilleures parades pour que <em>vos</em> projets ne finissent pas comme dans les prophéties mayas. Entre thérapie de groupe et recherche de solutions, cet atelier sera l’occasion de dire ce que vous avez sur le cœur, d’en rire, et de partager techniques et astuces pour devenir des as de la gestion de projet et sauver le monde.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/maxime-fortelle.php">Maxime Fortelle</a> et <a href="https://www.paris-web.fr/2012/../orateurs/goulven-champenois.php">Goulven Champenois</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Maxime Fortelle" src="https://www.paris-web.fr/2012/assets_c/2012/08/maxime-fortelle-thumb-143x143-215.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Maxime (<a href="http://twitter.com/@maximeFF">@maximeFF</a>) est ergonome, ou expert UX selon l'envie, pour la société <a href="http://multicom-ergonomie.com/#/home/">Floralis Multicom</a>. Passé par la Belgique, il a pu y apprendre et mettre en pratique les méthodes de la démarche centrée utilisateur dans plusieurs projets avec des sociétés comme Orange, Nespresso, Altran, Arturia, etc.</p>

<p>Aujourd’hui, il connaît toutes les disciplines liées à son métier : expérience utilisateurs, utilisabilité, ergonomie et design d’interaction. Son métier est avant tout de rendre plus simple l’utilisation du monde numérique. Pour véhiculer ce message, il est investi dans l’association FLUPA. Avec ses amis FLUPAiens, ils ont créé la conférence FLUPA UX-day et organisent régulièrement des événements sur l’ergonomie en Rhône-Alpes.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Goulven Champenois" src="https://www.paris-web.fr/2012/assets_c/2012/08/goulven-champenois-thumb-143x143-204.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Intégrateur passionné, Goulven Champenois jongle avec l’accessibilité, l’ergonomie, les performances et le mobile pour une expérience utilisateur optimale intégrant les dernières évolutions technologiques.</p>

<p>Formé en grande partie grâce aux sites openweb et pompage, il rejoint ce projet en 2006. Trouvant le temps trop long entre deux éditions de Paris Web, il participe à l'organisation de SudWeb depuis 2011.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/1001-techniques-pour-faire-exploser-un-projet-web-et-comment-les-eviter.php&amp;ref=prez-1001-techniques-pour-faire-exploser-un-projet&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
