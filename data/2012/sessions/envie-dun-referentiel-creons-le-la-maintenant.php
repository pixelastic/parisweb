...
<title>Paris Web - Envie d'un référentiel ? Créons-le ! Là, maintenant :)</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/ami-freelance-tu-aurais-besoin-dun-petit-recadrage.php" title="Ami freelance, tu aurais besoin d'un petit recadrage" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/dejeuner-1.php" title="Déjeuner" />
	...
	<meta name="twitter:title" content="Envie d'un référentiel ? Créons-le ! Là, maintenant :)" />
	<meta property="twitter:description" content="Mobile, CSS, JS, ergonomie etc. Avez-vous en main tous les référentiels dont vous avez besoin ? La méthode Opquast (Open Quality Standards) est un déroulé collaboratif qui permet de créer des…" />
	<meta property="dc:title" content="Envie d'un référentiel ? Créons-le ! Là, maintenant :)" />
	<meta property="og:title" content="Envie d'un référentiel ? Créons-le ! Là, maintenant :)" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/envie-dun-referentiel-creons-le-la-maintenant.php" />
	<meta property="og:description" content="Mobile, CSS, JS, ergonomie etc. Avez-vous en main tous les référentiels dont vous avez besoin ? La méthode Opquast (Open Quality Standards) est un déroulé collaboratif qui permet de créer des…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Envie d'un référentiel ? Créons-le ! Là, maintenant :)</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-794">
						<header>
							<h1>Envie d'un référentiel ? Créons-le ! Là, maintenant :)</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-794">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/envie-dun-referentiel-creons-le-la-maintenant.php" class="url">Envie d'un référentiel ? Créons-le ! Là, maintenant :)</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/communautaire" rel="tag">communautaire</a><br /><a href="http://www.paris-web.fr/2012/recherche/referentiels" rel="tag">référentiels</a></dd>
    ...
    <div class="talk-description"><p>Mobile, CSS, JS, ergonomie etc. Avez-vous en main tous les référentiels dont vous avez besoin ? La méthode <strong>Opquast</strong> (<span lang="en">Open Quality Standards</span>) est un déroulé collaboratif qui permet de créer des check-lists par et pour les professionnels.</p>
<p>Après une rapide présentation de cette méthode qui servira à cadrer l'atelier, le groupe réfléchira ensemble au(x) référentiel(s) qui manque à nos métiers.<p>
<p>Nous pourrons alors nous pencher ensemble sur la création d'un des référentiels retenus, accompagnés dans la méthode par Élie et Delphine. Le travail fait en atelier servira de base pour la finalisation d'un référentiel sous licence Creative Commons et intégré aux listes Opquast.</p>
<p>NB : les participants seront invités à laisser leur nom pour être crédités et le travail fait en commun sera disponible en temps réel en ligne.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/delphine-malassingne.php">Delphine Malassingne</a> et <a href="https://www.paris-web.fr/2012/../orateurs/elie-sloim.php">Élie Sloïm</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Delphine Malassingne" src="https://www.paris-web.fr/2012/assets_c/2012/08/delphine-thumb-143x143-227.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Delphine est responsable qualité chez Ekino, agence technologique où elle est arrivée en janvier 2012. Depuis 2009, elle n'a de cesse de faire connaître les méthodes et outils de la gestion de la qualité web. C'est en partie pour cette raison qu'elle a co-fondé <a href="http://w3qualite.net/">w3qualité</a>, portail en ligne qui ne demande qu'à prendre son envol.</p>

<p>Quand elle n'est pas le nez sur un écran - ce qui est rare - elle rêve de voyages ou dessine (essentiellement autour des lettres et de l'écriture).</p>

<p>Elle a rejoint Paris-Web en 2009 par enthousiasme pour cette initiative, l'esprit communautaire et... le web de qualité !</p>

<p>Plus sur Delphine sur <a href="http://www.nissone.com/">nissone.com</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/envie-dun-referentiel-creons-le-la-maintenant.php&amp;ref=prez-envie-dun-referentiel-creons-le-la-maintenant&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
