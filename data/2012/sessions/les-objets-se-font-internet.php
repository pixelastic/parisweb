...
<title>Paris Web - Les objets se font internet</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/dejeuner-1.php" title="Déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/application-cache.php" title="Application cache" />
	...
	<meta name="twitter:title" content="Les objets se font internet" />
	<meta property="twitter:description" content="Comment sortir des catégories du web ? Malgré son « jeune âge », le web est déjà pensé comme une continuité, un langage qui ne demande qu'à être développé, alors que nous en sommes à esquisser ses…" />
	<meta property="dc:title" content="Les objets se font internet" />
	<meta property="og:title" content="Les objets se font internet" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/les-objets-se-font-internet.php" />
	<meta property="og:description" content="Comment sortir des catégories du web ? Malgré son « jeune âge », le web est déjà pensé comme une continuité, un langage qui ne demande qu'à être développé, alors que nous en sommes à esquisser ses…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les objets se font internet</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-681">
						<header>
							<h1>Les objets se font internet</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xvdyhk?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/29-05-2012-DS-ParisWeb%202012.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-681">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/les-objets-se-font-internet.php" class="url">Les objets se font internet</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2012/recherche/inspiration" rel="tag">inspiration</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Comment sortir des catégories du web ? </p>

<p>Malgré son « jeune âge », le web est déjà pensé comme une continuité, un langage qui ne demande qu'à être développé, alors que nous en sommes à esquisser ses premières lettres, et donc encore loin de ces premiers mots. </p>

<p>Si l'on ne peut anticiper les discours du web de demain, au moins pouvons-nous décrire la manière dont la pensée créatrice des designers peut se mettre en mouvement, et surprendre.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/dominique-sciamma.php">Dominique Sciamma</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Dominique Sciamma" src="https://www.paris-web.fr/2012/assets_c/2012/08/D-Sciamma-thumb-143x143-248.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Dominique Sciamma est diplômé de l’université Paris 7 en mathématiques, ainsi qu’en informatique théorique. Depuis 30 ans, il navigue dans le monde des TIC, en y expérimentant l’ensemble des métiers : chercheur en IA, auteur logiciel, directeur marketing, responsable international en Asie, consultant en stratégie (pour le groupe Bull de 1980 à 1991), consulting dans la résolution de problèmes complexes, et marketing multimédia (pour EDS, de 1992 à 1995), direction des éditions électronique de la Tribune (de 1996 à 1997), Consultant indépendant en E-Stratégie, mais aussi développeur d’un CMS, scénariste de BD et de jeux vidéo, concepteur d’interface (Encyclopédie Larousse). Travaillant pour Strate Collège Designers depuis 1998, où il encadre l’ensemble des diplômes, il y crée en 2007 le département « Systèmes et Objets Interactifs », avant d’en prendre aussi la direction de la recherche en 2010.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/les-objets-se-font-internet.php&amp;ref=prez-les-objets-se-font-internet&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
