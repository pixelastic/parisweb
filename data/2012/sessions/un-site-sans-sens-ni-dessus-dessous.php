...
<title>Paris Web - Un site sans sens ni dessus dessous</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/le-web-fait-du-hors-piste.php" title="Le Web fait du hors piste !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/collecter-et-prioriser-les-besoin-de-vos-utilisateurs-a-laide-de-workshops-agile-ux.php" title="Collecter et prioriser les besoins de vos utilisateurs à l’aide de Focus Groups “Agile UX”." />
	...
	<meta name="twitter:title" content="Un site sans sens ni dessus dessous" />
	<meta property="twitter:description" content="Dans cet atelier, vous verrez comment transformer un site LTR (Left To Right) en RTL (Right To Left), tout en gardant une maintenabilité au maximum...." />
	<meta property="dc:title" content="Un site sans sens ni dessus dessous" />
	<meta property="og:title" content="Un site sans sens ni dessus dessous" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/un-site-sans-sens-ni-dessus-dessous.php" />
	<meta property="og:description" content="Dans cet atelier, vous verrez comment transformer un site LTR (Left To Right) en RTL (Right To Left), tout en gardant une maintenabilité au maximum...." />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Un site sans sens ni dessus dessous</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-796">
						<header>
							<h1>Un site sans sens ni dessus dessous</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-796">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/un-site-sans-sens-ni-dessus-dessous.php" class="url">Un site sans sens ni dessus dessous</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2012/recherche/localisation" rel="tag">localisation</a></dd>
    ...
    <div class="talk-description"><p>Dans cet atelier, vous verrez comment transformer un site LTR (<span lang="en">Left To Right</span>) en RTL (<span lang="en">Right To Left</span>), tout en gardant une maintenabilité au maximum. </p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/aurelien-masfrand.php">Aurélien Masfrand</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Aurélien Masfrand" src="https://www.paris-web.fr/2012/assets_c/2012/09/Aurelien_Masfrand-thumb-143x143-263.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Moitié-dev, moitié-intégrateur. La face cachée du pain de la tartine. Deux mondes trop riches pour être parfait dans les deux mais il faut tenir bon pour conserver la qualité.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/un-site-sans-sens-ni-dessus-dessous.php&amp;ref=prez-un-site-sans-sens-ni-dessus-dessous&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
