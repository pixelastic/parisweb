...
<title>Paris Web - Un site efficace ? Six questions, six outils pour y répondre</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/html5css3-et-leffet-waouh-les-dessous-de-la-magie.php" title="HTML5/CSS3 et l'effet &quot;Waouh !&quot; : les dessous de la magie" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/html5-stockage-local-et-synchronisation.php" title="HTML5 : stockage local et synchronisation" />
	...
	<meta name="twitter:title" content="Un site efficace ? Six questions, six outils pour y répondre" />
	<meta property="twitter:description" content="À la suite de la conférence de 2011 sur les Neurosciences au Service du design digital, Marc vous invite cette année à découvrir comment évaluer un design de manière objective et à faible coût. Au…" />
	<meta property="dc:title" content="Un site efficace ? Six questions, six outils pour y répondre" />
	<meta property="og:title" content="Un site efficace ? Six questions, six outils pour y répondre" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/un-site-efficace-six-questions-six-outils-pour-y-repondre.php" />
	<meta property="og:description" content="À la suite de la conférence de 2011 sur les Neurosciences au Service du design digital, Marc vous invite cette année à découvrir comment évaluer un design de manière objective et à faible coût. Au…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Un site efficace ? Six questions, six outils pour y répondre</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-789">
						<header>
							<h1>Un site efficace ? Six questions, six outils pour y répondre</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/marc_van_rymenant_parisweb2012.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-789">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/un-site-efficace-six-questions-six-outils-pour-y-repondre.php" class="url">Un site efficace ? Six questions, six outils pour y répondre</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/neurosciences" rel="tag">neurosciences</a><br /><a href="http://www.paris-web.fr/2012/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>À la suite de la conférence de 2011 sur les Neurosciences au Service du design digital, Marc vous invite cette année à découvrir comment évaluer un design de manière objective et à faible coût.</p>

<p>Au travers de plusieurs exemples concrets (avant / après) de pages ayant générés des résultats business prouvés, Marc vous propose de compléter vos connaissances sur les éléments cognitifs, visuels, et émotionnels de vos écrans.</p>

<p>Pour cela il utilise des outils de pointe disponibles en mode <abbr>SAAS</abbr>. Ces outils permettent de mesurer l'attractivité des zones de votre écran, leur visibilité ainsi que la facilité de lecture d'un texte, la facilité de compréhension d'un texte et la facilité de clic des boutons.
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/marc-van-rymenant.php">Marc Van Rymenant</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marc Van Rymenant" src="https://www.paris-web.fr/2012/assets_c/2012/09/marc-van-rymenant-thumb-143x143-162-thumb-143x143-254.png" width="143" height="143">
...
<p>Verdict : nous avons perdu ! Cela m'a pris la tête et j'ai commencé à étudier les sciences cognitives en parallele afin de comprendre ce phénomène. 10 ans plus tard, ma passion donnait naissance à Netway. La particularité de notre approche est de lier le scientifique au design afin de générer des résultats business concrets.</p>

<p>Nous avons introduit le eyetracking en Europe en 2000. Aujourd'hui nous complétons des mesures de Advanced Eyetracking par du BrainTracking (analyse de ce qui se passe dans le cerveau par l'intermédiaire de matériel IRM Fonctionnel).</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/un-site-efficace-six-questions-six-outils-pour-y-repondre.php&amp;ref=prez-un-site-efficace-six-questions-six-outils-pou&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
