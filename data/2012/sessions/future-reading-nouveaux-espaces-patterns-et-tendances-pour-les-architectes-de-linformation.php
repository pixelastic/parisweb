...
<title>Paris Web - Future Reading : nouveaux espaces, patterns et tendances pour les architectes de l’information </title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/le-tournant-des-css-vers-le-layout.php" title="Le tournant des CSS vers le Layout" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/tba.php" title="13.0.0.0.0, ou toute la vérité sur le calendrier maya, internet et l’homo evolutis" />
	...
	<meta name="twitter:title" content="Future Reading : nouveaux espaces, patterns et tendances pour les…" />
	<meta property="twitter:description" content="Bien que la fin du livre soit annoncée depuis aussi longtemps que la fin du monde, de nouveaux espaces de lecture sont en train de se créer. Les architectes de l'information auront le rôle de les…" />
	<meta property="dc:title" content="Future Reading : nouveaux espaces, patterns et tendances pour les architectes de l’information " />
	<meta property="og:title" content="Future Reading : nouveaux espaces, patterns et tendances pour les architectes de l’information " />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/future-reading-nouveaux-espaces-patterns-et-tendances-pour-les-architectes-de-linformation.php" />
	<meta property="og:description" content="Bien que la fin du livre soit annoncée depuis aussi longtemps que la fin du monde, de nouveaux espaces de lecture sont en train de se créer. Les architectes de l'information auront le rôle de les…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Future Reading : nouveaux espaces, patterns et tendances pour les architectes de l’information </span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-704">
						<header>
							<h1>Future Reading : nouveaux espaces, patterns et tendances pour les architectes de l’information </h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xx8b7p?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/Vandi_Donovan-NewReadingExperiences-ParisWeb2012.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-704">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/future-reading-nouveaux-espaces-patterns-et-tendances-pour-les-architectes-de-linformation.php" class="url">Future Reading : nouveaux espaces, patterns et tendances pour les architectes de l’information </a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2012/conferences/">Conférence</a></dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/ergonomie" rel="tag">ergonomie</a><br /><a href="http://www.paris-web.fr/2012/recherche/geolocalisation" rel="tag">géolocalisation</a><br /><a href="http://www.paris-web.fr/2012/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Bien que la fin du livre soit annoncée depuis aussi longtemps que la fin du monde, <strong>de nouveaux espaces de lecture sont en train de se créer</strong>. Les architectes de l'information auront le rôle de les aménager pour tirer le maximum de nouvelles opportunités d’expérience et d’interaction qu’ils ouvrent.</p>

<p>Dans cette conférence, un <strong>panorama complet</strong> de ces nouveaux espaces de lecture, des "patterns" d'interaction qui y sont associés et des tendances d’interaction qu’ils dégagent vous sera présenté. L’impact qu’ils peuvent avoir sur les pratiques de lecture et sur la manière de concevoir l'architecture de l'information des objets de lecture y sera bien sûr analysé. </p>

<p>Ainsi les sujets suivants seront abordés :</p>
<ul>
<li>Les <strong>nouveaux espaces de lecture</strong> : les espaces classiques et leurs évolutions, les nouvelles opportunités du "native touch", les magazines personnalisés, l’indépendance du contenu par rapport aux supports ;</li>
<li>L’<strong>interaction pendant la lecture</strong> : les classiques de navigation et pagination revisités ; les règles d’interaction comme partie intégrante de l’expérience d’une marque ; l’enrichissement de l’espace de lecture ;</li>
<li>Les <strong>interactions autour de la lecture</strong> : l’extension de l’espace de lecture, la lecture géolocalisée, la lecture sociale.</li>
</ul>

<p>Au cours de cette conférence Claudio Vandi et Grandin Donovan ne se limiteront pas à présenter une collection de cas mais avaliseront les opportunités qui s’ouvrent aux architectes de l’information et l’impact sur leur travail de conception et réalisation de produits destinés à la lecture.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/grandin-donovan.php">Grandin Donovan</a> et <a href="https://www.paris-web.fr/2012/../orateurs/claudio-vandi.php">Claudio Vandi</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Grandin Donovan" src="https://www.paris-web.fr/2012/assets_c/2012/08/grandin_donovan-thumb-143x143-205.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio">Diplômé de la <span lang="en">New-York University</span> en littérature et journalisme, Grandin Donovan a d’abord travaillé comme enquêteur avant de s’installer à Paris. Passionné par le design d’expérience utilisateur, il à passé plusieurs années comme <span lang="en">Product Manager</span> chez Dailymotion, puis rejoint Nealite en tant que manager UX. Il est Ambassadeur de l’EuroIA pour la France, et co-fondateur d’UX Paris. Il aime bien parler de la bouffe.</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Claudio Vandi" src="https://www.paris-web.fr/2012/assets_c/2012/08/Claudio%20Vandi-thumb-143x143-197.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Claudio est l'expert en utilisabilité et ergonomie cognitive de Silicon Xperience. Issu d'une formation en Sémiotique et Sciences de la Communication (Université de Bologne, Italie) et Psychologie Cognitive (EPHE et l'Université de Paris 8) il a exploré différents thèmes de recherche : l'usage de métaphores dans les interfaces homme-machine, le transfert d'habitudes d'interaction à travers les interfaces, et le changement comportementaux liés à la lecture à l'écran.</p>

<p>Il a travaillé comme chercheur au LUTIN Userlab, chef de projet au sein d'Universcience, Cité des sciences et de l'industrie et a participé en tant que expert à la European Satellite Navigation Competition. Il est principal  auteur du livre blanc « Seniors et tablettes interactives » et il a récemment publié un livre intitulé « L'usabilità, modelli e progettazione » (Utilisabilité : modèles et design).</p>

<p>Depuis 2010 il conçoit de nouvelles expérience de lecture avec <a href="http://www.flipbulbs.com/">Flipbulbs</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/future-reading-nouveaux-espaces-patterns-et-tendances-pour-les-architectes-de-linformation.php&amp;ref=prez-future-reading-nouveaux-espaces-patterns-et-t&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
