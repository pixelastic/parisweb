...
<title>Paris Web - Web Design's Lego: visual grammar and lexicon of the web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/les-tests-utilisateurs-a-distance-interet-et-limites-dans-le-cycle-de-conception-centre-utilisateur.php" title="Les tests utilisateurs à distance : intérêt et limites dans le cycle de conception centré utilisateur" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/real-2-real.php" title="Du réel au réel, Internet des usages" />
	...
	<meta name="twitter:title" content="Web Design's Lego: visual grammar and lexicon of the web" />
	<meta property="twitter:description" content=" With spoken language, fluency comes from constant exposure and practice. However, in order to truly master a language, all children must learn its grammar. Likewise, to masterfully tell stories, one…" />
	<meta property="dc:title" content="Web Design's Lego: visual grammar and lexicon of the web" />
	<meta property="og:title" content="Web Design's Lego: visual grammar and lexicon of the web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/web-designs-lego-visual-grammar-and-lexicon-of-the-web.php" />
	<meta property="og:description" content=" With spoken language, fluency comes from constant exposure and practice. However, in order to truly master a language, all children must learn its grammar. Likewise, to masterfully tell stories, one…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Web Design's Lego: visual grammar and lexicon of the web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-697">
						<header>
							<h1>Web Design's Lego: visual grammar and lexicon of the web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xw4ipk?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-697">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/web-designs-lego-visual-grammar-and-lexicon-of-the-web.php" class="url">Web Design's Lego: visual grammar and lexicon of the web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2012/recherche/storytelling" rel="tag">storytelling</a></dd>
...
<p>With spoken language, fluency comes from constant exposure and practice. However, in order to truly master a language, all children must learn its grammar. Likewise, to masterfully tell stories, one must learn its lexicon. 
</p><p>
The language of web design is no different. While we all are fluent in the lingua franca of our craft, do we know what we need to masterfully communicate Story visually? 
</p><p>
Let's explore how we can begin to infuse our designs with the <strong>magic of storytelling</strong> by discovering the grammar of visual "linguistic" units of web design. 
</p><p>
We will then look at how we can artfully connect these units to form eloquent visual phrases and sentences, and combine all of these techniques to communicate compelling stories through our creations.</p>
</div>
<div lang="fr" class="span-6 last">
<p>
Pour être à l'aise avec une langue parlée, il faut y être constamment exposé, en écoute comme en expression. Toutefois, pour la maîtriser véritablement, il faut en apprendre la grammaire. De la même façon pour raconter avec succès des histoires, il faut en apprendre le lexique.
</p><p>
Le langage du design web ne fait pas exception. Alors que nous sommes tous à l'aise avec la lingua franca de notre métier, avons-nous pour autant assez de connaissances pour transmettre une Histoire visuelle avec succès ?
</p><p>
Je vous propose d‘explorer les façons d'imprégner nos designs de la <strong>magie du conteur</strong>, en découvrant la grammaire des unités « linguistiques » visuelles du design web.
</p><p>
Nous pourrons alors déterminer comment combiner ces unités avec art pour produire des phrases visuelles éloquentes, et comment tirer parti de toutes ces techniques pour raconter de captivantes histoires au moyen de nos créations.
</p>
</div>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/denise-jacobs.php">Denise Jacobs</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Denise Jacobs" src="https://www.paris-web.fr/2012/assets_c/2012/08/denise-jacobs-thumb-143x143-200.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p lang="en">
Denise Jacobs adores being a sought-after international Speaker, Author, Web Designer, and Creativity Evangelist. Most appreciated on Twitter as <a href="https://twitter.com/denisejacobs">@denisejacobs</a> for her “Great Resources”, Denise is the author of The CSS Detective Guide, the premier book on troubleshooting CSS code; and co-author to InterAct with Web Standards and the just-released Smashing Book #3: Redesign the Web. Her widely-read articles encourage people to express their creativity as they Banish Their Inner Critic and Reignite Their Creative Spark. Her latest pet project: to encourage more people from underrepresented groups to Rawk The Web by becoming visible web experts.
</p>
</div>
<div lang="fr" class="span-6 last">
<p>
Denise Jacobs adore être courtisée en tant qu'oratrice d'envergue internationale, designer web, auteure, et évangéliste Créativité.  Très appréciée sur Twitter en tant que <a href="https://twitter.com/denisejacobs">@denisejacobs</a> pour ses “Grandes Ressources”, Denise est l’auteure de The CSS Detective Guide, le principal ouvrage sur le débogage de code CSS ; et la co-auteure de InterAct with Web Standards et du tout récent Smashing Book #3: Redesign the Web. Ses articles au large public encouragent ses lecteurs à exprimer leur créativité en Bannissant Leur Critique Interne et à Raviver Leur Étincelle Créative.  Son dernier projet personnel : encourager davantage de gens issus de groupes peu représentés à Bouger Le Web en devenant des experts web reconnus.
</p>
</div></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/web-designs-lego-visual-grammar-and-lexicon-of-the-web.php&amp;ref=prez-web-designs-lego-visual-grammar-and-lexicon-o&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
