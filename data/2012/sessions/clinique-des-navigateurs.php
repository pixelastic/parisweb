...
<title>Paris Web - Clinique des navigateurs</title>
...
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/gestion-personnelle-dinformation-outils-et-methodologie-pour-survivre-au-deluge-dinformations.php" title="Gestion personnelle d'information: outils et méthodologie pour survivre au déluge ... d'informations" />
	...
	<meta name="twitter:title" content="Clinique des navigateurs" />
	<meta property="twitter:description" content="Nous débuterons par une courte introduction sur comment préparer un bon rapport de bug ou une demande de fonctionnalité. Puis les participants seront invités à exprimer leurs soucis avec les…" />
	<meta property="dc:title" content="Clinique des navigateurs" />
	<meta property="og:title" content="Clinique des navigateurs" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/clinique-des-navigateurs.php" />
	<meta property="og:description" content="Nous débuterons par une courte introduction sur comment préparer un bon rapport de bug ou une demande de fonctionnalité. Puis les participants seront invités à exprimer leurs soucis avec les…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Clinique des navigateurs</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-795">
						<header>
							<h1>Clinique des navigateurs</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/ARicaud_clinique_navigateurs.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-795">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/clinique-des-navigateurs.php" class="url">Clinique des navigateurs</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/navigateurs" rel="tag">navigateurs</a></dd>
    ...
    <div class="talk-description"><p>Nous débuterons par une courte introduction sur comment préparer un bon <strong>rapport de bug</strong> ou <strong>une demande de fonctionnalité</strong>.</p>
<p>Puis les participants seront invités à exprimer leurs soucis avec les navigateurs, que ce soit au niveau de l'interface ou du rendu des pages. Des tuteurs accompagneront les participants pour <strong>comprendre</strong> leurs problèmes puis les <strong>exprimer</strong> au bon endroit (<span lang="en">bug tracker</span>, <span lang="en">mailing list</span>).</p>
<p>Les participants devraient en retirer une meilleure compréhension des navigateurs et des spécifications. Les "tuteurs" repartiront avec plein de bugs à corriger.</p>
<p><strong><a href="http://hanblog.info/blog/post/2012/10/Clinique-des-navigateurs">Bien se préparer pour cet atelier</a></strong>.</p></div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/clinique-des-navigateurs.php&amp;ref=prez-clinique-des-navigateurs&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
