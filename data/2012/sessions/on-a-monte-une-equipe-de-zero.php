...
<title>Paris Web - On a monté une équipe de zéro</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/utilisez-les-apis-web-daujourdhui-pour-creer-les-interfaces-de-demain.php" title="Utilisez les APIs Web d'aujourd'hui pour créer les interfaces de demain" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/pause-1.php" title="Pause" />
	...
	<meta name="twitter:title" content="On a monté une équipe de zéro" />
	<meta property="twitter:description" content="L'équipe technique reste le pilier central d'un projet pour assurer sa vie et son succès. Ainsi, avant de commencer le projet, il est important de constituer une équipe qui saura le porter. C’est ce…" />
	<meta property="dc:title" content="On a monté une équipe de zéro" />
	<meta property="og:title" content="On a monté une équipe de zéro" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/on-a-monte-une-equipe-de-zero.php" />
	<meta property="og:description" content="L'équipe technique reste le pilier central d'un projet pour assurer sa vie et son succès. Ainsi, avant de commencer le projet, il est important de constituer une équipe qui saura le porter. C’est ce…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>On a monté une équipe de zéro</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-699">
						<header>
							<h1>On a monté une équipe de zéro</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/k7mSfdLUMjaT9C3tPnb?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/slides/On-a-monte-une-equipe-de-zero.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-699">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/on-a-monte-une-equipe-de-zero.php" class="url">On a monté une équipe de zéro</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/agilite" rel="tag">agilité</a><br /><a href="http://www.paris-web.fr/2012/recherche/gestion-de-projet" rel="tag">gestion de projet</a><br /><a href="http://www.paris-web.fr/2012/recherche/methodologie" rel="tag">méthodologie</a></dd>
    ...
    <div class="talk-description"><p>L'équipe technique reste le pilier central d'un projet pour assurer sa vie et son succès. </p>

<p>Ainsi, avant de commencer le projet, il est important de constituer une équipe qui saura le porter. C’est ce que nous avons essayé de faire en montant notre équipe technique de zéro en début d’année. </p>

<p>Cet atelier reviendra sur les différentes problématiques que nous avons rencontrés et de la manière dont nous avons choisi d’y répondre :</p>

<ul>
<li>recrutement,</li>
<li>organisation et ambiance interne,</li>
<li>mise en place de méthodes agiles,</li>
<li>choix des outils techniques.</li>
</ul>

<p>Nous parlerons ainsi de nos succès mais aussi des pièges que nous n’avons pas réussi à éviter. </p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/julien-fusco.php">Julien Fusco</a> et <a href="https://www.paris-web.fr/2012/../orateurs/anne-sophie-tranchet.php">Anne-Sophie Tranchet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Julien Fusco" src="https://www.paris-web.fr/2012/assets_c/2012/08/julien_fusco-thumb-143x143-211.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Développeur web chez TEA la journée, Julien Fusco contribue à monter une plateforme de diffusion du livre numérique. Il aime bien ça car il code dans un esprit Open Source et que la liberté du lecteur numérique est mise au centre des discours. Du haut de ses 6 années d'expérience, il s'est spécialisé dans PHP et a fait ses armes en SSII.</p>

<p>Expérimentateur diurne, il joue avec les dernières technologies ayant trait de près ou de loin à PHP.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/on-a-monte-une-equipe-de-zero.php&amp;ref=prez-on-a-monte-une-equipe-de-zero&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
