...
<title>Paris Web - Comprendre l'autisme pour améliorer les projets transmédias</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/souriez-vous-etes-trackes.php" title="Souriez (?) vous êtes trackés !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/de-lart-de-prendre-la-fuite.php" title="De l'art de prendre la fuite" />
	...
	<meta name="twitter:title" content="Comprendre l'autisme pour améliorer les projets transmédias" />
	<meta property="twitter:description" content="L’explosion des réseaux sociaux, des plateformes et des contenus a entre autres permis l’émergence d’une forme de diffusion qui passionne autant les créateurs que les consommateurs : le transmédia.…" />
	<meta property="dc:title" content="Comprendre l'autisme pour améliorer les projets transmédias" />
	<meta property="og:title" content="Comprendre l'autisme pour améliorer les projets transmédias" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/comprendre-lautisme-pour-ameliorer-les-projets-transmedias.php" />
	<meta property="og:description" content="L’explosion des réseaux sociaux, des plateformes et des contenus a entre autres permis l’émergence d’une forme de diffusion qui passionne autant les créateurs que les consommateurs : le transmédia.…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Comprendre l'autisme pour améliorer les projets transmédias</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-695">
						<header>
							<h1>Comprendre l'autisme pour améliorer les projets transmédias</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xuxuyi?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/vmparisweb2012-finale-121019052421-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/vmparisweb2012-finale-121019052421-phpapp02.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-695">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/comprendre-lautisme-pour-ameliorer-les-projets-transmedias.php" class="url">Comprendre l'autisme pour améliorer les projets transmédias</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/personas" rel="tag">personas</a><br /><a href="http://www.paris-web.fr/2012/recherche/storytelling" rel="tag">storytelling</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>L’explosion des réseaux sociaux, des plateformes et des contenus a entre autres permis l’émergence d’une forme de diffusion qui passionne autant les créateurs que les consommateurs : le transmédia. </p>

<p>Seulement, voilà que l’évidence ne suffit pas pour que cela fonctionne réellement. Pourtant tout y est. Que manque-t-il que nous ne voyons pas pour que la réussite de ce mode de narration s’impose ? Peut-être faut-il chercher du côté des champions du sens, les autistes. Vous allez être surpris…</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/veronique-marino.php">Véronique Marino</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Véronique Marino" src="https://www.paris-web.fr/2012/assets_c/2012/08/091208_Ve%E2%95%A0%C3%BCronique_Marino_photo-thumb-143x143-231.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Basée à Montréal, Véronique Marino est consultante en développement et stratégie de contenu multiplateforme sur le Web.</p>

<p>De 1996 à 1999, elle est associée au développement et à l'implantation du portail généraliste InfiniT.com pour le compte du Groupe Vidéotron, et du premier site Internet pour le réseau de télédiffusion TVA. De 1999 à 2001, elle a poursuivi sa carrière comme chef de produit d’une suite logiciel basée sur la reconnaissance du langage naturel sur le Web au sein de Nomino Technologies. Ses qualités de gestionnaire et sa compréhension du développement innovateur l'ont conduite chez Nurun où elle a assuré le développement de nombreux projets avec l'ensemble du Groupe Quebecor. Directrice du programme Médias interactifs de L’inis depuis 2004, elle a développé depuis 2009 l’activité de son service-conseil, Espace Infusion, spécialisé dans le transmédia et incubateur des projets les plus reconnus sur le web (zieuter.tv...).</p>

<p>Elle donne régulièrement des ateliers ainsi que des conférences dans tout le Canada et en France (pour l'INA et L'INASup).</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/comprendre-lautisme-pour-ameliorer-les-projets-transmedias.php&amp;ref=prez-comprendre-lautisme-pour-ameliorer-les-projet&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
