...
<title>Paris Web - Utilisez les APIs Web d'aujourd'hui pour créer les interfaces de demain</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/tba.php" title="13.0.0.0.0, ou toute la vérité sur le calendrier maya, internet et l’homo evolutis" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/on-a-monte-une-equipe-de-zero.php" title="On a monté une équipe de zéro" />
	...
	<meta name="twitter:title" content="Utilisez les APIs Web d'aujourd'hui pour créer les interfaces de…" />
	<meta property="twitter:description" content="Cette présentation a comme but de démystifier les interfaces utilisateur futuristes. On montrera comment les technologies disponibles aujourd'hui en tant que APIs Web peuvent être utilisées pour…" />
	<meta property="dc:title" content="Utilisez les APIs Web d'aujourd'hui pour créer les interfaces de demain" />
	<meta property="og:title" content="Utilisez les APIs Web d'aujourd'hui pour créer les interfaces de demain" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/utilisez-les-apis-web-daujourdhui-pour-creer-les-interfaces-de-demain.php" />
	<meta property="og:description" content="Cette présentation a comme but de démystifier les interfaces utilisateur futuristes. On montrera comment les technologies disponibles aujourd'hui en tant que APIs Web peuvent être utilisées pour…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Utilisez les APIs Web d'aujourd'hui pour créer les interfaces de demain</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-698">
						<header>
							<h1>Utilisez les APIs Web d'aujourd'hui pour créer les interfaces de demain</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xuyza9?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/luzcaballero.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-698">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/utilisez-les-apis-web-daujourdhui-pour-creer-les-interfaces-de-demain.php" class="url">Utilisez les APIs Web d'aujourd'hui pour créer les interfaces de demain</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/web-api" rel="tag">web API</a><br /><a href="http://www.paris-web.fr/2012/recherche/web-apps" rel="tag">web apps</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Cette présentation a comme but de démystifier les <strong>interfaces utilisateur</strong> futuristes. </p>

<p>On montrera comment les technologies disponibles aujourd'hui en tant que <strong>APIs Web</strong> peuvent être utilisées pour concevoir des expériences utilisateur qui sortent de l'ordinaire. </p>

<p>On présentera des exemples de ces interfaces dont on analysera le code point par point. On parlera d'APIs Web comme :</p>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/luz-caballero.php">Luz Caballero</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Luz Caballero" src="https://www.paris-web.fr/2012/assets_c/2012/09/luz_caballero_143-thumb-143x143-265.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Luz travaille comme Web Opener chez Opera Software à Palo Alto, Californie. Elle aide les développeurs à utiliser les standards web pour que leurs applications soient interopérables dans toutes les plateformes et dispositifs possibles, favorisant ainsi un web accessible à tout le monde.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/utilisez-les-apis-web-daujourdhui-pour-creer-les-interfaces-de-demain.php&amp;ref=prez-utilisez-les-apis-web-daujourdhui-pour-creer-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
