...
<title>Paris Web - Bien démarrer avec le Responsive Webdesign</title>
...
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/optimisation-des-images-png-et-jpg-compression-deflate-extreme-des-fichiers-statiques.php" title="Optimisation des images .png et .jpg, compression Deflate extrême des fichiers statiques" />
	...
	<meta name="twitter:title" content="Bien démarrer avec le Responsive Webdesign" />
	<meta property="twitter:description" content=" Le web a définitivement adopté le Responsive Design. Pour cela, les développeurs et les designers doivent adapter une bonne partie de leurs méthodes. Nous vous proposons un aperçu méthodologique…" />
	<meta property="dc:title" content="Bien démarrer avec le Responsive Webdesign" />
	<meta property="og:title" content="Bien démarrer avec le Responsive Webdesign" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/bien-demarrer-avec-le-responsive-webdesign.php" />
	<meta property="og:description" content=" Le web a définitivement adopté le Responsive Design. Pour cela, les développeurs et les designers doivent adapter une bonne partie de leurs méthodes. Nous vous proposons un aperçu méthodologique…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Bien démarrer avec le Responsive Webdesign</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-783">
						<header>
							<h1>Bien démarrer avec le Responsive Webdesign</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/Bien-demarrer-responsive-design.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-783">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/bien-demarrer-avec-le-responsive-webdesign.php" class="url">Bien démarrer avec le Responsive Webdesign</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/responsive-design" rel="tag">responsive design</a></dd>
...
Le web a définitivement adopté le <em lang="en">Responsive Design</em>. Pour cela, les développeurs et les designers doivent adapter une bonne partie de leurs méthodes. Nous vous proposons un aperçu méthodologique combiné à un atelier pratique pour développer ou revoir vos bases en <em lang="en">Responsive Web Design</em>. 
</p>
<ul>
<li>Responsive Webdesign&nbsp;: <abbr title="What the Fuck" lang="en">WTF</abbr></li>
<li>Avantages/Inconvénients&nbsp;: comment savoir si le <em lang="en">Responsive Webdesign</em> est adapté à ce projet&nbsp;?</li> 
<li>Implication du <em lang="en">Responsive Webdesign</em> dans la gestion d'un projet web</li>
<li>En pratique&nbsp;!</li>
</ul></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/gregoire-hoin.php">Grégoire Hoin</a> et <a href="https://www.paris-web.fr/2012/../orateurs/benoit-vrins.php">Benoît Vrins</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Grégoire Hoin" src="https://www.paris-web.fr/2012/assets_c/2012/10/Gr%C3%A9goire-Hoin-thumb-143x143-270.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Greg est un des fondateurs de l'agence Bruxelloise <a href="http://www.spade.be">Spade</a>. Designer hybride passé par une formation d'ingénierie, il est aussi bien passionné d'ergonomie, de typographie et de systèmes de grilles, qu'expert en HTML/CSS. Parfois pointilleux et excessif, il est néanmoins curieux, et adore voyager pour participer à des conférences entre confrères (web)designers. Sinon, il adore bidouiller en Javascript et suivre les derniers outils venus de la <span lang="en">Bay Area</span>. </p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Benoît Vrins" src="https://www.paris-web.fr/2012/assets_c/2012/10/Benoit-Vrins-thumb-143x143-269.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Benoit est un des fondateurs de l'agence Bruxelloise <a href="http://www.spade.be">Spade</a>. Web designer depuis plus d'une décennie, il a suivi les évolutions du métier, et conseille entreprises et associations au niveau créatif, stratégique et technique. Il est passionnée de CSS3, LESS, HTML5, d'un CMS open-source nommé SPIP. Et ne le lancez pas dans une conversation sur le Rock&amp;Roll, il ne s'arrêtera pas&nbsp;!  </p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/bien-demarrer-avec-le-responsive-webdesign.php&amp;ref=prez-bien-demarrer-avec-le-responsive-webdesign&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
