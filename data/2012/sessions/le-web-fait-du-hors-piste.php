...
<title>Paris Web - Le Web fait du hors piste !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/recommandation-le-defi.php" title="Recommandation, le défi" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/un-site-sans-sens-ni-dessus-dessous.php" title="Un site sans sens ni dessus dessous" />
	...
	<meta name="twitter:title" content="Le Web fait du hors piste !" />
	<meta property="twitter:description" content="Les technologies du Web sont partout et associées à la vague du Do It Yourself; ainsi de nouvelles possibilités qui s'ouvrent aux développeurs Web d'aujourd'hui : Lire des puces RFID avec NodeJS ;…" />
	<meta property="dc:title" content="Le Web fait du hors piste !" />
	<meta property="og:title" content="Le Web fait du hors piste !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/le-web-fait-du-hors-piste.php" />
	<meta property="og:description" content="Les technologies du Web sont partout et associées à la vague du Do It Yourself; ainsi de nouvelles possibilités qui s'ouvrent aux développeurs Web d'aujourd'hui : Lire des puces RFID avec NodeJS ;…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le Web fait du hors piste !</span>
			</p>
	...
	<section class="s-talk-subject" id="sujet-791">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/le-web-fait-du-hors-piste.php" class="url">Le Web fait du hors piste !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/javascript" rel="tag">Javascript</a><br /><a href="http://www.paris-web.fr/2012/recherche/rfid" rel="tag">RFID</a><br /><a href="http://www.paris-web.fr/2012/recherche/web-api" rel="tag">web API</a></dd>
    ...
    <div class="talk-description"><p>Les technologies du Web sont partout et associées à la vague du "<span lang="en">Do It Yourself</span>"; ainsi de nouvelles possibilités qui s'ouvrent aux développeurs Web d'aujourd'hui :</p>
<ul>
...
<li>utiliser votre manette de jeu Xbox et PlayStation dans votre navigateur avec la GamePad API ;</li><li>la visioconférence ;</li>
<li>le P2P ;</li>
<li>etc.</li>
</ul>
<p>Cet atelier tentera d'explorer ces nouveaux usages à travers un tour d'horizon des nouvelles possibilités accompagnées de démos.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/jonathan-blanchet.php">Jonathan Blanchet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jonathan Blanchet" src="https://www.paris-web.fr/2012/assets_c/2012/08/jonathan-blanchet-thumb-143x143-235.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Passionné du web passé par la section multimédia de l'école Gobelins.<br />
J'ai ensuite exercé le métier de développeur Ruby avant de m'installer à mon compte comme Freelance développeur web (<a href="http://jblanche.fr/">http://jblanche.fr/</a>) au sein du collectif Lab212 (<a href="http://lab212.org/">http://lab212.org/</a>).<br />
 <br />
J'y participe à l'élaboration d'application web variées, depuis leur conception jusqu'à la réalisation tout en suivant les projets plus artistiques développés par le collectif.</p>

<p>J'ai également déjà animé un <a href="http://www.paris-web.fr/2011/ateliers/coffeescript-le-javascript-simple-et-elegant.php">atelier sur CoffeeScript l'an dernier</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/le-web-fait-du-hors-piste.php&amp;ref=prez-le-web-fait-du-hors-piste&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
