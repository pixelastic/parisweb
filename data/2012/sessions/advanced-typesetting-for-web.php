...
<title>Paris Web - Advanced Typesetting for Web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/10-new-year-s-resolutions-designers.php" title="How Designers Destroyed the World" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/faire-du-web-moderne-a-destination-de-tous.php" title="Faire du web moderne à destination de tous" />
	...
	<meta name="twitter:title" content="Advanced Typesetting for Web" />
	<meta property="twitter:description" content=" With the rise of web fonts, we are finally able to deliver sophisticated typographic experiences to our users. However, devil is in the details, so let’s investigate how far can we go to tweak for…" />
	<meta property="dc:title" content="Advanced Typesetting for Web" />
	<meta property="og:title" content="Advanced Typesetting for Web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/advanced-typesetting-for-web.php" />
	<meta property="og:description" content=" With the rise of web fonts, we are finally able to deliver sophisticated typographic experiences to our users. However, devil is in the details, so let’s investigate how far can we go to tweak for…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Advanced Typesetting for Web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-688">
						<header>
							<h1>Advanced Typesetting for Web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xwji8u?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-688">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/advanced-typesetting-for-web.php" class="url">Advanced Typesetting for Web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/typographie" rel="tag">typographie</a></dd>
...
<p>With the rise of web fonts, we are finally able to <strong>deliver sophisticated typographic experiences</strong> to our users. However, devil is in the details, so let’s investigate how far can we go to tweak for improved legibility covering wide variety of devices. 
</p>
<p>
You will learn <strong>how to choose typeface</strong> for function over form, about font and pixel size across devices, how to set-up macro and micro white-space and how to design line, leading and word space.</p>
</div>
<div lang="fr" class="span-6 last">
<p>Avec la percée des fontes web, nous voici enfin à même de <strong>fournir une expérience typographique raffinée</strong> à nos utilisateurs. Néanmoins, le diable est dans les détails, aussi examinons jusqu’où nos ajustements peuvent aller pour améliorer la lisibilité tout en prenant en charge une large variété de périphériques.
</p>
<p>
Vous apprendrez <strong>comment choisir une police</strong> sur base de la fonction plutôt que la forme, verrez la distinction entre taille de fonte et taille de police suivant les périphériques, découvrirez comment définir des espacements macro et micro et comment concevoir les rapports d’espacement entre les lignes et les mots.</p>
</div>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/marko-dugonjic.php">Marko Dugonjić</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marko Dugonjić" src="https://www.paris-web.fr/2012/assets_c/2012/08/Marko%20Dugonjic-thumb-143x143-213.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p>Marko Dugonjić is a designer and web standards developer from Zagreb, Croatia. As the creative and user experience director at Creative Nights, Marko improves customers’ digital experience for top local and international clients and occasionally speaks at European web design conferences. He founded FFWD.PRO, a micro-conference and workshops for internet professionals in Croatia. One of his favorite projects is Typetester, a popular online tool for testing screen fonts.</p>
</div>
<div lang="fr" class="span-6 last">
<p>Marko Dugonjić est un designer et développeur fan de standards web basé à Zagreb, en Croatie.  En tant que directeur créatif et expérience utilisateur chez Creative Nights, Marko améliore l’expérience numérique des utilisateurs de clients locaux et internationaux de premier plan, et participe occasionnellement à des conférences européennes sur le design web. Il a fondé FFWD.PRO, une micro-conférence complétée par des ateliers pour les profesionnels du web en Croatie. L’un de ses projets préférés est Typetester, un outil en ligne populaire pour tester les fontes sur écran.</p>
</div></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/advanced-typesetting-for-web.php&amp;ref=prez-advanced-typesetting-for-web&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
