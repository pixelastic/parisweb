...
<title>Paris Web - Collecter et prioriser les besoins de vos utilisateurs à l’aide de Focus Groups “Agile UX”.</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/un-site-sans-sens-ni-dessus-dessous.php" title="Un site sans sens ni dessus dessous" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/pause-1.php" title="Pause" />
	...
	<meta name="twitter:title" content="Collecter et prioriser les besoins de vos utilisateurs à l’aide de…" />
	<meta property="twitter:description" content="L'étape primordiale d’un projet, quelle que soit la méthodologie adoptée, est la collecte des besoins. Il est souvent difficile de les identifier, de les comprendre et de leur associer des priorités.…" />
	<meta property="dc:title" content="Collecter et prioriser les besoins de vos utilisateurs à l’aide de Focus Groups “Agile UX”." />
	<meta property="og:title" content="Collecter et prioriser les besoins de vos utilisateurs à l’aide de Focus Groups “Agile UX”." />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/collecter-et-prioriser-les-besoin-de-vos-utilisateurs-a-laide-de-workshops-agile-ux.php" />
	<meta property="og:description" content="L'étape primordiale d’un projet, quelle que soit la méthodologie adoptée, est la collecte des besoins. Il est souvent difficile de les identifier, de les comprendre et de leur associer des priorités.…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Collecter et prioriser les besoins de vos utilisateurs à l’aide de Focus Groups “Agile UX”.</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-799">
						<header>
							<h1>Collecter et prioriser les besoins de vos utilisateurs à l’aide de Focus Groups “Agile UX”.</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-799">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/collecter-et-prioriser-les-besoin-de-vos-utilisateurs-a-laide-de-workshops-agile-ux.php" class="url">Collecter et prioriser les besoins de vos utilisateurs à l’aide de Focus Groups “Agile UX”.</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/agilite" rel="tag">agilité</a><br /><a href="http://www.paris-web.fr/2012/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>L'étape primordiale d’un projet, quelle que soit la <strong>méthodologie</strong> adoptée, est la collecte des besoins. Il est souvent difficile de les identifier, de les comprendre et de leur associer des priorités. <br />Qu’il s’agisse de projets réalisés en mode Agile ou plus classiquement en cascade, l’approche User Centric apporte des solutions concrètes à ce stade du projet.</p>
<p>Vous souhaitez découvrir la technique originale des focus groups "UX Agile" ? Cet atelier est fait pour vous.</p>

<p>En repartant de cet atelier vous saurez précisément  :</p>

<ul>
<li>apporter la vue utilisateur (Backlog orienté utilisateur) ;</li>
<li>définir des <span lang="en">User Stories</span> avec vos utilisateurs;</li>
<li>mettre à profit les <strong>concepts Agiles</strong> pour gagner en efficacité;</li>
<li>comprendre les pièges UX à éviter en termes d’évaluation utilisateur;</li>
<li>et plus largement comprendre le contexte Agile UX et comment intégrer l'utilisateur dans une approche Agile.</li>
</ul>

<p>Vous apprendrez à plonger vos utilisateurs en immersion dans une session de focus group timeboxée qui tiendra toutes ses promesses pour délivrer une feuille de route orientée utilisateur à votre équipe de développement.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/gautier-barrere.php">Gautier Barrère</a> et <a href="https://www.paris-web.fr/2012/../orateurs/eric-mazzone.php">Éric Mazzone</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Gautier Barrère" src="https://www.paris-web.fr/2012/assets_c/2012/08/gautierbarrere-thumb-143x143-232.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Gautier Barrère est psychologue, stratège UX et spécialiste en persuasive design. Il coordonne l'équipe "Web &amp; UX" Office du gouvernement luxembourgeois, responsable du référentiel de qualité Web Renow (<a href="http://www.renow.lu">www.renow.lu</a>).</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Éric Mazzone" src="https://www.paris-web.fr/2012/assets_c/2012/08/Eric%20Mazzone-thumb-143x143-201.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Éric Mazzone est consultant spécialiste dans l'analyse BPM et dans les démarche centrées utilisateur. Ses missions consistent notamment à intégrer l'approche centrée utilisateur au sein des démarches d'analyse et des méthodes de gestion de projet. </p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/collecter-et-prioriser-les-besoin-de-vos-utilisateurs-a-laide-de-workshops-agile-ux.php&amp;ref=prez-collecter-et-prioriser-les-besoin-de-vos-util&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
