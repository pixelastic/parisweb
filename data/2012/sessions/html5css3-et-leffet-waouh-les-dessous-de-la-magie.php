...
<title>Paris Web - HTML5/CSS3 et l'effet &quot;Waouh !&quot; : les dessous de la magie</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/pause-1.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/un-site-efficace-six-questions-six-outils-pour-y-repondre.php" title="Un site efficace ? Six questions, six outils pour y répondre" />
	...
	<meta name="twitter:title" content="HTML5/CSS3 et l'effet Waouh ! : les dessous de la magie" />
	<meta property="twitter:description" content="HTML5/CSS3 c'est le royaume de la démo qui tue, des étoiles dans les yeux, de l'effet Waouh !. Mais au delà de ça, une fois qu'on a eu son shoot de paillette, on se demande souvent comment ça marche…" />
	<meta property="dc:title" content="HTML5/CSS3 et l'effet Waouh ! : les dessous de la magie" />
	<meta property="og:title" content="HTML5/CSS3 et l'effet Waouh ! : les dessous de la magie" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/html5css3-et-leffet-waouh-les-dessous-de-la-magie.php" />
	<meta property="og:description" content="HTML5/CSS3 c'est le royaume de la démo qui tue, des étoiles dans les yeux, de l'effet Waouh !. Mais au delà de ça, une fois qu'on a eu son shoot de paillette, on se demande souvent comment ça marche…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>HTML5/CSS3 et l'effet "Waouh !" : les dessous de la magie</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-786">
						<header>
							<h1>HTML5/CSS3 et l'effet "Waouh !" : les dessous de la magie</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-786">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/html5css3-et-leffet-waouh-les-dessous-de-la-magie.php" class="url">HTML5/CSS3 et l'effet "Waouh !" : les dessous de la magie</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/css3" rel="tag">CSS3</a><br /><a href="http://www.paris-web.fr/2012/recherche/html5" rel="tag">HTML5</a><br /><a href="http://www.paris-web.fr/2012/recherche/javascript" rel="tag">Javascript</a></dd>
    ...
    <div class="talk-description"><p>HTML5/CSS3 c'est le royaume de la démo qui tue, des étoiles dans les yeux, de l'effet "Waouh !". Mais au delà de ça, une fois qu'on a eu son shoot de paillette, on se demande souvent comment ça marche concrètement...
</p>
<p>
Cette fois, plutôt que de vous laisser seul face à vos questions, nous vous proposons de déconstruire et d'analyser ensemble ce qui se cache derrière la magie. De la conception à la réalisation, en passant par la gestion des capacités du navigateur, tout sera expliqué.
</p>
<p>
Âmes sensibles s'abstenir : ça va roxxer du bisounours !</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/jeremie-patonnier.php">Jérémie Patonnier</a> et <a href="https://www.paris-web.fr/2012/../orateurs/corinne-schillinger.php">Corinne Schillinger</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jérémie Patonnier" src="https://www.paris-web.fr/2012/assets_c/2012/08/jeremie-thumb-143x143-234.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Consultant Web pour Clever Age, Paris</p>

<p>Après avoir terminé des études de communication, Jérémie a commencé sa carrière dans le Web en 2000 en temps que Web Designer. Il a tenu ce poste pendant 3 ans puis a intégré une autre Web Agency en 2003 en temps qu’Intégrateur/Développeur. Il a ensuite pris en charge la gestion de l’équipe de développement Web de Cetelem (filiale de BNP) en 2006. À présent, il est consultant Web pour l'agence Clever Age. Il a volontairement fait évoluer son poste afin d’avoir une vue d’ensemble complète de la chaine de production Internet, et de la conception à la mise en œuvre. Il en fait désormais bénéficier les clients de son agence.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Corinne Schillinger" src="https://www.paris-web.fr/2012/assets_c/2012/08/corinne-thumb-143x143-228.png" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>C’est au cours de son projet de fin d’études que Corinne découvre les standards du web. Motivée par cette approche qualitative, elle fait une croix sur les tableaux de mise en page et les hacks navigateur. Après quelques années passées à se former en autodidacte, elle se met à son compte en mai 2009 pour pouvoir partager son expertise et devient <a href="http://accessiweb.org/index.php/expert-accessiweb-en-evaluation.html">Expert AccessiWeb en Évaluation</a>.</p>

<p>Elle fait également partie de l'équipe éditoriale du <a href="http://letrainde13h37.fr/">train de 13h37</a>, un magazine francophone dédié à la conception Web, et est l'auteur du livre <a href="http://www.amazon.fr/Int%C3%A9gration-web-bonnes-pratiques-lint%C3%A9grateur/dp/2212133707/ref=ntt_at_ep_dpi_1">Intégration web : Les bonnes pratiques</a> publié aux éditions Eyrolles.</p>

<p>Plus sur Corinne sur <a href="http://www.inseo.fr/">inseo.fr</a> ou <a href="https://twitter.com/schillinger">@schillinger</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/html5css3-et-leffet-waouh-les-dessous-de-la-magie.php&amp;ref=prez-html5css3-et-leffet-waouh-les-dessous-de-la-m&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
