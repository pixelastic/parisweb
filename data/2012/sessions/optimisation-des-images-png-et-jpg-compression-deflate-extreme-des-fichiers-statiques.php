...
<title>Paris Web - Optimisation des images .png et .jpg, compression Deflate extrême des fichiers statiques</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/bien-demarrer-avec-le-responsive-webdesign.php" title="Bien démarrer avec le Responsive Webdesign" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/1001-techniques-pour-faire-exploser-un-projet-web-et-comment-les-eviter.php" title="1001 techniques pour faire exploser un projet web (et comment les éviter)" />
	...
	<meta name="twitter:title" content="Optimisation des images .png et .jpg, compression Deflate extrême des…" />
	<meta property="twitter:description" content="À l'heure où l'on accède de plus en plus souvent au Web en mobilité, les images représentent une part conséquente des données émises par les serveurs ou proxy HTTP. Pour autant les ténors de la…" />
	<meta property="dc:title" content="Optimisation des images .png et .jpg, compression Deflate extrême des fichiers statiques" />
	<meta property="og:title" content="Optimisation des images .png et .jpg, compression Deflate extrême des fichiers statiques" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/optimisation-des-images-png-et-jpg-compression-deflate-extreme-des-fichiers-statiques.php" />
	<meta property="og:description" content="À l'heure où l'on accède de plus en plus souvent au Web en mobilité, les images représentent une part conséquente des données émises par les serveurs ou proxy HTTP. Pour autant les ténors de la…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Optimisation des images .png et .jpg, compression Deflate extrême des fichiers statiques</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-784">
						<header>
							<h1>Optimisation des images .png et .jpg, compression Deflate extrême des fichiers statiques</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-784">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/optimisation-des-images-png-et-jpg-compression-deflate-extreme-des-fichiers-statiques.php" class="url">Optimisation des images .png et .jpg, compression Deflate extrême des fichiers statiques</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/compression" rel="tag">compression</a><br /><a href="http://www.paris-web.fr/2012/recherche/images" rel="tag">images</a><br /><a href="http://www.paris-web.fr/2012/recherche/optimisation" rel="tag">optimisation</a><br /><a href="http://www.paris-web.fr/2012/recherche/seo" rel="tag">SEO</a></dd>
    ...
    <div class="talk-description"><p>À l'heure où l'on accède de plus en plus souvent au Web en mobilité, les images représentent une part conséquente des données émises par les serveurs ou proxy HTTP. Pour autant les ténors de la production d'images tels Photoshop ou Fireworks ne génèrent pas toujours des fichiers parfaitement optimisés ou ne laissent pas l'utilisateur agir sur certains paramètres.</p>

<p>Après un rapide retour sur les spécifications PNG (type, couche alpha, filtrage etc.) et JPEG (sous-échantillonnage de la chrominance, baseline vs extended, transmission progressive etc.) cet atelier va vous familiariser avec quelques outils d'analyse (JPEGSnoop, TweakPNG etc.) afin d'y débusquer d'éventuelles <strong>métadonnées superflues</strong> (vignette de prévisualisation, commentaire, profil colorimétrique etc.) ou <strong>erreurs de ciblage</strong> (image noir et blanc ou 256 couleurs enregistrée en millions de couleurs).</p>

<p>Les meilleurs moteurs de compression Deflate (utilisables également sur les fichiers .css, .js ou .svg) ainsi que le nettoyage de la couche alpha et le filtrage automatique seront mis en œuvre pour (re)compresser des PNGs.</p>

<p>Du côté du JPEG le réglage fin de la transmission progressive et l'utilisation de régions d'intérêt seront expérimentés.</p>

<p>L'<strong>automatisation des optimisations</strong> par des scripts sera également pratiquée.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/frederic-kayser.php">Frédéric Kayser</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Frédéric Kayser" src="https://www.paris-web.fr/2012/assets_c/2012/08/kayser-143-thumb-143x143-230.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Ancien technicien de l'atelier numérique de l'École supérieure des arts décoratifs de Strasbourg et ancien administrateur système dans le pré-presse je suis aujourd'hui opérateur grand système IBM, mais surtout féru de compression et auteur de deux petits hacks pour optimiser les images PNG (cryopng et huffmix).</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/optimisation-des-images-png-et-jpg-compression-deflate-extreme-des-fichiers-statiques.php&amp;ref=prez-optimisation-des-images-png-et-jpg-compressio&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
