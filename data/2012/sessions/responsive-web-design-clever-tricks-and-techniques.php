...
<title>Paris Web - Responsive Web Design: Clever Tricks and Techniques</title>
...
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/les-nouveaux-horizons-de-la-cartographie-sur-le-web.php" title="Les nouveaux horizons de la cartographie sur le web" />
	...
	<meta name="twitter:title" content="Responsive Web Design: Clever Tricks and Techniques" />
	<meta property="twitter:description" content=" Responsive web design challenges web designers to adapt a new mindset to their design processes as well as techniques they are using in design and code. This talk provides an overview of various…" />
	<meta property="dc:title" content="Responsive Web Design: Clever Tricks and Techniques" />
	<meta property="og:title" content="Responsive Web Design: Clever Tricks and Techniques" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/responsive-web-design-clever-tricks-and-techniques.php" />
	<meta property="og:description" content=" Responsive web design challenges web designers to adapt a new mindset to their design processes as well as techniques they are using in design and code. This talk provides an overview of various…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Responsive Web Design: Clever Tricks and Techniques</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-684">
						<header>
							<h1>Responsive Web Design: Clever Tricks and Techniques</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xvb0xp?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-684">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/responsive-web-design-clever-tricks-and-techniques.php" class="url">Responsive Web Design: Clever Tricks and Techniques</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/responsive-design" rel="tag">responsive design</a><br /><a href="http://www.paris-web.fr/2012/recherche/ux" rel="tag">UX</a></dd>
...
<p><strong>Responsive web design</strong> challenges web designers to adapt a new mindset to their design processes as well as techniques they are using in design and code.
</p><p>
This talk provides an overview of <strong>various practical techniques</strong>, <strong>tips and tricks</strong> that you might want to be aware of when working on a new responsive design project.</p>
</div>
<div lang="fr" class="span-6 last">
<p>
Le <strong>design web <em>responsive</em></strong> met au défi les designers web de s’adapter à un nouveau mode de réflexion tant pour la conception leurs designs que dans le choix des techniques employées pour le design et le code.
</p>
<p>
Cette session fournit un tour d’<strong>horizon des techniques pratiques</strong>, <strong>trucs et astuces</strong> que vous souhaiterez probablement connaître lorsque vous attaquez un nouveau projet <em>responsive</em>.</p>
</div>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/vitaly-friedman.php">Vitaly Friedman</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Vitaly Friedman" src="https://www.paris-web.fr/2012/assets_c/2012/08/vitaly-friedman-portrait-thumb-143x143-246.jpg" width="143" height="143">
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/responsive-web-design-clever-tricks-and-techniques.php&amp;ref=prez-responsive-web-design-clever-tricks-and-techn&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
