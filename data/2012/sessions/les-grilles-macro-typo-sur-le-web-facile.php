...
<title>Paris Web - Les grilles macro-typo sur le web ? Facile !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/la-performance-sur-les-sites-mobiles.php" title="La performance sur les sites mobiles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/recommandation-le-defi.php" title="Recommandation, le défi" />
	...
	<meta name="twitter:title" content="Les grilles macro-typo sur le web ? Facile !" />
	<meta property="twitter:description" content=" On s’entend dire depuis un moment que les grilles sur le web, c’est le bien ; qu’elles facilitent la lisibilité et qu’elles apportent harmonie et structure. Tout cela est vrai ! Face à la pléthore…" />
	<meta property="dc:title" content="Les grilles macro-typo sur le web ? Facile !" />
	<meta property="og:title" content="Les grilles macro-typo sur le web ? Facile !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/les-grilles-macro-typo-sur-le-web-facile.php" />
	<meta property="og:description" content=" On s’entend dire depuis un moment que les grilles sur le web, c’est le bien ; qu’elles facilitent la lisibilité et qu’elles apportent harmonie et structure. Tout cela est vrai ! Face à la pléthore…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les grilles macro-typo sur le web ? Facile !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-785">
						<header>
							<h1>Les grilles macro-typo sur le web ? Facile !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/Les-grilles-macro-typo-pour-le-web-facile.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-785">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/les-grilles-macro-typo-sur-le-web-facile.php" class="url">Les grilles macro-typo sur le web ? Facile !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/css" rel="tag">CSS</a><br /><a href="http://www.paris-web.fr/2012/recherche/typographie" rel="tag">typographie</a></dd>
...
On s’entend dire depuis un moment que les grilles sur le web, c’est le bien ; qu’elles facilitent la lisibilité et qu’elles apportent harmonie et structure. Tout cela est vrai !
Face à la pléthore de frameworks qui existent sur le marché : 
</p>
<ul><li>par où commencer ?</li><li>Comment établir une grille commune qui facilitera le travail des web designers et des intégrateurs ?</li><li>Comment faire pour que cette grille soit respectée d’un bout à l’autre du projet ?</li></ul>
<p>
Ne cherchez plus ! Grâce aux compilateurs CSS existants, vous allez pouvoir utiliser et intégrer n’importe quelle grille, facilement et rapidement.
</p>
<p>
Nous reviendrons sur le principe de grilles, avant de vous présenter l’outil. Puis nous verrons qu’un grand pouvoir implique de grandes responsabilités, tant pour les web designers que pour les intégrateurs. Le tout agrémenté de vrais exemples déployés en production.
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/vincent-valentin.php">Vincent Valentin</a> et <a href="https://www.paris-web.fr/2012/../orateurs/marie-guillaumet.php">Marie Guillaumet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Vincent Valentin" src="https://www.paris-web.fr/2012/assets_c/2012/08/vincent-valentin-photo-thumb-143x143-226.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Vincent est développeur Web client depuis l’époque des tableaux de mise en page. Après quelques expériences (brèves mais intenses) dans de grandes agences, il travaille maintenant chez Clever Age ; une agence plus petite mais tout aussi respectable. Impliqué dans de nombreux projets qui tentent de promouvoir le Web de qualité, il aime échanger sur ses passions pour le Web en général et la typographie en particulier.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Marie Guillaumet" src="https://www.paris-web.fr/2012/assets_c/2012/08/marie-guillaumet-thumb-143x143-212.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Marie est web designer, développeur web front-end et infographiste. Passionnée par le web beau et ouvert, elle s’intéresse en particulier aux nouveaux outils permettant d’allier esthétique, accessibilité et performances : CSS3, SVG et autres grilles typographiques.</p>

<p>Formée à Sciences Po Grenoble et au Celsa, Marie attache de l’importance à la portée sémantique et sémiologique des projets web auxquels elle contribue.</p>

<p>Quand elle n’est pas clouée à son ordinateur, Marie aime vagabonder en bord de mer, prendre des photos et dissoudre les comètes qui lui passent une à une au travers de la tête.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/les-grilles-macro-typo-sur-le-web-facile.php&amp;ref=prez-les-grilles-macro-typo-sur-le-web-facile&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
