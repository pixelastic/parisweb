...
<title>Paris Web - Les tests utilisateurs à distance : intérêt et limites dans le cycle de conception centré utilisateur</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/accueil-1.php" title="Accueil des participants" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/web-designs-lego-visual-grammar-and-lexicon-of-the-web.php" title="Web Design's Lego: visual grammar and lexicon of the web" />
	...
	<meta name="twitter:title" content="Les tests utilisateurs à distance : intérêt et limites dans le cycle…" />
	<meta property="twitter:description" content="La place des tests utilisateurs dans le cycle de conception centré utilisateurs est indéniable et indispensable pour assurer la bonne qualité ergonomique d'une application ou service web. La mise en…" />
	<meta property="dc:title" content="Les tests utilisateurs à distance : intérêt et limites dans le cycle de conception centré utilisateur" />
	<meta property="og:title" content="Les tests utilisateurs à distance : intérêt et limites dans le cycle de conception centré utilisateur" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/les-tests-utilisateurs-a-distance-interet-et-limites-dans-le-cycle-de-conception-centre-utilisateur.php" />
	<meta property="og:description" content="La place des tests utilisateurs dans le cycle de conception centré utilisateurs est indéniable et indispensable pour assurer la bonne qualité ergonomique d'une application ou service web. La mise en…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les tests utilisateurs à distance : intérêt et limites dans le cycle de conception centré utilisateur</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-690">
						<header>
							<h1>Les tests utilisateurs à distance : intérêt et limites dans le cycle de conception centré utilisateur</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xx656g?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/ParisWeb%272012_Bastien.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-690">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/les-tests-utilisateurs-a-distance-interet-et-limites-dans-le-cycle-de-conception-centre-utilisateur.php" class="url">Les tests utilisateurs à distance : intérêt et limites dans le cycle de conception centré utilisateur</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/ergonomie" rel="tag">ergonomie</a><br /><a href="http://www.paris-web.fr/2012/recherche/tests-utilisateurs" rel="tag">tests utilisateurs</a><br /><a href="http://www.paris-web.fr/2012/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>La place des tests utilisateurs dans le cycle de conception centré utilisateurs est indéniable et indispensable pour assurer la bonne qualité ergonomique d'une application ou service web. La mise en place de ces tests a fait l'objet de nombreuses publications. Il s'agit d'une méthode éprouvée. </p>

<p>Depuis quelques années, de nombreuses publications scientifiques se sont employé à déterminer le nombre d’utilisateurs qu’il fallait observer pour identifier les problèmes d’utilisabilité. On se rend maintenant compte que <strong>les recommandations faites pour les applications interactives "traditionnelles", ne sont plus valides pour le web…</strong> Dans ce contexte, les tests à distance, parce qu'ils permettent de solliciter de nombreux utilisateurs, peuvent constituer une <strong>solution complémentaire intéressante et efficace</strong> pour solutionner ce problème.</p>

<p>Cette conférence permettra de faire le point sur les connaissances scientifiques relatives à la mise en place des tests utilisateurs à distance et de présenter l’outil que nous avons développé au sein du laboratoire.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/christian-bastien.php">Christian Bastien</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Christian Bastien" src="https://www.paris-web.fr/2012/assets_c/2012/08/christian-bastien-thumb-143x143-196.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Christian Bastien est actuellement Professeur à l'Université de Lorraine (site de Metz), Directeur de l'équipe de recherche ETIC (Expériences utilisateurs dans le Traitement des Interactions technologiques et des Conduites humaines et sociales) du Laboratoire InterPsy et Directeur scientifique de la Société Insyde Labs. Christian Bastien est spécialiste d'ergonomie cognitive et d'ergonomie des systèmes interactifs. Ses travaux sur les méthodes d'évaluation ont été publiés dans de nombreuses conférences et revues nationales et internationales. </p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/les-tests-utilisateurs-a-distance-interet-et-limites-dans-le-cycle-de-conception-centre-utilisateur.php&amp;ref=prez-les-tests-utilisateurs-a-distance-interet-et-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
