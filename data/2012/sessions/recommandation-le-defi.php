...
<title>Paris Web - Recommandation, le défi</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/les-grilles-macro-typo-sur-le-web-facile.php" title="Les grilles macro-typo sur le web ? Facile !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/le-web-fait-du-hors-piste.php" title="Le Web fait du hors piste !" />
	...
	<meta name="twitter:title" content="Recommandation, le défi" />
	<meta property="twitter:description" content="1h30 pour ajouter de la recommandation sociale sur votre site web, sans la moindre API et sans le moindre service externe ! Vous croyez cela impossible ?! C'est le défi que nous vous proposons de…" />
	<meta property="dc:title" content="Recommandation, le défi" />
	<meta property="og:title" content="Recommandation, le défi" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/recommandation-le-defi.php" />
	<meta property="og:description" content="1h30 pour ajouter de la recommandation sociale sur votre site web, sans la moindre API et sans le moindre service externe ! Vous croyez cela impossible ?! C'est le défi que nous vous proposons de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Recommandation, le défi</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-790">
						<header>
							<h1>Recommandation, le défi</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/recommandationledfi-121020093035-phpapp01" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/Recommandation-le-defi.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-790">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/recommandation-le-defi.php" class="url">Recommandation, le défi</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2012/recherche/social" rel="tag">social</a></dd>
    ...
    <div class="talk-description"><p>1h30 pour ajouter de la recommandation sociale sur votre site web, sans la moindre API et sans le moindre service externe ! Vous croyez cela impossible ?! C'est le défi que nous vous proposons de relever ensemble pendant cet atelier.
</p><p>
...
Pour profiter au mieux de cet atelier, les participants sont invités à venir équipés :</p> 
<ul>
<li>un ordinateur incluant un IDE,</li>
<li>les sources d'un de leur site auquel ils souhaitent apporter cette fonctionnalité,</li>
<li>une environnement local pour la tester.</li>
</ul>
<p>Application, site e-commerce, forum, etc. : tout site avec des comptes utilisateurs est concerné. 1h30 plus tard, si le défi est relevé, nous aurons même un prototype fonctionnel !</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/thomas-gasc.php">Thomas Gasc</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Thomas Gasc" src="https://www.paris-web.fr/2012/assets_c/2012/09/thomas-gasc-thumb-143x143-261.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Développeur web depuis 2003, spécialisé sur les technologies liées au PHP (MySQL, Symfony, PHPUnit, etc ...) mais également intéressé par les thèmes liés à l'intégration HTML et plus généralement à la publication web (UX, Accessibilité, Sémantique, etc).</p>

<p>Je travaille comme développeur depuis 2010 chez Marcom-Connect. Nous éditons des solutions web de gestionnaire d'agenda et de prise de rendez-vous.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/recommandation-le-defi.php&amp;ref=prez-recommandation-le-defi&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
