...
<title>Paris Web - Petit florilège de bonnes pratiques graphiques</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/gestion-personnelle-dinformation-outils-et-methodologie-pour-survivre-au-deluge-dinformations.php" title="Gestion personnelle d'information: outils et méthodologie pour survivre au déluge ... d'informations" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/le-projet-web-dont-vous-etes-le-heros-agile.php" title="Le projet web dont vous êtes le héros agile" />
	...
	<meta name="twitter:title" content="Petit florilège de bonnes pratiques graphiques" />
	<meta property="twitter:description" content="Quels principes adopter en phase de création graphique pour préserver l’ergonomie et l’accessibilité de l’interface web ? Lisibilité typographique, contrastes, couleurs, signalétique des hyperliens,…" />
	<meta property="dc:title" content="Petit florilège de bonnes pratiques graphiques" />
	<meta property="og:title" content="Petit florilège de bonnes pratiques graphiques" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/petit-florilege-de-bonnes-pratiques-graphiques.php" />
	<meta property="og:description" content="Quels principes adopter en phase de création graphique pour préserver l’ergonomie et l’accessibilité de l’interface web ? Lisibilité typographique, contrastes, couleurs, signalétique des hyperliens,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Petit florilège de bonnes pratiques graphiques</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-798">
						<header>
							<h1>Petit florilège de bonnes pratiques graphiques</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/crea11y-parisweb2012-130120135404-phpapp02" 
	width="598" height="498" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" 
	 allowfullscreen> 
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/florilege-bonnes-pratiques.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-798">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/petit-florilege-de-bonnes-pratiques-graphiques.php" class="url">Petit florilège de bonnes pratiques graphiques</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2012/recherche/typographie" rel="tag">typographie</a><br /><a href="http://www.paris-web.fr/2012/recherche/webdesign" rel="tag">webdesign</a></dd>
    ...
    <div class="talk-description"><p>Quels principes adopter en phase de création graphique pour préserver l’ergonomie et l’accessibilité de l’interface web ? Lisibilité typographique, contrastes, couleurs, signalétique des hyperliens, utilisabilité des formulaires, messages d’erreur etc. Quels exemples suivre ?</p>

<p>Cet atelier permettra d'échanger des exemples concrets, c’est-à-dire visuels, d’application des critères de référence (Opquast, AccessiWeb), afin de fournir des repères et pistes d’exploration aux infographistes et directeurs artistiques, en guise de charte graphique, ergonomique et accessible. Comme un B-A-ba du graphisme web.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/romy-duhem-verdiere.php">Romy Duhem Verdière</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Romy Duhem Verdière" src="https://www.paris-web.fr/2012/assets_c/2012/09/romy-thumb-143x143-259.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Soucieuse de qualité, de sémantique et d'accessibilité, d'abord intégratrice indépendante, aujourd'hui consultante web UX pour Alter Way, Romy documente et partage ses réflexions sur son blog depuis 1999.</p></div>
</div>
