...
<title>Paris Web - L'audiodescription pour sauver l'humanité</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/les-user-agents-cest-le-mal.php" title="Les User Agents, c'est le mal !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/creative-technologist-web-evangelist-developer-advocate.php" title="Creative Technologist, Web Evangelist, Developer Advocate !?!" />
	...
	<meta name="twitter:title" content="L'audiodescription pour sauver l'humanité" />
	<meta property="twitter:description" content="La fin du monde approche. Alors qu'une guerre informatique mondiale se joue en secret, un virus a été mis au point pour empêcher la diffusion des images sur le web, notamment dans les vidéos. La…" />
	<meta property="dc:title" content="L'audiodescription pour sauver l'humanité" />
	<meta property="og:title" content="L'audiodescription pour sauver l'humanité" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/laudiodescription-pour-sauver-lhumanite.php" />
	<meta property="og:description" content="La fin du monde approche. Alors qu'une guerre informatique mondiale se joue en secret, un virus a été mis au point pour empêcher la diffusion des images sur le web, notamment dans les vidéos. La…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>L'audiodescription pour sauver l'humanité</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-675">
						<header>
							<h1>L'audiodescription pour sauver l'humanité</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xwglz1?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/2012-10-18-Armony_audiodesc_diaporama.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-675">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/laudiodescription-pour-sauver-lhumanite.php" class="url">L'audiodescription pour sauver l'humanité</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/accessibilite" rel="tag">accessibilité</a></dd>
    ...
    <div class="talk-description"><p>La fin du monde approche. Alors qu'une guerre informatique mondiale se joue en secret, un virus a été mis au point pour empêcher la diffusion des images sur le web, notamment dans les vidéos. </p>

<p>La solution ? L'audiodescription. </p>

<p><strong>Démo en direct.</strong><br />
À refaire chez soi.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/armony-altinier.php">Armony Altinier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Armony Altinier" src="https://www.paris-web.fr/2012/assets_c/2012/08/armony-altinier-thumb-143x143-194.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Armony Altinier est directrice de la société ACS Horizons, spécialisée dans la création de sites web libres et accessibles. Consultante en accessibilité du Web, formatrice et intégratrice, elle est également engagée dans le monde associatif pour promouvoir accessibilité, logiciels libres et diversité.<br />
</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/laudiodescription-pour-sauver-lhumanite.php&amp;ref=prez-laudiodescription-pour-sauver-lhumanite&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
