...
<title>Paris Web - Gestion personnelle d'information: outils et méthodologie pour survivre au déluge ... d'informations</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/clinique-des-navigateurs.php" title="Clinique des navigateurs" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/petit-florilege-de-bonnes-pratiques-graphiques.php" title="Petit florilège de bonnes pratiques graphiques" />
	...
	<meta name="twitter:title" content="Gestion personnelle d'information: outils et méthodologie pour…" />
	<meta property="twitter:description" content="Comment avoir la bonne information sous la bonne forme, au bon endroit, au bon moment ? Une organisation de l'information personnelle (emails, notes, documents, veille, temps, tâches) bien pensée…" />
	<meta property="dc:title" content="Gestion personnelle d'information: outils et méthodologie pour survivre au déluge ... d'informations" />
	<meta property="og:title" content="Gestion personnelle d'information: outils et méthodologie pour survivre au déluge ... d'informations" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/gestion-personnelle-dinformation-outils-et-methodologie-pour-survivre-au-deluge-dinformations.php" />
	<meta property="og:description" content="Comment avoir la bonne information sous la bonne forme, au bon endroit, au bon moment ? Une organisation de l'information personnelle (emails, notes, documents, veille, temps, tâches) bien pensée…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Gestion personnelle d'information: outils et méthodologie pour survivre au déluge ... d'informations</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-797">
						<header>
							<h1>Gestion personnelle d'information: outils et méthodologie pour survivre au déluge ... d'informations</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-797">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/gestion-personnelle-dinformation-outils-et-methodologie-pour-survivre-au-deluge-dinformations.php" class="url">Gestion personnelle d'information: outils et méthodologie pour survivre au déluge ... d'informations</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2012/ateliers/">Atelier</a></dd>
...
<dd class="column">
<a href="/2012/20.php">samedi 20</a>
</dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/documentation" rel="tag">documentation</a><br /><a href="http://www.paris-web.fr/2012/recherche/gestion-du-temps" rel="tag">gestion du temps</a><br /><a href="http://www.paris-web.fr/2012/recherche/methodologie" rel="tag">méthodologie</a><br /><a href="http://www.paris-web.fr/2012/recherche/veille" rel="tag">veille</a></dd>
    ...
    <div class="talk-description"><p>Comment avoir la bonne information sous la bonne forme, au bon endroit, au bon moment ?</p>

<p>Une <strong>organisation de l'information personnelle</strong> (emails, notes, documents, veille, temps, tâches) bien pensée réduit le stress, améliore l'accès à l'information aussi bien que les processus cognitifs de mémorisation et d'élaboration de la pensée dont dépend notre travail. </p>

<p>En explicitant clairement les "entrées" et les "sorties", une bonne organisation personnelle de l'information permet également de <strong>mieux articuler son travail</strong> avec celui de ses collègues et partenaires et profite ainsi au travail collaboratif.<br />
Cet atelier s'adresse aux aux « travailleurs de l’information » (chefs de projet, managers, designers, développeurs, graphistes etc.) souhaitant échanger sur ce sujet.</p>

<p>Véronique présentera les <strong>enjeux de la gestion personnelle de l'information</strong> ainsi que des éléments de méthodologie. Elle précisera les apports spécifiques des outils numériques, en identifiant différentes fonctions (ce que je veux faire) et fonctionnalités (comment un outil me permet concrètement de le faire).
<br/>
...
<ul><li><b>vos coups de coeur</b>: cas pratiques d’utilisation d'un outil: pourquoi je l'utilise, quelles sont ses fonctionnalités intéressantes
</li>
<li><b>vos coups de blues</b>: description d'un problème de gestion d'infos personnelles (description des contraintes et du contexte - métier, environnement technique, etc. - et du problème lui-même).<br/>
...
<li><b>vos coups de génie</b>: description d'une solution de gestion d'info (description des contraintes, du contexte métier, du problème et de la solution)</li>

<p>
Consultez le support de présentation sur le billet <a href="http://www.e-tissage.net/gestion-personnelle-dinformation-quelques-enjeux-outils-et-reperes-methodologiques/">Gestion personnelle d’information:
quelques enjeux, outils et repères méthodologiques</a>.
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/veronique-gendner.php">Véronique Gendner</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Véronique Gendner" src="https://www.paris-web.fr/2012/assets_c/2012/08/veroniquegendner-thumb-143x143-252.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après des études de langues (anglais, mandarin) et un cursus de Linguistique Informatique (TAL) à Paris VII, Véronique Gendner a travaillé au LIMSI, CNRS où elle a réalisé des recherches sur l’utilisation des catégories morphosyntaxiques dans un système de reconnaissance automatique de la parole. Elle a enseigné à l’université, en DESS et pour la formation permanente (linguistique du français, algorithmique, structures de données, analyse de données textuelle et utilisation d’Excel).</p>

<p>Depuis 2007 elle réalise différentes missions de <strong>production de documents</strong> et de <strong>design d’information de documents et de flux</strong> ainsi qu'une recherche personnelle sur le design d'information et la gestion des informations personnelles avec les outils numériques.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/gestion-personnelle-dinformation-outils-et-methodologie-pour-survivre-au-deluge-dinformations.php&amp;ref=prez-gestion-personnelle-dinformation-outils-et-me&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
