...
<title>Paris Web - Le projet web dont vous êtes le héros agile</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/petit-florilege-de-bonnes-pratiques-graphiques.php" title="Petit florilège de bonnes pratiques graphiques" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/le-processus-creatif-du-brief-au-prototype.php" title="Le processus créatif du brief au prototype" />
	...
	<meta name="twitter:title" content="Le projet web dont vous êtes le héros agile" />
	<meta property="twitter:description" content=" Vous êtes une équipe de développement en charge d’un projet web. Si vous voulez connaître votre mission, allez en 2. Si vous voulez savoir comment va se dérouler l’atelier, allez en 3. Vous allez…" />
	<meta property="dc:title" content="Le projet web dont vous êtes le héros agile" />
	<meta property="og:title" content="Le projet web dont vous êtes le héros agile" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/le-projet-web-dont-vous-etes-le-heros-agile.php" />
	<meta property="og:description" content=" Vous êtes une équipe de développement en charge d’un projet web. Si vous voulez connaître votre mission, allez en 2. Si vous voulez savoir comment va se dérouler l’atelier, allez en 3. Vous allez…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le projet web dont vous êtes le héros agile</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-800">
						<header>
							<h1>Le projet web dont vous êtes le héros agile</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-800">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/le-projet-web-dont-vous-etes-le-heros-agile.php" class="url">Le projet web dont vous êtes le héros agile</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/agilite" rel="tag">agilité</a></dd>
...
Vous êtes une équipe de développement en charge d’un projet web. Si vous voulez connaître votre mission, allez en 2. Si vous voulez savoir comment va se dérouler l’atelier, allez en 3.
</p>
<p>
Vous allez être plongés dans l’aventure de la conception et la réalisation d’un projet web. Si vous avez hâte d’en découdre, allez en 4. Si vous avez trop peur, allez en 5.
</p>
<p>
L’atelier se présente sous la forme d’un jeu de rôle dont les participants seront les héros. Dans la grande veine des “livres dont vous êtes le héros”, les joueurs auront à faire des choix pertinents pour relever des défis agiles et terminer l’aventure. Allez en 2 pour connaître votre mission.
</p>
<p>
Soyez les bienvenus dans cette aventure ! Prenez votre courage et votre épée… heu… vos outils (papier, crayon, micro-ordinateur, éditeur de texte, tablette graphique, cerveau) et rejoignez-nous pour cet atelier ludique, agile et résolument web.
</p>
<p>
Paralysés par la peur de l’échec, vous manquez de communication claire, de répartie, les spécifications vous étouffent, vous ne rendez pas le projet à temps, le client est insatisfait, votre équipe démissionne, votre réputation empire… votre société dépose le bilan. Vous voulez recommencer ?
</p>
<p>
<a href="http://vousetesleheros.alwaysdata.net/">http://vousetesleheros.alwaysdata.net/</a>
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/bruno-bord.php">Bruno Bord</a> et <a href="https://www.paris-web.fr/2012/../orateurs/pablo-pernot.php">Pablo Pernot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Bruno Bord" src="https://www.paris-web.fr/2012/assets_c/2012/09/brunobord-thumb-143x143-256.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Bruno & Pablo a.k.a <a href="http://fr.wikipedia.org/wiki/Starsky_et_Hutch">Starsky & Hutch</a>.</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Pablo Pernot" src="https://www.paris-web.fr/2012/assets_c/2012/08/pablo-pernot-thumb-143x143-239.jpg" width="143" height="143">
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/le-projet-web-dont-vous-etes-le-heros-agile.php&amp;ref=prez-le-projet-web-dont-vous-etes-le-heros-agile&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
