...
<title>Paris Web - Scrum vu des petites tranchées</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/faire-du-web-moderne-a-destination-de-tous.php" title="Faire du web moderne à destination de tous" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/pause-2.php" title="Pause" />
	...
	<meta name="twitter:title" content="Scrum vu des petites tranchées" />
	<meta property="twitter:description" content="Mélange d'un retour d’expérience, sur 3 années d’activités, pour mettre en place scrum au sein de petites équipes, et proposition concrète pour une mise en application de scrum à petite échelle.…" />
	<meta property="dc:title" content="Scrum vu des petites tranchées" />
	<meta property="og:title" content="Scrum vu des petites tranchées" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/scrum-vue-des-petites-tranchees.php" />
	<meta property="og:description" content="Mélange d'un retour d’expérience, sur 3 années d’activités, pour mettre en place scrum au sein de petites équipes, et proposition concrète pour une mise en application de scrum à petite échelle.…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Scrum vu des petites tranchées</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-703">
						<header>
							<h1>Scrum vu des petites tranchées</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-703">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/scrum-vue-des-petites-tranchees.php" class="url">Scrum vu des petites tranchées</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/agilite" rel="tag">agilité</a><br /><a href="http://www.paris-web.fr/2012/recherche/scrum" rel="tag">scrum</a></dd>
    ...
    <div class="talk-description"><p>Mélange d'un retour d’expérience, sur 3 années d’activités, pour <strong>mettre en place <a href="https://fr.wikipedia.org/wiki/Scrum_(méthode)">scrum</a> au sein de petites équipes</strong>, et proposition concrète pour une mise en application de scrum à petite échelle.</p>

<p>Jusqu'au 18 octobre et pendant le déroulement de la conférence, le site <a href="http://prswb.fr/">prswb.fr</a> sera ouvert au public afin d'échanger, contribuer et collaborer avec l'équipe à l'élaboration d'un produit.</p>

<p>Démarrage de la conférence par un plongeon dans le sprint zéro. L'occasion de définir la vision du projet et se préparer aux futurs sprints : rédaction du document vision, élaboration du backlog de produit, conception des personas, planification de la release, capture des users stories.<br />
Nous partirons ensuite et ensemble, sur la réalisation du sprint 1 pour élaborer le produit.</p>

<p>Au programme : planification de sprint, développement, daily scrum, démo et rétrospective.</p>

<p><strong>Particularités</strong> :</p>

<ul>
	<li>Le graphiste et l'intégrateur font partie de l’équipe et participent de facto aux estimations.</li>
	<li>La DA et l'architecture apparaissent au fil du projet.</li>
	<li>Les outils utilisés sont triviaux : Trello, gDoc (ou autre), Github.</li>
	<li>La documentation est très légère et maintenable.</li>
	<li>Le budget peut-être fermé, le curseur de réglage reste l'ajustement fonctionnel.</li>
	<li>En amont et pendant la présentation, les clients (l’assistance) peuvent participer à l’élaboration du backlog de sprint et backlog de produit.</li>
	<li>Les questions projets sont posées pendant la conférence.</li>
</ul>

<p>Pour participer activement à cette conférence : <a href="http://prswb.fr/">prswb.fr</a> - <a href="https://twitter.com/prswb">@prswb</a>.</p>

<p>Cette conférence vous est proposée grâce à la collaboration de Vincent Agnano <a href="https://twitter.com/vinyll">@vinyll</a>, Nicolas Perriault <a href="https://twitter.com/n1k0">@n1k0</a>, Erick Gardin <a href="https://twitter.com/newick">@newick</a>, Benito, Stéphane Langlois <a href="https://twitter.com/langlois_s">@langlois_s</a> et Amanda Martinez <a href="https://twitter.com/MartinezAmandaa">@MartinezAmandaa</a>.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/stephane-langlois.php">Stéphane Langlois</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Langlois" src="https://www.paris-web.fr/2012/assets_c/2012/09/stephane_Langlois_143-thumb-143x143-264.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Réveillé en 1996 par la sonnerie stridente d'un modem.</p>

<p>J'ai, aujourd'hui, malgré quelques phases anormales de sommeil paradoxal, sombré à jamais dans l'Insomnie Hyperactive Orientée Full Web - IHOFW.</p>

<p>De 1996 à 2004, j'ai piloté Krashtest, authentique laboratoire de création numérique. Après un cycle en V appliqué sur un projet titanesque, nous avons scratché 8 années de collaboration en prenant de plein fouet un mur prémonitoire.</p>

<p>Après une année de mise en grotte, j'ai médité sur cet échec et découvert les frameworks, l'ingénierie logiciel avec eXtrem Programming et le pilotage par méthodologies légères avec Scrum, Lean et Kanban.</p>

<p>Ma composition actuelle : 60% facilitateur de projets web, 15% formateur, 10% coding et 25% de recherche et formation.</p>

<p>Comme vous pouvez le constater, c'est, pour vous, l'occasion unique de rencontrer un authentique traumatisé, éternellement plongé dans une profonde thérapie Agile.</p></div>
</div>
