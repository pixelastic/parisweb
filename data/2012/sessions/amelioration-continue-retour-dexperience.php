...
<title>Paris Web - Amélioration continue : retour d’expérience</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/les-icones-qui-sont-elles-quels-sont-leurs-pictos.php" title="Les icônes, qui sont-elles ? Quels sont leurs pictos ?  " />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/le-jeu-en-vie.php" title="Le jeu en vie" />
	...
	<meta name="twitter:title" content="Amélioration continue : retour d’expérience" />
	<meta property="twitter:description" content="En 10 ans la topologie des projets web a radicalement changé. L’avènement du web 2.0 et des RIA a permis de bousculer la conception des sites en améliorant l’expérience utilisateur. En 2012 une…" />
	<meta property="dc:title" content="Amélioration continue : retour d’expérience" />
	<meta property="og:title" content="Amélioration continue : retour d’expérience" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/amelioration-continue-retour-dexperience.php" />
	<meta property="og:description" content="En 10 ans la topologie des projets web a radicalement changé. L’avènement du web 2.0 et des RIA a permis de bousculer la conception des sites en améliorant l’expérience utilisateur. En 2012 une…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Amélioration continue : retour d’expérience</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-702">
						<header>
							<h1>Amélioration continue : retour d’expérience</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xvdwv4?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/cyril-balit.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-702">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/amelioration-continue-retour-dexperience.php" class="url">Amélioration continue : retour d’expérience</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/methodologie" rel="tag">méthodologie</a><br /><a href="http://www.paris-web.fr/2012/recherche/qualite" rel="tag">qualité</a><br /><a href="http://www.paris-web.fr/2012/recherche/testing" rel="tag">testing</a></dd>
    ...
    <div class="talk-description"><p>En 10 ans la topologie des projets web a radicalement changé. L’avènement du web 2.0 et des RIA a permis de bousculer la conception des sites en améliorant l’expérience utilisateur. En 2012 une nouvelle révolution est en cours : ce changement dépasse la notion d’ergonomie avec l’explosion des environnements techniques et des supports proposés.  </p>

<p>Le développeur web doit se poser sur des concepts jusque là réservés au développeur back (Framework MVC, Design pattern, industrialisation, intégration continue) tout en réfléchissant à de nouvelles problématiques (performances, responsive design…).</p>

<p>Lors de cette conférence, Cyril Balit nous présentera les différentes pistes mises en place dans une équipe front-end pour accompagner cette transition.</p>

<p>En effet, de l’automatisation aux best practices en passant par des check-lists, tout au long de ce processus Cyril et son équipe ont essayé de répondre aux questions suivantes :</p>

<ul>
<li><strong>Comment pérenniser les développements ?</strong></li>
<li><strong>Comment améliorer la  non régression au fil des évolutions ?</strong></li>
<li><strong>Comment optimiser les performances d’un site ?</strong></li>
</ul>

<p>Au final, cette conférence parle d’<strong>une équipe front qui adapte ses processus pour appréhender au mieux cette révolution</strong>.<br />
</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/cyril-balit.php">Cyril Balit</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Cyril Balit" src="https://www.paris-web.fr/2012/assets_c/2012/08/Cyril%20Balit-thumb-143x143-198.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Cyril Balit est architecte RIA dans la société <a href="http://www.ekino.com/">Ekino</a>.</p>

<p>Après un parcours atypique de biologie, du Cobol, du VB et du Java, Cyril découvre le développement web au début des années 2000 en créant le projet open source <a href="http://www.improve-foundations.org/factory/projects/rialto/wiki">Rialto</a>. Il s’intéresse par la suite au développement Flex et mobile.</p>

<p>Actuellement Cyril encadre une équipe de développeurs front orientée web, Flex/Flash et mobile.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/amelioration-continue-retour-dexperience.php&amp;ref=prez-amelioration-continue-retour-dexperience&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
