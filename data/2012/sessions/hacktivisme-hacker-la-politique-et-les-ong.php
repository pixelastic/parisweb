...
<title>Paris Web - Hacktivisme : hacker la politique et les ONG</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/dejeuner.php" title="Déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/applications-mobiles-utiliser-le-web.php" title="Applications mobiles : utiliser le web" />
	...
	<meta name="twitter:title" content="Hacktivisme : hacker la politique et les ONG" />
	<meta property="twitter:description" content="Les hackers sont au cœur de son ADN autant que la décentralisation et l'horizontalité d'Internet est au centre de l'éthique hacker. L'hacktivisme est né en même temps que le réseau téléphonique…" />
	<meta property="dc:title" content="Hacktivisme : hacker la politique et les ONG" />
	<meta property="og:title" content="Hacktivisme : hacker la politique et les ONG" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/hacktivisme-hacker-la-politique-et-les-ong.php" />
	<meta property="og:description" content="Les hackers sont au cœur de son ADN autant que la décentralisation et l'horizontalité d'Internet est au centre de l'éthique hacker. L'hacktivisme est né en même temps que le réseau téléphonique…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Hacktivisme : hacker la politique et les ONG</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-683">
						<header>
							<h1>Hacktivisme : hacker la politique et les ONG</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/Paris-Web-Hacktivistes-ONG.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-683">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/hacktivisme-hacker-la-politique-et-les-ong.php" class="url">Hacktivisme : hacker la politique et les ONG</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/hacktivisme" rel="tag">hacktivisme</a><br /><a href="http://www.paris-web.fr/2012/recherche/politique" rel="tag">politique</a><br /><a href="http://www.paris-web.fr/2012/recherche/societe" rel="tag">société</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Les hackers sont au cœur de son ADN autant que la décentralisation et l'horizontalité d'Internet est au centre de l'éthique hacker. </p>

<p><strong>L'hacktivisme</strong> est né en même temps que le réseau téléphonique (phreaking) et qu'Internet mais il a considérablement évolué ces dix dernières années avec l'émergence et le développement d'Anonymous, de Wikileaks, de Télécomix, des fablab et autres hackerspaces…</p>

<p><strong>La cyberculture</strong> est toujours aussi empreinte de contre culture. Aujourd'hui, elle existe de manière massive, partout dans le monde, s'est démocratisée et prend une part grandissante en politique <sup><a href="#note1">1</a></sup> mais également dans le champ des ONG puisque : RSF, la FIDH, Greenpeace, Amnesty International, <span lang="en">Human Rights Watch</span>, MSF collaborent avec des hackers ou utilisent l'hacktivisme comme un mode de plaidoyer.</p>

<p>En tant qu'auteur de « <a href="http://www.fypeditions.com/anonymous-pirates-ou-altermondialistes-numeriques-peuvent-ils-changer-le-monde/">Anonymous. Peuvent ils changer le monde ?</a> »<sup><a href="#note2">2</a></sup> (FYP Editions) et que co-fondateur de l'Agence LIMITE spécialisée dans les ONG, je suis un fin connaisseur de la cyberculture et de l'<strong>évolution des rapports de force</strong> entre hackers, politiques, société civile et ONG.</p>

<ol>
<li><span id="note1">1. Parti Pirate en Suède et en Allemagne.</span></li>
<li><span id="note2">2. nous avions publié à la sortie du livre une <a href="http://obsession.nouvelobs.com/hacker-ouvert/20111124.OBS5268/infographie-les-anonymous-de-1940-a-demain.html">infographie</a> sur l'évolution de l'hacktivisme depuis 1940.</span></li>
</ol></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/frederic-bardeau.php">Frédéric Bardeau</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Frédéric Bardeau" src="https://www.paris-web.fr/2012/assets_c/2012/08/frederic-bardeau-2-thumb-143x143-203.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Formé en agence corporate, entrepreneur du web, freelance, formateur et cofondateur d'une agence conseil, Frédéric Bardeau est le co-fondateur de l'Agence LIMITE, pur player entièrement spécialisé en communication responsable ( <a href="http://agence-limite.fr/blog">http://agence-limite.fr/blog</a> ). Il mène également une carrière d'intervenant/conférencier et de consultant indépendant en stratégie digitale.</p>

<p>Il a publié avec Nicolas Danet en novembre 2011 « <a href="http://www.fypeditions.com/anonymous-pirates-ou-altermondialistes-numeriques-peuvent-ils-changer-le-monde/">Anonymous. Peuvent ils changer le monde ?</a> » (FYP Editions).</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/hacktivisme-hacker-la-politique-et-les-ong.php&amp;ref=prez-hacktivisme-hacker-la-politique-et-les-ong&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
