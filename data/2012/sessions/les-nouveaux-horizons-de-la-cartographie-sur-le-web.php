...
<title>Paris Web - Les nouveaux horizons de la cartographie sur le web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/responsive-web-design-clever-tricks-and-techniques.php" title="Responsive Web Design: Clever Tricks and Techniques" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/les-user-agents-cest-le-mal.php" title="Les User Agents, c'est le mal !" />
	...
	<meta name="twitter:title" content="Les nouveaux horizons de la cartographie sur le web" />
	<meta property="twitter:description" content="Les API cartographiques pour le web ont fait des cartes interactives et de la géographie en général un élément banal de l'expérience de navigation. Google Maps en est le standard de facto, rarement…" />
	<meta property="dc:title" content="Les nouveaux horizons de la cartographie sur le web" />
	<meta property="og:title" content="Les nouveaux horizons de la cartographie sur le web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/les-nouveaux-horizons-de-la-cartographie-sur-le-web.php" />
	<meta property="og:description" content="Les API cartographiques pour le web ont fait des cartes interactives et de la géographie en général un élément banal de l'expérience de navigation. Google Maps en est le standard de facto, rarement…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les nouveaux horizons de la cartographie sur le web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-696">
						<header>
							<h1>Les nouveaux horizons de la cartographie sur le web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xung4y?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/nouveaux_horizons_cartographie-BenjaminBecquet.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-696">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/les-nouveaux-horizons-de-la-cartographie-sur-le-web.php" class="url">Les nouveaux horizons de la cartographie sur le web</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/cartographie" rel="tag">cartographie</a><br /><a href="http://www.paris-web.fr/2012/recherche/web-api" rel="tag">web API</a><br /><a href="http://www.paris-web.fr/2012/recherche/web-apps" rel="tag">web apps</a></dd>
    ...
    <div class="talk-description"><p>Les API cartographiques pour le web ont fait des cartes interactives et de la géographie en général un élément banal de l'expérience de navigation.</p>

<p>Google Maps en est le standard de facto, rarement remis en cause. Du moins jusqu'au début de cette année, où la nouvelle politique tarifaire adoptée par Google a poussé de plus en plus d'acteurs à regarder dans d'autres directions.</p>

<p>L'occasion de découvrir, au delà de l'aspect économique, de réelles opportunités de se libérer de cette hégémonie et de son uniformité imposée. Le domaine est même en pleine ébullition, notamment autour d'OpenStreetMap et de nombreux projets opensource.</p>

<p>Benjamin Becquet nous propose un état des lieux de ces outils, et de la façon dont ils peuvent s'intégrer dans des projets web modernes.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/benjamin-becquet.php">Benjamin Becquet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Benjamin Becquet" src="https://www.paris-web.fr/2012/assets_c/2012/08/photo_Benjamin_Becquet-thumb-143x143-240.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Benjamin Becquet a attrapé le goût du mélange informatique/géographie lors de ses études d'ingénieur.</p>

<p>Après être passé deux ans par une case SSII peu enthousiasmante, il a pu à nouveau cultiver cet intérêt chez Mediamobile, société qui développe des services d'information trafic et d'aide à la mobilité routière. </p>

<p>Depuis 2006, il est responsable de la R&D en calcul d'itinéraires. Sa deuxième « casquette » est celle de développeur web, principalement sur des applications dynamiques organisées autour des API cartographiques.</p>

<p>En dehors de son travail, il touche aussi à ce domaine, en développant des bibliothèques pour ces outils, et il profite de son goût pour le vélo et la marche pour contribuer activement à OpenStreetMap.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/les-nouveaux-horizons-de-la-cartographie-sur-le-web.php&amp;ref=prez-les-nouveaux-horizons-de-la-cartographie-sur-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
