...
<title>Paris Web - Fast Mobile UIs</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/2012-lannee-ou-le-web-est-devenu-un-ouvre-boite-universel.php" title="2012, l'année où le web est devenu un ouvre-boite universel" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/pause-3.php" title="Pause" />
	...
	<meta name="twitter:title" content="Fast Mobile UIs" />
	<meta property="twitter:description" content=" I will show you how to use the new features in HTML5 to create mobile games and the hoops you have to jump through to build a sleek and responsive user interface while trying to avoid most of the..." />
	<meta property="dc:title" content="Fast Mobile UIs" />
	<meta property="og:title" content="Fast Mobile UIs" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/fast-mobile-uis.php" />
	<meta property="og:description" content=" I will show you how to use the new features in HTML5 to create mobile games and the hoops you have to jump through to build a sleek and responsive user interface while trying to avoid most of the..." />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Fast Mobile UIs</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-689">
						<header>
							<h1>Fast Mobile UIs</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xwfj9o?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/horia-fast-mobile-uis-ParisWeb.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-689">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/fast-mobile-uis.php" class="url">Fast Mobile UIs</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/mobile" rel="tag">mobile</a></dd>
...
<p>I will show you how to use the new features in HTML5 to create <strong>mobile games</strong> and the hoops you have to jump through to build a sleek and responsive user interface while trying to avoid most of the headaches that come with the job when you are always an edge case.</p>
</div>
<div lang="fr" class="span-6 last">
<p>Je vous montrerai comment utiliser les nouvelles fonctionnalités de HTML5 pour créer des <strong>jeux sur mobile</strong>, et les obstacles à franchir pour obtenir une interface utilisateur léchée et réactive, tout en essayant d’éviter la plupart des maux de tête qui accompagnent généralement ce type de travail puisqu’on est toujours en train de gérer un cas inhabituel.</p>
</div>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/horia-dragomir.php">Horia Dragomir</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Horia Dragomir" src="https://www.paris-web.fr/2012/assets_c/2012/08/HoriaDragomir-thumb-143x143-207.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en" class="span-6">
<p>Horia Dragomir is a UI Developer, Hungry and Foolish - currently working at wooga in Berlin, where he focuses on developing HTML5 Mobile games.</p>
</div>
<div lang="fr" class="span-6 last">
<p>Horia Dragomir est développeur d’interface utilisateur, avide et un brin déjanté — il travaille actuellement chez wooga à Berlin, où il se concentre sur le développement de jeux HTML5 pour mobile.</p>
</div></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/fast-mobile-uis.php&amp;ref=prez-fast-mobile-uis&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
