...
<title>Paris Web - Ami freelance, tu aurais besoin d'un petit recadrage</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/ateliers/1001-techniques-pour-faire-exploser-un-projet-web-et-comment-les-eviter.php" title="1001 techniques pour faire exploser un projet web (et comment les éviter)" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/ateliers/envie-dun-referentiel-creons-le-la-maintenant.php" title="Envie d'un référentiel ? Créons-le ! Là, maintenant :)" />
	...
	<meta name="twitter:title" content="Ami freelance, tu aurais besoin d'un petit recadrage" />
	<meta property="twitter:description" content="Le point de vue d'un individu dans une situation donnée, va fortement influencer sa manière de réagir, même inconsciemment. Par conséquent, dans le milieu des freelances beaucoup d'idées sont…" />
	<meta property="dc:title" content="Ami freelance, tu aurais besoin d'un petit recadrage" />
	<meta property="og:title" content="Ami freelance, tu aurais besoin d'un petit recadrage" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/ateliers/ami-freelance-tu-aurais-besoin-dun-petit-recadrage.php" />
	<meta property="og:description" content="Le point de vue d'un individu dans une situation donnée, va fortement influencer sa manière de réagir, même inconsciemment. Par conséquent, dans le milieu des freelances beaucoup d'idées sont…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Ami freelance, tu aurais besoin d'un petit recadrage</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-793">
						<header>
							<h1>Ami freelance, tu aurais besoin d'un petit recadrage</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-793">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/ateliers/ami-freelance-tu-aurais-besoin-dun-petit-recadrage.php" class="url">Ami freelance, tu aurais besoin d'un petit recadrage</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/freelance" rel="tag">freelance</a><br /><a href="http://www.paris-web.fr/2012/recherche/gestion-de-projet" rel="tag">gestion de projet</a></dd>
    ...
    <div class="talk-description"><p><cite>"Le point de vue d'un individu dans une situation donnée, va fortement influencer sa manière de réagir, même inconsciemment"</cite>. Par conséquent, dans le milieu des freelances beaucoup d'idées sont répandues à torts : </p>
<ul><li><cite>"Mon client est mon supérieur hiérarchique"</cite> ;</li>
<li><cite>"Si je baisse mes tarifs, mon client sera content"</cite> ;</li>
<li><cite>"Il est normal de bosser jusque tard le soir"</cite> ;</li>
<li><cite>"Être freelance, c'est risqué !"</cite> ;</li>
<li><cite>"Je ne saurai jamais le faire"</cite> ;</li>
<li>etc.</li>
</ul>
<p>Un recadrage s'impose !</p>
<p>Après avoir passé en revue certaines de ces idées, Thibault expliquera pourquoi il les juge invalides voir nocives.</p>
<p>Cette atelier s'adresse tout d'abord à des freelances, mais pas uniquement.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/thibault-jouannic.php">Thibault Jouannic</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Thibault Jouannic" src="https://www.paris-web.fr/2012/assets_c/2012/08/thibaultjouannic-thumb-143x143-244.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Freelance, mégalomane (mais un peu moins chaque jour), développeur passionné et pratiquant féru d’Aïkido.</p>

<p>Après (et un peu pendant) des études d’informatiques, il commence sa carrière dans la VoIP, avant de revenir au web, et travaille deux ans dans la TMA (tierce maintenance applicative).</p>

<p>De son emploi de « débuggeur pompier professionnel », il garde une aversion viscérale pour le travail bâclé, le code sale, l’absence de bonnes pratiques et la gestion de projet à l’arrache.</p>

<p>Indépendant depuis trois ans, il aime se considérer comme un artisan, passionné par son métier, motivé par la satisfaction de ses clients et par l’amour du travail bien fait.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/ateliers/ami-freelance-tu-aurais-besoin-dun-petit-recadrage.php&amp;ref=prez-ami-freelance-tu-aurais-besoin-dun-petit-reca&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
