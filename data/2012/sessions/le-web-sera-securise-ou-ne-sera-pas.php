...
<title>Paris Web - Le web sera sécurisé ou ne sera pas</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/pause-2.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/influence-du-bauhaus-dans-le-digital-par-lexemple.php" title="Influence du Bauhaus dans le digital par l’exemple" />
	...
	<meta name="twitter:title" content="Le web sera sécurisé ou ne sera pas" />
	<meta property="twitter:description" content="Un nouveau web. Un web qui hébergerait tous les services de la vie courante par le biais de webapps. Ceux qui sont devenus incontournables pour faire de nous des humains complets et intégrés dans la…" />
	<meta property="dc:title" content="Le web sera sécurisé ou ne sera pas" />
	<meta property="og:title" content="Le web sera sécurisé ou ne sera pas" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/le-web-sera-securise-ou-ne-sera-pas.php" />
	<meta property="og:description" content="Un nouveau web. Un web qui hébergerait tous les services de la vie courante par le biais de webapps. Ceux qui sont devenus incontournables pour faire de nous des humains complets et intégrés dans la…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le web sera sécurisé ou ne sera pas</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-671">
						<header>
							<h1>Le web sera sécurisé ou ne sera pas</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xw0mit?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2012/Paris_Web_VGALINDO_gemalto.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-671">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/le-web-sera-securise-ou-ne-sera-pas.php" class="url">Le web sera sécurisé ou ne sera pas</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/securite" rel="tag">sécurité</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Un nouveau web. Un web qui hébergerait tous les services de la vie courante par le biais de webapps. Ceux qui sont devenus incontournables pour faire de nous des humains complets et intégrés dans la cité. Regarder la dernière saison d’une série décalée. Payer nos courses d'un clic. Déclarer nos revenus. Sur n’importe quelle plateforme, n’importe quel périphérique…</p>

<p>Le challenge est de taille. Le fossé qui nous sépare de cette réalité est grand. Aucun banquier, diffuseur de contenu HD ou gouvernement n’investira dans le format des webapps tant que ce support n’améliorera pas son modèle sécuritaire. Cette sécurité doit leur garantir le même niveau de sérénité que celui offert par les applications natives. </p>

<p>Cette présentation a pour vocation de sensibiliser les web développeurs aux exigences sécuritaires de  ces industries chatouilleuses. Ces exigences reposent sur des principes simples tels que : l’open web platform ne doit pas permettre de voler les identifiants de clients, de contrefaire une transaction bancaire, de distribuer sans contrôle une œuvre artistique protégée, ou d’affaiblir l’accès sécurisé aux services publics. Seront également développés dans cette présentation, l’état de l’art de la sécurité dans les webapps, ainsi que les perspectives ouvertes par les récentes initiatives du W3C en matière d'API et de sécurité.</p></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/virginie-galindo.php">Virginie Galindo</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Virginie Galindo" src="https://www.paris-web.fr/2012/assets_c/2012/09/vgalindo-thumb-143x143-260.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Virginie est employée depuis plus de 10 ans par gemalto, un fournisseur de solutions numériques sécurisées. Au sein du département Technologie & Innovation, elle soutient les activités de standardisation relatives aux mobile. Depuis début 2012, Virginie est chair du groupe de travail W3C "Web Cryptography Working Group".</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/le-web-sera-securise-ou-ne-sera-pas.php&amp;ref=prez-le-web-sera-securise-ou-ne-sera-pas&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
