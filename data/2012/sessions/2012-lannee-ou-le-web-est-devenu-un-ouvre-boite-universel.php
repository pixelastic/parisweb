...
<title>Paris Web - 2012, l'année où le web est devenu un ouvre-boite universel</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2012/conferences/application-cache.php" title="Application cache" />
<link rel="next bookmark" href="https://www.paris-web.fr/2012/conferences/fast-mobile-uis.php" title="Fast Mobile UIs" />
	...
	<meta name="twitter:title" content="2012, l'année où le web est devenu un ouvre-boite universel" />
	<meta property="twitter:description" content="Mobile, identité, Applications, AppStore : tous ces systèmes sont nés propriétaires. Voyons comment le web va révolutionner ces systèmes en les ouvrants à partir de 2012. Fidèle à sa mission et…" />
	<meta property="dc:title" content="2012, l'année où le web est devenu un ouvre-boite universel" />
	<meta property="og:title" content="2012, l'année où le web est devenu un ouvre-boite universel" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2012/conferences/2012-lannee-ou-le-web-est-devenu-un-ouvre-boite-universel.php" />
	<meta property="og:description" content="Mobile, identité, Applications, AppStore : tous ces systèmes sont nés propriétaires. Voyons comment le web va révolutionner ces systèmes en les ouvrants à partir de 2012. Fidèle à sa mission et…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>2012, l'année où le web est devenu un ouvre-boite universel</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-687">
						<header>
							<h1>2012, l'année où le web est devenu un ouvre-boite universel</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//www.dailymotion.com/embed/video/xx8b7x?logo=0" width="100%" height="475" frameborder="0"></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-687">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2012/conferences/2012-lannee-ou-le-web-est-devenu-un-ouvre-boite-universel.php" class="url">2012, l'année où le web est devenu un ouvre-boite universel</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2012/recherche/identite-numerique" rel="tag">identité numérique</a><br /><a href="http://www.paris-web.fr/2012/recherche/mobile" rel="tag">mobile</a><br /><a href="http://www.paris-web.fr/2012/recherche/privacy" rel="tag">privacy</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p><strong>Mobile</strong>, <strong>identité</strong>, <strong>Applications</strong>, <strong>AppStore</strong> : tous ces systèmes sont nés propriétaires. Voyons comment le web va révolutionner ces systèmes en les ouvrants à partir de 2012. </p>

<p>Fidèle à sa mission et toujours à la recherche des solutions qui feront que le web sera plus ouvert, plus innovant et au service de l'humain, <strong>Mozilla Foundation</strong> a lancé plusieurs initiatives qui vont dans ce sens : "Boot to Gecko", "WebAPIs", "Marketplace", "Persona". </p>

<p>Alors, « 2012, la fin d'un Internet, le début d'un autre ? » : </p>

<p>Oui pour le début d'un nouveau monde, sans pour autant abandonner un  <strong>web libre</strong>, participatif et respectueux de l'utilisateur et de ses données personnelles.</p>

<p>Oui pour que le web devienne un vraie <strong>plateforme</strong>, mieux interfacée avec matériel y compris mobile : WebAPI.</p>

<p>Oui pour que les <strong>applications mobiles</strong> soient aussi écrites avec des technologies web (Boot 2 Gecko).</p>

<p>Oui pour un web dont l'auteur serait rémunéré, sans avoir à pister ses utilisateurs pour <strong>monétiser des données personnelles</strong> (la fin du « tout  publicitaire », début d'un « business model » alternatif).</p>

<p>Oui pour un web personnalisé sans avoir à passer par Facebook (Persona /  BrowserID, pour une identification décentralisée et universelle).</p>

<p>Oui pour un web qui permet de jouer, sans avoir recours à des technologies propriétaires.</p>

<p>Oui pour un web sans silos, qui permet de développer sur mobile ou desktop.</p>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2012/../orateurs/anthony-ricaud.php">Anthony Ricaud</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Anthony Ricaud" src="https://www.paris-web.fr/2012/assets_c/2012/08/anthony-ricaud-thumb-143x143-193.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Développeur Web, Anthony anime nos discussions sur ##openweb, <a href="https://twitter.com/rik24d">Twitter (@rik24d)</a> et autres avec passion et humour. Une langue acérée et un cœur tendre en toutes circonstances, il est toujours prompt à aider. Il a participé au code source de WebKit. Il travaille pour Mozilla dans l'équipe de développement Web.</p>

<p>De temps en temps, il blogue sur <a href="http://hanblog.info/">hanblog.info</a>.</p>

<p>Cette biographie collective a été rédigée via <abbr>IRC</abbr> : irc.freenode.net ##openweb.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2012/conferences/2012-lannee-ou-le-web-est-devenu-un-ouvre-boite-universel.php&amp;ref=prez-2012-lannee-ou-le-web-est-devenu-un-ouvre-boi&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
