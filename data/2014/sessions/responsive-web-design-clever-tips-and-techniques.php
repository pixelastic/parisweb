...
<title>Paris Web - Responsive Web Design: Clever Tips and Techniques</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/in.php" title="Informelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/pause-1.php" title="Pause" />
	...
	<meta name="twitter:title" content="Responsive Web Design: Clever Tips and Techniques" />
	<meta property="twitter:description" content=" Responsive Web Design: Clever Tips and Techniques Responsive Web design challenges Web designers to adapt a new mindset to their design processes as well as techniques they are using in design and…" />
	<meta property="dc:title" content="Responsive Web Design: Clever Tips and Techniques" />
	<meta property="og:title" content="Responsive Web Design: Clever Tips and Techniques" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/responsive-web-design-clever-tips-and-techniques.php" />
	<meta property="og:description" content=" Responsive Web Design: Clever Tips and Techniques Responsive Web design challenges Web designers to adapt a new mindset to their design processes as well as techniques they are using in design and…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			...
			<div class="l-content l-block l-third">
					<article id="entry-1695">
						<header>
							<h1>Responsive Web Design: Clever Tips and Techniques</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113941029" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1695">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/responsive-web-design-clever-tips-and-techniques.php" class="url">Responsive Web Design: Clever Tips and Techniques</a></span></span></h2>
...
<strong>Responsive Web Design: Clever Tips and Techniques</strong>
<p>Responsive Web design challenges Web designers to adapt a new mindset to their design processes as well as techniques they are using in design and code. This talk provides an overview of various practical techniques, tips and tricks that you might want to be aware of when working on a new responsive design project.</p>
</div>
<div lang="fr">
<strong>Responsive Web Design : bonnes astuces et techniques</strong>
<p>Le Responsive Web design pousse les web designers à adopter une nouvelle manière d'aborder les processus et techniques de conception qu'ils exploitent dans leurs créations et leur code. Cette conférence offre une vue d'ensemble de nombreuses techniques, astuces et bonnes pratiques que vous souhaiterez certainement connaître lors de votre prochain projet RWD.</p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/vitaly-friedman.php">Vitaly Friedman</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Vitaly Friedman" src="https://www.paris-web.fr/2014/assets_c/2014/10/2014-photo-Vitaly-thumb-143x143-450.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="fr">
<p>Vitaly Friedman aime les beaux contenus et n’abandonne pas facilement. Originaire de Minsk en Biélorussie, il a étudié l’informatique et les maths en Allemagne, se découvrant au passage une passion pour la typographie, l’écriture et le design. Après avoir travaillé comme designer et développeur freelance pendant 6 ans, il a co-fondé Smashing Magazine, l’un des principaux magazines en ligne dédié au design et développement web. Vitaly est auteur, co-auteur et éditeur de tous les Smashing Books. Il travaille actuellement comme rédacteur-en-chef de Smashing Magazine dans la charmante ville de Freiburg, en Allemagne.</p>
</div>
<div lang="en">
<p>Vitaly Friedman loves beautiful content and doesn’t like to give in easily. Originally from Minsk, Belarus, he studied computer science and mathematics in Germany where he has discovered his passion for typography, writing and design. After working as a freelancing designer and developer for 6 years, he co-founded Smashing Magazine, one of the largest online magazines dedicated to Web design and development. Vitaly is writer, co-author and editor of both Smashing Books. He is now working as the editor-in-chief of Smashing Magazine in the lovely city of Germany, Freiburg.</p>
</div></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/responsive-web-design-clever-tips-and-techniques.php&amp;ref=prez-responsive-web-design-clever-tips-and-techniq&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
