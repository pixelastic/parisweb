...
<title>Paris Web - Mes projets web se passent toujours bien !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/changement-de-salle-5.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/dark-patterns-la-contre-attaque-du-pire.php" title="Dark patterns, la contre-attaque du pire" />
	...
	<meta name="twitter:title" content="Mes projets web se passent toujours bien !" />
	<meta property="twitter:description" content="Trop souvent les projets web virent au chaos. Mal maitrisés, ils deviennent un enfer pour tout le monde : développeurs, clients, chef de projet, etc. Pourtant, il y a plein de petits trucs simples…" />
	<meta property="dc:title" content="Mes projets web se passent toujours bien !" />
	<meta property="og:title" content="Mes projets web se passent toujours bien !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/mes-projets-web-se-passent-toujours-bien.php" />
	<meta property="og:description" content="Trop souvent les projets web virent au chaos. Mal maitrisés, ils deviennent un enfer pour tout le monde : développeurs, clients, chef de projet, etc. Pourtant, il y a plein de petits trucs simples…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Mes projets web se passent toujours bien !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1606">
						<header>
							<h1>Mes projets web se passent toujours bien !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939763" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1606">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/mes-projets-web-se-passent-toujours-bien.php" class="url">Mes projets web se passent toujours bien !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/methodologie" rel="tag">méthodologie</a><br /><a href="http://www.paris-web.fr/2014/recherche/metier" rel="tag">métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Trop souvent les projets web virent au chaos. Mal maitrisés, ils deviennent un enfer pour tout le monde : développeurs, clients, chef de projet, etc. Pourtant, il y a plein de petits trucs simples pour éviter ça. Il ne s'agit pas de disserter sur les grandes théories de la gestion de projet mais bien de passer une heure à voir comment, au travers de bonnes pratiques simple à mettre en œuvre, il est possible de vivre au paradis des projets web.</p>
</div>
	</section>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/mes-projets-web-se-passent-toujours-bien.php&amp;ref=prez-mes-projets-web-se-passent-toujours-bien&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
