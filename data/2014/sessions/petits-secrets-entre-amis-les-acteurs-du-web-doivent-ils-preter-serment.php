...
<title>Paris Web - Petits secrets entre amis : les acteurs du web doivent ils prêter serment ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-6.php" title="Informelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/de.php" title="Déjeuner" />
	...
	<meta name="twitter:title" content="Petits secrets entre amis : les acteurs du web doivent ils prêter…" />
	<meta property="twitter:description" content="webmaster, chef de projets, développeurs, intégrateurs, administrateur réseau… Nous avons tous entre les mains des mots de passe de nos collègues, amis, responsables, voire de nos sociétés, certains…" />
	<meta property="dc:title" content="Petits secrets entre amis : les acteurs du web doivent ils prêter serment ?" />
	<meta property="og:title" content="Petits secrets entre amis : les acteurs du web doivent ils prêter serment ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/petits-secrets-entre-amis-les-acteurs-du-web-doivent-ils-preter-serment.php" />
	<meta property="og:description" content="webmaster, chef de projets, développeurs, intégrateurs, administrateur réseau… Nous avons tous entre les mains des mots de passe de nos collègues, amis, responsables, voire de nos sociétés, certains…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Petits secrets entre amis : les acteurs du web doivent ils prêter serment ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1632">
						<header>
							<h1>Petits secrets entre amis : les acteurs du web doivent ils prêter serment ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939766#t=24m57s" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1632">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/petits-secrets-entre-amis-les-acteurs-du-web-doivent-ils-preter-serment.php" class="url">Petits secrets entre amis : les acteurs du web doivent ils prêter serment ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/ethique" rel="tag">éthique</a><br /><a href="http://www.paris-web.fr/2014/recherche/metier" rel="tag">métier</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/jean-philippe-simonnet.php">Jean-Philippe Simonnet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jean-Philippe Simonnet" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Jean-Philippe-Simonnet-thumb-143x143-430.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après un parcours dans le multimédia et la télévision locale pendant plus de 10 ans, le web est devenu partie intégrante de mon quotidien.
Responsable des développements internet et chef de projet accessibilité, je gère des projets web grand public pour le compte de l'Etat au sein de mon association. Je participe au sujet de l'amélioration de la qualité et de l'accessibilité des sites web. Enfin, je milite pour une neutralité du web, un respect des données personnelles et pour une conception vraiment universelle.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/petits-secrets-entre-amis-les-acteurs-du-web-doivent-ils-preter-serment.php&amp;ref=prez-petits-secrets-entre-amis-les-acteurs-du-web-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
