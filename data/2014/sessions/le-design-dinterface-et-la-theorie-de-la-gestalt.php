...
<title>Paris Web - Le design d'interface et la théorie de la Gestalt</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/le-futur-de-lindustrialisation-du-web-lingenierie-dirigee-par-les-modeles.php" title="Le futur de l'industrialisation du web : l'ingénierie dirigée par les modèles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/changement-de-salle-6.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Le design d'interface et la théorie de la Gestalt" />
	<meta property="twitter:description" content="Devant la complexité de notre environnement, le cerveau va chercher à mettre en forme, à donner une structure signifiante à ce qu’il perçoit suivant plusieurs lois : la loi de proximité, la loi de…" />
	<meta property="dc:title" content="Le design d'interface et la théorie de la Gestalt" />
	<meta property="og:title" content="Le design d'interface et la théorie de la Gestalt" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/le-design-dinterface-et-la-theorie-de-la-gestalt.php" />
	<meta property="og:description" content="Devant la complexité de notre environnement, le cerveau va chercher à mettre en forme, à donner une structure signifiante à ce qu’il perçoit suivant plusieurs lois : la loi de proximité, la loi de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le design d'interface et la théorie de la Gestalt</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1635">
						<header>
							<h1>Le design d'interface et la théorie de la Gestalt</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839416" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1635">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/le-design-dinterface-et-la-theorie-de-la-gestalt.php" class="url">Le design d'interface et la théorie de la Gestalt</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/ergonomie" rel="tag">ergonomie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Devant la complexité de notre environnement, le cerveau va chercher à mettre en forme, à donner une structure signifiante à ce qu’il perçoit suivant plusieurs lois : la loi de proximité, la loi de similarité, la loi de clôture et la loi de Fitts. Nous verrons en quoi celles-ci consistent et comment elles s'appliquent au design d'interface. </p>

<p>En terme de design d’interface, il est également important de s’intérréser à la loi de Hick et les nombres magiques de Miller.
La loi de Hick déclare que le temps requis pour prendre une décision est une fonction du nombre d’alternatives possibles, tandis que les nombres de Miller s’attaquent aux limites de notre mémoire de travail.
En d’autres termes, plus le choix est large, plus celui-ci est difficile. Nous verrons quelle influence ont ces deux paramètres sur notre façon d’interpréter les interfaces.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/vincent-desdoigts.php">Vincent Desdoigts</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Vincent Desdoigts" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Vincent%20Desdoigts-thumb-143x143-411.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Vincent est un jeune développeur sensible aux problématiques techniques et d’interfaces liées à la diversité grandissante des appareils connectés. Outre l’aspect technique, il affectionne et tend à développer ses compétences en terme d’ergonomie et d’expérience utilisateur. Il travaille chez JoliCode en tant que développeur web et mobile. Vous pouvez le suivre sur <a href="http://twitter.com/vdesdoigts">@vdesdoigts</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/le-design-dinterface-et-la-theorie-de-la-gestalt.php&amp;ref=prez-le-design-dinterface-et-la-theorie-de-la-gest&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
