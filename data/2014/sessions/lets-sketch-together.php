...
<title>Paris Web - Let's sketch together</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/dejeuner-1.php" title="Déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/les-web-components-oui-mais-tout-de-suite.php" title="Les Web Components, oui, mais tout de suite !" />
	...
	<meta name="twitter:title" content="Let's sketch together" />
	<meta property="twitter:description" content="On entend bien souvent parler de collaboration ou de coopération au sein d'organisations ou d'équipes agiles. C'est d'ailleurs l'un des principes du manifeste agile : « les utilisateurs ou leurs…" />
	<meta property="dc:title" content="Let's sketch together" />
	<meta property="og:title" content="Let's sketch together" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/lets-sketch-together.php" />
	<meta property="og:description" content="On entend bien souvent parler de collaboration ou de coopération au sein d'organisations ou d'équipes agiles. C'est d'ailleurs l'un des principes du manifeste agile : « les utilisateurs ou leurs…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Let's sketch together</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1589">
						<header>
							<h1>Let's sketch together</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2014/slides/Alvin_Berthelot-Let_s_sketch_together.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1589">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/lets-sketch-together.php" class="url">Let's sketch together</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/design" rel="tag">design</a></dd>
    ...
    <div class="talk-description"><p>On entend bien souvent parler de collaboration ou de coopération au sein d'organisations ou d'équipes agiles.
C'est d'ailleurs l'un des principes du manifeste agile : « les utilisateurs ou leurs représentants et les développeurs doivent travailler ensemble quotidiennement tout au long du projet ».</p>

<p>Si ce principe semble du bon sens, on s'aperçoit qu'il est trop souvent laissé de côté dès qu’il s’agit de questions portant sur l’interface, le design d’information ou la structuration de l’écran.</p>

<p>Cet atelier propose de palier ce manque en facilitant la collaboration des différentes parties prenantes d'un projet autour d'une simple feuille de papier. Si de cet exercice en découle nécessairement un livrable : un croquis ; il possède également de nombreuses vertus cachées qui vont bien au delà de l'aspect visuel. </p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/alvin-berthelot.php">Alvin Berthelot</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Alvin Berthelot" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Alvin-Berthelot-thumb-143x143-441.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Collaborateur d'Ippon Technologies et membre au sein de l’association Agile Nantes, je suis à la recherche d'une "autre façon de travailler". Façon, qui saura faire preuve de pragmatisme ayant pour objectif l’efficience collective, mais aussi l’accomplissement personnel. 
Pour trouver cela, je ne refuse rien à ma curiosité, j'adore expérimenter, partager et échanger. Qui sait peut être avec vous ?</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/lets-sketch-together.php&amp;ref=prez-lets-sketch-together&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
