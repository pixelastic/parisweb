...
<title>Paris Web - 100 % de revue de code</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/changement-de-salle-3.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/sponsor-clever-age.php" title="[Conf Sponsor] La « logiciellisation » du web" />
	...
	<meta name="twitter:title" content="100 % de revue de code" />
	<meta property="twitter:description" content="Chez TEA, nous faisions un peu de revue de code de temps en temps. Nous avons décidé de faire revoir TOUT notre code par nos collègues avant de le passer en production. Comment nous en sommes-nous…" />
	<meta property="dc:title" content="100 % de revue de code" />
	<meta property="og:title" content="100 % de revue de code" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/100-de-revue-de-code.php" />
	<meta property="og:description" content="Chez TEA, nous faisions un peu de revue de code de temps en temps. Nous avons décidé de faire revoir TOUT notre code par nos collègues avant de le passer en production. Comment nous en sommes-nous…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>100 % de revue de code</span>
			</p>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113941030" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1625">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/100-de-revue-de-code.php" class="url">100 % de revue de code</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Chez TEA, nous faisions un peu de revue de code de temps en temps. Nous avons décidé de faire revoir TOUT notre code par nos collègues avant de le passer en production. Comment nous en sommes-nous sortis ?</p>

<p>Laissez-moi vous présenter nos outils, nos processus et les bénéfices que nous en avons retirés.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/agnes-haasser.php">Agnès Haasser</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Agnès Haasser" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Agnes%20Haasser-thumb-143x143-396.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Agnès est développeuse web. Elle a découvert le CSS à 15 ans, et en a fait son métier, après un détour par des études d'ingénieur et l'édition scientifique. À présent, elle travaille chez TEA, où elle touche à plein de choses (du PHP au CSS en passant par Ruby) pour faire fonctionner le livre numérique en France.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/100-de-revue-de-code.php&amp;ref=prez-100-de-revue-de-code&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
