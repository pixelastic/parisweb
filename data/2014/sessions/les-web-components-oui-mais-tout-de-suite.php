...
<title>Paris Web - Les Web Components, oui, mais tout de suite !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/lets-sketch-together.php" title="Let's sketch together" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/applications-cartographiques-modernes-et-mobiles.php" title="Applications cartographiques modernes et mobiles" />
	...
	<meta name="twitter:title" content="Les Web Components, oui, mais tout de suite !" />
	<meta property="twitter:description" content="HTML Templates, Shadow DOM, HTML imports, Custom Elements, decorators : derrière ces termes obscurs se cachent les principes fondateurs de la nouvelle génération de composants d'interface. Les Web…" />
	<meta property="dc:title" content="Les Web Components, oui, mais tout de suite !" />
	<meta property="og:title" content="Les Web Components, oui, mais tout de suite !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/les-web-components-oui-mais-tout-de-suite.php" />
	<meta property="og:description" content="HTML Templates, Shadow DOM, HTML imports, Custom Elements, decorators : derrière ces termes obscurs se cachent les principes fondateurs de la nouvelle génération de composants d'interface. Les Web…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les Web Components, oui, mais tout de suite !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1594">
						<header>
							<h1>Les Web Components, oui, mais tout de suite !</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1594">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/les-web-components-oui-mais-tout-de-suite.php" class="url">Les Web Components, oui, mais tout de suite !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a></dd>
    ...
    <div class="talk-description"><p>HTML Templates, Shadow DOM, HTML imports, Custom Elements, decorators : derrière ces termes obscurs se cachent les principes fondateurs de la nouvelle génération de composants d'interface. Les Web Components offrent la possibilité d'étendre les possibilités du navigateur en créant vos propres balises HTML. Après une explication et un point sur l'avancée de ces nouvelles spécifications, nous examinerons les librairies permettant dès aujourd'hui de développer des composants, à savoir Polymer, x-tags et Bosonic.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/raphael-rougeron.php">Raphaël Rougeron</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Rougeron" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Raphael%20Rougeron-thumb-143x143-421.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Raphaël Rougeron est responsable R&amp;D au sein du groupe Viareport. Expert des technologies web, ses principaux centres d'intérêts sont aujourd'hui Scala et Javascript. Il est également l'auteur de Bosonic, un toolkit permettant la création de Web Components.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/les-web-components-oui-mais-tout-de-suite.php&amp;ref=prez-les-web-components-oui-mais-tout-de-suite&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
