...
<title>Paris Web - Réutiliser son JavaScript côté serveur et côté client</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/les-outils-des-designers-web-lre-post-adobe.php" title="Les outils des designers web : l’ère post-Adobe" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/creer-un-clone-de-whatsapp-en-html5.php" title="Créer un clone de WhatsApp en HTML5" />
	...
	<meta name="twitter:title" content="Réutiliser son JavaScript côté serveur et côté client" />
	<meta property="twitter:description" content="Avec l’avènement des applications web et l'arrivée de Node.js il est très tentant de vouloir maximiser la réutilisation de son code JavaScript côté serveur et coté client afin d'éviter de dupliquer…" />
	<meta property="dc:title" content="Réutiliser son JavaScript côté serveur et côté client" />
	<meta property="og:title" content="Réutiliser son JavaScript côté serveur et côté client" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/reutiliser-son-javascript-cote-serveur-et-cote-client.php" />
	<meta property="og:description" content="Avec l’avènement des applications web et l'arrivée de Node.js il est très tentant de vouloir maximiser la réutilisation de son code JavaScript côté serveur et coté client afin d'éviter de dupliquer…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Réutiliser son JavaScript côté serveur et côté client</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1599">
						<header>
							<h1>Réutiliser son JavaScript côté serveur et côté client</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1599">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/reutiliser-son-javascript-cote-serveur-et-cote-client.php" class="url">Réutiliser son JavaScript côté serveur et côté client</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/javascript" rel="tag">JavaScript</a></dd>
    ...
    <div class="talk-description"><p>Avec l’avènement des applications web et l'arrivée de Node.js il est très tentant de vouloir maximiser la réutilisation de son code JavaScript côté serveur et coté client afin d'éviter de dupliquer la logique de son application et de faciliter sa maintenance.</p>

<p>Cet atelier vous présentera la philosophie du JavaScript isomorphique avec ses avantages et inconvénients ainsi que sa mise en œuvre via des solutions existantes comme Browserify, Rendr ou encore React.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/yannick-croissant.php">Yannick Croissant</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Yannick Croissant" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Yannick%20Croissant-thumb-143x143-423.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Passionné de développement web et ayant œuvré de nombreuses années en tant qu'intégrateur, il s'intéresse aujourd'hui au développement back-end avec node.js ainsi qu'aux nouvelles architectures des applications web modernes et leurs impacts sur les performances et l'accessibilité.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/reutiliser-son-javascript-cote-serveur-et-cote-client.php&amp;ref=prez-reutiliser-son-javascript-cote-serveur-et-cot&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
