...
<title>Paris Web - [Conf Sponsor] La « logiciellisation » du web</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/100-de-revue-de-code.php" title="100 % de revue de code" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-2.php" title="Informelles" />
	...
	<meta name="twitter:title" content="[Conf Sponsor] La « logiciellisation » du web" />
	<meta property="twitter:description" content="Plus le web et ses technologies évoluent, plus elles commencent à marcher sur les platebandes des logicielles traditionnels: Les applications web brouille les cartes; Les performances de JavaScript…" />
	<meta property="dc:title" content="[Conf Sponsor] La « logiciellisation » du web" />
	<meta property="og:title" content="[Conf Sponsor] La « logiciellisation » du web" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/sponsor-clever-age.php" />
	<meta property="og:description" content="Plus le web et ses technologies évoluent, plus elles commencent à marcher sur les platebandes des logicielles traditionnels: Les applications web brouille les cartes; Les performances de JavaScript…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Conf Sponsor] La « logiciellisation » du web</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1664">
						<header>
							<h1>[Conf Sponsor] La « logiciellisation » du web</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839415" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1664">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/sponsor-clever-age.php" class="url">[Conf Sponsor] La « logiciellisation » du web</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Plus le web et ses technologies évoluent, plus elles commencent à marcher sur les platebandes des logicielles traditionnels:</p>

<ul>
<li>Les applications web brouille les cartes;</li>
<li>Les performances de JavaScript qui rivalisent avec les langages compilés autorisent le portage d'application C/C++ directement dans les navigateurs;</li>
<li>Les systèmes d'exploitations aussi sont tout tourneboulé avec d'un coté Windows8 et Linux qui utilisent les langages web et d'un autre coté Firefox OS et Tizen qui sont carrément battis sur les technologies web.</li>
</ul>

<p>On fera donc un peu le point pour voir comment tout ça fonctionne et change le marché du développement web.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/jeremie-patonnier.php">Jeremie Patonnier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jeremie Patonnier" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-JeremiePatonnier-thumb-143x143-417.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>15 ans dans la jungle du développement web, présent sur tous les front: design, développement front et back, gestion de projet… Avec son barda de survivant, Jérémie vient discuter des techniques de survie en milieux web hostile. Consultant chez Clever Age et contributeur chez Mozilla, il prend sa casquette de sergent instructeur pour vous sortir de l'enfer des projets web apocalyptiques.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/sponsor-clever-age.php&amp;ref=prez-sponsor-clever-age&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
