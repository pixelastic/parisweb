...
<title>Paris Web - Internet et les TIC, pas très écologiques ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/frontend-performance-beginner-to-expert-to-crazy-person.php" title="Frontend Performance Beginner to Expert to Crazy Person" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-4.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Internet et les TIC, pas très écologiques ?" />
	<meta property="twitter:description" content="Qui n'a jamais reçu un courrier ou un e-mail l'invitant à souscrire à la facturation électronique, en remplacement de la facturation papier ? Fournisseurs d'énergie, opérateurs de téléphonie,…" />
	<meta property="dc:title" content="Internet et les TIC, pas très écologiques ?" />
	<meta property="og:title" content="Internet et les TIC, pas très écologiques ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/internet-et-les-tic-pas-tres-ecologique.php" />
	<meta property="og:description" content="Qui n'a jamais reçu un courrier ou un e-mail l'invitant à souscrire à la facturation électronique, en remplacement de la facturation papier ? Fournisseurs d'énergie, opérateurs de téléphonie,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Internet et les TIC, pas très écologiques ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1608">
						<header>
							<h1>Internet et les TIC, pas très écologiques ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839409" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1608">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/internet-et-les-tic-pas-tres-ecologique.php" class="url">Internet et les TIC, pas très écologiques ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/societe" rel="tag">société</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/luc-poupard.php">Luc Poupard</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Luc Poupard" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Luc%20Poupard-thumb-143x143-418.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Web designer, intégrateur, chef de projet et aspirant qualiticien web, Luc est un touche-à-tout passionné. Quand il découvre Internet dans son adolescence, il s'émerveille instantanément - et continue de s'émerveiller - des possibilités sans commune mesure du web pour découvrir, informer, partager… Soucieux de bien faire les choses, il s'intéresse vite aux problématiques d'accessibilité et de qualité web : il devient Expert Accessiweb en Évaluation en 2010 et rejoint le collectif w3qualité en 2012.</p>
<p>Aujourd'hui, il prépare avec un ami un périple de 12 000 km à vélo jusqu'au Cap Nord, avec la volonté de monter un projet le plus respectueux de l'environnement possible. Partageant en ligne leurs expériences, ils souhaitent naturellement que leur site web soit le plus « vert » possible. Pour y parvenir, Luc accumule des données sur l'impact écologique des <abbr title="Technologies de l'information et de la communication">TIC</abbr> et ce n'est pas joli à voir… Vous pouvez le suivre sur <a href="http://twitter.com/klohFR">@klohFR</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/internet-et-les-tic-pas-tres-ecologique.php&amp;ref=prez-internet-et-les-tic-pas-tres-ecologique&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
