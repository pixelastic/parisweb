...
<title>Paris Web - Votre site web est-il lisible, compréhensible et utilisable par tous ?</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/creer-un-clone-de-whatsapp-en-html5.php" title="Créer un clone de WhatsApp en HTML5" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/pause-2.php" title="Pause" />
	...
	<meta name="twitter:title" content="Votre site web est-il lisible, compréhensible et utilisable par tous…" />
	<meta property="twitter:description" content="Savez-vous que les animations et clignotements peuvent rendre un site inutilisable si l'on ne fournit pas de moyen de les arrêter, que votre solution anti-spam, si elle est mal choisie, empêche de…" />
	<meta property="dc:title" content="Votre site web est-il lisible, compréhensible et utilisable par tous ?" />
	<meta property="og:title" content="Votre site web est-il lisible, compréhensible et utilisable par tous ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/votre-site-web-est-il-lisible-comprehensible-et-utilisable-par-tous.php" />
	<meta property="og:description" content="Savez-vous que les animations et clignotements peuvent rendre un site inutilisable si l'on ne fournit pas de moyen de les arrêter, que votre solution anti-spam, si elle est mal choisie, empêche de…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Votre site web est-il lisible, compréhensible et utilisable par tous ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1638">
						<header>
							<h1>Votre site web est-il lisible, compréhensible et utilisable par tous ?</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1638">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/votre-site-web-est-il-lisible-comprehensible-et-utilisable-par-tous.php" class="url">Votre site web est-il lisible, compréhensible et utilisable par tous ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2014/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2014/recherche/ergonomie" rel="tag">ergonomie</a></dd>
    ...
    <div class="talk-description"><p>Savez-vous que  les animations et clignotements peuvent rendre un site inutilisable si l'on ne fournit pas de moyen de les arrêter, que votre solution anti-spam, si elle est mal choisie, empêche de nombreuses personnes de s'inscrire à votre infolettre, qu’une personne aveugle peut très bien naviguer sur internet quand les sites sont bien conçus ?</p>

<p>En partant de 10 personas, 10 profils différents, nous observerons à travers des exemples concrets les différentes manières d'utiliser un ordinateur, les difficultés rencontrées par chaque personne, les astuces à mettre en œuvre pour que tout le monde ait accès à la même information. 
Ensuite, pour mettre cela en pratique et apprendre à utiliser différents outils de test, vous évaluerez l'accessibilité d'un site web sur base de 15 critères.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/sophie-schuermans.php">Sophie Schuermans</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Sophie Schuermans" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Sophie-Schuermans-thumb-143x143-437.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Sophie est consultante en accessibilité numérique chez AnySurfer, en Belgique, depuis 2010.
Ses activités principales consistent à accompagner les agences web et leurs clients dans la création de sites web accessibles, ainsi que d'auditer des sites existants. Les activités de formation et de sensibilisation occupent également une bonne partie de son emploi du temps, que ce soit pour l'accessibilité des sites web, des documents PDF ou des vidéos.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/votre-site-web-est-il-lisible-comprehensible-et-utilisable-par-tous.php&amp;ref=prez-votre-site-web-est-il-lisible-comprehensible-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
