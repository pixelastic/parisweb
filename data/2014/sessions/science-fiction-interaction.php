...
<title>Paris Web - Science-fiction &amp; interaction !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/introduction.php" title="Introduction" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/qualite-web-lheure-de-passer-a-la-caisse.php" title="Qualité web : l’heure de passer à la caisse" />
	...
	<meta name="twitter:title" content="Science-fiction & interaction !" />
	<meta property="twitter:description" content="La science-fiction est souvent citée quand l'on veut parler d'innovation en termes d'interaction humain machine. D'un côté, nous avons des films (ou des séries) qui nous prédisent le futur et d'un…" />
	<meta property="dc:title" content="Science-fiction & interaction !" />
	<meta property="og:title" content="Science-fiction & interaction !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/science-fiction-interaction.php" />
	<meta property="og:description" content="La science-fiction est souvent citée quand l'on veut parler d'innovation en termes d'interaction humain machine. D'un côté, nous avons des films (ou des séries) qui nous prédisent le futur et d'un…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Science-fiction & interaction !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1605">
						<header>
							<h1>Science-fiction & interaction !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/114950686" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2014/slides/Science_fiction_et_interactions.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1605">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/science-fiction-interaction.php" class="url">Science-fiction & interaction !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/culture" rel="tag">culture</a><br /><a href="http://www.paris-web.fr/2014/recherche/design" rel="tag">design</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>La science-fiction est souvent citée quand l'on veut parler d'innovation en termes d'interaction humain machine. D'un côté, nous avons des films (ou des séries) qui nous prédisent le futur et d'un autre côté les technologies qui évoluent souvent plus rapidement que les prédictions. L'un influençant l'autre.</p>

<p>Ces interfaces, qu'elles soient utilisables ou non, nous enseignent bien des leçons en termes de conception. Il est amusant de regarder comment elles abordent les différents problèmes courants même aujourd'hui, par exemple, pour distinguer les humains, des robots ou identifier une personne.</p>

<p>Au-delà de l'interface, il faut aussi s'intéresser aux usages qui découlent de ces scénarios et voir comment la communication, l'apprentissage ou la médecine évoluent en fonction de ces technologies futuristes ou extraterrestres.</p>

<p>Malgré les limites de l'exercice, peut-on imaginer que ce qui marche pour une certaine audience, fonctionne aussi pour certains utilisateurs ?</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/raphael-yharrassarry.php">Raphaël Yharrassarry</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Raphaël Yharrassarry" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Raphael%20Yharrassarry-thumb-143x143-406.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Issu d’une formation en psychologie et en ergonomie à Paris 5 en 1999, Raphaël Yharrassarry travaille depuis comme ergonome IHM en Freelance. Il a complété cette formation par un Mastère spécialisé en marketing au CNAM, afin de mieux comprendre les enjeux commerciaux.</p>

<p>Il réalise de nombreuses missions de conseils, de conceptions et d'évaluations sur des sujets variés allant des applications professionnelles aux services grand public sur la télévision en passant par le web et les tablettes. Il intervient aussi bien auprès de grands groupes, de PME que d'administrations.</p>

<p>Dans une volonté de formaliser, de partager et d'approfondir ces connaissances, il crée en 2009 un bloc-notes sur l'ergonomie des IHM et l'expérience utilisateur. Vous pouvez le suivre sur <a href="http://twitter.com/iergo">@iErgo</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/science-fiction-interaction.php&amp;ref=prez-science-fiction-interaction&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
