...
<title>Paris Web - Mutation d’un géant du web vers le Mobile</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/things-i-wish-i-knew-when-i-started-in-digital-accessibility.php" title="Things I wish I knew when I started in Digital Accessibility" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-1.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Mutation d’un géant du web vers le Mobile" />
	<meta property="twitter:description" content="Les usages d’aujourd'hui sont en passe de devenir majoritairement mobiles. Leader européen des sites de rencontres, Meetic est un pionner du web français. Historiquement orienté vers le Desktop,…" />
	<meta property="dc:title" content="Mutation d’un géant du web vers le Mobile" />
	<meta property="og:title" content="Mutation d’un géant du web vers le Mobile" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/mutation-dun-geant-du-web-vers-le-mobile.php" />
	<meta property="og:description" content="Les usages d’aujourd'hui sont en passe de devenir majoritairement mobiles. Leader européen des sites de rencontres, Meetic est un pionner du web français. Historiquement orienté vers le Desktop,…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Mutation d’un géant du web vers le Mobile</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1612">
						<header>
							<h1>Mutation d’un géant du web vers le Mobile</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839943" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2014/slides/Meetic-Mobile-final.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1612">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/mutation-dun-geant-du-web-vers-le-mobile.php" class="url">Mutation d’un géant du web vers le Mobile</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2014/recherche/methodologie" rel="tag">méthodologie</a><br /><a href="http://www.paris-web.fr/2014/recherche/metier" rel="tag">métier</a><br /><a href="http://www.paris-web.fr/2014/recherche/mobile" rel="tag">mobile</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Les usages d’aujourd'hui sont en passe de devenir majoritairement mobiles.
Leader européen des sites de rencontres, Meetic est un pionner du web français.
Historiquement orienté vers le Desktop, l’entreprise se transforme en profondeur pour s’adapter aux nouveaux usages.
Je vous propose une immersion au cœur de cette mutation.</p>

<p>On parlera de technologies mobiles, web et natives, et d’architecture orientée services.
On verra également comment s'organisent les équipes et ce que les méthodologies Agile et le Lean permettent d’apporter.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/jean-loup-yu.php">Jean-Loup Yu</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Jean-Loup Yu" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Jean-Loup%20Yu-thumb-143x143-416.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Jean-Loup est un geek, passionné par les technologies et spécialisé dans le Mobile depuis quelques années.
Chef de projet chez Meetic, il est responsable des développements des applications mobiles.
Après plusieurs années de conseil pour des acteurs majeurs des médias et de l'Internet, il rejoint Meetic pour mettre en oeuvre la stratégie mobile de l'entreprise. Vous pouvez le suivre sur <a href="http://twitter.com/djelmen">@djelmen</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/mutation-dun-geant-du-web-vers-le-mobile.php&amp;ref=prez-mutation-dun-geant-du-web-vers-le-mobile&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
