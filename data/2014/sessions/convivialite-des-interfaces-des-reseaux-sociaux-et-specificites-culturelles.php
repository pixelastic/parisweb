...
<title>Paris Web - Convivialité des interfaces des réseaux sociaux et spécificités culturelles </title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/a.php" title="Accueil des participants" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/code-de-qualite-ce-quil-faut-savoir.php" title="Code de qualité : ce qu'il faut savoir" />
	...
	<meta name="twitter:title" content="Convivialité des interfaces des réseaux sociaux et spécificités…" />
	<meta property="twitter:description" content="Les interfaces des réseaux sociaux et des blogs, appelés aussi dispositifs médiatiques numériques, visent à instaurer une convivialité des interactions entre les internautes. La convivialité…" />
	<meta property="dc:title" content="Convivialité des interfaces des réseaux sociaux et spécificités culturelles " />
	<meta property="og:title" content="Convivialité des interfaces des réseaux sociaux et spécificités culturelles " />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/convivialite-des-interfaces-des-reseaux-sociaux-et-specificites-culturelles.php" />
	<meta property="og:description" content="Les interfaces des réseaux sociaux et des blogs, appelés aussi dispositifs médiatiques numériques, visent à instaurer une convivialité des interactions entre les internautes. La convivialité…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Convivialité des interfaces des réseaux sociaux et spécificités culturelles </span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1607">
						<header>
							<h1>Convivialité des interfaces des réseaux sociaux et spécificités culturelles </h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113838748" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1607">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/convivialite-des-interfaces-des-reseaux-sociaux-et-specificites-culturelles.php" class="url">Convivialité des interfaces des réseaux sociaux et spécificités culturelles </a></span></span></h2>
...
<dd class="column location"><a href="/lieux/">Auditorium Blin</a></dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/culture" rel="tag">culture</a><br /><a href="http://www.paris-web.fr/2014/recherche/ergonomie" rel="tag">ergonomie</a><br /><a href="http://www.paris-web.fr/2014/recherche/ux" rel="tag">UX</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Les interfaces des réseaux sociaux et des blogs, appelés aussi dispositifs médiatiques numériques, visent à instaurer une convivialité des interactions entre les internautes. La convivialité intervient à deux niveaux : </p>

<ul>
<li>dans l’expérience interactionnelle et les usages qu’elle suscite (ex : prise de parole politique, expression par la vidéo, la photo, etc.) ; </li>
<li>dans l’apprentissage itératif des fonctionnalités et de l’interface utilisée. </li>
</ul>

<p>La notion de convivialité s’envisage ainsi selon deux points de vue dans lesquels les spécificités culturelles jouent un rôle important :  </p>

<ul>
<li>ces dispositifs médiatiques numériques peuvent faciliter la prise de parole pour l’internaute, et offrir la possibilité d’une plus grande liberté d’expression ; </li>
<li>par ailleurs, les normes des interfaces impliquent une standardisation culturelle des usages qui accompagnent les changements des pratiques de communication des internautes.</li>
</ul>

<p>Des exemples concrets de différentes parties du monde (Océanie, Maghreb, Afrique de l’Ouest et Europe) seront dévoilés grâce à une analyse et des interactions sur le web s'inscrivant dans un champ récent des sciences sociales : l’anthropologie numérique (Digital Anthropology) qui étudie la relation entre l’homme et la technologie numérique.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/leonie-marin.php">Léonie Marin</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Léonie Marin" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Leonie-Marin-thumb-143x143-447.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Léonie Marin est docteure en Sciences de l’information et de la communication et sa thèse porte sur les changements des pratiques de communication des kanaks (Nouvelle-Calédonie), des médias écrits aux médias numériques. Plus largement, elle étudie les nouveaux médias et l’appropriation des <abbr title="Technologies de l’information et de la communication">TIC</abbr>. Ses séjours en Afrique de l’Ouest, Amérique latine, Europe, Maghreb et Océanie l’ont amenée à préconiser les dimensions culturelles pour analyser les usages des <abbr title="Technologies de l’information et de la communication">TIC</abbr>, et à s’intéresser à l’anthropologie numérique (Digital Anthropology).</p>
<p>En dehors de la recherche, Léonie exerce la photographie depuis une dizaine d’années et a travaillé à titre de journaliste et dans des agences de communication.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/convivialite-des-interfaces-des-reseaux-sociaux-et-specificites-culturelles.php&amp;ref=prez-convivialite-des-interfaces-des-reseaux-socia&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
