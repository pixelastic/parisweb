...
<title>Paris Web - Frontend Performance Beginner to Expert to Crazy Person</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/de.php" title="Déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/internet-et-les-tic-pas-tres-ecologique.php" title="Internet et les TIC, pas très écologiques ?" />
	...
	<meta name="twitter:title" content="Frontend Performance Beginner to Expert to Crazy Person" />
	<meta property="twitter:description" content=" Frontend Performance Beginner to Expert to Crazy Person The very first requirement of a great user experience is actually getting the bytes of that experience to the user before they they get tired…" />
	<meta property="dc:title" content="Frontend Performance Beginner to Expert to Crazy Person" />
	<meta property="og:title" content="Frontend Performance Beginner to Expert to Crazy Person" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/frontend-performance-beginner-to-expert-to-crazy-person.php" />
	<meta property="og:description" content=" Frontend Performance Beginner to Expert to Crazy Person The very first requirement of a great user experience is actually getting the bytes of that experience to the user before they they get tired…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Frontend Performance Beginner to Expert to Crazy Person</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1604">
						<header>
							<h1>Frontend Performance Beginner to Expert to Crazy Person</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939047" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1604">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/frontend-performance-beginner-to-expert-to-crazy-person.php" class="url">Frontend Performance Beginner to Expert to Crazy Person</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/ux" rel="tag">UX</a></dd>
...
<p><strong>Frontend Performance Beginner to Expert to Crazy Person</strong></p>
<p>The very first requirement of a great user experience is actually getting the bytes of that experience to the user before they they get tired and leave.</p>

<p>In this talk we'll start with the basics and get progressively insane. We'll go over several frontend performance best practices, a few anti-patterns, the reasoning behind the rules, and how they've changed over the years. We'll also look at some great tools to help you.</p>
</div>

<div lang="fr">
<p><strong>La performance front-end de débutant, à expert, à fou furieux !</strong></p>
<p>La toute première condition nécessaire à une bonne expérience utilisateur est de pouvoir obtenir les octets de cette expérience avant que l'utilisateur ne se lasse et parte.</p>

<p>Nous débuterons cette conférence avec les bases pour progressivement devenir démentiel. Nous aborderons plusieurs des meilleurs pratiques de la performance front-end, quelques anti-patterns à éviter, le raisonnement derrière les règles, et comment ces dernières ont changé au fil des ans. Nous regarderons d'un peu plus près quelques très bon outils qui peuvent vous aider.</p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/philip-tellis.php">Philip Tellis</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Philip Tellis" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Philip%20Tellis-thumb-143x143-420.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Philip Tellis is a geek who likes to make the computer do his work for him. As Chief Architect at SOASTA, he analyses the impact of various design decisions on web application performance, scalability and security. He is the lead developer of "boomerang" -- a JavaScript based web performance testing tool.</p>

<p>In his spare time, Philip enjoys cycling, reading, cooking and learning spoken languages.</p>

<p>Philip has spoken at several conferences in the past, including FOSS.IN, FREED.IN, Ubuntulive, Linux Symposium, PHP Quebec, ConFoo, FOSDEM, IPC, WebDU, Velocity and JSConf. He also writes for Smashing Magazine, blogs at <a href="http://tech.bluesmoon.info/">http://tech.bluesmoon.info/</a> and is <a href="https://twitter.com/bluesmoon">@bluesmoon</a> on twitter.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/frontend-performance-beginner-to-expert-to-crazy-person.php&amp;ref=prez-frontend-performance-beginner-to-expert-to-cr&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
