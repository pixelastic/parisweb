...
<title>Paris Web - [Conf Sponsor] JS + toi = &lt;3</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/les-masques-css-vers-de-nouveaux-usages-dans-le-webdesign.php" title="Les masques CSS : vers de nouveaux usages dans le webdesign" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/le-web-fait-pousser-mes-tomates.php" title="Le web fait pousser mes tomates" />
	...
	<meta name="twitter:title" content="[Conf Sponsor] JS + toi = &lt;3" />
	<meta property="twitter:description" content="Si quand on comprend vraiment ses ennemis on ne peut faire autrement que les aimer, alors après ça tu vais aimer JS. JavaScript, l’un des langages les plus incompris de la planète, en est pourtant…" />
	<meta property="dc:title" content="[Conf Sponsor] JS + toi = &lt;3" />
	<meta property="og:title" content="[Conf Sponsor] JS + toi = &lt;3" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/js-plus-toi-egal-coeur.php" />
	<meta property="og:description" content="Si quand on comprend vraiment ses ennemis on ne peut faire autrement que les aimer, alors après ça tu vais aimer JS. JavaScript, l’un des langages les plus incompris de la planète, en est pourtant…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Conf Sponsor] JS + toi = <3</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1658">
						<header>
							<h1>[Conf Sponsor] JS + toi = <3</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839414" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1658">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/js-plus-toi-egal-coeur.php" class="url">[Conf Sponsor] JS + toi = <3</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2014/recherche/javascript" rel="tag">JavaScript</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Si quand on comprend vraiment ses ennemis on ne peut faire autrement que les aimer, alors après ça tu vais aimer JS.</p>

<p>JavaScript, l’un des langages les plus incompris de la planète, en est pourtant devenu le langage n°1… Derrière les trucs surprenants, les quelques verrues, les syntaxes inattendues, doit donc bien se cacher une grosse valeur intrinsèque. Car oui, JS n’est pas Voldemort, mais un vrai Good Guy, c’est juste qu’il a eu une enfance pas facile.</p>

<p>En 30 minutes, Christophe va tenter d’éclaircir trois gros points traditionnels d’incompréhension de JS : le binding (« pourquoi this vaut ça, là ? »), les closures, et les prototypes (héritage compris). Parce qu’en comprenant les choses, on les apprivoise…</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/christophe-porteneuve.php">Christophe Porteneuve</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Christophe Porteneuve" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Christophe-Porteneuve-thumb-143x143-427.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Christophe conçoit des pages web depuis septembre 1995. Après avoir travaillé sur le premier portail <abbr title="JavaServer Pages">JSP</abbr> en Europe, il dirige la filière <abbr title="Institut Supérieur d'Informatique Appliquée">INSIA</abbr> où il y enseigne les nouvelles technologies puis est directeur technique d'une agence web pendant 5 ans. Auteur du best-seller « Bien développer pour le Web 2.0 » chez Eyrolles, il a également écrit la référence « Prototype and script.aculo.us » chez Pragmatic Programmers.<br /><br />

Il est aujourd’hui fondateur et directeur technique de Delicious Insights, qui tout en travaillant sur des SaaS B2B à venir conçoit et propose les cycles de formation Git Attitude et JS Attitude. Vous pouvez le suivre sur <a href="http://twitter.com/porteneuve">@porteneuve</a>.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/js-plus-toi-egal-coeur.php&amp;ref=prez-js-plus-toi-egal-coeur&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
