...
<title>Paris Web - Les clés pour s'orienter dans un projet libre</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/finissons-en-ensemble-avec-le-mythe-du-responsive-web-design-lent.php" title="Finissons-en ensemble avec le mythe du Responsive web Design lent" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/dejeuner-1.php" title="Déjeuner" />
	...
	<meta name="twitter:title" content="Les clés pour s'orienter dans un projet libre" />
	<meta property="twitter:description" content="Dans votre métier, vous utilisez énormément de projets libres: jQuery, Symfony, node, grunt, Firefox, MySQL, et j'en passe. Il est sans doute arrivé que vous trouviez un problème, voire que vous le…" />
	<meta property="dc:title" content="Les clés pour s'orienter dans un projet libre" />
	<meta property="og:title" content="Les clés pour s'orienter dans un projet libre" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/les-cles-pour-sorienter-dans-un-projet-libre.php" />
	<meta property="og:description" content="Dans votre métier, vous utilisez énormément de projets libres: jQuery, Symfony, node, grunt, Firefox, MySQL, et j'en passe. Il est sans doute arrivé que vous trouviez un problème, voire que vous le…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les clés pour s'orienter dans un projet libre</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1600">
						<header>
							<h1>Les clés pour s'orienter dans un projet libre</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1600">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/les-cles-pour-sorienter-dans-un-projet-libre.php" class="url">Les clés pour s'orienter dans un projet libre</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a></dd>
    ...
    <div class="talk-description"><p>Dans votre métier, vous utilisez énormément de projets libres: jQuery, Symfony, node, grunt, Firefox, MySQL, et j'en passe. Il est sans doute arrivé que vous trouviez un problème, voire que vous le corrigiez dans votre projet, sans envoyer la correction au projet initial faute de savoir comment s'y prendre.</p>

<p>On va voir ça ensemble !</p>

<p>Cet atelier sera divisé en deux parties.</p>

<p>Dans la première partie, nous évoquerons les différentes composantes d'un projet libre, afin que vous puissiez vous orienter dans tout ce jargon. Puis j'aimerais que nous échangions autour de vos expériences de contribution : avez-vous déjà essayé de contribuer, qu'est-ce qui vous a arrêté, etc.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/julien-wajsberg.php">Julien Wajsberg</a></h2>
