...
<title>Paris Web - Exploring PayPal’s Bootstrap Accessibility Plugin</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/les-recettes-du-web-multi-ecran.php" title="Les recettes du web multi-écran" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-3.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Exploring PayPal’s Bootstrap Accessibility Plugin" />
	<meta property="twitter:description" content="Learn what accessibility issues exist in the popular front-end framework Bootstrap, and how to fix them with the PayPal Bootstrap Accessibility Plugin. Several components will be demonstrated…" />
	<meta property="dc:title" content="Exploring PayPal’s Bootstrap Accessibility Plugin" />
	<meta property="og:title" content="Exploring PayPal’s Bootstrap Accessibility Plugin" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/exploring-paypals-bootstrap-accessibility-plugin.php" />
	<meta property="og:description" content="Learn what accessibility issues exist in the popular front-end framework Bootstrap, and how to fix them with the PayPal Bootstrap Accessibility Plugin. Several components will be demonstrated…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Exploring PayPal’s Bootstrap Accessibility Plugin</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1665">
						<header>
							<h1>Exploring PayPal’s Bootstrap Accessibility Plugin</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/114950687" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1665">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/exploring-paypals-bootstrap-accessibility-plugin.php" class="url">Exploring PayPal’s Bootstrap Accessibility Plugin</a></span></span></h2>
...
<dd class="column">
11 <abbr title="heures">h</abbr> 10
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge">Traduction <abbr title="français">FR</abbr></span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>
    ...
    <div class="talk-description" lang="en"><span lang="en"><p>Learn what accessibility issues exist in the popular front-end framework Bootstrap, and how to fix them with the PayPal Bootstrap Accessibility Plugin.<br />
Several components will be demonstrated including tooltip, modal, and dropdown. Code will be examined thoroughly, including how WAI-ARIA can greatly improve screen reader accessibility. Conventions for keyboard interactions will also covered.</p></span>

<span lang="fr"><p>Apprenez quels problèmes d'accessibilité existent dans le framework Bootstrap, et comment les corriger grâce au plugin PayPal Bootstrap Accessibility.<br />
De nombreux composants seront passés à la loupe, incluant les info-bulles, les fenêtres modales et les menus déroulants. Le code sera passé en revu, notamment comment WAI-ARIA peut grandement améliorer l'accessibilité pour lecteur d'écran. Des conventions pour l’interaction au clavier seront aussi abordés.</p></span></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/dennis-lembree.php">Dennis Lembree</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Dennis Lembree" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Dennis-Lembree-thumb-143x143-429.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Mr. Lembree is an experienced web developer who is passionate about the
user experience. He works on the accessibility team at PayPal and has
previously worked for several start-up companies and also contracted at
Google, Ford, and Disney. Mr. Lembree has presented at numerous
conferences and webinars including the Annual International Technology and
Persons with Disabilities Conference (CSUN) and the HTML5 Developer
Conference. His personal projects include EasyChirp.org, an award-winning
web-accessible Twitter app, and WebAxe.org, a blog and podcast on web
accessibility. He resides in Cupertino, California USA with his wife and
two boys.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/exploring-paypals-bootstrap-accessibility-plugin.php&amp;ref=prez-exploring-paypals-bootstrap-accessibility-plu&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
