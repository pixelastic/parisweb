...
<title>Paris Web - Présentation des outils de tests Cross Browser</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/chan.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/intitules-de-poste-bas-les-masques.php" title="Intitulés de poste : bas les masques !" />
	...
	<meta name="twitter:title" content="Présentation des outils de tests Cross Browser" />
	<meta property="twitter:description" content="De nos jours, mettre en production une application web c’est la mettre à disposition sur un nombre vertigineux de combinaisons os/browser. Mac OS, Windows, Linux, Iphone, Android, Chrome, Firefox… et…" />
	<meta property="dc:title" content="Présentation des outils de tests Cross Browser" />
	<meta property="og:title" content="Présentation des outils de tests Cross Browser" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/presentation-des-outils-de-tests-cross-browser.php" />
	<meta property="og:description" content="De nos jours, mettre en production une application web c’est la mettre à disposition sur un nombre vertigineux de combinaisons os/browser. Mac OS, Windows, Linux, Iphone, Android, Chrome, Firefox… et…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Présentation des outils de tests Cross Browser</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1622">
						<header>
							<h1>Présentation des outils de tests Cross Browser</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113843837" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1622">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/presentation-des-outils-de-tests-cross-browser.php" class="url">Présentation des outils de tests Cross Browser</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/integration" rel="tag">intégration</a><br /><a href="http://www.paris-web.fr/2014/recherche/metier" rel="tag">métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>De nos jours, mettre en production une application web c’est la mettre à disposition sur un nombre vertigineux de combinaisons os/browser. Mac OS, Windows, Linux, Iphone, Android, Chrome, Firefox… et le nombre de combinaisons ne fait qu’augmenter.</p>

<p>Du coup il devient coûteux voire illusoire de vouloir disposer de ces environnements pour tester notre application. La bonne nouvelle c’est qu’il existe une panoplie d’outils qui vont vous faciliter la tâche à coup de tests live ou automatisés, de comparaisons de screenshots, de partage de screencasts… Je vous propose un tour d’horizon de ces nouveaux acteurs du testing, leurs fonctionnalités, leurs atouts et leurs faiblesses.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/cyril-balit.php">Cyril Balit</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Cyril Balit" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Cyril%20Balit-thumb-143x143-413.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Cyril Balit est architecte RIA dans la société Sfeir.
Après un parcours atypique de biologie, du Cobol, du VB et du Java, Cyril découvre le développement web au début des années 2000 en créant le projet open source Rialto. Il s’intéresse par la suite au développement Flex et mobile mais il se recentre finalement sur les problématiques de qualité et d’industrialisation.</p>

<p>Actuellement Cyril encadre une équipe de développeurs frontend spécialisée dans le développement d’applications RIA (Node, Angular, Backbone) et les problématiques d’industrialisation (usine de développement, intégration continue, cloud)</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/presentation-des-outils-de-tests-cross-browser.php&amp;ref=prez-presentation-des-outils-de-tests-cross-browse&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
