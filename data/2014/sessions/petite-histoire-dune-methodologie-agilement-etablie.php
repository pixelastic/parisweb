...
<title>Paris Web - Petite histoire d’une méthodologie agilement établie</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/responsive-web-typography.php" title="Responsive Web Typography" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/informelles.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Petite histoire d’une méthodologie agilement établie" />
	<meta property="twitter:description" content="Plus besoin aujourd'hui de présenter les méthodes agiles qui axent la réussite d'un projet sur des contraintes de communication, d'intégration du client au process de création du projet, de…" />
	<meta property="dc:title" content="Petite histoire d’une méthodologie agilement établie" />
	<meta property="og:title" content="Petite histoire d’une méthodologie agilement établie" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/petite-histoire-dune-methodologie-agilement-etablie.php" />
	<meta property="og:description" content="Plus besoin aujourd'hui de présenter les méthodes agiles qui axent la réussite d'un projet sur des contraintes de communication, d'intégration du client au process de création du projet, de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Petite histoire d’une méthodologie agilement établie</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1613">
						<header>
							<h1>Petite histoire d’une méthodologie agilement établie</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839944" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1613">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/petite-histoire-dune-methodologie-agilement-etablie.php" class="url">Petite histoire d’une méthodologie agilement établie</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/agile" rel="tag">Agile</a><br /><a href="http://www.paris-web.fr/2014/recherche/methodologie" rel="tag">méthodologie</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/alexandre-jakubiak.php">Alexandre Jakubiak</a> et <a href="https://www.paris-web.fr/2014/../orateurs/julien-oger.php">Julien Oger</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Alexandre Jakubiak" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Alexandre-Jakubiak-thumb-143x143-424.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Chef de projet au sein de l'équipe de développement de GLOBALIS media systems depuis 2013, Alexandre a plus d'une dizaine d'années d'expérience dans le développement PHP et en gestion de projets. Il gère aujourd'hui des projets tant au forfait qu'en TMA, pour différents types de clients du petit au grand compte.</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Julien Oger" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Julien-Oger-thumb-143x143-431.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Chef de Projet chez GLOBALIS media systems depuis 7 ans, Julien travaille dans le web depuis une dizaine d'années pour de petits et grands comptes (BNP, Saint-Gobain, Fédération Française de couture, SNCF, etc.) sur des sujets aussi divers que de l'assistance MOA, audit organisationnel, gestion de projet au forfait, organisation de TMA.</p>

<p>Julien est également responsable de l'organisation des méthodes de travail dans la société et a participé à l'élaboration d'une méthode de travail adaptée aux besoins de GLOBALIS en empruntant à Scrum, Xtrem programming et Crystal Clear. Vous pouvez le suivre sur <a href="http://twitter.com/JulienOG">@JulienOG</a></p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/petite-histoire-dune-methodologie-agilement-etablie.php&amp;ref=prez-petite-histoire-dune-methodologie-agilement-e&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
