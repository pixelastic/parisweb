...
<title>Paris Web - Qualité web : l’heure de passer à la caisse</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/science-fiction-interaction.php" title="Science-fiction &amp; interaction !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/changement-de-salle.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Qualité web : l’heure de passer à la caisse" />
	<meta property="twitter:description" content="Dans un projet web lambda, il y a des choses qui ne se passent pas toujours très bien. Dans beaucoup de projets ces petits défauts, ces coûts de non qualité finissent par coûter très cher. Quels…" />
	<meta property="dc:title" content="Qualité web : l’heure de passer à la caisse" />
	<meta property="og:title" content="Qualité web : l’heure de passer à la caisse" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/qualite-web-lheure-de-passer-a-la-caisse.php" />
	<meta property="og:description" content="Dans un projet web lambda, il y a des choses qui ne se passent pas toujours très bien. Dans beaucoup de projets ces petits défauts, ces coûts de non qualité finissent par coûter très cher. Quels…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Qualité web : l’heure de passer à la caisse</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1610">
						<header>
							<h1>Qualité web : l’heure de passer à la caisse</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839946" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1610">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/qualite-web-lheure-de-passer-a-la-caisse.php" class="url">Qualité web : l’heure de passer à la caisse</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/methodologie" rel="tag">méthodologie</a><br /><a href="http://www.paris-web.fr/2014/recherche/qualite" rel="tag">qualité</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Dans un projet web lambda, il y a des choses qui ne se passent pas toujours très bien.</p>

<p>Dans beaucoup de projets ces petits défauts, ces coûts de non qualité finissent par coûter très cher. Quels sont-ils ? Combien coûtent-ils ? Comment est-il possible et combien coûte-t'il de les prévenir ?</p>

<p>Et si cette problématique n'était pas uniquement du ressort du gestionnaire ?</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/elie-sloim.php">Élie Sloïm</a> et <a href="https://www.paris-web.fr/2014/../orateurs/nicolas-hoffmann.php">Nicolas Hoffmann</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Élie Sloïm" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Elie%20Sloim-thumb-143x143-415.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Élie Sloïm est Président de la société Temesis, spécialisée sur la qualité et l’accessibilité des sites Internet. Il dirige depuis 2004 le projet Opquast (Open Quality Standards). Le projet Opquast inclut des référentiels (Opquast bonnes pratiques) et des outils de gestion de projet orientés qualité (Opquast Reporting).</p>

<p>Élie Sloïm est consultant, formateur et conférencier. À ce titre, il intervient dans de nombreuses manifestations, entreprises et cursus de formation en France et à l’étranger. Il s’est spécialisé sur la création de référentiels. Il a notamment travaillé sur la production du RGAA, des bonnes pratiques Opquast, et de nombreux autres référentiels publics ou privés.</p>

<p>Auteur de plus d’une centaine d’articles sur la qualité web, il assure la direction actuelle du projet OpenWeb. Il est également l’auteur avec les contributeurs du projet Opquast du memento « Site Web : les bonnes pratiques », publié chez Eyrolles et préfacier des ouvrages « CSS2 » par Raphaël Goetter, « Ergonomie Web » par Amélie Boucher et « Card Sorting » de Gautier Barrère et Eric Mazzone. Vous pouvez le suivre sur <a href="http://twitter.com/Eliesl">@Eliesl</a>.</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Nicolas Hoffmann" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Nicolas-Hoffmann-thumb-143x143-432.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Nicolas est développeur front-end depuis une dizaine d'années en web agency en Suisse. Son quotidien est de dompter la créativité de ses graphistes par le truchement des CSS, le tout avec un niveau d'exigence qualitatif proche de l'horlogerie suisse, mais sans faire coucou. </p>

<p>Co-directeur du collectif OpenWeb, il lui arrive de commettre quelques infidélités à ce dernier pour Alsacréations, le Train de 13H37, w3qualité, Opquast, etc. mais il ne s'éloigne jamais longtemps de ce dernier… sauf à la rigueur pour quelques conférences. Vous pouvez le suivre sur <a href="http://twitter.com/Nico3333fr">@Nico3333fr</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/qualite-web-lheure-de-passer-a-la-caisse.php&amp;ref=prez-qualite-web-lheure-de-passer-a-la-caisse&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
