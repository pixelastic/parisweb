...
<title>Paris Web - Le burnout et comment on l'évite</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/changement-de-salle-4.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/sponsor-microsoft.php" title="[Conf Sponsor] Microsoft — Introduction à TypeScript et retour d'expérience sur le portage de BabylonJS" />
	...
	<meta name="twitter:title" content="Le burnout et comment on l'évite" />
	<meta property="twitter:description" content="Rentrer en surchauffe (oui, c'est la traduction de burnout, en fait), c'est finir par ne plus avoir les neurones qui réagissent, les nerfs en vrac, et la plupart du temps ne s'en rendre compte que…" />
	<meta property="dc:title" content="Le burnout et comment on l'évite" />
	<meta property="og:title" content="Le burnout et comment on l'évite" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/le-burnout-et-comment-on-levite.php" />
	<meta property="og:description" content="Rentrer en surchauffe (oui, c'est la traduction de burnout, en fait), c'est finir par ne plus avoir les neurones qui réagissent, les nerfs en vrac, et la plupart du temps ne s'en rendre compte que…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le burnout et comment on l'évite</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1629">
						<header>
							<h1>Le burnout et comment on l'évite</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939052" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1629">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/le-burnout-et-comment-on-levite.php" class="url">Le burnout et comment on l'évite</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/metier" rel="tag">métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Rentrer en surchauffe (oui, c'est la traduction de burnout, en fait), c'est finir par ne plus avoir les neurones qui réagissent, les nerfs en vrac, et la plupart du temps ne s'en rendre compte que trop tard. Par chance, cette fois-ci j'ai pu le prévenir. Quelques pistes pour éviter que ça vous arrive aussi.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/stephane-deschamps.php">Stéphane Deschamps</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Stéphane Deschamps" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Stephane%20Deschamps-thumb-143x143-407.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Stéphane est tombé dans le web en 1996 avant de devenir intégrateur en 1999. D'agence en agence, il est ensuite allé chez France Telecom pour devenir responsable technique du pôle Accessibilité Groupe. Il est maintenant directeur de Clever Garden, l'entité front-end de <a href="http://fr.clever-age.com/">Clever Age</a>, où il fait du conseil en pilotage de la qualité web et de l'expertise front.</p>

<p>Membre du collectif <a href="http://openweb.eu.org/">Openweb</a>, fondateur de Paris Web, préfacier de plusieurs livres, dont <cite><a href="http://qualite-web-lelivre.com/">Qualité web, Les bonnes pratiques pour améliorer vos sites</a></cite> (formidable initiative de <a href="http://temesis.com/">Temesis</a>) et <cite><a href="http://miam.redisdead.net/#sansbeurre">Sans beurre et sans reproches</a></cite> par <a href="http://www.redisdead.net/">Laurence Vagner</a>, il écrit de temps en temps sur son <a href="http://nota-bene.org/">site perso</a> (comme on disait avant), mais commet aussi des photos floues, des textes de chansons approximatifs, et aime mettre plein de liens dans sa biographie pour faire croire qu'il connaît du monde.</p>

<p>Malgré tous ses efforts pour faire parler de lui en bons termes, sa notoriété lui vient principalement des calembours encore plus approximatifs qu'il fait subir à son entourage.</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/le-burnout-et-comment-on-levite.php&amp;ref=prez-le-burnout-et-comment-on-levite&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
