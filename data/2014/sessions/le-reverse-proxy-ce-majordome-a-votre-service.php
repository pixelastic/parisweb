...
<title>Paris Web - Le Reverse Proxy, ce majordome à votre service</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-2.php" title="Informelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/p.php" title="Pause" />
	...
	<meta name="twitter:title" content="Le Reverse Proxy, ce majordome à votre service" />
	<meta property="twitter:description" content="Avec l'arrivée de PHP-FPM et la fin des mod_* d'Apache, nous glissons nécessairement vers une configuration à base de reverse proxys. Au travers de l'histoire de l'évolution d'un site, vous verrez…" />
	<meta property="dc:title" content="Le Reverse Proxy, ce majordome à votre service" />
	<meta property="og:title" content="Le Reverse Proxy, ce majordome à votre service" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/le-reverse-proxy-ce-majordome-a-votre-service.php" />
	<meta property="og:description" content="Avec l'arrivée de PHP-FPM et la fin des mod_* d'Apache, nous glissons nécessairement vers une configuration à base de reverse proxys. Au travers de l'histoire de l'évolution d'un site, vous verrez…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le Reverse Proxy, ce majordome à votre service</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1623">
						<header>
							<h1>Le Reverse Proxy, ce majordome à votre service</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939053#t=18m16s" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1623">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/le-reverse-proxy-ce-majordome-a-votre-service.php" class="url">Le Reverse Proxy, ce majordome à votre service</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/backend" rel="tag">backend</a><br /><a href="http://www.paris-web.fr/2014/recherche/performance" rel="tag">performance</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Avec l'arrivée de PHP-FPM et la fin des mod_* d'Apache, nous glissons nécessairement vers une configuration à base de reverse proxys. Au travers de l'histoire de l'évolution d'un site, vous verrez comment un reverse proxy peut être déployer pour vous permettre d'offrir un accès SSL, faire de la sécurité, de la répartition de charge, gérer vos périodes de maintenances, faire de la webperformance, etc.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/nicolas-steinmetz.php">Nicolas Steinmetz</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Nicolas Steinmetz" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Nicolas%20Steinmetz-thumb-143x143-405.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Curieux insatiable et généraliste du web touchant à tout ce qu'il trouve. Focalisé tant sur les usages que la technique, je cherche à concilier les deux pour répondre aux besoins de mes utilisateurs et à leurs problématiques.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/le-reverse-proxy-ce-majordome-a-votre-service.php&amp;ref=prez-le-reverse-proxy-ce-majordome-a-votre-service&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
