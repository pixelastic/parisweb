...
<title>Paris Web - Intitulés de poste : bas les masques !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/presentation-des-outils-de-tests-cross-browser.php" title="Présentation des outils de tests Cross Browser" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/dejeuner.php" title="Déjeuner" />
	...
	<meta name="twitter:title" content="Intitulés de poste : bas les masques !" />
	<meta property="twitter:description" content="La vision simpliste « Moi développeur, toi graphiste » est une illusion dangereuse. À force d'y croire, on se rouille du cerveau, alors que tout le monde a la capacité de créer, rêver, rebondir et…" />
	<meta property="dc:title" content="Intitulés de poste : bas les masques !" />
	<meta property="og:title" content="Intitulés de poste : bas les masques !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/intitules-de-poste-bas-les-masques.php" />
	<meta property="og:description" content="La vision simpliste « Moi développeur, toi graphiste » est une illusion dangereuse. À force d'y croire, on se rouille du cerveau, alors que tout le monde a la capacité de créer, rêver, rebondir et…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Intitulés de poste : bas les masques !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1628">
						<header>
							<h1>Intitulés de poste : bas les masques !</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2014/slides/Goulwen_Champenois_—_Intitulés_de_poste.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1628">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/intitules-de-poste-bas-les-masques.php" class="url">Intitulés de poste : bas les masques !</a></span></span></h2>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>La vision simpliste « Moi développeur, toi graphiste » est une illusion dangereuse. À force d'y croire, on se rouille du cerveau, alors que tout le monde a la capacité de créer, rêver, rebondir et échanger autour des besoins et contraintes de chaque projet pour les emmener encore plus loin. Redevenons curieux et flinguons les mythes de l'ingénieur qui-sait-tout, du designer artiste et du développeur binaire.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/goulven-champenois.php">Goulven Champenois</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Goulven Champenois" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-GoulvenChampenois-thumb-143x143-442.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Depuis bientôt 10 ans qu'il est tombé dans le Web, Goulven n'a de cesse d'améliorer l'ergonomie et l'accessibilité, un site à la fois ou —plus ambitieusement— en diffusant les connaissances par les traductions de Pompage, en donnant et en organisant des conférences. À l’aise tant pour la définition des besoins que pour la conception, le développement et l’intégration responsive, sa vue d’ensemble lui permet de prendre en compte les besoins utilisateurs à toutes les étapes projet. Vous pouvez le suivre sur <a href="http://twitter.com/goulvench">@goulvench</a></p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/intitules-de-poste-bas-les-masques.php&amp;ref=prez-intitules-de-poste-bas-les-masques&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
