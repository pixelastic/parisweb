...
<title>Paris Web - Créer un clone de WhatsApp en HTML5</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/reutiliser-son-javascript-cote-serveur-et-cote-client.php" title="Réutiliser son JavaScript côté serveur et côté client" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/votre-site-web-est-il-lisible-comprehensible-et-utilisable-par-tous.php" title="Votre site web est-il lisible, compréhensible et utilisable par tous ?" />
	...
	<meta name="twitter:title" content="Créer un clone de WhatsApp en HTML5" />
	<meta property="twitter:description" content="Peut-on considérer le HTML5 comme une technologie mature pour la réalisation d'applications mobile ? Qu'en est-il de l'interface graphique ? A-t-on accès aux mêmes APIs internes que les applications…" />
	<meta property="dc:title" content="Créer un clone de WhatsApp en HTML5" />
	<meta property="og:title" content="Créer un clone de WhatsApp en HTML5" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/creer-un-clone-de-whatsapp-en-html5.php" />
	<meta property="og:description" content="Peut-on considérer le HTML5 comme une technologie mature pour la réalisation d'applications mobile ? Qu'en est-il de l'interface graphique ? A-t-on accès aux mêmes APIs internes que les applications…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Créer un clone de WhatsApp en HTML5</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1636">
						<header>
							<h1>Créer un clone de WhatsApp en HTML5</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1636">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/creer-un-clone-de-whatsapp-en-html5.php" class="url">Créer un clone de WhatsApp en HTML5</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2014/recherche/mobile" rel="tag">mobile</a></dd>
    ...
    <div class="talk-description"><p>Peut-on considérer le HTML5 comme une technologie mature pour la réalisation d'applications mobile ?</p>

<ul>
<li>Qu'en est-il de l'interface graphique ?</li>
<li>A-t-on accès aux mêmes APIs internes que les applications natives ?</li>
<li>Quels sont les différents outils de développement ?</li>
<li>Quid du debugging ?</li>
<li>Le code multiplateforme est-il une réalité ou un mythe ?</li>
</ul>

<p>Pendant ce workshop, j'utiliserai AngularJS, Ionic Framework, Gulp, Cordova et sûrement d'autres outils annexes tel une API de gestion de notifications comme Urban Airship, Parse ou autre.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/yacine-rezgui.php">Yacine Rezgui</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Yacine Rezgui" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Yacine-Rezgui-thumb-143x143-449.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Je suis développeur web depuis plusieurs années. Je me suis spécialisé dans le fullstack JavaScript et j'expérimente toutes les nouveautés relatives au HTML5, bases de données orientées document/graph, le cloud hosting dans ses différentes natures. J'ai donné plusieurs talks à des meetups différents à Nice, Paris et Londres. Je suis organisateur du London Phonegap Meetup.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/creer-un-clone-de-whatsapp-en-html5.php&amp;ref=prez-creer-un-clone-de-whatsapp-en-html5&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
