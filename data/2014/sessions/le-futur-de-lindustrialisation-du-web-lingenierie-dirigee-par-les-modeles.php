...
<title>Paris Web - Le futur de l'industrialisation du web : l'ingénierie dirigée par les modèles</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-7.php" title="Informelles" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/le-design-dinterface-et-la-theorie-de-la-gestalt.php" title="Le design d'interface et la théorie de la Gestalt" />
	...
	<meta name="twitter:title" content="Le futur de l'industrialisation du web : l'ingénierie dirigée par les…" />
	<meta property="twitter:description" content="La conception d'interfaces web est de plus en plus complexe : les navigateurs, terminaux et plateformes permettant d'accéder au web sont de plus en plus nombreux et divers, de même que les…" />
	<meta property="dc:title" content="Le futur de l'industrialisation du web : l'ingénierie dirigée par les modèles" />
	<meta property="og:title" content="Le futur de l'industrialisation du web : l'ingénierie dirigée par les modèles" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/le-futur-de-lindustrialisation-du-web-lingenierie-dirigee-par-les-modeles.php" />
	<meta property="og:description" content="La conception d'interfaces web est de plus en plus complexe : les navigateurs, terminaux et plateformes permettant d'accéder au web sont de plus en plus nombreux et divers, de même que les…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le futur de l'industrialisation du web : l'ingénierie dirigée par les modèles</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1631">
						<header>
							<h1>Le futur de l'industrialisation du web : l'ingénierie dirigée par les modèles</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939050#t=15m33s" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2014/slides/Alain-Vagner.industrialisation_du_web.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1631">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/le-futur-de-lindustrialisation-du-web-lingenierie-dirigee-par-les-modeles.php" class="url">Le futur de l'industrialisation du web : l'ingénierie dirigée par les modèles</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2014/conferences/mini-conferences/">Mini-<abbr title="conférence">conf</abbr></a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/">Salle Mœbius</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2014/17.php">vendredi 17</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
16 <abbr title="heures">h</abbr> 35
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/methodologie" rel="tag">méthodologie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>La conception d'interfaces web est de plus en plus complexe : les navigateurs, terminaux et plateformes permettant d'accéder au web sont de plus en plus nombreux et divers, de même que les utilisateurs et leurs contextes d'usage. Si l'on souhaite faire une interface web de qualité, l'ensemble des facettes à couvrir et donc des compétences nécessaires ne cesse de croître (utilité, utilisabilité, accessibilité, design graphique, design émotionnel, expérience utilisateur, sécurité, robustesse, performance, etc.).</p>

<p>On entend souvent parler de l'industrialisation du web pour gérer toute cette complexité, mais les solutions actuelles pour cette industrialisation sont essentiellement des méthodes (non outillées) qui couvrent partiellement le processus de conception d'une interface web.
L'ingénierie dirigée par les modèles (IDM, ou model-driven engineering, MDE en anglais) est une approche de développement logiciel qui devrait permettre d'apporter dans un avenir proche une solution globale au problème d'industrialisation du web. Elle est actuellement appliquée à la conception de systèmes industriels complexes et fait l'objet de travaux de recherche depuis une dizaine d'années dans le but d'appliquer ces résultats à la conception d'interfaces web.</p>

<p>Cette présentation permettra de découvrir ce qu'est l'IDM, comment l'appliquer concrètement au web et ses principaux bénéfices (automatisation des tâches répétitives, capitalisation des savoirs et savoir-faire, support à la collaboration dans les équipes pluridisciplinaires, vérification de la qualité).
Cette présentation sera illustrée d'exemples concrets et montrera les environnements logiciels actuellement disponibles pour mettre en place une démarche IDM dans vos projets.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/alain-vagner.php">Alain Vagner</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Alain Vagner" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Alain%20Vagner-thumb-143x143-397.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Ingénieur, chercheur, chef de projet, développeur, responsable produit, hacker, architecte, consultant (rayez les mentions inutiles) dans la recherche publique Luxembourgeoise [1] depuis une dizaine d&#8217;années, Alain Vagner a une obsession : développer efficacement des interfaces utilisateurs de qualité. Dans le domaine de l&#8217;ingénierie logicielle pour l&#8217;interaction Homme-machine, il participe à la définition et à la réalisation de plusieurs projets de recherche nationaux (ex: [2]) et accompagne les entreprises luxembourgeoises dans leurs projets de R&amp;D. Parallèlement, il fût membre de l’équipe de développement du blogware open source Dotclear [3] et membre fondateur des associations FLUPA (association &#8220;France - Luxembourg&#8221; des spécialistes de l’utilisabilité [4]) et COIN (promotion de la création vidéoludique dans l&#8217;Est de la France [5]). </p>

<p>Liens utiles :
[1] CRP Henri Tudor: http://www.tudor.lu
[2] Projet MoDEL: http://www.tudor.lu/fr/projets/model
[3] Projet Dotclear: http://www.dotclear.org
[4] Association FLUPA: http://www.flupa.eu
[5] Association COIN: http://www.extra-coin.fr</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/le-futur-de-lindustrialisation-du-web-lingenierie-dirigee-par-les-modeles.php&amp;ref=prez-le-futur-de-lindustrialisation-du-web-lingeni&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
