...
<title>Paris Web - Les outils des designers web : l’ère post-Adobe</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/un-jeu-web-accessible-avec-html-5-javascript-et-aria.php" title="Un jeu web accessible avec HTML 5, JavaScript et ARIA" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/reutiliser-son-javascript-cote-serveur-et-cote-client.php" title="Réutiliser son JavaScript côté serveur et côté client" />
	...
	<meta name="twitter:title" content="Les outils des designers web : l’ère post-Adobe" />
	<meta property="twitter:description" content="Photoshop et Illustrator sont peut-être des logiciels très puissants mais ils ne sont pas spécifiquement dédiés à la conception graphique de sites web. Quant à Fireworks, bien que spécifique cette…" />
	<meta property="dc:title" content="Les outils des designers web : l’ère post-Adobe" />
	<meta property="og:title" content="Les outils des designers web : l’ère post-Adobe" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/les-outils-des-designers-web-lre-post-adobe.php" />
	<meta property="og:description" content="Photoshop et Illustrator sont peut-être des logiciels très puissants mais ils ne sont pas spécifiquement dédiés à la conception graphique de sites web. Quant à Fireworks, bien que spécifique cette…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les outils des designers web : l’ère post-Adobe</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1593">
						<header>
							<h1>Les outils des designers web : l’ère post-Adobe</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2014/slides/Benoit_Vrins-Outils_ere_post-adobe.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1593">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/les-outils-des-designers-web-lre-post-adobe.php" class="url">Les outils des designers web : l’ère post-Adobe</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/design" rel="tag">design</a></dd>
    ...
    <div class="talk-description"><p>Photoshop et Illustrator sont peut-être des logiciels très puissants mais ils ne sont pas spécifiquement dédiés à la conception graphique de sites web. Quant à Fireworks, bien que spécifique cette fois au web, il n’a jamais réussi à conquérir sa place de marché.</p>

<p>Les métiers du web, eux, ont évolué plus vite que les outils de conception mis à disposition par la Creative Suite. Il était donc normal de voir apparaître une quantité de nouveaux outils sur le marché développés de façon plus artisanale mais toujours par des passionnés. Et la bonne nouvelle, c'est que de nombreux outils atteignent désormais un très bon niveau!</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/benoit-vrins.php">Benoit Vrins</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Benoit Vrins" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Benoit%20Vrins-thumb-143x143-399.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Benoît Vrins conçoit des sites web depuis plus de 10 ans. Ayant suivi de près les tendances et évolutions du web durant toute cette décennie, il aide les personnes, les sociétés et les associations dans le processus de création d’un site web. Il tient le rôle de "Creative Director" au sein de l'agence de communication Spade à Bruxelles.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/les-outils-des-designers-web-lre-post-adobe.php&amp;ref=prez-les-outils-des-designers-web-lre-post-adobe&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
