...
<title>Paris Web - Web Components, the right way</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/interactions-animations-et-interfaces.php" title="Interactions : Animations et interfaces" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/chan.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Web Components, the right way" />
	<meta property="twitter:description" content=" Web Components, the right way Web Component are to developers what catnip is to cats, or roast beef is to English and Americans. Yes, that exciting, because they're so powerful. But with the power…" />
	<meta property="dc:title" content="Web Components, the right way" />
	<meta property="og:title" content="Web Components, the right way" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/web-components-the-right-way.php" />
	<meta property="og:description" content=" Web Components, the right way Web Component are to developers what catnip is to cats, or roast beef is to English and Americans. Yes, that exciting, because they're so powerful. But with the power…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Web Components, the right way</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1659">
						<header>
							<h1>Web Components, the right way</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939760" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1659">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/web-components-the-right-way.php" class="url">Web Components, the right way</a></span></span></h2>
...
<dd class="column">
11 <abbr title="heures">h</abbr> 30
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2014/recherche/integration" rel="tag">intégration</a></dd>
...
<strong>Web Components, the right way</strong>
<p>Web Component are to developers what catnip is to cats, or roast beef is to English and Americans. Yes, that exciting, because they're so powerful. But with the power to write your own shiny HTML elements, you lose all the built-in goodies that browsers give you with existing elements. Bruce, un rosbif, and Karl, un bifburger, will show you how to write web components that extend the web platform without losing what's great about it.</p>
</div>

<div lang="fr">
<strong>Les <span lang="en">Web Components</span>, la marche à suivre</strong>
<p>Les Web Components sont aux développeurs ce que l’herbe à chats est aux
chats, ou le roastbeef aux Britanniques.  Oui, ça fait à ce point
saliver, parce qu'ils sont énormément puissants.  Mais pouvoir écrire
vos propres éléments HTML tout chatoyants a un prix : vous perdez tous
les avantages automatiques des éléments natifs fournis par les
navigateurs.  Bruce, qui est un rosbif, et Karl, plutôt un burger, vous
montreront comment écrire des Web Components qui étendent la plate-forme
web sans perdre tout ce qu'elle a déjà de bien.</p>
</div>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/bruce-lawson.php">Bruce Lawson</a> et <a href="https://www.paris-web.fr/2014/../orateurs/karl-groves.php">Karl Groves</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Bruce Lawson" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Bruce-Lawson-thumb-143x143-426.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><p>Bruce is an open web standards advocate for Opera, the European browser. He's previously been tech lead for a large UK legal website, a tarot card reader, guitarist, tutor to a princess and Bollywood movie extra. Follow him at <a href="https://twitter.com/brucel" title="@brucel">@brucel</a>, read him at <a href="http://brucelawson.co.uk" title="brucelawson.co.uk">brucelawson.co.uk</a>, get him drunk at the bar.</p>

<p>Bruce est évangéliste des standards du web ouvert pour Opera, le navigateur européen. Auparavant, il a été chef technique pour un site web juridique Britannique à fort trafic, lecteur de cartes à tarot, guitariste, tuteur d'une princesse et figurant pour des films à Bollywood. Suivez-le <a href="https://twitter.com/brucel" title="@brucel">@brucel</a>, lisez-le sur <a href="http://brucelawson.co.uk" title="brucelawson.co.uk">brucelawson.co.uk</a>, faites-le boire au bar.</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Karl Groves" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Karl%20Groves-thumb-143x143-446.jpg" width="143" height="143">
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/web-components-the-right-way.php&amp;ref=prez-web-components-the-right-way&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
