...
<title>Paris Web - Le web fait pousser mes tomates</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/js-plus-toi-egal-coeur.php" title="[Conf Sponsor] JS + toi = &lt;3" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/pause.php" title="Pause" />
	...
	<meta name="twitter:title" content="Le web fait pousser mes tomates" />
	<meta property="twitter:description" content="La permaculture est un ensemble de pratiques, de principes, et un mode de pensée visant à créer une production agricole durable (Wikipedia). Design, planif, hacktivisme sont quelques uns des nombreux…" />
	<meta property="dc:title" content="Le web fait pousser mes tomates" />
	<meta property="og:title" content="Le web fait pousser mes tomates" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/le-web-fait-pousser-mes-tomates.php" />
	<meta property="og:description" content="La permaculture est un ensemble de pratiques, de principes, et un mode de pensée visant à créer une production agricole durable (Wikipedia). Design, planif, hacktivisme sont quelques uns des nombreux…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Le web fait pousser mes tomates</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1630">
						<header>
							<h1>Le web fait pousser mes tomates</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113843836" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1630">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/le-web-fait-pousser-mes-tomates.php" class="url">Le web fait pousser mes tomates</a></span></span></h2>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/olivier-de-villardi.php">Olivier de Villardi</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Olivier de Villardi" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Olivier-de-Villardi-thumb-143x143-435.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après 7 années à travailler dans le Web (2 ans entrepreneur et 5 ans salarié) je termine actuellement mon année de césure, passée au Canada où j'ai travaillé dans 6 fermes biologiques. Ce changement radical de direction m'a ouvert les yeux sur les similarités qui existent entre ces 2 domaines d'apparence bien différents&nbsp;!</p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/le-web-fait-pousser-mes-tomates.php&amp;ref=prez-le-web-fait-pousser-mes-tomates&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
