...
<title>Paris Web - Les recettes du web multi-écran</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/p.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/exploring-paypals-bootstrap-accessibility-plugin.php" title="Exploring PayPal’s Bootstrap Accessibility Plugin" />
	...
	<meta name="twitter:title" content="Les recettes du web multi-écran" />
	<meta property="twitter:description" content="Au fil des années, la taille de nos écrans a beaucoup évolué. Le concept de responsive design nous a poussé à adapter nos applications web à différents facteurs comme la résolution ou la densité de…" />
	<meta property="dc:title" content="Les recettes du web multi-écran" />
	<meta property="og:title" content="Les recettes du web multi-écran" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/les-recettes-du-web-multi-ecran.php" />
	<meta property="og:description" content="Au fil des années, la taille de nos écrans a beaucoup évolué. Le concept de responsive design nous a poussé à adapter nos applications web à différents facteurs comme la résolution ou la densité de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Les recettes du web multi-écran</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1620">
						<header>
							<h1>Les recettes du web multi-écran</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839942" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1620">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/les-recettes-du-web-multi-ecran.php" class="url">Les recettes du web multi-écran</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2014/recherche/ergonomie" rel="tag">ergonomie</a><br /><a href="http://www.paris-web.fr/2014/recherche/javascript" rel="tag">JavaScript</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Au fil des années, la taille de nos écrans a beaucoup évolué. Le concept de responsive design nous a poussé à adapter nos applications web à différents facteurs comme la résolution ou la densité de pixels.</p>

<p>Un facteur nous résiste encore : le multi-écran. Répandu d’abord dans le milieu informatique, travailler sur deux écrans est devenu de plus en plus courant dans d'autres domaines. Au bureau ou à la maison, c'est souvent un écran fixe qui vient accompagner un ordinateur portable. Il est temps que nos applications web s’adaptent à ce cas de figure et profitent de cet espace pour mieux nous informer et nous servir.</p>

<p>Au menu de cette session : un peu d’ergonomie, dégustation de plusieurs démos fonctionnelles concrètes et analyse des recettes techniques pour les construire.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/hubert-sablonniere.php">Hubert Sablonnière</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Hubert Sablonnière" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Hubert%20Sablonniere-thumb-143x143-402.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Hubert Sablonnière est un développeur Web passionné d’<abbr title="Hypertext Markup Language" lang="en">HTML</abbr>, <abbr title="Cascading Style Sheets" lang="en">CSS</abbr> et JavaScript.</p>
<p>Depuis 5 ans il intervient chez INEAT Conseil en conseil et développement sur des projets Web (desktop et mobile). Habitué des plateformes Java et PHP, sa spécialité reste le JavaScript. Il donne même des cours dessus à l'<abbr title="Institut supérieur de l'électronique et du numérique">ISEN</abbr> Lille.</p>
<p>Quand il lui reste un peu de temps, il bidouille et contribue modestement à quelques projets : Firefox, DZslides… Vous pouvez le suivre sur <a href="http://twitter.com/hsablonniere">@hsablonniere</a>.</p></div>
</div>
