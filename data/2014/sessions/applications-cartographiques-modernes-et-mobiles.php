...
<title>Paris Web - Applications cartographiques modernes et mobiles</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/les-web-components-oui-mais-tout-de-suite.php" title="Les Web Components, oui, mais tout de suite !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/nodejs-demystifie.php" title="Node.js démystifié" />
	...
	<meta name="twitter:title" content="Applications cartographiques modernes et mobiles" />
	<meta property="twitter:description" content="On utilisera le projet Leaflet pour montrer comme il peut être simple de construire une application web cartographique typique, bâtie autour d'une carte dynamique. On fera en sorte que ce site soit…" />
	<meta property="dc:title" content="Applications cartographiques modernes et mobiles" />
	<meta property="og:title" content="Applications cartographiques modernes et mobiles" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/applications-cartographiques-modernes-et-mobiles.php" />
	<meta property="og:description" content="On utilisera le projet Leaflet pour montrer comme il peut être simple de construire une application web cartographique typique, bâtie autour d'une carte dynamique. On fera en sorte que ce site soit…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Applications cartographiques modernes et mobiles</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1596">
						<header>
							<h1>Applications cartographiques modernes et mobiles</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1596">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/applications-cartographiques-modernes-et-mobiles.php" class="url">Applications cartographiques modernes et mobiles</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/cartographie" rel="tag">cartographie</a><br /><a href="http://www.paris-web.fr/2014/recherche/mobile" rel="tag">mobile</a></dd>
    ...
    <div class="talk-description"><p>On utilisera le projet Leaflet pour montrer comme il peut être simple de construire une application web cartographique typique, bâtie autour d'une carte dynamique. On fera en sorte que ce site soit particulièrement adapté au contexte mobile.</p>

<p>On exploitera des données issues d'API open data pour expérimenter sur un cas réel, on utilisera la géolocalisation, et on évoquera des utilisations plus avancées de ces outils.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/benjamin-becquet.php">Benjamin Becquet</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Benjamin Becquet" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Benjamin%20Becquet-thumb-143x143-412.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>J'ai attrapé le goût du mariage informatique+géographie à l'occasion d'un projet à la fin de mes études d'ingénieur, en l'an 3 avant Google Maps. Depuis, ça ne m'a pas lâché. Je travaille depuis 2006 chez Mediamobile, diffuseur de services d'information trafic et d'aide à la mobilité routière. J'y suis entre autres responsable des développements web, pour une variété de projets qui partagent un point commun : l'utilisation de cartographies dynamiques de l'information.
Également attaché aux projets libres, je contribue à OpenStreetMap et à l'écosystème de Leaflet. </p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/applications-cartographiques-modernes-et-mobiles.php&amp;ref=prez-applications-cartographiques-modernes-et-mobi&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
