...
<title>Paris Web - Dark patterns, la contre-attaque du pire</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/mes-projets-web-se-passent-toujours-bien.php" title="Mes projets web se passent toujours bien !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-5.php" title="Informelles" />
	...
	<meta name="twitter:title" content="Dark patterns, la contre-attaque du pire" />
	<meta property="twitter:description" content="Dans une galaxie lointaine, d’obscures forces sont à l’œuvre pour créer des stratégies perverses piégeant les internautes. Nous explorerons en détail et à travers de nombreux exemples ces techniques…" />
	<meta property="dc:title" content="Dark patterns, la contre-attaque du pire" />
	<meta property="og:title" content="Dark patterns, la contre-attaque du pire" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/dark-patterns-la-contre-attaque-du-pire.php" />
	<meta property="og:description" content="Dans une galaxie lointaine, d’obscures forces sont à l’œuvre pour créer des stratégies perverses piégeant les internautes. Nous explorerons en détail et à travers de nombreux exemples ces techniques…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Dark patterns, la contre-attaque du pire</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1609">
						<header>
							<h1>Dark patterns, la contre-attaque du pire</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113838903" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
			...
			<h3>Diaporama</h3>
<iframe 
	src="//www.slideshare.net/slideshow/embed_code/40529076" 
	...
	<section class="s-talk-subject" id="sujet-1609">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/dark-patterns-la-contre-attaque-du-pire.php" class="url">Dark patterns, la contre-attaque du pire</a></span></span></h2>
...
<dd class="column">
15 <abbr title="heures">h</abbr> 00
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/design" rel="tag">design</a><br /><a href="http://www.paris-web.fr/2014/recherche/ethique" rel="tag">éthique</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Dans une galaxie lointaine, d’obscures forces sont à l’œuvre pour créer des stratégies perverses piégeant les internautes.</p>

<p>Nous explorerons en détail et à travers de nombreux exemples ces techniques qui ont pris le nom de « Dark patterns ».</p>

<p>Que ce soit dans l’e-commerce, dans les sites web, dans la publicité, une multitude de méthodes -toutes moins recommandables les unes que les autres- sont élaborées afin d’induire l’utilisateur final en erreur afin de maximiser les profits ou de biaiser les statistiques.</p>

<p>Quelles sont les motivations qui poussent les entreprises à duper leurs utilisateurs ? Quelles sont les conséquences que cela induit ? Que peut faire l’utilisateur pour éviter les pièges et se rebeller contre ces pratiques ?</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/clement-hardouin.php">Clément Hardoüin</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Clément Hardoüin" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Clement-Hardouin-thumb-143x143-428.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Tombé dans la marmite de l'informatique puis du web dès ses jeunes années, Clément Hardoüin poursuit naturellement des études en communication à l'<abbr title="Institut Supérieur de Communication et Publicité">ISCOM</abbr> puis en multimédia aux Gobelins jusqu'en 2002.</p>
<p>Depuis, il a évolué à différents postes, de chef de projet touche-à-tout dans une petite agence web à responsable Internet au sein de Juste pour Rire à Montréal. Depuis huit ans, il travaille chez MRM//McCANN Paris, d'abord en gestion de projet pour le compte d'un grand groupe automobile américain puis, de retour dans la technique, au poste de lead développeur front-end. Sa mission : renforcer et animer les équipes pour promouvoir un travail front-end de qualité. Vous pouvez le suivre sur <a href="http://twitter.com/fastclemmy">@fastclemmy</a></p></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/dark-patterns-la-contre-attaque-du-pire.php&amp;ref=prez-dark-patterns-la-contre-attaque-du-pire&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
