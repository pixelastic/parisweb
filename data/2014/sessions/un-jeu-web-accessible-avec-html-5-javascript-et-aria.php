...
<title>Paris Web - Un jeu web accessible avec HTML 5, JavaScript et ARIA</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/accueil.php" title="Accueil des ateliers" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/les-outils-des-designers-web-lre-post-adobe.php" title="Les outils des designers web : l’ère post-Adobe" />
	...
	<meta name="twitter:title" content="Un jeu web accessible avec HTML 5, JavaScript et ARIA" />
	<meta property="twitter:description" content="ARIA permet de rendre accessible une interface riche. Or, quoi de plus riche que l'interface d'un jeu web ? Cet atelier démontrera qu'avec HTML5, JavaScript et ARIA, il est tout à fait possible de…" />
	<meta property="dc:title" content="Un jeu web accessible avec HTML 5, JavaScript et ARIA" />
	<meta property="og:title" content="Un jeu web accessible avec HTML 5, JavaScript et ARIA" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/un-jeu-web-accessible-avec-html-5-javascript-et-aria.php" />
	<meta property="og:description" content="ARIA permet de rendre accessible une interface riche. Or, quoi de plus riche que l'interface d'un jeu web ? Cet atelier démontrera qu'avec HTML5, JavaScript et ARIA, il est tout à fait possible de…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Un jeu web accessible avec HTML 5, JavaScript et ARIA</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1590">
						<header>
							<h1>Un jeu web accessible avec HTML 5, JavaScript et ARIA</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1590">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/un-jeu-web-accessible-avec-html-5-javascript-et-aria.php" class="url">Un jeu web accessible avec HTML 5, JavaScript et ARIA</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/accessibilite" rel="tag">accessibilité</a></dd>
    ...
    <div class="talk-description"><p>ARIA permet de rendre accessible une interface riche. Or, quoi de plus riche que l'interface d'un jeu web ? Cet atelier démontrera qu'avec HTML5, JavaScript et ARIA, il est tout à fait possible de développer un jeu web accessible à tous.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/sylvie-duchateau.php">Sylvie Duchateau</a> et <a href="https://www.paris-web.fr/2014/../orateurs/victor-brito.php">Victor Brito</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Sylvie Duchateau" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Sylvie%20Duchateau-thumb-143x143-408.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après des études en langues étrangères appliquées anglais-allemand et en science politique, Sylvie Duchateau a travaillé pendant 15 ans au sein de l'Association BrailleNet.</p>
<p>Elle a contribué à la rédaction des différentes versions du Référentiel AccessiWeb. Elle a coordonné la traduction française des <abbr title="Web Content Accessibility Guidelines">WCAG</abbr>, recommandations internationales, norme <abbr title="Organisation internationale de normalisation">ISO</abbr>, du <abbr title="World Wide Web Consortium">W3C</abbr> sur les contenus Web, et de l'un de leur documents d'accompagnement.</p>
<p>Elle a effectué des sensibilisations, des formations à l'accessibilité numérique et rédigé des guides pour la création de documents accessibles. Depuis 1999, elle participe activement au groupe de travail Education and Outreach de W3C/<abbr title="Web Accessibility Initiative">WAI</abbr> (<a href="http://www.w3.org/WAI/EO/">www.w3.org/WAI/EO/</a>).<br /><br />Elle est aujourd'hui associée de Access42 (<a title="www.access42.net" href="http://www.access42.net">www.access42.net</a>).</p></div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Victor Brito" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Victor%20Brito-thumb-143x143-410.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Victor Brito est intégrateur HTML / CSS freelance. Expert Accessiweb en évaluation de l'accessibilité des sites Web, il s'implique activement dans l'accessibilité du Web, notamment en faisant partie du groupe d'experts référents intervenant dans la relecture des référentiels Accessiweb et en ayant participé à la relecture des notices AcceDe PDF et AcceDe Web.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/un-jeu-web-accessible-avec-html-5-javascript-et-aria.php&amp;ref=prez-un-jeu-web-accessible-avec-html-5-javascript-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
