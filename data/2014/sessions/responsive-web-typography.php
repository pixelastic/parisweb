...
<title>Paris Web - Responsive Web Typography</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/dejeuner.php" title="Déjeuner" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/petite-histoire-dune-methodologie-agilement-etablie.php" title="Petite histoire d’une méthodologie agilement établie" />
	...
	<meta name="twitter:title" content="Responsive Web Typography" />
	<meta property="twitter:description" content=" Responsive Web Typography Responsive Web Design done correctly is based upon content rather than actual device resolutions, and so typography should adapt to both layout and sizing across content…" />
	<meta property="dc:title" content="Responsive Web Typography" />
	<meta property="og:title" content="Responsive Web Typography" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/responsive-web-typography.php" />
	<meta property="og:description" content=" Responsive Web Typography Responsive Web Design done correctly is based upon content rather than actual device resolutions, and so typography should adapt to both layout and sizing across content…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Responsive Web Typography</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1602">
						<header>
							<h1>Responsive Web Typography</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939048" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1602">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/responsive-web-typography.php" class="url">Responsive Web Typography</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/rwd" rel="tag">RWD</a><br /><a href="http://www.paris-web.fr/2014/recherche/typographie" rel="tag">typographie</a></dd>
...
<strong>Responsive Web Typography</strong>
<p>Responsive Web Design done correctly is based upon content rather than actual device resolutions, and so typography should adapt to both layout and sizing across content breakpoints.</p>
<p>However, mere font sizing along the typographic scale based upon two-dimensional viewport @media queries is not enough.</p>
<p>Apart from setting the correct balance of the black and the white in letterforms and texts, there are other important factors such as reading distance, information density, screen sharpness and device orientation that also influence the reading process.</p>
<p>Learn to look at typography multidimensionally and enhance the overall responsive experience.</p>
</div>
<div lang="fr">
<strong>La typographie dans le Web Responsive</strong>
<p>L’application correcte du <span lang="en">Responsive Web Design</span> (RWD) part du contenu
plutôt que des résolutions de périphériques, aussi la typographie
devrait s'adapter tant à la disposition qu'aux redimensionnements au
travers des points de bascule du contenu.</p>
<p>Toutefois, se limiter à modifier la taille de fonte en fonction des
dimensions du viewport à l'aide des Media Queries n'est pas suffisant.</p>
<p>Il importe non seulement de trouver le bon équilibre entre noir et blanc
dans les formes lettrées et contenus textuels, mais aussi d'examiner
d'autres facteurs importants tels que la distance de lecture, la densité
d'information, la finesse de l'écran et l'orientation du périphérique,
tous ces éléments ayant une influence sur le processus de lecture.</p>
<p>Apprenez à considérer la typographie d'un point de vue multidimensionnel
et à améliorer l'expérience responsive générale que vous fournissez.</p>
</div></div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/marko-dugonjic.php">Marko Dugonjić</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Marko Dugonjić" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Marko%20Dugonjic-thumb-143x143-403.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en">
<p>Marko Dugonjić is a designer, speaker and author based in Velika Gorica, Croatia. As the creative and user experience director at Creative Nights, he improves customers’ digital experiences for both local and international clients. He is an editor at Smashing Magazine and is the co-author of the Smashing Book 4. His favorite pet project is Typetester, an online tool for testing screen fonts.</p>
</div>
<div lang="fr">
<p>Marko Dugonjić est un designer, orateur et auteur basé à Velika Gorica,
en Croatie. En tant que directeur créatif et responsable de
l'expérience utilisateur chez Creative Nights, il améliore l'expérience
numérique des utilisateurs pour ses clients locaux comme internationaux. Il est un des éditeurs de Smashing Magazine et le co-auteur du
Smashing Book n°4.  Son projet personnel préféré est Typetester, un
outil en ligne pour tester les fontes sur écran.</p>
</div></div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/responsive-web-typography.php&amp;ref=prez-responsive-web-typography&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
