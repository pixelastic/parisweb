...
<title>Paris Web - [Conf Sponsor] Microsoft — Introduction à TypeScript et retour d'expérience sur le portage de BabylonJS</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/le-burnout-et-comment-on-levite.php" title="Le burnout et comment on l'évite" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/informelles-6.php" title="Informelles" />
	...
	<meta name="twitter:title" content="[Conf Sponsor] Microsoft — Introduction à TypeScript et retour…" />
	<meta property="twitter:description" content="TypeScript ou comment goûter à une partie d’ECMAScript 6 le tout de manière typée. Inventé par le créateur de C# et Delphi ! JavaScript est passé d’un jouet utilisé dans une simple page web à de…" />
	<meta property="dc:title" content="[Conf Sponsor] Microsoft — Introduction à TypeScript et retour d'expérience sur le portage de BabylonJS" />
	<meta property="og:title" content="[Conf Sponsor] Microsoft — Introduction à TypeScript et retour d'expérience sur le portage de BabylonJS" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/sponsor-microsoft.php" />
	<meta property="og:description" content="TypeScript ou comment goûter à une partie d’ECMAScript 6 le tout de manière typée. Inventé par le créateur de C# et Delphi ! JavaScript est passé d’un jouet utilisé dans une simple page web à de…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>[Conf Sponsor] Microsoft — Introduction à TypeScript et retour d'expérience sur le portage de BabylonJS</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1667">
						<header>
							<h1>[Conf Sponsor] Microsoft — Introduction à TypeScript et retour d'expérience sur le portage de BabylonJS</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113839412" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1667">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/sponsor-microsoft.php" class="url">[Conf Sponsor] Microsoft — Introduction à TypeScript et retour d'expérience sur le portage de BabylonJS</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/javascript" rel="tag">JavaScript</a></dd>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/david-rousset.php">David Rousset</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="David Rousset" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-David%20Rousset-thumb-143x143-444.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>David est évangéliste technique chez Microsoft France. Il s’occupe principalement d’HTML5 mais travaille aussi beaucoup sur le portage de jeux pour les stores Windows (via Unity3D ou DirectX). Il adore les standards du Web et les teste sous IE, ce grand malade ! Il est co-auteur du framework open-source babylon.js pour créer des jeux WebGL.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/sponsor-microsoft.php&amp;ref=prez-sponsor-microsoft&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
