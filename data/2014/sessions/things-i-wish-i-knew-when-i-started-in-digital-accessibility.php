...
<title>Paris Web - Things I wish I knew when I started in Digital Accessibility</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/changement-de-salle-2.php" title="Changement de salle" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/mutation-dun-geant-du-web-vers-le-mobile.php" title="Mutation d’un géant du web vers le Mobile" />
	...
	<meta name="twitter:title" content="Things I wish I knew when I started in Digital Accessibility" />
	<meta property="twitter:description" content=" Things I wish I knew when I started in Digital Accessibility Knowing first hand how difficult accessibility can be for someone who is new, Billy aims to nurture their passion and boost their…" />
	<meta property="dc:title" content="Things I wish I knew when I started in Digital Accessibility" />
	<meta property="og:title" content="Things I wish I knew when I started in Digital Accessibility" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/things-i-wish-i-knew-when-i-started-in-digital-accessibility.php" />
	<meta property="og:description" content=" Things I wish I knew when I started in Digital Accessibility Knowing first hand how difficult accessibility can be for someone who is new, Billy aims to nurture their passion and boost their…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span><a href="https://www.paris-web.fr/2014/">Programme 2014</a></span>
				<span>Things I wish I knew when I started in Digital Accessibility</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1603">
						<header>
							<h1>Things I wish I knew when I started in Digital Accessibility</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113939759" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1603">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/things-i-wish-i-knew-when-i-started-in-digital-accessibility.php" class="url">Things I wish I knew when I started in Digital Accessibility</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2014/conferences/">Conférence</a></dd>

<dt class="clear span-1">Lieu</dt>
<dd class="column location"><a href="/lieux/">Salle Mœbius</a></dd>
<dt class="clear span-1">Date</dt>
<dd class="column">
<a href="/2014/16.php">jeudi 16</a>
</dd>
<dt class="clear span-1">Heure</dt>
<dd class="column">
16 <abbr title="heures">h</abbr> 55
<abbr title="utc" class="dtstart"><!-- --></abbr>
</dd>


<dt class="clear span-1">Thème(s)</dt>
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/accessibilite" rel="tag">accessibilité</a><br /><a href="http://www.paris-web.fr/2014/recherche/methodologie" rel="tag">méthodologie</a><br /><a href="http://www.paris-web.fr/2014/recherche/metier" rel="tag">métier</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span><span class="badge">Traduction <abbr title="français">FR</abbr></span><span class="badge"><abbr title="Présentation en anglais">EN</abbr></span></dd>

</dl>
</div>
		</aside>
    <div class="talk-description" lang="en"><div lang="en">
<p><strong>Things I wish I knew when I started in Digital Accessibility</strong></p>
<p>Knowing first hand how difficult accessibility can be for someone who is new, Billy aims to nurture their passion and boost their confidence by sharing some important lessons he wished he knew when he was starting out.</p>

<p>In the first section a three-part talk, Billy will demonstrate how he managed to introduce accessibility to multiple teams of Project Managers, Developers, Designers, and Clients who were resistant at first by debunking popular misconceptions that accessibility was “too costly”, “too difficult”, or “took too long”. This was not an overnight success story and resulted in many years of “debugging” his strategy.</p>

<p>Section two will focus on how Billy managed to win developers over by making them less “afraid” of accessibility. In this section Billy will share practical coding tips, time saving methodologies, and will demystify the guidelines that often confuse developers. He will also explain design patterns and how to test widgets and plugins to ensure the delivered product is never compromised.</p>

<p>Section three discusses how powerful a resource the accessibility community is and offers advice on how to participate. Billy will talk about how to meet other people in the community, the important role that social media plays, and the importance of attending and/or participating in camps and meet-ups.</p>
</div>

<div lang="fr">
<p><strong>Les choses que j'aurais souhaité connaître quand j'ai débuté dans l'accessibilité numérique</strong></p>

<p>Connaissant personnellement au combien difficile l'accessibilité peut être pour les néophytes, Billy a pour but d'encourager leurs passions et booster leurs confiances en partageant d'importantes leçons qu'il aurait souhaité connaître quand il a lui-même débuté.</p>

<p>Dans la première partie de cette présentation qui en contiendra trois, Billy démontrera comment il a réussi à introduire l'accessibilité à de multiples équipes de chefs de projets, développeurs, graphistes et clients qui étaient au début réfractaires, en débusquant les idées fausses selon lesquelles l'accessibilité serait "trop coûteuse", "trop difficile" ou "prendrait trop de temps". Cette <span lang="en">success story</span> ne s'est pas construite du jour au lendemain, ce qui a permis Billy de perfectionner sa stratégie d'approche au fil des ans.</p>
<p>La deuxième partie sera centrée sur les méthodes qui ont permis à Billy de gagner la confiance des développeurs pour qu'ils aient moins "peur" de l'accessibilité. Dans cette partie, Billy partagera des astuces de code, des méthodologies pour gagner du temps et démystifiera les recommandations qui rendent souvent les développeurs perplexes.</p>
<p>La troisième et dernière partie abordera la puissante ressource qu'est la communauté de l'accessibilité numérique, et donnera des conseils pour y participer. Billy vous racontera comment rencontrer d'autres personnes de la communauté, le rôle important que les médias sociaux jouent et l'importance d'assister ou de participer à des conférences ou à des <span lang="en">meet-ups</span>.</p>
</div>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/billy-gregory.php">Billy Gregory</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Billy Gregory" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-BillyGregory-thumb-143x143-440.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio" lang="en"><div lang="en">
<p>
Billy Gregory is an accessibility professional and Sr. Accessibility Engineer with The Paciello Group, a recognized leader in the Digital Accessibility field. As a former front-end developer, Billy can relate to many of the challenges and the apprehension faced by developers who are new to accessibility. He enjoys working with developers of all levels of experience to strengthen their skills and understanding of accessibility. Billy is active in the Accessibility Community as an advocate, practitioner, and public speaker. He co-runs the Toronto Accessibility Camp as well as the monthly Toronto Accessibility and Inclusive Design meet up group.</p>
</div>

<div lang="fr">
<p>
Billy Gregory est un professionnel de l'accessibilité et Ingénieur
Accessibilité Senior au Piacello Group, un des leaders établis de
l'accessibilité numérique.  En tant qu'ex-développeur front-end, Billy
connaît bien les challenges et l'appréhension que rencontrent les
développeurs qui découvrent l'accessibilité.  Il adore travailler avec
des développeurs de tous niveaux d'expérience pour renforcer leurs
compétences et leur compréhension de l'accessibilité.  Billy est un
membre actif de la communauté de l'accessibilité en tant que défenseur,
praticien et orateur.  Il co-anime le Toronto Accessibility Camp ainsi
que la rencontre mensuelle Toronto Accessibility and Inclusive Design.</p>
</div>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/things-i-wish-i-knew-when-i-started-in-digital-accessibility.php&amp;ref=prez-things-i-wish-i-knew-when-i-started-in-digita&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
...
<section class="news l-fixedColumn l-block l-primary">
		<article>
			<h2>L'édition 2014</h2>
			<ul>
            <li><a class="roll" href="/2014/conferences/" rel="bookmark">Les conférences 2014</a></li>
            <li><a class="roll" href="/2014/16.php" rel="bookmark">Programme du jeudi 16</a></li>
            <li><a class="roll" href="/2014/17.php" rel="bookmark">Programme du vendredi 17</a></li>

            <li><a class="roll" href="/2014/ateliers/" rel="bookmark">Les ateliers 2014</a></li>
            <li><a class="roll" href="/2014/18.php" rel="bookmark">Programme du samedi 18</a></li>
            <li><a class="roll" href="/2014/orateurs/" rel="bookmark">Les orateurs 2014</a></li>
			</ul>
        <ul class="large">
            <li><a href="http://www.paris-web.fr/2014/conferences-parisweb-2014.ics">Calendrier au format iCAL/ics des conférences 2014</a></li>
			<li><a href="http://www.paris-web.fr/2014/ateliers-parisweb-2014.ics">Calendrier au format iCAL/ics des ateliers 2014</a></li>
		</ul>
		</article>
	 </section>
