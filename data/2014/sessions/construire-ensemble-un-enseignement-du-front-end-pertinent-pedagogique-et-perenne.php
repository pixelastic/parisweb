...
<title>Paris Web - Construire ensemble un enseignement du front-end pertinent, pédagogique et pérenne</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/editer-du-code-avec-plaisir.php" title="Editer du code… avec plaisir !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/cloture.php" title="Clôture" />
	...
	<meta name="twitter:title" content="Construire ensemble un enseignement du front-end pertinent,…" />
	<meta property="twitter:description" content="Un atelier-débat improvisé à Sud web en mai 2014 a permis de lister quelques pistes sur l’enseignement du développement front-end. Parmi ces pistes, la difficulté de la pédagogie et le manque…" />
	<meta property="dc:title" content="Construire ensemble un enseignement du front-end pertinent, pédagogique et pérenne" />
	<meta property="og:title" content="Construire ensemble un enseignement du front-end pertinent, pédagogique et pérenne" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/construire-ensemble-un-enseignement-du-front-end-pertinent-pedagogique-et-perenne.php" />
	<meta property="og:description" content="Un atelier-débat improvisé à Sud web en mai 2014 a permis de lister quelques pistes sur l’enseignement du développement front-end. Parmi ces pistes, la difficulté de la pédagogie et le manque…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Construire ensemble un enseignement du front-end pertinent, pédagogique et pérenne</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1601">
						<header>
							<h1>Construire ensemble un enseignement du front-end pertinent, pédagogique et pérenne</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1601">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/construire-ensemble-un-enseignement-du-front-end-pertinent-pedagogique-et-perenne.php" class="url">Construire ensemble un enseignement du front-end pertinent, pédagogique et pérenne</a></span></span></h2>
		<aside class="s-talk-specs">
			<div class="span-4">
<dl class="clearfix">

<dt class="clear span-1">Format</dt>
<dd class="column"><a href="/2014/ateliers/">Atelier</a></dd>
...
<dd class="column">
<a href="/2014/18.php">samedi 18</a>
</dd>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2014/recherche/metier" rel="tag">métier</a></dd>
    ...
    <div class="talk-description"><p>Un atelier-débat improvisé à Sud web en mai 2014 a permis de lister quelques pistes sur l’enseignement du développement front-end. Parmi ces pistes, la difficulté de la pédagogie et le manque d’outils sont ressortis. Il s’agit en effet de bien transmettre les principes et les spécificités du média (plus que la technique, peu complexe en définitive) sans lasser, sans assomer, sans braquer ou encore donner l’impression de couper les cheveux en quatre.  </p>

<p>Nous vous proposons de concevoir ensemble des fiches pédagogiques qui permettraient :</p>

<ul>
<li>aux étudiants d’avoir un projet ou un cas concret avec un problème clair à résoudre.</li>
<li>à l’enseignant de distiller les grands principes du web petit à petit à travers ces cas concrets, et pas présentés de manière théorique.</li>
</ul>

<p>Le tout sera mis à la disposition de tous sur GitHub.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/delphine-malassingne.php">Delphine Malassingne</a> et <a href="https://www.paris-web.fr/2014/../orateurs/remi-parmentier.php">Rémi Parmentier</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Delphine Malassingne" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Delphine%20Malassingne-thumb-143x143-414.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Delphine Malassingne est Responsable qualité chez Ekino. Elle y accompagne les équipes dans la production de livrables de qualité mais aussi dans la façon de produire. Son enthousiasme pour le partage de connaissance l’ont amené en parallèle à participer à des projets communautaires (w3qualité, Opquast Checklists, Paris Web, notamment).
Elle essaye en parallèle “d’avoir une vie” en dessinant un peu, en calligraphiant et a même réussi à aligner trois points de couture !</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Rémi Parmentier" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Remi-Parmentier-thumb-143x143-436.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Rémi est intégrateur et co-gérant de sa petite agence web à Tourcoing, dans le Nord. En plus de faire des sites web, il intègre aussi des e-mails parfois. Il aime partager ses humeurs et ses découvertes sur <a href="http://www.hteumeuleu.fr/">son blog</a> et <a href="http://www.twitter.com/hteumeuleu">son compte Twitter</a>. Cette année, il a même lancé <a href="http://emails.hteumeuleu.fr/">un blog dédié à l’intégration d’e-mails</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/construire-ensemble-un-enseignement-du-front-end-pertinent-pedagogique-et-perenne.php&amp;ref=prez-construire-ensemble-un-enseignement-du-front-&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
