...
<title>Paris Web - Créer des ponts entre le point de vente physique et la vente en ligne</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/pause-1.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/profession-pompier.php" title="Profession : pompier" />
	...
	<meta name="twitter:title" content="Créer des ponts entre le point de vente physique et la vente en ligne" />
	<meta property="twitter:description" content="Emmener les clients vers la vente en ligne était un premier défi. Les faire revenir au point de vente physique après avoir goûté la facilité du web, rassembler vente physique et en ligne pour former…" />
	<meta property="dc:title" content="Créer des ponts entre le point de vente physique et la vente en ligne" />
	<meta property="og:title" content="Créer des ponts entre le point de vente physique et la vente en ligne" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/creer-des-ponts-entre-le-point-de-vente-physique-et-la-vente-en-ligne.php" />
	<meta property="og:description" content="Emmener les clients vers la vente en ligne était un premier défi. Les faire revenir au point de vente physique après avoir goûté la facilité du web, rassembler vente physique et en ligne pour former…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Créer des ponts entre le point de vente physique et la vente en ligne</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1624">
						<header>
							<h1>Créer des ponts entre le point de vente physique et la vente en ligne</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113838904" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
		...
		<h3>Télécharger</h3>
		<p class="clearfix">
			<a href="http://www.paris-web.fr/2014/slides/Eric_Nouri-creer-des-ponts-entre-le-point-de-vente.pdf" onClick="recordOutboundLink(this, 'Téléchargements', 'PDF');return false;" title="La présentation au format PDF."><span class="badge">PDF</span></a>
		</p>

</section>

	
	<section class="s-talk-subject" id="sujet-1624">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/creer-des-ponts-entre-le-point-de-vente-physique-et-la-vente-en-ligne.php" class="url">Créer des ponts entre le point de vente physique et la vente en ligne</a></span></span></h2>
...
<dd class="column">
16 <abbr title="heures">h</abbr> 30
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/e-commerce" rel="tag">e-commerce</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>Emmener les clients vers la vente en ligne était un premier défi. Les faire revenir au point de vente physique après avoir goûté la facilité du web, rassembler vente physique et en ligne pour former une expérience d'achat complète en sont deux autres. Tous les moyens possibles ne sont pas encore forcément maitrisés ou mis en place pour récompenser le client fidèle et le faire revenir en magasin. Avant tout il faut considérer l’utilisateur, c’est à dire le consommateur.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/eric-nouri.php">Eric Nouri</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Eric Nouri" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Eric%20Nouri-thumb-143x143-401.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Eric est UX researcher. Il a d’abord travaillé sur les objets connectés, chez Parrot en collaborant notamment avec Starck, avant de rejoindre l’équipe d’Axance, pour accompagner des entreprises comme BNP Paribas, SNCF, Louis Vuitton ou encore Philips. Vous pouvez le suivre sur <a href="http://twitter.com/userscanhelp">@userscanhelp</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/creer-des-ponts-entre-le-point-de-vente-physique-et-la-vente-en-ligne.php&amp;ref=prez-creer-des-ponts-entre-le-point-de-vente-physi&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
