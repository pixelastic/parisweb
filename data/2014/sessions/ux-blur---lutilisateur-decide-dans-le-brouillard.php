...
<title>Paris Web - UX Blur - L'utilisateur décide dans le brouillard !</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/pause-2.php" title="Pause" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/finissons-en-ensemble-avec-le-mythe-du-responsive-web-design-lent.php" title="Finissons-en ensemble avec le mythe du Responsive web Design lent" />
	...
	<meta name="twitter:title" content="UX Blur - L'utilisateur décide dans le brouillard !" />
	<meta property="twitter:description" content="Entre notre magnifique page web et le cerveau de l'utilisateur il y a les yeux ! Deux yeux qui transmettent très rapidement au cerveau une grande image grise et floue, puis, beaucoup plus lentement,…" />
	<meta property="dc:title" content="UX Blur - L'utilisateur décide dans le brouillard !" />
	<meta property="og:title" content="UX Blur - L'utilisateur décide dans le brouillard !" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/ux-blur---lutilisateur-decide-dans-le-brouillard.php" />
	<meta property="og:description" content="Entre notre magnifique page web et le cerveau de l'utilisateur il y a les yeux ! Deux yeux qui transmettent très rapidement au cerveau une grande image grise et floue, puis, beaucoup plus lentement,…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>UX Blur - L'utilisateur décide dans le brouillard !</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1591">
						<header>
							<h1>UX Blur - L'utilisateur décide dans le brouillard !</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1591">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/ux-blur---lutilisateur-decide-dans-le-brouillard.php" class="url">UX Blur - L'utilisateur décide dans le brouillard !</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/ux" rel="tag">UX</a></dd>
    ...
    <div class="talk-description"><p>Entre notre magnifique page web et le cerveau de l'utilisateur il y a les yeux !</p>

<p>Deux yeux qui transmettent très rapidement au cerveau une grande image grise et floue, puis, beaucoup plus lentement, des éléments partiels mais nets, précis et en couleur.</p>

<p>Pendant ce temps le cerveau s'impatiente et, pour hâter sa décision, va chercher d'autres informations !</p>

<p>En décortiquant compréhension, émotion et décision de l'utilisateur au cours de ces trois premières secondes nous redécouvrons et expliquons les « bonnes pratiques » des concepteurs d'interfaces à la lumière de l'eXpérience Utilisateur.</p>

<p>Nous abordons cinq aspects du design d'interface au travers d'exemples concrets de psychologie cognitive :</p>

<ul>
<li>Vision fovéale (comment fonctionne le regard)</li>
<li>Importance du contexte et de l'émotion</li>
<li>Le "banner blindness" (80% des bannières ne sont pas regardées)</li>
<li>Les surfaces utiles</li>
<li>Les actionnables et la mémoire prédictive</li>
</ul>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/yves-koekkoek.php">Yves Koekkoek</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Yves Koekkoek" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Yves-Koekkoek-thumb-143x143-439.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Yves est chercheur et consultant en eXpérience Utilisateur. Il enseigne notamment au Master Communications et Technologie Numérique du CELSA.
Fondateur du Labo Internet, il aide les créateurs d'interactions en testant chaque année plusieurs dizaines d'interfaces auprès de centaines d'utilisateurs. </p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/ux-blur---lutilisateur-decide-dans-le-brouillard.php&amp;ref=prez-ux-blur---lutilisateur-decide-dans-le-brouill&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
