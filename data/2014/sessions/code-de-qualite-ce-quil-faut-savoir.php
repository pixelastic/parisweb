...
<title>Paris Web - Code de qualité : ce qu'il faut savoir</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/conferences/convivialite-des-interfaces-des-reseaux-sociaux-et-specificites-culturelles.php" title="Convivialité des interfaces des réseaux sociaux et spécificités culturelles " />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/changement-de-salle-3.php" title="Changement de salle" />
	...
	<meta name="twitter:title" content="Code de qualité : ce qu'il faut savoir" />
	<meta property="twitter:description" content="Dans cette session, nous regardons un éventail d'outils et de processus qui vous permettront d'augmenter la qualité du code de votre projet. Et cela sans ralentir le rythme de travail. Ces méthodes…" />
	<meta property="dc:title" content="Code de qualité : ce qu'il faut savoir" />
	<meta property="og:title" content="Code de qualité : ce qu'il faut savoir" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/code-de-qualite-ce-quil-faut-savoir.php" />
	<meta property="og:description" content="Dans cette session, nous regardons un éventail d'outils et de processus qui vous permettront d'augmenter la qualité du code de votre projet. Et cela sans ralentir le rythme de travail. Ces méthodes…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Code de qualité : ce qu'il faut savoir</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1617">
						<header>
							<h1>Code de qualité : ce qu'il faut savoir</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/114950685" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1617">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/code-de-qualite-ce-quil-faut-savoir.php" class="url">Code de qualité : ce qu'il faut savoir</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/developpement" rel="tag">développement</a><br /><a href="http://www.paris-web.fr/2014/recherche/methodologie" rel="tag">méthodologie</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span><span class="badge">Vélotypie</span></dd>
    ...
    <div class="talk-description"><p>Dans cette session, nous regardons un éventail d'outils et de processus qui vous permettront d'augmenter la qualité du code de votre projet. Et cela sans ralentir le rythme de travail. Ces méthodes de travail sont largement utilisées par de nombreux projets à succès.
Nous partagerons aussi nos expériences lors de la mise en place progressive de ces méthodes. Vous pourrez mettre en place l'une de ses pratiques la semaine suivante.</p>

<p>Nous parlerons, entre autres, de revue de code, tests, gestionnaire de versions, gestionnaire de tickets, linter, guide de style, intégration continue, gérer votre dette technique, documentation à la demande, automatisation des tâches récurrentes.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/julien-wajsberg.php">Julien Wajsberg</a> et <a href="https://www.paris-web.fr/2014/../orateurs/anthony-ricaud.php">Anthony Ricaud</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Julien Wajsberg" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Julien%20Wasjberg-thumb-143x143-443.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Après avoir passé un certain temps à faire des applications Web en Java, Julien Wajsberg travaille à présent chez Mozilla dans l'équipe de Firefox OS. Il est plus particulièrement en charge de l'application de messagerie, entièrement réalisée avec des technologies Web.</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Anthony Ricaud" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Anthony%20Ricaud-thumb-143x143-398.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Développeur, Anthony anime nos discussions sur ##openweb, Twitter (<a href="https://twitter.com/rik24d">@rik24d</a>) et autres avec passion et humour. Une langue acérée et un cœur tendre en toutes circonstances, il est toujours prompt à aider. Il a participé au code source de WebKit. Il travaille aujourd'hui pour Mozilla sur FirefoxOS, notamment l'application de téléphonie.
De temps en temps, il blogue sur <a href="http://ricaud.me">http://ricaud.me</a>.</p>

<p>Cette biographie collective a été rédigée en partie via IRC irc://irc.freenode.net/openweb</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/code-de-qualite-ce-quil-faut-savoir.php&amp;ref=prez-code-de-qualite-ce-quil-faut-savoir&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
