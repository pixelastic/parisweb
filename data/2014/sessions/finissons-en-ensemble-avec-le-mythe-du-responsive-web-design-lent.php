...
<title>Paris Web - Finissons-en ensemble avec le mythe du Responsive web Design lent</title>
...
<link rel="prev bookmark" href="https://www.paris-web.fr/2014/ateliers/ux-blur---lutilisateur-decide-dans-le-brouillard.php" title="UX Blur - L'utilisateur décide dans le brouillard !" />
<link rel="next bookmark" href="https://www.paris-web.fr/2014/ateliers/les-cles-pour-sorienter-dans-un-projet-libre.php" title="Les clés pour s'orienter dans un projet libre" />
	...
	<meta name="twitter:title" content="Finissons-en ensemble avec le mythe du Responsive web Design lent" />
	<meta property="twitter:description" content="Ils sont deux, ils sont beaux, et ils mettent à genoux les problématiques liées aux webperfs et Responsive web Design. Faire du RWD, on commence à connaître. Faire de la performance, les bases sont…" />
	<meta property="dc:title" content="Finissons-en ensemble avec le mythe du Responsive web Design lent" />
	<meta property="og:title" content="Finissons-en ensemble avec le mythe du Responsive web Design lent" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/ateliers/finissons-en-ensemble-avec-le-mythe-du-responsive-web-design-lent.php" />
	<meta property="og:description" content="Ils sont deux, ils sont beaux, et ils mettent à genoux les problématiques liées aux webperfs et Responsive web Design. Faire du RWD, on commence à connaître. Faire de la performance, les bases sont…" />
...
<body>
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Finissons-en ensemble avec le mythe du Responsive web Design lent</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1598">
						<header>
							<h1>Finissons-en ensemble avec le mythe du Responsive web Design lent</h1>
						</header>
	...
	<section class="s-talk-subject" id="sujet-1598">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/ateliers/finissons-en-ensemble-avec-le-mythe-du-responsive-web-design-lent.php" class="url">Finissons-en ensemble avec le mythe du Responsive web Design lent</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/rwd" rel="tag">RWD</a></dd>
    ...
    <div class="talk-description"><p>Ils sont deux, ils sont beaux, et ils mettent à genoux les problématiques liées aux webperfs et Responsive web Design.</p>

<p>Faire du RWD, on commence à connaître. Faire de la performance, les bases sont connues et (plutôt) bien documentées. Faire du RWD Performant, on fait ça comment ?</p>

<p>On retrousse ses manches, et on recommence de zéro : montons ensemble un site web à la fois responsif et performant. Techniques, bonnes pratiques, astuces et compromis, vous saurez tout.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/matthias-dugue.php">Matthias Dugué</a> et <a href="https://www.paris-web.fr/2014/../orateurs/nicolas-hoizey.php">Nicolas Hoizey</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Matthias Dugué" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Matthias%20Dugue-thumb-143x143-419.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Matthias Dugué est Dev UI chez Clever Age et éleveur de licornes de
combat depuis 1996. Quand il ne s'amuse pas à démonter et à remonter les
interfaces de ses clients, il se livre à un culte étrange visant à
réinventer le web autour de bières en compagnie de ses compagnons de
fortune.</p>
</div>
</div>
...
<div class="s-listContent-item">
        <span class="l-float-left">
			...
			<img class="speaker-pic" alt="Nicolas Hoizey" src="https://www.paris-web.fr/2014/assets_c/2014/09/2014-photo-Nicolas-Hoizey-thumb-143x143-433.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Nicolas Hoizey est tombé dans le Web aux alentours de 1996, et n’en est jamais ressorti.</p>

<p>Co-fondateur et directeur de l'innovation de Clever Age, qui se positionne en conseil et réalisation sur tous types de projets Web et mobiles, Nicolas intervient en clientèle pour des missions de conseil, direction de projet et expertise, anime de multiples formations destinées aux maitrises d’ouvrage et maitrises d’œuvre, et intervient régulièrement dans des conférences.</p>

<p>S’appuyant sur plus de 15 ans d’expérience du Web, Nicolas prône un usage pragmatique des technologies du Web, appliquant pour cela les bonnes pratiques, techniques et méthodologiques, sur les standards, l'ergonomie et l'accessibilité, la performance, la capitalisation, etc.</p>

<p>Côté front end, la performance Web et le Responsive Web Design font parti de ses sujets de prédilection depuis quelques années.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/ateliers/finissons-en-ensemble-avec-le-mythe-du-responsive-web-design-lent.php&amp;ref=prez-finissons-en-ensemble-avec-le-mythe-du-respon&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
