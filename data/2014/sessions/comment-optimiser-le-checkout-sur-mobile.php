...
<title>Paris Web - Comment optimiser le checkout sur mobile ?</title>
...
<link rel="next bookmark" href="https://www.paris-web.fr/2014/conferences/comment-tirer-le-meilleur-parti-de-ses-erreurs.php" title="Comment tirer le meilleur parti de ses erreurs ?" />
	...
	<meta name="twitter:title" content="Comment optimiser le checkout sur mobile ?" />
	<meta property="twitter:description" content="De par la situation de mobilité du smartphone, la phase du checkout est délicate, car l'internaute ne risque pas de sortir sa carte bleue quand il n'est pas chez lui. En sachant qu'en ajoutant une…" />
	<meta property="dc:title" content="Comment optimiser le checkout sur mobile ?" />
	<meta property="og:title" content="Comment optimiser le checkout sur mobile ?" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="https://www.paris-web.fr/2014/conferences/comment-optimiser-le-checkout-sur-mobile.php" />
	<meta property="og:description" content="De par la situation de mobilité du smartphone, la phase du checkout est délicate, car l'internaute ne risque pas de sortir sa carte bleue quand il n'est pas chez lui. En sachant qu'en ajoutant une…" />
	...
	<div role="search">
		...
		<div role="main" id="main" class="l-groundZero" tabindex="-1">
			<p class="breadcrumb">
				...
				<span>Comment optimiser le checkout sur mobile ?</span>
			</p>
			<div class="l-content l-block l-third">
					<article id="entry-1626">
						<header>
							<h1>Comment optimiser le checkout sur mobile ?</h1>
						</header>
...
<section class="s-talk-talk">
    <header><h2>La présentation</h2></header>
			...
			<iframe src="//player.vimeo.com/video/113838749" width="100%" height="475" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
			<p>
	...
	<section class="s-talk-subject" id="sujet-1626">
		<h2>Le sujet<span class="hidden"> : <span class="summary"><a href="https://www.paris-web.fr/2014/conferences/comment-optimiser-le-checkout-sur-mobile.php" class="url">Comment optimiser le checkout sur mobile ?</a></span></span></h2>
...
<dd class="column location"><a href="http://www.paris-web.fr/2014/recherche/e-commerce" rel="tag">e-commerce</a><br /><a href="http://www.paris-web.fr/2014/recherche/ergonomie" rel="tag">ergonomie</a><br /><a href="http://www.paris-web.fr/2014/recherche/mobile" rel="tag">mobile</a></dd>
...
<dd class="services"><span class="badge"><abbr title="Langue des signes française">LSF</abbr></span></dd>
    ...
    <div class="talk-description"><p>De par la situation de mobilité du smartphone, la phase du checkout est délicate, car l'internaute ne risque pas de sortir sa carte bleue quand il n'est pas chez lui. 
En sachant qu'en ajoutant une étape dans le process de checkout, on perd à chaque fois la moitié de ses utilisateurs, il devient essentiel de réfléchir à la gestuelle du checkout de façon plus simple, de minimiser les champs à remplir, bref de faciliter cette étape de complétion d'achat.</p>
</div>
	</section>
...
<section class="s-talk-speaker s-listContent" id="talk-speakers">
		<h2>Présenté par <a href="https://www.paris-web.fr/2014/../orateurs/nicolas-el-azzi.php">Nicolas El Azzi</a></h2>

<div class="s-listContent-item">
        <span class="l-float-left">

			<img class="speaker-pic" alt="Nicolas El Azzi" src="https://www.paris-web.fr/2014/assets_c/2014/07/2014-photo-Nicolas%20El%20Azzi-thumb-143x143-404.jpg" width="143" height="143">

            
        </span>
<div class="speaker-bio"><p>Venant du print, Nicolas évolue rapidement dans l’univers du web suite à son entrée chez AOL. D’abord graphiste, il gagne en appétit pour la conception web et les logiques de navigation et de compréhension de l’utilisateur.
Tirant parti de cette double toque, il mitonne chez Axance depuis 2008 des maquettes ergonomiques et aime dispenser ses recettes en tant que conseiller et consultant sur les problématiques mobile, tablette et les applications métiers. Vous pouvez le suivre sur <a href="http://twitter.com/nicolaselazzi">@nicolaselazzi</a>.</p>
</div>
</div>
...
<iframe src="http://www.facebook.com/plugins/like.php?href=https://www.paris-web.fr/2014/conferences/comment-optimiser-le-checkout-sur-mobile.php&amp;ref=prez-comment-optimiser-le-checkout-sur-mobile&amp;locale=fr_FR&amp;layout=button_count&amp;action=recommend&amp;show_faces=false&amp;width=190&amp;colorscheme=light&amp;height=20" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:190px; height:20px;" allowTransparency="true"></iframe>
				</div>
			</footer>
		</article>
		</div>
